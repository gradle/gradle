...
set DIST_NAME=gradle-0.1.4-080505102209+0200
set GRADLE_HOME=%DIRNAME%gradle-wrapper\gradle-dist\gradle-0.1.4-080505102209+0200
set Path=%DIRNAME%gradle-wrapper\gradle-dist\gradle-0.1.4-080505102209+0200\bin;%Path%
