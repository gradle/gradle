...
project.plugins.withType<JavaBasePlugin> {
    project.extensions.getByName<SourceSetContainer>("sourceSets").configureEach {
        ...
        addErrorProneDependency(annotationProcessorConfigurationName, extension, "com.google.errorprone:error_prone_core:2.42.0") // 🚧 keep in sync with in `distributions-dependencies/build.gradle.kts`
...
tasks.withType<JavaCompile>().configureEach {
    options.errorprone {
        disable(
            ...
            "ConstantNaming", // 🐢 patchable
            "DirectReturn", // ❔ Don`t want to use this. https://github.com/junit-team/junit-framework/pull/5006#discussion_r2403984446
            "ExplicitArgumentEnumeration",
            "FormatStringConcatenation",
            "IdentityConversion",
            "IsInstanceLambdaUsage",
            "LexicographicalAnnotationAttributeListing", // ☑️ Don`t want to use this. https://github.com/junit-team/junit-framework/pull/5043#pullrequestreview-3330615838
            "LexicographicalAnnotationListing", // 🐢 patchable
            "MissingTestCall",
            "NestedOptionals",
            "NonStaticImport", // ❕ Don`t want to use this.
            "OptionalOrElseGet",
            "PrimitiveComparison",
            "RedundantStringConversion", // 🐢 patchable
            "RedundantStringEscape",
            "StaticImport", // 🐢 patchable
            "StringJoining",
            "TimeZoneUsage",
        )
        ...
        if (!getenv().containsKey("CI") && getenv("chitchat").toBoolean()) { // 🐢 opt in chitchat auto patch.
