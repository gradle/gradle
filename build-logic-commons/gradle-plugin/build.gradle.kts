...
dependencies {
    compileOnly("com.gradle:gradle-enterprise-gradle-plugin:3.14.1")

    implementation(project(":commons"))
    implementation("org.gradle.kotlin.kotlin-dsl:org.gradle.kotlin.kotlin-dsl.gradle.plugin:4.1.0")
