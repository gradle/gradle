...
public abstract class AbstractHttpBuildCacheServiceFactory implements BuildCacheServiceFactory<HttpBuildCache> {
    ...
    public AbstractHttpBuildCacheServiceFactory(SslContextFactory sslContextFactory, HttpBuildCacheRequestCustomizer requestCustomizer, HttpClientHelper.Factory httpClientHelperFactory) {
    ...
    public BuildCacheService createBuildCacheService(HttpBuildCache configuration, Describer describer) {
        ...
        return doCreateBuildCacheService(httpClientHelper, noUserInfoUrl, requestCustomizer, useExpectContinue);
    }

    abstract BuildCacheService doCreateBuildCacheService(HttpClientHelper httpClientHelper, URI noUserInfoUrl, HttpBuildCacheRequestCustomizer requestCustomizer, boolean useExpectContinue);
