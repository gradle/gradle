...
public class XcodePlugin extends IdePlugin {
    ...
    private void configureXcodeForXCTest(final Project project, PBXTarget.ProductType productType) {
        ...
        XcodeTarget target = newTarget(component.getModule().get() + " " + toString(productType), component.getModule().get(), productType, toGradleCommand(project.getRootProject()), getBridgeTaskPath(project), installXCTestBundle.getBundleDirectory(), installXCTestBundle.getBundleDirectory(), sources);
