...
class VisualStudioMultiProjectIntegrationTest extends AbstractVisualStudioIntegrationSpec {
    ...
    def "can build executable that depends on static library in another project from visual studio"() {
        ...
        then:
        resultDebug.assertTasksExecuted(':exe:compileMainDebugExecutableMainCpp', ':exe:linkMainDebugExecutable', ':exe:mainDebugExecutable', ':exe:installMainDebugExecutable', ':lib:compileHelloDebugSharedLibraryHelloCpp', ':lib:linkHelloDebugSharedLibrary', ':lib:helloDebugSharedLibrary')
        resultDebug.assertTasksNotSkipped(':exe:compileMainDebugExecutableMainCpp', ':exe:linkMainDebugExecutable', ':exe:mainDebugExecutable', ':exe:installMainDebugExecutable', ':lib:compileHelloDebugSharedLibraryHelloCpp', ':lib:linkHelloDebugSharedLibrary', ':lib:helloDebugSharedLibrary')
