...
public abstract class AbstractClassLoaderFactory implements ClassLoaderFactory {
    ...
    private ClassLoader createClassLoader(ClassLoader parent, Collection<URL> urls) {
    ...
    abstract protected ClassLoader doCreateClassLoader(ClassLoader parent, ClassPath classpath);

    abstract protected FilteringClassLoader doCreateFilteringClassLoader(ClassLoader parent, FilteringClassLoader.Spec spec);
