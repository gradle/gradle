 ...
 *
 * @deprecated This class is an internal API and will be removed in Gradle 9.0. To build artifacts during {@code assemble},
 *      add task dependencies directly on the {@code assemble} task.
 */
@Deprecated
