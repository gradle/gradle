...
public class DefaultLanguageRegistry implements LanguageRegistry {
    ...
    @Override
    public void add(LanguageRegistration<?> languageRegistration) {
        languageRegistrations.add(languageRegistration);
    }

    @Override
    public Iterator<LanguageRegistration<?>> iterator() {
        return languageRegistrations.iterator();
    }
}
