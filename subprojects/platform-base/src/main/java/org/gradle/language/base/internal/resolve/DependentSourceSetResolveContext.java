...
public abstract class DependentSourceSetResolveContext implements ResolveContext {
    ...
    public DependentSourceSetResolveContext(String projectPath, DependentSourceSetInternal sourceSet) {
