...
class BaseBinarySpecTest extends PlatformBaseSpecification {
    ...
    def "create fails if subtype does not have a public no-args constructor"() {
        ...
        e.cause.cause.message == "Unable to determine ${MyConstructedBinary.name} argument #1: missing parameter value of type class java.lang.String, or no service of type class java.lang.String"
    }
