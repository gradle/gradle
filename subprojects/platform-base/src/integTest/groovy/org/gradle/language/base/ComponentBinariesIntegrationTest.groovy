...
"""
        ...
        then:
        failure.assertHasCause("Exception thrown while executing model rule: binaries { ... } @ build.gradle line 55, column 5")
        failure.assertHasCause("Cannot create 'binaries.mylibMain' using creation rule 'mylibMain(CustomBinary) { ... } @ build.gradle line 56, column 9' as the rule 'ComponentModelBasePlugin.PluginRules#collectBinaries > put()' is already registered to create this model element.")
    }
