...
"""
        ...
        then:
        failure
            .assertHasDescription("Execution failed for task ':buildB:jar' (created by plugin 'org.gradle.java').")
...
"""
        ...
        then:
        failure
            .assertHasDescription("Execution failed for task ':buildC:jar' (created by plugin 'org.gradle.java').")
            .assertHasCause("jar task failed")
    }
...
"""
        ...
        failure.assertHasDescription("Execution failed for task ':buildB:b2:jar' (created by plugin 'org.gradle.java').")
