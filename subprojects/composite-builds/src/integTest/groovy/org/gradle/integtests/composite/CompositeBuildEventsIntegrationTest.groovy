...
"""
    ...
    def "fires build finished events for all builds when other builds fail"() {
        ...
        events(17)
        loggedOncePerBuild("buildListener.buildFinished failure=org.gradle.api.tasks.TaskExecutionException: Execution failed for task ':buildB:broken' (created in build file '../buildB/build.gradle').", [':buildB'])
        loggedOncePerBuild("gradle.buildFinished failure=org.gradle.api.tasks.TaskExecutionException: Execution failed for task ':buildB:broken' (created in build file '../buildB/build.gradle').", [':buildB'])
        ...
        // Root build also receives the failures from its children, including the buildFinished { } failures
        loggedOncePerBuild("buildListener.buildFinished failure=[org.gradle.api.tasks.TaskExecutionException: Execution failed for task ':buildB:broken' (created in build file '../buildB/build.gradle')., java.lang.RuntimeException: build B broken, java.lang.RuntimeException: build C broken]", [':'])
        loggedOncePerBuild("gradle.buildFinished failure=[org.gradle.api.tasks.TaskExecutionException: Execution failed for task ':buildB:broken' (created in build file '../buildB/build.gradle')., java.lang.RuntimeException: build B broken, java.lang.RuntimeException: build C broken]", [':'])

        failure.assertHasFailures(4)
        failure.assertHasDescription("Execution failed for task ':buildB:broken' (created in build file '../buildB/build.gradle').")
            .assertHasFileName("Build file '${buildB.buildFile}'")
