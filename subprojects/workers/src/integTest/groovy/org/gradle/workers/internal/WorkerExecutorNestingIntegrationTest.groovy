...
class WorkerExecutorNestingIntegrationTest extends AbstractWorkerExecutorIntegrationTest {
    ...
    def "workers with classpath isolation cannot spawn more work with #nestedIsolationMode"() {
        ...
        and:
        failure.assertHasCause("Unable to determine argument #1: value Hello World not assignable to type interface org.gradle.workers.WorkerExecutor, or no service of type interface org.gradle.workers.WorkerExecutor")
