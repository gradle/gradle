...
class SamplesJUnitTestSuiteIntegrationTest extends AbstractIntegrationTest {
    ...
    @Rule
    public final Sample sample = new Sample(testDirectoryProvider, 'testing/junit-test-suite-categories') // TODO duplicate and refactor
    ...
    @Test
    void categoriesSampleKotlin() {
        TestFile projectDir = sample.dir.file("kotlin")
