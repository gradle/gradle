...
class StringBuildOutcomeComparisonResult extends BuildOutcomeComparisonResultSupport<org.gradle.api.buildcomparison.outcome.string.StringBuildOutcome> {

    StringBuildOutcomeComparisonResult(BuildOutcomeAssociation<org.gradle.api.buildcomparison.outcome.string.StringBuildOutcome> compared) {
        super(compared)
    }
