...
public class DefaultIvyNormalizedPublication implements IvyNormalizedPublication {
    ...
    public DefaultIvyNormalizedPublication(String name, IvyPublicationIdentity projectIdentity, File ivyDescriptorFile, Set<IvyArtifact> allArtifacts) {
        this.name = name;
