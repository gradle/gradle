 ...
 *
 * An ivy publication is publishable by an {@link org.gradle.api.publish.ivy.tasks.IvyRepositoryPublish} task, that specifies the {@link org.gradle.api.artifacts.repositories.IvyArtifactRepository} to publish to.
 *
