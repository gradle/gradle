    ...
    public Collection<Result> readRequest(ExecutableElement method) {
        ...
        try {
            ...
            if (customAccessorsRequestReader.hasCustomAccessors(annotationMirror)) {
                return customAccessorsRequestReader.generateRequests(method, annotationMirror);
            } else {
                return autoGeneratedAccessorsRequestReader.getRequests(method, annotationMirror);
            }
