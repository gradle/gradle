...
class PropertyUpgradeAutoGeneratedAccessorsRequestReader {

    public List<CallInterceptionRequestReader.Result> readRequests(String propertyName, ExecutableElement input, AnnotationMirror annotation) {
        Type originalType = extractOriginalType(input, annotation);
        CallInterceptionRequest groovyPropertyRequest = createGroovyPropertyInterceptionRequest(propertyName, input, originalType);
        CallInterceptionRequest jvmGetterRequest = createJvmGetterInterceptionRequest(propertyName, input, originalType);
        CallInterceptionRequest jvmSetterRequest = createJvmSetterInterceptionRequest(propertyName, input, originalType);
    ...
    private static CallInterceptionRequest createGroovyPropertyInterceptionRequest(String propertyName, ExecutableElement method, Type originalType) {
        ...
        return new CallInterceptionRequestImpl(
            ...
            extractImplementationInfo(propertyName, method, originalType, "get", Collections.emptyList()),
            extras
        );
    }
    ...
    private static CallInterceptionRequest createJvmSetterInterceptionRequest(String propertyName, ExecutableElement method, Type originalType) {
        ...
        return new CallInterceptionRequestImpl(
            ...
            extractImplementationInfo(propertyName, method, returnType, "set", parameters),
            extras
        );
    }
    ...
    private static ImplementationInfoImpl extractImplementationInfo(String propertyName, ExecutableElement method, Type returnType, String methodPrefix, List<ParameterInfo> parameters) {
        ...
        String implementationName = "access_" + methodPrefix + "_" + propertyName;
