...
class BuildScanPerformanceTestRunner extends CrossBuildPerformanceTestRunner {
    ...
    BuildScanPerformanceTestRunner(PerformanceTestBuildExperimentRunner experimentRunner, DataReporter<CrossBuildPerformanceResults> dataReporter, String pluginCommitSha, IntegrationTestBuildContext buildContext) {
