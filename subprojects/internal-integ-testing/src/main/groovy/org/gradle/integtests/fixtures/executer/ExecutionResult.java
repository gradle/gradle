...
public interface ExecutionResult {
    ...
    /**
     * Asserts that this result includes the given error log message in the raw output (including ansi characters). Does not consider any text in or following the build result message (use {@link #assertHasPostBuildOutput(String)} instead).
     *
     * @param expectedOutput The expected log message, with line endings normalized to a newline character.
     */
    ...
    /**
     * Asserts that this result includes the given non-error log message (including ansi characters). Does not consider any text in or following the build result message (use {@link #assertHasPostBuildOutput(String)} instead).
     *
     * @param expectedOutput The expected log message, with line endings normalized to a newline character.
     */
