...
public class OutputScrapingExecutionResult implements ExecutionResult {
    ...
    private static final Pattern DEPRECATION_REPORT_PATTERN = Pattern.compile("Some deprecated APIs are used in this build, which may be broken in Gradle (\\d|\\.)+ See the detailed report at: file://(.*)$");
