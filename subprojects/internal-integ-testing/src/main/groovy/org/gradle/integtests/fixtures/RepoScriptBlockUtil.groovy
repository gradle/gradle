...
class RepoScriptBlockUtil {
    ...
    private static enum MirroredRepository {
        ...
        GRADLE('https://repo.gradle.org/artifactory/repo', System.getProperty('org.gradle.integtest.mirrors.gradle'), 'maven'),
        ...
        GRADLE_LIB_RELEASES('https://repo.gradle.org/artifactory/libs-releases', System.getProperty('org.gradle.integtest.mirrors.gradle'), 'maven'),
        GRADLE_LIB_MILESTONES('https://repo.gradle.org/artifactory/libs-milestones', System.getProperty('org.gradle.integtest.mirrors.gradle'), 'maven'),
        GRADLE_LIB_SNAPSHOTS('https://repo.gradle.org/artifactory/libs-snapshots', System.getProperty('org.gradle.integtest.mirrors.gradle'), 'maven'),
        GRADLE_JAVASCRIPT('https://repo.gradle.org/artifactory/javascript-public', System.getProperty('org.gradle.integtest.mirrors.gradlejavascript'), 'maven'),
