...
/**
 * Gives the sample tests double the normal memory, as they seem to be very resource intensive.
 *
 * //TODO find out why these tests need so much memory and fix it.
 */
