...
public class ResultAssertion implements Action<ExecutionResult> {
    private int expectedGenericDeprecationWarningsCount;
    ...
    public ResultAssertion(
        int expectedGenericDeprecationWarningsCount, List<String> expectedDeprecationWarnings,
        boolean expectStackTraces, boolean checkDeprecations, boolean checkJdkWarnings
    ) {
        this.expectedGenericDeprecationWarningsCount = expectedGenericDeprecationWarningsCount;
    ...
    public void execute(ExecutionResult executionResult) {
        ...
        if (expectedGenericDeprecationWarningsCount > 0) {
            throw new AssertionError(String.format("Expected %d more deprecation warnings", expectedGenericDeprecationWarningsCount));
        }
    }
