...
public abstract class EarPlugin implements Plugin<Project> {
    ...
    private void configureConfigurations(final ProjectInternal project) {
        ...
        Configuration deployConfiguration = configurations.migratingUnlocked(DEPLOY_CONFIGURATION_NAME, ConfigurationRolesForMigration.LEGACY_TO_RESOLVABLE_BUCKET)
            .setVisible(false)
            .setTransitive(false)
        ...
        Configuration earlibConfiguration = configurations.migratingUnlocked(EARLIB_CONFIGURATION_NAME, ConfigurationRolesForMigration.LEGACY_TO_RESOLVABLE_BUCKET)
            .setVisible(false)
