...
import org.gradle.plugins.ear.EarPluginExtension;
...
public class DefaultEarPluginExtension implements EarPluginExtension {
    ...
    public DefaultEarPluginExtension(ObjectFactory objectFactory) {
    ...
    public DefaultEarPluginExtension deploymentDescriptor(Closure configureClosure) {
        ConfigureUtil.configure(configureClosure, forceDeploymentDescriptor());
        return this;
    }

    @Override
    public DefaultEarPluginExtension deploymentDescriptor(Action<? super DeploymentDescriptor> configureAction) {
