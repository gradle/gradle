...
public class TestFiles {
    ...
    private static final DefaultExecActionFactory EXEC_FACTORY = DefaultExecActionFactory.of(resolver(), fileCollectionFactory(), objectFactory(), new DefaultExecutorFactory());
