...
import static org.gradle.util.TestUtil.*;
import static org.gradle.util.WrapUtil.toList;
import static org.hamcrest.Matchers.*;
import static org.junit.Assert.*;

@RunWith(JMock.class)
public abstract class AbstractTaskPlanExecutorTest {
    private final JUnit4Mockery context = new JUnit4GroovyMockery();
    protected final TaskArtifactStateCacheAccess taskArtifactStateCacheAccess = context.mock(TaskArtifactStateCacheAccess.class);
    protected DefaultTaskExecutionPlan taskExecutionPlan = new DefaultTaskExecutionPlan();
    protected AbstractTaskPlanExecutor taskPlanExecutor;
    protected DefaultProject root;
    protected DefaultProject sub1;
    protected DefaultProject sub2;
    protected List<Task> startedTasks = Collections.synchronizedList(new ArrayList<Task>());
    protected List<Task> completedTasks = Collections.synchronizedList(new ArrayList<Task>());
    protected ExecutorTestHelper helper;
    private ListenerBroadcast<TaskExecutionListener> taskListeners = new ListenerBroadcast<TaskExecutionListener>(TaskExecutionListener.class);

    protected void setUpBase() {
        root = createRootProject();
        sub1 = createChildProject(root, "sub1");
        sub2 = createChildProject(root, "sub2");
        helper = new ExecutorTestHelper(context, root, startedTasks, completedTasks);
    ...
    @Test
    public void testExecutesDependenciesInNameOrderWhenInSameProject() {
        Task a = helper.task("a");
    ...
    public void testExecutesTasksInASingleBatchInNameOrder() {
        ...
        assertThat(completedTasks, equalTo(toList(a, b, c)));
    }
    ...
    public void testExecutesBatchesInOrderAdded() {
        ...
        assertThat(completedTasks, equalTo(toList(b, c, a, d)));
    }
    ...
    public void testExecutesSharedDependenciesOfBatchesOnceOnly() {
        ...
        assertThat(completedTasks, equalTo(toList(a, b, c, d, e)));
    }
    ...
    public void testCanExecuteMultipleTimes() {
        ...
        addTasksToPlan(b);
        execute();
        assertThat(completedTasks, equalTo(toList(a, b)));
        ...
        process();
        assertThat(completedTasks, equalTo(toList(c)));
    }
    ...
    public void testNotifiesTaskListenerWhenTaskFails() {
        ...
        assertThat(completedTasks, equalTo(toList(a)));
    }
    ...
    protected void addTasksToPlan(Task... tasks) {
