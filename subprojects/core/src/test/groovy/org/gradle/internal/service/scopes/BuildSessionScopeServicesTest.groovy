...
class BuildSessionScopeServicesTest extends Specification {
    ...
    def "provides a BuildOperationWorkerRegistry"() {
        expect:
        registry.get(BuildOperationWorkerRegistry) instanceof DefaultWorkerManagementService
        registry.get(BuildOperationWorkerRegistry) == registry.get(BuildOperationWorkerRegistry)
    }

    def "provides a ProjectLockService"() {
        expect:
        registry.get(ProjectLockService) instanceof DefaultWorkerManagementService
