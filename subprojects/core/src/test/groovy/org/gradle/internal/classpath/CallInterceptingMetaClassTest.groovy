...
class CallInterceptingMetaClassTest extends Specification {
    ...
    def 'method invocation with #name on a metaClass is intercepted: #intercepted'() {
        ...
        "invokeMethod(sender, receiver, methodName, arguments, false, true)"  | { instance.metaClass.invokeMethod(getClass(), instance, "test", [].toArray(), false, true) }  | false       | GroovySystem.version.startsWith("3.")
