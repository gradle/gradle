...
package org.gradle.internal.file.physical.internal
...
@UsesNativeServices
class DefaultPhysicalSnapshotDirectoryWalkerTest extends Specification {
    @Rule
    public final TestNameTestDirectoryProvider tmpDir = new TestNameTestDirectoryProvider()

    def fileHasher = new TestFileHasher()
    def walker = new DefaultPhysicalSnapshotDirectoryWalker(fileHasher, TestFiles.fileSystem(), new StringInterner())
    ...
    private static PhysicalSnapshot walkDir(File dir, PatternSet patterns, DefaultPhysicalSnapshotDirectoryWalker walker) {
