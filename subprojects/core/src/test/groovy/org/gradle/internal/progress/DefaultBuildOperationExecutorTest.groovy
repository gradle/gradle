...
class DefaultBuildOperationExecutorTest extends ConcurrentSpec {
    ...
    def operationExecutor = new DefaultBuildOperationExecutor(listener, timeProvider, progressLoggerFactory, Mock(BuildOperationQueueFactory), Mock(ExecutorFactory), resourceLockCoordinator, 1)
