...
"""
    ...
    def "includes solutions of Java compilation problems as resolutions"() {
        ...
        def javaProblem = problems.internalReporter.create(groups.compilation.java.problem("Deprecated API used")) {
            it.details("Foo.java:3: warning: [deprecation] bar() in Foo has been deprecated")
            it.solution("Use baz() instead.")
        } as ProblemInternal
        def kotlinProblem = problems.internalReporter.create(groups.compilation.kotlin.problem("Unused import")) {
