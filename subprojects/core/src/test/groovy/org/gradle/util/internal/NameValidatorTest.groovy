...
class NameValidatorTest extends Specification {
    ...
    def domainObjectContainersWithValidation = [
        ...
        ["source sets", new DefaultSourceSetContainer(TestFiles.taskDependencyFactory(), null, TestUtil.instantiatorFactory().decorateLenient(), TestUtil.objectFactory(), CollectionCallbackActionDecorator.NOOP)]
    ]
