...
class DefaultPolymorphicNamedDomainObjectContainerDslTest extends Specification {
    ...
    def container = instantiator.newInstance(DefaultPolymorphicNamedDomainObjectContainer, Person, instantiator)
