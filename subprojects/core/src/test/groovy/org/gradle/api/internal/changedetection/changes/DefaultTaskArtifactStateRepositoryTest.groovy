...
class DefaultTaskArtifactStateRepositoryTest extends AbstractProjectBuilderSpec {
    ...
    def setup() {
        ...
        FileCollectionSnapshotter inputFileCollectionFingerprinter = new DefaultAbsolutePathInputNormalizer(stringInterner, TestFiles.directoryFileTreeFactory(), new DefaultFileSystemSnapshotter(fileHasher, stringInterner, TestFiles.fileSystem(), TestFiles.directoryFileTreeFactory(), fileSystemMirror))
        FileCollectionSnapshotter outputFileCollectionFingerprinter = new DefaultOutputNormalizer(stringInterner, TestFiles.directoryFileTreeFactory(), new DefaultFileSystemSnapshotter(fileHasher, stringInterner, TestFiles.fileSystem(), TestFiles.directoryFileTreeFactory(), fileSystemMirror))
        ...
        def snapshotterRegistry = new DefaultFileCollectionSnapshotterRegistry([inputFileCollectionFingerprinter, outputFileCollectionFingerprinter])
