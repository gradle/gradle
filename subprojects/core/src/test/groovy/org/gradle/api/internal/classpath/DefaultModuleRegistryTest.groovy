...
class DefaultModuleRegistryTest extends Specification {
    ...
    def "locates module using manifest from runtime ClassLoader when run from IDEA with a project generated by Gradle"() {
        given:
    ...
    def "does not add wrong resources dirs to classpath of 'gradle-resources' module"() {
        ...
        def cpFiles = module.implementationClasspath.asFiles
