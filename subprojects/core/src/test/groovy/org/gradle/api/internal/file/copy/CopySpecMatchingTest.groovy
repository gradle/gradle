...
class CopySpecMatchingTest extends Specification {
    ...
    DefaultCopySpec copySpec = new DefaultCopySpec(TestFiles.fileCollectionFactory(), TestUtil.propertyFactory(), TestFiles.filePropertyFactory(), TestUtil.instantiatorFactory().decorateLenient(), TestFiles.patternSetFactory)
    ...
    def matchingSpecInherited() {
        given:
        DefaultCopySpec childSpec = new DefaultCopySpec(TestFiles.fileCollectionFactory(), TestUtil.propertyFactory(), TestFiles.filePropertyFactory(), TestUtil.instantiatorFactory().decorateLenient(), TestFiles.patternSetFactory)
