...
class DefaultConfigurableFileTreeTest extends AbstractTestForPatternSet {
    ...
    @Before public void setUp() {
        super.setUp()
        fileSet = new DefaultConfigurableFileTree(testDir, fileResolverStub, taskResolverStub, instantiator, fileCopier)
    }
    ...
    @Test public void testFileSetConstructionFromMap() {
        fileSet = new DefaultConfigurableFileTree(fileResolverStub, taskResolverStub, dir: testDir, includes: ['include'], instantiator, fileCopier)
        assertEquals(testDir, fileSet.dir)
    ...
    @Test(expected = InvalidUserDataException) public void testFileSetConstructionWithNoBaseDirSpecified() {
        DefaultConfigurableFileTree fileSet = new DefaultConfigurableFileTree([:], fileResolverStub, taskResolverStub, instantiator, fileCopier)
        fileSet.contains(new File('unknown'))
    }

    @Test public void testFileSetConstructionWithBaseDirAsString() {
        DefaultConfigurableFileTree fileSet = new DefaultConfigurableFileTree(fileResolverStub, taskResolverStub, dir: 'dirname', instantiator, fileCopier)
