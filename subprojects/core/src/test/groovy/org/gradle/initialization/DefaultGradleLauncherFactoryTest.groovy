...
class DefaultGradleLauncherFactoryTest extends Specification {
    ...
    final def sessionServices = new BuildSessionScopeServices(userHomeServices, startParameter, new DefaultBuildRequestMetaData(Time.systemWallClock().currentTime), ClassPath.EMPTY)
