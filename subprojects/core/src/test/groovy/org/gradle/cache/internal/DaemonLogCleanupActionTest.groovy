...
class DaemonLogCleanupActionTest extends Specification {
    ...
    private File getCleanupMarkerFile(File versionDir) {
        return new File(versionDir, "daemon-cleanup.properties")
    }
    ...
    private long fifteenDaysAgo() {
        System.currentTimeMillis() - TimeUnit.DAYS.toMillis(15)
    }

    private long sixteenDaysAgo() {
        System.currentTimeMillis() - TimeUnit.DAYS.toMillis(16)
    }

    private long twentyDaysAgo() {
        System.currentTimeMillis() - TimeUnit.DAYS.toMillis(20)
    }

    private long exactlyNDaysAgo(long days) {
