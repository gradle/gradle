...
import org.gradle.cache.internal.scopes.DefaultGlobalScopedCacheFactory
...
class DefaultFileContentCacheFactoryTest extends Specification {
    ...
    def globalScopedCache = new DefaultGlobalScopedCacheFactory(cachesDir, cacheRepository)
