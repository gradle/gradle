...
class BuildOperationScriptPluginTest extends Specification {
    ...
    def buildOperationScriptPlugin = new BuildOperationScriptPlugin(decoratedScriptPlugin, buildOperationRunner, userCodeApplicationContext, new PropertyProvenanceRegistry(false, userCodeApplicationContext), true)
