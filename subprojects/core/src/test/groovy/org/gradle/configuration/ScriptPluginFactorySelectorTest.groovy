...
class ScriptPluginFactorySelectorTest extends Specification {
    ...
    def selector = new ScriptPluginFactorySelector(defaultScriptPluginFactory, providerInstantiator, new TestBuildOperationRunner(), new TestUserCodeApplicationContext(), remoteScriptListener)
