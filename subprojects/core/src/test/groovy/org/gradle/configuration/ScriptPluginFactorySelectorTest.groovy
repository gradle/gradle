...
class ScriptPluginFactorySelectorTest extends Specification {
    ...
    def selector = new ScriptPluginFactorySelector(defaultScriptPluginFactory, providerInstantiator, new TestBuildOperationExecutor(), new TestUserCodeApplicationContext())
