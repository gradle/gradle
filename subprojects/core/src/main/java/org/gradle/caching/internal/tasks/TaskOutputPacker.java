...
public interface TaskOutputPacker {
    ...
    PackResult pack(SortedSet<ResolvedTaskOutputFilePropertySpec> propertySpecs, Map<String, FileCollectionFingerprint> outputSnapshots, OutputStream output, TaskOutputOriginWriter writeOrigin) throws IOException;
