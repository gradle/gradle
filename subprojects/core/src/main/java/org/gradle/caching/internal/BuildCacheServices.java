            ...
            OriginMetadataFactory createOriginMetadataFactory(BuildInvocationScopeId buildInvocationScopeId) {
                return new OriginMetadataFactory(
                        ...
                        properties -> properties.setProperty(
                                GRADLE_VERSION_KEY, GradleVersion.current().getVersion()));
            }
        });
    }
        ...
        registration.addProvider(new ServiceRegistrationProvider() {
            ...
            BuildCacheConfigurationInternal createBuildCacheConfiguration(
                ...
                return instantiator.newInstance(
                        DefaultBuildCacheConfiguration.class, buildScopedInstantiator, allBuildCacheServiceFactories);
            }
            ...
            BuildCacheServiceRegistration createDirectoryBuildCacheServiceRegistration() {
                return new DefaultBuildCacheServiceRegistration(
                        DirectoryBuildCache.class, DirectoryBuildCacheServiceFactory.class);
            }
            ...
            BuildCacheEntryPacker createResultPacker(
                ...
                return new GZipBuildCacheEntryPacker(new TarBuildCacheEntryPacker(
                        fileSystemSupport,
                        new FilePermissionsAccessAdapter(fileSystem),
                        fileHasher,
                        stringInterner,
                        bufferProvider));
            }
            ...
            LifecycleAwareBuildCacheController createBuildCacheController(
                ...
                if (build instanceof RootBuildState) {
                    return rootControllerRef.createForRootBuild(
                            build.getIdentityPath(), buildCacheControllerFactory, injectingGenerator);
                } else {
                    return rootControllerRef.createForNonRootBuild(
                            build.getIdentityPath(), buildCacheControllerFactory, injectingGenerator);
                }
            }
