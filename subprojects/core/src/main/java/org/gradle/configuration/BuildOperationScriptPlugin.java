...
public class BuildOperationScriptPlugin implements ScriptPlugin {
    ...
    public BuildOperationScriptPlugin(
            ScriptPlugin decorated,
    ...
    public void apply(final Object target) {
        ...
        if (resource.isContentCached() && resource.getHasEmptyContent()) {
            ...
            userCodeApplicationContext.apply(
                    source,
                    userCodeApplicationId -> buildOperationRunner.run(new RunnableBuildOperation() {
                        @Override
                        ...
                        public BuildOperationDescriptor.Builder description() {
                            ...
                            final ResourceLocation resourceLocation =
                                    source.getResource().getLocation();
                            ...
                            return BuildOperationDescriptor.displayName(displayName)
                                    ...
                                    .details(new OperationDetails(
                                            file,
                                            resourceLocation,
                                            ConfigurationTargetIdentifier.of(target),
                                            userCodeApplicationId));
                        }
                    }));
        }
    }
    ...
    private static class OperationDetails implements ApplyScriptPluginBuildOperationType.Details {
        ...
        private OperationDetails(
                ...
                @Nullable ConfigurationTargetIdentifier identifier,
    ...
    private static final ApplyScriptPluginBuildOperationType.Result OPERATION_RESULT =
            new ApplyScriptPluginBuildOperationType.Result() {};
}
