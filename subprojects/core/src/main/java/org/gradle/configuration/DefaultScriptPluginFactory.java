...
public class DefaultScriptPluginFactory implements ScriptPluginFactory {
    ...
    private class ScriptPluginImpl implements ScriptPlugin {
        ...
        public void apply(final Object target) {
            ...
            ScriptRunner<? extends BasicScript, ?> initialRunner = compiler.compile(target, scriptType, initialOperation, baseScope, Actions.doNothing());
            ...
            final ScriptRunner<? extends BasicScript, BuildScriptData> runner = compiler.compile(target, scriptType, operation, targetScope, ClosureCreationInterceptingVerifier.INSTANCE);
