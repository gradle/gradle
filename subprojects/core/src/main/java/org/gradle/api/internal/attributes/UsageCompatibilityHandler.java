...
public class UsageCompatibilityHandler {
    ...
    @Deprecated
    public <T> ImmutableAttributes doConcat(
            AttributesFactory factory, ImmutableAttributes node, Attribute<T> key, Isolatable<T> value) {
        assert key.getName().equals(Usage.USAGE_ATTRIBUTE.getName())
                : "Should only be invoked for 'org.gradle.usage', got '" + key.getName() + "'";
        ...
        if (value instanceof CoercingStringValueSnapshot) {
            ...
            Isolatable<String> coercingStringValueSnapshot =
                    new CoercingStringValueSnapshot(replacementUsage, instantiator);
            ...
            return factory.concat(
                    ...
                    new CoercingStringValueSnapshot(libraryElements, instantiator));
        } else {
            ...
            return factory.concat(
                    ...
                    isolatableFactory.isolate(instantiator.named(LibraryElements.class, libraryElements)));
        }
    }
