...
public interface CopySpec extends CopySourceSpec, CopyProcessingSpec, PatternFilterable {
     ...
     */
    @Incubating
    CopySpec filesMatching(String[] patterns, Action<? super FileCopyDetails> action);
     ...
     */
    @Incubating
    CopySpec filesNotMatching(String[] patterns, Action<? super FileCopyDetails> action);
