...
public class DependencyClassPathProvider implements ClassPathProvider {
    ...
    private ClassPath initGradleApi() {
        ...
        for (String moduleName : Arrays.asList("gradle-worker-processes", "gradle-core", "gradle-workers", "gradle-dependency-management", "gradle-plugin-use", "gradle-tooling-api", "gradle-build-events")) {
