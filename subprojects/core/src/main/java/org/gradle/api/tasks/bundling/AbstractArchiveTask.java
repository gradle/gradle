...
public abstract class AbstractArchiveTask extends AbstractCopyTask {
    ...
    public void setArchiveName(String name) {
        DeprecationLogger.deprecateProperty("archiveName").replaceWith("archiveFileName").withDslReferenceForProperty(AbstractArchiveTask.class).nagUser();
    ...
    public File getDestinationDir() {
        DeprecationLogger.deprecateProperty("destinationDir").replaceWith("destinationDirectory").withDslReferenceForProperty(AbstractArchiveTask.class).nagUser();
    ...
    public String getBaseName() {
        DeprecationLogger.deprecateProperty("baseName").replaceWith("archiveBaseName").withDslReferenceForProperty(AbstractArchiveTask.class).nagUser();
    ...
    public String getAppendix() {
        DeprecationLogger.deprecateProperty("appendix").replaceWith("archiveAppendix").withDslReferenceForProperty(AbstractArchiveTask.class).nagUser();
    ...
    public String getVersion() {
        DeprecationLogger.deprecateProperty("version").replaceWith("archiveVersion").withDslReferenceForProperty(AbstractArchiveTask.class).nagUser();
    ...
    public String getExtension() {
        DeprecationLogger.deprecateProperty("extension").replaceWith("archiveExtension").withDslReferenceForProperty(AbstractArchiveTask.class).nagUser();
    ...
    public String getClassifier() {
        DeprecationLogger.deprecateProperty("classifier").replaceWith("archiveClassifier").withDslReferenceForProperty(AbstractArchiveTask.class).nagUser();
    ...
    public void setClassifier(@Nullable String classifier) {
        // This is used by the Kotlin plugin, we should upstream a fix to avoid this API first.
        // DeprecationLogger.deprecateProperty("classifier").replaceWith("archiveClassifier").withDslReference(AbstractArchiveTask.class).nagUser();
