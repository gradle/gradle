...
public abstract class RuntimeBeanNode<T> extends AbstractPropertyNode<Object> {
    ...
    public abstract void visitNode(PropertyVisitor visitor, Queue<RuntimeBeanNode<?>> queue, RuntimeBeanNodeFactory nodeFactory, WorkValidationContext validationContext);
