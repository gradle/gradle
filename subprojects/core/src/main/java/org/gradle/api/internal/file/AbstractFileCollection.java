...
public abstract class AbstractFileCollection implements FileCollectionInternal {
    ...
    @Override
    public TaskDependency getBuildDependencies() {
        DeprecationLogger.nagUserOfDiscontinuedMethod("AbstractFileCollection.getBuildDependencies()", "Do not extend AbstractFileCollection, use ProjectLayout.filesFor() instead.");
