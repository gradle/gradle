...
public class OutputFilePropertyAnnotationHandler extends AbstractOutputPropertyAnnotationHandler {
    ...
    @Override
    protected DeclaredTaskOutputFileProperty createFileSpec(ValidatingValue value, PropertySpecFactory specFactory) {
        return specFactory.createOutputFileSpec(value);
    }
}
