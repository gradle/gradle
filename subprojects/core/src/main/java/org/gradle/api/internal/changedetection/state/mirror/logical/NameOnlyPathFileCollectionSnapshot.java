...
public class NameOnlyPathFileCollectionSnapshot extends RootHoldingFileCollectionSnapshot {
    ...
    public NameOnlyPathFileCollectionSnapshot(ListMultimap<String, LogicalSnapshot> roots) {
        super(roots);
    }

    public NameOnlyPathFileCollectionSnapshot(Map<String, NormalizedFileSnapshot> snapshots, @Nullable HashCode hashCode) {
        super(hashCode);
    ...
    public static class SerializerImpl implements Serializer<NameOnlyPathFileCollectionSnapshot> {
        ...
        @Override
        public NameOnlyPathFileCollectionSnapshot read(Decoder decoder) throws IOException {
            ...
            return new NameOnlyPathFileCollectionSnapshot(snapshots, hash);
        }

        @Override
        public void write(Encoder encoder, NameOnlyPathFileCollectionSnapshot value) throws Exception {
        ...
        public boolean equals(Object obj) {
            ...
            NameOnlyPathFileCollectionSnapshot.SerializerImpl rhs = (NameOnlyPathFileCollectionSnapshot.SerializerImpl) obj;
