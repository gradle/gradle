...
public class ProjectFactory implements IProjectFactory {
    ...
    public ProjectInternal createProject(
        ...
        File buildFile =
                scriptResolution.resolveScriptsForProject(owner.getIdentity(), projectDescriptor::getBuildFile);
        ...
        project.beforeEvaluate(p -> {
            NameValidator.validate(
                    project.getName(), "project name", DefaultProjectDescriptor.INVALID_NAME_IN_INCLUDE_HINT);
