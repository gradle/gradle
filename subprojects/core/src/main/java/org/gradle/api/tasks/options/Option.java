...
public @interface Option {
    ...
    /**
     * The description of the autogenerated opposite option for boolean options.
     * When not provided, a generic description is used.
     *
     * @return The opposite option description.
     * @since 9.0
     */
    String oppositeDescription() default "";
}
