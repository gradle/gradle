...
public class DefaultProject extends AbstractPluginAware implements ProjectInternal, DynamicObjectAware,
    ...
    protected DefaultObjectConfigurationAction createObjectConfigurationAction() {
        return new DefaultObjectConfigurationAction(getFileResolver(), getScriptPluginFactory(), getScriptHandlerFactory(), getBaseClassLoaderScope(), getUrlResourceLoaderFactory(), this);
    }

    @Inject
    protected TextUrlResourceLoader.Factory getUrlResourceLoaderFactory() {
        throw new UnsupportedOperationException();
    }
