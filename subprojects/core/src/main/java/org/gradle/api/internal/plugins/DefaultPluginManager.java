...
public class DefaultPluginManager implements PluginManagerInternal {
    ...
    public DefaultPluginManager(final PluginRegistry pluginRegistry, Instantiator instantiator, final PluginTarget target, BuildOperationExecutor buildOperationExecutor, UserCodeApplicationContext userCodeApplicationContext, DomainObjectCollectionCallbackDecorator domainObjectCollectionCallbackDecorator) {
        this.instantiator = instantiator;
        this.target = target;
        this.pluginRegistry = pluginRegistry;
        this.pluginContainer = new DefaultPluginContainer(pluginRegistry, this, domainObjectCollectionCallbackDecorator);
    ...
    public DomainObjectSet<PluginWithId> pluginsForId(String id) {
        ...
        if (pluginsForId == null) {
            pluginsForId = new DefaultDomainObjectSet<PluginWithId>(PluginWithId.class, domainObjectCollectionCallbackDecorator);
