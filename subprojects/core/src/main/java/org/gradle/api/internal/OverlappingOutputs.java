...
public class OverlappingOutputs {
    ...
    @Nullable
    public static OverlappingOutputs detect(String propertyName, HistoricalFileCollectionFingerprint previousExecution, FileCollectionSnapshot beforeExecution) {
