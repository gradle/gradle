...
public class TaskIdentityFactory {
    ...
    public <T extends Task> TaskIdentity<T> create(String name, Class<T> type, ProjectInternal project, UserCodeSource userCodeSource) {
        ...
        return doCreate(name, type, project, id, userCodeSource);
    }
    ...
    public <T extends Task> TaskIdentity<T> recreate(String name, Class<T> type, ProjectInternal project, long uniqueId, UserCodeSource userCodeSource) {
        ...
        return doCreate(name, type, project, uniqueId, userCodeSource);
    }

    private static <T extends Task> TaskIdentity<T> doCreate(String name, Class<T> type, ProjectInternal project, long uniqueId, UserCodeSource userCodeSource) {
