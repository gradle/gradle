...
public class DefaultProjectWrapperRegistry implements ProjectWrapperRegistry, HoldsProjectState {
    ...
    @Override
    public void register(ProjectInternal delegate, ProjectInternal wrapper) {
        List<ProjectInternal> wrappers = projectWrappers.computeIfAbsent(
            delegate.getProjectIdentity(),
