...
public class RuntimeClasspathResourceSnapshotterFactory implements ResourceSnapshotterFactory<RuntimeClasspath> {
    private final StringInterner stringInterner;
    private final PersistentIndexedCache<HashCode, HashCode> cache;

    public RuntimeClasspathResourceSnapshotterFactory(StringInterner stringInterner, PersistentIndexedCache<HashCode, HashCode> cache) {
