...
public class BuildOperationWrappingTaskExecuter implements TaskExecuter {

    private final BuildOperationExecutor buildOperationExecutor;
    private final TaskExecuter delegate;

    public BuildOperationWrappingTaskExecuter(BuildOperationExecutor buildOperationExecutor, TaskExecuter delegate) {
