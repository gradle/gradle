...
public abstract class Zip extends AbstractArchiveTask {
    ...
    protected CopyAction createCopyAction() {
        ...
        return new ZipCopyAction(getArchiveFile().get().getAsFile(), getCompressor(), documentationRegistry, metadataCharset, getPreserveFileTimestamps().get(), getReproducibleFileTimestamp());
    }
