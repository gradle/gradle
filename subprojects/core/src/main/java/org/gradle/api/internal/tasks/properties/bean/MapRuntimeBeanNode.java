...
class MapRuntimeBeanNode extends RuntimeBeanNode<Map<?, ?>> {
    public MapRuntimeBeanNode(RuntimeBeanNode<?> parentNode, String propertyName, Map<?, ?> map, TypePropertyMetadata typePropertyMetadata) {
        super(parentNode, propertyName, map, typePropertyMetadata);
    }
