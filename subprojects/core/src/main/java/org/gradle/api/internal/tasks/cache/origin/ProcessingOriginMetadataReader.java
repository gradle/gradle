...
public abstract class ProcessingOriginMetadataReader implements OriginMetadataReader {
    @Override
    public void readFrom(InputStream inputStream) throws IOException {
        ...
        processMetadata(originMetadata);
    }

    protected abstract void processMetadata(OriginMetadata originMetadata);
