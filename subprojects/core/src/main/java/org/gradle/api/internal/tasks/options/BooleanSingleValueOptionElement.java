...
/**
 * A flag, takes one Boolean argument.
 */
public class BooleanSingleValueOptionElement extends AbstractOptionElement {
    private final PropertySetter setter;

    private final NotationParser<CharSequence, ?> notationParser;

    public BooleanSingleValueOptionElement(String optionName, Option option, PropertySetter setter, OptionValueNotationParserFactory notationParserFactory) {
