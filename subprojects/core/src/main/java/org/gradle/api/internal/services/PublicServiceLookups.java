...
/**
 * Validates and performs lookups of the services that Gradle exposes via {@code Project.service(Class)},
...
public final class PublicServiceLookups {
    ...
    public enum EntryPoint {
        PROJECT("project scripts and project plugins"),
        TASK("tasks"),
        SETTINGS("settings scripts and settings plugins");
     ...
     *
     * <p>The marker interfaces ({@code ProjectService}, {@code TaskService}, {@code SettingsService}) are only a compile-time
