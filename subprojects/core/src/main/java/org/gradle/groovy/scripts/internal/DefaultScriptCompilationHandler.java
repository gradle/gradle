...
public class DefaultScriptCompilationHandler implements ScriptCompilationHandler {
    ...
    private void wrapCompilationFailure(ScriptSource source, MultipleCompilationErrorsException e) {
        ...
        throw ((InternalProblems) getProblemsService()).getInternalReporter().throwing(
            new ScriptCompilationException(message, e, source, lineNumber),
            IdFactory.instance().createProblemId(TextUtil.screamingSnakeToKebabCase("compilation-failed"), "Groovy DSL script compilation problem", GradleCoreProblemGroup.compilation().groovyDsl()),
            spec -> spec
