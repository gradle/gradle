...
public interface ScriptCompiler {
     ...
     */
    <T extends Script, M> ScriptRunner<T, M> compile(Object target, Class<T> scriptType, CompileOperation<M> extractingTransformer, ClassLoaderScope targetScope, Action<? super ClassNode> verifier);
}
