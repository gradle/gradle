...
public class DefaultWorkerProcessBuilder implements WorkerProcessBuilder {
    ...
    public WorkerProcess build() {
        ...
        // TODO(ew): alternative to passing build operation id with each event:
        //      change behavior on each request, when you perform this request, wrap with behavior that sets build operation id
            //  stop setting build operation id on completion of request
        // TODO(ew): ask Gary or Paul how this might be achieved
            ...
            public void execute(final ObjectConnection connection) {
                workerProcess.onConnect(connection, new Runnable() {
                    ...
                    public void run() {
                        ...
                        // TODO(EW): NOTE: Output event listener comes from BuildSessionScopeServices
