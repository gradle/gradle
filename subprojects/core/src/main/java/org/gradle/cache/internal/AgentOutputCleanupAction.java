...
public class AgentOutputCleanupAction implements MonitoredCleanupAction {
    ...
    private static final int MAX_UNUSED_DAYS_FOR_AGENT_OUTPUT = 7;
    ...
    public AgentOutputCleanupAction(File projectCacheDir, Deleter deleter, CleanupFrequency cleanupFrequency) {
        this.projectCacheDir = projectCacheDir;
        this.removeUnusedEntriesOlderThan = TimestampSuppliers.daysAgo(MAX_UNUSED_DAYS_FOR_AGENT_OUTPUT);
