...
public class ReadOnlyFileTreeElement implements FileTreeElement {
    private final File file;
    private final RelativePath relativePath;
    private final Stat stat;

    private ReadOnlyFileTreeElement(File file, RelativePath relativePath, Stat stat) {
        this.file = file;
        this.relativePath = relativePath;
        this.stat = stat;
    }

    public static boolean relativePathMatchesSpec(Spec<FileTreeElement> filter, File element, String relativePathString, Stat stat) {
