...
public interface IntermediateToolingModelProvider {
     ...
     */
    default <T> List<T> getModels(
            ProjectState requester, List<ProjectState> targets, Class<T> modelType, @Nullable Object parameter) {
     ...
     */
    <P extends Plugin<Project>> void applyPlugin(
