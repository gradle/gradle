...
import org.gradle.internal.fingerprint.LineEndingSensitiveNormalizer;
...
public class DefaultFileNormalizationSpec implements FileNormalizationSpec {
    ...
    public static FileNormalizationSpec from(Class<? extends FileNormalizer> normalizer, DirectorySensitivity directorySensitivity, LineEndingNormalization lineEndingNormalization) {
        DirectorySensitivity effectiveDirectorySensitivity = DirectorySensitiveNormalizer.class.isAssignableFrom(normalizer) ? directorySensitivity : DirectorySensitivity.DEFAULT;
        LineEndingNormalization effectiveLineEndingNormalization = LineEndingSensitiveNormalizer.class.isAssignableFrom(normalizer) ? lineEndingNormalization : LineEndingNormalization.DEFAULT;
        return new DefaultFileNormalizationSpec(normalizer, effectiveDirectorySensitivity, effectiveLineEndingNormalization);
    }
