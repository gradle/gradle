...
package org.gradle.internal.classpath.declarations.stubs;
...
public class PropertyUpgradesInterceptorsStub {
    /**
     ...
     */
    @InterceptCalls
    @CallableKind.StaticMethod(ofClass = PropertyUpgradesInterceptorsStub.class)
    @CallableDefinition.Name("emptyStubToEnsureClassGenerationForPropertyUpgrades")
