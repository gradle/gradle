...
import org.gradle.internal.file.fingerprint.fingerprinter.FingerprintingStrategy;
...
public class DefaultFileCollectionFingerprint implements FileCollectionFingerprint {
    ...
    @Override
    public boolean visitChangesSince(FileCollectionFingerprint oldSnapshot, String title, boolean includeAdded, TaskStateChangeVisitor visitor) {
