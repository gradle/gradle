...
class PersistentScopeIdStoreFactory {
    ...
    ObjectCache<UniqueId> create(File file, String description) {
        return new FileIntegrityViolationSuppressingObjectCacheDecorator<UniqueId>(
            new FileBackedObjectCache<UniqueId>(
                file,
