...
public interface FingerprintingStrategy {
    ...
    /**
     * Converts the roots into the {@link FileFingerprint}s used by the {@link FileCollectionFingerprint}.
     */
    Map<String, FileFingerprint> collectFingerprints(Iterable<FileSystemSnapshot> roots);
