...
class BuildScanPluginCompatibilityEnforcer {
    ...
    private static final VersionNumber MAX_UNSUPPORTED_VERSION = VersionNumber.parse("1.7.1");
    private static final VersionNumber MIN_SUPPORTED_VERSION = VersionNumber.parse("1.7.2");
