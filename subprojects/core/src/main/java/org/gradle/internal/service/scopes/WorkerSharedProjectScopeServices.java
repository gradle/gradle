...
public class WorkerSharedProjectScopeServices {
    ...
    protected ProjectScopedCache createProjectScopedCache(TemporaryFileProvider temporaryFileProvider, ScopedCacheBuilderFactory scopedCacheBuilderFactory) {
        return new DefaultProjectScopedCacheBuilderFactory(temporaryFileProvider.newTemporaryFile(".cache"), scopedCacheBuilderFactory);
    }

    protected DecompressionCacheFactory createDecompressionCacheFactory(TemporaryFileProvider temporaryFileProvider, ScopedCacheBuilderFactory scopedCacheBuilderFactory) {
        return new DefaultDecompressionCacheFactory(() -> new DefaultProjectScopedCacheBuilderFactory(temporaryFileProvider.newTemporaryFile(".cache"), scopedCacheBuilderFactory));
    }
}
