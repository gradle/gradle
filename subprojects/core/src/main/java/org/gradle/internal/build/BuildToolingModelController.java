...
public interface BuildToolingModelController {
    ...
    ToolingModelScope locateBuilderForTarget(ToolingModelContext toolingModelContext);

    ToolingModelScope locateBuilderForTarget(ProjectState target, ToolingModelContext toolingModelContext);
}
