...
public interface InstrumentedClosuresTracker {
    ...
    static void enterInstrumentedClosure(InstrumentableClosure thisClosure) {
        INSTANCE.enterClosure(thisClosure);
    }

    @SuppressWarnings("unused") // call sites generated by instrumentation in `CallInterceptionClosureInstrumentingClassVisitor`
    static void leaveInstrumentedClosure(InstrumentableClosure thisClosure) {
        INSTANCE.leaveClosure(thisClosure);
    }

    InstrumentedClosuresTracker INSTANCE = new PerThreadInstrumentedClosuresTracker(DefaultInstrumentedClosuresTracker::new);
}
