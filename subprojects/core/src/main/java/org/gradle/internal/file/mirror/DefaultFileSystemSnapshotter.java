...
import org.gradle.internal.file.physical.FilteredPhysicalSnapshot;
...
import org.gradle.internal.file.physical.PhysicalSnapshotDirectoryWalker;
import org.gradle.internal.file.physical.internal.DefaultPhysicalSnapshotDirectoryWalker;
...
public class DefaultFileSystemSnapshotter implements FileSystemSnapshotter {
    ...
    private PhysicalSnapshot snapshotAndCache(DirectoryFileTree directoryTree) {
        ...
        PhysicalSnapshot visitableDirectoryTree = directoryWalker.walk(fileSnapshot);
    ...
    private PhysicalSnapshot snapshotWithoutCaching(DirectoryFileTree directoryTree) {
        return directoryWalker.walk(snapshotSelf(directoryTree.getDir()), directoryTree.getPatterns());
    }
