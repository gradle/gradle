...
public class DefaultPhysicalSnapshotDirectoryWalker implements PhysicalSnapshotDirectoryWalker {
    private final FileHasher hasher;
    private final FileSystem fileSystem;
    private final StringInterner stringInterner;

    public DefaultPhysicalSnapshotDirectoryWalker(FileHasher hasher, FileSystem fileSystem, StringInterner stringInterner) {
        this.hasher = hasher;
