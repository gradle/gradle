...
public class GradleCoreInstrumentationTypeRegistry implements InstrumentationTypeRegistry {
    ...
    private Map<String, Set<String>> loadInstrumentedSuperTypes() {
        try (InputStream stream =
                GradleCoreInstrumentationTypeRegistry.class.getResourceAsStream(INSTRUMENTED_SUPER_TYPES_FILE)) {
            if (stream == null) {
            ...
            properties.forEach((k, v) ->
                    builder.put((String) k, ImmutableSet.copyOf(v.toString().split(","))));
