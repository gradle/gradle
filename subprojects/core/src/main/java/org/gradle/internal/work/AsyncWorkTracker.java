...
public interface AsyncWorkTracker {
     ...
     * @throws IllegalStateException when new work is submitted for an operation while another thread is waiting in {@code waitForCompletion(BuildOperationRef, boolean)} for the same operation.
     */
