...
public class DefaultRelativePathFileCollectionFingerprinter extends AbstractPathOnlyFileCollectionFingerprinter implements RelativePathFileCollectionFingerprinter {

    public DefaultRelativePathFileCollectionFingerprinter(StringInterner stringInterner, DirectoryFileTreeFactory directoryFileTreeFactory, FileSystemSnapshotter fileSystemSnapshotter) {
