...
public class BuildSessionScopeServices extends DefaultServiceRegistry {
    ...
    BuildOperationProcessor createBuildOperationProcessor(WorkerLeaseRegistry workerLeaseRegistry, BuildOperationExecutor buildOperationExecutor, StartParameter startParameter, ExecutorFactory executorFactory) {
        return new DefaultBuildOperationProcessor(workerLeaseRegistry, buildOperationExecutor, new DefaultBuildOperationQueueFactory(), executorFactory, startParameter.getMaxWorkerCount());
    }
