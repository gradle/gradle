...
import org.gradle.internal.file.content.hasher.RegularFileHasher;
import org.gradle.internal.file.content.hasher.ResourceHasher;
import org.gradle.internal.file.fingerprint.fingerprinter.NormalizedPathFingerprintCompareStrategy;
    ...
    private List<NormalizedFileSnapshot> snapshotZipEntries(String jarFile) throws IOException {
        ...
        try {
            ...
            while ((zipEntry = zipInput.getNextEntry()) != null) {
                ...
                if (hash != null) {
                    snapshots.add(new DefaultNormalizedFileSnapshot(zipEntry.getName(), new FileHashSnapshot(hash)));
                }
            }
