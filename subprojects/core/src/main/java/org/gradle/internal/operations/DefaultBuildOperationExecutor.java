...
public class DefaultBuildOperationExecutor implements BuildOperationExecutor, Stoppable {
    ...
    private static class DefaultBuildOperationExecutionContext implements BuildOperationExecutionContext {

        private final ManagedExecutor executor;
        private final int maxConcurrency;
        private final boolean requiresWorkerLease;

        private DefaultBuildOperationExecutionContext(ManagedExecutor executor, int maxConcurrency, boolean requiresWorkerLease) {
