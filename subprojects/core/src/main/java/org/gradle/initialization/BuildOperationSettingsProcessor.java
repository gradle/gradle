...
public class BuildOperationSettingsProcessor implements SettingsProcessor {
    ...
    public BuildOperationSettingsProcessor(
            SettingsProcessor settingsProcessor, BuildOperationRunner buildOperationRunner) {
    ...
    public SettingsState process(
            ...
            final SettingsLocation settingsLocation,
            final ClassLoaderScope buildRootClassLoaderScope,
        ...
        return buildOperationRunner.call(new CallableBuildOperation<SettingsState>() {
            ...
            public SettingsState call(BuildOperationContext context) {
                SettingsState state =
                        settingsProcessor.process(gradle, settingsLocation, buildRootClassLoaderScope, startParameter);
