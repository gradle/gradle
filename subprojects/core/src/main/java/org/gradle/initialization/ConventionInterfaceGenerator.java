...
public class ConventionInterfaceGenerator {
    ...
    public static final String RETURN_OBJECT_FROM_CONVENTION_KCLASS =
            getMethodDescriptor(OBJECT_TYPE, CONVENTION_TYPE, KCLASS_TYPE);
    public static final String CONVENTION_INTERFACE_NAME = CONVENTION_TYPE.getInternalName();
    public static final String EXTENSION_CONTAINER_DELEGATE_IMPLEMENTATION_NAME =
            getType(DelegatingConvention.class).getInternalName();
    public static final String EXTENSION_CONTAINER_CLASS_NAME =
            getType(ExtensionContainer.class).getInternalName();
    ...
    public static final String DEFAULT_DECORATED_CONVENTION_NAME =
    ...
    public static final ImmutableList<String> REMOVED_CLASSES = ImmutableList.of(
            CONVENTION_INTERFACE_CLASS_NAME, DEFAULT_DECORATED_CONVENTION_NAME, CONVENTION_EXTENSIONS_KT_NAME);
    private static final int JAVA_BYTE_CODE_COMPATIBILITY = Opcodes.V1_8;
    private static final int INTERFACE_ACCESS_MODIFIERS =
            ACC_PUBLIC | Opcodes.ACC_SYNTHETIC | Opcodes.ACC_INTERFACE | ACC_ABSTRACT;
        ...
        new ClassVisitorScope(classWriter) {
            {
                ...
                visit(
                        ...
                        new String[] {CONVENTION_INTERFACE_NAME});
        ...
        new ClassVisitorScope(classWriter) {
            {
                ...
                visit(
                        ...
                        new String[] {EXTENSION_CONTAINER_CLASS_NAME});
                ...
                publicAbstractMethod(
                        FIND_PLUGIN, RETURN_OBJECT_FROM_CLASS, RETURN_GENERIC_FROM_CLASS, methodVisitor -> {});
