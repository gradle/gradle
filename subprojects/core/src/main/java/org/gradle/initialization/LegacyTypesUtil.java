...
public class LegacyTypesUtil {
    static final Set<String> CLASSES_TO_MIX_IN_GROOVY_OBJECT = readClassNames("converted-types.txt");
    static final Set<String> SYNTHETIC_CLASSES = readClassNames("removed-types.txt");
    ...
    static byte[] generateEmptyClass(String name) {
