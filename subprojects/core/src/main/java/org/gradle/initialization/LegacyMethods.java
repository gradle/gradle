...
public class LegacyMethods {
    ...
    public Consumer<ClassVisitor> missingMethodImplementationFor(String className) {
        if (!classesToPatch.contains(className)) {
            ...
            return new Consumer<ClassVisitor>() {
                @Override
                public void accept(ClassVisitor vw) {
                    ...
                    Label label2;
                    Label label3;
                    methodVisitor = vw.visitMethod(ACC_PUBLIC | ACC_DEPRECATED, "getArchiveName", "()Ljava/lang/String;", null, null);
                    ...
                    methodVisitor = vw.visitMethod(ACC_PUBLIC | ACC_DEPRECATED, "setArchiveName", "(Ljava/lang/String;)V", null, null);
                    annotationVisitor0 = methodVisitor.visitAnnotation("Ljava/lang/Deprecated;", true);
                    annotationVisitor0.visitEnd();
                    methodVisitor.visitCode();
                    label0 = new Label();
                    ...
                    methodVisitor.visitEnd();
                    methodVisitor = vw.visitMethod(ACC_PUBLIC | ACC_DEPRECATED, "getArchivePath", "()Ljava/io/File;", null, null);
                    annotationVisitor0 = methodVisitor.visitAnnotation("Ljava/lang/Deprecated;", true);
                    annotationVisitor0.visitEnd();
                    annotationVisitor0 = methodVisitor.visitAnnotation("Lorg/gradle/api/model/ReplacedBy;", true);
                    ...
                    methodVisitor.visitMaxs(1, 1);
                    methodVisitor.visitEnd();
                    methodVisitor = vw.visitMethod(ACC_PUBLIC | ACC_DEPRECATED, "getDestinationDir", "()Ljava/io/File;", null, null);
                    annotationVisitor0 = methodVisitor.visitAnnotation("Ljava/lang/Deprecated;", true);
                    annotationVisitor0.visitEnd();
                    annotationVisitor0 = methodVisitor.visitAnnotation("Lorg/gradle/api/model/ReplacedBy;", true);
                    ...
                    methodVisitor.visitMaxs(1, 1);
                    methodVisitor.visitEnd();
                    methodVisitor = vw.visitMethod(ACC_PUBLIC | ACC_DEPRECATED, "setDestinationDir", "(Ljava/io/File;)V", null, null);
                    annotationVisitor0 = methodVisitor.visitAnnotation("Ljava/lang/Deprecated;", true);
                    annotationVisitor0.visitEnd();
                    methodVisitor.visitCode();
                    label0 = new Label();
                    ...
                    methodVisitor.visitEnd();
                    methodVisitor = vw.visitMethod(ACC_PUBLIC | ACC_DEPRECATED, "getBaseName", "()Ljava/lang/String;", null, null);
                    ...
                    methodVisitor.visitMaxs(1, 1);
                    methodVisitor.visitEnd();
                    methodVisitor = vw.visitMethod(ACC_PUBLIC | ACC_DEPRECATED, "setBaseName", "(Ljava/lang/String;)V", null, null);
                    annotationVisitor0 = methodVisitor.visitAnnotation("Ljava/lang/Deprecated;", true);
                    annotationVisitor0.visitEnd();
                    ...
                    methodVisitor.visitMaxs(2, 2);
                    methodVisitor.visitEnd();
                    methodVisitor = vw.visitMethod(ACC_PUBLIC | ACC_DEPRECATED, "getAppendix", "()Ljava/lang/String;", null, null);
                    annotationVisitor0 = methodVisitor.visitAnnotation("Ljavax/annotation/Nullable;", true);
                    annotationVisitor0.visitEnd();
                    annotationVisitor0 = methodVisitor.visitAnnotation("Ljava/lang/Deprecated;", true);
                    annotationVisitor0.visitEnd();
                    ...
                    methodVisitor.visitMaxs(1, 1);
                    methodVisitor.visitEnd();
                    methodVisitor = vw.visitMethod(ACC_PUBLIC | ACC_DEPRECATED, "setAppendix", "(Ljava/lang/String;)V", null, null);
                    annotationVisitor0 = methodVisitor.visitAnnotation("Ljava/lang/Deprecated;", true);
                    annotationVisitor0.visitEnd();
                    methodVisitor.visitAnnotableParameterCount(1, true);
                    annotationVisitor0 = methodVisitor.visitParameterAnnotation(0, "Ljavax/annotation/Nullable;", true);
                    ...
                    methodVisitor.visitMaxs(2, 2);
                    methodVisitor.visitEnd();
                    methodVisitor = vw.visitMethod(ACC_PUBLIC | ACC_DEPRECATED, "getVersion", "()Ljava/lang/String;", null, null);
                    annotationVisitor0 = methodVisitor.visitAnnotation("Ljavax/annotation/Nullable;", true);
                    annotationVisitor0.visitEnd();
                    annotationVisitor0 = methodVisitor.visitAnnotation("Ljava/lang/Deprecated;", true);
                    annotationVisitor0.visitEnd();
                    ...
                    methodVisitor.visitMaxs(1, 1);
                    methodVisitor.visitEnd();
                    methodVisitor = vw.visitMethod(ACC_PUBLIC | ACC_DEPRECATED, "setVersion", "(Ljava/lang/String;)V", null, null);
                    annotationVisitor0 = methodVisitor.visitAnnotation("Ljava/lang/Deprecated;", true);
                    annotationVisitor0.visitEnd();
                    methodVisitor.visitAnnotableParameterCount(1, true);
                    annotationVisitor0 = methodVisitor.visitParameterAnnotation(0, "Ljavax/annotation/Nullable;", true);
                    ...
                    methodVisitor.visitMaxs(2, 2);
                    methodVisitor.visitEnd();
                    methodVisitor = vw.visitMethod(ACC_PUBLIC | ACC_DEPRECATED, "getExtension", "()Ljava/lang/String;", null, null);
                    annotationVisitor0 = methodVisitor.visitAnnotation("Ljavax/annotation/Nullable;", true);
                    annotationVisitor0.visitEnd();
                    annotationVisitor0 = methodVisitor.visitAnnotation("Ljava/lang/Deprecated;", true);
                    annotationVisitor0.visitEnd();
                    ...
                    methodVisitor.visitMaxs(1, 1);
                    methodVisitor.visitEnd();
                    methodVisitor = vw.visitMethod(ACC_PUBLIC | ACC_DEPRECATED, "setExtension", "(Ljava/lang/String;)V", null, null);
                    annotationVisitor0 = methodVisitor.visitAnnotation("Ljava/lang/Deprecated;", true);
                    annotationVisitor0.visitEnd();
                    methodVisitor.visitAnnotableParameterCount(1, true);
                    annotationVisitor0 = methodVisitor.visitParameterAnnotation(0, "Ljavax/annotation/Nullable;", true);
                    ...
                    methodVisitor.visitMaxs(2, 2);
                    methodVisitor.visitEnd();
                    methodVisitor = vw.visitMethod(ACC_PUBLIC | ACC_DEPRECATED, "getClassifier", "()Ljava/lang/String;", null, null);
                    annotationVisitor0 = methodVisitor.visitAnnotation("Ljavax/annotation/Nullable;", true);
                    annotationVisitor0.visitEnd();
                    annotationVisitor0 = methodVisitor.visitAnnotation("Ljava/lang/Deprecated;", true);
                    annotationVisitor0.visitEnd();
                    ...
                    methodVisitor.visitMaxs(1, 1);
                    methodVisitor.visitEnd();
                    methodVisitor = vw.visitMethod(ACC_PUBLIC | ACC_DEPRECATED, "setClassifier", "(Ljava/lang/String;)V", null, null);
                    annotationVisitor0 = methodVisitor.visitAnnotation("Ljava/lang/Deprecated;", true);
                    annotationVisitor0.visitEnd();
                    methodVisitor.visitAnnotableParameterCount(1, true);
                    annotationVisitor0 = methodVisitor.visitParameterAnnotation(0, "Ljavax/annotation/Nullable;", true);
