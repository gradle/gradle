...
public class SettingsFactory {
    ...
    public SettingsFactory(Instantiator instantiator, ServiceRegistry buildScopeServices, ScriptHandlerFactory scriptHandlerFactory, GradlePropertiesAccessListener gradlePropertiesAccessListener) {
    ...
    public SettingsState createSettings(
        ...
        ((ExtraPropertiesExtensionInternal) settings.getExtensions().getExtraProperties())
            .attachGradleProperties(new DefaultExtraPropertiesGradlePropertiesLookup(gradlePropertiesAccessListener, gradleProperties.getProperties()));
