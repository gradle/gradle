...
public class DefaultDependencyResolutionManagement implements DependencyResolutionManagementInternal {
    private final SharedDependencyResolutionServices services;

    public DefaultDependencyResolutionManagement(SharedDependencyResolutionServices services) {
        this.services = services;
    }

    @Override
    public void repositories(Action<? super RepositoryHandler> repositoryConfiguration) {
        repositoryConfiguration.execute(services.getResolveRepositoryHandler());
    }

    @Override
    public RepositoryHandler getRepositoryHandler() {
        return services.getResolveRepositoryHandler();
    }
}
