...
public class StartParameterBuildOptions extends BuildOptionSet<StartParameterInternal> {
    ...
    private static List<BuildOption<StartParameterInternal>> options = Arrays.asList(
        ...
        new IsolatedProjectsDiagnosticModeOption(),
    ...
    public static class IsolatedProjectsDiagnosticModeOption extends BooleanBuildOption<StartParameterInternal> {
        public static final String PROPERTY_NAME = "org.gradle.unsafe.isolated-projects.diagnostic";

        public IsolatedProjectsDiagnosticModeOption() {
            super(PROPERTY_NAME);
        }
