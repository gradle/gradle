...
class CommandLineArgDeprecationIntegrationTest extends AbstractIntegrationSpec {
    ...
    def "deprecation warning appears when using #deprecatedArgs and warningtype #warningsType in Tooling API"() {
        ...
        'https://github.com/gradle/gradle/issues/3334' | '--no-search-upward'  | WarningType.All           | 1                     | 0                     | NO_SEARCH_UPWARD_MESSAGE
        'https://github.com/gradle/gradle/issues/3334' | '-u'                  | WarningType.All           | 1                     | 0                     | NO_SEARCH_UPWARD_MESSAGE
        'https://github.com/gradle/gradle/issues/3334' | '-u'                  | WarningType.Summary       | 0                     | 1                     | NO_SEARCH_UPWARD_MESSAGE
        'https://github.com/gradle/gradle/issues/3334' | '-u'                  | WarningType.NoDeprecation | 0                     | 0                     | NO_SEARCH_UPWARD_MESSAGE
    }
