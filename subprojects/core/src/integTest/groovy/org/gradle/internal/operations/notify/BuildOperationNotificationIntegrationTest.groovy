...
class BuildOperationNotificationIntegrationTest extends AbstractIntegrationSpec {
    ...
    def "can emit notifications for nested builds"() {
        ...
        notifications.op(RunRootBuildWorkBuildOperationType.Details).parentId == notifications.op(RunMainWorkBuildOperationType.Details).id
        notifications.op(RunMainWorkBuildOperationType.Details).parentId == notifications.op(RunBuildBuildOperationType.Details).id
    }
