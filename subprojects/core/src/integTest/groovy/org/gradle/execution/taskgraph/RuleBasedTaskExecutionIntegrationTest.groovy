...
class RuleBasedTaskExecutionIntegrationTest extends AbstractIntegrationSpec {
    ...
    def "does not create rule based tasks in projects without required tasks"() {
        ...
        then:
        createdTasksFor(":a:t1") == [":a:t1", ":a:t2"]
        createdTasksFor(":a:t1", "b:t1") == [":a:t1", ":a:t2", ":b:t1", ":b:t2"]
        createdTasksFor("t1") == [":a:t1", ":a:t2", ":b:t1", ":b:t2", ":c:t1", ":c:t2", ":t1", ":t2"]
        createdTasksFor(":t1") == [":t1", ":t2"]
    }
