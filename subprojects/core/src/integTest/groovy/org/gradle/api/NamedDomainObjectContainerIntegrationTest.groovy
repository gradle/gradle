...
class QueryAndMutateFromWithTypeAllNamedDomainObjectContainerIntegrationTest extends QueryAndMutateFromWithTypeAllDomainObjectContainerIntegrationTest implements AbstractNamedDomainObjectContainerIntegrationTest {
}

class QueryAndMutateFromWithTypeGetByNameNamedDomainObjectContainerIntegrationTest extends QueryAndMutateFromWithTypeGetByNameDomainObjectContainerIntegrationTest implements AbstractNamedDomainObjectContainerIntegrationTest {
}
...
class MutationFailureFromProviderConfigureNamedDomainObjectContainerIntegrationTest extends MutationFailureFromProviderConfigureDomainObjectContainerIntegrationTest implements AbstractNamedDomainObjectContainerIntegrationTest {
}
