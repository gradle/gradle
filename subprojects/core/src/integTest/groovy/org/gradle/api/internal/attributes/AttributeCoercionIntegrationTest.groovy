        ...
        buildFile("producer/build.gradle", """
            ...
            configurations {
                consumable("myVariant") {
                    attributes {
                        attribute(ATTRIBUTE_TYPE, objectFactory.named(MyAttributeType.class, 'myValue'))
                    }
            ...
            public abstract class MyPlugin implements Plugin<Project> {
                ...
                public void apply(Project project) {
                    project.getConfigurations().consumable("myVariant", c -> {
                        c.getAttributes().attribute(ATTRIBUTE_TYPE, c.getAttributes().getObjectFactory().named(MyAttributeType.class, "myValue"));
