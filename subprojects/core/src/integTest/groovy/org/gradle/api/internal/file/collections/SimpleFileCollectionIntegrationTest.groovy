...
class SimpleFileCollectionIntegrationTest extends AbstractIntegrationSpec {
    def 'creating SimpleFileCollection produces deprecation warning'() {
        ...
        expect:
        succeeds "help"
        output.contains "The SimpleFileCollection type has been deprecated and is scheduled to be removed in Gradle 5.0. Please use ProjectLayout.filesFor() or ProjectLayout.mutableFilesFor() instead."
    }
}
