...
class FileCollectionIntegrationTest extends AbstractIntegrationSpec {
    ...
    def "getting build dependencies from custom file collection produces deprecation warning"() {
        ...
        expect:
        succeeds "help"
        output.contains "The AbstractFileCollection.getBuildDependencies() method has been deprecated and is scheduled to be removed in Gradle 5.0. Do not extend AbstractFileCollection, use ProjectLayout.files() instead."
    }
}
