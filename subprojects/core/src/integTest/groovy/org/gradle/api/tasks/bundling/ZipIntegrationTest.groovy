...
class ZipIntegrationTest extends AbstractIntegrationSpec {
    ...
    def "task is out of date after `into` changes"() {
        ...
        then:
        skippedTasks.empty
        output.contains "Value of input property 'resolvedRootSpec.children.\$0.children.\$0.destinationPath' has changed for task ':zip'"
        output.contains "Value of input property 'resolvedRootSpec.children.\$0.children.\$0.children.\$0.destinationPath' has changed for task ':zip'"
    }
