...
class TaskInputFilePropertiesIntegrationTest extends AbstractIntegrationSpec {
    ...
    def "TaskInputs.#method shows deprecation warning when used with complex input"() {
        ...
        result.deprecationReport.contains "Using TaskInputs.$method() with something that doesn't resolve to a File object has been deprecated and is scheduled to be removed in Gradle 5.0. Use TaskInputs.files() instead."
