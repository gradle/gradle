...
"""
    ...
    def 'can create #collectionType containing #content'() {
        ...
        'FileCollection'             | 'URI'            | 'project.layout.filesFor(new URI("file:%s/src/resource/file.txt".replaceAll(" ", "%%20")))'
        'FileCollection'             | 'URL'            | 'project.layout.filesFor(new URL("file:%s/src/resource/file.txt".replaceAll(" ", "%%20")))'
        ...
        'ConfigurableFileCollection' | 'URI'            | 'project.layout.mutableFilesFor(new URI("file:%s/src/resource/file.txt".replaceAll(" ", "%%20")))'
        'ConfigurableFileCollection' | 'URL'            | 'project.layout.mutableFilesFor(new URL("file:%s/src/resource/file.txt".replaceAll(" ", "%%20")))'
