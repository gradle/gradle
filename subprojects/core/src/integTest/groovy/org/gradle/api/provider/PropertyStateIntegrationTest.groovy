...
"""
        ...
        then:
        result.deprecationReport.contains("The property(Class) method has been deprecated and is scheduled to be removed in Gradle 5.0. Please use the ObjectFactory.property(Class) method instead.")
