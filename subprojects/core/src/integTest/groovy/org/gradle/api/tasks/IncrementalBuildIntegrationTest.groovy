...
"""
    ...
    def "using non-directory fileTrees as outputs is deprecated"() {
        ...
        then:
        skippedTasks.contains(':myTask')
        output.contains('Adding file trees which are not directory trees as output files has been deprecated and is scheduled to be removed in Gradle 5.0. Outputs should always be actual files.')
    }
