...
service: closed with value 10001
    ...
    def "injection by name fails if optional service is not found but used"() {
        ...
        then:
        failure.assertHasDescription("Execution failed for task ':missingService' (created in build file 'build.gradle').")
...
"""
    ...
    def "cannot inject Gradle provided service #serviceType into build service"() {
        ...
        then:
        failure.assertHasDescription("Execution failed for task ':check' (created in build file 'build.gradle').")
    ...
    def "reports failure to create the service instance"() {
        ...
        failure.assertHasDescription("Execution failed for task ':first' (created in build file 'build.gradle').")
        ...
        failure.assertHasDescription("Execution failed for task ':second' (created in build file 'build.gradle').")
