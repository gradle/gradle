    ...
    def "can create and use property state in Kotlin-based build script"() {
        ...
        file("buildSrc/src/main/kotlin/MyTask.kt") << """
            ...
            open class MyTask : DefaultTask() {
                ...
                val outputFiles: ConfigurableFileCollection = project.layout.mutableFilesFor()
        ...
        buildFile << """
            ...
            myTask.setOutputFiles(project.layout.filesFor("${normaliseFileSeparators(projectUnderTest.customOutputFile.canonicalPath)}"))
        """
        succeeds('myTask')
