...
class VisualStudioPlugin implements Plugin<ProjectInternal> {
    ...
    static class Rules {
        ...
        @Model
        static DefaultVisualStudioExtension visualStudio(ServiceRegistry serviceRegistry) {
            def instantiator = serviceRegistry.get(Instantiator)
            def projectLocator = serviceRegistry.get(ProjectLocator)
        ...
        public static void createVisualStudioModelForBinaries(DefaultVisualStudioExtension visualStudioExtension, BinaryContainer binaryContainer) {
        ...
        @Mutate
        @SuppressWarnings("GroovyUnusedDeclaration")
        public static void createTasksForVisualStudio(TaskContainer tasks, VisualStudioExtension visualStudioExtension) {
