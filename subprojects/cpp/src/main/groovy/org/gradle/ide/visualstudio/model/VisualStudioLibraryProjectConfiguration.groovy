...
class VisualStudioLibraryProjectConfiguration extends VisualStudioProjectConfiguration {
    private final binary

    VisualStudioLibraryProjectConfiguration(LibraryBinary binary) {
        super(binary)
        this.binary = binary
    }
    ...
    def getConfigurationName() {
        ...
        return super.configurationName
    }

    private boolean isStaticLibrary() {
        return binary instanceof StaticLibraryBinary
    }
}
