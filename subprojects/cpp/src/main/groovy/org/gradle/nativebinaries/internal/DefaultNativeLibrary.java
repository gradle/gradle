...
public class DefaultNativeLibrary extends AbstractTargetedProjectNativeComponent implements NativeLibrary {
    public DefaultNativeLibrary(ProjectNativeComponentIdentifier id) {
        super(id);
    }
