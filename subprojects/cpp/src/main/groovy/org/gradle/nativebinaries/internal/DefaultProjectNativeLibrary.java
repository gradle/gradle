...
public class DefaultProjectNativeLibrary extends AbstractTargetedProjectNativeComponent implements ProjectNativeLibrary {
    public DefaultProjectNativeLibrary(NamedProjectComponentIdentifier id) {
        super(id);
    }
