...
/**
 * A convention-based plugin that automatically adds a single C++ source set named "main" and wires it into a {@link org.gradle.binaries.nativebinaries.Executable} named "main".
 */
@Incubating
