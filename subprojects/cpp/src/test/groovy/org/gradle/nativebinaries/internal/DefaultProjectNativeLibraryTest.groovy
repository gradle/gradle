...
class DefaultProjectNativeLibraryTest extends Specification {
    final library = new DefaultProjectNativeLibrary(new DefaultNamedProjectComponentIdentifier("project-path", "someLib"))
