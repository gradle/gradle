...
class DefaultNativeLibraryTest extends Specification {
    final library = new DefaultNativeLibrary(new DefaultNamedProjectComponentIdentifier("project-path", "someLib"))
