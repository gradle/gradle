...
"""
    ...
    def "produces reasonable error message when referenced library #label"() {
        ...
        "does not exist"                       | "library: 'unknown'"                    | "Could not locate library 'unknown'."                      | "ProjectNativeLibrary with name 'unknown' not found."
        ...
        "does not exist in referenced project" | "project: ':other', library: 'unknown'" | "Could not locate library 'unknown' for project ':other'." | "ProjectNativeLibrary with name 'unknown' not found."
    }
