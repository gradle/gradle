...
class ToolChainDiscoveryIntegrationTest extends AbstractInstalledToolChainIntegrationSpec {
    ...
    def helloWorldApp = new CompilerDetectingHelloWorldApp()
    ...
    def "can discover tool chain in environment"() {
        ...
        and:
        // We explicity apply the tool chain plugin here, to avoid using an alternative tool chain
        buildFile << """
        ...
        mainExecutable.exec().out == "C++ ${toolChain.typeDisplayName}"
