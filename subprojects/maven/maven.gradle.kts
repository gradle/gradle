...
dependencies {
    ...
    implementation(libs.pmaven_common)
    implementation(libs.pmaven_groovy)
    implementation(libs.maven3_wagon_file)
    implementation(libs.maven3_wagon_http)
    implementation(libs.plexus_container)
    implementation(libs.aether_connector)
