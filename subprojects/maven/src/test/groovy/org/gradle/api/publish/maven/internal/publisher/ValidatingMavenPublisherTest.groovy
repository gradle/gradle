...
class ValidatingMavenPublisherTest extends Specification {
    ...
    def "delegates when publication is valid"() {
        ...
        def publication = new DefaultMavenNormalizedPublication("pub-name", projectIdentity, "pom", createPomFile(projectIdentity, null, marker), null, emptySet())
    ...
    def "validates project coordinates"() {
        ...
        def publication = new DefaultMavenNormalizedPublication("pub-name", projectIdentity, "pom", createPomFile(projectIdentity), null, emptySet())
    ...
    def "project coordinates must match POM file"() {
        ...
        def publication = new DefaultMavenNormalizedPublication("pub-name", projectIdentity, "pom", pomFile, null, emptySet())
    ...
    def "validates artifact attributes"() {
        ...
        def publication = new DefaultMavenNormalizedPublication("pub-name", projectIdentity, "pom", pomFile, null, toSet([mavenArtifact]))
    ...
    def "cannot publish with duplicate artifacts"() {
        ...
        def projectIdentity = makeProjectIdentity("group", "artifact", "version")
        def pomFile = createPomFile(projectIdentity)
        def publication = new DefaultMavenNormalizedPublication("pub-name", projectIdentity, "pom", pomFile, null, toSet([artifact1, artifact2]))
    ...
    def "cannot publish extra artifact with same attributes as POM"() {
        ...
        def projectIdentity = makeProjectIdentity("group", "artifact", "version")
        def pomFile = createPomFile(projectIdentity)
        def publication = new DefaultMavenNormalizedPublication("pub-name", projectIdentity, "pom", pomFile, null, toSet([artifact1, pomFile]))
