...
public class MavenPlugin implements Plugin<ProjectInternal> {
    ...
    public void apply(final ProjectInternal project) {
        ...
        plugins.withType(WarPlugin.class, warPlugin -> configureWarScopeMappings(project.getConfigurations(), pluginConvention.getConf2ScopeMappings()));
        plugins.withType(JavaLibraryPlugin.class, javaLibraryPlugin -> configureJavaLibraryScopeMappings(project.getConfigurations(), pluginConvention.getConf2ScopeMappings()));
    }
