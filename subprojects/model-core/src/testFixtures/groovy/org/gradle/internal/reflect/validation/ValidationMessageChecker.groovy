...
trait ValidationMessageChecker {
    ...
    String dummyValidationProblem(String onType = 'InvalidTask', String onProperty = 'dummy', String desc = 'test problem', String testReason = 'this is a test. This behaviour has been deprecated') {
    ...
    String dummyValidationProblemWithLink(String onType = 'InvalidTask', String onProperty = 'dummy', String desc = 'test problem', String testReason = 'this is a test. This behaviour has been deprecated') {
        display(SimpleMessage, 'dummy') {
            type(onType).property(onProperty)
            description(desc)
            reason(testReason)
    ...
    void expectThatExecutionOptimizationDisabledWarningIsDisplayed(GradleExecuter executer,
        ...
        String deprecationMessage = asSingleLine + (asSingleLine.endsWith(" ") ? '' : ' ') +
            "This behaviour is scheduled to be removed in Gradle 8.0. " +
