...
abstract public class StructStrategySupport implements ModelSchemaExtractionStrategy {
    protected final Factory<String> supportedTypeDescriptions;
    protected final ModelSchemaExtractor extractor;

    public StructStrategySupport(ModelSchemaExtractor extractor, Factory<String> supportedTypeDescriptions) {
