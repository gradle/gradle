...
public class JavaLanguagePluginServiceRegistry extends AbstractPluginServiceRegistry {
    ...
    private static class JavaProjectScopeServices {
        public IncrementalCompilerFactory<JavaCompileSpec> createJavaIncrementalCompilerFactory(FileOperations fileOperations, StreamHasher streamHasher, GeneralCompileCaches compileCaches, BuildOperationExecutor buildOperationExecutor, StringInterner interner, FileSystemSnapshotter fileSystemSnapshotter, FileHasher fileHasher) {
            return new IncrementalCompilerFactory<JavaCompileSpec>(fileOperations, streamHasher, compileCaches, buildOperationExecutor, interner, fileSystemSnapshotter, fileHasher);
        }
    }
}
