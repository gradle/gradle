...
class JavaCompilerArgumentsBuilderTest extends Specification {
    ...
    def setup() {
        ...
        spec.compileOptions = TestUtil.objectFactory().newInstance(CompileOptions, TestUtil.objectFactory())
    }
    ...
    def "generates -bootclasspath option"() {
        def compileOptions = TestUtil.objectFactory().newInstance(CompileOptions, TestUtil.objectFactory())
