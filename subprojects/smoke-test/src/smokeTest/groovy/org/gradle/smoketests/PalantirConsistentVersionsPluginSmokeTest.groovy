...
class PalantirConsistentVersionsPluginSmokeTest extends AbstractSmokeTest {
    ...
    def 'basic functionality'() {
        ...
        runner('--write-locks', '--stacktrace')
            ...
            // See: https://github.com/palantir/gradle-consistent-versions/blob/341e7d4cde984b7b04e41c15cc5f71a80a187646/src/main/java/com/palantir/gradle/versions/VersionsLockPlugin.java#L276
