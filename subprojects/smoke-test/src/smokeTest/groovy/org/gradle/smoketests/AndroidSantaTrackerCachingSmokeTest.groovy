...
class AndroidSantaTrackerCachingSmokeTest extends AbstractAndroidSantaTrackerSmokeTest {
    ...
    def "can cache Santa Tracker Android application (agp=#agpVersion)"() {
        ...
        when: 'clean build'
        runnerForLocation(originalDir, agpVersion, "assembleDebug")
        ...
        and:
        def expectedResults = agpVersion.startsWith('4.0')
            ? AndroidPluginExpectations.EXPECTED_RESULTS_4_0
...
class AndroidPluginExpectations {
    ...
    static final EXPECTED_RESULTS_4_1 = [
        ':cityquiz:assembleDebug': SUCCESS,
        ':cityquiz:checkDebugAarMetadata': FROM_CACHE,
        ':cityquiz:checkDebugDuplicateClasses': FROM_CACHE,
        ':cityquiz:compileDebugAidl': NO_SOURCE,
    ...
    static final EXPECTED_RESULTS_4_0 = [
        ':cityquiz:assembleDebug': SUCCESS,
        ':cityquiz:checkDebugDuplicateClasses': FROM_CACHE,
        ':cityquiz:compileDebugAidl': NO_SOURCE,
        ':cityquiz:compileDebugJavaWithJavac': FROM_CACHE,
