...
abstract class AbstractSmokeTest extends Specification {
    ...
    static class TestedVersions {
        ...
        static nebulaPluginPlugin = "15.4.1"
        ...
        static artifactoryPlugin = "4.24.14"
        ...
        static spotless = Versions.of("5.14.2")

        // https://plugins.gradle.org/plugin/com.google.cloud.tools.jib
        static jib = Versions.of("3.1.2")

        // https://plugins.gradle.org/plugin/io.freefair.lombok
        static lombok = Versions.of("6.1.0-m1")
        ...
        static ktlint = Versions.of("10.1.0")
