    ...
    def "performs static validation of plugins used by the Gradle build"() {
        ...
        inProject(":") {
            onPlugin('org.jetbrains.gradle.plugin.idea-ext') {
                failsWith([
                    "Type 'BuildIdeArtifact': property 'artifact' is missing an input or output annotation.": WARNING,
                    "Type 'BuildIdeArtifact': property 'outputDirectory' is missing an input or output annotation.": WARNING
                ])
            }
        }
