...
class NormalizingGosuCompilerTest extends Specification {
    Compiler<GosuCompileSpec> target = Mock()
    DefaultGosuCompileSpec spec = new DefaultGosuCompileSpec()
    NormalizingGosuCompiler compiler = new NormalizingGosuCompiler(target)
    ...
    def setup() {
        ...
        spec.gosuCompileOptions = new BaseGosuCompileOptions()
    }
    ...
    def "ignores compile failure when failOnError is false"() {
        ...
        spec.gosuCompileOptions.failOnError = false
