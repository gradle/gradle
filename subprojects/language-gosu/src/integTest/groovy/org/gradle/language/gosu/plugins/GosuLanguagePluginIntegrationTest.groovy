...
class GosuLanguagePluginIntegrationTest extends AbstractJvmPluginLanguageIntegrationTest {
    String sourceSetTypeName = GosuLanguageSourceSet.class.simpleName
}
