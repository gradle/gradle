...
public class NotFoundGosuToolProvider implements ToolProvider {
    private Exception exception;

    public NotFoundGosuToolProvider(Exception moduleVersionNotFoundException) {
    ...
    public void explain(TreeVisitor<? super String> visitor) {
        visitor.node("Cannot provide Gosu Compiler");
