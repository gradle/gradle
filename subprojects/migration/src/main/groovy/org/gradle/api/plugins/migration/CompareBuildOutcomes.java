...
public class CompareBuildOutcomes extends DefaultTask {
    ...
    private BuildOutcomeComparatorFactory buildOutcomeComparatorFactory;

    public BuildComparisonSpec getBuildComparisonSpec() {
        return buildComparisonSpec;
    }

    public void setBuildComparisonSpec(BuildComparisonSpec buildComparisonSpec) {
        this.buildComparisonSpec = buildComparisonSpec;
    }

    public BuildOutcomeComparatorFactory getBuildOutcomeComparatorFactory() {
        return buildOutcomeComparatorFactory;
    }

    public void setBuildOutcomeComparatorFactory(BuildOutcomeComparatorFactory buildOutcomeComparatorFactory) {
        this.buildOutcomeComparatorFactory = buildOutcomeComparatorFactory;
    }
    ...
    public void doComparison() {
        ...
        // TODO - this is not real reporting
