...
Build Setup tasks
-----------------
init (org.gradle.buildinit.tasks.InitBuild [Decorated]) - Initializes a new Gradle build.
wrapper (org.gradle.api.tasks.wrapper.Wrapper [Decorated]) - Generates Gradle wrapper files.
...
dependencies (org.gradle.api.tasks.diagnostics.DependencyReportTask [Decorated]) - Displays all dependencies declared in root project '$projectName'.
dependencyInsight (org.gradle.api.tasks.diagnostics.DependencyInsightReportTask [Decorated]) - Displays the insight into a specific dependency in root project '$projectName'.
help (org.gradle.configuration.Help [Decorated]) - Displays a help message.
javaToolchains (org.gradle.jvm.toolchain.internal.task.ShowToolchainsTask [Decorated]) - Displays the detected java toolchains.
outgoingVariants (org.gradle.api.tasks.diagnostics.OutgoingVariantsReportTask [Decorated]) - Displays the outgoing variants of root project '$projectName'.
projects (org.gradle.api.tasks.diagnostics.ProjectReportTask [Decorated]) - Displays the sub-projects of root project '$projectName'.
properties (org.gradle.api.tasks.diagnostics.PropertyReportTask [Decorated]) - Displays the properties of root project '$projectName'.
tasks (org.gradle.api.tasks.diagnostics.TaskReportTask [Decorated]) - Displays the tasks runnable from root project '$projectName'.""")
    }
...
Build tasks
-----------
sayHello (org.gradle.api.DefaultTask [Decorated])""")
    }
...
Build tasks
-----------
sub1:sayHello (org.gradle.api.DefaultTask [Decorated])
sub2:sayHello (org.gradle.api.DefaultTask [Decorated])""")
    }
