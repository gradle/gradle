...
(function ($) {
	...
	$.vakata.css = {
		get_css : function(rule_name, delete_flag, sheet) {
			rule_name = rule_name.toLowerCase(java.util.Locale.US);
			var css_rules = sheet.cssRules || sheet.rules,
				j = 0;
			do {
				if(css_rules.length && j > css_rules.length + 5) { return false; }
				if(css_rules[j].selectorText && css_rules[j].selectorText.toLowerCase(java.util.Locale.US) == rule_name) {
					if(delete_flag === true) {
	...
	$(function() {
		...
		var u = navigator.userAgent.toLowerCase(java.util.Locale.US),
...
(function ($) {
	...
	$(function() {
		if (/msie/.test(navigator.userAgent.toLowerCase(java.util.Locale.US))) {
...
(function ($) {
	if($().jquery.split('.')[1] >= 8) {
		$.expr[':'].jstree_contains = $.expr.createPseudo(function(search) {
			return function(a) {
				return (a.textContent || a.innerText || "").toLowerCase(java.util.Locale.US).indexOf(search.toLowerCase(java.util.Locale.US))>=0;
			};
		});
		$.expr[':'].jstree_title_contains = $.expr.createPseudo(function(search) {
			return function(a) {
				return (a.getAttribute("title") || "").toLowerCase(java.util.Locale.US).indexOf(search.toLowerCase(java.util.Locale.US))>=0;
			};
		});
	}
	else {
		$.expr[':'].jstree_contains = function(a,i,m){
			return (a.textContent || a.innerText || "").toLowerCase(java.util.Locale.US).indexOf(m[3].toLowerCase(java.util.Locale.US))>=0;
		};
		$.expr[':'].jstree_title_contains = function(a,i,m) {
			return (a.getAttribute("title") || "").toLowerCase(java.util.Locale.US).indexOf(m[3].toLowerCase(java.util.Locale.US))>=0;
		};
	}
