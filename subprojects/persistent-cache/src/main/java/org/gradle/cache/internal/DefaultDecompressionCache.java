...
public class DefaultDecompressionCache implements DecompressionCache {
    ...
    public DefaultDecompressionCache(ScopedCacheBuilderFactory scopedCacheBuilderFactory) {
        this.cache = scopedCacheBuilderFactory.cacheBuilder(EXPANSION_CACHE_KEY)
