...
public class ProjectLayoutSetupRegistryFactory {
    ...
    public ProjectLayoutSetupRegistry createProjectLayoutSetupRegistry() {
        ...
        registry.add(BuildInitTypeIds.KOTLIN_APPLICATION, new KotlinApplicationProjectInitDescriptor(templateOperationBuilder, fileResolver, libraryVersionProvider, settingsDescriptor));
        registry.add(BuildInitTypeIds.KOTLIN_LIBRARY, new KotlinLibraryProjectInitDescriptor(templateOperationBuilder, fileResolver, libraryVersionProvider, settingsDescriptor));
        registry.add(BuildInitTypeIds.BASIC, new BasicTemplateBasedProjectInitDescriptor(fileResolver, settingsDescriptor));
