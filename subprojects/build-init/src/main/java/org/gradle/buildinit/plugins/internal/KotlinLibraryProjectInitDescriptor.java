...
public class KotlinLibraryProjectInitDescriptor extends LanguageLibraryProjectInitDescriptor {
    public KotlinLibraryProjectInitDescriptor(TemplateOperationFactory templateOperationFactory, FileResolver fileResolver, DefaultTemplateLibraryVersionProvider versionProvider, BuildContentGenerator settingsGenerator) {
        super("kotlin", templateOperationFactory, fileResolver, versionProvider, settingsGenerator);
    }
