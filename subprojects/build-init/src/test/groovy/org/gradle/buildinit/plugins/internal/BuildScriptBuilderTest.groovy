...
""")))
    ...
    @Unroll
    def "can add further configuration to #scriptDsl build scripts"() {
        when:
...
""")
    ...
    def "can add further configuration specialized per build script DSL"() {
        given:
        builder.configuration(
            "Specialized configuration per DSL",
            ImmutableMap.<BuildInitBuildScriptDsl, String> builder()
                .put(GROOVY, "test { enabled = false }")
