...
""")
    ...
    def "can add container elements"() {
        given:
        builder.block("Add some thing", "foo.bar") { b ->
            b.containerElement("Element 1", "one") { e ->
                e.propertyAssignment(null, "value", "bazar")
                e.containerElement(null, "nested")
            }
            b.containerElement("Element 2", "two")
        }
