...
""")
    ...
    def "can add allprojects block"() {
        given:
        builder.allprojects()
            .plugin("Apply java plugin", "java")
            .plugin("Apply application plugin", "application")
            .propertyAssignment("Set a property", "foo.bar", "bazar")
            .taskPropertyAssignment("Configure a thing", "SomeType", "foo.bar", "bazar")
            .taskPropertyAssignment(null, "SomeType", "thing", 45)
            .taskPropertyAssignment(null, "AType", "foo.bar", "bazar")
