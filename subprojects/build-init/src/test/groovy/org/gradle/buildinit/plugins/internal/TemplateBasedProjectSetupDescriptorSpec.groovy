...
class TemplateBasedProjectSetupDescriptorSpec extends Specification {
    ...
    private TestTemplateBasedProjectInitDescriptor descriptor
    ...
    def setup() {
        ...
        descriptor = new TestTemplateBasedProjectInitDescriptor(fileResolver, documentationRegistry)
    }
    ...
    class TestTemplateBasedProjectInitDescriptor extends TemplateBasedProjectInitDescriptor {
        ...
        public TestTemplateBasedProjectInitDescriptor(FileResolver fileResolver, DocumentationRegistry documentationRegistry) {
