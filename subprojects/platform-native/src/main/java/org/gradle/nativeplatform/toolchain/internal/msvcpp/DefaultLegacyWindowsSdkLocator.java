...
public class DefaultLegacyWindowsSdkLocator implements LegacyWindowsSdkLocator {
    private static final Logger LOGGER = LoggerFactory.getLogger(DefaultLegacyWindowsSdkLocator.class);
    ...
    public DefaultLegacyWindowsSdkLocator(OperatingSystem os, WindowsRegistry windowsRegistry) {
        this.os = os;
