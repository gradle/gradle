...
public class VisualCppToolChain extends ExtendableToolChain<VisualCppPlatformToolChain> implements VisualCpp, NativeToolChainInternal {
    ...
    public VisualCppToolChain(String name, BuildOperationExecutor buildOperationExecutor, OperatingSystem operatingSystem, FileResolver fileResolver, ExecActionFactory execActionFactory,
                              ...
                              UcrtLocator ucrtLocator, Instantiator instantiator, NativeExecutor nativeExecutor) {
    ...
    public PlatformToolProvider select(NativePlatformInternal targetPlatform) {
        ...
        return new VisualCppPlatformToolProvider(buildOperationExecutor, targetPlatform.getOperatingSystem(), configurableToolChain.tools, visualCpp, windowsSdk, ucrt, targetPlatform, execActionFactory, compilerOutputFileNamingSchemeFactory, nativeExecutor);
    }
