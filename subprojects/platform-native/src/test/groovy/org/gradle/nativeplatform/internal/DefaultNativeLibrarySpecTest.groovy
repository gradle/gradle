...
class DefaultNativeLibrarySpecTest extends Specification {
    final library = BaseComponentFixtures.create(DefaultNativeLibrarySpec, new ModelRegistryHelper(), new DefaultComponentSpecIdentifier("project-path", "someLib"), Stub(ProjectSourceSet), DirectInstantiator.INSTANCE)
