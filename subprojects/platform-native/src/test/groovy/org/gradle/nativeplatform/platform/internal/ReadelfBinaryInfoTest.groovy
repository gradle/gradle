...
class ReadelfBinaryInfoTest extends Specification {
    @SafeUnroll("reads soname value with #language readelf output")
...
"""
    ...
    @SafeUnroll("returns null for no soname value with #language readelf output")
...
"""
    ...
    @SafeUnroll("reads architecture value with #language readelf output")
...
"""
    ...
    @SafeUnroll("reads architecture value and throws RuntimeException with #language readelf output")
