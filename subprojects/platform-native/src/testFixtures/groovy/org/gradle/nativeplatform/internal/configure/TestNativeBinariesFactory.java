...
public class TestNativeBinariesFactory {
    ...
    public static <T extends BaseBinarySpec & NativeBinarySpec> T create(Class<T> type, String name, Instantiator instantiator, ITaskFactory taskFactory, final NativeComponentSpec component,
                                                                         final BinaryNamingScheme namingScheme, final NativeDependencyResolver resolver, final NativeToolChain toolChain,
                                                                         final PlatformToolProvider toolProvider, final NativePlatform platform, final BuildType buildType, final Flavor flavor) {
        T binary = BaseBinarySpec.create(type, name, instantiator, taskFactory);
        Action<NativeBinarySpec> initializer = DefaultNativeBinariesFactory.binaryInitializer(Actions.doNothing(), component, namingScheme, resolver, toolChain, toolProvider, platform, buildType,
                flavor);
