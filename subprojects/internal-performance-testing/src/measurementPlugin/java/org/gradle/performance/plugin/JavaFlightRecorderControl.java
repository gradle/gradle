...
/**
 * Add -Porg.gradle.performance.jfr parameter to build parameters to trigger JFR dump at the end of the build.
 *
...
public class JavaFlightRecorderControl {
    public static final String JFR_CREATE_DUMP = "org.gradle.performance.jfr";
