...
class ClearArtifactTransformCacheWithoutInstrumentedJarsMutatorTest extends Specification {
    ...
    def "should cleanup all folders except the ones with instrumented jars"() {
        ...
        createFile(new File(gradleUserHome, "caches/transforms-2/second/transformed/$AGENT_INSTRUMENTATION_MARKER_FILE_NAME"))
        ...
        new File(gradleUserHome, "caches/transforms-2/second/transformed/$AGENT_INSTRUMENTATION_MARKER_FILE_NAME").exists()
