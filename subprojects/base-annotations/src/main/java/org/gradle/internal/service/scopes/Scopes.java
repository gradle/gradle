...
public interface Scopes {
     ...
     *
     * <p>{@link Scope.Global} and parent scope services are visible to "UserHome" scope services, but not vice versa.</p>
     */
    ...
    /**
     * These services are created once per Settings the beginning of the build invocation
    ...
    /**
     * These services are created once per {@link Gradle} at the beginning of the build invocation.
     * These services are closed at the end of the build invocation.
     *
