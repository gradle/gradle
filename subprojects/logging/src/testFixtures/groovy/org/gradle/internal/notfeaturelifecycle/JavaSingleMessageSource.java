 ...
 */
public class JavaSingleMessageSource implements NaggingSource {
    @Override
    public void execute() {
        create(NaggingSource.DIRECT_CALL);
        indirectly(NaggingSource.INDIRECT_CALL);
        indirectly2(NaggingSource.INDIRECT_CALL_2);

    }

    @Override
    public void create(String message) {
        SingleMessageLogger.nagUserWith(message);
    }
