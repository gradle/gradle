    ...
    public void onOutput(OutputEvent event) {
        if (event instanceof ProgressStartEvent) {
            ...
            if (startEvent.isBuildOperationStart()) {
                ...
                } else if ((startEvent.getBuildOperationCategory() == BuildOperationCategory.TASK || startEvent.getBuildOperationCategory() == BuildOperationCategory.TRANSFORM) && currentPhase == Phase.Executing) {
                    currentPhaseChildren.add(startEvent.getProgressOperationId());
                }
            }
