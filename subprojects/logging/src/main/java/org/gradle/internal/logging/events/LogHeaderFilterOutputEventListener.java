...
public class LogHeaderFilterOutputEventListener implements OutputEventListener {
    ...
    private final Spec<LogGroupHeaderEvent> headerFilter;

    public LogHeaderFilterOutputEventListener(OutputEventListener listener, Spec<LogGroupHeaderEvent> headerFilter) {
