...
public class LogGroupHeaderEventSerializer implements Serializer<LogGroupHeaderEvent> {
    ...
    public LogGroupHeaderEventSerializer(Serializer<LogLevel> logLevelSerializer, Serializer<List<StyledTextOutputEvent.Span>> spanSerializer, Serializer<BuildOperationCategory> buildOperationCategorySerializer) {
    ...
    @Override
    public void write(Encoder encoder, LogGroupHeaderEvent event) throws Exception {
        ...
        encoder.writeBoolean(event.isGroupHasLogs());
    }

    @Override
    public LogGroupHeaderEvent read(Decoder decoder) throws EOFException, Exception {
        ...
        boolean hasLogs = decoder.readBoolean();
        return new LogGroupHeaderEvent(timestamp, category, logLevel, buildOperationId, spans, buildOperationCategory, hasLogs);
    }
}
