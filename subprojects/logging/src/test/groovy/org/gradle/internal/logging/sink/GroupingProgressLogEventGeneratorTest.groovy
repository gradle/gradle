...
class GroupingProgressLogEventGeneratorTest extends OutputSpecification {
    ...
    def "renders ungrouped logging headers"() {
        ...
        def downloadEvent = new ProgressStartEvent(new OperationIdentifier(-3L), new OperationIdentifier(-4L), tenAm, CATEGORY, "Download description", null, header, null, 0, false, null, null, BuildOperationCategory.UNCATEGORIZED)
    ...
    def "forwards a group of logs for a task"() {
        ...
        then:
        1 * logHeaderFormatter.format(taskStartEvent.loggingHeader, taskStartEvent.description, taskStartEvent.shortDescription, taskCompleteEvent.status, false) >> {
    ...
    def "handles multiple simultaneous operations"() {
        ...
        then:
        1 * logHeaderFormatter.format(taskBStartEvent.loggingHeader, taskBStartEvent.description, taskBStartEvent.shortDescription, taskBCompleteEvent.status, false) >> {
