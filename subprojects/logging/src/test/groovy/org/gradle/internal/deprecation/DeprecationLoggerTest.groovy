...
class DeprecationLoggerTest extends ConcurrentSpec {
    ...
    def "logs deprecation warning once until reset"() {
        when:
        DeprecationLogger.deprecate("nag").willBeRemovedInNextMajorVersion().undocumented().nagUser()
        DeprecationLogger.deprecate("nag").willBeRemovedInNextMajorVersion().undocumented().nagUser()
        ...
        async {
            ...
            start {
                DeprecationLogger.whileDisabled {
                    instant.disabled
                    DeprecationLogger.deprecate("ignored").willBeRemovedInNextMajorVersion().undocumented().nagUser()
