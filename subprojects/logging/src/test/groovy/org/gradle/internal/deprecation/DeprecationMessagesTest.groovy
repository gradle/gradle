...
class DeprecationMessagesTest extends Specification {
    ...
    def "logs deprecation message"() {
        ...
        when:
        builder.willBeRemovedInNextMajorVersion().undocumented().nagUser()
    ...
    def "logs generic deprecation message for specific thing"() {
        when:
        DeprecationLogger.deprecate("Something").willBeRemovedInNextMajorVersion().undocumented().nagUser()

        then:
        expectMessage "Something has been deprecated. This is scheduled to be removed in Gradle ${NEXT_GRADLE_VERSION}."
    }

    def "logs generic deprecation message for something to be removed in specified version of Gradle"() {
        when:
        DeprecationLogger.deprecate("Something").willBeRemovedInVersion(GradleVersion.current().getNextMajor()).undocumented().nagUser()

        then:
        expectMessage "Something has been deprecated. This is scheduled to be removed in Gradle ${NEXT_GRADLE_VERSION}."
    }

    def "logs generic deprecation message for something that will fail with an error in specified version of Gradle"() {
        when:
        DeprecationLogger.deprecate("Something").willBecomeAnError(GradleVersion.current().getNextMajor()).undocumented().nagUser()

        then:
        expectMessage "Something has been deprecated. This will fail with an error in Gradle ${NEXT_GRADLE_VERSION}."
    }

    def "logs deprecated behaviour message"() {
        when:
        DeprecationLogger.deprecateBehaviour("Some behaviour.").willBeRemovedInNextMajorVersion().undocumented().nagUser()
    ...
    def "logs deprecated indirect user code cause message"() {
        when:
        DeprecationLogger.deprecate("Something").withAdvice("Advice.").withContext("Contextual advice.").willBeRemovedInNextMajorVersion().undocumented().nagUser()
    ...
    def "logs deprecated build invocation message"() {
        when:
        DeprecationLogger.deprecateBuildInvocationFeature("Feature").withAdvice("Advice.").willBeRemovedInNextMajorVersion().undocumented().nagUser()
    ...
    def "logs deprecated and replaced parameter usage message"() {
        when:
        DeprecationLogger.deprecateNamedParameter("paramName").replaceWith("replacement").willBeRemovedInNextMajorVersion().undocumented().nagUser()
    ...
    def "logs deprecated property message"() {
        when:
        DeprecationLogger.deprecateProperty(DeprecationLogger, "propertyName").withAdvice("Advice.").willBeRemovedInNextMajorVersion().undocumented().nagUser()
    ...
    def "logs deprecated and replaced property message"() {
        when:
        DeprecationLogger.deprecateProperty(DeprecationLogger, "propertyName").replaceWith("replacement").willBeRemovedInNextMajorVersion().undocumented().nagUser()
    ...
    def "logs discontinued method message"() {
        when:
        DeprecationLogger.deprecateMethod(DeprecationLogger, "method()").withAdvice("Advice.").willBeRemovedInNextMajorVersion().undocumented().nagUser()
    ...
    def "logs replaced method message"() {
        when:
        DeprecationLogger.deprecateMethod(DeprecationLogger, "method()").replaceWith("replacementMethod()").willBeRemovedInNextMajorVersion().undocumented().nagUser()
    ...
    def "logs discontinued invocation message"() {
        when:
        DeprecationLogger.deprecateAction("Some action").willBecomeAnErrorInNextMajorVersion().undocumented().nagUser()
    ...
    def "logs deprecated method invocation message"() {
        when:
        DeprecationLogger.deprecateInvocation("method()").withAdvice("Advice.").willBecomeAnErrorInNextMajorVersion().undocumented().nagUser()
    ...
    def "logs replaced method invocation message"() {
        when:
        DeprecationLogger.deprecateInvocation("method()").replaceWith("replacementMethod()").willBecomeAnErrorInNextMajorVersion().undocumented().nagUser()
    ...
    def "logs replaced task"() {
        when:
        DeprecationLogger.deprecateTask("taskName").replaceWith("replacementTask").willBeRemovedInNextMajorVersion().undocumented().nagUser()
    ...
    def "logs plugin replaced with external one message"() {
        when:
        DeprecationLogger.deprecatePlugin("pluginName").replaceWithExternalPlugin("replacement").willBeRemovedInNextMajorVersion().undocumented().nagUser()
    ...
    def "logs deprecated plugin message"() {
        when:
        DeprecationLogger.deprecatePlugin("pluginName").withAdvice("Advice.").willBeRemovedInNextMajorVersion().undocumented().nagUser()
    ...
    def "logs replaced plugin message"() {
        when:
        DeprecationLogger.deprecatePlugin("pluginName").replaceWith("replacement").willBeRemovedInNextMajorVersion().undocumented().nagUser()
    ...
    def "logs deprecated plugin message with link to upgrade guide"() {
        when:
        DeprecationLogger.deprecatePlugin("pluginName").willBeRemovedInNextMajorVersion().withUpgradeGuideSection(42, "upgradeGuideSection").nagUser()
    ...
    def "logs configuration deprecation message for artifact declaration"() {
        when:
        DeprecationLogger.deprecateConfiguration("ConfigurationType").forArtifactDeclaration().replaceWith(['r1', 'r2', 'r3']).willBecomeAnErrorInNextMajorVersion().undocumented().nagUser()
    ...
    def "logs configuration deprecation message for consumption"() {
        when:
        DeprecationLogger.deprecateConfiguration("ConfigurationType").forConsumption().replaceWith(['r1', 'r2', 'r3']).willBecomeAnErrorInNextMajorVersion().undocumented().nagUser()
    ...
    def "logs configuration deprecation message for dependency declaration"() {
        when:
        DeprecationLogger.deprecateConfiguration("ConfigurationType").forDependencyDeclaration().replaceWith(['r1', 'r2', 'r3']).willBecomeAnErrorInNextMajorVersion().undocumented().nagUser()
    ...
    def "logs configuration deprecation message for resolution"() {
        when:
        DeprecationLogger.deprecateConfiguration("ConfigurationType").forResolution().replaceWith(['r1', 'r2', 'r3']).willBecomeAnErrorInNextMajorVersion().undocumented().nagUser()
