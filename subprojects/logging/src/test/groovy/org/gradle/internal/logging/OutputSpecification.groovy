...
abstract class OutputSpecification extends Specification {
    ...
    ProgressStartEvent start(Map args) {
        ...
        return new ProgressStartEvent(new OperationIdentifier(id), parent, tenAm, category, args.description, args.loggingHeader, args.status, 0, buildOperationStart, buildOperationId, parentBuildOperationId, buildOperationCategory)
    }
