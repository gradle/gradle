...
class SingleMessageLoggerTest extends ConcurrentSpec {
    ...
    def "logs deprecation warning once until reset"() {
        when:
        SingleMessageLogger.nagUserWith(DeprecationMessage.specificThingHasBeenDeprecated("nag"))
        SingleMessageLogger.nagUserWith(DeprecationMessage.specificThingHasBeenDeprecated("nag"))
        ...
        async {
            ...
            start {
                SingleMessageLogger.whileDisabled {
                    instant.disabled
                    SingleMessageLogger.nagUserWith(DeprecationMessage.specificThingHasBeenDeprecated("ignored"))
