...
class DefaultDirectoryStateChangeDetecter implements DirectoryStateChangeDetecter {
    ...
    DefaultDirectoryStateChangeDetecter(final File directoryToProcess, IoFactory ioFactory,
                                        DirectoryStateBuilder directoryStateBuilder, DigesterCache digesterCache,
                                        DigesterUtil digesterUtil, DirectoryListFileCreator directoryListFileCreator,
                                        StateFileUtil stateFileUtil,
    ...
    public void detectChanges(ChangeProcessor changeProcessor) {
        ...
        try {
            ...
            Map<String, DirectoryState> previousLevelDirectoryStates = Collections.unmodifiableMap(
                    new HashMap<String, DirectoryState>());
            ...
            for (int levelIndex = lowestLevel; levelIndex >= 0; levelIndex--) {
                ...
                if (directoryLevelListFile.exists()) {
                    final File stateFile = stateFileUtil.getNewDirsStateFile(stateFileUtil.getDirsStateFilename(
                            levelIndex));
                ...
                previousLevelDirectoryStates = Collections.unmodifiableMap(new HashMap<String, DirectoryState>(
