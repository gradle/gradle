...
public interface DigesterUtilStrategy {
     ...
     *
     * The DigesterUtil needs to make sure that the following holds true before calling this method: - digester is not
     * null - file is not null - the file exists - the file is a file
     *
     ...
     *
     * The DigesterUtil needs to make sure that the following holds true before calling this method: - digester is not
     * null - directory is not null - the directory exists - the directory is a directory
     *
     * @param digester The digester to update.
