...
public interface FileCollectionDependency extends SelfResolvingDependency {
    /**
     * Returns the set of tasks which build the files of this dependency.
     *
    ...
    /**
     * Sets the tasks which build the files of this dependency.
     *
     * @param tasks The tasks. These are evaluated as for {@link org.gradle.api.Task#dependsOn(Object...)}.
     * @return this
     */
    FileCollectionDependency setBuiltBy(Iterable<?> tasks);

    /**
     * Registers the tasks which build the files of this dependency.
     *
     * @param tasks The tasks. These are evaluated as for {@link org.gradle.api.Task#dependsOn(Object...)}.
     * @return this
     */
    FileCollectionDependency builtBy(Object... tasks);
}
