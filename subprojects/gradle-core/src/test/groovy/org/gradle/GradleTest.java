...
public class GradleTest {
    ...
    public void setUp() {
        ...
        gradleLauncher = new GradleLauncher(buildMock, settingsHandlerMock, gradlePropertiesLoaderMock, buildLoaderMock, buildConfigurerMock);
