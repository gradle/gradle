...
public interface JavaExecSpec extends JavaForkOptions, BaseExecSpec {
     ...
     *
     * <p>This does not need to be set if using an <a href="https://docs.oracle.com/javase/tutorial/deployment/jar/appman.html">Executable Jar</a> with a {@code Main-Class} attribute.</p>
     *
     * @since 6.4
     */
    @Optional
