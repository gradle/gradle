...
/**
 * <p>Specifies the options to use to fork a JVM process.</p>
 *
 * @since 7.1
 */
public interface JvmForkOptions {
    /**
     ...
     * @return this
     */
    JvmForkOptions systemProperties(Map<String, ?> properties);
     ...
     * @return this
     */
    JvmForkOptions systemProperty(String name, Object value);
     ...
     * @return this
     */
    JvmForkOptions jvmArgs(Iterable<?> arguments);
     ...
     * @return this
     */
    JvmForkOptions jvmArgs(Object... arguments);
     ...
     * @return this
     */
    JvmForkOptions bootstrapClasspath(Object... classpath);
