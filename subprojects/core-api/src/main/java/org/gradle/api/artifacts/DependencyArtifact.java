...
/**
 * Represents an artifact included in a {@link org.gradle.api.artifacts.Dependency}.
 *
 * @implSpec all implementations should be written as immutable value objects
 */
