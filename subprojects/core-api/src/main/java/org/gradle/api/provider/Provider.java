 ...
 *     <li>By calling {@link ProviderFactory#provider(Callable)}, {@link org.gradle.api.initialization.Settings#provider(Callable)}, or {@link org.gradle.api.Project#provider(Callable)} to create a new provider from a {@link Callable}.</li>
 * </ul>
 *
 * <p>
