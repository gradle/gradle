...
public interface Task extends Comparable<Task>, ExtensionAware, Named {
     ...
     *
     * <p>The services available for lookup are the Gradle types that implement {@link TaskService}.
     * A task only resolves services of the project that owns it.</p>
     *
     ...
     * @throws InvalidUserDataException when the given type is not one of the services available to tasks
     * @since 9.9.0
     */
    @Incubating
