 ...
 *     force 'asm:asm-all:3.3.1', 'commons-io:commons-io:2.21.0'
...
public interface ResolutionStrategy {
     ...
     *
     * configurations.all {
     *   resolutionStrategy.force 'asm:asm-all:3.3.1', 'commons-io:commons-io:2.21.0'
     * }
     * </pre>
     *
     ...
     *
     * configurations.all {
     *   resolutionStrategy.forcedModules = ['asm:asm-all:3.3.1', 'commons-io:commons-io:2.21.0']
     * }
     * </pre>
     *
