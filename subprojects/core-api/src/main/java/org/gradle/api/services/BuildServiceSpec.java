...
public interface BuildServiceSpec<P extends BuildServiceParameters> {
     ...
     *
     * <p>
     * IMPORTANT: the build service must be consumed via a {@link ServiceReference} property, or explicitly registered with every using task via {@link org.gradle.api.Task#usesService(Provider) Task#usesService}
