 ...
 * @since 3.5
 */
public interface VariantTransform extends ArtifactTransformRegistration {
     ...
     */
    void artifactTransform(Class<?> type);
     ...
     */
    void artifactTransform(Class<?> type, Action<? super ActionConfiguration> configAction);
}
