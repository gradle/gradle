...
public interface ExpandDetails {
    /**
     * Controls if the underlying {@code groovy.text.SimpleTemplateEngine} escapes backslashes in the file before processing. If this is set to {@code false} then escape sequences in the processed
