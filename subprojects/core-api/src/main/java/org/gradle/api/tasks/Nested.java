 ...
 * If it does not, the index in the iterable prefixed by {@code $} is used, e.g. {@code $0}.
 * The ordering of the elements in the iterable is crucial for for reliable up-to-date checks and caching if not all of the elements implement {@link org.gradle.api.Named}.</p>
