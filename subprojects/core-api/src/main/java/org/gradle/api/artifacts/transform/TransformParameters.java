 ...
 *     See the <a href="https://docs.gradle.org/current/userguide/incremental_builds.html#table:incremental_build_annotations">table of incremental build property type annotations</a> for all annotations which can be used.
 *     Example:
 * </p>
