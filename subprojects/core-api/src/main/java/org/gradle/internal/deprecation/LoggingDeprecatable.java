...
public class LoggingDeprecatable implements Deprecatable {
    ...
    public void checkDeprecation() {
        for (String deprecation : deprecations) {
            DeprecationLogger.deprecateBuildInvocationFeature(deprecation).willBeRemovedInNextMajorVersion().undocumented().nagUser();
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        return deprecations.equals(that.deprecations);
    }

    @Override
    public int hashCode() {
        return deprecations.hashCode();
    }
}
