...
package org.gradle.tooling.internal.events;
...
public class DefaultProgressListenerRegistry implements ProgressListenerRegistry {
    private final List<SubscribableBuildActionRunnerRegistration> registrations;
    private final ListenerManager listenerManager;
    private final BuildOperationListenerManager buildOperationListenerManager;

    public DefaultProgressListenerRegistry(List<SubscribableBuildActionRunnerRegistration> registrations, ListenerManager listenerManager, BuildOperationListenerManager buildOperationListenerManager) {
    ...
    public void register(Provider<? extends ProgressListener> listenerProvider) {
        ...
        for (SubscribableBuildActionRunnerRegistration registration : registrations) {
            Iterable<Object> listeners = registration.createListeners(new BuildClientSubscriptions(Collections.singleton(OperationType.TASK)), consumer);
