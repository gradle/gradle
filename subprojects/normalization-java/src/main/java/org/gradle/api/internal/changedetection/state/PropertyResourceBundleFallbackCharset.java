 ...
 *
 * This class is only necessary because <code>sun.util.PropertyResourceBundleCharset</code> is not
 * available in Java 8.  This class can be removed in favor of <code>sun.util.PropertyResourceBundleCharset</code>
