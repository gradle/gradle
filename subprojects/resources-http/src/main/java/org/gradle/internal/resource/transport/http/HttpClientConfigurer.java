...
public class HttpClientConfigurer {
    ...
    public void configure(HttpClientBuilder builder) {
        ...
        configureSslContext(builder, httpSettings.getSslContextFactory());
    ...
    private void configureSslContext(HttpClientBuilder builder, Factory<SSLContext> sslContextFactory) {
