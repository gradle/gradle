...
public class WebdavHttpConnectorFactory implements ResourceConnectorFactory {
    ...
    public WebdavHttpConnectorFactory(SslContextFactory sslContextFactory, HttpClientHelper.Factory httpClientHelperFactory) {
    ...
    public ExternalResourceConnector createResourceConnector(ResourceConnectorSpecification connectionDetails) {
        ...
        HttpResourceAccessor accessor = new WebdavHttpResourceAccessor(http);
        HttpResourceLister lister = new HttpResourceLister(accessor);
        WebdavHttpResourceUploader uploader = new WebdavHttpResourceUploader(connectionDetails.getAuthentications());
