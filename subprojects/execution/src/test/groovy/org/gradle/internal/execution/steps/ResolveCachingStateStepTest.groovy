...
class ResolveCachingStateStepTest extends StepSpec<BeforeExecutionContext> {
    ...
    def "disables caching when work is invalid"() {
        ...
        1 * delegate.execute(work, { CachingContext context ->
            ...
            context.cachingState.disabledReasons*.message == ["Caching has been disabled to ensure correctness due to validation failures. Please consult deprecation warnings for more details."]
        })
    }
