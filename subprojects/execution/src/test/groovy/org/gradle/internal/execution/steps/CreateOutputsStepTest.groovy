...
class CreateOutputsStepTest extends StepSpec {
    ...
    def "outputs are created"() {
        ...
        1 * work.visitOutputProperties(_ as UnitOfWork.OutputPropertyVisitor) >> { UnitOfWork.OutputPropertyVisitor visitor ->
            visitor.visitOutputProperty(outputFileProperty("dir", TreeType.DIRECTORY, ImmutableList.of(file("outDir"))))
            visitor.visitOutputProperty(outputFileProperty("dirs", TreeType.DIRECTORY, ImmutableList.of(file("outDir1"), file("outDir2"))))
            visitor.visitOutputProperty(outputFileProperty("file", TreeType.FILE, ImmutableList.of(file("parent/outFile"))))
            visitor.visitOutputProperty(outputFileProperty("files", TreeType.FILE, ImmutableList.of(file("parent1/outFile"), file("parent2/outputFile1"), file("parent2/outputFile2"))))
        }
