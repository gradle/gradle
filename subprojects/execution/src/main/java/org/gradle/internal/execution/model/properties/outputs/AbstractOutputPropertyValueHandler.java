...
package org.gradle.internal.execution.model.properties.outputs;
...
public class AbstractOutputPropertyValueHandler extends PropertyValueHandler {

    private final OutputFilePropertyType filePropertyType;

    public AbstractOutputPropertyValueHandler(Class<? extends Annotation> annotation, OutputFilePropertyType filePropertyType) {
        super(annotation);
