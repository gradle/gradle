...
public interface IncrementalInputProperties {
    ...
    InputFileChanges nonIncrementalChanges(ImmutableSortedMap<String, PreviousFileCollectionFingerprint> previous, ImmutableSortedMap<String, CurrentFileCollectionFingerprint> current);
    InputFileChanges incrementalChanges(ImmutableSortedMap<String, PreviousFileCollectionFingerprint> previous, ImmutableSortedMap<String, CurrentFileCollectionFingerprint> current);
