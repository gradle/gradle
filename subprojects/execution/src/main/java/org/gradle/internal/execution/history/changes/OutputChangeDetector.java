...
public class OutputChangeDetector {
    private final CompareStrategy.ChangeDetector<FileSystemLocationFingerprint> delegate;

    public OutputChangeDetector(CompareStrategy.ChangeDetector<FileSystemLocationFingerprint> delegate) {
    ...
    public boolean visitChangesSince(FileSystemSnapshot previous, FileSystemSnapshot current, String propertyTitle, ChangeVisitor visitor) {
        ...
        return delegate.visitChangesSince(
            previousFingerprint,
            currentFingerprint,
            propertyTitle,
            visitor);
