...
public class AbstractInputFilePropertyValueHandler extends PropertyValueHandler {

    private final InputFilePropertyType filePropertyType;

    public AbstractInputFilePropertyValueHandler(Class<? extends Annotation> annotation, InputFilePropertyType filePropertyType) {
        super(annotation);
