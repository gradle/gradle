...
public class DefaultAfterPreviousExecutionState extends AbstractExecutionState<SerializableFileCollectionFingerprint> implements AfterPreviousExecutionState {
    ...
    public DefaultAfterPreviousExecutionState(
        ...
        ImmutableSortedMap<String, SerializableFileCollectionFingerprint> inputFileProperties,
