...
public class DefaultAfterPreviousExecutionState extends AbstractExecutionState<PreviousFileCollectionFingerprint> implements AfterPreviousExecutionState {
    ...
    public DefaultAfterPreviousExecutionState(
        ...
        ImmutableSortedMap<String, PreviousFileCollectionFingerprint> inputFileProperties,
