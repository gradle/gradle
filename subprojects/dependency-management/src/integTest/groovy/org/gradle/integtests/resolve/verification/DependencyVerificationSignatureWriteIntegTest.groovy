...
import static org.gradle.security.fixtures.SigningFixtures.useSignatureFromResource
...
"""
    ...
    def "doesn't fail with non utf chars in keyring user id"() {
        PGPPublicKeyRing keyring = newKeyRingFromResource("/org/gradle/integtests/resolve/verification/DependencyVerificationSignatureWriteIntegTest/auto-value-public-key.asc")
        ...
        uncheckedModule("org", "foo", "1.0") {
            withSignature {
                useSignatureFromResource(it, '/org/gradle/integtests/resolve/verification/DependencyVerificationSignatureWriteIntegTest/auto-value-signature.asc')
            }
        }
        buildFile << """
            dependencies {
    ...
    def "doesn't fail with non utf chars"() {
        def verificationMetadata = file("gradle/verification-metadata.xml")
        verificationMetadata.parentFile.mkdirs()
        verificationMetadata << """<?xml version="1.0" encoding="UTF-8"?>
<verification-metadata xmlns="https://schema.gradle.org/dependency-verification" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="https://schema.gradle.org/dependency-verification https://schema.gradle.org/dependency-verification/dependency-verification-1.1.xsd">
   ...
   <components>
      <component group="com.google.auto" name="auto-parent" version="7">
         <artifact name="auto-parent-7.pom">
            <sha256 value="a46426fccb5d32705ad9cbbc996f786bd048cc8cbdd21db046500169f15a4356" origin="Generated by Gradle"/>
         </artifact>
      </component>
...
repositories {
    ...
    google()
            ...
            dependencies {
                implementation "com.google.auto.value:auto-value:1.82"
            }
        """

        expect:
        executer.withArguments("--write-verification-metadata", "sha256", "--export-keys")
        succeeds "jar"
    }
