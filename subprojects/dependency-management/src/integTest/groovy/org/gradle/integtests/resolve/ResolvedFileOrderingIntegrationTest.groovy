...
"""
        ...
        outputContains("artifacts 1: [test-lib.jar, a-lib.jar, b-lib.jar, c-lib.jar, a.jar, a.jar, test-1.0.jar, test-1.0-from-main.jar, test-1.0-from-a.jar, test-1.0-from-c.jar, b.jar, c.jar, test2-1.0.jar, test3-1.0.jar]")
