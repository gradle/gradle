...
class ConfigurationRoleUsageIntegrationTest extends AbstractIntegrationSpec implements ConfigurationUsageChangingFixture {
    ...
    def "can add declaration alternatives to configuration deprecated for declaration"() {
        ...
        buildFile << """
            configurations {
                def conf = migratingUnlocked("testConf", org.gradle.api.internal.artifacts.configurations.ConfigurationRolesForMigration.RESOLVABLE_BUCKET_TO_RESOLVABLE)
                conf.addDeclarationAlternatives("anotherConf")
            }
    ...
    def "can add resolution alternatives to configuration deprecated for resolution"() {
        ...
        buildFile << """
            configurations {
                deps
                def conf = migratingUnlocked("testConf", org.gradle.api.internal.artifacts.configurations.ConfigurationRolesForMigration.LEGACY_TO_CONSUMABLE)
                conf.addResolutionAlternatives("anotherConf")
