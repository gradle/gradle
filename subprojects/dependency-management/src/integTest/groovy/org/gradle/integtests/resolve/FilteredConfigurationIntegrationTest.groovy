...
"""
        ...
        outputContains("child1-dependencies: [child1-lib.jar, child1.jar, test2-1.0.jar]")
        outputContains("child1-dependencies resolved-config: [child1-lib.jar, child1.jar, test2-1.0.jar]")
