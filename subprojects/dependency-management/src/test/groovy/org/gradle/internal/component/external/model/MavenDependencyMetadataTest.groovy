...
class MavenDependencyMetadataTest extends DefaultDependencyMetadataTest {
    ...
    def "selects compile and master configurations from target when traversing from compile configuration"() {
        ...
        expect:
        dep.selectConfigurations(fromComponent, fromCompile, toComponent, attributesMatchingStrategy) as List == [toCompile, toMaster]
    }
    ...
    def "selects compile, runtime and master configurations from target when traversing from other configuration"() {
        ...
        expect:
        dep.selectConfigurations(fromComponent, fromRuntime, toComponent, attributesMatchingStrategy) as List == [toRuntime, toCompile, toMaster]
        dep.selectConfigurations(fromComponent, fromRuntime2, toComponent, attributesMatchingStrategy) as List == [toRuntime, toCompile, toMaster]
    }
    ...
    def "selects runtime and master configurations from target when traversing from other configuration and target's runtime extends compile"() {
        ...
        expect:
        dep.selectConfigurations(fromComponent, fromRuntime, toComponent, attributesMatchingStrategy) as List == [toRuntime, toMaster]
        dep.selectConfigurations(fromComponent, fromRuntime2, toComponent, attributesMatchingStrategy) as List == [toRuntime, toMaster]
    }
    ...
    def "ignores missing master configuration"() {
        ...
        expect:
        dep.selectConfigurations(fromComponent, fromRuntime, toComponent, attributesMatchingStrategy) as List == [toRuntime]
    }
    ...
    def "falls back to default configuration when compile is not defined in target component"() {
        ...
        expect:
        dep.selectConfigurations(fromComponent, fromCompile, toComponent, attributesMatchingStrategy) as List == [toDefault, toMaster]
    }
    ...
    def "falls back to default configuration when runtime is not defined in target component"() {
        ...
        expect:
        dep.selectConfigurations(fromComponent, fromRuntime, toComponent, attributesMatchingStrategy) as List == [toDefault, toMaster]
    }
    ...
    def "fails when compile configuration is not defined in target component"() {
        ...
        when:
        dep.selectConfigurations(fromComponent, fromCompile, toComponent, attributesMatchingStrategy)
    ...
    def "fails when runtime configuration is not defined in target component"() {
        ...
        when:
        dep.selectConfigurations(fromComponent, fromRuntime, toComponent, attributesMatchingStrategy)
