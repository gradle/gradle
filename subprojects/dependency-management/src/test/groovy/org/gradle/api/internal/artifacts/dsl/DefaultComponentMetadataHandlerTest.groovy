...
class DefaultComponentMetadataHandlerTest extends Specification {
    ...
    def executor = new ComponentMetadataRuleExecutor(Stub(GlobalScopedCacheFactory), Stub(DefaultInMemoryCacheDecoratorFactory), Stub(ValueSnapshotter), Stub(BuildCommencedTimeProvider), Stub(Serializer))
