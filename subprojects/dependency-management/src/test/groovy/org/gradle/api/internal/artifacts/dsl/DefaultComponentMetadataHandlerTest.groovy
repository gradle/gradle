...
class DefaultComponentMetadataHandlerTest extends Specification {
    ...
    def handler = new DefaultComponentMetadataHandler(TestUtil.instantiatorFactory().decorate(), moduleIdentifierFactory, stringInterner, AttributeTestUtil.attributesFactory(), SnapshotTestUtil.valueSnapshotter(), executor)
    RuleActionAdapter adapter = Mock(RuleActionAdapter)
    def mockedHandler = new DefaultComponentMetadataHandler(TestUtil.instantiatorFactory().decorate(), adapter, moduleIdentifierFactory, stringInterner, AttributeTestUtil.attributesFactory(), SnapshotTestUtil.valueSnapshotter(), executor)
