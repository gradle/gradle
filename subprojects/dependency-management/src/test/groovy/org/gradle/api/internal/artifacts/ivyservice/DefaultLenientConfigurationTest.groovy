...
class DefaultLenientConfigurationTest extends Specification {
    ...
    private DefaultLenientConfiguration newConfiguration() {
        new DefaultLenientConfiguration(configuration, selectFromAllVariants, null, artifactsResults, fileDependencyResults, resultsLoader, transforms, buildOperationExecutor, dependencyVerificationOverride, new TestWorkerLeaseService())
    }
