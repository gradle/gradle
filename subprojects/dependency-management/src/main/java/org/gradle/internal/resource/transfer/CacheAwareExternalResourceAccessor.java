...
public interface CacheAwareExternalResourceAccessor {
     ...
     * @param localCandidates a list of candidates, found in a different place than the cache. When null, will only look into the cache. When not null, the checksum of the
