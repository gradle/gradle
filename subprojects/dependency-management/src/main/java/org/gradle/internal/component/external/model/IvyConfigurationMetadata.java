...
class IvyConfigurationMetadata extends DefaultConfigurationMetadata {
    ...
    IvyConfigurationMetadata(ModuleComponentIdentifier componentId, String name, boolean transitive, boolean visible, ImmutableList<String> hierarchy, List<Exclude> excludes, ImmutableList<ModuleComponentArtifactMetadata> artifacts, DependencyMetadataRules dependencyMetadataRules) {
