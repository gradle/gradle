...
public class DependencyManagementGradleUserHomeScopeServices {
    ...
    ArtifactCachesProvider createArtifactCaches(
        ...
        DefaultArtifactCaches artifactCachesProvider = new DefaultArtifactCaches(globalScopedCache, cacheBuilderFactory, parameters, documentationRegistry, cleanupActionDecorator, cacheConfigurations);
