...
public class RootProjectAccessorSourceGenerator extends AbstractProjectAccessorsSourceGenerator {
    ...
    private static final String ROOT_PROJECT_ACCESSOR = "RootProjectAccessor";
    ...
    public static String generateSource(Writer writer,
        ...
        try {
            generator.generate(packageName, ROOT_PROJECT_ACCESSOR, root);
            return ROOT_PROJECT_ACCESSOR;
        } catch (IOException e) {
