...
public class DefaultIvyArtifactMetadataSource extends AbstractArtifactMetadataSource<MutableIvyModuleResolveMetadata> implements IvyArtifactMetadataSource {
    private final ImmutableModuleIdentifierFactory moduleIdentifierFactory;

    @Inject
    public DefaultIvyArtifactMetadataSource(ImmutableModuleIdentifierFactory moduleIdentifierFactory) {
