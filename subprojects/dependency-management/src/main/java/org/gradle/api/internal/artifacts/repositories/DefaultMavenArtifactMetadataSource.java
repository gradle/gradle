...
public class DefaultMavenArtifactMetadataSource extends AbstractArtifactMetadataSource<MutableMavenModuleResolveMetadata> implements MavenArtifactMetadataSource {
    private final ImmutableModuleIdentifierFactory moduleIdentifierFactory;

    @Inject
    public DefaultMavenArtifactMetadataSource(ImmutableModuleIdentifierFactory moduleIdentifierFactory) {
    ...
    protected MutableMavenModuleResolveMetadata createMissingComponentMetadata(ModuleComponentIdentifier moduleComponentIdentifier) {
        ...
        return MavenResolver.processMetaData(DefaultMutableMavenModuleResolveMetadata.missing(mvi, moduleComponentIdentifier));
    }
}
