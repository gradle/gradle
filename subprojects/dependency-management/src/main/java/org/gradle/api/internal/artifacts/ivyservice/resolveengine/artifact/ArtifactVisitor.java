...
public interface ArtifactVisitor {
    ...
    /**
     * Should {@link #visitFiles(ComponentIdentifier, FileCollection)} be called?
     */
     ...
     */
    void visitFiles(@Nullable ComponentIdentifier componentIdentifier, FileCollection files);
}
