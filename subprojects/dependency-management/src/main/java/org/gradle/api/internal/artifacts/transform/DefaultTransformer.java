...
public class DefaultTransformer extends AbstractTransformer<TransformAction> {
    ...
    private TransformAction newTransformAction(File inputFile, ArtifactTransformDependencies artifactTransformDependencies, IncrementalInputs incrementalInputs) {
        ServiceLookup services = new TransformServiceLookup(inputFile, getIsolatedParameters().getIsolatedParameterObject().isolate(), requiresDependencies ? artifactTransformDependencies : null, incremental ? incrementalInputs : null);
