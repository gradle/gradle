...
public interface ModuleArtifactsCache {
    CachedArtifacts cacheArtifacts(ModuleComponentRepository repository, ComponentIdentifier componentId, String context, BigInteger descriptorHash, Set<ModuleComponentArtifactIdentifier> artifacts);
