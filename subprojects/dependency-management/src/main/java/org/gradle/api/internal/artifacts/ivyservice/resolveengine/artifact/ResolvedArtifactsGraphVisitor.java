...
import org.gradle.api.internal.artifacts.ivyservice.resolveengine.DefaultModuleExcludeRuleFilter;
...
public class ResolvedArtifactsGraphVisitor implements DependencyGraphVisitor {
    ...
    private ArtifactSet getArtifacts(DependencyGraphEdge dependency, DependencyGraphNode childConfiguration) {
        ...
        if (!artifacts.isEmpty()) {
            return new DefaultArtifactSet(component.getId(), component.getSource(), DefaultModuleExcludeRuleFilter.all(), artifacts, artifactResolver, allResolvedArtifacts, id);
        }
