...
public interface ConfigurationRole {
    ...
    static ConfigurationRole forConfiguration(ConfigurationInternal configuration) {
        return forUsage(configuration.getName(), configuration.isCanBeConsumed(), configuration.isCanBeResolved(), configuration.isCanBeDeclaredAgainst(), configuration.isDeprecatedForConsumption(), configuration.isDeprecatedForResolution(), configuration.isDeprecatedForDeclarationAgainst());
    }
