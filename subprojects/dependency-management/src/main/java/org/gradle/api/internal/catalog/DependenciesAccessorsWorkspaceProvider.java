...
public class DependenciesAccessorsWorkspaceProvider implements WorkspaceProvider, Closeable {
    ...
    public DependenciesAccessorsWorkspaceProvider(BuildTreeScopedCache scopedCache, FileAccessTimeJournal fileAccessTimeJournal, InMemoryCacheDecoratorFactory inMemoryCacheDecoratorFactory, StringInterner stringInterner, ClassLoaderHierarchyHasher classLoaderHierarchyHasher) {
