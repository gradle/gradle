...
interface DependencyVerificationReportRenderer {
    ...
    void withErrors(Runnable action);
    void withArtifact(ModuleComponentArtifactIdentifier key, Runnable action);
    void reportFailure(RepositoryAwareVerificationFailure failure);
    void multipleErrors(Runnable action);
    void finish(DependencyVerificationReportWriter.HighLevelErrors highLevelErrors);
}
