...
/**
 * Extends a {@link DefaultConfiguration} to expose it as all three configuration types.
 */
public class DefaultLegacyConfiguration extends DefaultConfiguration implements ConsumableConfiguration, ResolvableConfiguration, DependenciesConfiguration {
