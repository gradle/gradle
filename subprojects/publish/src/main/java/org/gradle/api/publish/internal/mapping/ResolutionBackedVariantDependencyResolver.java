 ...
 * being published. Each outgoing edge of the analyzed resolution result will correspond
...
public class ResolutionBackedVariantDependencyResolver implements VariantDependencyResolver {
    ...
    private ModuleVersionIdentifier getProjectCoordinates(ResolvedVariantResult variant, ProjectComponentIdentifierInternal componentId, ComponentSelector requested, ImmutableAttributes requestAttributes) {
        ...
        //       We should not need to use the `projectDependencyResolver` here.
        ...
        if (coordinates == null) {
            ...
            // TODO: Work with AGP and KGP to avoid this. Then remove this functionality.
     ...
     * Perform a second round of attributes matching on all published configurations to see if we find a match.
