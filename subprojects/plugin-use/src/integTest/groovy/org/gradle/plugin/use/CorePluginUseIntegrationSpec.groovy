...
class CorePluginUseIntegrationSpec extends AbstractIntegrationSpec {
    ...
    void "core plugins cannot have a version number"() {
        ...
        then:
        failure.assertHasDescriptionStartingWith("Error resolving plugin [id: 'java', version: '1.0']")
    ...
    void "qualified core plugins cannot have a version number"() {
        ...
        then:
        failure.assertHasDescriptionStartingWith("Error resolving plugin [id: 'org.gradle.java', version: '1.0']")
    ...
    void "core plugins cannot be used with apply false"() {
        ...
        then:
        failure.assertHasDescriptionStartingWith("Error resolving plugin [id: 'java', apply: false]")
