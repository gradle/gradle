...
import org.gradle.tooling.events.internal.BaseAdvanceEvent;

public class DefaultBuildAdvanceEvent extends BaseAdvanceEvent implements BuildAdvanceEvent {

    public DefaultBuildAdvanceEvent(long eventTime, String displayName, BuildOperationDescriptor descriptor, BuildOperationResult result) {
