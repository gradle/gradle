...
public class ModelExceptionTransformer extends ExceptionTransformer {
    private final Class<?> modelType;

    public ModelExceptionTransformer(Class<?> modelType, Transformer<String, Throwable> connectionFailureProvider) {
        super(connectionFailureProvider);
