 ...
 *
 * <p>Consumer compatibility: This interface is used by all consumer versions from 1.8-rc-1 to 4.1. It is also used by later consumers when the provider does not
 ...
 *
 * @since 1.8-rc-1
 * @deprecated 4.2. Use {@link InternalBuildControllerVersion2} instead.
 */
@Deprecated
public interface InternalBuildController {
     ...
     *
     * <p>Consumer compatibility: This method is used by all consumer versions from 1.8-rc-1 to 4.1. It is also used by later consumers when the provider does not
     * implement newer interfaces.
     * </p>
     * <p>Provider compatibility: This method is implemented by all provider versions from 1.8-rc-1.</p>
     *
