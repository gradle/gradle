...
public class TaskSelectorsPropertyHandlerFactory {
    ...
    private static class ConsumerMapping implements Action<SourceObjectMapping>, Serializable {
        ...
        public void execute(SourceObjectMapping mapping) {
            if (GradleProject.class.isAssignableFrom(mapping.getTargetType()) && !versionDetails.supportsTaskSelectors()) {
                mapping.mixIn(GradleProjectTaksSelectorsMixInHandler.class);
            }
        }
    }
}
