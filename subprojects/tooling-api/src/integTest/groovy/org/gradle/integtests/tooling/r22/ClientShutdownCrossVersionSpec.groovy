...
"""
    ...
    private GradleExecuter daemonExecutor() {
        ...
        targetDist.executer(temporaryFolder).withDaemonBaseDir(toolingApi.daemonBaseDir).withBuildJvmOpts("-Xmx1024m", "-XX:MaxPermSize=256m", "-XX:+HeapDumpOnOutOfMemoryError").requireDaemon()
    }
}
