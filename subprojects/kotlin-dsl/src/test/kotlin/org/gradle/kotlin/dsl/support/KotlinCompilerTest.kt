...
class KotlinCompilerTest {
    ...
    @Test
    fun `Gradle JavaVersion greater than 18 to Kotlin JvmTarget conversion`() {
        JavaVersion.values().filter { it > JavaVersion.VERSION_18 }.forEach { javaVersion ->
            assertThat(javaVersion.toKotlinJvmTarget(), equalTo(JvmTarget.JVM_18))
        }
    }
}
