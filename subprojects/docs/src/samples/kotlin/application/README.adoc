...
For more information, see link:{userManualPath}/application_plugin.html[Application Plugin reference chapter] and link:https://kotlinlang.org/docs/reference/using-gradle.html[building a Kotlin project with Gradle reference].
You can also get started quickly using the link:{userManualPath}/build_init_plugin.html#sec:kotlin_application[Build Init Plugin].
