NOTE: You can open the samples inside a Android Studio IDE using the https://developer.android.com/studio/projects/create-project#ImportAProject[project importer].
...
For more information, we suggest reading <<getting_started.adoc#,Getting Started with Gradle>>.
