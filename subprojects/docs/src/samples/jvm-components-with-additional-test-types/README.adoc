...
====
include::sample[dir="samples/jvm-components-with-additional-test-types/groovy",files="library/build.gradle[]"]
include::sample[dir="samples/jvm-components-with-additional-test-types/kotlin",files="library/build.gradle.kts[]"]
====
