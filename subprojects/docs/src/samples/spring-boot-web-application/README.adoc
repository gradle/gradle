...
====
include::sample[dir="samples/spring-boot-web-application/groovy",files="build.gradle[]"]
include::sample[dir="samples/spring-boot-web-application/kotlin",files="build.gradle.kts[]"]
====
