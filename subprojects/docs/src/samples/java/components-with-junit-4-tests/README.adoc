...
====
include::sample[dir="samples/java-components-with-jUnit4Tests/groovy",files="library/build.gradle[]"]
include::sample[dir="samples/java-components-with-jUnit4Tests/kotlin",files="library/build.gradle.kts[]"]
====
