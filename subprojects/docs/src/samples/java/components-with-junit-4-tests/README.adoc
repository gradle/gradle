...
====
include::sample[dir="samples/java/components-with-junit-4-tests/groovy",files="application/build.gradle[]"]
include::sample[dir="samples/java/components-with-junit-4-tests/kotlin",files="application/build.gradle.kts[]"]
====

Libraries can be configured as follow:

====
include::sample[dir="samples/java/components-with-junit-4-tests/groovy",files="library/build.gradle[]"]
include::sample[dir="samples/java/components-with-junit-4-tests/kotlin",files="library/build.gradle.kts[]"]
====
