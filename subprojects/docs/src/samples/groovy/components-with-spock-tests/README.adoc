...
====
include::sample[dir="samples/groovy-components-with-spock-tests/groovy",files="library/build.gradle[]"]
include::sample[dir="samples/groovy-components-with-spock-tests/kotlin",files="library/build.gradle.kts[]"]
====
