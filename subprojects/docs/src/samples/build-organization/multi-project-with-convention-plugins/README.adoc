...
│   │   │       └── com.example.library-conventions.gradle
...
----
=====
[.multi-language-sample]
...
│   │   │       └── com.example.library-conventions.gradle.kts
...
----
=====
====
...
It applies `java-library` and `maven-publish` plugins as well as the `com.example.java-conventions` plugin.

The internal library subproject applies `com.example.java-conventions` plugin:
====
...
The two public library subprojects apply `com.example.library-conventions` plugin.
====
...
By applying `com.example.java-conventions` plugin we state: this is `com.example` organization's "Java" project.
By applying `com.example.library-conventions` plugin we state: this is `com.example` organization's "Library" project.
