...
====
include::sample[dir="groovy",files="buildSrc/src/main/kotlin/myproject.jvm-conventions.gradle.kts[]"]
include::sample[dir="kotlin",files="buildSrc/src/main/groovy/myproject.jvm-conventions.gradle[]"]
====
