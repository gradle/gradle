...
Common configuration for all projects are performed in a _convention plugin_:

====
include::sample[dir="groovy",files="buildSrc/src/main/groovy/myproject.jvm-conventions.gradle[]"]
include::sample[dir="kotlin",files="buildSrc/src/main/kotlin/myproject.jvm-conventions.gradle.kts[]"]
====
