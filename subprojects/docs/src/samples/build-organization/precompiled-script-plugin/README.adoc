...
====
include::sample[dir="groovy/plugin",files="build.gradle[tags=publishing]"]
include::sample[dir="kotlin/plugin",files="build.gradle.kts[tags=publishing]"]
====
...
This root of this sample contains a consumer project that demonstrates how the plugins can be consumed once they are published:
====
