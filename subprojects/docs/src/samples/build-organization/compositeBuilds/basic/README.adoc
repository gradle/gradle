...
====
include::sample[dir="groovy",files="my-app/build.gradle[tags=app_dependencies]"]
include::sample[dir="kotlin",files="my-app/build.gradle.kts[tags=app_dependencies]"]
====
...
====
include::sample[dir="groovy/composite",files="settings.gradle[]"]
include::sample[dir="kotlin/composite",files="settings.gradle.kts[]"]
====
...
====
include::sample[dir="groovy/composite",files="build.gradle[tags=run]"]
include::sample[dir="kotlin/composite",files="build.gradle.kts[tags=run]"]
====
