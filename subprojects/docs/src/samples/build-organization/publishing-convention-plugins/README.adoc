...
NOTE: There is also a link:sample_incubating_publishing_convention_plugins.html[new sample] demonstrating how to use the <<feature_lifecycle.adoc#feature_lifecycle,incubating>> link:{userManualPath}/test_suite_plugin.html[Test Suite Plugin] in this scenario.
