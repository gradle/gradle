...
The sample contains an example consumer project in `consumer-service` directory that demonstrates how the plugins can be consumed in a standalone project:
====
