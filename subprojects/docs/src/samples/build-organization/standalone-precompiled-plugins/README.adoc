...
This sample shows how precompiled script plugins can be used to compose build logic.

== Use case

Use case for this sample is an organization that produces two types of artifacts - services and libraries.
...
* `com.example.library` - configures publishing to company's repository.
...
In addition, they configure specifics for library and service artifacts.
...
The intended use for this project is to build and publish the plugins to a repository and consume them in other projects.
