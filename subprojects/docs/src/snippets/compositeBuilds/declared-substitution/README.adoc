...
====
include::sample[dir="groovy/my-app",files="settings.gradle[tags=composite_substitution]"]
include::sample[dir="kotlin/my-app",files="settings.gradle.kts[tags=composite_substitution]"]
====
