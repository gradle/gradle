...
dependencies {
    ...
    "integrationTestImplementation"(platform("org.spockframework:spock-bom:2.2-M3-groovy-4.0"))
    "integrationTestImplementation"("org.spockframework:spock-core")

    "functionalTestImplementation"(platform("org.spockframework:spock-bom:2.2-M3-groovy-4.0"))
