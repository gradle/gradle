...
val checkDependencies by tasks.registering {
    ...
    doLast {
        ...
        assert(configurations.getByName("testRuntimeClasspath").files.any { it.name == "junit-jupiter-5.8.2.jar" })
        ...
        assert(configurations.getByName("secondaryTestRuntimeClasspath").files.any { it.name == "junit-jupiter-5.8.2.jar" })
        ...
        assert(configurations.getByName("tertiaryTestRuntimeClasspath").files.any { it.name == "junit-jupiter-5.8.2.jar" })
