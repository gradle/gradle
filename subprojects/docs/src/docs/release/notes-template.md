...
See the [Gradle 6.x upgrade guide](userguide/upgrading_version_{previous-gradle-version}.html) to learn about breaking changes and considerations for upgrading from Gradle 5.x.
