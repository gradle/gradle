...
The new [`forwardOutput()`](javadoc/org/gradle/testkit/runner/GradleRunner.html#forwardOutput\(\)) method can be used to route the output from the build under test to the output stream of the process using the Gradle runner.
