...
The new report is generated by the [DependencyInsightReportTask task](javadoc/org/gradle/api/tasks/diagnostics/DependencyInsightReportTask.html).
Advanced users can create pre-configured instances of this task should they need to.
