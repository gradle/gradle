...
## Deprecation messages with documentation

Deprecation messages will include links to relevant documentation, explaining the deprecation and how to upgrade. For example:
