...
- [Jean-Baptiste Nizet](https://github.com/jnizet) — Include Kotlin DSL samples in Gradle Base Plugin, Announcements Plugins, Building Java Projects, Java Library, and Java Testing user manual chapters (gradle/gradle#6488, gradle/gradle#6500, gradle/gradle#6518, gradle/gradle#6521)
