...
### Injectable services available to Settings plugin

Our [injectable services](/userguide/custom_gradle_types.html#services_for_injection) are now available to Settings plugin.
