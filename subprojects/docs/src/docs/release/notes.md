...
A moment you have anticipated is nearly here, as the [Kotlin DSL reaches version 1.0 RC4](https://github.com/gradle/kotlin-dsl/releases/tag/v1.0-RC4).
...
[Kotlin DSL version 1.0 RC](https://github.com/gradle/kotlin-dsl/releases/tag/v1.0-RC4) is now available. Major updates from v0.18 include:
...
See the [Gradle Kotlin DSL release notes](https://github.com/gradle/kotlin-dsl/releases/tag/v1.0-RC4) for more information and how to fix builds broken by the changes described above.
