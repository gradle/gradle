...
#### Improved reloading for `PlayRun`
...
Gradle now supports the standard built-in Twirl templates for HTML, JavaScript, TXT and XML.

#### Build can provide custom Twirl template formats
...
#### Can specify additional imports for all Twirl templates

Gradle now supports adding arbitrary imports for packages and classes to the Scala/Java code generated by the Play Twirl template compiler.
