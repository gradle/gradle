...
and enhanced the experience of developing Play application using Gradle with continuous build.

In addition to this, this version of Gradle finally makes it easier use GitHub or BitBucket to back an authenticated Maven repository,
...
**NOTE**: This only affects wrappers _generated by_ Gradle 2.6.
          If you generated your wrapper with a older version, you can still update that wrapper to point to Gradle 2.6 without issue.
...
The authentication schemes to use are specified by adding them to the new <a href="dsl/org.gradle.api.artifacts.repositories.MavenArtifactRepository.html#org.gradle.api.artifacts.repositories.MavenArtifactRepository:authentication(org.gradle.api.Action)">authentication</a> element for a repository.
...
This release introduces new dependency management features for JVM components, our first step toward true variant-aware dependency resolution.
