...
The [input normalization](userguide/more_about_tasks.html#sec:configure_input_normalization) is now correctly tracked by the configuration cache. Task up-to-date checks now consider normalization
