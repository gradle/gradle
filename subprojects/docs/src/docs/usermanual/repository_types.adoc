...
.build.gradle
----
include::{samples-path}/userguide/artifacts/defineRepository/build.gradle[tag=flat-dir-multi]
----
...
.build.gradle
----
include::{samples-path}/userguide/artifacts/defineRepository/build.gradle[tag=maven-jcenter]
----
...
.build.gradle
----
include::{samples-path}/userguide/artifacts/defineRepository/build.gradle[tag=maven-google]
----
...
.build.gradle
----
include::{samples-path}/userguide/artifacts/defineRepository/build.gradle[tag=maven-local]
----
...
.build.gradle
----
include::{samples-path}/userguide/artifacts/defineRepository/build.gradle[tag=maven-like-repo]
----
...
.build.gradle
----
include::{samples-path}/userguide/artifacts/defineRepository/build.gradle[tag=maven-like-repo-with-jar-repo]
----
...
.build.gradle
----
include::{samples-path}/userguide/artifacts/defineRepository/build.gradle[tag=authenticated-maven-repo]
----
...
.build.gradle
----
include::{samples-path}/userguide/artifacts/defineRepository/build.gradle[tag=ivy-repo]
----
...
.build.gradle
----
include::{samples-path}/userguide/artifacts/defineRepository/build.gradle[tag=ivy-repo-with-pattern-layout]
----
...
.build.gradle
----
include::{samples-path}/userguide/artifacts/defineRepository/build.gradle[tag=ivy-repo-with-custom-pattern]
----
...
.build.gradle
----
include::{samples-path}/userguide/artifacts/defineRepository/build.gradle[tag=ivy-repo-with-m2compatible-layout]
----
...
.build.gradle
----
include::{samples-path}/userguide/artifacts/defineRepository/build.gradle[tag=authenticated-ivy-repo]
----
...
.build.gradle
----
include::{samples-path}/userguide/artifacts/defineRepository/build.gradle[tag=maven-repo-with-metadata-sources]
----
...
.build.gradle
----
include::{samples-path}/userguide/artifacts/defineRepository/build.gradle[tag=maven-ivy-repository-no-auth]
----
...
.build.gradle
----
include::{samples-path}/userguide/artifacts/defineRepository/build.gradle[tag=maven-ivy-repository-auth]
----

When using an AWS S3 backed repository you need to authenticate using link:{groovy-dsl-path}/org.gradle.api.credentials.AwsCredentials.html[AwsCredentials], providing access-key and a private-key. The following example shows how to declare a S3 backed repository and providing AWS credentials:
...
.build.gradle
----
include::{samples-path}/userguide/artifacts/defineRepository/build.gradle[tag=maven-ivy-s3-repository]
----
...
.build.gradle
----
include::{samples-path}/userguide/artifacts/defineRepository/build.gradle[tag=maven-ivy-s3-repository-with-iam]
----
...
.build.gradle
----
include::{samples-path}/userguide/artifacts/defineRepository/build.gradle[tag=maven-ivy-gcs-repository]
----
...
.build.gradle
----
include::{samples-path}/userguide/artifacts/defineRepository/build.gradle[tag=preemptive-authentication]
----
