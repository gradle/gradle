...
.build.gradle
----
include::{samples-path}/java-library/quickstart/build.gradle[tag=use-plugin]
----
...
.build.gradle
----
include::{samples-path}/java-library/quickstart/build.gradle[tag=dependencies]
----
...
----
include::{samples-path}/java-library/quickstart/src/main/java/org/gradle/HttpClientWrapper.java[tag=sample]
----
...
.a/build.gradle
----
include::{samples-path}/java-library/with-groovy/a/build.gradle[tag=configure-groovy]
----
