...
.build.gradle
----
include::{samples-path}/webApplication/quickstart/build.gradle[tag=use-war-plugin]
----
...
.build.gradle
----
include::{samples-path}/webApplication/quickstart/build.gradle[tag=use-gretty-plugin]
----
...
You can find out more about the War plugin in <<war_plugin#,War Plugin>>. You can find more sample Java projects in the `samples/webApplication` directory in the Gradle distribution.
