...
* Including the plugin from the plugin portal or a <<#sec:custom_plugin_repositories,custom repository>> using the plugins DSL (see <<plugins.adoc#sec:plugins_block,Applying plugins using the plugins DSL>>).
