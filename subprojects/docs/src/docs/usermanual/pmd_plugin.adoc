...
.build.gradle
----
include::{samples-path}/codeQuality/build.gradle[tag=use-pmd-plugin]
----
...
`pmdMain` — type: `link:{groovy-dsl-path}/org.gradle.api.plugins.quality.Pmd.html[Pmd]`::
+
Runs PMD against the production Java source files.

`pmdTest` — type: `link:{groovy-dsl-path}/org.gradle.api.plugins.quality.Pmd.html[Pmd]`::
+
Runs PMD against the test Java source files.

`pmd__SourceSet__` — type: `link:{groovy-dsl-path}/org.gradle.api.plugins.quality.Pmd.html[Pmd]`::
+
...
See the `link:{groovy-dsl-path}/org.gradle.api.plugins.quality.PmdExtension.html[PmdExtension]` class in the API documentation.
