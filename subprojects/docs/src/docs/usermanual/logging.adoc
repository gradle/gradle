...
[source.multi-language-sample,groovy]
----
include::{samples-path}/userguide/initScripts/customLogger/customLogger.sample.conf[tag=cli]
include::{samples-path}/userguide/initScripts/customLogger/build.out[]
----
