...
This can be used in conjunction with a proxy, authenticated or not. See <<build_environment#sec:accessing_the_web_via_a_proxy>> for more information on how to configure the `Wrapper` to use a proxy.
