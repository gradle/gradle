...
`distTar` — type: `link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task.html[Task]`::
Creates a TAR archive of the distribution contents.

`assembleDist` — type: `link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task.html[Task]`::
...
`assemble__DistributionName__Dist` — type: `link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task.html[Task]`::
