...
<sample id="model-language-support-all" dir="modelRules/language-support" includeLocation="true" title="strongly modelling sources sets">
    ...
    <output args="help" name="model-language-support-all.out"/>
</sample>
++++
...
[TIP]
====
The model DSL makes heavy use of various Groovy DSL features. Please have a read of <<writing_build_scripts#groovy-dsl-basics,Groovy DSL basics>> for an introduction to these Groovy features.
====
