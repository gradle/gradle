...
.build.gradle
----
include::{samples-path}/codeQuality/build.gradle[tag=use-codenarc-plugin]
----
...
`codenarcMain` — type: link:{groovy-dsl-path}/org.gradle.api.plugins.quality.CodeNarc.html[CodeNarc]::
+
Runs CodeNarc against the production Java source files.

`codenarcTest` — type: link:{groovy-dsl-path}/org.gradle.api.plugins.quality.CodeNarc.html[CodeNarc]::
+
Runs CodeNarc against the test Java source files.

`codenarc__SourceSet__` — type: link:{groovy-dsl-path}/org.gradle.api.plugins.quality.CodeNarc.html[CodeNarc]::
+
...
See the link:{groovy-dsl-path}/org.gradle.api.plugins.quality.CodeNarcExtension.html[CodeNarcExtension] class in the API documentation.
