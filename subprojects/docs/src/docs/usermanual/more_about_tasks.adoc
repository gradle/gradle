...
* `link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task:getInputs()[Task.getInputs()]` of type api:org.gradle.api.tasks.TaskInputs[]
* `link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task:getOutputs()[Task.getOutputs()]` of type api:org.gradle.api.tasks.TaskOutputs[]
* `link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task:getDestroyables()[Task.getDestroyables()]` of type api:org.gradle.api.tasks.TaskDestroyables[]
