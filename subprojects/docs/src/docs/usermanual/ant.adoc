...
In your build script, a property called `ant` is provided by Gradle. This is a reference to an `link:{groovy-dsl-path}/org.gradle.api.AntBuilder.html[AntBuilder]` instance. This `AntBuilder` is used to access Ant tasks, types and properties from your build script. There is a very simple mapping from Ant's `build.xml` format to Groovy, which is explained below.
...
.build.gradle
----
include::{samples-path}/userguide/ant/useAntTask/build.gradle[]
----

.Output of `gradle hello`
----
> gradle hello
include::{samples-path}/userguide/ant/useAntTask/useAntTask.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/ant/taskWithNestedText/build.gradle[]
----

.Output of `gradle hello`
----
> gradle hello
include::{samples-path}/userguide/ant/taskWithNestedText/taskWithNestedText.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/ant/taskWithNestedElements/build.gradle[]
----
...
.build.gradle
----
include::{samples-path}/userguide/ant/useAntType/build.gradle[]
----
...
.build.gradle
----
include::{samples-path}/userguide/ant/useExternalAntTask/build.gradle[]
----
...
.build.gradle
----
include::{samples-path}/userguide/ant/useExternalAntTaskWithConfig/build.gradle[tag=define-classpath]
----
...
.build.gradle
----
include::{samples-path}/userguide/ant/useExternalAntTaskWithConfig/build.gradle[tag=use-classpath]
----
...
.build.gradle
----
include::{samples-path}/userguide/ant/hello/build.gradle[]
----

[source,xml]
.build.xml
----
include::{samples-path}/userguide/ant/hello/build.xml[]
----
...
.build.gradle
----
include::{samples-path}/userguide/ant/dependsOnAntTarget/build.gradle[]
----

.Output of `gradle intro`
----
> gradle intro
include::{samples-path}/userguide/ant/dependsOnAntTarget/dependsOnAntTarget.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/ant/addBehaviourToAntTarget/build.gradle[]
----

.Output of `gradle hello`
----
> gradle hello
include::{samples-path}/userguide/ant/addBehaviourToAntTarget/addBehaviourToAntTarget.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/ant/dependsOnTask/build.gradle[]
----

[source,xml]
.build.xml
----
include::{samples-path}/userguide/ant/dependsOnTask/build.xml[]
----

.Output of `gradle hello`
----
> gradle hello
include::{samples-path}/userguide/ant/dependsOnTask/dependsOnTask.out[]
----

Sometimes it may be necessary to “rename” the task generated for an Ant target to avoid a naming collision with existing Gradle tasks. To do this, use the `link:{javadoc-path}/org/gradle/api/AntBuilder.html#importBuild-java.lang.Object,%20org.gradle.api.Transformer-[AntBuilder.importBuild(java.lang.Object, org.gradle.api.Transformer)]` method.
...
.build.gradle
----
include::{samples-path}/userguide/ant/renameTask/build.gradle[]
----

[source,xml]
.build.xml
----
include::{samples-path}/userguide/ant/renameTask/build.xml[]
----

.Output of `gradle a-hello`
----
> gradle a-hello
include::{samples-path}/userguide/ant/renameTask/renameAntDelegate.out[]
----

Note that while the second argument to this method should be a `link:{groovy-dsl-path}/org.gradle.api.Transformer.html[Transformer]`, when programming in Groovy we can simply use a closure instead of an anonymous inner class (or similar) due to http://mrhaki.blogspot.ie/2013/11/groovy-goodness-implicit-closure.html[Groovy's support for automatically coercing closures to single-abstract-method types].
...
.build.gradle
----
include::{samples-path}/userguide/ant/properties/build.gradle[tag=set-property]
----

[source,xml]
.build.xml
----
include::{samples-path}/userguide/ant/properties/build.xml[tag=setproperty]
----
...
.build.xml
----
include::{samples-path}/userguide/ant/properties/build.xml[tag=getproperty]
----

[source.multi-language-sample,groovy]
.build.gradle
----
include::{samples-path}/userguide/ant/properties/build.gradle[tag=get-property]
----
...
.build.gradle
----
include::{samples-path}/userguide/ant/properties/build.gradle[tag=set-reference]
----

[source,xml]
.build.xml
----
include::{samples-path}/userguide/ant/properties/build.xml[tag=setreference]
----
...
.build.gradle
----
include::{samples-path}/userguide/ant/properties/build.gradle[tag=get-reference]
----

[source,xml]
.build.xml
----
include::{samples-path}/userguide/ant/properties/build.xml[tag=getreference]
----
...
.build.gradle
----
include::{samples-path}/userguide/ant/antLogging/build.gradle[]
----

.Output of `gradle hello`
----
> gradle hello
include::{samples-path}/userguide/ant/antLogging/antLogging.out[]
----
...
The Ant integration is provided by `link:{groovy-dsl-path}/org.gradle.api.AntBuilder.html[AntBuilder]`.
