...
This chapter explains how to apply basic dependency management concepts to Java-based projects. For a detailed introduction to dependency management, see <<introduction_dependency_management#,Introduction to Dependency Management>>.
...
To find out more about defining dependencies, have a look at <<declaring_dependencies#,Declaring Dependencies>>.
...
With those three purposes in mind, let's take a look at a few of the <<java_library_plugin#sec:java_library_configurations_graph,standard configurations defined by the Java Library Plugin>>.
...
To find out more about defining repositories, have a look at <<declaring_repositories#,Declaring Repositories>>.
...
To learn more about publishing artifacts, have a look at <<artifact_management#,Artifact Management>>.
