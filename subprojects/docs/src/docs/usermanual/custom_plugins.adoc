...
Alternatively, if your plugin is published to the plugin portal, you can use the incubating plugins DSL (see <<plugins#sec:plugins_block,Applying plugins using the plugins DSL>>) to apply the plugin:
