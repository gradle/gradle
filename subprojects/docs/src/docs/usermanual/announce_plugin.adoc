...
.build.gradle
----
include::{samples-path}/announce/build.gradle[tag=use-plugin]
----

[[sec:announce_configuration]]
== Configuration

NOTE: See also the `link:{groovy-dsl-path}/org.gradle.api.plugins.announce.AnnouncePluginExtension.html[AnnouncePluginExtension]` class in the API documentation.
...
.build.gradle
----
include::{samples-path}/announce/build.gradle[tag=announce-plugin-conf]
----
...
.build.gradle
----
include::{samples-path}/announce/build.gradle[tag=announce-usage]
----
