...
<<Sharing copy specs,As described earlier>>, you can use the `link:{groovy-dsl-path}/org.gradle.api.Project.html#org.gradle.api.Project:copySpec(org.gradle.api.Action)[Project.copySpec(org.gradle.api.Action)]` method to share content between archives.
