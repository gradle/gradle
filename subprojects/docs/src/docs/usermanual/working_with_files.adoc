...
You can easily delete files and directories using either the `link:{groovy-dsl-path}/org.gradle.api.tasks.Delete.html[Delete]` task or the api:org.gradle.api.Project#delete(org.gradle.api.Action)[] method.
