...
* Configure the <<publishing_maven#,Maven>> or <<publishing_ivy#,Ivy>> publishing plugins to publish a <<plugins#sec:plugin_markers,Plugin Marker Artifact>> for each plugin.
