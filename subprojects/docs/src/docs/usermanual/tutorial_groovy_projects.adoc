...
.build.gradle
----
include::{samples-path}/groovy/quickstart/build.gradle[]
----
...
You can find out more about the <<groovy_plugin#,Groovy plugin>>, and you can find more sample Groovy projects in the `samples/groovy` directory in the Gradle distribution.
