...
A project can declare one or more dependencies. Gradle can visualize the whole dependency tree for every <<managing_dependency_configurations#sub:what_is_a_configuration,configuration>> available in the project.
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/inspectingDependencies/dependenciesReport/build.gradle[tag=dependency-declaration]
----
...
include::{samples-path}/userguide/dependencyManagement/inspectingDependencies/dependenciesReport/dependencyReport.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/inspectingDependencies/dependencyInsightReport/build.gradle[tag=dependency-declaration]
----
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/inspectingDependencies/dependencyReason/build.gradle[tag=dependency-reason]
----
...
include::{samples-path}/userguide/dependencyManagement/inspectingDependencies/dependencyReason/dependencyReasonReport.out[]
----
