...
In Gradle you can declare a link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task:setGroup(java.lang.String)[group] and a link:{groovy-dsl-path}/org.gradle.api.Task.html#api:org.gradle.api.Task:setDescription(java.lang.String)[description] for any task of the build.
