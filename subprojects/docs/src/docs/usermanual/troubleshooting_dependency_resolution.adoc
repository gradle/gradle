...
You can override the default cache modes using <<troubleshooting_dependency_resolution.adoc#sec:controlling_dependency_caching_command_line,command line options>>. You can also <<troubleshooting_dependency_resolution.adoc#sec:controlling_dependency_caching_programmatically,change the cache expiry times in your build programmatically>> using the resolution strategy.
