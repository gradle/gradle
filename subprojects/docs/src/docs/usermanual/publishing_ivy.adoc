...
This plugin provides <<publishing_overview#glossary:publication,publications>> of type link:{groovy-dsl-path}/org.gradle.api.publish.ivy.IvyPublication.html[IvyPublication]. To learn how to define and use publications, see the section on <<publishing_overview#sec:basic_publishing,basic publishing>>.
