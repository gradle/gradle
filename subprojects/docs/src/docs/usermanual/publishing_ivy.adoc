...
A published Ivy module can be consumed by Gradle (see <<declaring_dependencies#,"Declaring Dependencies">>) and other tools that understand the Ivy format. You can learn about the fundamentals of publishing in <<publishing_overview#,"Publishing Overview">>.
...
This plugin provides <<glossary:publication,publications>> of type `link:{groovy-dsl-path}/org.gradle.api.publish.ivy.IvyPublication.html[IvyPublication]`. To learn how to define and use publications, see the section on <<sec:basic_publishing,basic publishing>>.

There are four main things you can configure in an Ivy publication:

 * A <<glossary:component,component>> — via `link:{groovy-dsl-path}/org.gradle.api.publish.ivy.IvyPublication.html#org.gradle.api.publish.ivy.IvyPublication:from(org.gradle.api.component.SoftwareComponent)[IvyPublication.from(org.gradle.api.component.SoftwareComponent)]`.
 * <<sec:publishing_custom_artifacts_to_maven,Custom artifacts>> — via the `link:{groovy-dsl-path}/org.gradle.api.publish.ivy.IvyPublication.html#org.gradle.api.publish.ivy.IvyPublication:artifact(java.lang.Object)[IvyPublication.artifact(java.lang.Object)]` method. See `link:{groovy-dsl-path}/org.gradle.api.publish.ivy.IvyArtifact.html[IvyArtifact]` for the available configuration options for custom Ivy artifacts.
...
* `organisation` - `link:{groovy-dsl-path}/org.gradle.api.Project.html#org.gradle.api.Project:getGroup()[Project.getGroup()]`
* `module` - `link:{groovy-dsl-path}/org.gradle.api.Project.html#org.gradle.api.Project:getName()[Project.getName()]`
* `revision` - `link:{groovy-dsl-path}/org.gradle.api.Project.html#org.gradle.api.Project:getVersion()[Project.getVersion()]`
* `status` - `link:{groovy-dsl-path}/org.gradle.api.Project.html#org.gradle.api.Project:getStatus()[Project.getStatus()]`
* `branch` - (not set)
...
This plugin provides <<sub:terminology_repository,repositories>> of type `link:{groovy-dsl-path}/org.gradle.api.artifacts.repositories.IvyArtifactRepository.html[IvyArtifactRepository]`. To learn how to define and use repositories for publishing, see the section on <<sec:basic_publishing,basic publishing>>.
...
.build.gradle
----
include::{samples-path}/ivy-publish/java-multi-project/build.gradle[]
----
