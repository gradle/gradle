...
This plugin provides <<#glossary:publication,publications>> of type `link:{groovy-dsl-path}/org.gradle.api.publish.ivy.IvyPublication.html[IvyPublication]`. To learn how to define and use publications, see the section on <<publishing_overview#sec:basic_publishing,basic publishing>>.

There are four main things you can configure in an Ivy publication:

 * A <<publishing_overview#glossary:component,component>> — via `link:{groovy-dsl-path}/org.gradle.api.publish.ivy.IvyPublication.html#org.gradle.api.publish.ivy.IvyPublication:from(org.gradle.api.component.SoftwareComponent)[IvyPublication.from(org.gradle.api.component.SoftwareComponent)]`.
 * <<publishing_overview#sec:publishing_custom_artifacts_to_maven,Custom artifacts>> — via the `link:{groovy-dsl-path}/org.gradle.api.publish.ivy.IvyPublication.html#org.gradle.api.publish.ivy.IvyPublication:artifact(java.lang.Object)[IvyPublication.artifact(java.lang.Object)]` method. See `link:{groovy-dsl-path}/org.gradle.api.publish.ivy.IvyArtifact.html[IvyArtifact]` for the available configuration options for custom Ivy artifacts.
...
This plugin provides <<dependency_management_terminology#sub:terminology_repository,repositories>> of type `link:{groovy-dsl-path}/org.gradle.api.artifacts.repositories.IvyArtifactRepository.html[IvyArtifactRepository]`. To learn how to define and use repositories for publishing, see the section on <<publishing_overview#sec:basic_publishing,basic publishing>>.
