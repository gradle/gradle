...
.build.gradle
----
include::{samples-path}/userguide/javaLibraryDistribution/build.gradle[tag=use-plugin]
----
...
.build.gradle
----
include::{samples-path}/userguide/javaLibraryDistribution/build.gradle[tag=name-conf]
----
...
| `distZip`
| `jar`
| `link:{groovy-dsl-path}/org.gradle.api.tasks.bundling.Zip.html[Zip]`
...
.build.gradle
----
include::{samples-path}/userguide/javaLibraryDistribution/build.gradle[tag=custom-distribution]
----
