...
For configuring this directory or different kinds of build caches see <<build_cache.adoc#sec:build_cache_configure>>.
...
Task output caching is automatically enabled when you enable the build cache, see <<build_cache.adoc#sec:build_cache_enable>>.
