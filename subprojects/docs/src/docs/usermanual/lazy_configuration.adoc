...
- api:org.gradle.api.provider.ProviderFactory#provider(java.util.concurrent.Callable)[] instantiates a new `Provider`. An instance of the api:org.gradle.api.provider.ProviderFactory[] can be referenced from `link:{groovy-dsl-path}/org.gradle.api.Project.html#org.gradle.api.Project:getProviders()[Project.getProviders()]` or by injecting `ProviderFactory` through a constructor or method.
- api:org.gradle.api.model.ObjectFactory#property(java.lang.Class)[] instantiates a new `Property`. An instance of the api:org.gradle.api.model.ObjectFactory[] can be referenced from `link:{groovy-dsl-path}/org.gradle.api.Project.html#org.gradle.api.Project:getObjects()[Project.getObjects()]` or by injecting `ObjectFactory` through a constructor or method.
