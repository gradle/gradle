...
====
include::sample[dir="userguide/java/basic/groovy",files="build.gradle[tags=apply-java-plugin]"]
include::sample[dir="userguide/java/basic/kotlin",files="build.gradle.kts[tags=apply-java-plugin]"]
====
...
====
include::sample[dir="userguide/java/basic/groovy",files="build.gradle[tags=java-dependency-mgmt]"]
include::sample[dir="userguide/java/basic/kotlin",files="build.gradle.kts[tags=java-dependency-mgmt]"]
====
...
====
include::sample[dir="userguide/java/customDirs/groovy",files="build.gradle[tags=custom-src-dirs]"]
include::sample[dir="userguide/java/customDirs/kotlin",files="build.gradle.kts[tags=custom-src-dirs]"]
====
...
====
include::sample[dir="userguide/java/customDirs/groovy",files="build.gradle[tags=custom-extra-src-dir]"]
include::sample[dir="userguide/java/customDirs/kotlin",files="build.gradle.kts[tags=custom-extra-src-dir]"]
====
...
====
include::sample[dir="userguide/java/basic/groovy",files="build.gradle[tags=java-compiler-options]"]
include::sample[dir="userguide/java/basic/kotlin",files="build.gradle.kts[tags=java-compiler-options]"]
====
...
====
include::sample[dir="java/crossCompilation/groovy",files="build.gradle[tags=java-cross-compilation]"]
include::sample[dir="java/crossCompilation/kotlin",files="build.gradle.kts[tags=java-cross-compilation]"]
====
...
====
include::sample[dir="signing/maven-publish/groovy",files="build.gradle[tags=defining-sources-jar-task]"]
include::sample[dir="signing/maven-publish/kotlin",files="build.gradle.kts[tags=defining-sources-jar-task]"]
====
...
====
include::sample[dir="userguide/java/basic/groovy",files="build.gradle[tags=using-custom-doclet]"]
include::sample[dir="userguide/java/basic/kotlin",files="build.gradle.kts[tags=using-custom-doclet]"]
====
...
====
include::sample[dir="userguide/java/basic/groovy",files="build.gradle[tags=defining-custom-javadoc-task]"]
include::sample[dir="userguide/java/basic/kotlin",files="build.gradle.kts[tags=defining-custom-javadoc-task]"]
====
