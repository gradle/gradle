...
If you don't have much experience with building JVM-based projects with Gradle, take a look at the link:{guidesUrl}/?q=JVM[Java tutorials] for step-by-step instructions on how to build various types of basic Java projects.
...
====
include::sample[dir="snippets/userguide/java/basic/groovy",files="build.gradle[tags=apply-java-plugin]"]
include::sample[dir="snippets/userguide/java/basic/kotlin",files="build.gradle.kts[tags=apply-java-plugin]"]
====
...
====
include::sample[dir="snippets/userguide/java/basic/groovy",files="build.gradle[tags=java-dependency-mgmt]"]
include::sample[dir="snippets/userguide/java/basic/kotlin",files="build.gradle.kts[tags=java-dependency-mgmt]"]
====
...
Be aware that the <<java_library_plugin.adoc#java_library_plugin,Java Library Plugin>> creates an additional configuration — `api` — for dependencies that are required for compiling both the module and any modules that depend on it.
...
====
include::sample[dir="snippets/userguide/java/customDirs/groovy",files="build.gradle[tags=custom-src-dirs]"]
include::sample[dir="snippets/userguide/java/customDirs/kotlin",files="build.gradle.kts[tags=custom-src-dirs]"]
====
...
====
include::sample[dir="snippets/userguide/java/customDirs/groovy",files="build.gradle[tags=custom-extra-src-dir]"]
include::sample[dir="snippets/userguide/java/customDirs/kotlin",files="build.gradle.kts[tags=custom-extra-src-dir]"]
====
...
====
include::sample[dir="snippets/userguide/java/basic/groovy",files="build.gradle[tags=java-compiler-options]"]
include::sample[dir="snippets/userguide/java/basic/kotlin",files="build.gradle.kts[tags=java-compiler-options]"]
====
...
If you need or want more than one compilation task for any reason, you can either <<#sec:custom_java_source_sets,create a new source set>> or simply define a new task of type link:{groovyDslPath}/org.gradle.api.tasks.compile.JavaCompile.html[JavaCompile]. We look at setting up a new source set next.
...
You can easily create Java properties files via the link:{groovyDslPath}/org.gradle.api.tasks.WriteProperties.html[WriteProperties] task, which fixes a well-known problem with `Properties.store()` that can reduce the usefulness of <<more_about_tasks.adoc#sec:up_to_date_checks,incremental builds>>.
...
====
include::sample[dir="snippets/userguide/tutorial/manifest/groovy",files="build.gradle[tags=add-to-manifest]"]
include::sample[dir="snippets/userguide/tutorial/manifest/kotlin",files="build.gradle.kts[tags=add-to-manifest]"]
====
...
====
include::sample[dir="snippets/userguide/tutorial/manifest/groovy",files="build.gradle[tags=custom-manifest]"]
include::sample[dir="snippets/userguide/tutorial/manifest/kotlin",files="build.gradle.kts[tags=custom-manifest]"]
====
...
====
include::sample[dir="snippets/userguide/tutorial/manifest/groovy",files="build.gradle[tags=merge]"]
include::sample[dir="snippets/userguide/tutorial/manifest/kotlin",files="build.gradle.kts[tags=merge]"]
====
...
====
include::sample[dir="snippets/userguide/tutorial/manifest/groovy",files="build.gradle[tags=write]"]
include::sample[dir="snippets/userguide/tutorial/manifest/kotlin",files="build.gradle.kts[tags=write]"]
====
...
====
include::sample[dir="snippets/userguide/java/basic/groovy",files="build.gradle[tags=using-custom-doclet]"]
include::sample[dir="snippets/userguide/java/basic/kotlin",files="build.gradle.kts[tags=using-custom-doclet]"]
====
...
====
include::sample[dir="snippets/userguide/java/basic/groovy",files="build.gradle[tags=defining-custom-javadoc-task]"]
include::sample[dir="snippets/userguide/java/basic/kotlin",files="build.gradle.kts[tags=defining-custom-javadoc-task]"]
====
...
[WARNING]
====
Using a Java preview feature is very likely to make your code incompatible with one compiled without a feature preview. As a consequence, we strongly recommend you not to publish libraries compiled with preview features and restrict the use of feature previews either to toy projects.
====
...
====
include::sample[dir="snippets/userguide/tutorial/compileTaskClasspath/groovy",files="build.gradle[tags=compile-task-classpath]"]
include::sample[dir="snippets/userguide/tutorial/compileTaskClasspath/kotlin",files="build.gradle.kts[tags=compile-task-classpath]"]
====
