...
====
include::sample[dir="snippets/userguide/java/preview/groovy",files="build.gradle[tags=enabling-feature-preview]"]
include::sample[dir="snippets/userguide/java/preview/kotlin",files="build.gradle.kts[tags=enabling-feature-preview]"]
====
