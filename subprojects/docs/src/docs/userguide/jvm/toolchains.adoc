...
Given the snippet below, only toolchain are taken into accounts whos `java.vendor` property contains the given match string. Matching is done case-insensitive.
