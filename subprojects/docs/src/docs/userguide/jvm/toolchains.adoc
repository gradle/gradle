...
<3> You can configure toolchain repositories with the same set of <<repositories_cheat_sheet.adoc#sec:authentication_schemes,authentication and authorization options>> used for dependency management.
