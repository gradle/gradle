...
This is the most straightforward way to share configuration across _every_ test suite.  The configurations is lazily run for each test suite as it is created.
