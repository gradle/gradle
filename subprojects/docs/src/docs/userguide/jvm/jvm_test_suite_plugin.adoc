...
// TODO link:{groovyDslPath}/org.gradle.api.attributes.TestSuiteName.html[TestSuiteName]
// TODO link:{groovyDslPath}/org.gradle.api.attributes.TestSuiteTargetName.html[TestSuiteTargetName]
// TODO link:{groovyDslPath}/org.gradle.api.attributes.TestSuiteType.html[TestSuiteType]
