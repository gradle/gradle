...
====
include::sample[dir="snippets/application/groovy",files="build.gradle[tags=use-plugin]"]
include::sample[dir="snippets/application/kotlin",files="build.gradle.kts[tags=use-plugin]"]
====
...
====
include::sample[dir="snippets/application/groovy",files="build.gradle[tags=mainClass-conf]"]
include::sample[dir="snippets/application/kotlin",files="build.gradle.kts[tags=mainClass-conf]"]
====
...
====
include::sample[dir="snippets/application/groovy",files="build.gradle[tags=application-defaultjvmargs]"]
include::sample[dir="snippets/application/kotlin",files="build.gradle.kts[tags=application-defaultjvmargs]"]
====
...
====
include::sample[dir="snippets/application/groovy",files="build.gradle[tags=executableDir-conf]"]
include::sample[dir="snippets/application/kotlin",files="build.gradle.kts[tags=executableDir-conf]"]
====
...
====
include::sample[dir="snippets/application/groovy",files="build.gradle[tags=mainModule-conf]"]
include::sample[dir="snippets/application/kotlin",files="build.gradle.kts[tags=mainModule-conf]"]
====
...
[NOTE]
====
Java Module System support is an incubating feature and therefore you need to turn on _module path inference_ explicitly as shown below.
====

.Activate module path inference
====
include::sample[dir="snippets/application/groovy",files="build.gradle[tags=inferModulePath]"]
include::sample[dir="snippets/application/kotlin",files="build.gradle.kts[tags=inferModulePath]"]
====
...
====
include::sample[dir="snippets/application/groovy",files="build.gradle[tags=distribution-spec]"]
include::sample[dir="snippets/application/kotlin",files="build.gradle.kts[tags=distribution-spec]"]
====
...
----
> gradle distZip
include::{snippetsPath}/application/dependentTaskForApplicationDistributionOutput.out[]
----
...
====
include::sample[dir="snippets/application/groovy",files="build.gradle[tags=applicationName-conf]"]
include::sample[dir="snippets/application/kotlin",files="build.gradle.kts[tags=applicationName-conf]"]
====
