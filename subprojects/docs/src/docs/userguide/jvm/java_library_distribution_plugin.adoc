...
====
include::sample[dir="userguide/javaLibraryDistribution/groovy",files="build.gradle[tags=use-plugin]"]
include::sample[dir="userguide/javaLibraryDistribution/kotlin",files="build.gradle.kts[tags=use-plugin]"]
====
...
====
include::sample[dir="userguide/javaLibraryDistribution/groovy",files="build.gradle[tags=name-conf]"]
include::sample[dir="userguide/javaLibraryDistribution/kotlin",files="build.gradle.kts[tags=name-conf]"]
====
...
====
include::sample[dir="userguide/javaLibraryDistribution/groovy",files="build.gradle[tags=custom-distribution]"]
include::sample[dir="userguide/javaLibraryDistribution/kotlin",files="build.gradle.kts[tags=custom-distribution]"]
====
