...
====
include::sample[dir="snippets/javaLibraryDistribution/groovy",files="build.gradle[tags=use-plugin]"]
include::sample[dir="snippets/javaLibraryDistribution/kotlin",files="build.gradle.kts[tags=use-plugin]"]
====
...
====
include::sample[dir="snippets/javaLibraryDistribution/groovy",files="build.gradle[tags=name-conf]"]
include::sample[dir="snippets/javaLibraryDistribution/kotlin",files="build.gradle.kts[tags=name-conf]"]
====
...
====
include::sample[dir="snippets/javaLibraryDistribution/groovy",files="build.gradle[tags=custom-distribution]"]
include::sample[dir="snippets/javaLibraryDistribution/kotlin",files="build.gradle.kts[tags=custom-distribution]"]
====
