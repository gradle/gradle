...
[NOTE]
====
If you are working with the IntelliJ IDE, you may wish to flag the directories in these additional source sets as containing test source rather than production source as explained in <<idea_plugin.adoc#sec:idea_identify_additional_source_sets,the Idea Plugin>> documentation.
====
