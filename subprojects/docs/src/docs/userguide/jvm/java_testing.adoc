...
====
include::sample[dir="snippets/userguide/java/basic/groovy",files="build.gradle[tags=java-basic-test-config]"]
include::sample[dir="snippets/userguide/java/basic/kotlin",files="build.gradle.kts[tags=java-basic-test-config]"]
====
...
====
include::sample[dir="snippets/userguide/java/customDirs/groovy",files="build.gradle[tags=custom-report-dirs]"]
include::sample[dir="snippets/userguide/java/customDirs/kotlin",files="build.gradle.kts[tags=custom-report-dirs]"]
====
...
====
include::sample[dir="snippets/testing/testReport/groovy",files="build.gradle[tags=test-report]"]
include::sample[dir="snippets/testing/testReport/kotlin",files="build.gradle.kts[tags=test-report]"]
====
...
====
include::sample[dir="snippets/userguide/java/basic/groovy",files="build.gradle[tags=practical-integ-test-source-set]"]
include::sample[dir="snippets/userguide/java/basic/kotlin",files="build.gradle.kts[tags=practical-integ-test-source-set]"]
====
...
====
include::sample[dir="snippets/userguide/java/basic/groovy",files="build.gradle[tags=integ-test-task]"]
include::sample[dir="snippets/userguide/java/basic/kotlin",files="build.gradle.kts[tags=integ-test-task]"]
====
...
However, there are some things to consider depending on whether you need module information to be available, and module boundaries to be enforced, during test runtime.
In this context, often the terms _whitebox testing_ (module boundaries are deactivated or relaxed) and _blackbox testing_ (module boundaries are in place) are used.
Whitebox testing if often used/needed for unit testing and blackbox testing often fits functional or integration test requirements.
...
The simplest setup to write unit tests for functions or classes in modules is to _not_ use module specifics during test runtime.
...
NOTE: If you are using Eclipse: By default, Eclipse also runs unit tests as modules using module patching (see <<#sec:java_testing_modular_patching,below>>).
...
NOTE: If you are using Eclipse: Eclipse does currently https://bugs.eclipse.org/bugs/show_bug.cgi?id=520667[not support] defining multiple modules in one project.
...
Another approach for whitebox testing is to not leave the module world completely, but _patch_ the tests into the module under test.
...
====
include::sample[dir="snippets/userguide/java/basic/groovy",files="build.gradle[tags=skip-tests-condition]"]
include::sample[dir="snippets/userguide/java/basic/kotlin",files="build.gradle.kts[tags=skip-tests-condition]"]
====
...
====
include::sample[dir="snippets/userguide/java/fixtures/groovy",files="lib/build.gradle[tags=use-plugin]"]
include::sample[dir="snippets/userguide/java/fixtures/kotlin",files="lib/build.gradle.kts[tags=use-plugin]"]
====
...
====
include::sample[dir="snippets/userguide/java/fixtures/groovy",files="lib/build.gradle[tags=test_fixtures_deps]"]
include::sample[dir="snippets/userguide/java/fixtures/kotlin",files="lib/build.gradle.kts[tags=test_fixtures_deps]"]
====
...
====
include::sample[dir="snippets/userguide/java/fixtures/groovy",files="build.gradle[tags=consumer_dependencies]"]
include::sample[dir="snippets/userguide/java/fixtures/kotlin",files="build.gradle.kts[tags=consumer_dependencies]"]
====
...
====
include::sample[dir="snippets/userguide/java/fixtures/groovy",files="build.gradle[tags=external-test-fixtures-dependency]"]
include::sample[dir="snippets/userguide/java/fixtures/kotlin",files="build.gradle.kts[tags=external-test-fixtures-dependency]"]
====
...
====
include::sample[dir="snippets/userguide/java/fixtures/groovy/lib",files="build.gradle[tags=disable-test-fixtures-publishing]"]
include::sample[dir="snippets/userguide/java/fixtures/kotlin/lib",files="build.gradle.kts[tags=disable-test-fixtures-publishing]"]
====
