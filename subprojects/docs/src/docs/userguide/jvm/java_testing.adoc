...
----
> gradle -q showDirs
include::{samplesPath}/java/customDirs/javaCustomReportDirs.out[]
----
...
----
include::{samplesPath}/java/fixtures/groovy/lib/src/main/java/com/acme/Person.java[tags=sample]
----
...
----
include::{samplesPath}/java/fixtures/groovy/lib/src/testFixtures/java/com/acme/Simpsons.java[tags=sample]
----
...
include::{samplesPath}/java/fixtures/dependencyInsight.out[]
----
