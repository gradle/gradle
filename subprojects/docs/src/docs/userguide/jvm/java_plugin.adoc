...
----
include::{snippetsPath}/java/incrementalAnnotationProcessing/groovy/processor/src/main/java/ServiceRegistryProcessor.java[tag=options-of-dynamic-processor]
----
...
----
include::{snippetsPath}/java/incrementalAnnotationProcessing/groovy/processor/src/main/java/EntityProcessor.java[tag=isolating-annotation-processor]
----
...
.processor/src/main/java/ServiceRegistryProcessor.java
----
include::{snippetsPath}/java/incrementalAnnotationProcessing/groovy/processor/src/main/java/ServiceRegistryProcessor.java[tag=aggregating-annotation-processor]
----
