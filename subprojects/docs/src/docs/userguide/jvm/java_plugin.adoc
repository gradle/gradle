...
====
include::sample[dir="userguide/java/basic/groovy",files="build.gradle[tags=java-extension]"]
include::sample[dir="userguide/java/basic/kotlin",files="build.gradle.kts[tags=java-extension]"]
====
