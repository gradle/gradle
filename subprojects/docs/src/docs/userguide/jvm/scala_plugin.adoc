...
====
include::sample[dir="snippets/scala/quickstart/groovy",files="build.gradle[tags=scala3-dependency]"]
include::sample[dir="snippets/scala/quickstart/kotlin",files="build.gradle.kts[tags=scala3-dependency]"]
====
