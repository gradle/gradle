...
_Depends on_: `compileJava` (can be turned off with `java { withoutCompileJavaFirst() }`)
+
...
_Depends on_: `compileTestJava` (can be turned off with `java { withoutCompileJavaFirst() }`)
+
...
_Depends on_: `compile__SourceSet__Java` (can be turned off with `java { withoutCompileJavaFirst() }`)
+
