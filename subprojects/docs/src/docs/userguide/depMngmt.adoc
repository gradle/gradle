...
| A pre-configured repository that looks for dependencies in Google repository.
...
The Google repository hosts Android-specific artifacts including the Android SDK. __Note:__ The contents of the repository cannot be explored from the browser.
