...
====
include::sample[dir="scala/quickstart/groovy",files="build.gradle[tags=use-plugin]"]
include::sample[dir="scala/quickstart/kotlin",files="build.gradle.kts[tags=use-plugin]"]
====
...
====
include::sample[dir="scala/customizedLayout/groovy",files="build.gradle[tags=custom-source-locations]"]
include::sample[dir="scala/customizedLayout/kotlin",files="build.gradle.kts[tags=custom-source-locations]"]
====
...
====
include::sample[dir="scala/quickstart/groovy",files="build.gradle[tags=scala-dependency]"]
include::sample[dir="scala/quickstart/kotlin",files="build.gradle.kts[tags=scala-dependency]"]
====
...
====
include::sample[dir="userguide/scala/scalaDependency/groovy",files="build.gradle[tags=scala-test-dependency]"]
include::sample[dir="userguide/scala/scalaDependency/kotlin",files="build.gradle.kts[tags=scala-test-dependency]"]
====
...
The Scala plugin uses a configuration named `zinc` to resolve the https://github.com/typesafehub/zinc[Zinc compiler] and its dependencies. Gradle will provide a default version of Zinc, but if you need to use a particular Zinc version, you can add an explicit dependency like `“org.scala-sbt:zinc_2.12:1.2.5”` to the `zinc` configuration. Gradle supports version 1.2.0 of Zinc and above.

.Declaring a version of the Zinc compiler to use
====
include::sample[dir="userguide/scala/zincDependency/groovy",files="build.gradle[tags=zinc-dependency]"]
...
.Forcing a scala-library dependency for all configurations
====
include::sample[dir="userguide/scala/zincOverride/groovy",files="build.gradle[tags=all-dependency]"]
include::sample[dir="userguide/scala/zincOverride/kotlin",files="build.gradle.kts[tags=all-dependency]"]
====
...
.Forcing a scala-library dependency for the zinc configuration
====
include::sample[dir="userguide/scala/zincOverride/groovy",files="build.gradle[tags=zinc-dependency]"]
include::sample[dir="userguide/scala/zincOverride/kotlin",files="build.gradle.kts[tags=zinc-dependency]"]
====
...
====
include::sample[dir="scala/zinc/groovy",files="build.gradle[tags=adjust-memory]"]
include::sample[dir="scala/zinc/kotlin",files="build.gradle.kts[tags=adjust-memory]"]
====
...
====
include::sample[dir="scala/force/groovy",files="build.gradle[tags=force-compilation]"]
include::sample[dir="scala/force/kotlin",files="build.gradle.kts[tags=force-compilation]"]
====
...
====
include::sample[dir="scala/crossCompilation/groovy",files="build.gradle[tags=scala-cross-compilation]"]
include::sample[dir="scala/crossCompilation/kotlin",files="build.gradle.kts[tags=scala-cross-compilation]"]
====
...
====
include::sample[dir="userguide/scala/ideaTargetVersion/groovy",files="build.gradle[tags=scala-idea-target-version]"]
include::sample[dir="userguide/scala/ideaTargetVersion/kotlin",files="build.gradle.kts[tags=scala-idea-target-version]"]
====
