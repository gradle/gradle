...
| Old: `task myTask(type: MyTask) {}`
.2+| There is not a shorthand Groovy DSL for using the new API.
| New: `tasks.register("myTask", MyTask) {}`

| Old: api:org.gradle.api.tasks.TaskContainer#create(java.util.Map)[]
.2+| Use one of the alternatives below.
| New: No direct equivalent.

| Old: api:org.gradle.api.tasks.TaskContainer#create(java.util.Map,groovy.lang.Closure)[]
.2+| Use one of the alternatives below.
| New: No direct equivalent.

| Old: api:org.gradle.api.tasks.TaskContainer#create(java.lang.String)[]
.2+| This returns a `TaskProvider` instead of a `Task`.
| New: api:org.gradle.api.tasks.TaskContainer#register(java.lang.String)[]

| Old: api:org.gradle.api.tasks.TaskContainer#create(java.lang.String,groovy.lang.Closure)[]
.2+| This returns a `TaskProvider` instead of a `Task`.
| New: api:org.gradle.api.tasks.TaskContainer#register(java.lang.String,org.gradle.api.Action)[]

| Old: api:org.gradle.api.tasks.TaskContainer#create(java.lang.String,java.lang.Class)[]
.2+| This returns a `TaskProvider` instead of a `Task`.
| New: api:org.gradle.api.tasks.TaskContainer#register(java.lang.String,java.lang.Class)[]

| Old: api:org.gradle.api.tasks.TaskContainer#create(java.lang.String,java.lang.Class,org.gradle.api.Action)[]
.2+| This returns a `TaskProvider` instead of a `Task`.
| New: api:org.gradle.api.tasks.TaskContainer#register(java.lang.String,java.lang.Class,org.gradle.api.Action)[]

| Old: api:org.gradle.api.tasks.TaskContainer#create(java.lang.String,java.lang.Class,java.lang.Object...)[]
.2+| This returns a `TaskProvider` instead of a `Task`.
| New: api:org.gradle.api.tasks.TaskContainer#register(java.lang.String,java.lang.Class,java.lang.Object...)[]

| Old: api:org.gradle.api.tasks.TaskCollection#getByName(java.lang.String)[]
.2+| This returns a `TaskProvider` instead of a `Task`.
| New: api:org.gradle.api.tasks.TaskCollection#named(java.lang.String)[]

| Old: api:org.gradle.api.tasks.TaskCollection#getByName(java.lang.String,groovy.lang.Closure)[]
.2+| This returns a `TaskProvider` instead of a `Task`.
| New: `named(java.lang.String).configure(Action)`

| Old: api:org.gradle.api.tasks.TaskContainer#getByPath(java.lang.String)[]
.2+| Accessing tasks from another project requires a specific ordering of project evaluation. 
| New: No direct equivalent.

| Old: api:org.gradle.api.NamedDomainObjectCollection#findByName(java.lang.String)[]
...
| Old: api:org.gradle.api.tasks.TaskContainer#findByPath(java.lang.String)[]
.2+| See `getByPath(String)` above.
| New: No direct equivalent.

| Old: api:org.gradle.api.tasks.TaskCollection#withType(java.lang.Class)[]
.2+| This is OK to use because it does not require tasks to be created immediately.
| New: _OK_

| Old: `withType(java.lang.Class).getByName(java.lang.String)`
.2+| This returns a `TaskProvider` instead of a `Task`.
| New: `withType(java.lang.Class).named(java.lang.String)`

| Old: api:org.gradle.api.DomainObjectCollection#withType(java.lang.Class,org.gradle.api.Action)[]
.2+| This returns `void`, so it cannot be chained.
| New: `withType(java.lang.Class).configureEach(org.gradle.api.Action)`

| Old: api:org.gradle.api.DomainObjectCollection#all(org.gradle.api.Action)[]
.2+| This returns `void`, so it cannot be chained.
| New: api:org.gradle.api.DomainObjectCollection#configureEach(org.gradle.api.Action)[]

| Old: api:org.gradle.api.NamedDomainObjectSet#findAll(groovy.lang.Closure)[]
.2+| Avoid calling this method. `matching(Spec)` and `configureEach(Action)` are more appropriate in most cases.
| New: _OK_, with issues.

| Old: api:org.gradle.api.tasks.TaskCollection#matching(groovy.lang.Closure)[]
.2+| This is OK to use because it does not require tasks to be created immediately.
| New: _OK_

| Old: api:org.gradle.api.tasks.TaskCollection#getAt(java.lang.String)[]
