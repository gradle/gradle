...
For example, the {cpp} Unit Test Plugin attaches a task to this lifecycle task to run tests.
This task is added by the <<base_plugin.adoc,Base Plugin>>.
...
The {cpp} Application Plugin will compile whatever it finds and ignores anything missing.
