...
====
include::sample[dir="maven/quickstart",files="build.gradle[tags=use-plugin]"]
====
...
====
include::sample[dir="maven/pomGeneration",files="build.gradle[tags=new-pom]"]
====
...
====
include::sample[dir="userguide/artifacts/maven",files="build.gradle[tags=upload-file]"]
====
...
====
include::sample[dir="userguide/artifacts/maven",files="build.gradle[tags=upload-with-ssh]"]
====
...
====
include::sample[dir="userguide/artifacts/maven",files="build.gradle[tags=customize-pom]"]
====
...
====
include::sample[dir="userguide/artifacts/maven",files="build.gradle[tags=builder]"]
====
...
====
include::sample[dir="maven/pomGeneration",files="build.gradle[tags=when-configured]"]
====
...
====
include::sample[dir="userguide/artifacts/maven",files="build.gradle[tags=customize-installer]"]
====
...
====
include::sample[dir="userguide/artifacts/maven",files="build.gradle[tags=multiple-poms]"]
====
...
====
include::sample[dir="userguide/artifacts/maven",files="build.gradle[tags=mappings]"]
====
