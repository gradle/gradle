...
====
include::sample[dir="userguide/tutorial/helloShortcut/groovy", files="build.gradle[]"]
====
...
====
include::sample[dir="userguide/tutorial/extraProperties/groovy", files="build.gradle[tag=taskProperties]"]
...
====
include::sample[dir="userguide/tutorial/externalDependency/groovy", files="build.gradle[tag=declare-classpath]"]
====
...
====
include::sample[dir="userguide/tutorial/externalDependency/groovy", files="build.gradle[tag=all]"]
