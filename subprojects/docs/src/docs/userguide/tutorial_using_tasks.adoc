...
====
include::sample[dir="userguide/tutorial/hello", files="build.gradle[]"]
====
...
.A task definition shortcut
====
include::sample[dir="userguide/tutorial/helloShortcut", files="build.gradle[]"]
====
...
====
include::sample[dir="userguide/tutorial/upper", files="build.gradle[]"]
...
.Using Groovy in Gradle's tasks
====
include::sample[dir="userguide/tutorial/count", files="build.gradle[]"]
...
====
include::sample[dir="userguide/tutorial/intro", files="build.gradle[]"]
...
====
include::sample[dir="userguide/tutorial/lazyDependsOn", files="build.gradle[]"]
...
====
include::sample[dir="userguide/tutorial/dynamic", files="build.gradle[]"]
...
====
include::sample[dir="userguide/tutorial/dynamicDepends", files="build.gradle[]"]
...
====
include::sample[dir="userguide/tutorial/helloEnhanced", files="build.gradle[]"]
...
====
include::sample[dir="userguide/tutorial/helloWithShortCut", files="build.gradle[]"]
...
====
include::sample[dir="userguide/tutorial/extraProperties", files="build.gradle[tag=taskProperties]"]
...
====
include::sample[dir="userguide/tutorial/antLoadfile", files="build.gradle[]"]
...
====
include::sample[dir="userguide/tutorial/antLoadfileWithMethod", files="build.gradle[]"]
...
====
include::sample[dir="userguide/tutorial/defaultTasks", files="build.gradle[]"]
...
====
include::sample[dir="userguide/tutorial/configByDag", files="build.gradle[]"]
...
====
include::sample[dir="userguide/tutorial/externalDependency", files="build.gradle[tag=declare-classpath]"]
====
...
====
include::sample[dir="userguide/tutorial/externalDependency", files="build.gradle[tag=all]"]
