...
.build.gradle
----
include::{samples-path}/userguide/tutorial/hello/build.gradle[]
----
...
----
> gradle -q hello
include::{samples-path}/userguide/tutorial/hello/hello.out[]
----
...
This functionality is deprecated and will be removed in Gradle 5.0 without replacement. Use the methods link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task:doFirst(org.gradle.api.Action)[Task.doFirst(org.gradle.api.Action)] and link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task:doLast(org.gradle.api.Action)[Task.doLast(org.gradle.api.Action)] to define an action instead, as demonstrated by the rest of the examples in this chapter.
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/helloShortcut/build.gradle[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/upper/build.gradle[]
----

.Output of **`gradle -q upper`**
----
> gradle -q upper
include::{samples-path}/userguide/tutorial/upper/upper.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/count/build.gradle[]
----

.Output of **`gradle -q count`**
----
> gradle -q count
include::{samples-path}/userguide/tutorial/count/count.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/intro/build.gradle[]
----

.Output of **`gradle -q intro`**
----
> gradle -q intro
include::{samples-path}/userguide/tutorial/intro/intro.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/lazyDependsOn/build.gradle[]
----

.Output of **`gradle -q taskX`**
----
> gradle -q taskX
include::{samples-path}/userguide/tutorial/lazyDependsOn/lazyDependsOn.out[]
----
...
Please notice that you can't use <<tutorial_using_tasks.adoc#sec:shortcut_notations, shortcut notation>> when referring to a task that is not yet defined.
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/dynamic/build.gradle[]
----

.Output of **`gradle -q task1`**
----
> gradle -q task1
include::{samples-path}/userguide/tutorial/dynamic/dynamic.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/dynamicDepends/build.gradle[]
----

.Output of **`gradle -q task0`**
----
> gradle -q task0
include::{samples-path}/userguide/tutorial/dynamicDepends/dynamicDepends.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/helloEnhanced/build.gradle[]
----

.Output of **`gradle -q hello`**
----
> gradle -q hello
include::{samples-path}/userguide/tutorial/helloEnhanced/helloEnhanced.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/helloWithShortCut/build.gradle[]
----

.Output of **`gradle -q hello`**
----
> gradle -q hello
include::{samples-path}/userguide/tutorial/helloWithShortCut/helloWithShortCut.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/extraProperties/build.gradle[tag=taskProperties]
----

.Output of **`gradle -q printTaskProperties`**
----
> gradle -q printTaskProperties
include::{samples-path}/userguide/tutorial/extraProperties/extraTaskProperties.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/antLoadfile/build.gradle[]
----

.Output of **`gradle -q loadfile`**
----
> gradle -q loadfile
include::{samples-path}/userguide/tutorial/antLoadfile/antLoadfile.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/antLoadfileWithMethod/build.gradle[]
----

.Output of **`gradle -q loadfile`**
----
> gradle -q loadfile
include::{samples-path}/userguide/tutorial/antLoadfileWithMethod/antLoadfileWithMethod.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/defaultTasks/build.gradle[]
----

.Output of **`gradle -q`**
----
> gradle -q
include::{samples-path}/userguide/tutorial/defaultTasks/defaultTasks.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/configByDag/build.gradle[]
----

.Output of `gradle -q distribution`
----
> gradle -q distribution
include::{samples-path}/userguide/tutorial/configByDag/configByDagNoRelease.out[]
----

.Output of `gradle -q release`
----
> gradle -q release
include::{samples-path}/userguide/tutorial/configByDag/configByDag.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/externalDependency/build.gradle[tag=declare-classpath]
----

The closure passed to the `buildscript()` method configures a link:{javadoc-path}/org/gradle/api/initialization/dsl/ScriptHandler.html[ScriptHandler] instance. You declare the build script classpath by adding dependencies to the `classpath` configuration. This is the same way you declare, for example, the Java compilation classpath. You can use any of the <<dependency_types.adoc#dependency_types,dependency types>> except project dependencies.
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/externalDependency/build.gradle[tag=all]
----

.Output of **`gradle -q encode`**
----
> gradle -q encode
include::{samples-path}/userguide/tutorial/externalDependency/externalBuildDependency.out[]
----
...
Every project automatically has a `buildEnvironment` task of type link:{groovy-dsl-path}/org.gradle.api.tasks.diagnostics.BuildEnvironmentReportTask.html[BuildEnvironmentReportTask] that can be invoked to report on the resolution of the build script dependencies.
