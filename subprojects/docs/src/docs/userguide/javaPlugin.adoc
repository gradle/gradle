...
_The classpath to use when compiling the source files of this source set._ Default value: `compile__SourceSet__` configuration.

`api:org.gradle.api.file.FileCollection[] runtimeClasspath`::
_The classpath to use when executing the classes of this source set._ Default value: `output` + `runtime__SourceSet__` configuration.
