...
The Java plugin adds a number of <<sec:sub:scope_of_dependency_configurations,dependency configurations>> to your project, as shown below. It assigns those configurations to tasks such as `compileJava` and `test`.
