...
`clean` — type: `Delete`::
Deletes the build directory and everything in it, i.e. the path specified by the link:{groovyDslPath}/org.gradle.api.Project.html#org.gradle.api.Project:getBuildDir()[Project.getBuildDir()] project property.
