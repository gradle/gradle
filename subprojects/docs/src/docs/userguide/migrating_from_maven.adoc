...
.Mimicing the behavior of Maven profiles in Gradle
====
...
If you do need to implement custom logic, either via build scripts or plugins, then be sure to familiarize yourself with Gradle's link:{groovyDslPath}/[Groovy DSL Reference], which provides comprehensive documentation on the API that you'll be working with.
