...
You can learn more about this feature and the difference between `platform()` and `enforcedPlatform()` in the section on <<controlling_transitive_dependencies#sub:bom_import,importing version recommendations from a Maven BOM>>.
