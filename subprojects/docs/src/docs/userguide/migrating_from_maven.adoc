 ...
 * <<dependency_constraints.adoc#sec:enforcing_dependency_version,Overriding transitive versions>>
...
If you want to exclude a dependency for reasons unrelated to versions, then check out the section on <<dependency_constraints.adoc#sec:excluding-transitive-deps>>.
