...
++++
<sample id="declaringDependencyVersionsWithDependencyConstraints" dir="userguide/dependencies/declaringDependencyVersionsWithDependencyConstraints" title="Define dependency constraints">
