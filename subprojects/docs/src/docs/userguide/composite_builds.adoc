...
====
include::sample[dir="compositeBuilds/hierarchical-multirepo/multirepo-app/groovy",files="build.gradle[tags=publishDeps]"]
include::sample[dir="compositeBuilds/hierarchical-multirepo/multirepo-app/kotlin",files="build.gradle.kts[tags=publishDeps]"]
====
