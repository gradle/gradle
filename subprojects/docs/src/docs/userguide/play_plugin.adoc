...
`playBinary` — type: link:{groovyDslPath}/org.gradle.api.Task.html[Task]::
...
`dist` — type: link:{groovyDslPath}/org.gradle.api.Task.html[Task]::
_Depends on_: `createPlayBinaryZipDist`, `createPlayBinaryTarDist`
+
Assembles the Play distribution.

`stage` — type: link:{groovyDslPath}/org.gradle.api.Task.html[Task]::
...
`runPlayBinary` — type: link:{groovyDslPath}/org.gradle.play.tasks.PlayRun.html[PlayRun]::
...
`testPlayBinary` — type: link:{groovyDslPath}/org.gradle.api.tasks.testing.Test.html[Test]::
...
`compilePlayBinaryScala` — type: link:{javadocPath}/org/gradle/language/scala/tasks/PlatformScalaCompile.html[PlatformScalaCompile]::
_Depends on_: Scala and Java
+
Compiles all Scala and Java sources defined by the Play application.

`compilePlayBinaryPlayTwirlTemplates` — type: link:{groovyDslPath}/org.gradle.play.tasks.TwirlCompile.html[TwirlCompile]::
...
`compilePlayBinaryPlayRoutes` — type: link:{groovyDslPath}/org.gradle.play.tasks.RoutesCompile.html[RoutesCompile]::
_Depends on_: Play Route files
+
Compiles routes files into Scala sources.

`minifyPlayBinaryJavaScript` — type: link:{groovyDslPath}/org.gradle.play.tasks.JavaScriptMinify.html[JavaScriptMinify]::
...
`createPlayBinaryStartScripts` — type: link:{javadocPath}/org/gradle/api/tasks/application/CreateStartScripts.html[CreateStartScripts]::
+
Generates scripts to run the Play application distribution.

`stagePlayBinaryDist` — type: link:{groovyDslPath}/org.gradle.api.tasks.Copy.html[Copy]::
...
`createPlayBinaryZipDist` — type: link:{groovyDslPath}/org.gradle.api.tasks.bundling.Zip.html[Zip]::
+
Bundles the Play application as a standalone distribution packaged as a zip.

`createPlayBinaryTarDist` — type: link:{groovyDslPath}/org.gradle.api.tasks.bundling.Tar.html[Tar]::
+
