...
The POM file generated by the _new_ Maven publishing support provided by the <<publishing_maven.adoc#publishing_maven,Maven Publishing plugin>> is automatically signed if the corresponding publication is <<signing_plugin.adoc#sec:signing_publications,specified to be signed>>.
====
