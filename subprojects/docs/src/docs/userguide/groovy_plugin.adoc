...
.build.gradle
----
include::{samples-path}/groovy/quickstart/build.gradle[tag=use-plugin]
----
...
`compileGroovy` — type: link:{groovy-dsl-path}/org.gradle.api.tasks.compile.GroovyCompile.html[GroovyCompile]::
_Depends on_: `compileJava`
+
Compiles production Groovy source files.

`compileTestGroovy` — type: link:{groovy-dsl-path}/org.gradle.api.tasks.compile.GroovyCompile.html[GroovyCompile]::
_Depends on_: `compileTestJava`
+
Compiles test Groovy source files.

`compile__SourceSet__Groovy` — type: link:{groovy-dsl-path}/org.gradle.api.tasks.compile.GroovyCompile.html[GroovyCompile]::
_Depends on_: `compile__SourceSet__Java`
+
Compiles the given source set's Groovy source files.

`groovydoc` — type: link:{groovy-dsl-path}/org.gradle.api.tasks.javadoc.Groovydoc.html[Groovydoc]::
+
...
.build.gradle
----
include::{samples-path}/groovy/customizedLayout/build.gradle[tag=custom-source-locations]
----
...
.build.gradle
----
include::{samples-path}/groovy/quickstart/build.gradle[tag=groovy-dependency]
----
...
.build.gradle
----
include::{samples-path}/userguide/groovy/groovyDependency/build.gradle[tag=groovy-test-dependency]
----
...
.build.gradle
----
include::{samples-path}/userguide/groovy/groovyDependency/build.gradle[tag=bundled-groovy-dependency]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/groovyWithFlatDir/build.gradle[tag=groovy-dependency]
----
...
`groovy` — type: link:{groovy-dsl-path}/org.gradle.api.file.SourceDirectorySet.html[SourceDirectorySet] (read-only)::
...
`allGroovy` — type: link:{javadoc-path}/org/gradle/api/file/FileTree.html[FileTree] (read-only)::
_Default value_: Not null
+
All Groovy source files of this source set. Contains only the `.groovy` files found in the Groovy source directories.

These properties are provided by a convention object of type link:{groovy-dsl-path}/org.gradle.api.tasks.GroovySourceSet.html[GroovySourceSet].
...
|  `classpath`
| link:{javadoc-path}/org/gradle/api/file/FileCollection.html[FileCollection]
| `__sourceSet__.compileClasspath`

|  `source`
| link:{javadoc-path}/org/gradle/api/file/FileTree.html[FileTree]. Can set using anything described in <<working_with_files.adoc#sec:specifying_multiple_files,Specifying Multiple Files>>.
...
.gradle.properties
----
include::{samples-path}/groovy/crossCompilation/gradle.properties[]
----

[source.multi-language-sample,groovy]
.build.gradle
----
include::{samples-path}/groovy/crossCompilation/build.gradle[tag=groovy-cross-compilation]
----
