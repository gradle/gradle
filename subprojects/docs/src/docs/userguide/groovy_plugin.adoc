...
`compileGroovy` — type: link:{groovyDslPath}/org.gradle.api.tasks.compile.GroovyCompile.html[GroovyCompile]::
_Depends on_: `compileJava`
+
Compiles production Groovy source files.

`compileTestGroovy` — type: link:{groovyDslPath}/org.gradle.api.tasks.compile.GroovyCompile.html[GroovyCompile]::
_Depends on_: `compileTestJava`
+
Compiles test Groovy source files.

`compile__SourceSet__Groovy` — type: link:{groovyDslPath}/org.gradle.api.tasks.compile.GroovyCompile.html[GroovyCompile]::
_Depends on_: `compile__SourceSet__Java`
+
Compiles the given source set's Groovy source files.

`groovydoc` — type: link:{groovyDslPath}/org.gradle.api.tasks.javadoc.Groovydoc.html[Groovydoc]::
+
...
`groovy` — type: link:{groovyDslPath}/org.gradle.api.file.SourceDirectorySet.html[SourceDirectorySet] (read-only)::
...
`allGroovy` — type: link:{javadocPath}/org/gradle/api/file/FileTree.html[FileTree] (read-only)::
_Default value_: Not null
+
