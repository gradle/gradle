...
To enable the incubating support for Groovy compilation avoidance, add a system property `org.gradle.groovy.compilation.avoidance` to your Gradle invocation, for example:
