...
A well-known example is http://groovy-lang.org/metaprogramming.html#_code_generation_transformations[Groovy AST transformations].
In these cases, these dependencies must be declared separately in a classpath called `compilerPluginClasspath`:
