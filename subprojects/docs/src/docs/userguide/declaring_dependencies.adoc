...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/declaringDependencies/concreteVersion/build.gradle[tag=dependencies]
----
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/declaringDependencies/withoutVersion/build.gradle[tag=dependencies-without-version]
----
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/declaringDependencies/dynamicVersion/build.gradle[tag=dependencies]
----
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/declaringDependencies/changingVersion/build.gradle[tag=dependencies]
----
...
Gradle is flexible enough to treat any version as changing version e.g. if you wanted to model snapshot behavior for an Ivy module. All you need to do is to set the property link:{javadoc-path}/org/gradle/api/artifacts/ExternalModuleDependency.html#setChanging-boolean-[ExternalModuleDependency.setChanging(boolean)] to `true`.
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/declaringDependencies/fileDependencies/build.gradle[tag=file-dependencies]
----
...
link:{groovy-dsl-path}/org.gradle.api.Project.html#org.gradle.api.Project:files(java.lang.Object++[]++)[Project.files(java.lang.Object...)],
link:{javadoc-path}/org/gradle/api/file/ProjectLayout.html#files-java.lang.Object++...++-[ProjectLayout.files(java.lang.Object...)],
link:{javadoc-path}/org/gradle/api/file/ProjectLayout.html#configurableFiles-java.lang.Object++...++-[ProjectLayout.configurableFiles(java.lang.Object...)], and
link:{groovy-dsl-path}/org.gradle.api.Project.html#org.gradle.api.Project:fileTree(java.lang.Object)[Project.fileTree(java.lang.Object)]
...
The following example declares the dependencies on the `utils` and `api` project from the `web-service` project. The method link:{groovy-dsl-path}/org.gradle.api.Project.html#org.gradle.api.Project:project(java.lang.String)[Project.project(java.lang.String)] creates a reference to a specific subproject by path.
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/declaringDependencies/projectDependencies/build.gradle[tag=project-dependencies]
----
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/declaringDependencies/artifactOnly/build.gradle[tag=artifact-only-dependency-declaration]
----
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/declaringDependencies/artifactOnlyWithClassifier/build.gradle[tag=artifact-only-dependency-declaration]
----
