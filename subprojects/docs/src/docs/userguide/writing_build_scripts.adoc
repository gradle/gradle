...
.build.gradle
----
include::{samples-path}/userguide/tutorial/projectApi/build.gradle[tag=project-name]
----

.Output of **`gradle -q check`**
----
> gradle -q check
include::{samples-path}/userguide/tutorial/projectApi/projectApi.out[]
----
...
| `project`
| link:{groovy-dsl-path}/org.gradle.api.Project.html[Project]
...
| `ant`
| link:{javadoc-path}/org/gradle/api/AntBuilder.html[AntBuilder]
...
When Gradle executes a script, it compiles the script into a class which implements link:{groovy-dsl-path}/org.gradle.api.Script.html[Script]. This means that all of the properties and methods declared by the `Script` interface are available in your script.
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/localVariables/build.gradle[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/extraProperties/build.gradle[tag=extraProperties]
----

.Output of **`gradle -q printProperties`**
----
> gradle -q printProperties
include::{samples-path}/userguide/tutorial/extraProperties/extraProperties.out[]
----
...
For further details on extra properties and their API, see the link:{groovy-dsl-path}/org.gradle.api.plugins.ExtraPropertiesExtension.html[ExtraPropertiesExtension] class in the API documentation.
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/configureObject/build.gradle[]
----

.Output of **`gradle -q configure`**
----
> gradle -q configure
include::{samples-path}/userguide/tutorial/configureObject/configureObject.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/configureObjectUsingScript/build.gradle[]
----

[source.multi-language-sample,groovy]
.other.gradle
----
include::{samples-path}/userguide/tutorial/configureObjectUsingScript/other.gradle[]
----

.Output of`gradle -q configure`
----
> gradle -q configure
include::{samples-path}/userguide/tutorial/configureObjectUsingScript/configureObjectUsingScript.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/groovy/build.gradle[tag=groovyJdk]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/groovy/build.gradle[tag=propertyAccessors]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/groovy/build.gradle[tag=methodCallWithoutParentheses]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/groovy/build.gradle[tag=listAndMapLiterals]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/groovy/build.gradle[tag=closureAsLastParam]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/groovy/build.gradle[tag=closureDelegates]
----
