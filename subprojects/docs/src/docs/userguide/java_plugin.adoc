...
`compileJava` — type: link:{groovyDslPath}/org.gradle.api.tasks.compile.JavaCompile.html[JavaCompile]::
...
`processResources` — type: link:{groovyDslPath}/org.gradle.api.tasks.Copy.html[Copy]::
...
`compileTestJava` — type: link:{groovyDslPath}/org.gradle.api.tasks.compile.JavaCompile.html[JavaCompile]::
...
`processTestResources` — type: link:{groovyDslPath}/org.gradle.api.tasks.Copy.html[Copy]::
...
`clean` — type: link:{groovyDslPath}/org.gradle.api.tasks.Delete.html[Delete]::
Deletes the project build directory.

`clean__TaskName__` — type: link:{groovyDslPath}/org.gradle.api.tasks.Delete.html[Delete]::
...
`compile__SourceSet__Java` — type: link:{groovyDslPath}/org.gradle.api.tasks.compile.JavaCompile.html[JavaCompile]::
...
`process__SourceSet__Resources` — type: link:{groovyDslPath}/org.gradle.api.tasks.Copy.html[Copy]::
Copies the given source set's resources into the resources directory.

`__sourceSet__Classes` — type: link:{groovyDslPath}/org.gradle.api.Task.html[Task]::
...
The Java plugin uses the link:{groovyDslPath}/org.gradle.api.tasks.Copy.html[Copy] task for resource handling. It adds an instance for each source set in the project. You can find out more about the copy task in <<working_with_files.adoc#sec:copying_files,Copying files>>.
...
Starting with Gradle 2.1, it is possible to compile Java incrementally. See the link:{groovyDslPath}/org.gradle.api.tasks.compile.JavaCompile.html[JavaCompile] task for information on how to enable it.
