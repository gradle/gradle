...
Starting with version 2.13, Gradle provides a <<test_kit.adoc#sub:test-kit-automatic-classpath-injection,conventional mechanism to inject the code under test into the test build>>.
...
| <<test_kit.adoc#sub:test-kit-classpath-injection,Plugin classpath injection>>
| 2.8
...
| <<test_kit.adoc#sub:test-kit-debug,Inspecting build output in debug mode>>
| 2.9
...
| <<test_kit.adoc#sub:test-kit-automatic-classpath-injection,Automatic plugin classpath injection>>
| 2.13
