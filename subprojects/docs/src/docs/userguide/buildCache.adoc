...
[NOTE]
============================================
It is very important that a cacheable task has a complete picture of its inputs so that the results from one build can be safely re-used somewhere else.
