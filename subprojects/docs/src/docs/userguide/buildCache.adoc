...
Some tasks, like api:org.gradle.api.tasks.Copy[], usually do not make sense to make cacheable because Gradle is only copying files from one location to another.
