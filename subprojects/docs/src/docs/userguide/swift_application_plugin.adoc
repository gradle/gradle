...
link:{groovyDslPath}/org.gradle.nativeplatform.tasks.LinkExecutable.html#org.gradle.nativeplatform.tasks.LinkExecutable:toolChain[toolChain]:: <<building_swift_projects.adoc#swift_supported_tool_chain,automatically selected based on target machine>>
