...
| Instead of: link:{javadocPath}/org/gradle/api/tasks/TaskContainer.html#create-java.lang.String-org.gradle.api.Action-[TaskContainer.create(java.lang.String, org.gradle.api.Action)]
.2+| This returns a `TaskProvider` instead of a `Task`.
...
| Instead of: link:{javadocPath}/org/gradle/api/tasks/TaskCollection.html#getByName-java.lang.String-org.gradle.api.Action-[TaskCollection.getByName(java.lang.String, org.gradle.api.Action)]
.2+| This returns a `TaskProvider` instead of a `Task`.
...
| Instead of: link:{javadocPath}/org/gradle/api/NamedDomainObjectSet.html#findAll-org.gradle.api.specs.Spec-[NamedDomainObjectSet.findAll(org.gradle.api.specs.Spec)]
...
| Instead of: link:{javadocPath}/org/gradle/api/tasks/TaskCollection.html#matching-org.gradle.api.specs.Spec-[TaskCollection.matching(org.gradle.api.specs.Spec)]
...
.2+| Avoid doing this as it requires creating and configuring all tasks. See `findAll(Spec)` above.
| Use: _OK_, with issues.
