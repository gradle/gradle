...
====
include::sample[dir="userguide/tasks/customTask/groovy",files="build.gradle[tags=define-task]"]
include::sample[dir="userguide/tasks/customTask/kotlin",files="build.gradle.kts[tags=define-task]"]
====
...
.A hello world task
====
include::sample[dir="userguide/tasks/customTask/groovy",files="build.gradle[tags=add-action]"]
include::sample[dir="userguide/tasks/customTask/kotlin",files="build.gradle.kts[tags=add-action]"]
====
...
====
include::sample[dir="userguide/tasks/customTaskWithProperty/groovy",files="build.gradle[tags=add-property]"]
include::sample[dir="userguide/tasks/customTaskWithProperty/kotlin",files="build.gradle.kts[tags=add-property]"]
====
...
----
include::{samplesPath}/customPlugin/groovy/plugin/src/main/groovy/org/gradle/GreetingTask.groovy[]
----
...
====
include::sample[dir="customPlugin/groovy/consumer",files="build.gradle[tags=use-task]"]
include::sample[dir="customPlugin/kotlin/consumer",files="build.gradle.kts[tags=use-task]"]
====
...
----
include::{samplesPath}/customPlugin/groovy/plugin/src/test/groovy/org/gradle/GreetingTaskTest.groovy[tag=test-task]
----
...
When using link:{javadocPath}/org/gradle/api/tasks/incremental/IncrementalTaskInputs.html[IncrementalTaskInputs], it is only possible to query for all file changes of the task inputs.
...
The new link:{groovyDslPath}/org.gradle.work.InputChanges.html[InputChanges] API, which is documented here, replaces the old API and addresses its shortcomings.
If you need to use the old API, have a look at the documentation in the link:https://docs.gradle.org/5.3.1/userguide/custom_tasks.html#incremental_tasks[user manual for Gradle 5.3.1].
====
...
====
include::sample[dir="userguide/tasks/incrementalTask/groovy",files="build.gradle[tags=incremental-task]"]
include::sample[dir="userguide/tasks/incrementalTask/kotlin",files="build.gradle.kts[tags=incremental-task]"]
====
...
* An link:{javadocApi}/org/gradle/api/tasks/TaskOutputs.html#upToDateWhen-groovy.lang.Closure-[`upToDateWhen`] criterion added to the task returns `false`.
...
====
include::sample[dir="userguide/tasks/incrementalTask/groovy",files="build.gradle[tags=reverse]"]
include::sample[dir="userguide/tasks/incrementalTask/kotlin",files="build.gradle.kts[tags=reverse]"]
...
====
include::sample[dir="userguide/tasks/incrementalTask/groovy",files="build.gradle[tags=updated-inputs]"]
include::sample[dir="userguide/tasks/incrementalTask/kotlin",files="build.gradle.kts[tags=updated-inputs]"]
...
====
include::sample[dir="userguide/tasks/incrementalTask/groovy",files="build.gradle[tags=removed-input]"]
include::sample[dir="userguide/tasks/incrementalTask/kotlin",files="build.gradle.kts[tags=removed-input]"]
...
====
include::sample[dir="userguide/tasks/incrementalTask/groovy",files="build.gradle[tags=removed-output]"]
include::sample[dir="userguide/tasks/incrementalTask/kotlin",files="build.gradle.kts[tags=removed-output]"]
...
.UrlVerify.java
----
include::{samplesPath}/userguide/tasks/commandLineOption/stringOption/groovy/buildSrc/src/main/java/UrlVerify.java[tag=custom-task-implementation]
----
...
====
include::sample[dir="userguide/tasks/commandLineOption/stringOption/groovy",files="build.gradle[tags=task]"]
include::sample[dir="userguide/tasks/commandLineOption/stringOption/kotlin",files="build.gradle.kts[tags=task]"]
====
...
.UrlProcess.java
----
include::{samplesPath}/userguide/tasks/commandLineOption/optionValues/groovy/buildSrc/src/main/java/UrlProcess.java[tag=custom-task-implementation]
----
...
====
include::sample[dir="workerApi/noIsolation/groovy",files="build.gradle[tags=unit-of-work]"]
include::sample[dir="workerApi/noIsolation/kotlin",files="build.gradle.kts[tags=unit-of-work]"]
====
...
====
include::sample[dir="workerApi/noIsolation/groovy",files="build.gradle[tags=task-implementation]"]
include::sample[dir="workerApi/noIsolation/kotlin",files="build.gradle.kts[tags=task-implementation]"]
====
...
====
include::sample[dir="workerApi/waitForCompletion/groovy",files="build.gradle[tags=wait-for-completion]"]
include::sample[dir="workerApi/waitForCompletion/kotlin",files="build.gradle.kts[tags=wait-for-completion]"]
====
...
====
include::sample[dir="workerApi/workerDaemon/groovy",files="build.gradle[tags=worker-daemon]"]
include::sample[dir="workerApi/workerDaemon/kotlin",files="build.gradle.kts[tags=worker-daemon]"]
====
