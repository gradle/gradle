...
----
> gradle -q hello
include::{snippetsPath}/tasks/customTask/customTaskWithAction.out[]
----
...
include::{snippetsPath}/tasks/customTaskWithProperty/customTaskWithProperty.out[]
----
...
----
include::{snippetsPath}/customExternalTask/groovy/task/src/main/groovy/org/gradle/GreetingTask.groovy[]
----
...
----
include::{snippetsPath}/customExternalTask/groovy/task/src/test/groovy/org/gradle/GreetingTaskTest.groovy[tag=test-task]
----
...
include::{snippetsPath}/tasks/incrementalTask/incrementalTaskFirstRun.out[]
----
====
...
include::{snippetsPath}/tasks/incrementalTask/incrementalTaskNoChange.out[]
----
====
...
include::{snippetsPath}/tasks/incrementalTask/incrementalTaskUpdatedInputs.out[]
----
====
...
include::{snippetsPath}/tasks/incrementalTask/incrementalTaskRemovedInput.out[]
----
====
...
include::{snippetsPath}/tasks/incrementalTask/incrementalTaskRemovedOutput.out[]
----
====
...
include::{snippetsPath}/tasks/incrementalTask/incrementalTaskChangedProperty.out[]
----
====
...
include::{snippetsPath}/tasks/commandLineOption/stringOption/taskCommandLineOption.out[]
----
...
include::{snippetsPath}/tasks/commandLineOption/optionValues/helpTaskOptions.out[]
----
