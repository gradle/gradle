...
With Gradle, it's very simple to implement a task that is skipped when all of its inputs and outputs are up to date (see <<incremental_builds.adoc#incremental_builds,Incremental Builds>>).
