...
----
> gradle -q hello
include::{samplesPath}/tasks/customTask/customTaskWithAction.out[]
----
...
include::{samplesPath}/tasks/customTaskWithProperty/customTaskWithProperty.out[]
----
...
include::{samplesPath}/tasks/incrementalTask/incrementalTaskFirstRun.out[]
----
====
...
include::{samplesPath}/tasks/incrementalTask/incrementalTaskNoChange.out[]
----
====
...
include::{samplesPath}/tasks/incrementalTask/incrementalTaskUpdatedInputs.out[]
----
====
...
include::{samplesPath}/tasks/incrementalTask/incrementalTaskRemovedInput.out[]
----
====
...
include::{samplesPath}/tasks/incrementalTask/incrementalTaskRemovedOutput.out[]
----
====
...
include::{samplesPath}/tasks/incrementalTask/incrementalTaskChangedProperty.out[]
----
====
...
.UrlVerify.java
----
include::{samplesPath}/tasks/commandLineOption/stringOption/groovy/buildSrc/src/main/java/UrlVerify.java[tag=custom-task-implementation]
----
...
include::{samplesPath}/tasks/commandLineOption/stringOption/taskCommandLineOption.out[]
----
...
.UrlProcess.java
----
include::{samplesPath}/tasks/commandLineOption/optionValues/groovy/buildSrc/src/main/java/UrlProcess.java[tag=custom-task-implementation]
----
...
include::{samplesPath}/tasks/commandLineOption/optionValues/helpTaskOptions.out[]
----
