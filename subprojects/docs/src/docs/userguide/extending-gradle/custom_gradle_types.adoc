...
.Download.java
----
include::{snippetsPath}/plugins/mutableManagedProperty/java/buildSrc/src/main/java/Download.java[]
----
[source.multi-language-sample,kotlin]
.Download.kt
----
include::{snippetsPath}/plugins/mutableManagedProperty/kotlin/buildSrc/src/main/kotlin/Download.kt[]
----
[source.multi-language-sample,groovy]
.Download.groovy
----
include::{snippetsPath}/plugins/mutableManagedProperty/groovy/buildSrc/src/main/groovy/Download.groovy[]
----
====
...
.Download.java
----
include::{snippetsPath}/plugins/readOnlyManagedProperty/java/buildSrc/src/main/java/Download.java[]
----
[source.multi-language-sample,kotlin]
.Download.kt
----
include::{snippetsPath}/plugins/readOnlyManagedProperty/kotlin/buildSrc/src/main/kotlin/Download.kt[]
----
[source.multi-language-sample,groovy]
.Download.groovy
----
include::{snippetsPath}/plugins/readOnlyManagedProperty/groovy/buildSrc/src/main/groovy/Download.groovy[]
----
====
...
.Download.java
----
include::{snippetsPath}/plugins/readOnlyNestedProperty/java/buildSrc/src/main/java/Download.java[tags=download]
include::{snippetsPath}/plugins/readOnlyNestedProperty/java/buildSrc/src/main/java/Resource.java[tags=resource]
----
[source.multi-language-sample,kotlin]
.Download.kt
----
include::{snippetsPath}/plugins/readOnlyNestedProperty/kotlin/buildSrc/src/main/kotlin/Download.kt[tags=download]
----
[source.multi-language-sample,groovy]
.Download.groovy
----
include::{snippetsPath}/plugins/readOnlyNestedProperty/groovy/buildSrc/src/main/groovy/Download.groovy[tags=download]
----
====
...
.Download.java
----
include::{snippetsPath}/plugins/constructorServiceInjection/java/buildSrc/src/main/java/Download.java[]
----
[source.multi-language-sample,kotlin]
.Download.kt
----
include::{snippetsPath}/plugins/constructorServiceInjection/kotlin/buildSrc/src/main/kotlin/Download.kt[]
----
[source.multi-language-sample,groovy]
.Download.groovy
----
include::{snippetsPath}/plugins/constructorServiceInjection/groovy/buildSrc/src/main/groovy/Download.groovy[]
----
====
...
.Download.java
----
include::{snippetsPath}/plugins/propertyServiceInjection/java/buildSrc/src/main/java/Download.java[]
----
[source.multi-language-sample,kotlin]
.Download.kt
----
include::{snippetsPath}/plugins/propertyServiceInjection/kotlin/buildSrc/src/main/kotlin/Download.kt[]
----
[source.multi-language-sample,groovy]
.Download.groovy
----
include::{snippetsPath}/plugins/propertyServiceInjection/groovy/buildSrc/src/main/groovy/Download.groovy[]
----
====
...
----
include::{snippetsPath}/plugins/nestedObjects/java/buildSrc/src/main/java/DownloadExtension.java[]
include::{snippetsPath}/plugins/nestedObjects/java/buildSrc/src/main/java/Resource.java[tags=resource]
----
[source.multi-language-sample,kotlin]
.DownloadExtension.kt
----
include::{snippetsPath}/plugins/nestedObjects/kotlin/buildSrc/src/main/kotlin/DownloadExtension.kt[]
include::{snippetsPath}/plugins/nestedObjects/kotlin/buildSrc/src/main/kotlin/Resource.kt[tags=resource]
----
[source.multi-language-sample,groovy]
.DownloadExtension.groovy
----
include::{snippetsPath}/plugins/nestedObjects/groovy/buildSrc/src/main/groovy/DownloadExtension.groovy[]
include::{snippetsPath}/plugins/nestedObjects/groovy/buildSrc/src/main/groovy/Resource.groovy[tags=resource]
----
====
...
.DownloadExtension.java
----
include::{snippetsPath}/plugins/namedDomainObjectContainer/java/buildSrc/src/main/java/DownloadExtension.java[]
include::{snippetsPath}/plugins/namedDomainObjectContainer/java/buildSrc/src/main/java/Resource.java[tags=resource]
----
[source.multi-language-sample,kotlin]
.DownloadExtension.kt
----
include::{snippetsPath}/plugins/namedDomainObjectContainer/kotlin/buildSrc/src/main/kotlin/DownloadExtension.kt[]
include::{snippetsPath}/plugins/namedDomainObjectContainer/kotlin/buildSrc/src/main/kotlin/Resource.kt[tags=resource]
----
[source.multi-language-sample,groovy]
.DownloadExtension.groovy
----
include::{snippetsPath}/plugins/namedDomainObjectContainer/groovy/buildSrc/src/main/groovy/DownloadExtension.groovy[]
include::{snippetsPath}/plugins/namedDomainObjectContainer/groovy/buildSrc/src/main/groovy/Resource.groovy[tags=resource]
----
====
