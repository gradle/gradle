...
When Gradle exposes the custom types to the DSL it can choose a preferred public type.
You can influence this by declaring the public type for your custom types using the link:{javadocPath}/org/gradle/api/reflect/PublicType.html[@PublicType] annotation.
