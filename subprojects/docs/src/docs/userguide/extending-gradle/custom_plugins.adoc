...
----
> gradle -q hello
include::{snippetsPath}/customPlugins/customPlugin/customPlugin.out[]
----
...
----
> gradle -q hello
include::{snippetsPath}/customPlugins/customPluginWithConvention/customPluginWithConvention.out[]
----
...
----
> gradle -q hello
include::{snippetsPath}/customPlugins/customPluginWithAdvancedConvention/customPluginWithAdvancedConvention.out[]
----
...
include::{snippetsPath}/tasks/customTaskWithFileProperty/lazyFileProperties.out[]
----
