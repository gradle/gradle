...
----
> gradle -q hello
include::{samplesPath}/customPlugins/customPlugin/customPlugin.out[]
----
...
----
> gradle -q hello
include::{samplesPath}/customPlugins/customPluginWithConvention/customPluginWithConvention.out[]
----
...
----
> gradle -q hello
include::{samplesPath}/customPlugins/customPluginWithAdvancedConvention/customPluginWithAdvancedConvention.out[]
----
...
include::{samplesPath}/tasks/customTaskWithFileProperty/lazyFileProperties.out[]
----
