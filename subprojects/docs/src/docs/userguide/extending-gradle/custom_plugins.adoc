...
====
include::sample[dir="snippets/customPlugin/groovy/consumer",files="build.gradle[tags=use-plugin]"]
include::sample[dir="snippets/customPlugin/kotlin/consumer",files="build.gradle.kts[tags=use-plugin]"]
====
