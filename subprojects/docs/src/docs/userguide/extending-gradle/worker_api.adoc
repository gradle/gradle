...
<3> Before submitting work, you'll need to get a `WorkQueue` object with the desired isolation mode.
    We'll talk more about isolation modes later.
<4> When submitting the unit of work, specify the unit of work implementation, in this case `GenerateMD5` and configure its parameters.
