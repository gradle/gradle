...
====
include::sample[dir="providers/implicitTaskInputFileDependency/groovy",files="build.gradle[]"]
include::sample[dir="providers/implicitTaskInputFileDependency/kotlin",files="build.gradle.kts[]"]
====
...
----
$ gradle consumer
include::{samplesPath}/providers/implicitTaskInputFileDependency/implicitTaskInputFileDependencyGroovy.out[]
----
.Output of **`gradle consumer`**
[.multi-language-text.lang-kotlin]
----
$ gradle consumer
include::{samplesPath}/providers/implicitTaskInputFileDependency/implicitTaskInputFileDependencyKotlin.out[]
----
...
====
include::sample[dir="providers/implicitTaskInputDependency/groovy",files="build.gradle[]"]
include::sample[dir="providers/implicitTaskInputDependency/kotlin",files="build.gradle.kts[]"]
====
...
----
$ gradle consumer
include::{samplesPath}/providers/implicitTaskInputDependency/implicitTaskInputDependencyGroovy.out[]
----
.Output of **`gradle consumer`**
[.multi-language-text.lang-kotlin]
----
...
.Map property
====
include::sample[dir="providers/mapProperty/groovy",files="build.gradle[]"]
include::sample[dir="providers/mapProperty/kotlin",files="build.gradle.kts[]"]
====
