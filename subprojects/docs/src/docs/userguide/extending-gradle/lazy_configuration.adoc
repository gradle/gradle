...
----
$ gradle greeting
include::{snippetsPath}/providers/propertyAndProvider/usePropertyAndProvider.out[]
----
...
----
$ gradle greeting
include::{snippetsPath}/providers/connectProperties/connectProperties.out[]
----
...
----
$ gradle print
include::{snippetsPath}/providers/fileAndDirectoryProperty/workingWithFilesGroovy.out[]
----
.Output of **`gradle print`**
[.multi-language-text.lang-kotlin]
----
$ gradle print
include::{snippetsPath}/providers/fileAndDirectoryProperty/workingWithFilesKotlin.out[]
----
...
----
$ gradle consumer
include::{snippetsPath}/providers/implicitTaskInputFileDependency/implicitTaskInputFileDependencyGroovy.out[]
----
.Output of **`gradle consumer`**
[.multi-language-text.lang-kotlin]
----
$ gradle consumer
include::{snippetsPath}/providers/implicitTaskInputFileDependency/implicitTaskInputFileDependencyKotlin.out[]
----
...
----
$ gradle consumer
include::{snippetsPath}/providers/implicitTaskInputDependency/implicitTaskInputDependencyGroovy.out[]
----
.Output of **`gradle consumer`**
[.multi-language-text.lang-kotlin]
----
$ gradle consumer
include::{snippetsPath}/providers/implicitTaskInputDependency/implicitTaskInputDependencyKotlin.out[]
----
...
----
$ gradle consumer
include::{snippetsPath}/providers/listProperty/listPropertyGroovy.out[]
----
.Output of **`gradle consumer`**
[.multi-language-text.lang-kotlin]
----
$ gradle consumer
include::{snippetsPath}/providers/listProperty/listPropertyKotlin.out[]
----
...
----
$ gradle generate
include::{snippetsPath}/providers/mapProperty/mapProperty.out[]
----
...
====
include::sample[dir="snippets/providers/propertyConvention/groovy",files="build.gradle[]"]
include::sample[dir="snippets/providers/propertyConvention/kotlin",files="build.gradle.kts[]"]
====

.Output of **`gradle show`**
----
$ gradle show
include::{snippetsPath}/providers/propertyConvention/propertyConvention.out[]
----
