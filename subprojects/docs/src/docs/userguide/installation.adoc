...
You might check the user guide at ``GRADLE_HOME`/docs/userguide/userguide.html`. It is also available on the website:documentation.html[Gradle web site]. Typing `gradle help` prints the command line help. Typing `gradle tasks` shows all the tasks of a Gradle build.