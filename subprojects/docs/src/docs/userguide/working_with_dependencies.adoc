...
These APIs only return the declared dependencies and do not trigger <<declaring_repositories.adoc#sec:how-gradle-downloads-deps,dependency resolution>>.
