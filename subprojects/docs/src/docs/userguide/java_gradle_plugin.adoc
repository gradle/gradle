...
====
include::sample[dir="javaGradlePlugin/groovy",files="build.gradle[tag=use-java-gradle-plugin-plugin]"]
include::sample[dir="javaGradlePlugin/kotlin",files="build.gradle.kts[tag=use-java-gradle-plugin-plugin]"]
====
...
====
include::sample[dir="javaGradlePlugin/groovy",files="build.gradle[tag=gradle-plugin-block]"]
include::sample[dir="javaGradlePlugin/kotlin",files="build.gradle.kts[tag=gradle-plugin-block]"]
====
