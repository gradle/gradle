...
====
include::sample[dir="javaGradlePlugin/groovy",files="build.gradle[tags=use-java-gradle-plugin-plugin]"]
include::sample[dir="javaGradlePlugin/kotlin",files="build.gradle.kts[tags=use-java-gradle-plugin-plugin]"]
====
...
====
include::sample[dir="javaGradlePlugin/groovy",files="build.gradle[tags=gradle-plugin-block]"]
include::sample[dir="javaGradlePlugin/kotlin",files="build.gradle.kts[tags=gradle-plugin-block]"]
====
