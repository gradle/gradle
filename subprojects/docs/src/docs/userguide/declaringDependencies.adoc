...
The most prominent methods for creating a file reference are api:org.gradle.api.Project#files(java.lang.Object...)[], api:org.gradle.api.file.ProjectLayout#filesFor(java.lang.Object...)[], api:org.gradle.api.file.ProjectLayout#mutableFilesFor(java.lang.Object...)[], and api:org.gradle.api.Project#fileTree(java.lang.Object)[]
Alternatively, you can also define the source directory of one or many file dependencies in the form of a <<sec:flat_dir_resolver,flat directory repository>>.
