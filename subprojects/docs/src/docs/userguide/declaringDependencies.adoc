...
++++
<sample id="binary-dependencies-concrete-version" dir="userguide/dependencies/declaringBinaryDependenciesWithConcreteVersion" title="Declaring a dependencies with a concrete version">
...
++++
<sample id="binary-dependencies-without-version" dir="userguide/dependencies/declaringBinaryDependenciesWithoutVersion" title="Declaring a dependencies without version">
    <sourcefile file="build.gradle" snippet="binary-dependencies-without-version"/>
</sample>
++++
...
++++
<sample id="binary-dependencies-dynamic-version" dir="userguide/dependencies/declaringBinaryDependenciesWithDynamicVersion" title="Declaring a dependencies with a dynamic version">
    <sourcefile file="build.gradle" snippet="binary-dependencies"/>
</sample>
++++
...
++++
<sample id="binary-dependencies-changing-version" dir="userguide/dependencies/declaringBinaryDependenciesWithChangingVersion" title="Declaring a dependencies with a changing version">
    <sourcefile file="build.gradle" snippet="binary-dependencies"/>
</sample>
++++
