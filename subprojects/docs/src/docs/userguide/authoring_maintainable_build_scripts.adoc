...
====
include::sample[dir="userguide/bestPractices/conditionalLogic/dont/groovy", files="build.gradle[]"]
include::sample[dir="userguide/bestPractices/conditionalLogic/dont/kotlin", files="build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/bestPractices/conditionalLogic/do/groovy/buildSrc/src/main/java/com/enterprise", files="ReleasePlugin.java[]"]
====
...
====
include::sample[dir="userguide/bestPractices/conditionalLogic/do/groovy", files="build.gradle[]"]
include::sample[dir="userguide/bestPractices/conditionalLogic/do/kotlin", files="build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/bestPractices/taskDefinition/groovy", files="build.gradle[]"]
include::sample[dir="userguide/bestPractices/taskDefinition/kotlin", files="build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/bestPractices/taskGroupDescription/groovy", files="build.gradle[]"]
include::sample[dir="userguide/bestPractices/taskGroupDescription/kotlin", files="build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/bestPractices/logicDuringConfiguration/dont/groovy", files="build.gradle[tags=config-logic]"]
include::sample[dir="userguide/bestPractices/logicDuringConfiguration/dont/kotlin", files="build.gradle.kts[tags=config-logic]"]
====
...
====
include::sample[dir="userguide/bestPractices/logicDuringConfiguration/do/groovy", files="build.gradle[tags=config-logic]"]
include::sample[dir="userguide/bestPractices/logicDuringConfiguration/do/kotlin", files="build.gradle.kts[tags=config-logic]"]
====
