...
* Any other configuration logic for a task should be defined as part of link:{groovyDslPath}/org.gradle.api.Project.html#org.gradle.api.Project:task(java.lang.String,groovy.lang.Closure)[Project.task(java.lang.String, groovy.lang.Closure)] if possible.
...
In Gradle you can declare a link:{groovyDslPath}/org.gradle.api.Task.html#org.gradle.api.Task:setGroup(java.lang.String)[group] and a link:{groovyDslPath}/org.gradle.api.Task.html#org.gradle.api.Task:setDescription(java.lang.String)[description] for any task of the build.
...
The link:{groovyDslPath}/org.gradle.api.tasks.tasks.GradleBuild.html[GradleBuild] task type allows a build script to define a task that invokes another Gradle build.
