...
* Use <<composite_builds.adoc#composite-builds,composite builds>> for projects that are physically separated but should occasionally be built as a single unit.
