...
====
include::sample[dir="userguide/bestPractices/conditionalLogic/dont", files="build.gradle[]"]
====
...
====
include::sample[dir="userguide/bestPractices/conditionalLogic/do/buildSrc/src/main/java/com/enterprise", files="ReleasePlugin.java[]"]
====
...
====
include::sample[dir="userguide/bestPractices/conditionalLogic/do", files="build.gradle[]"]
====
...
====
include::sample[dir="userguide/bestPractices/taskDefinition", files="build.gradle[]"]
====
...
====
include::sample[dir="userguide/bestPractices/taskGroupDescription", files="build.gradle[]"]
====
...
====
include::sample[dir="userguide/bestPractices/logicDuringConfiguration/dont", files="build.gradle[tags=config-logic]"]
====
...
====
include::sample[dir="userguide/bestPractices/logicDuringConfiguration/do", files="build.gradle[tags=config-logic]"]
====
