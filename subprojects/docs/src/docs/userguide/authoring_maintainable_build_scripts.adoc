...
* _Declarative code:_ Built-in, language-agnostic DSL elements (e.g. link:{groovy-dsl-path}/org.gradle.api.Project.html#org.gradle.api.Project:dependencies(groovy.lang.Closure)[Project.dependencies{}] or link:{groovy-dsl-path}/org.gradle.api.Project.html#org.gradle.api.Project:repositories(groovy.lang.Closure)[Project.repositories{}]) or DSLs exposed by plugins
...
As a side product, you automatically enable your team to link:{guides-url}/designing-gradle-plugins/#reusable_logic_should_be_written_as_binary_plugin[reuse the plugin logic in other projects] if you publish the artifact to a binary repository.
...
By moving the code into a class link:{guides-url}/testing-gradle-plugins/[testability] also becomes a valid option.
...
.build.gradle
----
include::{samples-path}/userguide/bestPractices/conditionalLogic/dont/build.gradle[]
----
...
.ReleasePlugin.java
----
include::{samples-path}/userguide/bestPractices/conditionalLogic/do/buildSrc/src/main/java/com/enterprise/ReleasePlugin.java[]
----
...
.build.gradle
----
include::{samples-path}/userguide/bestPractices/conditionalLogic/do/build.gradle[]
----
...
To provide a nested DSL for your custom task, don't use `org.gradle.internal.reflect.Instantiator`; use link:{javadoc-path}/org/gradle/api/model/ObjectFactory.html[ObjectFactory] instead.
...
Use link:{javadoc-path}/org/gradle/api/provider/Provider.html[Provider] and/or link:{javadoc-path}/org/gradle/api/provider/Property.html[Property].
You can find an example for capturing user input to configure runtime behavior in the link:{guides-url}/implementing-gradle-plugins/#capturing_user_input_to_configure_plugin_runtime_behavior[implementing plugins guide].
...
Gradle plugin authors may find the Designing Gradle Plugins subsection on link:{guides-url}/designing-gradle-plugins/#restricting_the_plugin_implementation_to_gradle_s_public_api[restricting the plugin implementation to Gradle's public API] helpful.
...
* Any other configuration logic for a task should be defined as part of link:{groovy-dsl-path}/org.gradle.api.Project.html#org.gradle.api.Project:task(java.lang.String,groovy.lang.Closure)[Project.task(java.lang.String, groovy.lang.Closure)] if possible.
* <<tutorial_using_tasks.adoc#sec:hello_world,Task actions>> should only be declared with the methods link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task:doFirst(org.gradle.api.Action)[Task.doFirst{}] or link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task:doLast(org.gradle.api.Action)[Task.doLast{}].
* link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task:doLast(org.gradle.api.Action)[Task.doLast{}] should be used if the task only defines a single action.
* A task should <<authoring_maintainable_build_scripts.adoc#sec:improving_task_discoverability,define a group and description>>.
...
.build.gradle
----
include::{samples-path}/userguide/bestPractices/taskDefinition/build.gradle[]
----
...
In Gradle you can declare a link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task:setGroup(java.lang.String)[group] and a link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task:setDescription(java.lang.String)[description] for any task of the build.
...
.build.gradle
----
include::{samples-path}/userguide/bestPractices/taskGroupDescription/build.gradle[]
----
...
.build.gradle
----
include::{samples-path}/userguide/bestPractices/logicDuringConfiguration/dont/build.gradle[tag=config-logic]
----
...
.build.gradle
----
include::{samples-path}/userguide/bestPractices/logicDuringConfiguration/do/build.gradle[tag=config-logic]
----

[[sec:avoiding_use_of_gradlebuild]]
== Avoiding the use of `GradleBuild`

The link:{groovy-dsl-path}/org.gradle.api.tasks.tasks.GradleBuild.html[GradleBuild] task type allows a build script to define a task that invokes another Gradle build.
...
* Explicitly depending on a task from another project via link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task:dependsOn(java.lang.Object[])[Task.dependsOn(java.lang.Object...)].
* Setting property values or calling methods on domain objects from another project.
* Executing another portion of the build with <<authoring_maintainable_build_scripts.adoc#sec:avoiding_use_of_gradlebuild,GradleBuild>>.
