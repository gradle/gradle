...
// TODO use the include::sample syntax as above, when it actually supports multiple tags
...
.build.gradle.kts
----
include::{samplesPath}/java/quickstart/kotlin/build.gradle.kts[tags=use-plugin;use-eclipse-plugin;customization;repo;dependencies;task-customization;upload]
----
