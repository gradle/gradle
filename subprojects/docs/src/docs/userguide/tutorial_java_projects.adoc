...
====
include::sample[dir="java/multiproject/groovy/api",files="build.gradle[tags=dependencies]"]
include::sample[dir="java/multiproject/kotlin/api",files="build.gradle.kts[tags=dependencies]"]
====
...
====
include::sample[dir="java/multiproject/groovy/api",files="build.gradle[tags=dists]"]
include::sample[dir="java/multiproject/kotlin/api",files="build.gradle.kts[tags=dists]"]
====
