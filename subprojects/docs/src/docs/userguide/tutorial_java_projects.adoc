...
====
include::sample[dir="java/quickstart/groovy", files="build.gradle[tags=repo]"]
include::sample[dir="java/quickstart/kotlin", files="build.gradle.kts[tags=repo]"]
====
...
.Adding dependencies
====
include::sample[dir="java/quickstart/groovy", files="build.gradle[tags=dependencies]"]
include::sample[dir="java/quickstart/kotlin", files="build.gradle.kts[tags=dependencies]"]
====
...
====
include::sample[dir="java/quickstart/groovy", files="build.gradle[tags=customization]"]
include::sample[dir="java/quickstart/kotlin", files="build.gradle.kts[tags=customization]"]
====
...
.Adding a test system property
====
include::sample[dir="java/quickstart/groovy", files="build.gradle[tags=task-customization]"]
include::sample[dir="java/quickstart/kotlin", files="build.gradle.kts[tags=task-customization]"]
====
...
.Publishing the JAR file
====
include::sample[dir="java/quickstart/groovy", files="build.gradle[tags=upload]"]
include::sample[dir="java/quickstart/kotlin", files="build.gradle.kts[tags=upload]"]
====
...
.Eclipse plugin
====
include::sample[dir="java/quickstart/groovy", files="build.gradle[tags=use-eclipse-plugin]"]
include::sample[dir="java/quickstart/kotlin", files="build.gradle.kts[tags=use-eclipse-plugin]"]
====
...
====
include::sample[dir="java/quickstart/groovy", files="build.gradle[tags=complete-example]"]
include::sample[dir="java/quickstart/kotlin", files="build.gradle.kts[tags=complete-example]"]
====
...
To define a multi-project build, you need to create a _settings file_. The settings file lives in the root directory of the source tree, and specifies which projects to include in the build. It must be called `settings.gradle` (with Groovy) or `settings.gradle.kts` (with Kotlin). For this example, we are using a simple hierarchical layout. Here is the corresponding settings file:

.Multi-project build - settings file
====
include::sample[dir="java/multiproject/groovy",files="settings.gradle[tags=include-projects]"]
include::sample[dir="java/multiproject/kotlin",files="settings.gradle.kts[tags=include-projects]"]
====
...
====
include::sample[dir="java/multiproject/groovy",files="build.gradle[tags=configuration-injection]"]
include::sample[dir="java/multiproject/kotlin",files="build.gradle.kts[tags=configuration-injection]"]
====
...
====
include::sample[dir="java/multiproject/groovy",files="api/build.gradle[tags=dependencies]"]
include::sample[dir="java/multiproject/kotlin",files="api/build.gradle.kts[tags=dependencies]"]
====
...
.Multi-project build - distribution file
====
include::sample[dir="java/multiproject/groovy",files="api/build.gradle[tags=dists]"]
include::sample[dir="java/multiproject/kotlin",files="api/build.gradle.kts[tags=dists]"]
====
