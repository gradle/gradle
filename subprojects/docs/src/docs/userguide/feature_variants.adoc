...
[NOTE]
====
While the engine supports feature variants independently of the the ecosystem, this feature is currently only available using the Java plugins.
====
