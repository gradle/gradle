...
====
include::sample[dir="userguide/multiproject/firstExample/water/groovy",files="settings.gradle[]"]
include::sample[dir="userguide/multiproject/firstExample/water/kotlin",files="settings.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/multiproject/firstExample/water/groovy",files="build.gradle[]"]
include::sample[dir="userguide/multiproject/firstExample/water/kotlin",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/multiproject/addKrill/water/groovy",files="settings.gradle[]"]
include::sample[dir="userguide/multiproject/addKrill/water/kotlin",files="settings.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/multiproject/addKrill/water/groovy",files="build.gradle[]"]
include::sample[dir="userguide/multiproject/addKrill/water/kotlin",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/multiproject/useSubprojects/water/groovy",files="build.gradle[]"]
include::sample[dir="userguide/multiproject/useSubprojects/water/kotlin",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/multiproject/subprojectsAddFromTop/water/groovy",files="build.gradle[]"]
include::sample[dir="userguide/multiproject/subprojectsAddFromTop/water/kotlin",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/multiproject/spreadSpecifics/water/groovy",files="settings.gradle[];bluewhale/build.gradle[];krill/build.gradle[];build.gradle[]"]
include::sample[dir="userguide/multiproject/spreadSpecifics/water/kotlin",files="settings.gradle.kts[];bluewhale/build.gradle.kts[];krill/build.gradle.kts[];build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/multiproject/addTropical/water/groovy",files="settings.gradle[];build.gradle[]"]
include::sample[dir="userguide/multiproject/addTropical/water/kotlin",files="settings.gradle.kts[];build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/multiproject/tropicalWithProperties/water/groovy",files="settings.gradle[];bluewhale/build.gradle[];krill/build.gradle[];build.gradle[];tropicalFish/build.gradle[]"]
include::sample[dir="userguide/multiproject/tropicalWithProperties/water/kotlin",files="settings.gradle.kts[];bluewhale/build.gradle.kts[];krill/build.gradle.kts[];build.gradle.kts[];tropicalFish/build.gradle.kts[]"]
====

.Output of `gradle -q hello`
----
> gradle -q hello --settings-file=../settings.gradle
...
----
> gradle -q hello --settings-file=../settings.gradle
include::{samplesPath}/userguide/multiproject/tropicalWithProperties/water/multiprojectSubBuild.out[]
----
[source.multi-language-sample,kotlin]
----
> gradle -q hello --settings-file=../settings.gradle.kts
include::{samplesPath}/userguide/multiproject/tropicalWithProperties/water/multiprojectSubBuild.out[]
----
...
====
include::sample[dir="userguide/multiproject/partialTasks/water/groovy",files="bluewhale/build.gradle[];krill/build.gradle[]"]
include::sample[dir="userguide/multiproject/partialTasks/water/kotlin",files="bluewhale/build.gradle.kts[];krill/build.gradle.kts[]"]
====
...
[source.multi-language-sample,groovy]
----
> gradle -q :hello :krill:hello hello --settings-file=../settings.gradle
include::{samplesPath}/userguide/multiproject/tropicalWithProperties/water/multiprojectAbsoluteTaskPaths.out[]
----
[source.multi-language-sample,kotlin]
----
> gradle -q :hello :krill:hello hello --settings-file=../settings.gradle.kts
include::{samplesPath}/userguide/multiproject/tropicalWithProperties/water/multiprojectAbsoluteTaskPaths.out[]
----
...
====
include::sample[dir="userguide/multiproject/dependencies/firstMessages/messages/groovy",files="build.gradle[];settings.gradle[];consumer/build.gradle[];producer/build.gradle[]"]
include::sample[dir="userguide/multiproject/dependencies/firstMessages/messages/kotlin",files="build.gradle.kts[];settings.gradle.kts[];consumer/build.gradle.kts[];producer/build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/multiproject/dependencies/messagesHack/messages/groovy",files="build.gradle[];settings.gradle[];consumer/build.gradle[];aProducer/build.gradle[]"]
include::sample[dir="userguide/multiproject/dependencies/messagesHack/messages/kotlin",files="build.gradle.kts[];settings.gradle.kts[];consumer/build.gradle.kts[];aProducer/build.gradle.kts[]"]
====
...
[source.multi-language-sample,groovy]
----
> gradle -q action --settings-file=../settings.gradle
include::{samplesPath}/userguide/multiproject/dependencies/messagesHack/messages/multiprojectMessagesHackBroken.out[]
----
[source.multi-language-sample,kotlin]
----
> gradle -q action --settings-file=../settings.gradle.kts
include::{samplesPath}/userguide/multiproject/dependencies/messagesHack/messages/multiprojectMessagesHackBroken.out[]
----
...
====
include::sample[dir="userguide/multiproject/dependencies/webDist/groovy",files="settings.gradle[];build.gradle[]"]
include::sample[dir="userguide/multiproject/dependencies/webDist/kotlin",files="settings.gradle.kts[];build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/multiproject/dependencies/java/groovy",files="settings.gradle[];build.gradle[]"]
include::sample[dir="userguide/multiproject/dependencies/java/kotlin",files="settings.gradle.kts[];build.gradle.kts[]"]
====

All the build logic is in the build script of the root project.footnote:[We do this here, as it makes the layout a bit easier. We usually put the project specific stuff into the build script of the respective projects.] A “_lib_” dependency is a special form of an execution dependency. It causes the other project to be built first and adds the jar with the classes of the other project to the classpath. It also adds the dependencies of the other project to the classpath. So you can enter the “`api`” directory and trigger a “`gradle compile`”. First the “`shared`” project is built and then the “`api`” project is built. Project dependencies enable partial multi-project builds.
...
====
include::sample[dir="userguide/multiproject/dependencies/javaWithCustomConf/groovy",files="build.gradle[]"]
include::sample[dir="userguide/multiproject/dependencies/javaWithCustomConf/kotlin",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/multiproject/dependencies/outgoingArtifact/groovy/producer",files="build.gradle[]"]
include::sample[dir="userguide/multiproject/dependencies/outgoingArtifact/kotlin/producer",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/multiproject/dependencies/outgoingArtifact/groovy/consumer",files="build.gradle[tags=producer-project-dependency]"]
include::sample[dir="userguide/multiproject/dependencies/outgoingArtifact/kotlin/consumer",files="build.gradle.kts[tags=producer-project-dependency]"]
====
