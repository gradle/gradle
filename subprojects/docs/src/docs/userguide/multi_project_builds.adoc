...
.settings.gradle
----
include::{samples-path}/userguide/multiproject/firstExample/water/settings.gradle[]
----
...
.build.gradle
----
include::{samples-path}/userguide/multiproject/firstExample/water/build.gradle[]
----

.Output of **`gradle -q hello`**
----
> gradle -q hello
include::{samples-path}/userguide/multiproject/firstExample/water/multiprojectFirstExample.out[]
----
...
.settings.gradle
----
include::{samples-path}/userguide/multiproject/addKrill/water/settings.gradle[]
----
...
.build.gradle
----
include::{samples-path}/userguide/multiproject/addKrill/water/build.gradle[]
----

.Output of **`gradle -q hello`**
----
> gradle -q hello
include::{samples-path}/userguide/multiproject/addKrill/water/multiprojectAddKrill.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/multiproject/useSubprojects/water/build.gradle[]
----

.Output of **`gradle -q hello`**
----
> gradle -q hello
include::{samples-path}/userguide/multiproject/useSubprojects/water/multiprojectUseSubprojects.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/multiproject/subprojectsAddFromTop/water/build.gradle[]
----

.Output of **`gradle -q hello`**
----
> gradle -q hello
include::{samples-path}/userguide/multiproject/subprojectsAddFromTop/water/multiprojectSubprojectsAddFromTop.out[]
----
...
.settings.gradle
----
include::{samples-path}/userguide/multiproject/spreadSpecifics/water/settings.gradle[]
----

[source.multi-language-sample,groovy]
.bluewhale/build.gradle
----
include::{samples-path}/userguide/multiproject/spreadSpecifics/water/bluewhale/build.gradle[]
----

[source.multi-language-sample,groovy]
.krill/build.gradle
----
include::{samples-path}/userguide/multiproject/spreadSpecifics/water/krill/build.gradle[]
----

[source.multi-language-sample,groovy]
.build.gradle
----
include::{samples-path}/userguide/multiproject/spreadSpecifics/water/build.gradle[]
----

.Output of `gradle -q hello`
----
> gradle -q hello
include::{samples-path}/userguide/multiproject/spreadSpecifics/water/multiprojectSpreadSpecifics.out[]
----
...
.settings.gradle
----
include::{samples-path}/userguide/multiproject/addTropical/water/settings.gradle[]
----

[source.multi-language-sample,groovy]
.build.gradle
----
include::{samples-path}/userguide/multiproject/addTropical/water/build.gradle[]
----

.Output of `gradle -q hello`
----
> gradle -q hello
include::{samples-path}/userguide/multiproject/addTropical/water/multiprojectAddTropical.out[]
----
...
.settings.gradle
----
include::{samples-path}/userguide/multiproject/tropicalWithProperties/water/settings.gradle[]
----

[source.multi-language-sample,groovy]
.bluewhale/build.gradle
----
include::{samples-path}/userguide/multiproject/tropicalWithProperties/water/bluewhale/build.gradle[]
----

[source.multi-language-sample,groovy]
.krill/build.gradle
----
include::{samples-path}/userguide/multiproject/tropicalWithProperties/water/krill/build.gradle[]
----

[source.multi-language-sample,groovy]
.build.gradle
----
include::{samples-path}/userguide/multiproject/tropicalWithProperties/water/build.gradle[]
----

[source.multi-language-sample,groovy]
.tropicalFish/build.gradle
----
include::{samples-path}/userguide/multiproject/tropicalWithProperties/water/tropicalFish/build.gradle[]
----

.Output of`gradle -q hello`
----
> gradle -q hello
include::{samples-path}/userguide/multiproject/tropicalWithProperties/water/multiprojectTropicalWithProperties.out[]
----

In the build file of the `water` project we use an `afterEvaluate` notification. This means that the closure we are passing gets evaluated _after_ the build scripts of the subproject are evaluated. As the property `arctic` is set in those build scripts, we have to do it this way. You will find more on this topic in <<multi_project_builds.adoc#sec:dependencies_which_dependencies,Dependencies — Which Dependencies?>>
...
----
> gradle -q hello
include::{samples-path}/userguide/multiproject/tropicalWithProperties/water/bluewhale/multiprojectSubBuild.out[]
----
...
.bluewhale/build.gradle
----
include::{samples-path}/userguide/multiproject/partialTasks/water/bluewhale/build.gradle[]
----

[source.multi-language-sample,groovy]
.krill/build.gradle
----
include::{samples-path}/userguide/multiproject/partialTasks/water/krill/build.gradle[]
----

.Output of `gradle -q distanceToIceberg`
----
> gradle -q distanceToIceberg
include::{samples-path}/userguide/multiproject/partialTasks/water/multiprojectPartialTasks.out[]
----
...
include::{samples-path}/userguide/multiproject/partialTasks/water/multiprojectPartialTasksNotQuiet.out[]
----
...
include::{samples-path}/userguide/multiproject/tropicalWithProperties/water/tropicalFish/multiprojectAbsoluteTaskPaths.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/multiproject/dependencies/firstMessages/messages/build.gradle[]
----

[source.multi-language-sample,groovy]
.settings.gradle
----
include::{samples-path}/userguide/multiproject/dependencies/firstMessages/messages/settings.gradle[]
----

[source.multi-language-sample,groovy]
.consumer/build.gradle
----
include::{samples-path}/userguide/multiproject/dependencies/firstMessages/messages/consumer/build.gradle[]
----

[source.multi-language-sample,groovy]
.producer/build.gradle
----
include::{samples-path}/userguide/multiproject/dependencies/firstMessages/messages/producer/build.gradle[]
----

.Output of`gradle -q action`
----
> gradle -q action
include::{samples-path}/userguide/multiproject/dependencies/firstMessages/messages/multiprojectFirstMessages.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/multiproject/dependencies/messagesHack/messages/build.gradle[]
----

[source.multi-language-sample,groovy]
.settings.gradle
----
include::{samples-path}/userguide/multiproject/dependencies/messagesHack/messages/settings.gradle[]
----

[source.multi-language-sample,groovy]
.aProducer/build.gradle
----
include::{samples-path}/userguide/multiproject/dependencies/messagesHack/messages/aProducer/build.gradle[]
----

[source.multi-language-sample,groovy]
.consumer/build.gradle
----
include::{samples-path}/userguide/multiproject/dependencies/messagesHack/messages/consumer/build.gradle[]
----

.Output of`gradle -q action`
----
> gradle -q action
include::{samples-path}/userguide/multiproject/dependencies/messagesHack/messages/multiprojectMessagesHack.out[]
----
...
----
> gradle -q action
include::{samples-path}/userguide/multiproject/dependencies/messagesHack/messages/consumer/multiprojectMessagesHackBroken.out[]
----
...
.settings.gradle
----
include::{samples-path}/userguide/multiproject/dependencies/webDist/settings.gradle[]
----

[source.multi-language-sample,groovy]
.build.gradle
----
include::{samples-path}/userguide/multiproject/dependencies/webDist/build.gradle[]
----
...
“`services`” is also a project, but we use it just as a container. It has no build script and gets nothing injected by another build script. We use the `:` separator to define a project path. Consult the DSL documentation of link:{groovy-dsl-path}++/org.gradle.api.initialization.Settings.html#org.gradle.api.initialization.Settings:include(java.lang.String[])++[Settings.include(java.lang.String[\])] for more information about defining project paths.
...
.settings.gradle
----
include::{samples-path}/userguide/multiproject/dependencies/java/settings.gradle[]
----

[source.multi-language-sample,groovy]
.build.gradle
----
include::{samples-path}/userguide/multiproject/dependencies/java/build.gradle[]
----
...
.build.gradle
----
include::{samples-path}/userguide/multiproject/dependencies/javaWithCustomConf/build.gradle[]
----
...
<<multi_project_builds.adoc#sec:project_jar_dependencies,Project dependencies>> model dependencies between modules. Effectively, you are saying that you depend on the main output of another project. In a Java-based project that's usually a JAR file.
...
.build.gradle
----
include::{samples-path}/userguide/multiproject/dependencies/outgoingArtifact/producer/build.gradle[]
----
...
.build.gradle
----
include::{samples-path}/userguide/multiproject/dependencies/outgoingArtifact/consumer/build.gradle[tag=producer-project-dependency]
----
...
Although Gradle already offers parallel test execution via link:{javadoc-path}/org/gradle/api/tasks/testing/Test.html#setMaxParallelForks-int-[Test.setMaxParallelForks(int)] the feature described in this section is parallel execution at a project level. Parallel execution is an incubating feature. Please use it and let us know how it works for you.

Parallel project execution allows the separate projects in a decoupled multi-project build to be executed in parallel (see also <<multi_project_builds.adoc#sec:decoupled_projects,Decoupled projects>>). While parallel execution does not strictly require decoupling at configuration time, the long-term goal is to provide a powerful set of features that will be available for fully decoupled projects. Such features include:

* <<multi_project_builds.adoc#sec:configuration_on_demand,Configuration on-demand>>.
...
In <<multi_project_builds.adoc#javadependencies_2,this example>>, the “`:services:personservice`” project depends on both the “`:api`” and “`:shared`” projects. The “`:api`” project also depends on the “`:shared`” project.
...
----
> gradle :api:build
include::{samples-path}/userguide/multiproject/dependencies/java/multitestingBuild.out[]
----
...
include::{samples-path}/userguide/multiproject/dependencies/java/multitestingBuildNeeded.out[]
----
...
include::{samples-path}/userguide/multiproject/dependencies/java/multitestingBuildDependents.out[]
----
