...
.build.xml
----
include::{samplesPath}/userguide/ant/hello/groovy/build.xml[]
----
...
.build.xml
----
include::{samplesPath}/userguide/ant/dependsOnTask/groovy/build.xml[]
----
...
.build.xml
----
include::{samplesPath}/userguide/ant/renameTask/groovy/build.xml[]
----
