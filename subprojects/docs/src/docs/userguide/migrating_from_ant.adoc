...
See the chapters on <<declaring_dependencies#declaring_dependencies,Declaring Dependencies>>, <<managing_dependency_configurations#what-are-dependency-configurations,Managing Dependency Configurations>> and <<declaring_repositories#declaring_repositories,Declaring Repositories>> for more information.
