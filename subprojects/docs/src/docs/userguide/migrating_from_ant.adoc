...
////
Integration tests under gradle/subprojects/integ-test/src/integTest/groovy/org/gradle/integtests/samples/antmigration

To run:

   ./gradlew :integTest:intTestImage :integTest:integTest --tests "*SamplesAntImportIntegrationTest"
////
...
====
include::sample[dir="userguide/antMigration/importBuild/groovy",files="build.gradle[tags=apply-plugin]"]
include::sample[dir="userguide/antMigration/importBuild/kotlin",files="build.gradle.kts[tags=apply-plugin]"]
====
...
====
include::sample[dir="userguide/antMigration/importBuild/groovy",files="build.gradle[tags=import-build]"]
include::sample[dir="userguide/antMigration/importBuild/kotlin",files="build.gradle.kts[tags=import-build]"]
====
...
====
include::sample[dir="userguide/antMigration/importBuild/groovy",files="build.gradle[tags=source-sets]"]
include::sample[dir="userguide/antMigration/importBuild/kotlin",files="build.gradle.kts[tags=source-sets]"]
====
...
====
include::sample[dir="userguide/antMigration/importBuild/groovy",files="build.gradle[tags=task-dependencies]"]
include::sample[dir="userguide/antMigration/importBuild/kotlin",files="build.gradle.kts[tags=task-dependencies]"]
====
...
====
include::sample[dir="userguide/antMigration/fileDeps/groovy",files="build.gradle[tags=file-deps]"]
include::sample[dir="userguide/antMigration/fileDeps/kotlin",files="build.gradle.kts[tags=file-deps]"]
====
...
+
See the chapters on <<controlling_transitive_dependencies#,Controlling Transitive Dependencies>> and <<customizing_dependency_resolution_behavior#customizing_dependency_resolution_behavior,Customizing Dependency Resolution Behavior>> for more information on this aspect of Gradle.
...
====
include::sample[dir="userguide/antMigration/fileDeps/groovy",files="build.gradle[tags=retrieve-deps]"]
include::sample[dir="userguide/antMigration/fileDeps/kotlin",files="build.gradle.kts[tags=retrieve-deps]"]
====
+
...
Before you attempt to migrate this particular aspect of your build, read the <<publishing#publishing_overview,Publishing>> chapter to learn about Gradle's publishing model.
...
If you'd prefer to limit which publications go to which repositories, check out the <<publishing.adoc#sec:publishing_maven:conditional_publishing,relevant section of the Publishing chapter>>.
...
====
include::sample[dir="userguide/antMigration/fileDeps/groovy",files="build.gradle[tags=properties]"]
include::sample[dir="userguide/antMigration/fileDeps/kotlin",files="build.gradle.kts[tags=properties]"]
====
...
+
====
include::sample[dir="userguide/antMigration/multiProject/groovy",files="web/build.xml[tags=build-required]"]
====
...
+
====
include::sample[dir="userguide/antMigration/multiProject/groovy",files="web/build.gradle[]"]
include::sample[dir="userguide/antMigration/multiProject/kotlin",files="web/build.gradle.kts[]"]
====
+
This is not as robust or powerful as Gradle's <<multi_project_builds#sec:project_jar_dependencies,project dependencies>>, but it solves the immediate problem without big changes to the build. Just be careful to remove or override any dependencies on tasks that delegate to other subprojects, like the `buildRequiredProjects` task.
