...
If you'd prefer to limit which publications go to which repositories, check out the <<publishing.adoc#publishing_maven:conditional_publishing,relevant section of the Publishing chapter>>.
