...
.build.gradle
----
include::{snippetsPath}/customModel/languageType/build.gradle[tag=build-script]
----
...
----
include::{snippetsPath}/customModel/languageType/buildSrc/src/main/groovy/sample/documentation/DocumentationComponent.groovy[tag=component-declaration]
----
...
----
include::{snippetsPath}/customModel/languageType/buildSrc/src/main/groovy/sample/documentation/DocumentationPlugin.groovy[tag=component-registration]
----
...
----
include::{snippetsPath}/customModel/languageType/buildSrc/src/main/groovy/sample/documentation/DocumentationBinary.groovy[tag=binary-declaration]
----
...
.DocumentationPlugin.groovy
----
include::{snippetsPath}/customModel/languageType/buildSrc/src/main/groovy/sample/documentation/DocumentationPlugin.groovy[tag=binary-registration]
----
...
----
include::{snippetsPath}/customModel/languageType/buildSrc/src/main/groovy/sample/markdown/MarkdownSourceSet.groovy[tag=markdown-lang-declaration]
----
...
----
include::{snippetsPath}/customModel/languageType/buildSrc/src/main/groovy/sample/markdown/MarkdownPlugin.groovy[tag=markdown-lang-registration]
----
...
.DocumentationPlugin.groovy
----
include::{snippetsPath}/customModel/languageType/buildSrc/src/main/groovy/sample/documentation/DocumentationPlugin.groovy[tag=binaries-generation]
----
...
.DocumentationPlugin.groovy
----
include::{snippetsPath}/customModel/languageType/buildSrc/src/main/groovy/sample/documentation/DocumentationPlugin.groovy[tag=text-tasks-generation]
----
...
.MarkdownPlugin.groovy
----
include::{snippetsPath}/customModel/languageType/buildSrc/src/main/groovy/sample/markdown/MarkdownPlugin.groovy[tag=markdown-tasks-generation]
----
...
----
> gradle -q components
include::{snippetsPath}/customModel/languageType//softwareModelExtend-components.out[]
----
...
.build.gradle
----
include::{snippetsPath}/customModel/internalViews/build.gradle[tag=type-declaration]
----
...
.build.gradle
----
include::{snippetsPath}/customModel/internalViews/build.gradle[tag=type-registration]
----
...
.build.gradle
----
include::{snippetsPath}/customModel/internalViews/build.gradle[tag=internal-view-mutation]
----
...
.build.gradle
----
include::{snippetsPath}/customModel/internalViews/build.gradle[tag=build-script]
----

.Output of `gradle -q model`
----
> gradle -q model
include::{snippetsPath}/customModel/internalViews/softwareModelExtend-iv-model.out[]
----
