...
.build.gradle
----
include::{samplesPath}/modelRules/configureAsRequired/build.gradle[tag=configure-rule]
----

.Output of **`gradle showPerson`**
----
> gradle showPerson
include::{samplesPath}/modelRules/configureAsRequired/modelDslConfigureRuleRunWhenRequired.out[]
----
...
include::{samplesPath}/modelRules/configureAsRequired/modelDslConfigureRuleNotRunWhenNotRequired.out[]
----
...
.build.gradle
----
include::{samplesPath}/modelRules/initializationRuleRunsBeforeConfigurationRules/build.gradle[tag=configure-and-create-rules]
----

.Output of **`gradle showPerson`**
----
> gradle showPerson
include::{samplesPath}/modelRules/initializationRuleRunsBeforeConfigurationRules/modelDslInitializationRuleRunsBeforeConfigurationRule.out[]
----
...
.build.gradle
----
include::{samplesPath}/modelRules/configureElementsOfMap/build.gradle[tag=create-and-configure]
----

.Output of **`gradle listPeople`**
----
> gradle listPeople
include::{samplesPath}/modelRules/configureElementsOfMap/modelDslModelMapNestedAll.out[]
----
