...
.build.gradle
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/build.gradle[tag=managed-type-and-plugin]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/build.gradle[tag=create-rule]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/build.gradle[tag=plugin-mutate-rule]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/build.gradle[tag=task-create-rule]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/build.gradle[tag=managed-type]
----
...
[source,groovy,indent=0]
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/build.gradle[tag=property-type-string]
----
...
[source,groovy,indent=0]
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/build.gradle[tag=property-type-file]
----
...
[source,groovy,indent=0]
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/build.gradle[tag=property-type-long]
----
...
[source,groovy,indent=0]
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/build.gradle[tag=property-type-boolean]
----
...
[source,groovy,indent=0]
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/build.gradle[tag=property-type-int]
----
...
[source,groovy,indent=0]
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/build.gradle[tag=property-type-managed]
----
...
[source,groovy,indent=0]
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/build.gradle[tag=property-type-enum]
----
...
[source,groovy,indent=0]
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/build.gradle[tag=property-type-managedset]
----
...
[source,groovy,indent=0]
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/build.gradle[tag=property-type-collection-scalar]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/ruleSourcePluginEach/build.gradle[]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/modelDsl/build.gradle[tag=configure-rule]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/configureAsRequired/build.gradle[tag=configure-rule]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/modelDsl/build.gradle[tag=create-rule]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/modelDsl/build.gradle[tag=create-rule-no-config]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/initializationRuleRunsBeforeConfigurationRules/build.gradle[tag=configure-and-create-rules]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/modelDsl/build.gradle[tag=model-map-nested-create-rule]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/modelDsl/build.gradle[tag=model-map-nested-configure-rule]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/configureElementsOfMap/build.gradle[tag=create-and-configure]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/modelDsl/build.gradle[tag=managed-type-nested-config-rule]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/modelDslCoercion/build.gradle[]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/modelDsl/build.gradle[tag=rule-inputs]
----
