...
.build.gradle
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=managed-type-and-plugin]
----

.Output of **`gradle hello`**
----
> gradle hello
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/basicRuleSourcePlugin-all.out[]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=create-rule]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=plugin-mutate-rule]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=task-create-rule]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=managed-type]
----
...
[source,groovy,indent=0]
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=property-type-string]
----
...
[source,groovy,indent=0]
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=property-type-file]
----
...
[source,groovy,indent=0]
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=property-type-long]
----
...
[source,groovy,indent=0]
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=property-type-boolean]
----
...
[source,groovy,indent=0]
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=property-type-int]
----
...
[source,groovy,indent=0]
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=property-type-managed]
----
...
[source,groovy,indent=0]
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=property-type-enum]
----
...
[source,groovy,indent=0]
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=property-type-managedset]
----
...
[source,groovy,indent=0]
----
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/groovy/build.gradle[tag=property-type-collection-scalar]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/ruleSourcePluginEach/groovy/build.gradle[]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/modelDsl/groovy/build.gradle[tag=configure-rule]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/configureAsRequired/groovy/build.gradle[tag=configure-rule]
----

.Output of **`gradle showPerson`**
----
> gradle showPerson
include::{snippetsPath}/modelRules/configureAsRequired/modelDslConfigureRuleRunWhenRequired.out[]
----
...
include::{snippetsPath}/modelRules/configureAsRequired/modelDslConfigureRuleNotRunWhenNotRequired.out[]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/modelDsl/groovy/build.gradle[tag=create-rule]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/modelDsl/groovy/build.gradle[tag=create-rule-no-config]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/initializationRuleRunsBeforeConfigurationRules/groovy/build.gradle[tag=configure-and-create-rules]
----

.Output of **`gradle showPerson`**
----
> gradle showPerson
include::{snippetsPath}/modelRules/initializationRuleRunsBeforeConfigurationRules/modelDslInitializationRuleRunsBeforeConfigurationRule.out[]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/modelDsl/groovy/build.gradle[tag=model-map-nested-create-rule]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/modelDsl/groovy/build.gradle[tag=model-map-nested-configure-rule]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/configureElementsOfMap/groovy/build.gradle[tag=create-and-configure]
----

.Output of **`gradle listPeople`**
----
> gradle listPeople
include::{snippetsPath}/modelRules/configureElementsOfMap/modelDslModelMapNestedAll.out[]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/modelDsl/groovy/build.gradle[tag=managed-type-nested-config-rule]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/modelDslCoercion/groovy/build.gradle[]
----
...
.build.gradle
----
include::{snippetsPath}/modelRules/modelDsl/groovy/build.gradle[tag=rule-inputs]
----
...
----
> gradle model
include::{snippetsPath}/modelRules/basicRuleSourcePlugin/basicRuleSourcePlugin-model-task.out[]
----
