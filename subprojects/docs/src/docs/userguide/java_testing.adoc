...
====
include::sample[dir="userguide/java/fixtures/groovy/lib",files="build.gradle[tags=disable-test-fixtures-publishing]"]
include::sample[dir="userguide/java/fixtures/kotlin/lib",files="build.gradle.kts[tags=disable-test-fixtures-publishing]"]
====
