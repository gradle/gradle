...
====
include::sample[dir="userguide/visualStudio/groovy",files="build.gradle[tags=apply-plugin]"]
include::sample[dir="userguide/visualStudio/kotlin",files="build.gradle.kts[tags=apply-plugin]"]
====
...
+
Generates the `.vcxproj.filters` file.
...
The location of the generated solution can be configured on the root project using the `visualStudio` script bloc as follow:

.Change the generated solution file location
====
include::sample[dir="userguide/visualStudio/groovy",files="build.gradle[tags=configure-solution-location]"]
include::sample[dir="userguide/visualStudio/kotlin",files="build.gradle.kts[tags=configure-solution-location]"]
====

=== Change project generated files location

The location of the generated project files can be configured on any project using the `visualStudio` script bloc as follow:

.Change the generated project files location
====
include::sample[dir="userguide/visualStudio/groovy",files="build.gradle[tags=configure-project-and-filters-location]"]
include::sample[dir="userguide/visualStudio/kotlin",files="build.gradle.kts[tags=configure-project-and-filters-location]"]
====