...
Learn more in <<sec:inspecting_dependencies>>.
...
Concrete examples of build scripts and output available in the <<dependency_management, dependency management chapter>>.
