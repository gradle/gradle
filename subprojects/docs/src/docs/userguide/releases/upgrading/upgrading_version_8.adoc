...
The `java-base` plugin now assumes a maximum of one `link:{javadocPath}/org/gradle/api/component/Component.html[Component]` with the *internal* type `JvmSoftwareComponentInternal` will ever be created.
