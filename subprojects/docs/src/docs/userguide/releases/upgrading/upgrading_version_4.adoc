 ...
 * The `plugins {}` block can now be <<writing_plugins.adoc#sec:subprojects_plugins_dsl,used in subprojects>> and for <<writing_plugins.adoc#sec:buildsrc_plugins_dsl,plugins in the _buildSrc_ directory>>.
