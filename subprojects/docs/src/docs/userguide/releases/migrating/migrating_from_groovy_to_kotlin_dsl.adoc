...
TIP: Because your IDE knows about the configuration elements that a plugin provides, it will include those elements when you ask your IDE for suggestions. +
...
TIP:The easiest way to find out what configurations are available is by asking your IDE for suggestions within the `configurations` container. +
...
TIP: Please find detailed documentation in the <<kotlin_dsl.adoc#sec:interoperability,interoperability section of the Gradle Kotlin DSL Primer>>.
