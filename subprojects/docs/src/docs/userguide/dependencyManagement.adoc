...
Gradle builds can declare dependencies on external binaries, files and other Gradle projects as described below. Check out the <<dependency_types,full reference on all types of dependencies>> for more information.
