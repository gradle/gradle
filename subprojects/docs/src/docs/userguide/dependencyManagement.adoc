...
Gradle is not limited to declaring binary, file or project dependencies. Check out the <<dependency_types,full reference on all types of dependencies>> for more information.
