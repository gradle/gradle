...
====
include::sample[dir="ear/earWithWar/groovy",files="build.gradle[tags=use-ear-plugin]"]
include::sample[dir="ear/earWithWar/kotlin",files="build.gradle.kts[tags=use-ear-plugin]"]
====
...
====
include::sample[dir="ear/earCustomized/groovy/ear",files="build.gradle[]"]
include::sample[dir="ear/earCustomized/kotlin/ear",files="build.gradle.kts[]"]
====
