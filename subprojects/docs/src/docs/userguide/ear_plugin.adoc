...
`ear` — type: link:{groovyDslPath}/org.gradle.plugins.ear.Ear.html[Ear]::
...
`deploymentDescriptor` — type: link:{javadocPath}/org/gradle/plugins/ear/descriptor/DeploymentDescriptor.html[DeploymentDescriptor]::
