...
Favor <<multi_project_builds#sec:decoupled_projects,decoupling your projects>> instead.
...
In multi-project builds you should centrally declare plugin dependencies in the root project build file, specifying the version, without applying those used in sub-projects only.
