...
If you want to use a plugin that can't be applied using the `plugins {}` block directly in a single project build, see the <<kotlin_dsl#sec:plugins_resolution_strategy,dedicated section>> below.
