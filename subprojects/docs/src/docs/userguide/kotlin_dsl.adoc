...
====
include::sample[dir="kotlinDsl/androidBuild",files="build.gradle.kts[tags=android-buildscript];lib/build.gradle.kts[tags=android];app/build.gradle.kts[tags=android]"]
====
