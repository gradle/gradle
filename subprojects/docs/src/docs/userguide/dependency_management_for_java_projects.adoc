...
.Dependency declarations for a Java-based project
====
include::sample[dir="userguide/artifacts/dependencyBasics/groovy",files="build.gradle[]"]
include::sample[dir="userguide/artifacts/dependencyBasics/kotlin",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/artifacts/externalDependencies/groovy",files="build.gradle[tags=define-dependency]"]
include::sample[dir="userguide/artifacts/externalDependencies/kotlin",files="build.gradle.kts[tags=define-dependency]"]
====
...
====
include::sample[dir="userguide/artifacts/defineRepository/groovy",files="build.gradle[tags=local-ivy-repo]"]
include::sample[dir="userguide/artifacts/defineRepository/kotlin",files="build.gradle.kts[tags=local-ivy-repo]"]
====
