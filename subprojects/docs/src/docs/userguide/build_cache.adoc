...
* Other tasks:
    ...
    link:{javadocPath}/org/gradle/plugin/devel/tasks/ValidatePlugin.html[ValidatePlugin],
...
Gradle's <<composite_builds.adoc#composite-builds,composite build feature>> allows including other complete Gradle builds into another.
