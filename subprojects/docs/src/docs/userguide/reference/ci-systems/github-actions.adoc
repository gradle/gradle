...
----
$ git clone https://github.com/<YOUR-GITHUB-USER>/github-actions-gradle-sample.git
...
The following steps describe how to configure a GitHub Actions workflow to build your project.
...
[listing.terminal.sample-command]
----
$ git commit -a -m "Add GitHub Actions workflow"
$ git push
----
