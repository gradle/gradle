...
----
$ gradle wrapper
include::{samplesPath}/wrapper/simple/wrapperCommandLine.out[]
----
...
----
$ gradlew.bat build
include::{samplesPath}/wrapper/wrapperBatchFileExecution.out[]
----
...
include::{samplesPath}/wrapper/wrapperGradleVersionUpgrade.out[]
----
