...
----
$ gradle wrapper
include::{snippetsPath}/wrapper/simple/wrapperCommandLine.out[]
----
...
----
$ gradlew.bat build
include::{snippetsPath}/wrapper/simple/wrapperBatchFileExecution.out[]
----
...
include::{snippetsPath}/wrapper/simple/wrapperGradleVersionUpgrade.out[]
----
