...
include::{snippetsPath}/tutorial/excludeTasks/excludeTask.out[]
----
...
----
$ gradle cT
include::{snippetsPath}/tutorial/excludeTasks/abbreviateCamelCaseTaskName.out[]
----
...
include::{snippetsPath}/tutorial/projectReports/groovy/taskHelp.out[]
----
...
include::{snippetsPath}/tutorial/projectReports/groovy/propertyListReport.out[]
----
