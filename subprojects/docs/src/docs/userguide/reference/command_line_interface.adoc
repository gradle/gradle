...
include::{samplesPath}/tutorial/excludeTasks/excludeTask.out[]
----
...
----
$ gradle cT
include::{samplesPath}/tutorial/excludeTasks/abbreviateCamelCaseTaskName.out[]
----
...
include::{samplesPath}/tutorial/projectReports/taskHelp.out[]
----
...
include::{samplesPath}/tutorial/projectReports/propertyListReport.out[]
----
