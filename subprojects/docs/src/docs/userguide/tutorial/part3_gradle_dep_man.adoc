...
https://mvnrepository.com/artifact/junit/junit[JUnit] is a unit testing framework and https://mvnrepository.com/artifact/com.google.guava/guava[Guava] is a suite of libraries from Google.
