...
[NOTE]
====
If you're using <<toolchains.adoc#toolchains,Java Toolchains>>, the Java major version,
...
[NOTE]
====
<<java_plugin.adoc#sec:java_compile_avoidance,Java compile avoidance>> will treat this bytecode the same since it extracts the ABI.
====
