...
====
include::sample[dir="userguide/swift/basic/groovy",files="build.gradle[tags=apply-swift-plugin]"]
include::sample[dir="userguide/swift/basic/kotlin",files="build.gradle.kts[tags=apply-swift-plugin]"]
====
...
[[sec:introducing_build_variants]]
...
Gradle provides support for consuming pre-built binaries from Maven repositories published by Gradle footnote:[Unfortunately, Cocoapods repositories aren’t yet support as core features].
...
====
include::sample[dir="userguide/swift/basic/groovy",files="build.gradle[tags=swift-dependency-mgmt]"]
include::sample[dir="userguide/swift/basic/kotlin",files="build.gradle.kts[tags=swift-dependency-mgmt]"]
====
...
We have only scratched the surface here, so we recommend that you read the <<introduction_dependency_management.adoc#,dedicated dependency management chapters>> once you’re comfortable with the basics of building Swift projects with Gradle.
...
====
include::sample[dir="userguide/swift/basic/groovy",files="build.gradle[tags=swift-source-set]"]
include::sample[dir="userguide/swift/basic/kotlin",files="build.gradle.kts[tags=swift-source-set]"]
====
...
====
include::sample[dir="userguide/swift/basic/groovy",files="build.gradle[tags=swift-compiler-options-all-variants]"]
include::sample[dir="userguide/swift/basic/kotlin",files="build.gradle.kts[tags=swift-compiler-options-all-variants]"]
====
...
====
include::sample[dir="userguide/swift/basic/groovy",files="build.gradle[tags=swift-compiler-options-per-variants]"]
include::sample[dir="userguide/swift/basic/kotlin",files="build.gradle.kts[tags=swift-compiler-options-per-variants]"]
====
...
====
include::sample[dir="userguide/swift/basic/groovy",files="build.gradle[tags=swift-select-target-machines]"]
include::sample[dir="userguide/swift/basic/kotlin",files="build.gradle.kts[tags=swift-select-target-machines]"]
====
...
The Swift Application and Library Plugins add a `clean` task to you project by using the <<base_plugin,base plugin>>.
...
//In addition, you can see a basic, practical example of building a Swift library in the corresponding link:{guidesUrl}/building-swift-libraries[guide].
...
// TODO Uncomment when guides are ready
//You can see a basic example of building a Swift application in the corresponding link:{guidesUrl}/building-swift-applications[guide].
