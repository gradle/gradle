...
Large projects may have to increase this setting on the relevant tasks, e.g. <<build_environment.adoc#example_set_java_compile_options_for_javacompile_tasks,`JavaCompile`>> or link:{groovyDslPath}/org.gradle.api.tasks.testing.Test.html[`Test`].
