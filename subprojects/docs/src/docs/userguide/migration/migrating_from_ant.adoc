...
[NOTE]
====
If you store your dependencies in the standard Maven repository layout (`<repoDir>/<group>/<module>/<version>`), you can define a <<declaring_repositories.adoc#sec:maven_repo,custom Maven repository>> with a "file://" URL.
====
