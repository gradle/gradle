...
To run:
   ...
   ./gradlew :integTest:integTest --tests "*SamplesAntImportIntegrationTest"
////
...
====
include::sample[dir="snippets/userguide/antMigration/importBuild/groovy",files="build.gradle[tags=apply-plugin]"]
include::sample[dir="snippets/userguide/antMigration/importBuild/kotlin",files="build.gradle.kts[tags=apply-plugin]"]
====
...
====
include::sample[dir="snippets/userguide/antMigration/importBuild/groovy",files="build.gradle[tags=import-build]"]
include::sample[dir="snippets/userguide/antMigration/importBuild/kotlin",files="build.gradle.kts[tags=import-build]"]
====
...
====
include::sample[dir="snippets/userguide/antMigration/importBuild/groovy",files="build.gradle[tags=source-sets]"]
include::sample[dir="snippets/userguide/antMigration/importBuild/kotlin",files="build.gradle.kts[tags=source-sets]"]
====
...
====
include::sample[dir="snippets/userguide/antMigration/importBuild/groovy",files="build.gradle[tags=task-dependencies]"]
include::sample[dir="snippets/userguide/antMigration/importBuild/kotlin",files="build.gradle.kts[tags=task-dependencies]"]
====
...
====
include::sample[dir="snippets/userguide/antMigration/fileDeps/groovy",files="build.gradle[tags=file-deps]"]
include::sample[dir="snippets/userguide/antMigration/fileDeps/kotlin",files="build.gradle.kts[tags=file-deps]"]
====
...
====
include::sample[dir="snippets/userguide/antMigration/fileDeps/groovy",files="build.gradle[tags=retrieve-deps]"]
include::sample[dir="snippets/userguide/antMigration/fileDeps/kotlin",files="build.gradle.kts[tags=retrieve-deps]"]
====
+
...
====
include::sample[dir="snippets/userguide/antMigration/fileDeps/groovy",files="build.gradle[tags=properties]"]
include::sample[dir="snippets/userguide/antMigration/fileDeps/kotlin",files="build.gradle.kts[tags=properties]"]
====
...
+
====
include::sample[dir="snippets/userguide/antMigration/multiProject/groovy",files="web/build.xml[tags=build-required]"]
====
...
+
====
include::sample[dir="snippets/userguide/antMigration/multiProject/groovy",files="web/build.gradle[]"]
include::sample[dir="snippets/userguide/antMigration/multiProject/kotlin",files="web/build.gradle.kts[]"]
====
+
