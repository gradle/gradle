...
The above sample will add `our-custom.jar`, `log4j-core-2.19.0.jar` and `commons-io-2.11.0.jar` to the `implementation` configuration, which is used to compile the project's code.
