...
Gradle 6.3 does not support the <<command_line_interface.adoc#rich_console, rich console>> for 32-bit Unix systems and for old FreeBSD versions (older than FreeBSD 10). Microsoft Windows 32-bit is unaffected.
