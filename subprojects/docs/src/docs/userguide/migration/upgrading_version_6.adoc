...
Gradle Kotlin DSL extensions have been changed to favour Gradle's `Action<T>` type over Kotlin function types.

While the change should be transparent to Kotlin clients, Java clients need to be updated.
