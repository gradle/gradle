...
- `getDependencies() - DECLARABLE (also permitted when declaration is allowed but deprecated)
- `getDependencyConstraints() - DECLARABLE (also permitted when declaration is allowed but deprecated)
