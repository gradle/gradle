...
While the updated solution may be more verbose, 
reducing the number of ways to achieve the same result is a worthwhile
trade-off. Moving forward, component metadata rules
should live within build-logic and should not clutter up
the buildscript.
