...
[[configuration_copying_deprecated]]

Copying `Configuration` using any of the following methods deprecated for removal:
...
Instead of copying configurations, create a new configuration and extend existing configurations using `extendsFrom` where necessary.
For an example of this, see
 <<organizing_gradle_projects#sec:replacements_for_copy,alternatives to the copy method>>.
