...
- PMD has been updated to https://github.com/pmd/pmd/releases/tag/pmd_releases%2F6.55.0[PMD 6.55.0].
- CodeNarc has been updated to https://github.com/CodeNarc/CodeNarc/blob/v3.2.0/CHANGELOG.md#version-320----jan-2023[CodeNarc 3.2.0].
