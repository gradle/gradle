...
A new API for defining file permissions has been added, see link:{javadocPath}/org/gradle/api/file/FileAccessPermissions.html[FileAccessPermissions].
Unix mode based old methods have been deprecated:
