...
The deprecation warnings show up in https://scans.gradle.com/s/txrptciitl2ha/deprecations[Build Scan™] for every build, regardless of the command-line switches used.
...
Please use https://scans.gradle.com/[Build Scan™] for build analysis and comparison.
...
link:https://gradle.com/build-scans[Build Scan™] shows much deeper insights into your build and you can use link:https://gradle.com/[Gradle Enterprise] to directly compare two different build-scans.
