...
The deprecated Play plugins has been removed.
An external replacement link:https://gradle.github.io/playframework[Play Framework plugin] available from the plugin portal.
