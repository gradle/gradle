...
You can opt into the old behavior for selected repositories by adding the `artifact()` <<repositories_cheat_sheet.adoc#sec:supported_metadata_sources,metadata source>>.
