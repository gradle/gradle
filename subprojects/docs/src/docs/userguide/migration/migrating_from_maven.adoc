...
----
> gradle projects
include::{samplesPath}/mavenMigration/multiModule/projects.out[]
----
...
----
> gradle greeting
include::{samplesPath}/mavenMigration/profiles/greeting-default.out[]
----
.Output of **`gradle -PbuildProfile=test greeting`**
----
> gradle -PbuildProfile=test greeting
include::{samplesPath}/mavenMigration/profiles/greeting-test.out[]
----
