...
Gradle will also create a settings script if you're migrating a <<creating_multi_project_builds#multi_project_builds,multi-project build>>.
...
Maven's multi-module builds map nicely to Gradle's <<creating_multi_project_builds#multi_project_builds,multi-project builds>>.
