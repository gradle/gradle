...
TIP: Suffering from slow Maven builds? https://gradle.com/training[Register here] for our Build Cache training session to learn how Gradle Enterprise can speed up Maven builds by up to 90%.
