...
----
> gradle projects
include::{snippetsPath}/mavenMigration/multiModule/projects.out[]
----
...
----
> gradle greeting
include::{snippetsPath}/mavenMigration/profiles/greeting-default.out[]
----
.Output of **`gradle -PbuildProfile=test greeting`**
----
> gradle -PbuildProfile=test greeting
include::{snippetsPath}/mavenMigration/profiles/greeting-test.out[]
----
