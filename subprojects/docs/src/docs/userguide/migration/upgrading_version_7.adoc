...
If you must use AdoptOpenJDK, you should turn off auto-download. If an Eclipse Temurin or IBM Semeru build works for you, specify `JvmVendorSpec.TEMURIN` or `JvmVendorSpec.SEMERU` as the vendor or leave the vendor unspecified.
