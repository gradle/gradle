...
With Gradle 7.x Kotlin Gradle Plugin 1.3.72 through 1.6.21 were tested and supported.
With Gradle 8.x minimal Kotlin Gradle Plugin tested and supported version is 1.6.10.
It is still possible to compile to lower Kotlin language version, by modifying language version and api version setting for the Kotlin compile task.

==== Minimal supported Android Gradle Plugin version changed
With Gradle 7.x Android Gradle Plugin 4.1 through 7.3 were tested and supported.
With Gradle 8.x minimal Android Gradle Plugin tested and supported version is 7.3 with `android.experimental.legacyTransform.forceNonIncremental=true` property.
Android Gradle Plugin 8 and later don't require additional property to work with Gradle 8.
