...
Groovy has been updated to https://groovy-lang.org/releasenotes/groovy-3.0.html[Groovy 3.0.12].

==== Upgrade to PMD 6.48.0

PMD has been updated to https://pmd.github.io/latest/pmd_release_notes.html[PMD 6.48.0].
