...
==== Upgrade to Guava 32.1.3

Guava has been updated from 31.1 to https://github.com/google/guava/releases/tag/v32.1.3[32.1.3].

==== Upgrade to Jackson 2.16.1

Jackson has been updated from 2.14.1 to https://github.com/FasterXML/jackson/wiki/Jackson-Release-2.15[2.15.3].

==== Upgrade to Ivy 2.5.3

Ivy has been updated from 2.3.0 to https://ant.apache.org/ivy/history/2.5.3/release-notes.html[2.5.3].

==== Upgrade to Maven 3.9.6

Maven has been updated from 3.6.3 to https://maven.apache.org/docs/3.9.6/release-notes.html[3.9.6].

==== Upgrade to Plexus Cipher 2.0

Plexus Cipher and related utils were upgraded from 1.x to https://github.com/codehaus-plexus/plexus-cipher/releases/tag/plexus-cipher-2.0[2.0].

==== Upgrade to ASM 9.8

ASM was upgraded from 9.4 to https://asm.ow2.io/versions.html[9.8] for better support of multi-release jars.
...
Apache SSHD has been updated from 2.0.0 to https://mina.apache.org/sshd-project/download_2.15.0.html[2.15.0].

==== Upgrade to Apache Commons Compress 1.27.1

Apache Commons Compress has been updated from 1.21 to https://commons.apache.org/proper/commons-compress/changes-report.html#a1.27.1[1.27.1].
...
Related Apache Commons libraries have also been updated.

=== Upgrade to Bouncy Castle 1.80

Bouncy Castle has been updated from 1.68 to https://www.bouncycastle.org/download/bouncy-castle-java/?filter=java%3Drelease-1-80[1.80].

==== Upgrade to Zinc 1.9.6

Zinc has been updated to https://github.com/sbt/zinc/releases/tag/v1.9.6[1.9.6].
...
Since Checkstyle runs as an external process you can control the memory via the `minHeapSize` and `maxHeapSize` properties on the Checkstyle tasks.
In case of out of memory errors, increasing the max memory via the `maxHeapSize` property should solve the issue.
By default, the process will start with `maxHeapSize` of 512MB.
...
some logic in the FileResolver.
