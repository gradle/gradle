...
Despite being an internal package, `org.gradle.util` is used by several Gradle plugins. In Gradle 7.1 we did a major cleanup there.

The following classes have known usages in external plugins. They are now deprecated and set for removal in Gradle 8.0:
...
[[exec_properties]]
=== Properties deprecated in Exec task

* The link:{groovyDslPath}/org.gradle.api.tasks.Exec.html#org.gradle.api.tasks.Exec:execResult[Exec.execResult]
property has been deprecated.
Use the link:{groovyDslPath}/org.gradle.api.tasks.Exec.html#org.gradle.api.tasks.Exec:executionResult[Exec.executionResult]
property instead.
...
* The link:{groovyDslPath}/org.gradle.api.file.SourceDirectorySet.html#org.gradle.api.file.SourceDirectorySet:outputDir[SourceDirectorySet.outputDir]
property has been deprecated.
Use the link:{groovyDslPath}/org.gradle.api.file.SourceDirectorySet.html#org.gradle.api.file.SourceDirectorySet:classesDirectory[SourceDirectorySet.classesDirectory]
property instead.
...
[[compile_options_properties]]
=== Properties deprecated in CompileOptions

* The link:{groovyDslPath}/org.gradle.api.tasks.compile.CompileOptions.html#org.gradle.api.tasks.compile.CompileOptions:annotationProcessorGeneratedSourcesDirectory[CompileOptions.annotationProcessorGeneratedSourcesDirectory]
property has been deprecated.
Use the link:{groovyDslPath}/org.gradle.api.tasks.compile.CompileOptions.html#org.gradle.api.tasks.compile.CompileOptions:generatedSourceOutputDirectory[CompileOptions.generatedSourceOutputDirectory]
property instead.

[[start_scripts_properties]]
==== Properties deprecated in CreateStartScripts task

* The `mainClassName` getters and setters
in link:{groovyDslPath}/org.gradle.jvm.application.tasks.CreateStartScripts.html[CreateStartScripts] task have been deprecated.
Use the link:{groovyDslPath}/org.gradle.jvm.application.tasks.CreateStartScripts.html#org.gradle.jvm.application.tasks.CreateStartScripts:mainClass[mainClass] property instead.
