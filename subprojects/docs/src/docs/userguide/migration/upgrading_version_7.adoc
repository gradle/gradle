...
Along with the Java language version, the <<toolchains#,Java toolchain>> DSL allows configuring other criteria such as specific vendors or VM implementations.
...
See more details about toolchain configuration in the <<toolchains#configuring_toolchain_specifications,user manual>>.
