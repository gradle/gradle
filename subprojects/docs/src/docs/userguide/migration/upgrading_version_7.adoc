...
[[kotlin_language_1_7]]
==== Kotlin DSL now uses Kotlin language/api 1.7

Starting with Gradle 8.0 it uses Kotlin language and API 1.7 level.
It was previously using 1.4.
This includes potential breaking changes for your `.gradle.kts` scripts and plugins authored with the `kotlin-dsl` plugin.

Please find below links to the included changes:

* Kotlin 1.5 link:https://kotlinlang.org/docs/whatsnew15.html#language-features[language] / link:https://kotlinlang.org/docs/whatsnew17.html#standard-library[stdlib]
...
* Kotlin 1.7 link:https://kotlinlang.org/docs/whatsnew17.html#language[language] / link:https://kotlinlang.org/docs/whatsnew15.html#standard-library[stdlib]
