...
==== Upgrade to Ivy 2.5.2

Ivy has been updated from 2.3.0 to https://ant.apache.org/ivy/history/2.5.2/release-notes.html[2.5.2].
...
ASM was upgraded from 9.4 to https://asm.ow2.io/versions.html[9.6] for better support of multi-release jars.
