...
Plugins extending these classes should be made abstract too. Gradle uses runtime class decoration to implement abstract methods. Those methods should not be directly implemented.
