...
.build.gradle
----
include::{samplesPath}/userguide/java/basic/build.gradle[tag=apply-java-plugin]
----
...
.build.gradle
----
include::{samplesPath}/userguide/java/basic/build.gradle[tag=java-dependency-mgmt]
----
...
.build.gradle
----
include::{samplesPath}/userguide/java/customDirs/build.gradle[tag=custom-src-dirs]
----
...
.build.gradle
----
include::{samplesPath}/userguide/java/customDirs/build.gradle[tag=custom-extra-src-dir]
----
...
.build.gradle
----
include::{samplesPath}/userguide/java/basic/build.gradle[tag=java-compiler-options]
----
...
.gradle.properties
----
include::{samplesPath}/java/crossCompilation/gradle.properties[]
----

[source.multi-language-sample,groovy]
.build.gradle
----
include::{samplesPath}/java/crossCompilation/build.gradle[tag=java-cross-compilation]
----
...
.build.gradle
----
include::{samplesPath}/userguide/java/basic/build.gradle[tag=defining-sources-jar-task]
----
...
.build.gradle
----
include::{samplesPath}/userguide/java/basic/build.gradle[tag=using-custom-doclet]
----
...
.build.gradle
----
include::{samplesPath}/userguide/java/basic/build.gradle[tag=defining-custom-javadoc-task]
----
...
The Java Plugin adds a `clean` task to your project by virtue of applying the <<base_plugin.adoc#base_plugin,Base Plugin>>. This task simply deletes everything in the `$buildDir` directory, hence why you should always put files generated by the build in there. The task is an instance of link:{groovyDslPath}/org.gradle.api.tasks.Delete.html[Delete] and you can change what directory it deletes by setting its `dir` property.
