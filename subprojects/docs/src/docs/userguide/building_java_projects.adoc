 ...
 * Defining a custom <<declaring_repositories.adoc#sub:maven_repo,Maven\->> or <<declaring_repositories.adoc#sec:ivy_repositories,Ivy-compatible>> repository
 * Using dependencies from a <<declaring_repositories.adoc#sec:flat_dir_resolver,local filesystem directory>>
