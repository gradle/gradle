...
`generateDescriptorFileFor__PubName__Publication` — type: link:{groovyDslPath}/org.gradle.api.publish.ivy.tasks.GenerateIvyDescriptor.html[GenerateIvyDescriptor]::
...
`publish__PubName__PublicationTo__RepoName__Repository` — type: link:{groovyDslPath}/org.gradle.api.publish.ivy.tasks.PublishToIvyRepository.html[PublishToIvyRepository]::
...
.output-ivy.xml
----
include::{samplesPath}/ivy-publish/java-multi-project/output-ivy.xml[tag=content]
----
