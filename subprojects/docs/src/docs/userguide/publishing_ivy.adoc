...
* The Javadoc and sources JAR artifacts of the Java component (because we configured `publishJavadoc()` and `publishSources()`): `project1-1.0-javadoc.jar`, `project1-1.0-source.jar`.
