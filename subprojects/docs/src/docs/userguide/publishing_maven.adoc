...
You can learn about the fundamentals of publishing in <<publishing.adoc#publishing_overview,Publishing Overview>>.
...
This plugin provides <<dependency_management_terminology.adoc#sub:terminology_repository,repositories>> of type link:{groovyDslPath}/org.gradle.api.artifacts.repositories.MavenArtifactRepository.html[MavenArtifactRepository]. To learn how to define and use repositories for publishing, see the section on <<publishing.adoc#sec:basic_publishing,basic publishing>>.
