...
====
include::sample[dir="userguide/organizingGradleProjects/configureProjectUsingScript/groovy", files="build.gradle[]"]
include::sample[dir="userguide/organizingGradleProjects/configureProjectUsingScript/kotlin", files="build.gradle.kts[]"]
====
...
====
include::sample[dir="plugins/dsl/groovy", files="build.gradle[tags=use-plugin]"]
include::sample[dir="plugins/dsl/kotlin", files="build.gradle.kts[tags=use-plugin]"]
====
...
====
include::sample[dir="plugins/multiproject/groovy", files="settings.gradle[tags=include-subprojects];build.gradle[tags=plugins-on-subprojects]"]
include::sample[dir="plugins/multiproject/kotlin", files="settings.gradle.kts[tags=include-subprojects];build.gradle.kts[tags=plugins-on-subprojects]"]
====
...
====
include::sample[dir="plugins/dslWithBuildSrc/groovy", files="buildSrc/build.gradle[tags=main-block]"]
include::sample[dir="plugins/dslWithBuildSrc/kotlin", files="buildSrc/build.gradle.kts[tags=main-block]"]
====
...
====
include::sample[dir="plugins/dslWithBuildSrc/groovy", files="build.gradle[tags=use-plugin]"]
include::sample[dir="plugins/dslWithBuildSrc/kotlin", files="build.gradle.kts[tags=use-plugin]"]
====
...
====
include::sample[dir="plugins/pluginManagement/groovy", files="settings.gradle[];init.gradle[]"]
include::sample[dir="plugins/pluginManagement/kotlin", files="settings.gradle.kts[];init.gradle.kts[]"]
====
...
====
include::sample[dir="plugins/consuming/groovy", files="settings.gradle[tags=custom-plugin-repositories]"]
include::sample[dir="plugins/consuming/kotlin", files="settings.gradle.kts[tags=custom-plugin-repositories]"]
====
...
====
include::sample[dir="plugins/resolutionRules/groovy", files="settings.gradle[tags=plugin-resolution-strategy]"]
include::sample[dir="plugins/resolutionRules/kotlin", files="settings.gradle.kts[tags=plugin-resolution-strategy]"]
====
...
====
include::sample[dir="plugins/publishing/groovy", files="build.gradle[tags=complete-plugin-publishing]"]
include::sample[dir="plugins/publishing/kotlin", files="build.gradle.kts[tags=complete-plugin-publishing]"]
====
...
====
include::sample[dir="userguide/tutorial/pluginIntro/groovy", files="build.gradle[tags=apply-by-type]"]
include::sample[dir="userguide/tutorial/pluginIntro/kotlin", files="build.gradle.kts[tags=apply-by-type]"]
====
...
====
include::sample[dir="plugins/buildscript/groovy", files="build.gradle[tags=buildscript_block]"]
include::sample[dir="plugins/buildscript/kotlin", files="build.gradle.kts[tags=buildscript_block]"]
====
