...
====
include::sample[dir="userguide/organizingGradleProjects/configureProjectUsingScript", files="build.gradle[]"]
====
...
====
include::sample[dir="plugins/dsl", files="build.gradle[tags=use-plugin]"]
====
...
====
include::sample[dir="plugins/dsl", files="build.gradle[tags=use-community-plugin]"]
====
...
====
include::sample[dir="plugins/multiproject", files="settings.gradle[tags=include-subprojects];build.gradle[tags=plugins-on-subprojects]"]
====
...
====
include::sample[dir="plugins/dslWithBuildSrc", files="buildSrc/build.gradle[tags=main-block]"]
====
...
====
include::sample[dir="plugins/dslWithBuildSrc", files="build.gradle[tags=use-plugin]"]
====
...
====
include::sample[dir="plugins/pluginManagement", files="settings.gradle[];init.gradle[]"]
====
...
====
include::sample[dir="plugins/consuming", files="settings.gradle[tags=custom-plugin-repositories]"]
====
...
====
include::sample[dir="plugins/resolutionRules", files="settings.gradle[tags=plugin-resolution-strategy]"]
====
...
====
include::sample[dir="plugins/publishing", files="build.gradle[tags=complete-plugin-publishing]"]
====
...
====
include::sample[dir="java/quickstart", files="build.gradle[tags=use-plugin]"]
====
...
====
include::sample[dir="userguide/tutorial/pluginIntro", files="build.gradle[tags=apply-by-type]"]
====
...
====
include::sample[dir="plugins/buildscript", files="build.gradle[tags=buildscript_block]"]
====
