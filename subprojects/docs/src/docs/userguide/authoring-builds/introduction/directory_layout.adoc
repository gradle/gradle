...
The Gradle User Home (`~/.gradle` or `C:\Users\username\.gradle` by default) stores global configuration properties and initialization scripts, caches, and log files.
