...
NOTE: The task configuration APIs are described in more detail in the <<task_configuration_avoidance#task_configuration_avoidance,task configuration avoidance chapter>>.
...
WARNING: The following shows how to access a task by path.
...
TIP: If you use the _Kotlin DSL_ and the task you want to configure was added by a plugin, you can use a convenient accessor for the task. +
...
NOTE: It's recommended to use the <<task_configuration_avoidance.adoc#task_configuration_avoidance,Task Configuration Avoidance>> APIs to improve configuration time.
