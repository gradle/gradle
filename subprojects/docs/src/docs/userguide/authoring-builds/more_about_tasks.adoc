...
====
include::sample[dir="samples/writing-tasks/tasks-with-dependency-resolution-result-inputs/groovy",files="settings.gradle[tag=includes];build.gradle[];utilities/build.gradle[];list/build.gradle[]"]
include::sample[dir="samples/writing-tasks/tasks-with-dependency-resolution-result-inputs/kotlin",files="settings.gradle.kts[tag=includes];build.gradle.kts[];utilities/build.gradle.kts[];list/build.gradle.kts[]"]
====
