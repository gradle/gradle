...
====
include::sample[dir="snippets/tasks/addToTaskContainer/groovy",files="build.gradle[]"]
include::sample[dir="snippets/tasks/addToTaskContainer/kotlin",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="snippets/tasks/defineAsGroovyExpression",files="build.gradle[]"]
include::sample[dir="snippets/tasks/defineAsKotlinDelegatedProperty",files="build.gradle.kts[]"]
...
====
include::sample[dir="snippets/tasks/accessAsGroovyProperty",files="build.gradle[]"]
include::sample[dir="snippets/tasks/accessAsKotlinDelegatedProperty",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="snippets/tasks/accessUsingPath/groovy",files="build.gradle[]"]
include::sample[dir="snippets/tasks/accessUsingPath/kotlin",files="build.gradle.kts[]"]

.Output of **`gradle -q hello`**
----
> gradle -q hello
include::{samplesPath}/tasks/accessUsingPath/accessUsingPath.out[]
----
====
...
====
include::sample[dir="snippets/tasks/taskConstructorArgs/onProject/groovy",files="build.gradle[tags=on-project]"]
include::sample[dir="snippets/tasks/taskConstructorArgs/onProject/kotlin",files="build.gradle.kts[tags=on-project]"]
====
...
----
> gradle -q taskX
include::{samplesPath}/tasks/addDependencyUsingPath/addDependencyUsingPath.out[]
----
====
...
----
> gradle -q taskX
include::{samplesPath}/tasks/addDependencyUsingTask/addDependencyUsingTask.out[]
----
====
...
----
> gradle -q taskX
include::{samplesPath}/tasks/addDependencyUsingClosure/addDependencyUsingClosure.out[]
----
====
...
include::{samplesPath}/tasks/mustRunAfter/mustRunAfter.out[]
----
====
...
----
> gradle -q taskY taskX
include::{samplesPath}/tasks/shouldRunAfter/shouldRunAfter.out[]
----
====
...
----
> gradle -q taskY
include::{samplesPath}/tasks/mustRunAfter/mustRunAfterSingleTask.out[]
----
====
...
----
> gradle -q taskX
include::{samplesPath}/tasks/shouldRunAfterWithCycle/shouldRunAfterWithCycle.out[]
----
====
...
include::{samplesPath}/tutorial/taskOnlyIf/taskOnlyIf.out[]
----
====
...
----
> gradle -q myTask
include::{samplesPath}/tutorial/stopExecutionException/stopExecutionException.out[]
----
====
...
----
> gradle disableMe
include::{samplesPath}/tutorial/disableTask/disableTask.out[]
----
====
...
include::sample[dir="snippets/tasks/timeout/kotlin",files="build.gradle.kts[]"]
====
...
----
include::{samplesPath}/tasks/incrementalBuild/customTaskClass/groovy/buildSrc/src/main/java/org/example/ProcessTemplates.java[tag=custom-task-class]
----

[source,java]
.buildSrc/src/main/java/org/example/TemplateData.java
----
include::{samplesPath}/tasks/incrementalBuild/customTaskClass/groovy/buildSrc/src/main/java/org/example/TemplateData.java[]
----

.Output of `gradle processTemplates`
----
> gradle processTemplates
include::{samplesPath}/tasks/incrementalBuild/customTaskClass/customTaskClassWithInputOutputAnnotations.out[]
----

.Output of `gradle processTemplates` (run again)
----
> gradle processTemplates
include::{samplesPath}/tasks/incrementalBuild/customTaskClass/customTaskClassWithInputOutputAnnotationsUpToDate.out[]
----
====
...
include::{samplesPath}/tasks/incrementalBuild/customTaskClass/customTaskClassWithoutInputOutputAnnotations.out[]
----
...
include::{samplesPath}/tasks/incrementalBuild/customTaskClass/incrementalAdHocTask.out[]
----
====
...
include::{samplesPath}/tasks/incrementalBuild/customTaskClass/incrementalAdHocTaskNoSource.out[]
----
====
...
include::{samplesPath}/tasks/incrementalBuild/customTaskClass/inferredTaskDep.out[]
----
====
...
include::{samplesPath}/tasks/incrementalBuild/customTaskClass/inferredTaskDep2.out[]
----
====
...
[source,java]
----
include::{samplesPath}/tasks/incrementalBuild/incrementalBuildAdvanced/groovy/buildSrc/src/main/java/org/example/ProcessTemplates.java[tag=custom-task-class]
----

.Output of `gradle processTemplates`
----
> gradle processTemplates
include::{samplesPath}/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildCustomMethods.out[]
----
====
...
[source,java]
----
include::{samplesPath}/tasks/incrementalBuild/incrementalBuildAdvanced/groovy/buildSrc/src/main/java/org/example/ProcessTemplates.java[tag=task-arg-method]
----

.Output of `gradle processTemplates2`
----
> gradle processTemplates2
include::{samplesPath}/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildCustomMethodsWithTaskArg.out[]
----
====
...
include::{samplesPath}/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildBadInputFilesConfig.out[]
----
====
...
include::{samplesPath}/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildInputFilesConfig.out[]
----
====
...
include::{samplesPath}/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildInputFilesConfigUsingTask.out[]
----
====
...
include::{samplesPath}/tasks/incrementalBuild/incrementalBuildAdvanced/inferredTaskDependencyWithBuiltBy.out[]
----
====
...
====
include::sample[dir="snippets/tasks/incrementalBuild/incrementalBuildAdvanced/groovy",files="build.gradle[tags=up-to-date-when]"]
include::sample[dir="snippets/tasks/incrementalBuild/incrementalBuildAdvanced/kotlin",files="build.gradle.kts[tags=up-to-date-when]"]

.Output of `gradle clean alwaysInstrumentClasses`
----
> gradle clean alwaysInstrumentClasses
include::{samplesPath}/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildUpToDateWhen.out[]
----

.Output of `gradle alwaysInstrumentClasses`
----
> gradle alwaysInstrumentClasses
include::{samplesPath}/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildUpToDateWhenAgain.out[]
----
====
...
include::{samplesPath}/tasks/addRules/taskRule.out[]
----
====
...
----
> gradle -q groupPing
include::{samplesPath}/tasks/addRules/taskRuleDependsOn.out[]
----
====
...
----
> gradle -q taskX
include::{samplesPath}/tasks/finalizers/taskFinalizers.out[]
----
====
...
----
> gradle -q taskX
include::{samplesPath}/tasks/finalizersWithFailure/taskFinalizersWithFailureGroovy.out[]
----
====
