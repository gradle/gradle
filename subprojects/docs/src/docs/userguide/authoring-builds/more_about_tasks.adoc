...
====
include::sample[dir="snippets/userguide/tasks/defineUsingStringTaskNames/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/tasks/defineUsingStringTaskNames/kotlin",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="snippets/userguide/tasks/addToTaskContainer/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/tasks/addToTaskContainer/kotlin",files="build.gradle.kts[]"]
====

Here we add tasks to the `tasks` collection. Have a look at link:{javadocPath}/org/gradle/api/tasks/TaskContainer.html[TaskContainer] for more variations of the `register()` method.

And finally, there are language specific syntaxes for the Groovy and Kotlin DSL:

.Defining tasks using a DSL specific syntax
====
include::sample[dir="snippets/userguide/tasks/defineAsGroovyExpression",files="build.gradle[]"]
include::sample[dir="snippets/userguide/tasks/defineAsKotlinDelegatedProperty",files="build.gradle.kts[]"]
...
====
include::sample[dir="snippets/userguide/tasks/accessAsGroovyProperty",files="build.gradle[]"]
include::sample[dir="snippets/userguide/tasks/accessAsKotlinDelegatedProperty",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="snippets/userguide/tasks/accessFromTaskContainer/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/tasks/accessFromTaskContainer/kotlin",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="snippets/userguide/tasks/accessUsingPath/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/tasks/accessUsingPath/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="snippets/userguide/tasks/accessUsingType/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/tasks/accessUsingType/kotlin",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="snippets/userguide/tasks/configureUsingBlock/groovy",files="build.gradle[tags=declare-task]"]
include::sample[dir="snippets/userguide/tasks/configureUsingBlock/kotlin",files="build.gradle.kts[tags=declare-task]"]
====
...
====
include::sample[dir="snippets/userguide/tasks/configureUsingVar/groovy",files="build.gradle[tags=configure]"]
include::sample[dir="snippets/userguide/tasks/configureUsingVar/kotlin",files="build.gradle.kts[tags=configure]"]
====
...
====
include::sample[dir="snippets/userguide/tasks/configureUsingBlock/groovy",files="build.gradle[tags=configure]"]
include::sample[dir="snippets/userguide/tasks/configureUsingBlock/kotlin",files="build.gradle.kts[tags=configure]"]
====

This works for _any_ task. Task access is just a shortcut for the `tasks.named()` (Kotlin) or `tasks.getByName()` (Groovy) method. It is important to note that blocks used here are for _configuring_ the task and are not evaluated when the task executes.
...
====
include::sample[dir="snippets/userguide/tasks/defineAndConfigure/groovy",files="build.gradle[tags=no-description]"]
include::sample[dir="snippets/userguide/tasks/defineAndConfigure/kotlin",files="build.gradle.kts[tags=no-description]"]
====
...
====
include::sample[dir="snippets/userguide/tasks/taskConstructorArgs/onTaskContainer/groovy",files="build.gradle[tags=inject-task-constructor]"]
include::sample[dir="snippets/userguide/tasks/taskConstructorArgs/onTaskContainer/kotlin",files="build.gradle.kts[tags=inject-task-constructor]"]
====
...
====
include::sample[dir="snippets/userguide/tasks/taskConstructorArgs/onTaskContainer/groovy",files="build.gradle[tags=on-task-container]"]
include::sample[dir="snippets/userguide/tasks/taskConstructorArgs/onTaskContainer/kotlin",files="build.gradle.kts[tags=on-task-container]"]
====
...
====
include::sample[dir="snippets/userguide/tasks/taskConstructorArgs/onProject/groovy",files="build.gradle[tags=on-project]"]
include::sample[dir="snippets/userguide/tasks/taskConstructorArgs/onProject/kotlin",files="build.gradle.kts[tags=on-project]"]
====
...
====
include::sample[dir="snippets/userguide/tasks/addDependencyUsingPath/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/tasks/addDependencyUsingPath/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="snippets/userguide/tasks/addDependencyUsingTask/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/tasks/addDependencyUsingTask/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="snippets/userguide/tasks/addDependencyUsingClosure/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/tasks/addDependencyUsingClosure/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="snippets/userguide/tasks/mustRunAfter/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/tasks/mustRunAfter/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="snippets/userguide/tasks/shouldRunAfter/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/tasks/shouldRunAfter/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="snippets/userguide/tasks/shouldRunAfterWithCycle/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/tasks/shouldRunAfterWithCycle/kotlin",files="build.gradle.kts[]"]
...
.Adding a description to a task
====
include::sample[dir="snippets/userguide/tasks/defineAndConfigure/groovy",files="build.gradle[tags=all]"]
include::sample[dir="snippets/userguide/tasks/defineAndConfigure/kotlin",files="build.gradle.kts[tags=all]"]
====
...
====
include::sample[dir="snippets/userguide/tutorial/taskOnlyIf/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/tutorial/taskOnlyIf/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="snippets/userguide/tutorial/stopExecutionException/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/tutorial/stopExecutionException/kotlin",files="build.gradle.kts[]"]
...
.Enabling and disabling tasks
====
include::sample[dir="snippets/userguide/tutorial/disableTask/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/tutorial/disableTask/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="snippets/userguide/tasks/timeout/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/tasks/timeout/kotlin",files="build.gradle.kts[]"]
====
...
----
include::{samplesPath}/userguide/tasks/incrementalBuild/customTaskClass/groovy/buildSrc/src/main/java/org/example/ProcessTemplates.java[tag=custom-task-class]
----

[source,java]
.buildSrc/src/main/java/org/example/TemplateData.java
----
include::{samplesPath}/userguide/tasks/incrementalBuild/customTaskClass/groovy/buildSrc/src/main/java/org/example/TemplateData.java[]
----
...
These problems are then turned into deprecation warnings when the task is executed.

.Example output with a task having undeclared inputs and outputs
----
> gradle processTemplatesRuntime
include::{samplesPath}/userguide/tasks/incrementalBuild/customTaskClass/customTaskClassWithoutInputOutputAnnotations.out[]
----
...
.Ad-hoc task
====
include::sample[dir="snippets/userguide/tasks/incrementalBuild/customTaskClass/groovy",files="build.gradle[tags=ad-hoc-task]"]
include::sample[dir="snippets/userguide/tasks/incrementalBuild/customTaskClass/kotlin",files="build.gradle.kts[tags=ad-hoc-task]"]
...
====
include::sample[dir="snippets/userguide/tasks/incrementalBuild/customTaskClass/groovy",files="build.gradle[tags=adhoc-destroyable-task]"]
include::sample[dir="snippets/userguide/tasks/incrementalBuild/customTaskClass/kotlin",files="build.gradle.kts[tags=adhoc-destroyable-task]"]
====
...
====
include::sample[dir="snippets/userguide/tasks/incrementalBuild/customTaskClass/groovy",files="build.gradle[tags=ad-hoc-task-skip-when-empty]"]
include::sample[dir="snippets/userguide/tasks/incrementalBuild/customTaskClass/kotlin",files="build.gradle.kts[tags=ad-hoc-task-skip-when-empty]"]

.Output of **`gradle clean processTemplatesAdHocSkipWhenEmpty`**
----
> gradle clean processTemplatesAdHocSkipWhenEmpty
include::{samplesPath}/userguide/tasks/incrementalBuild/customTaskClass/incrementalAdHocTaskNoSource.out[]
----
====
...
====
include::sample[dir="snippets/userguide/tasks/incrementalBuild/customTaskClass/groovy",files="build.gradle[tags=custom-class-runtime-api]"]
include::sample[dir="snippets/userguide/tasks/incrementalBuild/customTaskClass/kotlin",files="build.gradle.kts[tags=custom-class-runtime-api]"]
====
...
====
include::sample[dir="snippets/userguide/tasks/incrementalBuild/customTaskClass/groovy",files="build.gradle[tags=inferred-task-dep-via-outputs]"]
include::sample[dir="snippets/userguide/tasks/incrementalBuild/customTaskClass/kotlin",files="build.gradle.kts[tags=inferred-task-dep-via-outputs]"]
...
====
include::sample[dir="snippets/userguide/tasks/incrementalBuild/customTaskClass/groovy",files="build.gradle[tags=inferred-task-dep-via-task]"]
include::sample[dir="snippets/userguide/tasks/incrementalBuild/customTaskClass/kotlin",files="build.gradle.kts[tags=inferred-task-dep-via-task]"]
...
====
include::sample[dir="snippets/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/groovy",files="build.gradle[tags=custom-task-class]"]
include::sample[dir="snippets/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/kotlin",files="build.gradle.kts[tags=custom-task-class]"]

.ProcessTemplates.java
[source,java]
----
include::{samplesPath}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/groovy/buildSrc/src/main/java/org/example/ProcessTemplates.java[tag=custom-task-class]
----
...
====
include::sample[dir="snippets/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/groovy",files="build.gradle[tags=task-arg-method]"]
include::sample[dir="snippets/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/kotlin",files="build.gradle.kts[tags=task-arg-method]"]

.ProcessTemplates.java
[source,java]
----
include::{samplesPath}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/groovy/buildSrc/src/main/java/org/example/ProcessTemplates.java[tag=task-arg-method]
----
...
====
include::sample[dir="snippets/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/groovy",files="build.gradle[tags=failed-inferred-task-dep]"]
include::sample[dir="snippets/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/kotlin",files="build.gradle.kts[tags=failed-inferred-task-dep]"]
...
====
include::sample[dir="snippets/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/groovy",files="build.gradle[tags=inferred-task-dep]"]
include::sample[dir="snippets/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/kotlin",files="build.gradle.kts[tags=inferred-task-dep]"]
...
====
include::sample[dir="snippets/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/groovy",files="build.gradle[tags=inferred-task-dep-with-files]"]
include::sample[dir="snippets/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/kotlin",files="build.gradle.kts[tags=inferred-task-dep-with-files]"]
...
====
include::sample[dir="snippets/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/groovy",files="build.gradle[tags=inferred-task-dep-with-builtby]"]
include::sample[dir="snippets/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/kotlin",files="build.gradle.kts[tags=inferred-task-dep-with-builtby]"]
...
====
include::sample[dir="snippets/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/groovy",files="build.gradle[tags=up-to-date-when]"]
include::sample[dir="snippets/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/kotlin",files="build.gradle.kts[tags=up-to-date-when]"]
...
====
include::sample[dir="snippets/userguide/tasks/inputNormalization/groovy",files="build.gradle[tags=ignore-build-info-properties]"]
include::sample[dir="snippets/userguide/tasks/inputNormalization/kotlin",files="build.gradle.kts[tags=ignore-build-info-properties]"]
====
...
.Task rule
====
include::sample[dir="snippets/userguide/tasks/addRules/groovy",files="build.gradle[tags=task-rule]"]
include::sample[dir="snippets/userguide/tasks/addRules/kotlin",files="build.gradle.kts[tags=task-rule]"]
...
====
include::sample[dir="snippets/userguide/tasks/addRules/groovy",files="build.gradle[tags=all]"]
include::sample[dir="snippets/userguide/tasks/addRules/kotlin",files="build.gradle.kts[tags=all]"]
...
====
include::sample[dir="snippets/userguide/tasks/finalizers/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/tasks/finalizers/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="snippets/userguide/tasks/finalizersWithFailure/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/tasks/finalizersWithFailure/kotlin",files="build.gradle.kts[]"]

.Output of **`gradle -q taskX`**
----
> gradle -q taskX
include::{samplesPath}/userguide/tasks/finalizersWithFailure/taskFinalizersWithFailureGroovy.out[]
----
====
