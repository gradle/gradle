...
====
include::sample[dir="snippets/tasks/defineAsGroovyExpression/groovy",files="build.gradle[]"]
...
====
include::sample[dir="snippets/tasks/accessAsGroovyProperty/groovy",files="build.gradle[]"]
include::sample[dir="snippets/tasks/accessAsKotlinDelegatedProperty/kotlin",files="build.gradle.kts[]"]
====
...
----
> gradle -q hello
include::{snippetsPath}/tasks/accessUsingPath/accessUsingPath.out[]
----
====
...
----
> gradle -q taskX
include::{snippetsPath}/tasks/addDependencyUsingPath/addDependencyUsingPath.out[]
----
====
...
----
> gradle -q taskX
include::{snippetsPath}/tasks/addDependencyUsingTask/addDependencyUsingTask.out[]
----
====
...
----
> gradle -q taskX
include::{snippetsPath}/tasks/addDependencyUsingClosure/addDependencyUsingClosure.out[]
----
====
...
include::{snippetsPath}/tasks/mustRunAfter/mustRunAfter.out[]
----
====
...
----
> gradle -q taskY taskX
include::{snippetsPath}/tasks/shouldRunAfter/shouldRunAfter.out[]
----
====
...
----
> gradle -q taskY
include::{snippetsPath}/tasks/mustRunAfter/mustRunAfterSingleTask.out[]
----
====
...
----
> gradle -q taskX
include::{snippetsPath}/tasks/shouldRunAfterWithCycle/shouldRunAfterWithCycle.out[]
----
====
...
include::{snippetsPath}/tutorial/taskOnlyIf/taskOnlyIf.out[]
----
====
...
----
> gradle -q myTask
include::{snippetsPath}/tutorial/stopExecutionException/stopExecutionException.out[]
----
====
...
----
> gradle disableMe
include::{snippetsPath}/tutorial/disableTask/disableTask.out[]
----
====
...
include::{snippetsPath}/tasks/incrementalBuild/customTaskClass/customTaskClassWithInputOutputAnnotations.out[]
----

.Output of `gradle processTemplates` (run again)
----
> gradle processTemplates
include::{snippetsPath}/tasks/incrementalBuild/customTaskClass/customTaskClassWithInputOutputAnnotationsUpToDate.out[]
----
====
...
include::{snippetsPath}/tasks/incrementalBuild/customTaskClass/customTaskClassWithoutInputOutputAnnotations.out[]
----
...
include::{snippetsPath}/tasks/incrementalBuild/customTaskClass/incrementalAdHocTask.out[]
----
====
...
include::{snippetsPath}/tasks/incrementalBuild/customTaskClass/incrementalAdHocTaskNoSource.out[]
----
====
...
include::{snippetsPath}/tasks/incrementalBuild/customTaskClass/inferredTaskDep.out[]
----
====
...
include::{snippetsPath}/tasks/incrementalBuild/customTaskClass/inferredTaskDep2.out[]
----
====
...
----
> gradle processTemplates
include::{snippetsPath}/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildCustomMethods.out[]
----
====
...
include::{snippetsPath}/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildCustomMethodsWithTaskArg.out[]
----
====
...
include::{snippetsPath}/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildBadInputFilesConfig.out[]
----
====
...
include::{snippetsPath}/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildInputFilesConfig.out[]
----
====
...
include::{snippetsPath}/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildInputFilesConfigUsingTask.out[]
----
====
...
include::{snippetsPath}/tasks/incrementalBuild/incrementalBuildAdvanced/inferredTaskDependencyWithBuiltBy.out[]
----
====
...
include::{snippetsPath}/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildUpToDateWhen.out[]
----

.Output of `gradle alwaysInstrumentClasses`
----
> gradle alwaysInstrumentClasses
include::{snippetsPath}/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildUpToDateWhenAgain.out[]
----
====
...
include::{snippetsPath}/tasks/addRules/taskRule.out[]
----
====
...
----
> gradle -q groupPing
include::{snippetsPath}/tasks/addRules/taskRuleDependsOn.out[]
----
====
...
----
> gradle -q taskX
include::{snippetsPath}/tasks/finalizers/taskFinalizers.out[]
----
====
...
----
> gradle -q taskX
include::{snippetsPath}/tasks/finalizersWithFailure/taskFinalizersWithFailureGroovy.out[]
----
====
