...
====
include::sample[dir="plugins/multiproject/groovy", files="settings.gradle[tags=include-subprojects];build.gradle[tags=plugins-on-subprojects];goodbyeC/build.gradle[]"]
include::sample[dir="plugins/multiproject/kotlin", files="settings.gradle.kts[tags=include-subprojects];build.gradle.kts[tags=plugins-on-subprojects];goodbyeC/build.gradle.kts[]"]
====
...
One benefit of setting plugin versions this way is that the `pluginManagement.plugins {}` does not have the same <<#sec:constrained_syntax,constrained syntax>> as the build script `plugins {}` block. This allows plugin versions to be take from `gradle.properties`, or loaded via another mechanism.

.Example: Managing plugin versions via `pluginManagement`.
====
include::sample[dir="plugins/pluginVersions/groovy", files="settings.gradle[tags=configure-plugin-version];build.gradle[tags=apply-plugin];gradle.properties"]
include::sample[dir="plugins/pluginVersions/kotlin", files="settings.gradle.kts[tags=configure-plugin-version];build.gradle.kts[tags=apply-plugin];gradle.properties"]
====
...
====
include::sample[dir="java/quickstart/groovy", files="build.gradle[tags=use-plugin-legacy]"]
include::sample[dir="java/quickstart/kotlin", files="build.gradle.kts[tags=use-plugin-legacy]"]
====
