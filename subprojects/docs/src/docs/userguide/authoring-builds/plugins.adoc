...
====
include::sample[dir="snippets/plugins/multiproject/groovy/project", files="settings.gradle[tags=include-subprojects];build.gradle[tags=plugins-on-subprojects];goodbyeC/build.gradle[]"]
include::sample[dir="snippets/plugins/multiproject/kotlin/project", files="settings.gradle.kts[tags=include-subprojects];build.gradle.kts[tags=plugins-on-subprojects];goodbyeC/build.gradle.kts[]"]
====
