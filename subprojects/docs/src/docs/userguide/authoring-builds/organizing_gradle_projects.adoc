...
A custom Gradle distribution comprises the standard Gradle distribution plus one, or many custom initialization scripts.
...
[[sub:create_custom_gradle_distribution]]
=== Creating a custom Gradle distribution

At first, you need to download the distribution which is done by an `buildSrc` Gradle task.

.buildSrc download Gradle distribution task
====
include::sample[dir="{snippetsPath}/organizingGradleProjects/customGradleDistribution/groovy/buildSrc",files="src/main/groovy/org/gradle/distribution/DownloadGradle.groovy[]"]
include::sample[dir="{snippetsPath}/organizingGradleProjects/customGradleDistribution/kotlin/buildSrc",files="src/main/kotlin/org/gradle/distribution/DownloadGradle.kt[]"]
====

Now we can register and use this task.

.Register and configure the task
====
include::sample[dir="{snippetsPath}/organizingGradleProjects/customGradleDistribution/groovy",files="build.gradle[tags=taskRegistration]"]
include::sample[dir="{snippetsPath}/organizingGradleProjects/customGradleDistribution/kotlin",files="build.gradle.kts[tags=taskRegistration]"]
====

[[sub:configure_with_initialization_scripts]]
=== Configure Gradle with the help of initialization scripts

.Configure in-house Gradle plugin repository
====
include::sample[dir="{snippetsPath}/organizingGradleProjects/customGradleDistribution/groovy",files="src/main/dist/init.d/repositories.init.gradle[tags=pluginManagement]"]
include::sample[dir="{snippetsPath}/organizingGradleProjects/customGradleDistribution/kotlin",files="src/main/dist/init.d/repositories.init.gradle.kts[tags=pluginManagement]"]
====

.Configure in-house source repository
====
include::sample[dir="{snippetsPath}/organizingGradleProjects/customGradleDistribution/groovy",files="src/main/dist/init.d/repositories.init.gradle[tags=sourceRepository]"]
include::sample[dir="{snippetsPath}/organizingGradleProjects/customGradleDistribution/kotlin",files="src/main/dist/init.d/repositories.init.gradle.kts[tags=sourceRepository]"]
====

[[sub:bundle_custom_gradle_distribution]]
=== Bundle the custom Gradle distribution

.Bundle a custom Gradle distribution
====
include::sample[dir="{snippetsPath}/organizingGradleProjects/customGradleDistribution/groovy",files="build.gradle[tags=distribution]"]
include::sample[dir="{snippetsPath}/organizingGradleProjects/customGradleDistribution/kotlin",files="build.gradle.kts[tags=distribution]"]
====

[[sub:use_custom_gradle_distribution]]
=== Use the custom Gradle distribution

.Execute Gradle wrapper task to use the custom distribution
----
./gradlew wrapper \
    --gradle-distribution-url 'https://example.com/path/to/custom-distribution-gradle-6.7-bin.zip'
----
