...
====
include::sample[dir="userguide/organizingGradleProjects/separatedTestTypes/groovy",files="gradle/integration-test.gradle[tags=custom-source-set]"]
include::sample[dir="userguide/organizingGradleProjects/separatedTestTypes/kotlin",files="gradle/integration-test.gradle.kts[tags=custom-source-set]"]
====
...
====
include::sample[dir="userguide/organizingGradleProjects/separatedTestTypes/groovy",files="gradle/integration-test.gradle[tags=test-task]"]
include::sample[dir="userguide/organizingGradleProjects/separatedTestTypes/kotlin",files="gradle/integration-test.gradle.kts[tags=test-task]"]
====
...
====
include::sample[dir="java/multiproject/groovy",files="buildSrc/build.gradle[]"]
include::sample[dir="java/multiproject/kotlin",files="buildSrc/build.gradle.kts[]"]
====
...
You can find a sample (`userguide/organizingGradleProjects/customGradleDistribution`) that covers steps one to three in the `samples` directory of the standard `-all` Gradle distribution.

.Building a custom Gradle distribution
====
include::sample[dir="userguide/organizingGradleProjects/customGradleDistribution",files="build.gradle[]"]
====
