...
====
include::sample[dir="snippets/organizingGradleProjects/separatedTestTypes/groovy",files="gradle/integration-test.gradle[tags=custom-source-set]"]
include::sample[dir="snippets/organizingGradleProjects/separatedTestTypes/kotlin",files="gradle/integration-test.gradle.kts[tags=custom-source-set]"]
====
...
====
include::sample[dir="snippets/organizingGradleProjects/separatedTestTypes/groovy",files="gradle/integration-test.gradle[tags=test-task]"]
include::sample[dir="snippets/organizingGradleProjects/separatedTestTypes/kotlin",files="gradle/integration-test.gradle.kts[tags=test-task]"]
====
...
You can find a sample (`organizingGradleProjects/customGradleDistribution`) that covers steps one to three in the `samples` directory of the standard `-all` Gradle distribution.

.Building a custom Gradle distribution
====
include::sample[dir="snippets/organizingGradleProjects/customGradleDistribution",files="build.gradle[]"]
====
