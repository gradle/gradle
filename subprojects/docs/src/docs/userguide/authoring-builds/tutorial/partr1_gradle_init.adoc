...
<4> Build script for `app` dependencies
<5> Default Java source folder for `app`
<6> Default Java test source folder for `app`
...
The build script in the `app` subproject directory declares the dependencies that the `app` code will need to be assembled, tested, and published.

== Step 4. Review the Code

The file `app/src/main/java/authoring/tutorial/App.java` contains the main class of the source code:
