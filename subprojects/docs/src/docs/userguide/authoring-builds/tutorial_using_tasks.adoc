...
----
> gradle -q hello
include::{samplesPath}/tutorial/hello/hello.out[]
----
====
...
----
> gradle -q upper
include::{samplesPath}/tutorial/upper/upper.out[]
----
====
...
----
> gradle -q count
include::{samplesPath}/tutorial/count/count.out[]
----
====
...
----
> gradle -q intro
include::{samplesPath}/tutorial/intro/intro.out[]
----
====
...
----
> gradle -q taskX
include::{samplesPath}/tutorial/lazyDependsOn/lazyDependsOn.out[]
----
====
...
----
> gradle -q task1
include::{samplesPath}/tutorial/dynamic/dynamic.out[]
----
====
...
----
> gradle -q task0
include::{samplesPath}/tutorial/dynamicDepends/dynamicDepends.out[]
----
====
...
----
> gradle -q hello
include::{samplesPath}/tutorial/helloEnhanced/helloEnhanced.out[]
----
====
...
----
> gradle -q hello
include::{samplesPath}/tutorial/helloWithShortCut/helloWithShortCut.out[]
----
====
...
include::{samplesPath}/tutorial/extraProperties/extraTaskProperties.out[]
----
====
...
----
> gradle -q loadfile
include::{samplesPath}/tutorial/antLoadfile/antLoadfile.out[]
----
====
...
----
> gradle -q loadfile
include::{samplesPath}/tutorial/antLoadfileWithMethod/antLoadfileWithMethod.out[]
----
====
...
----
> gradle -q
include::{samplesPath}/tutorial/defaultTasks/defaultTasks.out[]
----
====
...
include::{samplesPath}/tutorial/configByDag/configByDagNoRelease.out[]
----

.Output of `gradle -q release`
----
> gradle -q release
include::{samplesPath}/tutorial/configByDag/configByDag.out[]
----
====
...
----
> gradle -q encode
include::{samplesPath}/tutorial/externalDependency/externalBuildDependency.out[]
----
====
