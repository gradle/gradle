...
----
> gradle -q hello
include::{snippetsPath}/tutorial/hello/hello.out[]
----
====
...
----
> gradle -q upper
include::{snippetsPath}/tutorial/upper/upper.out[]
----
====
...
----
> gradle -q count
include::{snippetsPath}/tutorial/count/count.out[]
----
====
...
----
> gradle -q intro
include::{snippetsPath}/tutorial/intro/intro.out[]
----
====
...
----
> gradle -q taskX
include::{snippetsPath}/tutorial/lazyDependsOn/lazyDependsOn.out[]
----
====
...
----
> gradle -q task1
include::{snippetsPath}/tutorial/dynamic/dynamic.out[]
----
====
...
----
> gradle -q task0
include::{snippetsPath}/tutorial/dynamicDepends/dynamicDepends.out[]
----
====
...
----
> gradle -q hello
include::{snippetsPath}/tutorial/helloEnhanced/helloEnhanced.out[]
----
====
...
====
include::sample[dir="snippets/tutorial/helloWithShortCut/groovy", files="build.gradle[]"]

.Output of **`gradle -q hello`**
----
> gradle -q hello
include::{snippetsPath}/tutorial/helloWithShortCut/helloWithShortCut.out[]
----
====
...
====
include::sample[dir="snippets/tutorial/extraProperties/groovy", files="build.gradle[tags=taskProperties]"]
include::sample[dir="snippets/tutorial/extraProperties/kotlin", files="build.gradle.kts[tags=taskProperties]"]

.Output of **`gradle -q printTaskProperties`**
----
> gradle -q printTaskProperties
include::{snippetsPath}/tutorial/extraProperties/extraTaskProperties.out[]
----
====
...
----
> gradle -q loadfile
include::{snippetsPath}/tutorial/antLoadfile/antLoadfile.out[]
----
====
...
----
> gradle -q loadfile
include::{snippetsPath}/tutorial/antLoadfileWithMethod/antLoadfileWithMethod.out[]
----
====
...
----
> gradle -q
include::{snippetsPath}/tutorial/defaultTasks/defaultTasks.out[]
----
====
...
====
include::sample[dir="snippets/tutorial/configByDag/groovy", files="build.gradle[]"]
include::sample[dir="snippets/tutorial/configByDag/kotlin", files="build.gradle.kts[]"]

.Output of `gradle -q distribution`
----
> gradle -q distribution
include::{snippetsPath}/tutorial/configByDag/configByDagNoRelease.out[]
----

.Output of `gradle -q release`
----
> gradle -q release
include::{snippetsPath}/tutorial/configByDag/configByDag.out[]
----
====
...
----
> gradle -q encode
include::{snippetsPath}/tutorial/externalDependency/externalBuildDependency.out[]
----
====
