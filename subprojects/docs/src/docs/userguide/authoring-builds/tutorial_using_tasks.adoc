...
Still, to give you an idea of what a taks is, we will look at defining some simple tasks in a build with one project in this chapter.
...
NOTE: Instead of manipulating the script classpath directly, it is recommended to <<pluginsadoc#,apply plugins>> that come with their own classpath.
