...
Next, we will look at multi-project builds that contain more than one subproject. We will explore how build logic can be shared across subprojects and how subprojects can depend on one another.
