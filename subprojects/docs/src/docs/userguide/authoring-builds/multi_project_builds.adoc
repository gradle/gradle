...
====
include::sample[dir="snippets/multiproject/firstExample/water/groovy",files="settings.gradle[]"]
include::sample[dir="snippets/multiproject/firstExample/water/kotlin",files="settings.gradle.kts[]"]
====
...
====
include::sample[dir="snippets/multiproject/firstExample/water/groovy",files="build.gradle[]"]
include::sample[dir="snippets/multiproject/firstExample/water/kotlin",files="build.gradle.kts[]"]

.Output of **`gradle -q hello`**
----
> gradle -q hello
include::{snippetsPath}/multiproject/firstExample/water/multiprojectFirstExample.out[]
----
====
...
====
include::sample[dir="snippets/multiproject/addKrill/water/groovy",files="settings.gradle[]"]
include::sample[dir="snippets/multiproject/addKrill/water/kotlin",files="settings.gradle.kts[]"]
====
...
====
include::sample[dir="snippets/multiproject/addKrill/water/groovy",files="build.gradle[]"]
include::sample[dir="snippets/multiproject/addKrill/water/kotlin",files="build.gradle.kts[]"]

.Output of **`gradle -q hello`**
----
> gradle -q hello
include::{snippetsPath}/multiproject/addKrill/water/multiprojectAddKrill.out[]
----
====
...
====
include::sample[dir="snippets/multiproject/useSubprojects/water/groovy",files="build.gradle[]"]
include::sample[dir="snippets/multiproject/useSubprojects/water/kotlin",files="build.gradle.kts[]"]

.Output of **`gradle -q hello`**
----
> gradle -q hello
include::{snippetsPath}/multiproject/useSubprojects/water/multiprojectUseSubprojects.out[]
----
====
...
====
include::sample[dir="snippets/multiproject/subprojectsAddFromTop/water/groovy",files="build.gradle[]"]
include::sample[dir="snippets/multiproject/subprojectsAddFromTop/water/kotlin",files="build.gradle.kts[]"]

.Output of **`gradle -q hello`**
----
> gradle -q hello
include::{snippetsPath}/multiproject/subprojectsAddFromTop/water/multiprojectSubprojectsAddFromTop.out[]
----
====
...
====
include::sample[dir="snippets/multiproject/spreadSpecifics/water/groovy",files="settings.gradle[];bluewhale/build.gradle[];krill/build.gradle[];build.gradle[]"]
include::sample[dir="snippets/multiproject/spreadSpecifics/water/kotlin",files="settings.gradle.kts[];bluewhale/build.gradle.kts[];krill/build.gradle.kts[];build.gradle.kts[]"]

.Output of `gradle -q hello`
----
> gradle -q hello
include::{snippetsPath}/multiproject/spreadSpecifics/water/multiprojectSpreadSpecifics.out[]
----
====
...
====
include::sample[dir="snippets/multiproject/addTropical/water/groovy",files="settings.gradle[];build.gradle[]"]
include::sample[dir="snippets/multiproject/addTropical/water/kotlin",files="settings.gradle.kts[];build.gradle.kts[]"]

.Output of `gradle -q hello`
----
> gradle -q hello
include::{snippetsPath}/multiproject/addTropical/water/multiprojectAddTropical.out[]
----
====
...
====
include::sample[dir="snippets/multiproject/tropicalWithProperties/water/groovy",files="settings.gradle[];bluewhale/build.gradle[];krill/build.gradle[];build.gradle[];tropicalFish/build.gradle[]"]
include::sample[dir="snippets/multiproject/tropicalWithProperties/water/kotlin",files="settings.gradle.kts[];bluewhale/build.gradle.kts[];krill/build.gradle.kts[];build.gradle.kts[];tropicalFish/build.gradle.kts[]"]

.Output of `gradle -q hello`
----
> gradle -q hello
include::{snippetsPath}/multiproject/tropicalWithProperties/water/multiprojectTropicalWithProperties.out[]
----
====
...
----
> gradle -q hello
include::{snippetsPath}/multiproject/tropicalWithProperties/water/multiprojectSubBuild.out[]
----
...
====
include::sample[dir="snippets/multiproject/partialTasks/water/groovy",files="bluewhale/build.gradle[];krill/build.gradle[]"]
include::sample[dir="snippets/multiproject/partialTasks/water/kotlin",files="bluewhale/build.gradle.kts[];krill/build.gradle.kts[]"]

.Output of `gradle -q distanceToIceberg`
----
> gradle -q distanceToIceberg
include::{snippetsPath}/multiproject/partialTasks/water/multiprojectPartialTasks.out[]
----
...
include::{snippetsPath}/multiproject/partialTasks/water/multiprojectPartialTasksNotQuiet.out[]
----
====
...
include::{snippetsPath}/multiproject/tropicalWithProperties/water/multiprojectAbsoluteTaskPaths.out[]
----
...
====
include::sample[dir="snippets/multiproject/dependencies/firstMessages/messages/groovy",files="build.gradle[];settings.gradle[];consumer/build.gradle[];producer/build.gradle[]"]
include::sample[dir="snippets/multiproject/dependencies/firstMessages/messages/kotlin",files="build.gradle.kts[];settings.gradle.kts[];consumer/build.gradle.kts[];producer/build.gradle.kts[]"]

.Output of `gradle -q action`
----
> gradle -q action
include::{snippetsPath}/multiproject/dependencies/firstMessages/messages/multiprojectFirstMessages.out[]
----
====
...
====
include::sample[dir="snippets/multiproject/dependencies/messagesHack/messages/groovy",files="build.gradle[];settings.gradle[];consumer/build.gradle[];aProducer/build.gradle[]"]
include::sample[dir="snippets/multiproject/dependencies/messagesHack/messages/kotlin",files="build.gradle.kts[];settings.gradle.kts[];consumer/build.gradle.kts[];aProducer/build.gradle.kts[]"]

.Output of `gradle -q action`
----
> gradle -q action
include::{snippetsPath}/multiproject/dependencies/messagesHack/messages/multiprojectMessagesHack.out[]
----
...
----
> gradle -q action
include::{snippetsPath}/multiproject/dependencies/messagesHack/messages/multiprojectMessagesHackBroken.out[]
----
====
...
----
> gradle :api:build
include::{snippetsPath}/multiproject/dependencies/java/multitestingBuild.out[]
----
=====
====
...
include::{snippetsPath}/multiproject/dependencies/java/multitestingBuildNeeded.out[]
----
=====
====
...
include::{snippetsPath}/multiproject/dependencies/java/multitestingBuildDependents.out[]
----
=====
====
