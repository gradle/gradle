...
====
include::sample[dir="snippets/userguide/multiproject/firstExample/water/groovy",files="settings.gradle[]"]
include::sample[dir="snippets/userguide/multiproject/firstExample/water/kotlin",files="settings.gradle.kts[]"]
====
...
====
include::sample[dir="snippets/userguide/multiproject/firstExample/water/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/multiproject/firstExample/water/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="snippets/userguide/multiproject/addKrill/water/groovy",files="settings.gradle[]"]
include::sample[dir="snippets/userguide/multiproject/addKrill/water/kotlin",files="settings.gradle.kts[]"]
====
...
====
include::sample[dir="snippets/userguide/multiproject/addKrill/water/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/multiproject/addKrill/water/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="snippets/userguide/multiproject/useSubprojects/water/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/multiproject/useSubprojects/water/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="snippets/userguide/multiproject/subprojectsAddFromTop/water/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/multiproject/subprojectsAddFromTop/water/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="snippets/userguide/multiproject/spreadSpecifics/water/groovy",files="settings.gradle[];bluewhale/build.gradle[];krill/build.gradle[];build.gradle[]"]
include::sample[dir="snippets/userguide/multiproject/spreadSpecifics/water/kotlin",files="settings.gradle.kts[];bluewhale/build.gradle.kts[];krill/build.gradle.kts[];build.gradle.kts[]"]
...
====
include::sample[dir="snippets/userguide/multiproject/addTropical/water/groovy",files="settings.gradle[];build.gradle[]"]
include::sample[dir="snippets/userguide/multiproject/addTropical/water/kotlin",files="settings.gradle.kts[];build.gradle.kts[]"]
...
====
include::sample[dir="snippets/userguide/multiproject/tropicalWithProperties/water/groovy",files="settings.gradle[];bluewhale/build.gradle[];krill/build.gradle[];build.gradle[];tropicalFish/build.gradle[]"]
include::sample[dir="snippets/userguide/multiproject/tropicalWithProperties/water/kotlin",files="settings.gradle.kts[];bluewhale/build.gradle.kts[];krill/build.gradle.kts[];build.gradle.kts[];tropicalFish/build.gradle.kts[]"]
...
====
include::sample[dir="snippets/userguide/multiproject/partialTasks/water/groovy",files="bluewhale/build.gradle[];krill/build.gradle[]"]
include::sample[dir="snippets/userguide/multiproject/partialTasks/water/kotlin",files="bluewhale/build.gradle.kts[];krill/build.gradle.kts[]"]
...
====
include::sample[dir="snippets/userguide/multiproject/dependencies/firstMessages/messages/groovy",files="build.gradle[];settings.gradle[];consumer/build.gradle[];producer/build.gradle[]"]
include::sample[dir="snippets/userguide/multiproject/dependencies/firstMessages/messages/kotlin",files="build.gradle.kts[];settings.gradle.kts[];consumer/build.gradle.kts[];producer/build.gradle.kts[]"]
...
====
include::sample[dir="snippets/userguide/multiproject/dependencies/messagesHack/messages/groovy",files="build.gradle[];settings.gradle[];consumer/build.gradle[];aProducer/build.gradle[]"]
include::sample[dir="snippets/userguide/multiproject/dependencies/messagesHack/messages/kotlin",files="build.gradle.kts[];settings.gradle.kts[];consumer/build.gradle.kts[];aProducer/build.gradle.kts[]"]
...
====
include::sample[dir="snippets/userguide/multiproject/dependencies/webDist/groovy",files="settings.gradle[];build.gradle[]"]
include::sample[dir="snippets/userguide/multiproject/dependencies/webDist/kotlin",files="settings.gradle.kts[];build.gradle.kts[]"]
====
...
[[javadependencies_2]]
====
include::sample[dir="snippets/userguide/multiproject/dependencies/java/groovy",files="settings.gradle[];build.gradle[]"]
include::sample[dir="snippets/userguide/multiproject/dependencies/java/kotlin",files="settings.gradle.kts[];build.gradle.kts[]"]
====
...
====
include::sample[dir="snippets/userguide/multiproject/dependencies/javaWithCustomConf/groovy",files="build.gradle[]"]
include::sample[dir="snippets/userguide/multiproject/dependencies/javaWithCustomConf/kotlin",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="snippets/userguide/multiproject/dependencies/outgoingArtifact/groovy/producer",files="build.gradle[]"]
include::sample[dir="snippets/userguide/multiproject/dependencies/outgoingArtifact/kotlin/producer",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="snippets/userguide/multiproject/dependencies/outgoingArtifact/groovy/consumer",files="build.gradle[tags=producer-project-dependency]"]
include::sample[dir="snippets/userguide/multiproject/dependencies/outgoingArtifact/kotlin/consumer",files="build.gradle.kts[tags=producer-project-dependency]"]
====
