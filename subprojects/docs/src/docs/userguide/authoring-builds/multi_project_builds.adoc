...
----
> gradle -q hello
include::{samplesPath}/multiproject/firstExample/water/multiprojectFirstExample.out[]
----
====
...
----
> gradle -q hello
include::{samplesPath}/multiproject/addKrill/water/multiprojectAddKrill.out[]
----
====
...
----
> gradle -q hello
include::{samplesPath}/multiproject/useSubprojects/water/multiprojectUseSubprojects.out[]
----
====
...
----
> gradle -q hello
include::{samplesPath}/multiproject/subprojectsAddFromTop/water/multiprojectSubprojectsAddFromTop.out[]
----
====
...
----
> gradle -q hello
include::{samplesPath}/multiproject/spreadSpecifics/water/multiprojectSpreadSpecifics.out[]
----
====
...
----
> gradle -q hello
include::{samplesPath}/multiproject/addTropical/water/multiprojectAddTropical.out[]
----
====
...
----
> gradle -q hello
include::{samplesPath}/multiproject/tropicalWithProperties/water/multiprojectTropicalWithProperties.out[]
----
====
...
----
> gradle -q hello
include::{samplesPath}/multiproject/tropicalWithProperties/water/multiprojectSubBuild.out[]
----
...
include::{samplesPath}/multiproject/partialTasks/water/multiprojectPartialTasks.out[]
----
...
include::{samplesPath}/multiproject/partialTasks/water/multiprojectPartialTasksNotQuiet.out[]
----
====
...
include::{samplesPath}/multiproject/tropicalWithProperties/water/multiprojectAbsoluteTaskPaths.out[]
----
...
----
> gradle -q action
include::{samplesPath}/multiproject/dependencies/firstMessages/messages/multiprojectFirstMessages.out[]
----
====
...
----
> gradle -q action
include::{samplesPath}/multiproject/dependencies/messagesHack/messages/multiprojectMessagesHack.out[]
----
...
----
> gradle -q action
include::{samplesPath}/multiproject/dependencies/messagesHack/messages/multiprojectMessagesHackBroken.out[]
----
====
...
----
> gradle :api:build
include::{samplesPath}/multiproject/dependencies/java/multitestingBuild.out[]
----
=====
====
...
include::{samplesPath}/multiproject/dependencies/java/multitestingBuildNeeded.out[]
----
=====
====
...
include::{samplesPath}/multiproject/dependencies/java/multitestingBuildDependents.out[]
----
=====
====
