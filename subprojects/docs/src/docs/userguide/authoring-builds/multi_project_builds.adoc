...
----
> gradle -q action
include::{snippetsPath}/multiproject/dependencies-messagesHack/multiprojectMessagesHack.out[]
----
...
----
> gradle -q action
include::{snippetsPath}/multiproject/dependencies-messagesHack/multiprojectMessagesHackBroken.out[]
----
====
