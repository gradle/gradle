...
The attribute `builtBy` takes care of establishing an inferred task dependency.
For more information on `builtBy`, see link:{groovyDslPath}/org.gradle.api.tasks.SourceSetOutput.html[SourceSetOutput].
