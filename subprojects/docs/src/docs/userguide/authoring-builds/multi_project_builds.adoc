...
include::{snippetsPath}/multiproject/partialTasks/multiprojectPartialTasks.out[]
----
...
include::{snippetsPath}/multiproject/partialTasks/multiprojectPartialTasksNotQuiet.out[]
----
====
