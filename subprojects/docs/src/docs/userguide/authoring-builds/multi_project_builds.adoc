...
----
> gradle -q hello
include::{snippetsPath}/multiproject/tropicalWithProperties/multiprojectTropicalWithProperties.out[]
----
====
...
----
> gradle -q hello
include::{snippetsPath}/multiproject/tropicalWithProperties/multiprojectSubBuild.out[]
----
...
include::{snippetsPath}/multiproject/tropicalWithProperties/multiprojectAbsoluteTaskPaths.out[]
----
