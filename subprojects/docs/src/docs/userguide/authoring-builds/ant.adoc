...
----
> gradle hello
include::{snippetsPath}/ant/useAntTask/useAntTask.out[]
----
...
----
> gradle hello
include::{snippetsPath}/ant/taskWithNestedText/taskWithNestedText.out[]
----
...
====
include::sample[dir="snippets/ant/useExternalAntTask/groovy",files="build.gradle"]
include::sample[dir="snippets/ant/useExternalAntTask/kotlin",files="build.gradle.kts"]
====
...
----
> gradle hello
include::{snippetsPath}/ant/hello/antHello.out[]
----
...
----
> gradle intro
include::{snippetsPath}/ant/dependsOnAntTarget/dependsOnAntTarget.out[]
----
...
----
> gradle hello
include::{snippetsPath}/ant/addBehaviourToAntTarget/addBehaviourToAntTarget.out[]
----
...
----
> gradle hello
include::{snippetsPath}/ant/dependsOnTask/dependsOnTask.out[]
----
...
----
> gradle a-hello
include::{snippetsPath}/ant/renameTask/renameAntDelegate.out[]
----
...
----
> gradle hello
include::{snippetsPath}/ant/antLogging/antLogging.out[]
----
