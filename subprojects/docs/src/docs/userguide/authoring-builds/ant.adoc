...
.Using an Ant task
====
include::sample[dir="userguide/ant/useAntTask/groovy",files="build.gradle"]
include::sample[dir="userguide/ant/useAntTask/kotlin",files="build.gradle.kts"]
====
...
====
include::sample[dir="userguide/ant/taskWithNestedText/groovy",files="build.gradle"]
include::sample[dir="userguide/ant/taskWithNestedText/kotlin",files="build.gradle.kts"]
====
...
====
include::sample[dir="userguide/ant/taskWithNestedElements/groovy",files="build.gradle"]
include::sample[dir="userguide/ant/taskWithNestedElements/kotlin",files="build.gradle.kts"]
====
...
.Using an Ant type
====
include::sample[dir="userguide/ant/useAntType/groovy",files="build.gradle"]
...
====
include::sample[dir="userguide/ant/useExternalAntTask/groovy",files="build.gradle"]
include::sample[dir="userguide/ant/useExternalAntTask/kotlin",files="build.gradle.kts"]
====
...
====
include::sample[dir="userguide/ant/useExternalAntTaskWithConfig/groovy",files="build.gradle[tags=define-classpath]"]
include::sample[dir="userguide/ant/useExternalAntTaskWithConfig/kotlin",files="build.gradle.kts[tags=define-classpath]"]
====
...
====
include::sample[dir="userguide/ant/useExternalAntTaskWithConfig/groovy",files="build.gradle[tags=use-classpath]"]
include::sample[dir="userguide/ant/useExternalAntTaskWithConfig/kotlin",files="build.gradle.kts[tags=use-classpath]"]
====
...
.Importing an Ant build
====
include::sample[dir="userguide/ant/hello/groovy",files="build.gradle"]
include::sample[dir="userguide/ant/hello/kotlin",files="build.gradle.kts"]
====

====
include::sample[dir="userguide/ant/hello/groovy",files="build.xml"]
====
...
====
include::sample[dir="userguide/ant/dependsOnAntTarget/groovy",files="build.gradle"]
include::sample[dir="userguide/ant/dependsOnAntTarget/kotlin",files="build.gradle.kts"]
====
...
====
include::sample[dir="userguide/ant/addBehaviourToAntTarget/groovy",files="build.gradle"]
include::sample[dir="userguide/ant/addBehaviourToAntTarget/kotlin",files="build.gradle.kts"]
====
...
====
include::sample[dir="userguide/ant/dependsOnTask/groovy",files="build.gradle"]
include::sample[dir="userguide/ant/dependsOnTask/kotlin",files="build.gradle.kts"]
====

====
include::sample[dir="userguide/ant/dependsOnTask/groovy",files="build.xml"]
====
...
====
include::sample[dir="userguide/ant/renameTask/groovy",files="build.gradle"]
include::sample[dir="userguide/ant/renameTask/kotlin",files="build.gradle.kts"]
====

====
include::sample[dir="userguide/ant/renameTask/groovy",files="build.xml"]
====
...
====
include::sample[dir="userguide/ant/properties/groovy",files="build.gradle[tags=set-property]"]
include::sample[dir="userguide/ant/properties/kotlin",files="build.gradle.kts[tags=set-property]"]
====
...
====
include::sample[dir="userguide/ant/properties/groovy",files="build.xml[tags=getproperty]"]
====

====
include::sample[dir="userguide/ant/properties/groovy",files="build.gradle[tags=get-property]"]
include::sample[dir="userguide/ant/properties/kotlin",files="build.gradle.kts[tags=get-property]"]
====
...
====
include::sample[dir="userguide/ant/properties/groovy",files="build.gradle[tags=set-reference]"]
include::sample[dir="userguide/ant/properties/kotlin",files="build.gradle.kts[tags=set-reference]"]
====

====
include::sample[dir="userguide/ant/properties/groovy",files="build.xml[tags=setreference]"]
====
...
====
include::sample[dir="userguide/ant/properties/groovy",files="build.xml[tags=getreference]"]
====

====
include::sample[dir="userguide/ant/properties/groovy",files="build.gradle[tags=get-reference]"]
include::sample[dir="userguide/ant/properties/kotlin",files="build.gradle.kts[tags=get-reference]"]
====
...
.Fine tuning Ant logging
====
include::sample[dir="userguide/ant/antLogging/groovy",files="build.gradle"]
include::sample[dir="userguide/ant/antLogging/kotlin",files="build.gradle.kts"]
====
