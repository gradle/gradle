...
----
> gradle hello
include::{samplesPath}/ant/useAntTask/useAntTask.out[]
----
...
----
> gradle hello
include::{samplesPath}/ant/taskWithNestedText/taskWithNestedText.out[]
----
...
----
> gradle hello
include::{samplesPath}/ant/hello/antHello.out[]
----
...
----
> gradle intro
include::{samplesPath}/ant/dependsOnAntTarget/dependsOnAntTarget.out[]
----
...
----
> gradle hello
include::{samplesPath}/ant/addBehaviourToAntTarget/addBehaviourToAntTarget.out[]
----
...
----
> gradle hello
include::{samplesPath}/ant/dependsOnTask/dependsOnTask.out[]
----
...
----
> gradle a-hello
include::{samplesPath}/ant/renameTask/renameAntDelegate.out[]
----
...
----
> gradle hello
include::{samplesPath}/ant/antLogging/antLogging.out[]
----
