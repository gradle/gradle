...
The `gradleTestKit()` encompasses the classes of the TestKit, as well as the <<third_party_integration.adoc#embedding,Gradle Tooling API client>>. It does not include a version of http://junit.org[JUnit], http://testng.org[TestNG], or any other test execution framework. Such a dependency must be explicitly declared.

.Declaring the JUnit dependency
====
include::sample[dir="snippets/testKit/gradleRunner/junitQuickstart/groovy",files="build.gradle[tags=declare-junit-dependency]"]
include::sample[dir="snippets/testKit/gradleRunner/junitQuickstart/kotlin",files="build.gradle.kts[tags=declare-junit-dependency]"]
====
...
----
include::{snippetsPath}/testKit/gradleRunner/junitQuickstart/groovy/src/test/java/org/gradle/sample/BuildLogicFunctionalTest.java[tag=functional-test-junit]
----
...
----
include::{snippetsPath}/testKit/gradleRunner/junitQuickstart/kotlin/src/test/kotlin/org/gradle/sample/BuildLogicFunctionalTest.kt[tag=functional-test-junit]
----
...
----
include::{snippetsPath}/testKit/gradleRunner/spockQuickstart/src/test/groovy/org/gradle/sample/BuildLogicFunctionalTest.groovy[tag=functional-test-spock]
----
...
====
include::sample[dir="snippets/testKit/gradleRunner/automaticClasspathInjectionQuickstart/groovy",files="build.gradle[tags=automatic-classpath]"]
include::sample[dir="snippets/testKit/gradleRunner/automaticClasspathInjectionQuickstart/kotlin",files="build.gradle.kts[tags=automatic-classpath]"]
====
...
----
include::{snippetsPath}/testKit/gradleRunner/automaticClasspathInjectionQuickstart/groovy/src/test/groovy/org/gradle/sample/BuildLogicFunctionalTest.groovy[tag=functional-test-classpath-setup-automatic]
----
...
====
include::sample[dir="snippets/testKit/gradleRunner/automaticClasspathInjectionCustomTestSourceSet/groovy",files="build.gradle[tags=custom-test-source-set]"]
include::sample[dir="snippets/testKit/gradleRunner/automaticClasspathInjectionCustomTestSourceSet/kotlin",files="build.gradle.kts[tags=custom-test-source-set]"]
====
...
====
include::sample[dir="snippets/testKit/gradleRunner/manualClasspathInjection/groovy",files="build.gradle[tags=test-logic-classpath]"]
include::sample[dir="snippets/testKit/gradleRunner/manualClasspathInjection/kotlin",files="build.gradle.kts[tags=test-logic-classpath]"]
====
...
.src/test/groovy/org/gradle/sample/BuildLogicFunctionalTest.groovy
----
include::{snippetsPath}/testKit/gradleRunner/manualClasspathInjection/groovy/src/test/groovy/org/gradle/sample/BuildLogicFunctionalTest.groovy[tag=functional-test-classpath-setup]
----
...
.src/test/groovy/org/gradle/sample/BuildLogicFunctionalTest.groovy
----
include::{snippetsPath}/testKit/gradleRunner/manualClasspathInjection/groovy/src/test/groovy/org/gradle/sample/BuildLogicFunctionalTest.groovy[tag=functional-test-classpath-setup-older-gradle]
----
...
.BuildLogicFunctionalTest.groovy
----
include::{snippetsPath}/testKit/gradleRunner/gradleVersion/src/test/groovy/org/gradle/sample/BuildLogicFunctionalTest.groovy[tag=functional-test-spock-gradle-version]
----
...
.BuildLogicFunctionalTest.groovy
----
include::{snippetsPath}/testKit/gradleRunner/testKitFunctionalTestSpockBuildCache/src/test/groovy/org/gradle/sample/BuildLogicFunctionalTest.groovy[tag=functional-test-build-cache]
----
...
.BuildLogicFunctionalTest.groovy
----
include::{snippetsPath}/testKit/gradleRunner/testKitFunctionalTestSpockBuildCache/src/test/groovy/org/gradle/sample/BuildLogicFunctionalTest.groovy[tag=clean-build-cache]
----
