...
At the time of writing Gradle 3.0 is the lowest supported version.
To learn about the precise ranges, check the <<third_party_integration.adoc#sec:embedding_compatibility,compatibility matrix>>.
