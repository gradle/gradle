...
include::{snippetsPath}/buildlifecycle/basic/buildlifecycle.groovy.out[]
----
[source.multi-language-sample,kotlin]
----
> gradle test testBoth
include::{snippetsPath}/buildlifecycle/basic/buildlifecycle.kotlin.out[]
----
...
====
include::sample[dir="snippets/buildlifecycle/projectEvaluateEvents/groovy",files="build.gradle[tags=after-evaluate];projectA.gradle[]"]
include::sample[dir="snippets/buildlifecycle/projectEvaluateEvents/kotlin",files="build.gradle.kts[tags=after-evaluate];projectA.gradle.kts[]"]
====

.Output of `gradle -q test`
----
> gradle -q test
include::{snippetsPath}/buildlifecycle/projectEvaluateEvents/projectEvaluateEvents.out[]
----
...
----
> gradle -q test
include::{snippetsPath}/buildlifecycle/buildProjectEvaluateEvents/buildProjectEvaluateEvents.groovy.out[]
----
[source.multi-language-sample,kotlin]
----
> gradle -q test
include::{snippetsPath}/buildlifecycle/buildProjectEvaluateEvents/buildProjectEvaluateEvents.kotlin.out[]
----
...
----
> gradle -q a
include::{snippetsPath}/buildlifecycle/taskCreationEvents/taskCreationEvents.out[]
----
...
----
> gradle -q broken
include::{snippetsPath}/buildlifecycle/taskExecutionEvents/taskExecutionEvents.groovy.out[]
----
[source.multi-language-sample,kotlin]
----
> gradle -q broken
include::{snippetsPath}/buildlifecycle/taskExecutionEvents/taskExecutionEvents.kotlin.out[]
----
