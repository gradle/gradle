...
include::{samplesPath}/buildlifecycle/basic/buildlifecycle.groovy.out[]
----
[source.multi-language-sample,kotlin]
----
> gradle test testBoth
include::{samplesPath}/buildlifecycle/basic/buildlifecycle.kotlin.out[]
----
...
----
> gradle -q test
include::{samplesPath}/buildlifecycle/projectEvaluateEvents/projectEvaluateEvents.out[]
----
...
----
> gradle -q test
include::{samplesPath}/buildlifecycle/buildProjectEvaluateEvents/buildProjectEvaluateEvents.groovy.out[]
----
[source.multi-language-sample,kotlin]
----
> gradle -q test
include::{samplesPath}/buildlifecycle/buildProjectEvaluateEvents/buildProjectEvaluateEvents.kotlin.out[]
----
...
----
> gradle -q a
include::{samplesPath}/buildlifecycle/taskCreationEvents/taskCreationEvents.out[]
----
...
----
> gradle -q broken
include::{samplesPath}/buildlifecycle/taskExecutionEvents/taskExecutionEvents.groovy.out[]
----
[source.multi-language-sample,kotlin]
----
> gradle -q broken
include::{samplesPath}/buildlifecycle/taskExecutionEvents/taskExecutionEvents.kotlin.out[]
----
