...
For now, you have to  link:../samples/sample_publishing_convention_plugins.html#publishing_convention_plugins[publish the settings convention plugins to a repository of your choice].
