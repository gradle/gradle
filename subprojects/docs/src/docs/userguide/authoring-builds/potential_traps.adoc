...
.scope.groovy
----
include::{snippetsPath}/tutorial/groovyScope/scope.groovy[]
----

.Output of `groovy scope.groovy`
----
> groovy scope.groovy
include::{snippetsPath}/tutorial/groovyScope/scope.out[]
----
...
----
> gradle -q compile
include::{snippetsPath}/tutorial/mkdirTrap/mkdirTrap.out[]
----
