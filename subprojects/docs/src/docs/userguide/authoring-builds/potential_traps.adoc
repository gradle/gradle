...
.scope.groovy
----
include::{samplesPath}/tutorial/groovyScope/scope.groovy[]
----

.Output of `groovy scope.groovy`
----
> groovy scope.groovy
include::{samplesPath}/tutorial/groovyScope/scope.out[]
----
...
----
> gradle -q compile
include::{samplesPath}/tutorial/mkdirTrap/mkdirTrap.out[]
----
