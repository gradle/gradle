...
----
> gradle -q list
include::{samplesPath}/files/fileCollections/fileCollectionsWithClosure.out[]
----
...
include::{samplesPath}/files/fileCollections/fileCollectionsFiltering.out[]
----
...
----
> gradle -q myZip
include::{samplesPath}/files/archiveNaming/archiveNaming.out[]
----
...
include::{samplesPath}/files/archiveNaming/zipWithCustomName.out[]
----
...
----
> gradle -q echoNames
include::{samplesPath}/files/archivesChangedBaseName/zipWithArchivesBaseName.out[]
----
