...
----
> gradle -q list
include::{snippetsPath}/files/fileCollections/fileCollectionsWithClosure.out[]
----
...
include::{snippetsPath}/files/fileCollections/fileCollectionsFiltering.out[]
----
...
----
> gradle -q myZip
include::{snippetsPath}/files/archiveNaming/archiveNaming.out[]
----
...
include::{snippetsPath}/files/archiveNaming/zipWithCustomName.out[]
----
...
----
> gradle -q echoNames
include::{snippetsPath}/files/archivesChangedBaseName/zipWithArchivesBaseName.out[]
----
