...
----
> gradle -q check
include::{snippetsPath}/tutorial/projectApi/projectApi.out[]
----
====
...
include::{snippetsPath}/tutorial/extraProperties/extraProperties.out[]
----
====
...
----
> gradle -q configure
include::{snippetsPath}/tutorial/configureObject/configureObject.out[]
----
====
...
----
> gradle -q configure
include::{snippetsPath}/tutorial/configureObjectUsingScript/configureObjectUsingScript.out[]
----
====
...
.Groovy JDK methods
====
include::sample[dir="snippets/tutorial/groovy",files="build.gradle[tags=groovyJdk]"]
====
...
.Property accessors
====
include::sample[dir="snippets/tutorial/groovy",files="build.gradle[tags=propertyAccessors]"]
====
...
====
include::sample[dir="snippets/tutorial/groovy",files="build.gradle[tags=methodCallWithoutParentheses]"]
====
...
.List and map literals
====
include::sample[dir="snippets/tutorial/groovy",files="build.gradle[tags=listAndMapLiterals]"]
====
...
====
include::sample[dir="snippets/tutorial/groovy",files="build.gradle[tags=closureAsLastParam]"]
====
...
.Closure delegates
====
include::sample[dir="snippets/tutorial/groovy",files="build.gradle[tags=closureDelegates]"]
====
