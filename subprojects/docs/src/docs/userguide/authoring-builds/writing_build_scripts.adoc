...
----
> gradle -q check
include::{samplesPath}/tutorial/projectApi/projectApi.out[]
----
====
...
include::{samplesPath}/tutorial/extraProperties/extraProperties.out[]
----
====
...
----
> gradle -q configure
include::{samplesPath}/tutorial/configureObject/configureObject.out[]
----
====
...
----
> gradle -q configure
include::{samplesPath}/tutorial/configureObjectUsingScript/configureObjectUsingScript.out[]
----
====
