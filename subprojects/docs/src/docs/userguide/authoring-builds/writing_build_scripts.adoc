...
IMPORTANT: Build scripts_ define `Project` objects. +
...
IMPORTANT: The _build scripts_ described here target `Project` objects. +
...
CAUTION: The Kotlin DSL does not support arbitrary object configuration using an external script. +
