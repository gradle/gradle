...
include::{samplesPath}/tutorial/properties/properties.out[]
----
...
include::{samplesPath}/tutorial/configureTaskUsingProjectProperty/configureTaskUsingProjectProperty.out[]
----
