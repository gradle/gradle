...
include::{snippetsPath}/tutorial/properties/properties.out[]
----
...
include::{snippetsPath}/tutorial/configureTaskUsingProjectProperty/configureTaskUsingProjectProperty.out[]
----
