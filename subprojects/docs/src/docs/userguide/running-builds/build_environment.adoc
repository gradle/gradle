...
link:https://scans.gradle.com[Build Scan™] will tell you information about the JVM that executed the build when you use the `--scan` option.

[caption="Build Environment in Build Scan™",link=https://scans.gradle.com/s/sample/cpp-parallel/infrastructure]
