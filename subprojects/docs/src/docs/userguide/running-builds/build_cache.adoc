...
====
include::sample[dir="snippets/buildCache/build-src/groovy",files="settings.gradle[tags=configure-build-src-build-cache];gradle/buildCacheSettings.gradle[tags=configure-build-src-build-cache];buildSrc/settings.gradle[tags=configure-build-src-build-cache]"]
include::sample[dir="snippets/buildCache/build-src/kotlin",files="settings.gradle.kts[tags=configure-build-src-build-cache];gradle/buildCacheSettings.gradle.kts[tags=configure-build-src-build-cache];buildSrc/settings.gradle.kts[tags=configure-build-src-build-cache]"]
====
