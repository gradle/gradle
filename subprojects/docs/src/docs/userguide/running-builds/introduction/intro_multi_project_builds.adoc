...
= Multi-Project Builds Basics

Gradle supports multi-project build.
...
Then, according to the task name arguments and the current directory, Gradle filters the tasks that should be executed.
