...
====
include::sample[dir="userguide/initScripts/configurationInjection/groovy",files="build.gradle[];init.gradle[]"]
include::sample[dir="userguide/initScripts/configurationInjection/kotlin",files="build.gradle.kts[];init.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/initScripts/externalDependency/groovy",files="init.gradle[tags=declare-classpath]"]
include::sample[dir="userguide/initScripts/externalDependency/kotlin",files="init.gradle.kts[tags=declare-classpath]"]
====
...
====
include::sample[dir="userguide/initScripts/externalDependency/groovy",files="init.gradle[tags=all]"]
include::sample[dir="userguide/initScripts/externalDependency/kotlin",files="init.gradle.kts[tags=all]"]
====
...
====
include::sample[dir="userguide/initScripts/plugins/groovy",files="init.gradle[tags=init-script-plugin];build.gradle[tag=show-repos-task]"]
include::sample[dir="userguide/initScripts/plugins/kotlin",files="init.gradle.kts[tags=init-script-plugin];build.gradle.kts[tag=show-repos-task]"]
====
