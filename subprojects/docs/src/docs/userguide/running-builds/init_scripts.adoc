...
include::{samplesPath}/initScripts/configurationInjection/initScriptConfiguration.out[]
----
...
include::{samplesPath}/initScripts/externalDependency/externalInitDependency.out[]
----
[source.multi-language-sample,kotlin]
----
...
include::{samplesPath}/initScripts/plugins/usePluginsInInitScripts.out[]
----
[source.multi-language-sample,kotlin]
----
