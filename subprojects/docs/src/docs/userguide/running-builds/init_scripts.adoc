...
include::{snippetsPath}/initScripts/configurationInjection/initScriptConfiguration.out[]
----
...
====
include::sample[dir="snippets/initScripts/externalDependency/groovy",files="init.gradle[tags=all]"]
include::sample[dir="snippets/initScripts/externalDependency/kotlin",files="init.gradle.kts[tags=all]"]
====
...
include::{snippetsPath}/initScripts/externalDependency/externalInitDependency.out[]
----
[source.multi-language-sample,kotlin]
----
...
include::{snippetsPath}/initScripts/plugins/usePluginsInInitScripts.out[]
----
[source.multi-language-sample,kotlin]
----
