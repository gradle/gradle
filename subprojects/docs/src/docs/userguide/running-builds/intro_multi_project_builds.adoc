...
For details about authoring _multi-project_ builds, consult the <<creating_multi_project_builds#multi_project_builds,Authoring Multi-Project Builds section of the user manual>>.
...
Because of Gradle's <<sharing_build_logic_between_subprojects#sec:cross_project_configuration,cross project configuration>>, _every_ project has to be evaluated before _any_ task gets executed.
...
If you're interested in how this is configured, you can read about writing multi-project builds <<creating_multi_project_builds.adoc#multi_project_builds,later in the user manual>>.
