...
link:{gradle-issues}13456[[.yellow]#⚠#]:: <<build_init_plugin.adoc#build_init_plugin,Build Init>>
...
link:{gradle-issues}23029[[.red]#✖#]:: <<custom_plugins.adoc#sec:precompiled_plugins,Groovy DSL Plugin Development>>
