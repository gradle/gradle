...
=== See the impact
image::configuration-cache-effect.gif[]
...
+
This will give you a good overview of the nature of problems your build and plugins are facing.
...
Let your team know that they can opt-in by, for example, enabling the configuration cache on their IDE run configurations for the supported workflow.
+
