...
// TODO value suppliers reference documentation
...
This section provides information about the current support in <<configuration_cache#core_plugins, core Gradle plugins>> and <<configuration_cache#community_plugins, community plugins>>.
...
* a copy of the console problem report, or ideally a ZIP of the HTML problem report you got, so the plugin author can easily reason about the problems,
