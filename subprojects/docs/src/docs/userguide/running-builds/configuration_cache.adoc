...
If a build configuration inputs has changed, Gradle will not use the entry and will run the configuration phase again as above, saving the result for later reuse.
...
| `project.rootDir`
| A task input property or script variable to capture the root directory.

| `project.projectDir`
| A task input property or script variable to capture the project directory.

| `project.buildDir`
| A task input property or script variable to capture the project build directory.

| `project.name`
| A task input property or script variable to capture the project name.

| `project.description`
| A task input property or script variable to capture the project description.

| `project.group`
| A task input property or script variable to capture the project group.

| `project.version`
| A task input property or script variable to capture the project version.
...
| `project.file(path)`
| A task input or output property or a script variable to capture the file.

| `project.uri(path)`
| A task input or output property or a script variable to capture the URI if it represents a parameter of the task action. Otherwise, `File.toURI()` or some other JVM API can be used.
...
| `project.copySpec {}`
| A task input property or a script variable to capture the copy spec.
