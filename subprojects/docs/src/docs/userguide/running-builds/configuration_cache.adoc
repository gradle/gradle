...
* [.green]#*✓*# <<java_library_distribution_plugin.adoc#java_library_distribution_plugin,Java Library Distribution>>
...
* [.red]#✖# <<build_init_plugin.adoc#build_init_plugin,Build Init>>
* [.red]#✖# <<signing_plugin.adoc#signing_plugin,Signing>>
* [.green]#*✓*# <<java_gradle_plugin.adoc#java_gradle_plugin,Plugin Development>>
