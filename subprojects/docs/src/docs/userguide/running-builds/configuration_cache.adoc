...
[source, groovy]
----
def config = providers.fileContents("some.conf").asText.forUseAtConfigurationTime()
----
=====
[.multi-language-sample]
=====
...
[source, kotlin]
----
val config = providers.fileContents("some.conf").asText.forUseAtConfigurationTime()
----
=====
====
