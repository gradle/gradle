...
Services are available for injection into the elements of the container.
See <<custom_tasks.adoc#service_injection,service injection for tasks>>. for details.
