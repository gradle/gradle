...
.A custom plugin with configuration closure
====
...
.Mapping extension properties to task properties
====
include::sample[dir="userguide/tasks/mapExtensionPropertiesToTaskProperties/groovy",files="build.gradle[]"]
include::sample[dir="userguide/tasks/mapExtensionPropertiesToTaskProperties/kotlin",files="build.gradle.kts[]"]
====
