...
`components.web`::
A link:{javadoc-path}/org/gradle/api/component/SoftwareComponent.html[SoftwareComponent] for <<publishing_overview.adoc#publishing_overview,publishing>> the production WAR created by the `war` task.
