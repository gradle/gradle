...
Dependency resolve rules provide a very powerful way to control the dependency resolution process, and can be used to implement all sorts of advanced patterns in dependency management. Some of these patterns are outlined below. For more information and code samples see the link:{groovy-dsl-path}/org.gradle.api.artifacts.ResolutionStrategy.html[ResolutionStrategy] class in the API documentation.
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/customizingResolution/resolutionStrategy/build.gradle[tag=releasable-unit]
----
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/customizingResolution/resolutionStrategy/build.gradle[tag=custom-versioning-scheme]
----
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/customizingResolution/resolutionStrategy/build.gradle[tag=blacklisting_version]
----
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/customizingResolution/resolutionStrategy/build.gradle[tag=module_substitution]
----
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/customizingResolution/substitutionRule/build.gradle[tag=module_to_project_substitution]
----
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/customizingResolution/substitutionRule/build.gradle[tag=project_to_module_substitution]
----
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/customizingResolution/conditionalSubstitutionRule/build.gradle[tag=project_substitution]
----
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/customizingResolution/metadataRule/build.gradle[tag=latest-selector]
----

.Output of **`gradle -q listConfigs`**
----
> gradle -q listConfigs
include::{samples-path}/userguide/dependencyManagement/customizingResolution/metadataRule/latestSelector.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/customizingResolution/metadataRule/build.gradle[tag=custom-status-scheme]
----
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/customizingResolution/metadataRule/build.gradle[tag=custom-status-scheme-module]
----
...
Values from the Ivy descriptor are made available via the link:{javadoc-path}/org/gradle/api/artifacts/ivy/IvyModuleDescriptor.html[IvyModuleDescriptor] interface.
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/customizingResolution/metadataRule/build.gradle[tag=ivy-component-metadata-rule]
----

Note that while any rule can request the link:{javadoc-path}/org/gradle/api/artifacts/ivy/IvyModuleDescriptor.html[IvyModuleDescriptor], only components sourced from an Ivy repository will have a non-null value for it.

As can be seen in the examples above, component metadata rules are defined by implementing link:{javadoc-path}/org/gradle/api/artifacts/ComponentMetadataRule.html[ComponentMetadataRule] which has a single `execute` method receiving an instance of link:{javadoc-path}/org/gradle/api/artifacts/ComponentMetadataContext.html[ComponentMetadataContext] as parameter.

The next example shows how you can configure the `ComponentMetadataRule` through an link:{javadoc-path}/org/gradle/api/ActionConfiguration.html[ActionConfiguration].
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/customizingResolution/metadataRule/build.gradle[tag=config-component-metadata-rule]
----
...
This is for the moment limited to the link:{javadoc-path}/org/gradle/api/artifacts/repositories/RepositoryResourceAccessor.html[RepositoryResourceAccessor].
...
Rules are configured via the link:{groovy-dsl-path}/org.gradle.api.artifacts.ComponentSelectionRules.html[ComponentSelectionRules] object. Each rule configured will be called with a link:{groovy-dsl-path}/org.gradle.api.artifacts.ComponentSelection.html[ComponentSelection] object as an argument which contains information about the candidate version being considered. Calling link:{groovy-dsl-path}/org.gradle.api.artifacts.ComponentSelection.html#org.gradle.api.artifacts.ComponentSelection:reject(java.lang.String)[ComponentSelection.reject(java.lang.String)] causes the given candidate version to be explicitly rejected, in which case the candidate will not be considered for the selector.
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/customizingResolution/selectionRule/build.gradle[tag=reject-version-1-1]
----
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/customizingResolution/selectionRule/build.gradle[tag=targeted-component-selection]
----

Component selection rules can also consider component metadata when selecting a version. Possible metadata arguments that can be considered are link:{javadoc-path}/org/gradle/api/artifacts/ComponentMetadata.html[ComponentMetadata] and link:{javadoc-path}/org/gradle/api/artifacts/ivy/IvyModuleDescriptor.html[IvyModuleDescriptor].
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/customizingResolution/selectionRule/build.gradle[tag=component-selection-with-metadata]
----

Note that a link:{groovy-dsl-path}/org.gradle.api.artifacts.ComponentSelection.html[ComponentSelection] argument is _always_ required as the first parameter when declaring a component selection rule with additional Ivy metadata parameters, but the metadata parameters can be declared in any order.
...
* must return void.
* must have link:{groovy-dsl-path}/org.gradle.api.artifacts.ComponentSelection.html[ComponentSelection] as the first argument.
* may have additional parameters of type link:{javadoc-path}/org/gradle/api/artifacts/ComponentMetadata.html[ComponentMetadata] and/or link:{javadoc-path}/org/gradle/api/artifacts/ivy/IvyModuleDescriptor.html[IvyModuleDescriptor].
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/customizingResolution/selectionRule/build.gradle[tag=api-component-selection]
----
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/customizingResolution/replacementRule/build.gradle[tag=module_replacement_declaration]
----

For more examples and detailed API, refer to the DSL reference for link:{javadoc-path}/org/gradle/api/artifacts/dsl/ComponentMetadataHandler.html[ComponentMetadataHandler].
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/customizingResolution/defaultDependency/build.gradle[tag=configuration-default-dependencies]
----
...
.build.gradle
----
include::{samples-path}/userguide/dependencyManagement/customizingResolution/ivyDynamicMode/build.gradle[tag=ivy-repo-dynamic-mode]
----
