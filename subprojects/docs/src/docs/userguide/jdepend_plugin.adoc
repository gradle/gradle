...
`jdependMain` — type: link:{groovyDslPath}/org.gradle.api.plugins.quality.JDepend.html[JDepend]::
_Depends on_: `classes`
+
Runs JDepend against the production Java source files.

`jdependTest` — type: link:{groovyDslPath}/org.gradle.api.plugins.quality.JDepend.html[JDepend]::
_Depends on_: `testClasses`
+
Runs JDepend against the test Java source files.

`jdepend__SourceSet__` — type: link:{groovyDslPath}/org.gradle.api.plugins.quality.JDepend.html[JDepend]::
