...
.build.gradle
----
include::{samples-path}/codeQuality/build.gradle[tag=use-jdepend-plugin]
----
...
`jdependMain` — type: link:{groovy-dsl-path}/org.gradle.api.plugins.quality.JDepend.html[JDepend]::
_Depends on_: `classes`
+
Runs JDepend against the production Java source files.

`jdependTest` — type: link:{groovy-dsl-path}/org.gradle.api.plugins.quality.JDepend.html[JDepend]::
_Depends on_: `testClasses`
+
Runs JDepend against the test Java source files.

`jdepend__SourceSet__` — type: link:{groovy-dsl-path}/org.gradle.api.plugins.quality.JDepend.html[JDepend]::
...
See the link:{groovy-dsl-path}/org.gradle.api.plugins.quality.JDependExtension.html[JDependExtension] class in the API documentation.
