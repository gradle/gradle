...
NOTE: This chapter describes the _original_ publishing mechanism available in Gradle 1.0, which has since been superseded by <<publishing.adoc#publishing_overview,an alternative model>>.
