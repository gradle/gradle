...
----
$ gradle -q list
include::{samplesPath}/artifacts/generatedFileDependencies/generatedFileDependencies.out[]
----
...
include::{samplesPath}/dependencyManagement/inspectingDependencies/dependencyReason/dependencyReasonReport.out[]
----
