...
If no such module metadata file exists, Gradle may look, depending on the <<declaring_repositories.adoc#sec:supported_metadata_sources,metadata sources definitions>>, for an artifact file called `hibernate-3.0.5.jar` directly.
