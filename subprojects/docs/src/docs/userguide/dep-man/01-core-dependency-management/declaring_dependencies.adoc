...
Historically, <<declaring_dependencies.adoc#sub:what_is_a_configuration,configurations>>  have been at the root of dependency resolution in Gradle.
...
Alternatively, you can also define the source directory of one or many file dependencies in the form of a <<declaring_repositories.adoc#sec:flat_dir_resolver,flat directory repository>>.
