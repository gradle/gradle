...
====
include::sample[dir="snippets/dependencyManagement/attributeMatching/snippets/groovy",files="build.gradle[tags=declare-configuration]"]
include::sample[dir="snippets/dependencyManagement/attributeMatching/snippets/kotlin",files="build.gradle.kts[tags=declare-configuration]"]
====
...
====
include::sample[dir="snippets/dependencyManagement/attributeMatching/snippets/groovy",files="build.gradle[tags=concrete-classpath]"]
include::sample[dir="snippets/dependencyManagement/attributeMatching/snippets/kotlin",files="build.gradle.kts[tags=concrete-classpath]"]
====
...
====
include::sample[dir="snippets/dependencyManagement/attributeMatching/snippets/groovy",files="build.gradle[tags=setup-configurations]"]
include::sample[dir="snippets/dependencyManagement/attributeMatching/snippets/kotlin",files="build.gradle.kts[tags=setup-configurations]"]
====
...
----
$ gradle -q list
include::{snippetsPath}/artifacts/generatedFileDependencies/generatedFileDependencies.out[]
----
...
====
include::sample[dir="snippets/dependencyManagement/declaringDependencies/projectDependencies/groovy",files="build.gradle[tags=project-dependencies]"]
include::sample[dir="snippets/dependencyManagement/declaringDependencies/projectDependencies/kotlin",files="build.gradle.kts[tags=project-dependencies]"]
====
...
====
include::sample[dir="snippets/plugins/customPlugin/groovy/plugin",files="build.gradle[tags=local-groovy-dependencies]"]
include::sample[dir="snippets/plugins/customPlugin/kotlin/plugin",files="build.gradle.kts[tags=local-groovy-dependencies]"]
====
...
include::{snippetsPath}/dependencyManagement/inspectingDependencies/dependencyReason/dependencyReasonReport.out[]
----
