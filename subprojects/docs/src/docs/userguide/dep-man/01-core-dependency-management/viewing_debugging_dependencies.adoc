...
[NOTE]
====
The `dependencies` task will only execute on a _single_ project.
...
include::{snippetsPath}/dependencyManagement/inspectingDependencies/dependenciesReport/dependencyReport.out[]
----
...
[NOTE]
====
The `dependencyInsight` task will only execute on a _single_ project.
...
include::{snippetsPath}/dependencyManagement/inspectingDependencies/dependencyInsightReport/dependencyInsightReport.out[]
----
