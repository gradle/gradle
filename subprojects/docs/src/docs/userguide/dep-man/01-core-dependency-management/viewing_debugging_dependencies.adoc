...
Gradle offers both capabilities through visual representation via Build Scan™ and as command line tooling.
...
[NOTE]
====
If you do not know what a link:https://scans.gradle.com/[Build Scan™] is, be sure to check it out!
====
