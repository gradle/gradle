...
[WARNING]
====
JCenter will soon be link:https://jfrog.com/blog/into-the-sunset-bintray-jcenter-gocenter-and-chartcenter[decommissioned], hence the `jcenter()` method is now deprecated.
====
