...
If you do use a local Maven repository, combine it with <<declaring_repositories.adoc#sec:repository-content-filtering,a repository filter>> to ensure it only provides specific dependencies.
