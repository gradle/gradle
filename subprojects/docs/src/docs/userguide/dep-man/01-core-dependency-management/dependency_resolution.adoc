...
| `modules-2`           | `files-2.1`           | `metadata-2.98`           | Gradle 7.5 and above
|===
...
NOTE: See the documentation on <<incremental_builds.adoc#sec:task_input_using_dependency_resolution_results, using dependency resolution results>> for more details on how to consume the results in a task.
