...
<<single-version-declarations#version_ordering,here>>.
...
All the rules of <<single-version-declarations#version_ordering,version ordering>> still apply, but the conflict resolver
