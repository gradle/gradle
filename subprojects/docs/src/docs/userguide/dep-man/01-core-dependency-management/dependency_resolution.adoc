...
Learn more about handling these type of conflicts in <<controlling_transitive_dependencies.adoc#selecting-between-candidates,Selecting between candidates>>.
