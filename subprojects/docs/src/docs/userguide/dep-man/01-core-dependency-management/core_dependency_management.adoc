...
<2> *Remote and local repositories for artifact locations.*
+
...
In this example, Gradle fetches _dependencies_ from the link:https://repo1.maven.org/maven2/[Maven] and link:https://maven.google.com/[Google] _repositories_. +
...
<4> *Specific artifact name and version within a specific scope.*
+
