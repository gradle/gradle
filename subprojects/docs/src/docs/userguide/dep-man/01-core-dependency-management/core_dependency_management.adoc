...
<1> *Define repositories for project.*

<2> *Remote and local repositories for dependency locations.*
+
...
<3> *Define dependencies used by project.*

<4> *Specific dependency name and version within a specific scope.*
+
