...
----
include::{samplesPath}/dependencyManagement/dependencyLocking/lockingSingleConfiguration/groovy/gradle/dependency-locks/compileClasspath.lockfile[]
----
...
.gradle.lockfile
----
include::{samplesPath}/dependencyManagement/dependencyLocking/lockingSingleFilePerProject/groovy/gradle.lockfile[]
----
