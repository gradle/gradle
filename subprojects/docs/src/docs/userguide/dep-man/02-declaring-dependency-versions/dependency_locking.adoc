...
====
include::sample[dir="userguide/dependencyManagement/dependencyLocking/unlockingSingleConfiguration/groovy",files="build.gradle[tags=locking-one]"]
include::sample[dir="userguide/dependencyManagement/dependencyLocking/unlockingSingleConfiguration/kotlin",files="build.gradle.kts[tags=locking-one]"]
====
...
====
include::sample[dir="userguide/dependencyManagement/dependencyLocking/lockModeSelection/groovy",files="build.gradle[tags=lock-mode]"]
include::sample[dir="userguide/dependencyManagement/dependencyLocking/lockModeSelection/kotlin",files="build.gradle.kts[tags=lock-mode]"]
====
