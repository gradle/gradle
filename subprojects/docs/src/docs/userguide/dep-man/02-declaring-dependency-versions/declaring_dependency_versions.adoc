...
The <<viewing_debugging_dependencies.adoc#sub:dynamic_versions_and_changing_modules,threshold can be configured>> as needed for example if you want to resolve new versions earlier.
...
Within this time frame, Gradle does not try to resolve newer versions from the declared repositories. The <<viewing_debugging_dependencies.adoc#sub:dynamic_versions_and_changing_modules,threshold can be configured>> as needed for example if you want to resolve new snapshot versions earlier.
