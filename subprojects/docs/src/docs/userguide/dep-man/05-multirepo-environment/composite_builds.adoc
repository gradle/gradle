...
====
include::sample[dir="samples/build-organization/compositeBuilds/basic/groovy",files="my-app/build.gradle[]"]
include::sample[dir="samples/build-organization/compositeBuilds/basic/kotlin",files="my-app/build.gradle.kts[]"]
====
...
include::{samplesPath}/build-organization/compositeBuilds/basic/tests/compositeBuilds_basic_cli.out
----
...
====
include::sample[dir="samples/build-organization/compositeBuilds/basic/groovy",files="composite/settings.gradle[]"]
include::sample[dir="samples/build-organization/compositeBuilds/basic/kotlin",files="composite/settings.gradle.kts[]"]
====
...
====
include::sample[dir="samples/build-organization/compositeBuilds/basic/groovy",files="composite/build.gradle[tags=run]"]
include::sample[dir="samples/build-organization/compositeBuilds/basic/kotlin",files="composite/build.gradle.kts[tags=run]"]
====
...
====
include::sample[dir="samples/build-organization/compositeBuilds/declared-substitution/groovy/anonymous-library",files="build.gradle[]"]
include::sample[dir="samples/build-organization/compositeBuilds/declared-substitution/kotlin/anonymous-library",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="samples/build-organization/compositeBuilds/declared-substitution/groovy/my-app",files="settings.gradle[]"]
include::sample[dir="samples/build-organization/compositeBuilds/declared-substitution/kotlin/my-app",files="settings.gradle.kts[]"]
====
...
====
include::sample[dir="samples/build-organization/compositeBuilds/hierarchical-multirepo/groovy",files="build.gradle[tags=publishDeps]"]
include::sample[dir="samples/build-organization/compositeBuilds/hierarchical-multirepo/kotlin",files="build.gradle.kts[tags=publishDeps]"]
====
