...
====
include::sample[dir="samples/build-organization/composite-builds/basic/groovy",files="my-app/app/build.gradle[]"]
include::sample[dir="samples/build-organization/composite-builds/basic/kotlin",files="my-app/app/build.gradle.kts[]"]
====
