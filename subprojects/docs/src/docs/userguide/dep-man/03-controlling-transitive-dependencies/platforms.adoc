...
The BOMs declared dependencies versions are recommendations only. 
In case you want to use another version provided by the BOM, you can set the version to the declared dependency.
This will then override the version provided by the BOM.
