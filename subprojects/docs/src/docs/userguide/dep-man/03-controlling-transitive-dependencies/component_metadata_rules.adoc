...
While variant selection can handle <<variant_attributes.adoc#abm_declaring_attributes,any custom attribute>>, version selection only considers attributes for which specific semantics are implemented.
