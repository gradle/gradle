...
Similar to dependency declarations, dependency constraint declarations are <<declaring_dependencies.adoc#what-are-dependency-configurations,scoped by configurations>> and can therefore be selectively defined for parts of a build.
