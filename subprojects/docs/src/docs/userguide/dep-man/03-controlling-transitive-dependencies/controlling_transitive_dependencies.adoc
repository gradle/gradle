...
<<#sec:capabilities,Capabilities>> help _realizing_ that you have a conflict, but Gradle also provides tools to express how to solve the conflicts.
...
It is preferable to express module conflicts in terms of <<sec:capabilities, capabilities conflicts>>.
