...
All variants of a component provide a number of <<controlling_transitive_dependencies#sec:capabilities, capabilities>>, which are denoted similarly using GAV coordinates.
