...
All variants of a component provide a number of <<controlling_transitive_dependencies#sub:capabilities, capabilities>>, which are denoted similarly using GAV coordinates.
