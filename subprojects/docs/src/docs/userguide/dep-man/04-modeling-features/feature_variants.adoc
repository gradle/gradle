...
[NOTE]
====
By convention, Gradle will map the feature name to a capability which group and version are the same as the group and version of the main component, but with a name composed of the main component name and the kebab-cased feature name.
