...
See the <<dependency_constraints.adoc#sec:adding-constraints-transitive-deps, capabilities section of the documentation>> to figure out how to fix capability conflicts.
