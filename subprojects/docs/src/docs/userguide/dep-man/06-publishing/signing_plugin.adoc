...
====
include::sample[dir="snippets/signing/maven/groovy",files="build.gradle[tags=use-plugin]"]
include::sample[dir="snippets/signing/maven/kotlin",files="build.gradle.kts[tags=use-plugin]"]
====
...
====
include::sample[dir="snippets/signing/in-memory/groovy-subkey",files="build.gradle[tags=signing]"]
include::sample[dir="snippets/signing/in-memory/kotlin-subkey",files="build.gradle.kts[tags=signing]"]
====
...
include::{snippetsPath}/signing/maven-publish/signingPluginSignPublication.out[]
----
...
====
include::sample[dir="snippets/signing/maven/groovy",files="build.gradle[tags=sign-archives]"]
include::sample[dir="snippets/signing/maven/kotlin",files="build.gradle.kts[tags=sign-archives]"]
====
...
----
> gradle signArchives
include::{snippetsPath}/signing/maven/signingArchivesOutput.out[]
----
...
----
> gradle signStuffZip
include::{snippetsPath}/signing/tasks/signingTaskOutput.out[]
----
...
This means that if you want to upload your signatures to your distribution repository along with the artifacts you simply execute the `uploadArchives` task.
...
[NOTE]
====
This section covers signing POM files for the _legacy_ publishing mechanism available in Gradle 1.0.
...
====
include::sample[dir="snippets/signing/maven/groovy",files="build.gradle[tags=sign-pom]"]
include::sample[dir="snippets/signing/maven/kotlin",files="build.gradle.kts[tags=sign-pom]"]
====
