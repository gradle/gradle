...
====
include::sample[dir="signing/in-memory/groovy",files="build.gradle[tags=signing]"]
include::sample[dir="signing/in-memory/kotlin",files="build.gradle.kts[tags=signing]"]
====
...
====
include::sample[dir="signing/in-memory/groovy-subkey",files="build.gradle[tags=signing]"]
include::sample[dir="signing/in-memory/kotlin-subkey",files="build.gradle.kts[tags=signing]"]
====
