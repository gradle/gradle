...
The `AdhocComponentWithVariants` component declares two method called `addVariantsFromConfiguration` and `withVariantsFromConfiguration` which accept two parameters:
