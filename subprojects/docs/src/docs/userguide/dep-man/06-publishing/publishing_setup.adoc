...
====
include::sample[dir="snippets/userguide/publishing/javaLibrary/groovy",files="build.gradle[tags=apply-plugins]"]
include::sample[dir="snippets/userguide/publishing/javaLibrary/kotlin",files="build.gradle.kts[tags=apply-plugins]"]
====
...
====
include::sample[dir="snippets/userguide/publishing/javaLibrary/groovy",files="build.gradle[tags=configure-publishing]"]
include::sample[dir="snippets/userguide/publishing/javaLibrary/kotlin",files="build.gradle.kts[tags=configure-publishing]"]
====
