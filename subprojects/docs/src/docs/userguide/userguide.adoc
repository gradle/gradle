...
Gradle Build Tool supports Android, Java, Kotlin Multiplatform, Groovy, Scala, Javascript, and C/C++.
...
* **Getting Started Tutorial** — <<introduction.adoc#getting_started,Learn Gradle basics>> and the benefits of building your App with Gradle.
