...
For an archive to be a candidate for comparison, it must be added as an artifact of the archives configuration. Take a look at <<artifact_management.adoc#artifact_management,Artifact Management>> for more information on how to configure and add artifacts.
