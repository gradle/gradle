...
Such scripts can be requested declaratively using the `plugins` block:

++++
<sample xmlns:xi="http://www.w3.org/2001/XInclude" id="configureProjectUsingScriptPlugin" dir="userguide/organizeBuildLogic/scriptPlugin" title="Configuring the project using a script plugin">
            <sourcefile file="build.gradle"/>
