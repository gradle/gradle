...
====
include::sample[dir="userguide/swift/testFiltering/groovy",files="build.gradle[tags=test-filtering]"]
include::sample[dir="userguide/swift/testFiltering/kotlin",files="build.gradle.kts[tags=test-filtering]"]
====
...
====
include::sample[dir="userguide/swift/testReport/groovy",files="build.gradle[tags=test-report]"]
include::sample[dir="userguide/swift/testReport/kotlin",files="build.gradle.kts[tags=test-report]"]
====
