...
====
include::sample[dir="userguide/distribution",files="build.gradle[tags=use-plugin]"]
====
...
====
include::sample[dir="userguide/distribution",files="build.gradle[tags=custom-distribution]"]
====
...
====
include::sample[dir="userguide/distribution",files="build.gradle[tags=configure-distribution]"]
====
...
====
include::sample[dir="userguide/distribution",files="build.gradle[tags=publish-distribution]"]
====
