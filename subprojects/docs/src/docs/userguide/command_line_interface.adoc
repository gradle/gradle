...
Learn more in <<viewing_debugging_dependencies.adoc#inspecting_dependencies,Inspecting Dependencies>>.
...
Concrete examples of build scripts and output available in the <<viewing_debugging_dependencies.adoc#inspecting_dependencies,Inspecting Dependencies>>.
...
`--offline`::
Specifies that the build should operate without accessing network resources. Learn more about <<viewing_debugging_dependencies.adoc#sec:controlling_dependency_caching_command_line,options to override dependency caching>>.

`--refresh-dependencies`::
Refresh the state of dependencies. Learn more about how to use this in the <<viewing_debugging_dependencies.adoc#sec:controlling_dependency_caching_command_line,dependency management docs>>.
