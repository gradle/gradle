...
`--offline`::
Specifies that the build should operate without accessing network resources. Learn more about <<declaring_dependency_versions.adoc#sec:controlling_dependency_caching_command_line,options to override dependency caching>>.

`--refresh-dependencies`::
Refresh the state of dependencies. Learn more about how to use this in the <<declaring_dependency_versions.adoc#sec:controlling_dependency_caching_command_line,dependency management docs>>.
