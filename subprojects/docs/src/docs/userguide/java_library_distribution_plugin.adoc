...
====
include::sample[dir="userguide/javaLibraryDistribution",files="build.gradle[tags=use-plugin]"]
====
...
====
include::sample[dir="userguide/javaLibraryDistribution",files="build.gradle[tags=name-conf]"]
====
...
====
include::sample[dir="userguide/javaLibraryDistribution",files="build.gradle[tags=custom-distribution]"]
====
