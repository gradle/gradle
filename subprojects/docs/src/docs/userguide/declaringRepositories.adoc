...
++++
<sample id="public-repository" dir="userguide/dependencyManagement/declaringRepositories/declaringPublicRepository" title="Declaring JCenter repository as source for resolving dependencies">
...
++++
<sample id="custom-repository" dir="userguide/dependencyManagement/declaringRepositories/declaringCustomRepository" title="Declaring a custom repository by URL">
...
++++
<sample id="multiple-repositories" dir="userguide/dependencyManagement/declaringRepositories/declaringMultipleRepositories" title="Declaring multiple repositories">
