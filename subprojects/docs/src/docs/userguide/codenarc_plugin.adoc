...
.build.gradle
----
include::{samplesPath}/codeQuality/build.gradle[tag=use-codenarc-plugin]
----
...
`codenarcMain` — type: link:{groovyDslPath}/org.gradle.api.plugins.quality.CodeNarc.html[CodeNarc]::
+
Runs CodeNarc against the production Java source files.

`codenarcTest` — type: link:{groovyDslPath}/org.gradle.api.plugins.quality.CodeNarc.html[CodeNarc]::
+
Runs CodeNarc against the test Java source files.

`codenarc__SourceSet__` — type: link:{groovyDslPath}/org.gradle.api.plugins.quality.CodeNarc.html[CodeNarc]::
+
