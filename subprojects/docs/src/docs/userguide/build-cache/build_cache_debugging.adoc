...
Gradle Enterprise has the necessary data to diagnose the cache miss when comparing two different Build Scan™, and will show you the properties that caused a different cache key to be generated.
