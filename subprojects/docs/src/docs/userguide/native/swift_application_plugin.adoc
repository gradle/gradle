...
====
include::sample[dir="snippets/userguide/swift/swiftApplication/groovy",files="build.gradle[tags=apply-plugin]"]
include::sample[dir="snippets/userguide/swift/swiftApplication/kotlin",files="build.gradle.kts[tags=apply-plugin]"]
====
...
====
include::sample[dir="snippets/userguide/swift/swiftApplication/groovy",files="build.gradle[tags=configure-target-machines]"]
include::sample[dir="snippets/userguide/swift/swiftApplication/kotlin",files="build.gradle.kts[tags=configure-target-machines]"]
====
