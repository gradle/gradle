...
====
include::sample[dir="snippets/cpp/basic/groovy",files="build.gradle[tags=cpp-source-set]"]
include::sample[dir="snippets/cpp/basic/kotlin",files="build.gradle.kts[tags=cpp-source-set]"]
====
