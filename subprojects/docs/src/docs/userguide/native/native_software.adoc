...
.build.gradle
----
include::{snippetsPath}/native-binaries/c/build.gradle[tag=libraries]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/c/build.gradle[tag=executables]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/cunit/build.gradle[tag=terse-example]
----
...
include::{snippetsPath}/native-binaries/cunit/dependentComponentsReport.out[]
----
...
include::{snippetsPath}/native-binaries/cunit/dependentComponentsReportAll.out[]
----
...
include::{snippetsPath}/native-binaries/cunit/assembleDependentComponentsReport.out[]
----
...
include::{snippetsPath}/native-binaries/cunit/buildDependentComponentsReport.out[]
----
...
include::{snippetsPath}/native-binaries/cunit/assembleDependentComponents.out[]
----
...
include::{snippetsPath}/native-binaries/cunit/buildDependentComponents.out[]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/custom-check/build.gradle[tag=custom-check]
----
...
include::{snippetsPath}/native-binaries/custom-check/nativeComponentCustomCheckOutput.out[]
----
...
----
> gradle components
include::{snippetsPath}/native-binaries/cpp/nativeComponentReport.out[]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/cpp/build.gradle[tag=apply-plugin]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/custom-layout/build.gradle[tag=cpp-sources]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/c/build.gradle[tag=apply-plugin]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/custom-layout/build.gradle[tag=c-sources]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/assembler/build.gradle[tag=apply-plugin]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/objective-c/build.gradle[tag=apply-plugin]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/objective-cpp/build.gradle[tag=apply-plugin]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/cpp/build.gradle[tag=all-binaries]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/c/build.gradle[tag=all-shared-libraries]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/assembler/build.gradle[tag=assembler-args]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/cpp-lib/build.gradle[tag=args]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/windows-resources/build.gradle[tag=apply-plugin]
----
...
----
include::{snippetsPath}/native-binaries/windows-resources/build-resource-only-dll.gradle[tag=windows-resource-set]
----
...
.build-resource-only-dll.gradle
----
include::{snippetsPath}/native-binaries/windows-resources/build-resource-only-dll.gradle[tag=resource-only-library]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/cpp/build.gradle[tag=source-library]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/custom-layout/build.gradle[tag=binary-library]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/multi-project/build.gradle[tag=project-dependencies]
----
...
----
include::{snippetsPath}/native-binaries/pre-compiled-headers/src/hello/headers/pch.h[]
----
...
----
include::{snippetsPath}/native-binaries/pre-compiled-headers/src/hello/cpp/hello.cpp[]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/pre-compiled-headers/build.gradle[tag=libraries]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/variants/build.gradle[tag=build-types]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/variants/build.gradle[tag=build-type-config]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/variants/build.gradle[tag=platforms]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/flavors/build.gradle[tag=flavors]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/variants/build.gradle[tag=target-platforms]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/tool-chains/build.gradle[tag=buildable]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/tool-chains/build.gradle[tag=toolChains]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/tool-chains/build.gradle[tag=withArguments]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/target-platforms/build.gradle[tag=targetplatforms]
----
...
.suite_operators.c
----
include::{snippetsPath}/native-binaries/cunit/src/operatorsTest/c/suite_operators.c[]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/cunit/build.gradle[tag=configure-test-binary]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/cunit/build.gradle[tag=complete-example]
----

.Output of `gradle -q runOperatorsTestFailingCUnitExe`
----
> gradle -q runOperatorsTestFailingCUnitExe
include::{snippetsPath}/native-binaries/cunit/completeCUnitExample.out[]
----
...
.build.gradle
----
include::{snippetsPath}/native-binaries/google-test/build.gradle[tag=configure-test-binary]
----
