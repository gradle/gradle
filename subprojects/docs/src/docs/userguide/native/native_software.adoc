...
.build.gradle
----
include::{snippetsPath}/native-binaries/multi-project/groovy/build.gradle[tag=project-dependencies]
----
...
include::{snippetsPath}/native-binaries/cunit/groovy/completeCUnitExample.out[]
----
