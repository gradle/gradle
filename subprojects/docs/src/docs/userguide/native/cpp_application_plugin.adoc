...
====
include::sample[dir="snippets/userguide/cpp/cppApplication/groovy",files="build.gradle[tags=apply-plugin]"]
include::sample[dir="snippets/userguide/cpp/cppApplication/kotlin",files="build.gradle.kts[tags=apply-plugin]"]
====
...
====
include::sample[dir="snippets/userguide/cpp/cppApplication/groovy",files="build.gradle[tags=configure-target-machines]"]
include::sample[dir="snippets/userguide/cpp/cppApplication/kotlin",files="build.gradle.kts[tags=configure-target-machines]"]
====
