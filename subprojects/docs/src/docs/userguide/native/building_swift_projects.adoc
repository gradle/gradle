...
====
include::sample[dir="snippets/swift/basic/groovy",files="build.gradle[tags=swift-source-set]"]
include::sample[dir="snippets/swift/basic/kotlin",files="build.gradle.kts[tags=swift-source-set]"]
====
