...
Set https://docs.gradle.org/current/javadoc/org/gradle/api/tasks/testing/logging/TestLoggingContainer.html[TestLoggingContainer] for more detail.
...
====
include::sample[dir="snippets/userguide/swift/testFiltering/groovy",files="build.gradle[tags=test-filtering]"]
include::sample[dir="snippets/userguide/swift/testFiltering/kotlin",files="build.gradle.kts[tags=test-filtering]"]
====
...
You can also combine filters defined at the command line with https://docs.gradle.org/current/userguide/command_line_interface.html#sec:continuous_build[continuous build] to re-execute a subset of tests immediately after every change to a production or test source file.
...
====
include::sample[dir="snippets/userguide/swift/testReport/groovy",files="build.gradle[tags=test-report]"]
include::sample[dir="snippets/userguide/swift/testReport/kotlin",files="build.gradle.kts[tags=test-report]"]
====
