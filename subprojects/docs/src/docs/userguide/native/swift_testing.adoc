...
====
include::sample[dir="snippets/swift/testReport/groovy",files="build.gradle[tags=test-report]"]
include::sample[dir="snippets/swift/testReport/kotlin",files="build.gradle.kts[tags=test-report]"]
====
