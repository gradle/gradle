...
====
include::sample[dir="snippets/xcode/groovy",files="build.gradle[tags=apply-plugin]"]
include::sample[dir="snippets/xcode/kotlin",files="build.gradle.kts[tags=apply-plugin]"]
====
