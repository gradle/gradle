...
====
include::sample[dir="snippets/userguide/xcode/groovy",files="build.gradle[tags=apply-plugin]"]
include::sample[dir="snippets/userguide/xcode/kotlin",files="build.gradle.kts[tags=apply-plugin]"]
====
...
`xcodeWorkspaceWorkspaceSettings` - link:{groovyDslPath}/org.gradle.api.xcode.tasks.GenerateWorkspaceSettingsFileTask.html[GenerateWorkspaceSettingsFileTask]::
+
Generates the `__projectName__.xcworkspace` file. This task is only available on the root project.

`xcodeWorkspace` - link:{groovyDslPath}/org.gradle.api.xcode.tasks.GenerateXcodeProjectFileTask.html[GenerateXcodeProjectFileTask]::
...
`xcodeProjectWorkspaceSettings` — link:{groovyDslPath}/org.gradle.api.xcode.tasks.GenerateWorkspaceSettingsFileTask.html[GenerateWorkspaceSettingsFileTask]::
+
Generates the `__projectName__.xcodeproj/project.xcworkspace/xcshareddata/WorkspaceSettings.xcsettings` file.

`xcodeScheme` — link:{groovyDslPath}/org.gradle.api.xcode.tasks.GenerateSchemeFileTask.html[GenerateSchemeFileTask]::
+
Generates the `__projectName__.xcodeproj/xcshareddata/xcschemes/__ProjectName__.xcscheme` file.

`xcodeProject` — link:{groovyDslPath}/org.gradle.api.xcode.tasks.GenerateXcodeProjectFileTask.html[GenerateXcodeProjectFileTask]::
