...
.Download.java
----
include::{samplesPath}/userguide/plugins/readOnlyNestedProperty/java/buildSrc/src/main/java/Download.java[tags=url-process]
include::{samplesPath}/userguide/plugins/readOnlyNestedProperty/java/buildSrc/src/main/java/Resource.java[tags=host-and-path]
----
[source.multi-language-sample,kotlin]
.Download.kt
----
include::{samplesPath}/userguide/plugins/readOnlyNestedProperty/kotlin/buildSrc/src/main/kotlin/Download.kt[tags=url-process]
----
[source.multi-language-sample,groovy]
.Download.groovy
----
include::{samplesPath}/userguide/plugins/readOnlyNestedProperty/groovy/buildSrc/src/main/groovy/Download.groovy[tags=url-process]
----
====
...
The constructor uses this to create a nested `Resources` object (also a custom Gradle type) and makes this object available through the `resources` property.
