...
* link:{javadocPath}/org/gradle/api/artifacts/transform/InputArtifact.html[@InputArtifact] cannot be placed on a property of type `File` anymore.
  Declare your input artifact property of type `Provider<FileSystemLocation>`.
