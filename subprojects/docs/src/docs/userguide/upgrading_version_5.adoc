...
These https://github.com/gradle/gradle/issues/9990["grossly invalid zip files" can trigger zip bomb detection].
...
Note that copy tasks also happily copy multiple sources with the same relative path to the destination directory.
That behavior has also been deprecated.
