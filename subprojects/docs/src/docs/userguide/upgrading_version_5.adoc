...
You can opt into the previous behavior for selected repositories by adding the `artifact()` <<supported_metadata_sources.adoc#sec:repository-content-filtering,metadata source>>.
