...
====
include::sample[dir="userguide/tasks/taskConstructorArgs/groovyMap",files="build.gradle[tags=inject-task-constructor]"]
====
...
====
include::sample[dir="userguide/tasks/taskConstructorArgs/groovyTaskContainer",files="build.gradle[tags=task-container]"]
====
...
====
include::sample[dir="userguide/tasks/taskConstructorArgs/groovyMap",files="build.gradle[tags=groovy-map]"]
====
...
.Creating a task with constructor arguments using Kotlin DSL
====
include::sample[dir="userguide/tasks/taskConstructorArgs/kotlinDsl",files="build.gradle.kts[tags=kotlin-dsl]"]
====
