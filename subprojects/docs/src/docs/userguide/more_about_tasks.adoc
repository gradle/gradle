...
`@link:{javadocPath}/org/gradle/api/tasks/Input.html[Input]` — Expected property type: Any `Serializable` type::
A simple input value

`@link:{javadocPath}/org/gradle/api/tasks/InputFile.html[InputFile]` — Expected property type: `File`*::
A single input file (not directory)

`@link:{javadocPath}/org/gradle/api/tasks/InputDirectory.html[InputDirectory]` — Expected property type: `File`*::
A single input directory (not file)

`@link:{javadocPath}/org/gradle/api/tasks/InputFiles.html[InputFiles]` — Expected property type: `Iterable&lt;File&gt;`*::
An iterable of input files and directories

`@link:{javadocPath}/org/gradle/api/tasks/Classpath.html[Classpath]` — Expected property type: `Iterable&lt;File&gt;`*::
...
`@link:{javadocPath}/org/gradle/api/tasks/CompileClasspath.html[CompileClasspath]` — Expected property type: `Iterable&lt;File&gt;`*::
...
`link:{javadocPath}/org/gradle/api/tasks/OutputFile.html[@OutputFile]` — Expected property type: `File`†::
A single output file (not directory)

`link:{javadocPath}/org/gradle/api/tasks/OutputDirectory.html[@OutputDirectory]` — Expected property type: `File`†::
A single output directory (not file)

`link:{javadocPath}/org/gradle/api/tasks/OutputFiles.html[@OutputFiles]` — Expected property type: `Map&lt;String, File&gt;`‡ or `Iterable&lt;File&gt;`†::
...
`link:{javadocPath}/org/gradle/api/tasks/OutputDirectories.html[@OutputDirectories]` — Expected property type: `Map&lt;String, File&gt;`‡ or `Iterable&lt;File&gt;`†::
...
`link:{javadocPath}/org/gradle/api/tasks/Destroys.html[@Destroys]` — Expected property type: `File` or `Iterable&lt;File&gt;`†::
...
`link:{javadocPath}/org/gradle/api/tasks/LocalState.html[@LocalState]` — Expected property type: `File` or `Iterable&lt;File&gt;`†::
...
`link:{javadocPath}/org/gradle/api/tasks/Nested.html[@Nested]` — Expected property type: Any custom type::
...
`link:{javadocPath}/org/gradle/api/tasks/Console.html[@Console]` — Expected property type: Any type::
...
`link:{javadocPath}/org/gradle/api/tasks/Internal.html[@Internal]` — Expected property type: Any type::
...
[#skip-when-empty]
`link:{javadocPath}/org/gradle/api/tasks/SkipWhenEmpty.html[@SkipWhenEmpty]`::
