...
====
include::sample[dir="userguide/tasks/accessAsProperty",files="build.gradle[]"]
====
...
====
include::sample[dir="userguide/tasks/accessFromTaskContainer",files="build.gradle[]"]
====
...
====
include::sample[dir="userguide/tasks/accessUsingPath",files="build.gradle[]"]
