...
====
include::sample[dir="userguide/tutorial/taskOnlyIf",files="build.gradle[]"]
...
====
include::sample[dir="userguide/tutorial/stopExecutionException",files="build.gradle[]"]
...
.Enabling and disabling tasks
====
include::sample[dir="userguide/tutorial/disableTask",files="build.gradle[]"]
