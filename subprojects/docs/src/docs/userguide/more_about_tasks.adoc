...
.Defining tasks
====
include::sample[dir="userguide/tasks/defineAsExpression",files="build.gradle[]"]
====
...
====
include::sample[dir="userguide/tasks/defineUsingStringTaskNames",files="build.gradle[]"]
====
...
====
include::sample[dir="userguide/tasks/addToTaskContainer",files="build.gradle[]"]
====
