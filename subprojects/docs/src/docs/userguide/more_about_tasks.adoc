...
We have already seen how to define tasks using strings for task names <<tutorial_using_tasks.adoc#tutorial_using_tasks,this chapter>>. There are a few variations on this style, which you may need to use in certain situations.

.Defining tasks using strings for task names
====
include::sample[dir="userguide/tasks/defineUsingStringTaskNames/groovy",files="build.gradle[]"]
include::sample[dir="userguide/tasks/defineUsingStringTaskNames/kotlin",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/tasks/addToTaskContainer/groovy",files="build.gradle[]"]
include::sample[dir="userguide/tasks/addToTaskContainer/kotlin",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/tasks/defineAsGroovyExpression",files="build.gradle[]"]
include::sample[dir="userguide/tasks/defineAsKotlinDelegatedProperty",files="build.gradle.kts[]"]
...
====
include::sample[dir="userguide/tasks/accessAsGroovyProperty",files="build.gradle[]"]
include::sample[dir="userguide/tasks/accessAsKotlinDelegatedProperty",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/tasks/accessFromTaskContainer/groovy",files="build.gradle[]"]
include::sample[dir="userguide/tasks/accessFromTaskContainer/kotlin",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/tasks/accessUsingPath/groovy",files="build.gradle[]"]
include::sample[dir="userguide/tasks/accessUsingPath/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="userguide/tasks/configureUsingBlock/groovy",files="build.gradle[tags=declare-task]"]
include::sample[dir="userguide/tasks/configureUsingBlock/kotlin",files="build.gradle.kts[tags=declare-task]"]
====
...
====
include::sample[dir="userguide/tasks/configureUsingVar/groovy",files="build.gradle[tags=configure]"]
include::sample[dir="userguide/tasks/configureUsingVar/kotlin",files="build.gradle.kts[tags=configure]"]
====
...
====
include::sample[dir="userguide/tasks/configureUsingBlock/groovy",files="build.gradle[tags=configure]"]
include::sample[dir="userguide/tasks/configureUsingBlock/kotlin",files="build.gradle.kts[tags=configure]"]
====

This works for _any_ task. Task access is just a shortcut for the `tasks.getByName()` method. It is important to note that if you pass a block to the `getByName()` method, this block is applied to _configure_ the task, not when the task executes.
...
====
include::sample[dir="userguide/tasks/defineAndConfigure/groovy",files="build.gradle[tags=no-description]"]
include::sample[dir="userguide/tasks/defineAndConfigure/kotlin",files="build.gradle.kts[tags=no-description]"]
====
...
====
include::sample[dir="userguide/tasks/taskConstructorArgs/onTaskContainer/groovy",files="build.gradle[tags=inject-task-constructor]"]
include::sample[dir="userguide/tasks/taskConstructorArgs/onTaskContainer/kotlin",files="build.gradle.kts[tags=inject-task-constructor]"]
====
...
====
include::sample[dir="userguide/tasks/taskConstructorArgs/onTaskContainer/groovy",files="build.gradle[tags=on-task-container]"]
include::sample[dir="userguide/tasks/taskConstructorArgs/onTaskContainer/kotlin",files="build.gradle.kts[tags=on-task-container]"]
====
...
====
include::sample[dir="userguide/tasks/taskConstructorArgs/onProject/groovy",files="build.gradle[tags=on-project]"]
include::sample[dir="userguide/tasks/taskConstructorArgs/onProject/kotlin",files="build.gradle.kts[tags=on-project]"]
====
...
====
include::sample[dir="userguide/tasks/addDependencyUsingPath/groovy",files="build.gradle[]"]
include::sample[dir="userguide/tasks/addDependencyUsingPath/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="userguide/tasks/addDependencyUsingTask/groovy",files="build.gradle[]"]
include::sample[dir="userguide/tasks/addDependencyUsingTask/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="userguide/tasks/addDependencyUsingClosure/groovy",files="build.gradle[]"]
include::sample[dir="userguide/tasks/addDependencyUsingClosure/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="userguide/tasks/mustRunAfter/groovy",files="build.gradle[]"]
include::sample[dir="userguide/tasks/mustRunAfter/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="userguide/tasks/shouldRunAfter/groovy",files="build.gradle[]"]
include::sample[dir="userguide/tasks/shouldRunAfter/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="userguide/tasks/shouldRunAfterWithCycle/groovy",files="build.gradle[]"]
include::sample[dir="userguide/tasks/shouldRunAfterWithCycle/kotlin",files="build.gradle.kts[]"]
...
.Adding a description to a task
====
include::sample[dir="userguide/tasks/defineAndConfigure/groovy",files="build.gradle[tags=all]"]
include::sample[dir="userguide/tasks/defineAndConfigure/kotlin",files="build.gradle.kts[tags=all]"]
====
...
.Overwriting a task
====
include::sample[dir="userguide/tutorial/replaceTask/groovy",files="build.gradle[]"]
include::sample[dir="userguide/tutorial/replaceTask/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="userguide/tutorial/taskOnlyIf/groovy",files="build.gradle[]"]
include::sample[dir="userguide/tutorial/taskOnlyIf/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="userguide/tutorial/stopExecutionException/groovy",files="build.gradle[]"]
include::sample[dir="userguide/tutorial/stopExecutionException/kotlin",files="build.gradle.kts[]"]
...
.Enabling and disabling tasks
====
include::sample[dir="userguide/tutorial/disableTask/groovy",files="build.gradle[]"]
include::sample[dir="userguide/tutorial/disableTask/kotlin",files="build.gradle.kts[]"]
...
.Ad-hoc task
====
include::sample[dir="userguide/tasks/incrementalBuild/customTaskClass/groovy",files="build.gradle[tags=ad-hoc-task]"]
include::sample[dir="userguide/tasks/incrementalBuild/customTaskClass/kotlin",files="build.gradle.kts[tags=ad-hoc-task]"]
...
====
include::sample[dir="userguide/tasks/incrementalBuild/customTaskClass/groovy",files="build.gradle[tags=adhoc-destroyable-task]"]
include::sample[dir="userguide/tasks/incrementalBuild/customTaskClass/kotlin",files="build.gradle.kts[tags=adhoc-destroyable-task]"]
====
...
====
include::sample[dir="userguide/tasks/incrementalBuild/customTaskClass/groovy",files="build.gradle[tags=custom-class-runtime-api]"]
include::sample[dir="userguide/tasks/incrementalBuild/customTaskClass/kotlin",files="build.gradle.kts[tags=custom-class-runtime-api]"]
...
====
include::sample[dir="userguide/tasks/incrementalBuild/customTaskClass/groovy",files="build.gradle[tags=runtime-api-conf]"]
include::sample[dir="userguide/tasks/incrementalBuild/customTaskClass/kotlin",files="build.gradle.kts[tags=runtime-api-conf]"]
...
====
include::sample[dir="userguide/tasks/incrementalBuild/customTaskClass/groovy",files="build.gradle[tags=inferred-task-dep-via-outputs]"]
include::sample[dir="userguide/tasks/incrementalBuild/customTaskClass/kotlin",files="build.gradle.kts[tags=inferred-task-dep-via-outputs]"]
...
====
include::sample[dir="userguide/tasks/incrementalBuild/customTaskClass/groovy",files="build.gradle[tags=inferred-task-dep-via-task]"]
include::sample[dir="userguide/tasks/incrementalBuild/customTaskClass/kotlin",files="build.gradle.kts[tags=inferred-task-dep-via-task]"]
...
====
include::sample[dir="userguide/tasks/incrementalBuild/incrementalBuildAdvanced/groovy",files="build.gradle[tags=custom-task-class]"]
include::sample[dir="userguide/tasks/incrementalBuild/incrementalBuildAdvanced/kotlin",files="build.gradle.kts[tags=custom-task-class]"]
...
====
include::sample[dir="userguide/tasks/incrementalBuild/incrementalBuildAdvanced/groovy",files="build.gradle[tags=task-arg-method]"]
include::sample[dir="userguide/tasks/incrementalBuild/incrementalBuildAdvanced/kotlin",files="build.gradle.kts[tags=task-arg-method]"]
...
====
include::sample[dir="userguide/tasks/incrementalBuild/incrementalBuildAdvanced/groovy",files="build.gradle[tags=failed-inferred-task-dep]"]
include::sample[dir="userguide/tasks/incrementalBuild/incrementalBuildAdvanced/kotlin",files="build.gradle.kts[tags=failed-inferred-task-dep]"]
...
====
include::sample[dir="userguide/tasks/incrementalBuild/incrementalBuildAdvanced/groovy",files="build.gradle[tags=inferred-task-dep]"]
include::sample[dir="userguide/tasks/incrementalBuild/incrementalBuildAdvanced/kotlin",files="build.gradle.kts[tags=inferred-task-dep]"]
...
.Setting up an inferred task dependency with filesFor()
====
include::sample[dir="userguide/tasks/incrementalBuild/incrementalBuildAdvanced/groovy",files="build.gradle[tags=inferred-task-dep-with-files]"]
include::sample[dir="userguide/tasks/incrementalBuild/incrementalBuildAdvanced/kotlin",files="build.gradle.kts[tags=inferred-task-dep-with-files]"]
...
====
include::sample[dir="userguide/tasks/incrementalBuild/incrementalBuildAdvanced/groovy",files="build.gradle[tags=inferred-task-dep-with-builtby]"]
include::sample[dir="userguide/tasks/incrementalBuild/incrementalBuildAdvanced/kotlin",files="build.gradle.kts[tags=inferred-task-dep-with-builtby]"]
...
====
include::sample[dir="userguide/tasks/incrementalBuild/incrementalBuildAdvanced/groovy",files="build.gradle[tags=up-to-date-when]"]
include::sample[dir="userguide/tasks/incrementalBuild/incrementalBuildAdvanced/kotlin",files="build.gradle.kts[tags=up-to-date-when]"]
...
.Task rule
====
include::sample[dir="userguide/tasks/addRules/groovy",files="build.gradle[tags=task-rule]"]
include::sample[dir="userguide/tasks/addRules/kotlin",files="build.gradle.kts[tags=task-rule]"]
...
====
include::sample[dir="userguide/tasks/addRules/groovy",files="build.gradle[tags=all]"]
include::sample[dir="userguide/tasks/addRules/kotlin",files="build.gradle.kts[tags=all]"]
...
====
include::sample[dir="userguide/tasks/finalizers/groovy",files="build.gradle[]"]
include::sample[dir="userguide/tasks/finalizers/kotlin",files="build.gradle.kts[]"]
...
====
include::sample[dir="userguide/tasks/finalizersWithFailure/groovy",files="build.gradle[]"]
include::sample[dir="userguide/tasks/finalizersWithFailure/kotlin",files="build.gradle.kts[]"]
