...
* Task has no actions and some dependencies, and any of the dependencies are executed. See also <<more_about_tasks.adoc#sec:lifecycle_tasks,Lifecycle Tasks>>.

`UP-TO-DATE`::
Task's outputs did not change.
+
* Task has outputs and inputs and they have not changed. See <<more_about_tasks.adoc#sec:up_to_date_checks,Incremental Builds>>.
* Task has actions, but the task tells Gradle it did not change its outputs.
* Task has no actions and some dependencies, but all of the dependencies are up-to-date, skipped or from cache. See also <<more_about_tasks.adoc#sec:lifecycle_tasks,Lifecycle Tasks>>.
...
* Task has an `onlyIf` predicate return false. See <<more_about_tasks.adoc#sec:using_a_predicate,Using a predicate>>.

`NO-SOURCE`::
Task did not need to execute its actions.
+
* Task has inputs and outputs, but <<more_about_tasks.adoc#skip-when-empty,no sources>>. For example, source files are `.java` files for link:{groovy-dsl-path}/org.gradle.api.tasks.compile.JavaCompile.html[JavaCompile].
...
.build.gradle
----
include::{samples-path}/userguide/tasks/defineAsExpression/build.gradle[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/defineUsingStringTaskNames/build.gradle[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/addToTaskContainer/build.gradle[]
----

Here we add tasks to the `tasks` collection. Have a look at link:{javadoc-path}/org/gradle/api/tasks/TaskContainer.html[TaskContainer] for more variations of the `create()` method.
...
.build.gradle
----
include::{samples-path}/userguide/tasks/accessAsProperty/build.gradle[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/accessFromTaskContainer/build.gradle[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/accessUsingPath/build.gradle[]
----

.Output of **`gradle -q hello`**
----
> gradle -q hello
include::{samples-path}/userguide/tasks/accessUsingPath/accessUsingPath.out[]
----

Have a look at link:{javadoc-path}/org/gradle/api/tasks/TaskContainer.html[TaskContainer] for more options for locating tasks.
...
.build.gradle
----
include::{samples-path}/userguide/tasks/configureUsingClosure/build.gradle[tag=declare-task]
----

This creates a copy task with no default behavior. The task can be configured using its API (see link:{groovy-dsl-path}/org.gradle.api.tasks.Copy.html[Copy]). The following examples show several different ways to achieve the same configuration.
...
.build.gradle
----
include::{samples-path}/userguide/tasks/configureUsingVar/build.gradle[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/configureUsingClosure/build.gradle[tag=all]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/defineAndConfigure/build.gradle[tag=no-description]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/taskConstructorArgs/groovyMap/build.gradle[tag=inject-task-constructor]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/taskConstructorArgs/groovyTaskContainer/build.gradle[tag=task-container]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/taskConstructorArgs/groovyMap/build.gradle[tag=groovy-map]
----
...
.build.gradle.kts
----
include::{samples-path}/userguide/tasks/taskConstructorArgs/kotlinDsl/build.gradle.kts[tag=kotlin-dsl]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/addDependencyUsingPath/build.gradle[]
----

.Output of **`gradle -q taskX`**
----
> gradle -q taskX
include::{samples-path}/userguide/tasks/addDependencyUsingPath/addDependencyUsingPath.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/addDependencyUsingTask/build.gradle[]
----

.Output of **`gradle -q taskX`**
----
> gradle -q taskX
include::{samples-path}/userguide/tasks/addDependencyUsingTask/addDependencyUsingTask.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/addDependencyUsingClosure/build.gradle[]
----

.Output of **`gradle -q taskX`**
----
> gradle -q taskX
include::{samples-path}/userguide/tasks/addDependencyUsingClosure/addDependencyUsingClosure.out[]
----

For more information about task dependencies, see the link:{groovy-dsl-path}/org.gradle.api.Task.html[Task] API.
...
.build.gradle
----
include::{samples-path}/userguide/tasks/mustRunAfter/build.gradle[]
----

.Output of **`gradle -q taskY taskX`**
----
> gradle -q taskY taskX
include::{samples-path}/userguide/tasks/mustRunAfter/mustRunAfter.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/shouldRunAfter/build.gradle[]
----

.Output of **`gradle -q taskY taskX`**
----
> gradle -q taskY taskX
include::{samples-path}/userguide/tasks/shouldRunAfter/shouldRunAfter.out[]
----
...
----
> gradle -q taskY
include::{samples-path}/userguide/tasks/mustRunAfter/mustRunAfterSingleTask.out[]
----

To specify a “must run after” or “should run after” ordering between 2 tasks, you use the link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task:mustRunAfter(java.lang.Object++[]++)[Task.mustRunAfter(java.lang.Object++...++)] and link:{javadoc-path}/org/gradle/api/Task.html#shouldRunAfter-java.lang.Object++...++-[Task.shouldRunAfter(java.lang.Object++...++)] methods.
These methods accept a task instance, a task name or any other input accepted by link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task:dependsOn(java.lang.Object++[]++)[Task.dependsOn(java.lang.Object++...++)].
...
.build.gradle
----
include::{samples-path}/userguide/tasks/shouldRunAfterWithCycle/build.gradle[]
----

.Output of **`gradle -q taskX`**
----
> gradle -q taskX
include::{samples-path}/userguide/tasks/shouldRunAfterWithCycle/shouldRunAfterWithCycle.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/defineAndConfigure/build.gradle[tag=all]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/replaceTask/build.gradle[]
----

.Output of **`gradle -q copy`**
----
> gradle -q copy
include::{samples-path}/userguide/tutorial/replaceTask/replaceTask.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/taskOnlyIf/build.gradle[]
----

.Output of **`gradle hello -PskipHello`**
----
> gradle hello -PskipHello
include::{samples-path}/userguide/tutorial/taskOnlyIf/taskOnlyIf.out[]
----
...
If the logic for skipping a task can't be expressed with a predicate, you can use the link:{javadoc-path}/org/gradle/api/tasks/StopExecutionException.html[StopExecutionException]. If this exception is thrown by an action, the further execution of this action as well as the execution of any following action of this task is skipped. The build continues with executing the next task.
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/stopExecutionException/build.gradle[]
----

.Output of **`gradle -q myTask`**
----
> gradle -q myTask
include::{samples-path}/userguide/tutorial/stopExecutionException/stopExecutionException.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tutorial/disableTask/build.gradle[]
----

.Output of **`gradle disableMe`**
----
> gradle disableMe
include::{samples-path}/userguide/tutorial/disableTask/disableTask.out[]
----
...
* Filesystem types
+
These consist of the standard `File` class but also derivatives of Gradle’s link:{javadoc-path}/org/gradle/api/file/FileCollection.html[FileCollection] type and anything else that can be passed to either the link:{groovy-dsl-path}/org.gradle.api.Project.html#org.gradle.api.Project:file(java.lang.Object)[Project.file(java.lang.Object)] method - for single file/directory properties - or the link:{groovy-dsl-path}/org.gradle.api.Project.html#org.gradle.api.Project:files(java.lang.Object++[]++)[Project.files(java.lang.Object++...++)], link:{javadoc-path}/org/gradle/api/file/ProjectLayout.html#files-java.lang.Object++...++-[ProjectLayout.files(java.lang.Object...)], and link:{javadoc-path}/org/gradle/api/file/ProjectLayout.html#configurableFiles-java.lang.Object++...++-[ProjectLayout.configurableFiles(java.lang.Object...)] methods.
...
----
include::{samples-path}/userguide/tasks/incrementalBuild/customTaskClass/buildSrc/src/main/java/org/example/ProcessTemplates.java[tag=custom-task-class]
----

[source.multi-language-sample,java]
.buildSrc/src/main/java/org/example/TemplateData.java
----
include::{samples-path}/userguide/tasks/incrementalBuild/customTaskClass/buildSrc/src/main/java/org/example/TemplateData.java[]
----

.Output of `gradle processTemplates`
----
> gradle processTemplates
include::{samples-path}/userguide/tasks/incrementalBuild/customTaskClass/customTaskClassWithInputOutputAnnotations.out[]
----

.Output of `gradle processTemplates` (run again)
----
> gradle processTemplates
include::{samples-path}/userguide/tasks/incrementalBuild/customTaskClass/customTaskClassWithInputOutputAnnotationsUpToDate.out[]
----
...
`@link:{javadoc-path}/org/gradle/api/tasks/Input.html[Input]` — Expected property type: Any `Serializable` type::
A simple input value

`@link:{javadoc-path}/org/gradle/api/tasks/InputFile.html[InputFile]` — Expected property type: `File`*::
A single input file (not directory)

`@link:{javadoc-path}/org/gradle/api/tasks/InputDirectory.html[InputDirectory]` — Expected property type: `File`*::
A single input directory (not file)

`@link:{javadoc-path}/org/gradle/api/tasks/InputFiles.html[InputFiles]` — Expected property type: `Iterable&lt;File&gt;`*::
An iterable of input files and directories

`@link:{javadoc-path}/org/gradle/api/tasks/Classpath.html[Classpath]` — Expected property type: `Iterable&lt;File&gt;`*::
An iterable of input files and directories that represent a Java classpath. This allows the task to ignore irrelevant changes to the property, such as different names for the same files. It is similar to annotating the property `@PathSensitive(RELATIVE)` but it will ignore the names of JAR files directly added to the classpath, and it will consider changes in the order of the files as a change in the classpath. Gradle will inspect the contents of jar files on the classpath and ignore changes that do not affect the semantics of the classpath (such as file dates and entry order). See also <<more_about_tasks.adoc#sec:task_input_using_classpath_annotations,Using the classpath annotations>>.
+
...
`@link:{javadoc-path}/org/gradle/api/tasks/CompileClasspath.html[CompileClasspath]` — Expected property type: `Iterable&lt;File&gt;`*::
An iterable of input files and directories that represent a Java compile classpath. This allows the task to ignore irrelevant changes that do not affect the API of the classes in classpath. See also <<more_about_tasks.adoc#sec:task_input_using_classpath_annotations,Using the classpath annotations>>.
+
...
`link:{javadoc-path}/org/gradle/api/tasks/OutputFile.html[@OutputFile]` — Expected property type: `File`†::
A single output file (not directory)

`link:{javadoc-path}/org/gradle/api/tasks/OutputDirectory.html[@OutputDirectory]` — Expected property type: `File`†::
A single output directory (not file)

`link:{javadoc-path}/org/gradle/api/tasks/OutputFiles.html[@OutputFiles]` — Expected property type: `Map&lt;String, File&gt;`‡ or `Iterable&lt;File&gt;`†::
...
`link:{javadoc-path}/org/gradle/api/tasks/OutputDirectories.html[@OutputDirectories]` — Expected property type: `Map&lt;String, File&gt;`‡ or `Iterable&lt;File&gt;`†::
...
`link:{javadoc-path}/org/gradle/api/tasks/Destroys.html[@Destroys]` — Expected property type: `File` or `Iterable&lt;File&gt;`†::
...
`link:{javadoc-path}/org/gradle/api/tasks/LocalState.html[@LocalState]` — Expected property type: `File` or `Iterable&lt;File&gt;`†::
...
`link:{javadoc-path}/org/gradle/api/tasks/Nested.html[@Nested]` — Expected property type: Any custom type::
...
`link:{javadoc-path}/org/gradle/api/tasks/Console.html[@Console]` — Expected property type: Any type::
...
`link:{javadoc-path}/org/gradle/api/tasks/Internal.html[@Internal]` — Expected property type: Any type::
...
[horizontal]
†::
In fact, `File` can be any type accepted by link:{groovy-dsl-path}/org.gradle.api.Project.html#org.gradle.api.Project:file(java.lang.Object)[Project.file(java.lang.Object)] and `Iterable&lt;File&gt;` can be any type accepted by link:{groovy-dsl-path}/org.gradle.api.Project.html#org.gradle.api.Project:files(java.lang.Object++[]++)[Project.files(java.lang.Object...)], link:{javadoc-path}/org/gradle/api/file/ProjectLayout.html#files-java.lang.Object++...++-[ProjectLayout.files(java.lang.Object++...++)], or link:{javadoc-path}/org/gradle/api/file/ProjectLayout.html#configurableFiles-java.lang.Object++...++-[ProjectLayout.configurableFiles(java.lang.Object++...++)].
...
‡::
Similar to the above, `File` can be any type accepted by link:{groovy-dsl-path}/org.gradle.api.Project.html#org.gradle.api.Project:file(java.lang.Object)[Project.file(java.lang.Object)]. The `Map` itself can be wrapped in ``Callable``s, such as closures.
====

===== Additional annotations used to further qualifying property type annotations

[#skip-when-empty]
`link:{javadoc-path}/org/gradle/api/tasks/SkipWhenEmpty.html[@SkipWhenEmpty]`::
...
`link:{javadoc-path}/org/gradle/api/tasks/Optional.html[@Optional]`::
Used with any of the property type annotations listed in the link:{javadoc-path}/org/gradle/api/tasks/Optional.html[Optional] API documentation. This annotation disables validation checks on the corresponding property. See <<more_about_tasks.adoc#sec:task_input_output_validation,the section on validation>> for more details.

`link:{javadoc-path}/org/gradle/api/tasks/PathSensitive.html[@PathSensitive]`::
...
As opposed to input properties annotated with `@link:{javadoc-path}/org/gradle/api/tasks/InputFiles.html[InputFiles]`, for classpath properties the order of the entries in the file collection matter.
...
Runtime classpaths are marked with `@link:{javadoc-path}/org/gradle/api/tasks/Classpath.html[Classpath]`, and they offer further customization via <<more_about_tasks.adoc#sec:configure_input_normalization,classpath normalization>>.

Input properties annotated with `@link:{javadoc-path}/org/gradle/api/tasks/CompileClasspath.html[CompileClasspath]` are considered Java compile classpaths.
...
When analyzing `@link:{javadoc-path}/org/gradle/api/tasks/Nested.html[Nested]` task properties for declared input and output sub-properties Gradle uses the type of the actual value.
Hence it can discover all sub-properties declared by a runtime sub-type.

When adding `@link:{javadoc-path}/org/gradle/api/tasks/Nested.html[Nested]` to a `@link:{javadoc-path}/org/gradle/api/provider/Provider.html[Provider]`, the value of the `Provider` is treated as a nested input.

When adding `@link:{javadoc-path}/org/gradle/api/tasks/Nested.html[Nested]` to an iterable, each element is treated as a separate nested input.
...
If an element of the iterable implements `link:{javadoc-path}/org/gradle/api/Named.html[Named]`, then the name is used as property name.
The ordering of the elements in the iterable is crucial for for reliable up-to-date checks and caching if not all of the elements implement `link:{javadoc-path}/org/gradle/api/Named.html[Named]`.
Multiple elements which have the same name are not allowed.

When adding `@link:{javadoc-path}/org/gradle/api/tasks/Nested.html[Nested]` to a map, then for each value a nested input is added, using the key as name.
...
By this it is also possible to add user provided code as an input, e.g. by annotating an `@link:{javadoc-path}/org/gradle/api/Action.html[Action]` property with `@link:{javadoc-path}/org/gradle/api/tasks/Nested.html[Nested]`.
...
Using nested inputs allows richer modeling and extensibility for tasks, as e.g. shown by link:{groovy-dsl-path}/org.gradle.api.tasks.testing.Test.html#org.gradle.api.tasks.testing.Test:jvmArgumentProviders[Test.getJvmArgumentProviders()].
...
For this to work, `link:{groovy-dsl-path}/org.gradle.testing.jacoco.plugins.JacocoTaskExtension.html[JacocoTaskExtension]` needs to have the correct input and output annotations.

The approach works for Test JVM arguments, since `link:{groovy-dsl-path}/org.gradle.api.tasks.testing.Test.html#org.gradle.api.tasks.testing.Test:jvmArgumentProviders[Test.getJvmArgumentProviders()]` is an `Iterable` annotated with `@link:{javadoc-path}/org/gradle/api/tasks/Nested.html[Nested]`.

There are other task types where this kind of nested inputs are available:

* link:{groovy-dsl-path}/org.gradle.api.tasks.JavaExec.html#org.gradle.api.tasks.JavaExec:argumentProviders[JavaExec.getArgumentProviders()] - model e.g. custom tools
* link:{groovy-dsl-path}/org.gradle.api.tasks.JavaExec.html#org.gradle.api.tasks.JavaExec:jvmArgumentProviders[JavaExec.getJvmArgumentProviders()] - used for Jacoco Java agent
* link:{groovy-dsl-path}/org.gradle.api.tasks.compile.CompileOptions.html#org.gradle.api.tasks.compile.CompileOptions:compilerArgumentProviders[CompileOptions.getCompilerArgumentProviders()] - model e.g annotation processors
* link:{groovy-dsl-path}/org.gradle.api.tasks.Exec.html#org.gradle.api.tasks.Exec:argumentProviders[Exec.getArgumentProviders()] - model e.g custom tools
...
* link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task:inputs[Task.getInputs()] of type link:{javadoc-path}/org/gradle/api/tasks/TaskInputs.html[TaskInputs]
* link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task:outputs[Task.getOutputs()] of type link:{javadoc-path}/org/gradle/api/tasks/TaskOutputs.html[TaskOutputs]
* link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task:destroyables[Task.getDestroyables()] of type link:{javadoc-path}/org/gradle/api/tasks/TaskDestroyables.html[TaskDestroyables]
...
.build.gradle
----
include::{samples-path}/userguide/tasks/incrementalBuild/customTaskClass/build.gradle[tag=ad-hoc-task]
----

.Output of **`gradle processTemplatesAdHoc`**
----
> gradle processTemplatesAdHoc
include::{samples-path}/userguide/tasks/incrementalBuild/customTaskClass/incrementalAdHocTask.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/incrementalBuild/customTaskClass/build.gradle[tag=adhoc-destroyable-task]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/incrementalBuild/customTaskClass/build.gradle[tag=custom-class-runtime-api]
----

.Output of`gradle processTemplatesRuntime`
----
> gradle processTemplatesRuntime
include::{samples-path}/userguide/tasks/incrementalBuild/customTaskClass/runtimeIncrementalApi.out[]
----

.Output of`gradle processTemplatesRuntime` (run again)
----
> gradle processTemplatesRuntime
include::{samples-path}/userguide/tasks/incrementalBuild/customTaskClass/runtimeIncrementalApiUpToDate.out[]
----
...
The runtime API methods only allow you to declare your inputs and outputs in themselves. However, the file-oriented ones return a builder - of type link:{javadoc-path}/org/gradle/api/tasks/TaskInputFilePropertyBuilder.html[TaskInputFilePropertyBuilder] - that lets you provide additional information about those inputs and outputs.
...
.build.gradle
----
include::{samples-path}/userguide/tasks/incrementalBuild/customTaskClass/build.gradle[tag=runtime-api-conf]
----

.Output of **`gradle clean processTemplatesRuntimeConf`**
----
> gradle clean processTemplatesRuntimeConf
include::{samples-path}/userguide/tasks/incrementalBuild/customTaskClass/runtimeIncrementalApiConfiguration.out[]
----

The `TaskInputs.files()` method returns a builder that has a `skipWhenEmpty()` method. Invoking this method is equivalent to annotating to the property with <<more_about_tasks.adoc#skip-when-empty,`@SkipWhenEmpty`>>.
...
.build.gradle
----
include::{samples-path}/userguide/tasks/incrementalBuild/customTaskClass/build.gradle[tag=inferred-task-dep-via-outputs]
----

.Output of **`gradle clean packageFiles`**
----
> gradle clean packageFiles
include::{samples-path}/userguide/tasks/incrementalBuild/customTaskClass/inferredTaskDep.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/incrementalBuild/customTaskClass/build.gradle[tag=inferred-task-dep-via-task]
----

.Output of **`gradle clean packageFiles2`**
----
> gradle clean packageFiles2
include::{samples-path}/userguide/tasks/incrementalBuild/customTaskClass/inferredTaskDep2.out[]
----
...
Note that if a task has an output directory specified, any files added to that directory since the last time it was executed are ignored and will NOT cause the task to be out of date. This is so unrelated tasks may share an output directory without interfering with each other. If this is not the behaviour you want for some reason, consider using link:{javadoc-path}/org/gradle/api/tasks/TaskOutputs.html#upToDateWhen-groovy.lang.Closure-[TaskOutputs.upToDateWhen(groovy.lang.Closure)]
...
.build.gradle
----
include::{samples-path}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/buildSrc/src/main/java/org/example/ProcessTemplates.java[tag=task-arg-method]
----

[source.multi-language-sample,groovy]
.build.gradle
----
include::{samples-path}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/build.gradle[tag=custom-task-class]
----

.Output of`gradle processTemplates`
----
> gradle processTemplates
include::{samples-path}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildCustomMethods.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/build.gradle[tag=task-arg-method]
----

.Output of`gradle processTemplates2`
----
> gradle processTemplates2
include::{samples-path}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildCustomMethodsWithTaskArg.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/build.gradle[tag=failed-inferred-task-dep]
----

.Output of **`gradle clean badInstrumentClasses`**
----
> gradle clean badInstrumentClasses
include::{samples-path}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildBadInputFilesConfig.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/build.gradle[tag=inferred-task-dep]
----

.Output of **`gradle clean instrumentClasses`**
----
> gradle clean instrumentClasses
include::{samples-path}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildInputFilesConfig.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/build.gradle[tag=inferred-task-dep-with-files]
----

.Output of **`gradle clean instrumentClasses2`**
----
> gradle clean instrumentClasses2
include::{samples-path}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildInputFilesConfigUsingTask.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/build.gradle[tag=inferred-task-dep-with-builtby]
----

.Output of **`gradle clean instrumentClassesBuiltBy`**
----
> gradle clean instrumentClassesBuiltBy
include::{samples-path}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/inferredTaskDependencyWithBuiltBy.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/build.gradle[tag=up-to-date-when]
----

.Output of `gradle clean alwaysInstrumentClasses`
----
> gradle clean alwaysInstrumentClasses
include::{samples-path}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildUpToDateWhen.out[]
----

.Output of `gradle alwaysInstrumentClasses`
----
> gradle alwaysInstrumentClasses
include::{samples-path}/userguide/tasks/incrementalBuild/incrementalBuildAdvanced/incrementalBuildUpToDateWhenAgain.out[]
----
...
All inputs annotated with `@link:{javadoc-path}/org/gradle/api/tasks/Classpath.html[Classpath]` are considered to be runtime classpaths.
...
In order to benefit from incremental builds again, you are able tell Gradle to ignore this file on the runtime classpath at the project level by using link:{groovy-dsl-path}/org.gradle.api.Project.html#org.gradle.api.Project:normalization(org.gradle.api.Action)[Project.normalization(org.gradle.api.Action)]:
...
.build.gradle
----
include::{samples-path}/userguide/tasks/inputNormalization/build.gradle[tag=ignore-build-info-properties]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/addRules/build.gradle[tag=task-rule]
----

.Output of **`gradle -q pingServer1`**
----
> gradle -q pingServer1
include::{samples-path}/userguide/tasks/addRules/taskRule.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/addRules/build.gradle[tag=all]
----

.Output of **`gradle -q groupPing`**
----
> gradle -q groupPing
include::{samples-path}/userguide/tasks/addRules/taskRuleDependsOn.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/finalizers/build.gradle[]
----

.Output of **`gradle -q taskX`**
----
> gradle -q taskX
include::{samples-path}/userguide/tasks/finalizers/taskFinalizers.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/tasks/finalizersWithFailure/build.gradle[]
----

.Output of **`gradle -q taskX`**
----
> gradle -q taskX
include::{samples-path}/userguide/tasks/finalizersWithFailure/taskFinalizersWithFailure.out[]
----
...
To specify a finalizer task you use the link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task:finalizedBy(java.lang.Object++[]++)[Task.finalizedBy(java.lang.Object...)] method. This method accepts a task instance, a task name, or any other input accepted by link:{groovy-dsl-path}/org.gradle.api.Task.html#org.gradle.api.Task:dependsOn(java.lang.Object++[]++)[Task.dependsOn(java.lang.Object...)].
