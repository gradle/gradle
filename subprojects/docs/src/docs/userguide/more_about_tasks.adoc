...
*::
In fact, `File` can be any type accepted by api:org.gradle.api.Project#file(java.lang.Object)[] and `Iterable&lt;File&gt;` can be any type accepted by api:org.gradle.api.Project#files(java.lang.Object...)[], api:org.gradle.api.file.ProjectLayout#files(java.lang.Object...)[], or api:org.gradle.api.file.ProjectLayout#configurableFiles(java.lang.Object...)[].
...
You can find out more about this feature in <<sec:continuous_build>>.
...
++++
<sample id="incrementalBuildInputFilesConfigUsingTask" dir="userguide/tasks/incrementalBuild/incrementalBuildAdvanced" title="Setting up an inferred task dependency with filesFor()">
