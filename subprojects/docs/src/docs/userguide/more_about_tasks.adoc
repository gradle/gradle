...
====
include::sample[dir="userguide/tasks/addDependencyUsingPath",files="build.gradle[]"]
...
====
include::sample[dir="userguide/tasks/addDependencyUsingTask",files="build.gradle[]"]
...
====
include::sample[dir="userguide/tasks/addDependencyUsingClosure",files="build.gradle[]"]
