...
====
include::sample[dir="userguide/tasks/configureUsingClosure",files="build.gradle[tags=declare-task]"]
====
...
====
include::sample[dir="userguide/tasks/configureUsingVar",files="build.gradle[]"]
====
...
====
include::sample[dir="userguide/tasks/configureUsingClosure",files="build.gradle[]"]
====
...
====
include::sample[dir="userguide/tasks/defineAndConfigure",files="build.gradle[tags=no-description]"]
====
...
.Adding a description to a task
====
include::sample[dir="userguide/tasks/defineAndConfigure",files="build.gradle[tags=all]"]
====
