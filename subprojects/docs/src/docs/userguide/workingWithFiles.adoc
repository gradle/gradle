...
In both cases, you specify which files and directories to delete in a way supported by the api:org.gradle.api.Project#files(java.lang.Object...)[], api:org.gradle.api.file.ProjectLayout#filesFor(java.lang.Object...)[], and api:org.gradle.api.file.ProjectLayout#mutableFilesFor(java.lang.Object...)[] methods.
...
The recommended way to specify a collection of files is to use the api:org.gradle.api.file.ProjectLayout#filesFor(java.lang.Object...)[] method, which returns a `FileCollection` instance.
...
The key to lazy creation is passing a closure to the `filesFor()` method. Your closure simply needs to return a value of a type accepted by `filesFor()`, such as `List<File>`, `String`, `FileCollection`, etc.
...
You can set the value of this property using any of the types supported by the <<sec:file_collections,filesFor()>> method, as mentioned in the api docs.
...
Alternatively, you can remove all doubt by explicitly using api:org.gradle.api.file.ProjectLayout#filesFor(java.lang.Object...)[] in your build.
...
In fact, `from()` accepts all the same arguments as api:org.gradle.api.Project#files(java.lang.Object...)[], api:org.gradle.api.file.ProjectLayout#filesFor(java.lang.Object...)[], and api:org.gradle.api.file.ProjectLayout#mutableFilesFor(java.lang.Object...)[], so see those methods for a more detailed list of acceptable types.
