...
*This is a feature of this specific task*! That means it will not happen for just any task that has a `FileCollection` or `FileTree` property. If you want to know whether implicit conversion happens in a particular situation, read the documentation. Alternatively, simply use api:org.gradle.api.Project#files(Object...)[] explicitly.
