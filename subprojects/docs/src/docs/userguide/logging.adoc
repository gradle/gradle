...
include::sample[dir="userguide/tutorial/logging",files="build.gradle[tags=use-slf4j]"]
...
====
include::sample[dir="userguide/tutorial/logging",files="build.gradle[tags=capture-stdout]"]

include::sample[dir="userguide/tutorial/loggingKts",files="build.gradle.kts[tags=capture-stdout]"]
====
...
====
include::sample[dir="userguide/tutorial/logging",files="build.gradle[tags=task-capture-stdout]"]

include::sample[dir="userguide/tutorial/loggingKts",files="build.gradle.kts[tags=task-capture-stdout]"]
====
...
====
include::sample[dir="userguide/initScripts/customLogger",files="init.gradle[]"]

include::sample[dir="userguide/initScripts/customLoggerKts",files="customLogger.init.gradle.kts[]"]
====
...
include::{samplesPath}/userguide/initScripts/customLoggerKts/customLoggerKts.out[]
----
