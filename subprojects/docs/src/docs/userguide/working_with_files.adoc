...
.build.gradle
----
include::{samplesPath}/userguide/files/sampleJavaProject/build.gradle[tag=link-task-properties]
----
...
.build.gradle
----
include::{samplesPath}/userguide/files/sampleJavaProject/build.gradle[tag=nested-specs]
----
