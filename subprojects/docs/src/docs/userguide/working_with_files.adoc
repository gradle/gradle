...
.build.gradle
----
include::{samplesPath}/userguide/files/fileTrees/build.gradle[tag=define]
----
...
.build.gradle
----
include::{samplesPath}/userguide/files/fileTrees/build.gradle[tag=use]
----
...
.build.gradle
----
include::{samplesPath}/userguide/files/fileTrees/build.gradle[tag=archive-trees]
----
