...
.build.gradle
----
include::{samplesPath}/userguide/files/inputFiles/build.gradle[tag=set-input-files]
----
...
.build.gradle
----
include::{samplesPath}/userguide/files/inputFiles/build.gradle[tag=add-input-files]
----
