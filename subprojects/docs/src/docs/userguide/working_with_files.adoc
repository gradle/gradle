...
====
include::sample[dir="userguide/files/misc/groovy",files="build.gradle[tags=using-root-dir-property]"]
include::sample[dir="userguide/files/misc/kotlin",files="build.gradle.kts[tags=using-root-dir-property]"]
====
...
.build.gradle
----
include::{samplesPath}/userguide/files/fileCollections/build.gradle[tag=simple-params]
----
...
.build.gradle
----
include::{samplesPath}/userguide/files/fileCollections/build.gradle[tag=closure]
----
...
.build.gradle
----
include::{samplesPath}/userguide/files/fileCollections/build.gradle[tag=usage]
----
...
.build.gradle
----
include::{samplesPath}/userguide/files/fileCollections/build.gradle[tag=filtering-file-collections]
----
