...
.build.gradle
----
include::{samplesPath}/userguide/files/misc/build.gradle[tag=mkdir-example]
----
...
.build.gradle
----
include::{samplesPath}/userguide/files/misc/build.gradle[tag=move-example]
----
...
.build.gradle
----
include::{samplesPath}/userguide/files/misc/build.gradle[tag=delete-example]
----
...
.build.gradle
----
include::{samplesPath}/userguide/files/misc/build.gradle[tag=delete-with-filter-example]
----
...
.build.gradle
----
include::{samplesPath}/userguide/files/misc/project2/build.gradle[tag=using-root-dir-property]
----
