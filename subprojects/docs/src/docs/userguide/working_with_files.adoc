...
.build.gradle
----
include::{samplesPath}/userguide/files/archiveNaming/build.gradle[tag=zip-task]
----
...
.build.gradle
----
include::{samplesPath}/userguide/files/archiveNaming/build.gradle[tag=zip-task-with-custom-base-name]
----
