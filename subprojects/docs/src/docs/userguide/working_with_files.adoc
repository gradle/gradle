...
====
include::sample[dir="userguide/files/copy/groovy",files="build.gradle[tags=copy-single-file-example]"]
include::sample[dir="userguide/files/copy/kotlin",files="build.gradle.kts[tags=copy-single-file-example]"]
====
...
====
include::sample[dir="userguide/files/copy/groovy",files="build.gradle[tags=copy-single-file-example-without-file-method]"]
include::sample[dir="userguide/files/copy/kotlin",files="build.gradle.kts[tags=copy-single-file-example-without-file-method]"]
====
...
====
include::sample[dir="userguide/files/copy/groovy",files="build.gradle[tags=copy-single-file-example-with-task-properties]"]
include::sample[dir="userguide/files/copy/kotlin",files="build.gradle.kts[tags=copy-single-file-example-with-task-properties]"]
====
...
====
include::sample[dir="userguide/files/copy/groovy",files="build.gradle[tags=copy-multiple-files-example]"]
include::sample[dir="userguide/files/copy/kotlin",files="build.gradle.kts[tags=copy-multiple-files-example]"]
====
...
.Using a flat filter
====
include::sample[dir="userguide/files/copy/groovy",files="build.gradle[tags=copy-multiple-files-with-flat-filter-example]"]
include::sample[dir="userguide/files/copy/kotlin",files="build.gradle.kts[tags=copy-multiple-files-with-flat-filter-example]"]
====
...
.Using a deep filter
====
include::sample[dir="userguide/files/copy/groovy",files="build.gradle[tags=copy-multiple-files-with-deep-filter-example]"]
include::sample[dir="userguide/files/copy/kotlin",files="build.gradle.kts[tags=copy-multiple-files-with-deep-filter-example]"]
====
...
====
include::sample[dir="userguide/files/copy/groovy",files="build.gradle[tags=copy-directory-example]"]
include::sample[dir="userguide/files/copy/kotlin",files="build.gradle.kts[tags=copy-directory-example]"]
====
...
====
include::sample[dir="userguide/files/copy/groovy",files="build.gradle[tags=copy-directory-including-itself-example]"]
include::sample[dir="userguide/files/copy/kotlin",files="build.gradle.kts[tags=copy-directory-including-itself-example]"]
====
...
====
include::sample[dir="userguide/files/copy/groovy",files="build.gradle[tags=create-archive-example]"]
include::sample[dir="userguide/files/copy/kotlin",files="build.gradle.kts[tags=create-archive-example]"]
====
...
====
include::sample[dir="userguide/files/archivesWithBasePlugin/groovy",files="build.gradle[tags=create-archive-with-base-plugin-example]"]
include::sample[dir="userguide/files/archivesWithBasePlugin/kotlin",files="build.gradle.kts[tags=create-archive-with-base-plugin-example]"]
====
...
====
include::sample[dir="userguide/files/archives/groovy",files="build.gradle[tags=unpack-archive-example]"]
include::sample[dir="userguide/files/archives/kotlin",files="build.gradle.kts[tags=unpack-archive-example]"]
====
...
====
include::sample[dir="userguide/files/misc/groovy",files="build.gradle[tags=mkdir-example]"]
include::sample[dir="userguide/files/misc/kotlin",files="build.gradle.kts[tags=mkdir-example]"]
====
...
====
include::sample[dir="userguide/files/misc/groovy",files="build.gradle[tags=move-example]"]
include::sample[dir="userguide/files/misc/kotlin",files="build.gradle.kts[tags=move-example]"]
====
...
====
include::sample[dir="userguide/files/copy/groovy",files="build.gradle[tags=rename-on-copy-example]"]
include::sample[dir="userguide/files/copy/kotlin",files="build.gradle.kts[tags=rename-on-copy-example]"]
====
...
====
include::sample[dir="userguide/files/copy/groovy",files="build.gradle[tags=truncate-names-example]"]
include::sample[dir="userguide/files/copy/kotlin",files="build.gradle.kts[tags=truncate-names-example]"]
====
...
[[sec:subtree_example]]
== Using only part of a file tree

Sometimes you'll need only one subdirectory of a file tree. In that case, you can use api:org.gradle.api.file.FileTree#subTree(java.lang.String)[] to get only part of the file tree. This will rename the files to be relative to the specified root. For example, if a file tree contained `bin/gradle` and `README`, calling `subTree('bin')` would give you a file tree with just `gradle`.

This is especially useful with archive trees where you only need a particular folder:

.Unpacking only part of an archive tree
====
include::sample[dir="userguide/files/archives/groovy",files="build.gradle[tags=subtree-zip]"]
include::sample[dir="userguide/files/archives/kotlin",files="build.gradle.kts[tags=subtree-zip]"]
====
...
====
include::sample[dir="userguide/files/misc/groovy",files="build.gradle[tags=delete-example]"]
include::sample[dir="userguide/files/misc/kotlin",files="build.gradle.kts[tags=delete-example]"]
====
...
====
include::sample[dir="userguide/files/misc/groovy",files="build.gradle[tags=delete-with-filter-example]"]
include::sample[dir="userguide/files/misc/kotlin",files="build.gradle.kts[tags=delete-with-filter-example]"]
====
...
====
include::sample[dir="userguide/files/sampleJavaProject/groovy",files="build.gradle[tags=link-task-properties]"]
include::sample[dir="userguide/files/sampleJavaProject/kotlin",files="build.gradle.kts[tags=link-task-properties]"]
====
...
.Locating files
====
include::sample[dir="userguide/files/file/groovy",files="build.gradle[tags=simple-params]"]
include::sample[dir="userguide/files/file/kotlin",files="build.gradle.kts[tags=simple-params]"]
====
...
====
include::sample[dir="userguide/files/misc/groovy/project2",files="build.gradle[tags=using-root-dir-property]"]
include::sample[dir="userguide/files/misc/kotlin/project2",files="build.gradle.kts[tags=using-root-dir-property]"]
====
...
====
include::sample[dir="userguide/files/fileCollections/groovy",files="build.gradle[tags=simple-params]"]
include::sample[dir="userguide/files/fileCollections/kotlin",files="build.gradle.kts[tags=simple-params]"]
====
...
====
include::sample[dir="userguide/files/fileCollections/groovy",files="build.gradle[tags=closure]"]
include::sample[dir="userguide/files/fileCollections/kotlin",files="build.gradle.kts[tags=closure]"]
====
...
====
include::sample[dir="userguide/files/fileCollections/groovy",files="build.gradle[tags=usage]"]
include::sample[dir="userguide/files/fileCollections/kotlin",files="build.gradle.kts[tags=usage]"]
====
...
====
include::sample[dir="userguide/files/fileCollections/groovy",files="build.gradle[tags=filtering-file-collections]"]
include::sample[dir="userguide/files/fileCollections/kotlin",files="build.gradle.kts[tags=filtering-file-collections]"]
====
...
====
include::sample[dir="userguide/files/fileTrees/groovy",files="build.gradle[tags=define]"]
include::sample[dir="userguide/files/fileTrees/kotlin",files="build.gradle.kts[tags=define]"]
====
...
====
include::sample[dir="userguide/files/copy/groovy",files="build.gradle[tags=change-default-exclusions]"]
include::sample[dir="userguide/files/copy/kotlin",files="build.gradle.kts[tags=change-default-exclusions]"]
====
...
.Using a file tree
====
include::sample[dir="userguide/files/fileTrees/groovy",files="build.gradle[tags=use]"]
include::sample[dir="userguide/files/fileTrees/kotlin",files="build.gradle.kts[tags=use]"]
====
...
====
include::sample[dir="userguide/files/fileTrees/groovy",files="build.gradle[tags=archive-trees]"]
include::sample[dir="userguide/files/fileTrees/kotlin",files="build.gradle.kts[tags=archive-trees]"]
====
...
====
include::sample[dir="userguide/files/inputFiles/groovy",files="build.gradle[tags=set-input-files]"]
include::sample[dir="userguide/files/inputFiles/kotlin",files="build.gradle.kts[tags=set-input-files]"]
====
...
====
include::sample[dir="userguide/files/inputFiles/groovy",files="build.gradle[tags=add-input-files]"]
include::sample[dir="userguide/files/inputFiles/kotlin",files="build.gradle.kts[tags=add-input-files]"]
====
...
====
include::sample[dir="userguide/files/copy/groovy",files="build.gradle[tags=copy-task-2]"]
include::sample[dir="userguide/files/copy/kotlin",files="build.gradle.kts[tags=copy-task-2]"]
====
...
====
include::sample[dir="userguide/files/copy/groovy",files="build.gradle[tags=copy-task-with-patterns]"]
include::sample[dir="userguide/files/copy/kotlin",files="build.gradle.kts[tags=copy-task-with-patterns]"]
====
...
.Renaming files as they are copied
====
include::sample[dir="userguide/files/copy/groovy",files="build.gradle[tags=rename-files]"]
include::sample[dir="userguide/files/copy/kotlin",files="build.gradle.kts[tags=rename-files]"]
====
...
====
include::sample[dir="userguide/files/copy/groovy",files="build.gradle[tags=filter-files]"]
include::sample[dir="userguide/files/copy/kotlin",files="build.gradle.kts[tags=filter-files]"]
====
...
====
include::sample[dir="userguide/files/copy/groovy",files="build.gradle[tags=standalone-copyspec]"]
include::sample[dir="userguide/files/copy/kotlin",files="build.gradle.kts[tags=standalone-copyspec]"]
====
...
====
include::sample[dir="userguide/files/copy/groovy",files="build.gradle[tags=shared-copy-patterns]"]
include::sample[dir="userguide/files/copy/kotlin",files="build.gradle.kts[tags=shared-copy-patterns]"]
====
...
.Nested copy specs
====
include::sample[dir="userguide/files/sampleJavaProject/groovy",files="build.gradle[tags=nested-specs]"]
include::sample[dir="userguide/files/sampleJavaProject/kotlin",files="build.gradle.kts[tags=nested-specs]"]
====
...
====
include::sample[dir="userguide/files/copy/groovy",files="build.gradle[tags=copy-method]"]
include::sample[dir="userguide/files/copy/kotlin",files="build.gradle.kts[tags=copy-method]"]
====
...
====
include::sample[dir="userguide/files/copy/groovy",files="build.gradle[tags=copy-method-with-dependency]"]
include::sample[dir="userguide/files/copy/kotlin",files="build.gradle.kts[tags=copy-method-with-dependency]"]
====
...
====
include::sample[dir="userguide/files/sync/groovy",files="build.gradle[tags=copy-dependencies]"]
include::sample[dir="userguide/files/sync/kotlin",files="build.gradle.kts[tags=copy-dependencies]"]
====
...
====
include::sample[dir="userguide/files/archiveNaming/groovy",files="build.gradle[tags=zip-task]"]
include::sample[dir="userguide/files/archiveNaming/kotlin",files="build.gradle.kts[tags=zip-task]"]
====
...
====
include::sample[dir="userguide/files/archiveNaming/groovy",files="build.gradle[tags=zip-task-with-custom-base-name]"]
include::sample[dir="userguide/files/archiveNaming/kotlin",files="build.gradle.kts[tags=zip-task-with-custom-base-name]"]
====
...
====
include::sample[dir="userguide/files/archivesChangedBaseName/groovy",files="build.gradle[]"]
include::sample[dir="userguide/files/archivesChangedBaseName/kotlin",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/files/archives/groovy",files="build.gradle[tags=reproducible]"]
include::sample[dir="userguide/files/archives/kotlin",files="build.gradle.kts[tags=reproducible]"]
====
