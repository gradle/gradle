...
+
image::https://gradle.com/wp-content/uploads/2018/08/deprecations-1.png[Deprecations View of a Gradle Build Scan]
+
...
. Try to run the project and debug any errors.
