...
`java.net.URL`:: This type is not supported on properties annotated with @Input because Java Serialization can be inconsistent for this type. This is a known issue, see the https://bugs.openjdk.org/browse/JDK-8075619[OpenJDK bug report] for more details.
