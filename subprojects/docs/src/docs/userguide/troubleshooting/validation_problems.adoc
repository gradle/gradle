...
Properties annotated with `link:{javadocPath}/org/gradle/api/tasks/ServiceReference.html[@ServiceReference]` are meant to hold references to <<build_services#build_services,shared build services>>.
