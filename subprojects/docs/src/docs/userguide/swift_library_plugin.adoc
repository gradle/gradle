...
====
include::sample[dir="userguide/swift/swiftLibrary/groovy",files="build.gradle[tags=apply-plugin]"]
include::sample[dir="userguide/swift/swiftLibrary/kotlin",files="build.gradle.kts[tags=apply-plugin]"]
====
...
Read the <<building_cpp_projects.adoc#sec:introducing_build_variants,introduction to build variants>> for more information.
...
====
include::sample[dir="userguide/swift/swiftLibrary/groovy",files="build.gradle[tags=configure-linkages]"]
include::sample[dir="userguide/swift/swiftLibrary/kotlin",files="build.gradle.kts[tags=configure-linkages]"]
====
...
====
include::sample[dir="userguide/swift/swiftLibrary/groovy",files="build.gradle[tags=configure-target-machines]"]
include::sample[dir="userguide/swift/swiftLibrary/kotlin",files="build.gradle.kts[tags=configure-target-machines]"]
====
...
// TODO: Add the following line when XCTest plugin chapter is added:
// For example, the <<swift_unit_test_plugin.adoc#,Swift Unit Test Plugin>> attach his test task to this lifecycle task.
This task is added by the <<base_plugin.adoc#,Base Plugin>>.
...
.Adding dependencies
====
include::sample[dir="userguide/swift/swiftLibrary/groovy",files="build.gradle[tags=dependency-management]"]
include::sample[dir="userguide/swift/swiftLibrary/kotlin",files="build.gradle.kts[tags=dependency-management]"]
====
...
// TODO: Replace with next line when chapter is available
...
link:{groovyDslPath}/org.gradle.language.swift.tasks.SwiftCompile.html#org.gradle.language.swift.tasks.SwiftCompile:toolChain[toolChain]:: automatically selected based on target machine

[[sec:swift_library_link_task]]
=== `link__Variant__` Task

The Swift Library Plugin adds a link:{groovyDslPath}/org.gradle.language.tasks.LinkSharedLibrary.html[LinkSharedLibrary] instance for each variant of the library containing shared linkage as a dimension - e.g. `linkDebug` and `linkRelease`.
Read the <<building_cpp_projects.adoc#sec:introducing_build_variants,introduction to build variants>> for more information.
Some of the most common configuration options are shown below.
...
link:{groovyDslPath}/org.gradle.nativeplatform.tasks.LinkSharedLibrary.html#org.gradle.nativeplatform.tasks.LinkSharedLibrary:linkedFile[linkedFile]:: `$buildDir/lib/main/__variant__/libModule[.so|dylib]`
...
link:{groovyDslPath}/org.gradle.nativeplatform.tasks.LinkSharedLibrary.html#org.gradle.nativeplatform.tasks.LinkSharedLibrary:toolChain[toolChain]:: automatically selected based on target machine

[[sec:swift_library_create_task]]
=== `create__Variant__` Task

The Swift Library Plugin adds a link:{groovyDslPath}/org.gradle.language.tasks.CreateStaticLibrary.html[CreateStaticLibrary] instance for each variant of the library containing static linkage as a dimension - e.g. `createDebug` and `createRelease`.
Read the <<building_cpp_projects.adoc#sec:introducing_build_variants,introduction to build variants>> for more information.
Some of the most common configuration options are shown below.

[horizontal]
link:{groovyDslPath}/org.gradle.nativeplatform.tasks.CreateStaticLibrary.html#org.gradle.nativeplatform.tasks.CreateStaticLibrary:outputFile[outputFile]:: `$buildDir/lib/main/__variant__/libModule.a`
...
link:{groovyDslPath}/org.gradle.nativeplatform.tasks.CreateStaticLibrary.html#org.gradle.nativeplatform.tasks.CreateStaticLibrary:toolChain[toolChain]:: automatically selected based on target machine
