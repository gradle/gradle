...
====
include::sample[dir="snippets/antlr/groovy",files="build.gradle[tags=use-plugin]"]
include::sample[dir="snippets/antlr/kotlin",files="build.gradle.kts[tags=use-plugin]"]
====
...
====
include::sample[dir="snippets/antlr/groovy",files="build.gradle[tags=declare-dependency]"]
include::sample[dir="snippets/antlr/kotlin",files="build.gradle.kts[tags=declare-dependency]"]
====
...
====
include::sample[dir="snippets/antlr/groovy",files="build.gradle[tags=generate-grammar-settings]"]
include::sample[dir="snippets/antlr/kotlin",files="build.gradle.kts[tags=generate-grammar-settings]"]
====
