...
====
include::sample[dir="snippets/visualStudio/groovy",files="build.gradle[tags=apply-plugin]"]
include::sample[dir="snippets/visualStudio/kotlin",files="build.gradle.kts[tags=apply-plugin]"]
====
...
====
include::sample[dir="snippets/visualStudio/groovy",files="build.gradle[tags=configure-solution-location]"]
include::sample[dir="snippets/visualStudio/kotlin",files="build.gradle.kts[tags=configure-solution-location]"]
====
...
====
include::sample[dir="snippets/visualStudio/groovy",files="build.gradle[tags=configure-project-and-filters-location]"]
include::sample[dir="snippets/visualStudio/kotlin",files="build.gradle.kts[tags=configure-project-and-filters-location]"]
====