...
====
include::sample[dir="snippets/basePlugin/groovy",files="build.gradle[tags=apply-base-plugin]"]
include::sample[dir="snippets/basePlugin/kotlin",files="build.gradle.kts[tags=apply-base-plugin]"]
====
