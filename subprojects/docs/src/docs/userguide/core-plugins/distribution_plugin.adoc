...
====
include::sample[dir="snippets/userguide/distribution/groovy",files="build.gradle[tags=use-plugin]"]
include::sample[dir="snippets/userguide/distribution/kotlin",files="build.gradle.kts[tags=use-plugin]"]
====
...
====
include::sample[dir="snippets/userguide/distribution/groovy",files="build.gradle[tags=custom-distribution]"]
include::sample[dir="snippets/userguide/distribution/kotlin",files="build.gradle.kts[tags=custom-distribution]"]
====
...
====
include::sample[dir="snippets/userguide/distribution/groovy",files="build.gradle[tags=configure-distribution]"]
include::sample[dir="snippets/userguide/distribution/kotlin",files="build.gradle.kts[tags=configure-distribution]"]
====
...
====
include::sample[dir="snippets/userguide/distribution/groovy",files="build.gradle[tags=publish-distribution]"]
include::sample[dir="snippets/userguide/distribution/kotlin",files="build.gradle.kts[tags=publish-distribution]"]
====
