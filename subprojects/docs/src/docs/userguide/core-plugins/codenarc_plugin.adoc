...
====
include::sample[dir="snippets/codeQuality/groovy",files="build.gradle[tags=use-codenarc-plugin]"]
include::sample[dir="snippets/codeQuality/kotlin",files="build.gradle.kts[tags=use-codenarc-plugin]"]
====
