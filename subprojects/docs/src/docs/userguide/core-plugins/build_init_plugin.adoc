...
* Provides link:{groovyDslPath}/org.gradle.buildinit.tasks.InitBuild.html#org.gradle.buildinit.tasks.InitBuild:insecureProtocolHandler[--insecure-protocol] option for handling Maven repositories located at URLs using `http`
