...
`--info` logs explain why a task was executed, though Build Scan™ do this in a searchable, visual way by going to the _Timeline_ view and clicking on the task you want to inspect.
