...
Initialization::
Gradle supports single and multi-project builds. During the initialization phase, Gradle determines which projects are going to take part in the build, and creates a link:{groovy-dsl-path}/org.gradle.api.Project.html[Project] instance for each of these projects.
Configuration::
...
.settings.gradle
----
include::{samples-path}/userguide/buildlifecycle/basic/settings.gradle[]
----

[source.multi-language-sample,groovy]
.build.gradle
----
include::{samples-path}/userguide/buildlifecycle/basic/build.gradle[]
----

.Output of `gradle test testBoth`
----
> gradle test testBoth
include::{samples-path}/userguide/buildlifecycle/basic/buildlifecycle.out[]
----

For a build script, the property access and method calls are delegated to a project object. Similarly property access and method calls within the settings file is delegated to a settings object. Look at the link:{groovy-dsl-path}/org.gradle.api.initialization.Settings.html[Settings] class in the API documentation for more information.
...
.settings.gradle
----
include::{samples-path}/userguide/multiproject/standardLayouts/settings.gradle[tag=hierarchical-layout]
----
...
More examples of how to work with the project path can be found in the DSL documentation of link:{groovy-dsl-path}++/org.gradle.api.initialization.Settings.html#org.gradle.api.initialization.Settings:include(java.lang.String[])++[Settings.include(java.lang.String[\])].
...
.settings.gradle
----
include::{samples-path}/userguide/multiproject/standardLayouts/settings.gradle[tag=flat-layout]
----
...
.settings.gradle
----
include::{samples-path}/userguide/multiproject/customLayout/settings.gradle[tag=lookup-project]
----
...
.settings.gradle
----
include::{samples-path}/userguide/multiproject/customLayout/settings.gradle[tag=change-project]
----

Look at the link:{javadoc-path}/org/gradle/api/initialization/ProjectDescriptor.html[ProjectDescriptor] class in the API documentation for more information.
...
.build.gradle
----
include::{samples-path}/userguide/buildlifecycle/projectEvaluateEvents/build.gradle[tag=after-evaluate]
----

[source.multi-language-sample,groovy]
.projectA.gradle
----
include::{samples-path}/userguide/buildlifecycle/projectEvaluateEvents/projectA.gradle[]
----

.Output of `gradle -q test`
----
> gradle -q test
include::{samples-path}/userguide/buildlifecycle/projectEvaluateEvents/projectEvaluateEvents.out[]
----
...
.build.gradle
----
include::{samples-path}/userguide/buildlifecycle/buildProjectEvaluateEvents/build.gradle[tag=evaluate-events]
----

.Output of **`gradle -q test`**
----
> gradle -q test
include::{samples-path}/userguide/buildlifecycle/buildProjectEvaluateEvents/buildProjectEvaluateEvents.out[]
----

You can also add a link:{javadoc-path}/org/gradle/api/ProjectEvaluationListener.html[ProjectEvaluationListener] to the link:{groovy-dsl-path}/org.gradle.api.invocation.Gradle.html[Gradle] to receive these events.
...
.build.gradle
----
include::{samples-path}/userguide/buildlifecycle/taskCreationEvents/build.gradle[]
----

.Output of **`gradle -q a`**
----
> gradle -q a
include::{samples-path}/userguide/buildlifecycle/taskCreationEvents/taskCreationEvents.out[]
----

You can also add an link:{javadoc-path}/org/gradle/api/Action.html[Action] to a link:{javadoc-path}/org/gradle/api/tasks/TaskContainer.html[TaskContainer] to receive these events.
...
You can also add a link:{javadoc-path}/org/gradle/api/execution/TaskExecutionGraphListener.html[TaskExecutionGraphListener] to the link:{javadoc-path}/org/gradle/api/execution/TaskExecutionGraph.html[TaskExecutionGraph] to receive these events.
...
.build.gradle
----
include::{samples-path}/userguide/buildlifecycle/taskExecutionEvents/build.gradle[]
----

.Output of **`gradle -q broken`**
----
> gradle -q broken
include::{samples-path}/userguide/buildlifecycle/taskExecutionEvents/taskExecutionEvents.out[]
----

You can also use a link:{javadoc-path}/org/gradle/api/execution/TaskExecutionListener.html[TaskExecutionListener] to the link:{javadoc-path}/org/gradle/api/execution/TaskExecutionGraph.html[TaskExecutionGraph] to receive these events.
