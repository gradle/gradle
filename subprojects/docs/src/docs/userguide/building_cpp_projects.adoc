 ...
 * Testing your fixes to 3rd-party dependency via <<composite_builds.adoc#composite-builds,composite builds>> (a better alternative to publishing to and consuming from <<declaring_repositories.adoc#sec:maven_local,Maven Local>>)
