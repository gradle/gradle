...
If you’re unsure of the difference between an API and implementation dependency, the <<cpp_library_plugin.adoc,C\++ Library Plugin>> chapter has a detailed explanation.
