...
`pmdMain` — type: link:{groovyDslPath}/org.gradle.api.plugins.quality.Pmd.html[Pmd]::
+
Runs PMD against the production Java source files.

`pmdTest` — type: link:{groovyDslPath}/org.gradle.api.plugins.quality.Pmd.html[Pmd]::
+
Runs PMD against the test Java source files.

`pmd__SourceSet__` — type: link:{groovyDslPath}/org.gradle.api.plugins.quality.Pmd.html[Pmd]::
+
