...
====
include::sample[dir="codeQuality/groovy",files="build.gradle[tags=use-pmd-plugin]"]
include::sample[dir="codeQuality/kotlin",files="build.gradle.kts[tags=use-pmd-plugin]"]
====
