...
This is the first of a number of sections with deep coverage on various aspects of Gradle plugin development.
You will learn how to properly design Gradle plugins based on established practices and apply them to your own projects.
...
The guide on link:https://guides.gradle.org/performance[Optimizing Gradle Build Performance] will give you additional code examples, pitfalls and recommendations.
