...
- Working knowledge in writing Java code (if you're writing your plugins in Kotlin make sure to check the <<writing_in_kotlin.adoc, Writing your plugins in Kotlin>> page in addition to this page)
