...
====
include::sample[dir="snippets/developingPlugins/pluginIdentifier/groovy/buildSrc",files="build.gradle[]"]
include::sample[dir="snippets/developingPlugins/pluginIdentifier/kotlin/buildSrc",files="build.gradle.kts[]"]
====
