...
====
include::sample[dir="snippets/kotlinDsl/multiProjectBuildKotlin/kotlin",files="settings.gradle.kts[tags=base];build.gradle.kts[tags=root];domain/build.gradle.kts[];infra/build.gradle.kts[];http/build.gradle.kts[]"]
====
...
====
include::sample[dir="snippets/kotlinDsl/multiProjectBuildKotlin/kotlin",files="settings.gradle.kts[tags=repositories]"]
====
...
.Cross-configuring projects
====
include::sample[dir="snippets/kotlinDsl/multiProjectBuildKotlin/kotlin",files="settings.gradle.kts[tags=base];build.gradle.kts[tags=cross]"]
====
...
====
include::sample[dir="snippets/kotlinDsl/kotlinDslPlugin/kotlin",files="buildSrc/build.gradle.kts[tags=disable-experimental-warning]"]
====
