...
<3> Property assignment supports also lazy values
...
The main differences from overloading other Kotlin operators is, that it works just for final properties.
