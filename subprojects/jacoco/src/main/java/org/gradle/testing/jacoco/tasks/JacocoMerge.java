...
public class JacocoMerge extends JacocoBase {
    ...
    private void configureExecutionData(final Task task) {
     ...
     * @param tasks one or more tasks to merge
     */
    public void executionData(TaskProvider<? extends Task>... tasks) {
        for (TaskProvider<? extends Task> taskProvider : tasks) {
