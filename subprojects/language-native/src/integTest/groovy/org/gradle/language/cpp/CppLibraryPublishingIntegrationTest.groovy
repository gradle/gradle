...
"""
    ...
    def "fails when a dependency is published without a matching target architecture"() {
        ...
        then:
        failure.assertHasCause("No matching variant of some.group:deck:1.2 was found. The consumer was configured to find attribute 'org.gradle.usage' with value 'native-link', attribute 'org.gradle.native.debuggable' with value 'true', attribute 'org.gradle.native.optimized' with value 'false', attribute 'org.gradle.native.operatingSystem' with value '${currentOsFamilyName.toLowerCase(java.util.Locale.US)}', attribute 'org.gradle.native.architecture' with value 'x86' but:")
