...
class IncrementalCompileProcessorTest extends Specification {
    ...
    def stateCache = new DummyObjectCache()
    ...
    class DummyObjectCache implements ObjectCache<CompilationState> {
        ...
        CompilationState update(ObjectCache.UpdateAction<CompilationState> updateAction) {
            throw new UnsupportedOperationException()
        }

        @Override
        CompilationState maybeUpdate(ObjectCache.UpdateAction<CompilationState> updateAction) {
            throw new UnsupportedOperationException()
        }
    }
