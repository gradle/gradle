...
class DefaultCppBinaryTest extends Specification {
    ...
    def setup() {
        ...
        binary = new DefaultCppBinary("mainDebug", projectLayout, TestUtil.objectFactory(), Stub(Provider), true, Stub(FileCollection), componentHeaders, configurations, implementation, Linkage.SHARED)
    }
