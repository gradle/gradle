...
class DefaultSwiftBinaryTest extends Specification {
    ...
    def setup() {
        _ * configurations.resolvableDependenciesUnlocked("swiftCompileDebug") >> compile
        _ * configurations.resolvableDependenciesUnlocked("nativeLinkDebug") >> link
        _ * configurations.migratingUnlocked('nativeRuntimeDebug', ConfigurationRolesForMigration.RESOLVABLE_BUCKET_TO_RESOLVABLE) >> runtime
