...
class DefaultSwiftBinaryTest extends Specification {
    ...
    def setup() {
        ...
        binary = new DefaultSwiftBinary("mainDebug", project.layout, project.objects, Stub(Provider), true, false,false, Stub(FileCollection),  configurations, implementation, Stub(SwiftPlatform), Stub(NativeToolChainInternal), Stub(PlatformToolProvider, SwiftLanguageVersion.SWIFT4))
    }
