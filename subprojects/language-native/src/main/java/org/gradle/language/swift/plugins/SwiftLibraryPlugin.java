    ...
    public void apply(final Project project) {
        ...
        project.afterEvaluate(p -> {
            ...
            library.getBinaries().whenElementKnown(SwiftSharedLibrary.class, sharedLibrary -> {
                ...
                Configuration apiElements = configurations.migratingUnlocked(names.withSuffix("SwiftApiElements"), ConfigurationRolesForMigration.CONSUMABLE_BUCKET_TO_CONSUMABLE);
