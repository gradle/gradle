    ...
    def setup() {
        buildFile << """
            ...
            configurations.codenarc {
                resolutionStrategy.force 'org.codehaus.groovy:groovy:3.0.12' // force latest Groovy 3 when using Java 14+.  Do not use GroovySystem#version as Groovy 4 needs different coordinates
            }
            """ : ""}
        """.stripIndent()
