...
class ToolingApiSuite extends ToolingApiCompatibilitySuite {
    ...
    boolean accept(BasicGradleDistribution toolingApi, BasicGradleDistribution gradle) {
        def m5 = GradleVersion.version('1.0-milestone-5')
        return GradleVersion.version(toolingApi.version) >= m5 && GradleVersion.version(gradle.version) >= m5
    }
    ...
    List<Class<?>> getClasses() {
        return [
                ...
                ToolingApiGradleProjectIntegrationTest,
                ToolingApiIdeaModelIntegrationTest
        ]
    }
}