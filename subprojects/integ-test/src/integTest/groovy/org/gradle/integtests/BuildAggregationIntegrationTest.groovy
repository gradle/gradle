...
'''
    ...
    def "nested build type is reported"() {
        when:
        buildFile << '''
            assert gradle.parent == null

            def buildType = gradle.services.get(org.gradle.initialization.buildtype.BuildTypeAttributes)
...
'''
        ...
        file('buildSrc/build.gradle') << '''
            ...
            classes << {
                ...
                def inTaskBuildType = gradle.services.get(org.gradle.initialization.buildtype.BuildTypeAttributes)
                assert inTaskBuildType.nestedBuild
            }
'''
