...
public class CacheProjectIntegrationTest extends AbstractIntegrationTest {
    ...
    public void setUp() {
        ...
        propertiesFile = userHomeDir.file("caches/$version/scripts/$source.className/ProjectScript/metadata_no_buildscript/cache.properties")
        classFile = userHomeDir.file("caches/$version/scripts/$source.className/ProjectScript/metadata_no_buildscript/classes/${source.className}.class")
