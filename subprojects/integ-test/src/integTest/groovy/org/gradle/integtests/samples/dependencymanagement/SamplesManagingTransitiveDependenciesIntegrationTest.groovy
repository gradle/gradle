...
class SamplesManagingTransitiveDependenciesIntegrationTest extends AbstractIntegrationSpec {
    ...
    @UsesSample("userguide/dependencyManagement/managingTransitiveDependencies/declaringDependencyVersionsWithDependencyConstraints")
    ...
    @UsesSample("userguide/dependencyManagement/managingTransitiveDependencies/unresolvedTransitiveDependencies")
...
> Could not find jmxri.jar (com.sun.jmx:jmxri:1.2.1).
  Searched in the following locations:
    ...
    @UsesSample("userguide/dependencyManagement/managingTransitiveDependencies/excludingTransitiveDependenciesForDependency")
    ...
    @UsesSample("userguide/dependencyManagement/managingTransitiveDependencies/excludingTransitiveDependenciesForConfiguration")
    ...
    @UsesSample("userguide/dependencyManagement/managingTransitiveDependencies/excludingTransitiveDependenciesForAllConfigurations")
    ...
    @UsesSample("userguide/dependencyManagement/managingTransitiveDependencies/forcingDependencyVersion")
    ...
    @UsesSample("userguide/dependencyManagement/managingTransitiveDependencies/forcingDependencyVersionPerConfiguration")
    ...
    @UsesSample("userguide/dependencyManagement/managingTransitiveDependencies/disablingTransitiveDependencyResolution")
    ...
    @UsesSample("userguide/dependencyManagement/managingTransitiveDependencies/disablingTransitiveDependencyResolutionForConfiguration")
