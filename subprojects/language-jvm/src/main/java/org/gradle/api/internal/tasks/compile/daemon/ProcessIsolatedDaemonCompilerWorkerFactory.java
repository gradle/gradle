...
public class ProcessIsolatedDaemonCompilerWorkerFactory extends AbstractDelegatingDaemonCompilerWorkerFactory {
    public ProcessIsolatedDaemonCompilerWorkerFactory(WorkerFactory delegate) {
        super(delegate);
    }
