...
abstract class AbstractJvmPluginLanguageIntegrationTest extends AbstractIntegrationSpec {
    ...
    def setup() {
        ...
        executer.expectDeprecationWarning("The ${languageName}-lang plugin has been deprecated. This is scheduled to be removed in Gradle 7.0. Consult the upgrading guide for further information: https://docs.gradle.org/${GradleVersion.current().version}/userguide/upgrading_version_6.html#upgrading_jvm_plugins")
