...
"""
        ...
        outputContains("file-dep.jar {artifactType=jar}")
        outputContains("compile.jar (test:compile:1.0) {artifactType=jar}")
        outputContains("other-java.jar (project :other-java) {artifactType=jar, org.gradle.dependency.packing=external, org.gradle.usage=java-api-jars}")
        outputContains("java.jar (project :java) {artifactType=jar, org.gradle.dependency.packing=external, org.gradle.usage=java-api-jars}")
