...
class ApplicationPluginIntegrationTest extends AbstractIntegrationSpec {
    def "can generate start scripts"() {
        given:
...
CLASSPATH=\$APP_HOME/lib/sample.jar
...
set CLASSPATH=%APP_HOME%\\lib\\sample.jar

@rem Execute sample
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SAMPLE_OPTS%  -classpath "%CLASSPATH%" org.gradle.test.Main %CMD_LINE_ARGS%
