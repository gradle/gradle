 ...
 */
public class DefaultClassPath2 implements ClassPath, Serializable {
    private final List<File> files;

    public DefaultClassPath2(Iterable<File> files) {
    ...
    public DefaultClassPath2(File... files) {
    ...
    public ClassPath plus(ClassPath other) {
        ...
        return new DefaultClassPath2(concat(files, other.getAsFiles()));
    }
    ...
    public ClassPath plus(Collection<File> other) {
        ...
        return new DefaultClassPath2(concat(files, other));
    }
    ...
    public boolean equals(Object obj) {
        ...
        DefaultClassPath2 other = (DefaultClassPath2) obj;
