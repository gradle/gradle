 ...
 */
public class DefaultClassPath1 implements ClassPath, Serializable {
    private final List<File> files;

    public DefaultClassPath1(Iterable<File> files) {
    ...
    public DefaultClassPath1(File... files) {
    ...
    public ClassPath plus(ClassPath other) {
        ...
        return new DefaultClassPath1(concat(files, other.getAsFiles()));
    }
    ...
    public ClassPath plus(Collection<File> other) {
        ...
        return new DefaultClassPath1(concat(files, other));
    }
    ...
    public boolean equals(Object obj) {
        ...
        DefaultClassPath1 other = (DefaultClassPath1) obj;
