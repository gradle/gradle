 ...
 */
public class DefaultClassPath4 implements ClassPath, Serializable {
    private final List<File> files;

    public DefaultClassPath4(Iterable<File> files) {
    ...
    public DefaultClassPath4(File... files) {
    ...
    public ClassPath plus(ClassPath other) {
        ...
        return new DefaultClassPath4(concat(files, other.getAsFiles()));
    }
    ...
    public ClassPath plus(Collection<File> other) {
        ...
        return new DefaultClassPath4(concat(files, other));
    }
    ...
    public boolean equals(Object obj) {
        ...
        DefaultClassPath4 other = (DefaultClassPath4) obj;
