 ...
 */
public class DefaultClassPath7 implements ClassPath, Serializable {
    private final List<File> files;

    public DefaultClassPath7(Iterable<File> files) {
    ...
    public DefaultClassPath7(File... files) {
    ...
    public ClassPath plus(ClassPath other) {
        ...
        return new DefaultClassPath7(concat(files, other.getAsFiles()));
    }
    ...
    public ClassPath plus(Collection<File> other) {
        ...
        return new DefaultClassPath7(concat(files, other));
    }
    ...
    public boolean equals(Object obj) {
        ...
        DefaultClassPath7 other = (DefaultClassPath7) obj;
