 ...
 */
public class DefaultClassPath6 implements ClassPath, Serializable {
    private final List<File> files;

    public DefaultClassPath6(Iterable<File> files) {
    ...
    public DefaultClassPath6(File... files) {
    ...
    public ClassPath plus(ClassPath other) {
        ...
        return new DefaultClassPath6(concat(files, other.getAsFiles()));
    }
    ...
    public ClassPath plus(Collection<File> other) {
        ...
        return new DefaultClassPath6(concat(files, other));
    }
    ...
    public boolean equals(Object obj) {
        ...
        DefaultClassPath6 other = (DefaultClassPath6) obj;
