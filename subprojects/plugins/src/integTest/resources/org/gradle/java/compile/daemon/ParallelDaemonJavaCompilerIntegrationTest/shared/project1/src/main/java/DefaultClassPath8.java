 ...
 */
public class DefaultClassPath8 implements ClassPath, Serializable {
    private final List<File> files;

    public DefaultClassPath8(Iterable<File> files) {
    ...
    public DefaultClassPath8(File... files) {
    ...
    public ClassPath plus(ClassPath other) {
        ...
        return new DefaultClassPath8(concat(files, other.getAsFiles()));
    }
    ...
    public ClassPath plus(Collection<File> other) {
        ...
        return new DefaultClassPath8(concat(files, other));
    }
    ...
    public boolean equals(Object obj) {
        ...
        DefaultClassPath8 other = (DefaultClassPath8) obj;
