 ...
 */
public class DefaultClassPath5 implements ClassPath, Serializable {
    private final List<File> files;

    public DefaultClassPath5(Iterable<File> files) {
    ...
    public DefaultClassPath5(File... files) {
    ...
    public ClassPath plus(ClassPath other) {
        ...
        return new DefaultClassPath5(concat(files, other.getAsFiles()));
    }
    ...
    public ClassPath plus(Collection<File> other) {
        ...
        return new DefaultClassPath5(concat(files, other));
    }
    ...
    public boolean equals(Object obj) {
        ...
        DefaultClassPath5 other = (DefaultClassPath5) obj;
