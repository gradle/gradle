 ...
 */
public class DefaultClassPath10 implements ClassPath, Serializable {
    private final List<File> files;

    public DefaultClassPath10(Iterable<File> files) {
    ...
    public DefaultClassPath10(File... files) {
    ...
    public ClassPath plus(ClassPath other) {
        ...
        return new DefaultClassPath10(concat(files, other.getAsFiles()));
    }
    ...
    public ClassPath plus(Collection<File> other) {
        ...
        return new DefaultClassPath10(concat(files, other));
    }
    ...
    public boolean equals(Object obj) {
        ...
        DefaultClassPath10 other = (DefaultClassPath10) obj;
