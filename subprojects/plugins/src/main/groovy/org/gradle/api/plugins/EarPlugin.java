...
/**
 * <p>A {@link Plugin} with tasks which assemble a web application into a EAR file.</p>
 *
...
public class EarPlugin implements Plugin<Project> {
                ...
                task.from(new Callable<FileCollection>() {
                    public FileCollection call() throws Exception {
                        ...
                        if (javaPlugin == null) {
                            ...
                            files = javaPlugin.getSourceSets().getByName(SourceSet.MAIN_SOURCE_SET_NAME).getClasses();
                        }
    ...
    private void configureConfigurations(final Project project) {
        ...
        Configuration moduleConfiguration = configurations.add(DEPLOY_CONFIGURATION_NAME).setVisible(false).
                setTransitive(false).
                setDescription("Classpath for deployable modules, not transitive.");
