...
public abstract class WarPlugin implements Plugin<Project> {
    ...
    private JvmFeature mainFeature;
    ...
    private void configureConfigurations(RoleBasedConfigurationContainerInternal configurationContainer, JvmFeature mainFeature) {
