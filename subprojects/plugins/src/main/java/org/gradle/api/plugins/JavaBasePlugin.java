...
public abstract class JavaBasePlugin implements Plugin<Project> {
    ...
    private void defineConfigurationsForSourceSet(SourceSet sourceSet, RoleBasedConfigurationContainerInternal configurations) {
        ...
        Configuration implementationConfiguration = configurations.maybeRegisterDependencyScopeUnlocked(implementationConfigurationName).get();
        ...
        Configuration compileOnlyConfiguration = configurations.maybeRegisterDependencyScopeUnlocked(compileOnlyConfigurationName).get();
        compileOnlyConfiguration.setVisible(false);
        compileOnlyConfiguration.setDescription("Compile only dependencies for " + sourceSetName + ".");

        Configuration compileClasspathConfiguration = configurations.maybeRegisterResolvableUnlocked(compileClasspathConfigurationName).get();
        ...
        Configuration annotationProcessorConfiguration = configurations.maybeRegisterResolvableDependencyScopeUnlocked(annotationProcessorConfigurationName).get();
        ...
        Configuration runtimeOnlyConfiguration = configurations.maybeRegisterDependencyScopeUnlocked(runtimeOnlyConfigurationName).get();
        runtimeOnlyConfiguration.setVisible(false);
        runtimeOnlyConfiguration.setDescription("Runtime only dependencies for " + sourceSetName + ".");

        Configuration runtimeClasspathConfiguration = configurations.maybeRegisterResolvableUnlocked(runtimeClasspathConfigurationName).get();
