...
public class DefaultJavaPluginExtension2 extends JavaPluginConvention {
    ...
    public DefaultJavaPluginExtension2(ProjectInternal project, SourceSetContainer sourceSets, DefaultToolchainSpec toolchainSpec, JvmPluginServices jvmPluginServices) {
