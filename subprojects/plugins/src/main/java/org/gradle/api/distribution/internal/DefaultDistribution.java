...
public abstract class DefaultDistribution implements Distribution {
    ...
    public String getBaseName() {
        DeprecationLogger.deprecateProperty(Distribution.class, "baseName").replaceWith("distributionBaseName").willBeRemovedInNextMajorVersion().withDslReference().nagUser();
