...
public class DefaultJvmEcosystemAttributesDetails implements JvmEcosystemAttributesDetails {
    ...
    @Override
    public JvmEcosystemAttributesDetails internalCompileView() {
        attributes.attribute(CompileView.VIEW_ATTRIBUTE, objectFactory.named(CompileView.class, CompileView.JAVA_INTERNAL));
        return this;
    }
