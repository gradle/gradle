...
public class GroovyRuntime {
    ...
    public FileCollection inferGroovyClasspath(final Iterable<File> classpath) {
        // alternatively, we could return project.getLayout().filesFor(Runnable)
        ...
        return new LazilyInitializedFileCollection() {
            ...
            public FileCollection createDelegate() {
                ...
                if (groovyJar.isGroovyAll()) {
                    return Cast.cast(FileCollectionInternal.class, project.getLayout().filesFor(groovyJar.getFile()));
                }
