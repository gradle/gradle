...
public abstract class DefaultJvmTestSuite implements JvmTestSuite {
    ...
    public enum TestingFramework {
        ...
        SPOCK("org.spockframework", "spock-core", SPOCK_BASE_VERSION + "-groovy-3.0", Collections.singletonList(
    ...
    @Inject
    protected abstract BuildServiceRegistry getSharedServices();
    ...
    @VisibleForTesting
    public Provider<String> getDerivedSpockVersion() {
        return getSharedServices()
                .registerIfAbsent(SpockVersionBuildService.NAME, SpockVersionBuildService.class, s -> {})
                .flatMap(svbs -> svbs.getDerivedSpockVersion(getClasspathToSearchForGroovyRuntime()));
    }
