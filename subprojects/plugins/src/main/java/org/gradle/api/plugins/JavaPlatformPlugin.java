...
public abstract class JavaPlatformPlugin implements Plugin<Project> {
    ...
    private void createConfigurations(ProjectInternal project) {
        ...
        Configuration api = configurations.dependenciesUnlocked(API_CONFIGURATION_NAME);
        ...
        Configuration runtime = project.getConfigurations().dependenciesUnlocked(RUNTIME_CONFIGURATION_NAME);
        ...
        Configuration classpath = configurations.migratingUnlocked(CLASSPATH_CONFIGURATION_NAME, ConfigurationRolesForMigration.RESOLVABLE_BUCKET_TO_RESOLVABLE);
    ...
    private Configuration createConsumableRuntime(ProjectInternal project, Configuration apiElements, String name, String platformKind) {
        Configuration runtimeElements = project.getConfigurations().migratingUnlocked(name, ConfigurationRolesForMigration.CONSUMABLE_BUCKET_TO_CONSUMABLE);
    ...
    private Configuration createConsumableApi(ProjectInternal project, Configuration api, String name, String platformKind) {
        Configuration apiElements = project.getConfigurations().migratingUnlocked(name, ConfigurationRolesForMigration.CONSUMABLE_BUCKET_TO_CONSUMABLE);
