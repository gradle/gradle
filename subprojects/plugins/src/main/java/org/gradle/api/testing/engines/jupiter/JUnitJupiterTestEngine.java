...
abstract public class JUnitJupiterTestEngine implements TestEngine<JUnitJupiterTestEngineRegistration> {
    ...
    public Class<? extends TestEngineConfigurationParameters> getConfigurationParametersType() {
        return JUnitJupiterConfigurationParameters.class;
    }

    @Inject
    public JUnitJupiterTestEngine() {
    }

    @Override
    public Iterable<Dependency> getImplementationDependencies() {
        return singletonList(getDependencyFactory().create("org.junit.jupiter:junit-jupiter-engine:" + getRegistration().getVersion().get()));
    }
