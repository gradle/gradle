...
public abstract class AbstractAnnotationModelRuleDefinitionHandler implements MethodRuleDefinitionHandler {

    private Class annotationClass;

    public AbstractAnnotationModelRuleDefinitionHandler(Class annotationClass){
