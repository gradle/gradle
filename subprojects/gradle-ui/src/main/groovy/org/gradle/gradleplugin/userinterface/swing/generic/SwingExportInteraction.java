...
/**
 * Swing implementation of ExportInteraction. This prompts the user for a file
 * via the JFileChooser and handles reporting errors.
 *
 * @author mhunsicker
 */
public class SwingExportInteraction implements DOM4JSerializer.ExportInteraction {
    ...
    */
    ...
    public boolean confirmOverwritingExisingFile(File file) {
        int result = JOptionPane.showConfirmDialog(SwingUtilities.getWindowAncestor(parent), "The file '" + file.getAbsolutePath() + "' already exists. Overwrite?", "Confirm Overwriting File", JOptionPane.YES_NO_OPTION);
