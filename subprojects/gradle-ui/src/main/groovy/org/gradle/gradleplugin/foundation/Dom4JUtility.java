...
public class Dom4JUtility {
    /**
      This returns the node that is a child of the specified parent that has
      the specified 'name' and an attribute with the specified value. This is
      similar to the below getChild, but this requires a specific tag name.
   */
    ...
    /**
       Thie returns the node that is a child of hte specified parent that has
       the specified attribute with the specified value. This is similar to the
       above getChild, but no tag name is required.
    */
