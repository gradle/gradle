...
public class ListReorderer {
    ...
    */
    public static void moveTo(List sourceList, List moveList, int index) {
        ...
        {
            List newMoveList = new ArrayList(moveList);   //we don't want to actually affect the move list. Callers use it for visually selecting items after the move. So we'll make a duplicate and just recursively call ourselves again.
    ...
    */
    ...
    /**
       Sorts a child list by position in a parent list to preserve relative
    ...
    */
    ...
    /**
       Returns true if all the elements of the check list are at the end of the
       source list.
       @param  sourceList .
       @param  checkList  .
       @return .
