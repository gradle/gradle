...
/**
 * This is a basic filter where you can specify specific projects and tasks
...
public class BasicProjectAndTaskFilter implements ProjectAndTaskFilter, SettingsSerializable {
    ...
    /*package*/void setFilteredOutProjectNames(List<String> filteredOutProjectNames) {
    ...
    /*package*/ void setFilteredOutTaskNames(List<String> filteredOutTaskNames) {
    ...
    /*package*/void setFilterOutTasksWithNoDescription(boolean filterOutTasksWithNoDescription) {
        this.filterOutTasksWithNoDescription = filterOutTasksWithNoDescription;
    }
