 ...
 * using the ProcessLauncherServer. This is a special request where the results
 * are to build up a project/task tree.
 *
 * @author mhunsicker
 */
public class RefreshTaskListRequest extends AbstractRequest {
    ...
    public RefreshTaskListRequest(String fullCommandLine, ExecutionQueue executionQueue, ExecuteGradleCommandServerProtocol.ExecutionInteraction executionInteraction, GradlePluginLord gradlePluginLord) {
    ...
    */
    ...
    private class ExecutionInteractionWrapper implements TaskListServerProtocol.ExecutionInteraction {
        ...
        */
         ...
         */
        public void reportExecutionFinished(boolean wasSuccessful, String message, Throwable throwable, List<ProjectView> projects) {
