...
class CustomCoffeeScriptImplementationIntegrationSpec extends AbstractIntegrationSpec {

    def "can compile coffeescript with a custom implementation"() {
        def customCoffeeScriptImpl = file('coffeescrript/coffee-script.min.js') << getClass().getResource("/coffee-script.min.js").text
                    ...
                    play {
                        ...
                        binaries.all {
                            tasks.withType(PlayCoffeeScriptCompile) {
                                coffeeScriptJs = files("${customCoffeeScriptImpl.path}")
                            }
                        }
                    }
                }
