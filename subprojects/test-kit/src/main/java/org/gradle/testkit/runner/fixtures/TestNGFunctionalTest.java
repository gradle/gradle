...
import org.gradle.testkit.runner.internal.file.TestNGTemporaryDirectoryProvider;
...
/**
 * Test fixture for functional testing with TestKit compatible with TestNG.
 *
 * @since 4.2
 */
@Incubating
public abstract class TestNGFunctionalTest implements FunctionalTestSupport {

    private final FunctionalTestSupport delegate = new DefaultFunctionalTestSupport(new TestNGTemporaryDirectoryProvider());
