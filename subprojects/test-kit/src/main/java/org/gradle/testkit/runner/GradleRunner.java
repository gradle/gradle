...
public abstract class GradleRunner {
    ...
    /**
     * Resolves the plugin classpath from the plugin metadata file 'plugin-under-test-metadata.properties' and injects it for the build.
     * <p>
     * The plugin metadata file is automatically generated by the 'java-gradle-plugin'. It's recommended to apply the plugin to the project.
     * If the plugin metadata file cannot be resolved an {@link InvalidPluginMetadataException} is thrown. Subsequent invocations of the
     * method {@link #withPluginClasspath(Iterable)} will override the classpath resolved from the plugin metadata file.
     * <p>
     ...
     * @since 2.13
     */
    public abstract GradleRunner withPluginClasspath();
