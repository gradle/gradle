...
public class ProviderBackedFileCollection extends CompositeFileCollection {
    ...
    public ProviderBackedFileCollection(ProviderInternal<?> provider, PathToFileResolver resolver, TaskDependencyFactory taskDependencyFactory, Factory<PatternSet> patternSetFactory, ProviderResolutionStrategy providerResolutionStrategy, FileCollectionListener fileCollectionListener) {
    ...
    public void visitDependencies(TaskDependencyResolveContext context) {
        ...
        if (producer.isKnown()) {
            ...
            UnpackingVisitor unpackingVisitor = new UnpackingVisitor(context::add, resolver, taskDependencyFactory, patternSetFactory, fileCollectionListener);
    ...
    protected void visitChildren(Consumer<FileCollectionInternal> visitor) {
        UnpackingVisitor unpackingVisitor = new UnpackingVisitor(visitor, resolver, taskDependencyFactory, patternSetFactory, fileCollectionListener);
        unpackingVisitor.add(providerResolutionStrategy.resolve(provider));
    }
