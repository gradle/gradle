...
class DefaultCompositeFileTreeTest extends WorkspaceTest {
    ...
    def "can be empty"() {
        when:
        def ft = new DefaultCompositeFileTree(TestFiles.taskDependencyFactory(), TestFiles.patternSetFactory, [])
    ...
    def "contains all files"() {
        ...
        def composite = new DefaultCompositeFileTree(TestFiles.taskDependencyFactory(), TestFiles.patternSetFactory, [a, b])
    ...
    def "dependencies are union of dependencies of source trees"() {
        ...
        expect:
        def composite = new DefaultCompositeFileTree(TestFiles.taskDependencyFactory(), TestFiles.patternSetFactory, [tree1, tree2])
