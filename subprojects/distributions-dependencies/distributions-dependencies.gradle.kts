...
dependencies {
    constraints {
        api(libs.aether_connector)      { version { strictly("1.13.1") }}
        api(libs.ant)                   { version { strictly("1.10.8") }}
        api(libs.asm)                   { version { strictly("7.3.1") }}
        api(libs.asm_commons)           { version { strictly("7.3.1") }}
        api(libs.asm_tree)              { version { strictly("7.3.1") }}
        api(libs.asm_util)              { version { strictly("7.3.1") }}
        api(libs.asm_analysis)          { version { strictly("7.3.1") }}
        api(libs.awsS3_core)            { version { strictly("1.11.633") }}
        api(libs.awsS3_s3)              { version { strictly("1.11.633") }}
        api(libs.awsS3_kms)             { version { strictly("1.11.633") }}
        api(libs.bouncycastle_provider) { version { strictly("1.64") }}
        api(libs.bouncycastle_pgp)      { version { strictly("1.64") }}
        ...
        api(libs.jackson_core)          { version { strictly("2.10.2") }}
        api(libs.jackson_annotations)   { version { strictly("2.10.2") }}
        api(libs.jackson_databind)      { version { strictly("2.10.2") }}
        ...
        api(libs.maven3)                { version { strictly("3.0.5") }}
        api(libs.maven3_wagon_file)     { version { strictly("3.0.0") }}
        api(libs.maven3_wagon_http)     { version { strictly("3.0.0"); because("3.1.0 of wagon-http seems to break Digest authentication")  }}
        ...
        api(libs.pmaven_common)         { version { strictly("0.8-20100325") }}
        api(libs.pmaven_groovy)         { version { strictly("0.8-20100325") }}
        ...
        api(libs.slf4j_api)             { version { strictly("1.7.28") }}
        api(libs.jcl_to_slf4j)          { version { strictly("1.7.28") }}
        api(libs.jul_to_slf4j)          { version { strictly("1.7.28") }}
        api(libs.log4j_to_slf4j)        { version { strictly("1.7.28") }}
        api(libs.ansi_control_sequence_util) { version { strictly("0.2") }}
        api(libs.jetbrains_annotations) { version { strictly("13.0") }}
        api(libs.ant_launcher)          { version { strictly("1.10.8") }}
        api(libs.asm_util)              { version { strictly("7.3.1") }}
        api(libs.minlog)                { version { strictly("1.2") }}
        api(libs.aether_api)            { version { strictly("1.13.1") }}
        api(libs.aether_impl)           { version { strictly("1.13.1") }}
        api(libs.aether_spi)            { version { strictly("1.13.1") }}
        api(libs.aether_util)           { version { strictly("1.13.1") }}
        api(libs.google_api_client)     { version { strictly("1.25.0") }}
        api(libs.google_http_client)    { version { strictly("1.25.0") }}
        api(libs.google_http_client_jackson2) { version { strictly("1.25.0") }}
        api(libs.google_oauth_client)   { version { strictly("1.25.0") }}
        ...
        api(libs.maven3_aether_provider) { version { strictly("3.0.5") }}
        api(libs.maven3_artifact)       { version { strictly("3.0.5") }}
        api(libs.maven3_compat)         { version { strictly("3.0.5") }}
        api(libs.maven3_model)          { version { strictly("3.0.5") }}
        api(libs.maven3_model_builder)  { version { strictly("3.0.5") }}
        api(libs.maven3_plugin_api)     { version { strictly("3.0.5") }}
        api(libs.maven3_repository_metadata) { version { strictly("3.0.5") }}
        api(libs.maven3_settings)       { version { strictly("3.0.5") }}
        api(libs.maven3_settings_builder) { version { strictly("3.0.5") }}
        ...
        api(libs.maven3_wagon_http_shared) { version { strictly("3.0.0") }}
        api(libs.maven3_wagon_provider_api) { version { strictly("3.0.0") }}
        ...
        api(libs.sshdCore)              { version { strictly("2.0.0") }}
        api(libs.sshdScp)               { version { strictly("2.0.0") }}
        api(libs.sshdSftp)              { version { strictly("2.0.0") }}
        ...
        api(libs.archunit)              { version { strictly("0.11.0") }}
        api(libs.archunit_junit4)       { version { strictly("0.11.0") }}
