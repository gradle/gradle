...
class SamplesGosuCustomizedLayoutIntegrationTest extends AbstractIntegrationTest {

    @Rule public final Sample sample = new Sample(testDirectoryProvider, 'gosu/customizedLayout')
    @Rule public final ForkGosuCompileInDaemonModeFixture forkGosuCompileInDaemonModeFixture = new ForkGosuCompileInDaemonModeFixture(executer, testDirectoryProvider)
