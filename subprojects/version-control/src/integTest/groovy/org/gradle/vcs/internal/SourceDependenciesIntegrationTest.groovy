...
class SourceDependenciesIntegrationTest extends AbstractIntegrationSpec {
    ...
    void vcsMapping(String module, GitRepository repo, List<String> plugins=[]) {
        vcsMapping(settingsFile, module, repo.getWorkTree().name, plugins)
    }

    void nestedVcsMapping(GitRepository repo, String module, GitRepository target, List<String> plugins=[]) {
