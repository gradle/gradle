...
public class VersionControlServices extends AbstractPluginServiceRegistry {
    ...
    private static class VersionControlBuildSessionServices {
        ...
        VersionControlRepositoryConnectionFactory createVersionControlSystemFactory(CleanupActionDecorator cleanupActionDecorator, BuildTreeScopedCacheBuilderFactory scopedCache) {
            return new DefaultVersionControlRepositoryFactory(scopedCache, cleanupActionDecorator);
        }

        VcsDirectoryLayout createVcsWorkingDirectoryRoot(BuildTreeScopedCacheBuilderFactory scopedCache) {
            return new VcsDirectoryLayout(scopedCache);
        }

        PersistentVcsMetadataCache createMetadataCache(BuildTreeScopedCacheBuilderFactory scopedCache) {
