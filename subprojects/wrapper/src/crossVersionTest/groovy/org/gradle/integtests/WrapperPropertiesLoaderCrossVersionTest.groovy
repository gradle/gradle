...
class WrapperPropertiesLoaderCrossVersionTest extends CrossVersionIntegrationSpec {
    ...
    void "System properties defined in gradle.properties are available in buildSrc and in included builds"() {
        ...
        buildFile << '''
            ...
            println("overridden_by_includedBuild in root:                   ${project.findProperty('overridden_by_includedBuild') ?: 'false'} ")
            task hello { }
        '''
        file('buildSrc/build.gradle') << '''
            ...
            println("overridden_by_includedBuild in buildSrc:               ${project.findProperty('overridden_by_includedBuild') ?: 'false'} ")
        '''
        file('includedBuild/build.gradle') << '''
            ...
            println("overridden_by_includedBuild in included root:          ${project.findProperty('overridden_by_includedBuild') ?: 'false'} ")
        '''
        ...
        file('includedBuild/buildSrc/build.gradle') << '''
            ...
            println("overridden_by_includedBuild in included buildSrc:      ${project.findProperty('overridden_by_includedBuild') ?: 'false'} ")
        '''
        file('gradle.properties') << '''
            systemProp.system_property_available=true
            project_property_available=true
            overridden_by_includedBuild=false
        '''.stripIndent()
        file('includedBuild/gradle.properties') << '''
            overridden_by_includedBuild=true
        '''.stripIndent()
        ...
        output.contains('overridden_by_includedBuild in buildSrc:               false')
        ...
        output.contains('overridden_by_includedBuild in included buildSrc:      false')
        ...
        output.contains('overridden_by_includedBuild in included root:          true')
        output.contains('system_property_available in root:                     true')
        output.contains('project_property_available in root:                    true')
        output.contains('overridden_by_includedBuild in root:                   false')
