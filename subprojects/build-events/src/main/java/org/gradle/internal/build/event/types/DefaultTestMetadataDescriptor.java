 ...
 */
public final class DefaultTestMetadataDescriptor extends DefaultOperationDescriptor implements InternalTestMetadataDescriptor {
    public DefaultTestMetadataDescriptor(OperationIdentifier id, OperationIdentifier parentId) {
        super(id, "metadata", "metadata", parentId);
    }
}
