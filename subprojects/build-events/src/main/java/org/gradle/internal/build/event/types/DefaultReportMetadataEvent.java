...
public class DefaultReportMetadataEvent extends DefaultTestMetadataEvent implements InternalReportMetadataEvent {
    ...
    public DefaultReportMetadataEvent(long startTime, InternalTestMetadataDescriptor descriptor, Map<String, Object> values, long timestamp) {
        super(startTime, descriptor, values);
