...
class Binary2JUnitXmlReportGeneratorSpec extends Specification {
    ...
    def generatorWithMaxThreads(int numThreads) {
        buildOperationProcessor = new DefaultBuildOperationProcessor(Stub(WorkerLeaseRegistry), new TestBuildOperationExecutor(), new DefaultBuildOperationQueueFactory(), new DefaultExecutorFactory(), numThreads)
