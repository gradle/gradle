...
public class JUnitPlatformTestClassProcessorFactory implements WorkerTestClassProcessorFactory, Serializable {
    ...
    public TestClassProcessor create(ServiceRegistry serviceRegistry) {
        // We load the TestClassProcessor via reflection since testing-jvm builds with java 6 and testing-junit-platform builds with java 8.
        // We assume the processor is on the classpath since we declare it as a runtime dependency in :distributions-core
