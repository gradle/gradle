...
public class TestReport extends DefaultTask {
     ...
     * </ul>
     *
     * @deprecated Use {@link #getTestResults()} and invoke {@link ConfigurableFileCollection#from(Object...)} instead, passing references to {@link Test#getBinaryResultsDirectory()} as arguments.
