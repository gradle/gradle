...
import org.gradle.api.plugins.jvm.internal.JUnitJupiterToolchain
import org.gradle.api.plugins.jvm.internal.KotlinTestToolchain
import org.gradle.api.plugins.jvm.internal.SpockToolchain
import org.gradle.api.plugins.jvm.internal.TestNGToolchain
...
class TestSuitesIntegrationTest extends AbstractIntegrationSpec {
        ...
        buildFile << """
            ...
            tasks.test {
                doLast {
                    ...
                    assert classpath.any { it.name == "junit-jupiter-${JUnitJupiterToolchain.DEFAULT_VERSION}.jar" }
                }
            }
        """
    ...
    def "configuring test framework on custom test suite is honored in task and dependencies with #testingFrameworkDeclaration"() {
        ...
        'useJUnitJupiter()'          | JUnitPlatformTestFramework | "junit-jupiter-${JUnitJupiterToolchain.DEFAULT_VERSION}.jar"
        'useJUnitJupiter("5.7.1")'   | JUnitPlatformTestFramework | "junit-jupiter-5.7.1.jar"
        'useSpock()'                 | JUnitPlatformTestFramework | "spock-core-${SpockToolchain.DEFAULT_VERSION}.jar"
        ...
        'useKotlinTest()'            | JUnitPlatformTestFramework | "kotlin-test-junit5-${KotlinTestToolchain.DEFAULT_VERSION}.jar"
        'useKotlinTest("1.5.30")'    | JUnitPlatformTestFramework | "kotlin-test-junit5-1.5.30.jar"
        'useTestNG()'                | TestNGTestFramework        | "testng-${TestNGToolchain.DEFAULT_VERSION}.jar"
