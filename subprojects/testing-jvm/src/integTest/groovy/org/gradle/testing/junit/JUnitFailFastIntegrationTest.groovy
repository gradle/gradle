...
class JUnitFailFastIntegrationTest extends AbstractIntegrationSpec {
    private static final String FAILED_RESOURCE = "fails"
    private static final String OTHER_RESOURCE = "other"
    ...
    def "all tests run without fail fast"() {
        given:
        buildFile << testableJavaProject('junit:junit:4.12', MAX_WORKERS) // TODO: inline this?
        withFailingTest()
        withNonfailingTest()
