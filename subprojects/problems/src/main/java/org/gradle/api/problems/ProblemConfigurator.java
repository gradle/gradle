...
public interface ProblemConfigurator {
     ...
     * @return this
     */
    ProblemConfigurator details(String details);
     ...
     * @return this
     */
    ProblemConfigurator solution(String solution);
     ...
     * @return this
     */
    ProblemConfigurator additionalData(String key, String value);
     ...
     * @return this
     */
    ProblemConfigurator withException(RuntimeException e);
     ...
     * @return this
     */
    ProblemConfigurator severity(Severity severity);
}
