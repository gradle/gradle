...
public class ProfileReportRenderer {
    ...
    private static class ProfilePageRenderer extends TabbedPageRenderer<BuildProfile> {
        ...
        protected ReportRenderer<BuildProfile, SimpleHtmlWriter> getHeaderRenderer() {
            return new BuildProfileSimpleHtmlWriterReportRenderer2();
        }

        @Override
        protected  ReportRenderer<BuildProfile, SimpleHtmlWriter> getContentRenderer() {
            return new BuildProfileSimpleHtmlWriterReportRenderer();
        }

        private static class BuildProfileSimpleHtmlWriterReportRenderer extends ReportRenderer<BuildProfile, SimpleHtmlWriter> {
            @Override
        ...
        private static class BuildProfileSimpleHtmlWriterReportRenderer2 extends ReportRenderer<BuildProfile, SimpleHtmlWriter> {
            @Override
            public void render(BuildProfile model, SimpleHtmlWriter htmlWriter) throws IOException {
