...
class ScalaPluginTest {
    ...
    @Test void addsScalaDocTasksToTheProject() {
        ...
        assertThat(task.classpath, FileCollectionMatchers.sameCollection(project.layout.mutableFilesFor(project.sourceSets.main.output, project.sourceSets.main.compileClasspath)))
