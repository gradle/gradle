 ...
 */
public class ResolvedConfigurationListenerFactory {
    public ResolvedConfigurationListener create(DependencyGraphListener dependencyGraphListener) {
        if (dependencyGraphListener == null) {
            return new NoOpDependencyGraphListener();
        }
        return new DependencyGraphProvider(dependencyGraphListener);
    }
