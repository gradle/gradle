...
class MavenSftpRepoResolveIncompatibleJavaVersionIntegrationTest extends AbstractIntegrationSpec {
    void "cannot resolve dependencies from a SFTP Maven repository for incompatible Java version"() {
        given:
        buildFile << """
            repositories {
                maven {
