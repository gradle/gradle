...
class RefreshWhenMissingInAllRepositoriesCachePolicyTest extends Specification {
    ...
    private RefreshWhenMissingInAllRepositoriesCachePolicy policy = new RefreshWhenMissingInAllRepositoriesCachePolicy(delegateCachePolicy, moduleDescriptorCache);
