...
public class DefaultDependencyFactoryTest {
    ...
    public void testCreateDependencyWithInvalidDescriptionShouldThrowInvalidUserDataEx() {
        final CliendModuleNotationParser testImplStringFactoryStub = context.mock(CliendModuleNotationParser.class, "String");
        context.checking(new Expectations() {{
    ...
    public void createModule() {
        final CliendModuleNotationParser testImplStringFactoryStub = context.mock(CliendModuleNotationParser.class, "String");
        final CliendModuleNotationParser clientModuleFactoryStub = context.mock(CliendModuleNotationParser.class);
