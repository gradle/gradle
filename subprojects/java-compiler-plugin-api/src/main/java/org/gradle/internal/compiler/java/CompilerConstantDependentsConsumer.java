...
/**
 * API class for consuming constants and it's dependents from Compiler Plugin
 */
public interface CompilerConstantDependentsConsumer {
     ...
     * }
     */
    void consumePublicDependent(String constantOrigin, String constantDependent);
     ...
     * }
     */
    void consumePrivateDependent(String constantOrigin, String constantDependent);
