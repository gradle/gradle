...
public interface BuildLifecycleAwareVirtualFileSystem extends VirtualFileSystem {
     ...
     */
    void afterBuildStarted(boolean watchingEnabled, boolean verboseVfsLogging, boolean debugWatchLogging, BuildOperationRunner buildOperationRunner);
     ...
     */
    void beforeBuildFinished(boolean watchingEnabled, boolean verboseVfsLogging, boolean debugWatchLogging, BuildOperationRunner buildOperationRunner, int maximumNumberOfWatchedHierarchies);
}
