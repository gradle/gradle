...
import org.gradle.internal.logging.serializer.LogGroupHeaderEventSerializer;
...
public class DaemonMessageSerializer {
    public static Serializer<Message> create() {
        ...
        registry.register(LogGroupHeaderEvent.class, new LogGroupHeaderEventSerializer(logLevelSerializer, new ListSerializer<StyledTextOutputEvent.Span>(new SpanSerializer(factory.getSerializerFor(StyledTextOutput.Style.class))), buildOperationCategorySerializer));
