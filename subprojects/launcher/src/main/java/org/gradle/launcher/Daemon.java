...
public class Daemon implements Runnable {
    ...
    public Daemon(ServiceRegistry loggingServices, DaemonServerConnector connector, StartParameter startParameter) {
    ...
    public void run() {
        ...
        connector.accept(idleTimeout, new IncomingConnectionHandler() {
