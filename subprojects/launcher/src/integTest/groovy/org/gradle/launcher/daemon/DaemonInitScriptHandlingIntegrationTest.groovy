...
class DaemonInitScriptHandlingIntegrationTest extends DaemonIntegrationSpec {
    ...
    def "init scripts from client distribution are used, not the one the daemon was started with"() {
        ...
        distro2Result.assertOutputContains "buildSrc: runtime gradle home: ${distro2.absolutePath}"
        distro2Result.assertOutputContains "main build: runtime gradle home: ${distro2.absolutePath}"
