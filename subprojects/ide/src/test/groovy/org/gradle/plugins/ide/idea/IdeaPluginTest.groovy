...
class IdeaPluginTest extends AbstractProjectBuilderSpec {
    ...
    def "adds special configuration if Java plugin is applied"() {
        ...
        project.idea.module.scopes == [
                PROVIDED: [plus: [project.configurations.compileClasspath, project.configurations.annotationProcessorClasspath], minus: []],
                COMPILE: [plus: [], minus: []],
                RUNTIME: [plus: [project.configurations.runtimeClasspath], minus: []],
                TEST: [plus: [project.configurations.testCompileClasspath, project.configurations.testRuntimeClasspath, project.configurations.testAnnotationProcessorClasspath], minus: []],
        ]
    }
