...
class FixedExclusiveModeCrossProcessCacheAccessTest extends Specification {
    ...
    def cacheAccess = new FixedExclusiveModeCrossProcessCacheAccess("<cache>", file, new DefaultLockOptions(FileLockManager.LockMode.Exclusive), lockManager, initAction, onOpenAction, onCloseAction)
