...
class DefaultCacheFactoryTest extends Specification {
    ...
    void "creates directory backed cache instance"() {
        when:
        def cache = factory.open(tmpDir.testDirectory, "<display>", [prop: 'value'], new DefaultLockOptions(Shared), null, null)
    ...
    void "reuses directory backed cache instances"() {
        when:
        def ref1 = factory.open(tmpDir.testDirectory, null, [prop: 'value'], new DefaultLockOptions(Exclusive), null, null)
        def ref2 = factory.open(tmpDir.testDirectory, null, [prop: 'value'], new DefaultLockOptions(Exclusive), null, null)
    ...
    void "closes cache instance when factory is closed"() {
        ...
        when:
        factory.open(tmpDir.testDirectory, null, [prop: 'value'], new DefaultLockOptions(Exclusive), null, null)
    ...
    void "closes cache instance when reference is closed"() {
        ...
        when:
        def cache1 = factory.open(tmpDir.testDirectory, null, [prop: 'value'], new DefaultLockOptions(Exclusive), null, null)
        def cache2 = factory.open(tmpDir.testDirectory, null, [prop: 'value'], new DefaultLockOptions(Exclusive), null, null)
    ...
    void "can close cache multiple times"() {
        ...
        when:
        def cache = factory.open(tmpDir.testDirectory, null, [prop: 'value'], new DefaultLockOptions(Exclusive), null, null)
    ...
    void "fails when directory cache is already open with different properties"() {
        ...
        when:
        factory.open(tmpDir.testDirectory, null, [prop: 'other'], new DefaultLockOptions(Exclusive), null, null)
    ...
    void "fails when directory cache when cache is already open with different lock mode"() {
        given:
        factory.open(tmpDir.testDirectory, null, [prop: 'value'], new DefaultLockOptions(Shared), null, null)
    ...
    void "can visit all caches created by factory"() {
        ...
        when:
        factory.open(tmpDir.testDirectory.file('foo'), "foo", [prop: 'value'], new DefaultLockOptions(Shared), null, null)
        factory.open(tmpDir.testDirectory.file('bar'), "bar", [prop: 'value'], new DefaultLockOptions(Shared), null, null)
        factory.open(tmpDir.testDirectory.file('baz'), "baz", [prop: 'value'], new DefaultLockOptions(Shared), null, null)
    ...
    void "does not visit caches that have been closed"() {
        ...
        when:
        factory.open(tmpDir.testDirectory.file('foo'), "foo", [prop: 'value'], new DefaultLockOptions(Shared), null, null)
        def bar = factory.open(tmpDir.testDirectory.file('bar'), "bar", [prop: 'value'], new DefaultLockOptions(Shared), null, null)
        factory.open(tmpDir.testDirectory.file('baz'), "baz", [prop: 'value'], new DefaultLockOptions(Shared), null, null)
