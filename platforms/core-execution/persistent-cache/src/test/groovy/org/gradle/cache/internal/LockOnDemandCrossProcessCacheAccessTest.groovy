...
class LockOnDemandCrossProcessCacheAccessTest extends ConcurrentSpec {
    ...
    def cacheAccess = new LockOnDemandCrossProcessCacheAccess("<cache>", file, new DefaultLockOptions(FileLockManager.LockMode.Exclusive), lockManager, new ReentrantLock(), Stub(CacheInitializationAction), Stub(Action), Stub(Action))
    ...
    def "initializes cache after lock is acquired"() {
        ...
        def contendedAction
        def cacheAccess = new LockOnDemandCrossProcessCacheAccess("<cache>", file, new DefaultLockOptions(FileLockManager.LockMode.Exclusive), lockManager, new ReentrantLock(), initAction, Stub(Action), Stub(Action))
    ...
    def "notifies handler when lock is acquired and released"() {
        ...
        def signal = Mock(FileLockReleasedSignal)
        def contendedAction
        def cacheAccess = new LockOnDemandCrossProcessCacheAccess("<cache>", file, new DefaultLockOptions(FileLockManager.LockMode.Exclusive), lockManager, new ReentrantLock(), Stub(CacheInitializationAction), onOpen, onClose)
