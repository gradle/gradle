...
@NonNullApi
public class InetSocketFileLockCommunicator implements FileLockCommunicator {
    private static final Logger LOGGER = LoggerFactory.getLogger(InetSocketFileLockCommunicator.class);
    ...
    public InetSocketFileLockCommunicator(InetAddressProvider inetAddressProvider) {
    ...
    public FileLockPacket receive() throws GracefullyStoppedException {
        try {
            ...
            return FileLockPacket.of(packet);
        } catch (IOException e) {
            if (!stopped) {
