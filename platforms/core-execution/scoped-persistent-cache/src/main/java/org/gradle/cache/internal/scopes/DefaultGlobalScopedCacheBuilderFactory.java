...
public class DefaultGlobalScopedCacheBuilderFactory extends AbstractScopedCacheBuilderFactory
        implements GlobalScopedCacheBuilderFactory, GlobalCache {
    public DefaultGlobalScopedCacheBuilderFactory(
