...
public class AssignImmutableWorkspaceStep<C extends IdentityContext> implements Step<C, WorkspaceResult> {
    ...
    private WorkspaceResult executeInWorkspace(UnitOfWork work, C context, LockingImmutableWorkspace workspace) {
        WorkspaceContext workspaceContext = new WorkspaceContext(context, workspace.getImmutableLocation(), null, true);
