...
public class CheckDependenciesStep<C extends IdentityContext, R extends Result> implements Step<C, R> {
    private final ExecutionProblemHandler problemHandler;
    private final Step<? super IdentityContext, ? extends R> delegate;

    public CheckDependenciesStep(
    ...
    public R execute(UnitOfWork work, C context) {
        work.checkDependencies(context.getValidationContext());
        problemHandler.handleReportedProblems(work, context.getValidationContext());
