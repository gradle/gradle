        ...
        if (valueType.isPrimitive() && propertyMetadata.isAnnotationPresent(Optional.class)) {
            validationContext.visitPropertyProblem(problem ->
                problem
                    ...
                    .noLocation()
                    .category(CATEGORY_VALIDATION, "property", TextUtil.screamingSnakeToKebabCase(CANNOT_USE_OPTIONAL_ON_PRIMITIVE_TYPES))
        ...
        if (File.class.isAssignableFrom(valueType)
            ...
            validationContext.visitPropertyProblem(problem ->
                problem
                    ...
                    .noLocation()
                    .category(CATEGORY_VALIDATION, "property", TextUtil.screamingSnakeToKebabCase(INCORRECT_USE_OF_INPUT_ANNOTATION))
                    .severity(Severity.ERROR)
        ...
        if (valueTypes.stream().anyMatch(URL.class::isAssignableFrom)) {
            validationContext.visitPropertyProblem(problem ->
                problem
                    ...
                    .noLocation()
                    .category(CATEGORY_VALIDATION, "property", TextUtil.screamingSnakeToKebabCase(UNSUPPORTED_VALUE_TYPE))
                    .severity(WARNING)
