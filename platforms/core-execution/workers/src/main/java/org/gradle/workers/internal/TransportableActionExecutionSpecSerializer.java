...
public class TransportableActionExecutionSpecSerializer implements Serializer<TransportableActionExecutionSpec> {
    ...
    public void write(Encoder encoder, TransportableActionExecutionSpec spec) throws Exception {
        ...
        encoder.writeString(spec.getSettingsDir().getAbsolutePath());
    ...
    public TransportableActionExecutionSpec read(Decoder decoder) throws Exception {
        ...
        String settingsDirPath = decoder.readString();
        ...
        return new TransportableActionExecutionSpec(implementationClassName, serializedParameters, classLoaderStructure, new File(settingsDirPath), new File(baseDirPath), new File(projectCacheDir), usesInternalServices);
    }
}
