...
public class WorkerDaemonStarter {
    ...
    public WorkerDaemonStarter(
            WorkerProcessFactory workerDaemonProcessFactory,
    ...
    WorkerDaemonClient startDaemon(DaemonForkOptions forkOptions) {
        ...
        MultiRequestWorkerProcessBuilder<TransportableActionExecutionSpec, DefaultWorkResult> builder =
                workerDaemonProcessFactory.multiRequestWorker(WorkerDaemonServer.class);
        ...
        builder.applicationClasspath(
                classPathRegistry.getClassPath("DAEMON_SERVER_WORKER").getAsFiles());
        ...
        if (forkOptions.getClassLoaderStructure() instanceof FlatClassLoaderStructure) {
            FlatClassLoaderStructure flatClassLoaderStructure =
                    (FlatClassLoaderStructure) forkOptions.getClassLoaderStructure();
        ...
        builder.registerArgumentSerializer(
        ...
        WorkerDaemonClient client = new WorkerDaemonClient(
                forkOptions, workerDaemonProcess, workerProcess, loggingManager.getLevel(), actionExecutionSpecFactory);
