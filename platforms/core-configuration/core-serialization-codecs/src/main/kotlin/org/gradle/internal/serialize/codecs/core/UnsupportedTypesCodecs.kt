...
fun BindingsBuilder.unsupportedTypes() {
    ...
    bind(unsupported<org.gradle.api.artifacts.ResolvedConfiguration>())
    @Suppress("DEPRECATION")
    bind(unsupported<org.gradle.api.artifacts.LenientConfiguration>())
    ...
    @Suppress("DEPRECATION")
    bind(unsupported<org.gradle.api.artifacts.ResolvedDependency>())
    @Suppress("DEPRECATION")
    bind(unsupported<org.gradle.api.artifacts.ResolvedArtifact>())
