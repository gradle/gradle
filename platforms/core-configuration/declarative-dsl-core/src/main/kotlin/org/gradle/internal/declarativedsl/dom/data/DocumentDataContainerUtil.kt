...
fun <D> BasicNodeDataContainer<D>.collectToMap(document: DeclarativeDocument): Map<DeclarativeDocument.DocumentNode, D> =
    buildMap {
...
fun <D, C> C.collectToMap(document: DeclarativeDocument): Map<DeclarativeDocument.Node, D> where C : BasicNodeDataContainer<out D>, C : BasicValueDataContainer<out D> =
    buildMap {
