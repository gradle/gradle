...
class GenericOpaqueTypesTest {
    ...
    fun `reports illegal parameterized types used as container types`() {
        ...
        assertEquals(
            "Container types must not have any type parameters. Illegal type parameters: T\n" +
                "  in class 'org.gradle.internal.declarativedsl.schemaBuidler.GenericOpaqueTypesTest.GenericType'",
            exception.message
        )
    }
