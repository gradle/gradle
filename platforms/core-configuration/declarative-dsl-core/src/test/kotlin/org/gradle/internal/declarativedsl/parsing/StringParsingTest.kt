...
class StringParsingTest {
    ...
    fun `empty or blank`() {
        ...
        val expected = """
                ...
                Assignment [indexes: 7..17, line/column: 2/1..2/11, file: test] (
                    lhs = NamedReference [indexes: 7..8, line/column: 2/1..2/2, file: test] (
                        name = b
                    )
    ...
    fun `escape chars`() {
        ...
        val expected = """
                ...
                |    lhs = NamedReference [indexes: 92..93, line/column: 3/1..3/2, file: test] (
                |        name = q
                |    )
    ...
    fun `multi-line`() {
        ...
        val expected = """
                ...
                Assignment [indexes: 14..29, line/column: 2/1..4/5, file: test] (
                    lhs = NamedReference [indexes: 14..15, line/column: 2/1..2/2, file: test] (
                        name = b
                    )
    ...
    fun `templates`() {
        ...
        val expected = """
                ...
                |    lhs = NamedReference [indexes: 98..99, line/column: 9/1..9/2, file: test] (
                |        name = g
                |    )
                ...
                |    lhs = NamedReference [indexes: 132..133, line/column: 11/1..11/2, file: test] (
                |        name = i
                |    )
