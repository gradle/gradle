...
class StringParsingTest {
    ...
    fun `escape chars`() {
        ...
        val expected = """
                LocalValue [indexes: 0..31, line/column: 1/1..1/32, file: test] (
                    name = s
                    rhs = StringLiteral [indexes: 8..31, line/column: 1/9..1/32, file: test] (_______)
                )
                LocalValue [indexes: 33..78, line/column: 3/1..7/5, file: test] (
                    name = m
                    rhs = StringLiteral [indexes: 41..78, line/column: 3/9..7/5, file: test] (a
        ...
        // TODO: this is weird, definitely not ok ...
    }
    ...
    fun `multi-line`() {
        ...
        val expected = """
                LocalValue [indexes: 0..17, line/column: 1/1..1/18, file: test] (
                    name = a
                    rhs = StringLiteral [indexes: 8..17, line/column: 1/9..1/18, file: test] (abc)
                )
    ...
    fun `templates`() {
        ...
        val expected = """
                ...
                |)
                |LocalValue [indexes: 14..28, line/column: 2/1..2/15, file: test] (
                |    name = b
                |    rhs = StringLiteral [indexes: 22..28, line/column: 2/9..2/15, file: test] ()
                |)
                |LocalValue [indexes: 29..47, line/column: 3/1..3/19, file: test] (
                |    name = c
                |    rhs = StringLiteral [indexes: 37..47, line/column: 3/9..3/19, file: test] ()
                |)
                |LocalValue [indexes: 48..68, line/column: 4/1..4/21, file: test] (
                |    name = d
                |    rhs = StringLiteral [indexes: 56..68, line/column: 4/9..4/21, file: test] ( "" )
                |)
                |LocalValue [indexes: 69..91, line/column: 5/1..5/23, file: test] (
                |    name = e
                |    rhs = StringLiteral [indexes: 77..91, line/column: 5/9..5/23, file: test] ( "" )
                |)
                |LocalValue [indexes: 92..121, line/column: 6/1..8/4, file: test] (
                |    name = f
                |    rhs = StringLiteral [indexes: 100..121, line/column: 6/9..8/4, file: test] (
                |${'\u0020'}${'\u0020'}
                |)
                |)
                ...
                |)
                |LocalValue [indexes: 139..163, line/column: 10/1..10/25, file: test] (
                |    name = h
                |    rhs = StringLiteral [indexes: 147..163, line/column: 10/9..10/25, file: test] (\foo)
                |)
        ...
        // TODO: string templates are supposed to be an unsupported language feature...
        // TODO: check results agains https://github.com/JetBrains/kotlin/blob/master/compiler/testData/diagnostics/tests/MultilineStringTemplates.kt
    }
