...
abstract public class DefaultJavaSoftwareType implements JavaSoftwareType {
    private final NamedDomainObjectContainer<HasSources.JavaSources> sourcesContainer;

    @Inject
    public DefaultJavaSoftwareType(ObjectFactory objectFactory) {
        this.sourcesContainer = objectFactory.domainObjectContainer(HasSources.JavaSources.class, name -> objectFactory.newInstance(DefaultJavaSources.class, name));
    }
