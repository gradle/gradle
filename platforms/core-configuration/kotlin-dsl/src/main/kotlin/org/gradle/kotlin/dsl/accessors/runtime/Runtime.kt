...
fun applySoftwareFeature(
    ...
    val context = when (target) {
        is ProjectInternal -> object : SoftwareFeatureSupportInternal.SoftwareFeatureContext {
            override fun getSoftwareFeatureApplicator(): SoftwareFeatureApplicator = target.serviceOf<SoftwareFeatureApplicator>()
            override fun getSoftwareFeatureRegistry(): SoftwareFeatureRegistry = target.serviceOf<SoftwareFeatureRegistry>()
        }
        else -> SoftwareFeatureSupportInternal.getContext(target)
    }
