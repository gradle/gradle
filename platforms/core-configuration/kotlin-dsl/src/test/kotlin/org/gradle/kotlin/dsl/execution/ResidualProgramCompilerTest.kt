...
class ResidualProgramCompilerTest : TestWithCompiler() {
    ...
    fun `Dynamic(Static(CloseTargetScope))`() {
        ...
        val stage2ProgramId = ProgramId(stage2SettingsTemplateId, scriptHost.scriptSource.fileName, sourceHash, mock())
    ...
    inner class TopLevelProgramVerifier<T : Any>(
        ...
        val programId = ProgramId(scriptTemplateId, scriptHost.scriptSource.fileName, sourceHash, mock())
