...
public class DirectNodeNoInputsModelAction<T> extends AbstractModelActionWithView<T> {
    ...
    private DirectNodeNoInputsModelAction(
            ModelReference<T> subjectReference,
            ModelRuleDescriptor descriptor,
            BiAction<? super MutableModelNode, ? super T> action) {
    ...
    public static <T> ModelAction of(
            ...
            ModelRuleDescriptor descriptor,
            final Action<? super MutableModelNode> action) {
