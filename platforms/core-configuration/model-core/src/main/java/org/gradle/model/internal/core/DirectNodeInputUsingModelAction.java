...
public class DirectNodeInputUsingModelAction<T> extends AbstractModelActionWithView<T> {
    ...
    public static <T> DirectNodeInputUsingModelAction<T> of(
            ModelReference<T> modelReference,
            ModelRuleDescriptor descriptor,
            List<? extends ModelReference<?>> inputs,
            TriAction<? super MutableModelNode, ? super T, ? super List<ModelView<?>>> action) {
    ...
    public static <T> ModelAction of(
            ModelReference<T> reference,
            ModelRuleDescriptor descriptor,
            List<? extends ModelReference<?>> input,
            final BiAction<? super MutableModelNode, ? super List<ModelView<?>>> action) {
    ...
    public static <T, I> ModelAction of(
            ModelReference<T> reference,
            ModelRuleDescriptor descriptor,
            ModelReference<I> input,
            final BiAction<? super MutableModelNode, ? super I> action) {
        return new AbstractModelAction<T>(reference, descriptor, input) {
            @Override
            public void execute(MutableModelNode modelNode, List<ModelView<?>> inputs) {
    ...
    public static <T, I, J> ModelAction of(
            ModelReference<T> reference,
            ModelRuleDescriptor descriptor,
            ModelReference<I> input1,
            ModelReference<J> input2,
            final TriAction<? super MutableModelNode, ? super I, ? super J> action) {
