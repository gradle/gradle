...
public class DefaultExtraPropertiesExtension extends GroovyObjectSupport implements ExtraPropertiesExtensionInternal {
    ...
    public boolean has(String name) {
        ...
        if (gradleProperties != null) {
            return gradleProperties.hasGradleProperty(name);
        }
    ...
    private Object find(String name) {
        ...
        if (gradleProperties != null) {
            return gradleProperties.getGradleProperty(name);
        }
    ...
    public Object getProperty(String name) {
        ...
        if (gradleProperties != null && gradleProperties.hasGradleProperty(name)) {
            return gradleProperties.getGradleProperty(name);
        }
    ...
    @Override
    public void attachGradleProperties(ExtraPropertiesGradlePropertiesLookup gradleProperties) {
