...
public class DefaultExtraPropertiesGradlePropertiesLookup implements ExtraPropertiesGradlePropertiesLookup {
    ...
    @Override
    public boolean hasGradleProperty(String propertyName) {
        Object value = gradleProperties.get(propertyName);
        accessListener.onGradlePropertyAccess(propertyName, value);
        return gradleProperties.containsKey(propertyName);
    }

    @Override
    public @Nullable Object getGradleProperty(String propertyName) {
        Object value = gradleProperties.get(propertyName);
        accessListener.onGradlePropertyAccess(propertyName, value);
        return value;
    }
