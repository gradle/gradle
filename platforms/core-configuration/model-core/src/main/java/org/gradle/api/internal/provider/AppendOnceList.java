 ...
 * <p>
 * Appending an element to the list can only be done once, because the internal buffer is shared by this list and the new one.
 * <p>
 * Unlike the {@code PersistentList}, appends elements to the back.
 *
