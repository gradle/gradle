...
public abstract class MapWithPrefixedKeysValueSource<P extends MapWithPrefixedKeysValueSource.Parameters>
        implements ValueSource<Map<String, String>, P> {
    ...
    protected Map<String, String> collectWithKeyPrefix(String prefix, Stream<Map.Entry<String, String>> items) {
        return items.filter(e -> e.getKey().startsWith(prefix))
