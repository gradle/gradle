...
"""
        ...
        then:
        failure.assertHasDescription("Execution failed for task ':wrongRuntimeElementType' (created in build file 'build.gradle').")
        ...
        then:
        failure.assertHasDescription("Execution failed for task ':wrongPropertyElementTypeDsl' (created in build file 'build.gradle').")
        ...
        then:
        failure.assertHasDescription("Execution failed for task ':wrongPropertyElementTypeApi' (created in build file 'build.gradle').")
        failure.assertHasCause("Cannot set the value of a property of type java.util.List with element type java.lang.String using a provider with element type java.lang.Integer.")
    }
