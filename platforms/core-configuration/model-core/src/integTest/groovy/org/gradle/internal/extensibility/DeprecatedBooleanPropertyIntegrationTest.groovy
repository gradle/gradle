...
class DeprecatedBooleanPropertyIntegrationTest extends AbstractIntegrationSpec {
    ...
    def "emits deprecation warning when a decorated class exposes a Boolean is-getter"() {
        ...
        executer.expectDocumentedDeprecationWarning("Referencing 'property' as a property declared with an 'is-' method with a Boolean type on extension 'myext' has been deprecated. " +
            "Starting with Gradle 10.0, this property will no longer be treated like a property. " +
