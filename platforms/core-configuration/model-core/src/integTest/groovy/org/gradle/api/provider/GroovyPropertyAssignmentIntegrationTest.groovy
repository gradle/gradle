...
class GroovyPropertyAssignmentIntegrationTest extends AbstractProviderOperatorIntegrationTest {
    ...
    def "lazy collection properties assignment for #description"() {
        ...
        "Collection<T> << T[]"                   | "<<"      | "ListProperty<MyObject>"        | '[new MyObject("a")] as MyObject[]'                      | unsupportedWithCause("Cannot get the value of a property of type java.util.List with element type MyObject as the source value contains an element of type java.util.ArrayList")
