...
class CachingTaskDependencyResolveContextTest extends Specification {
    ...
    private final TaskDependencyInternal dependency = Mock(TaskDependencyInternal)
    ...
    def resolvesBuildableWithInternalTaskDependency() {
        Buildable buildable = Mock()
        TaskDependency otherDependency = Mock(TaskDependencyInternal)
    ...
    def cachesResultForTaskDependency() {
        TaskDependencyInternal otherDependency = Mock(TaskDependencyInternal)
        TaskDependencyContainer otherDependency2 = Mock()
    ...
    def cachesResultForTaskDependencyInternal() {
        TaskDependencyInternal otherDependency = Mock(TaskDependencyInternal)
        TaskDependencyInternal otherDependency2 = Mock(TaskDependencyInternal)
