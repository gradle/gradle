...
class ConfigurationCacheFingerprintWriter(
    ...
    private fun fingerprintBuildSrcPresence() {
    ...
    fun captureBuildSrcPresence(buildState: BuildState) {
        ...
        if (!BuildSrcDetector.isValidBuildSrcBuild(candidateBuildSrc)) {
            buildScopedSink.write(ConfigurationCacheFingerprint.MissingBuildSrc(candidateBuildSrc))
        }
    }
