...
internal class DefaultConfigurationCacheDegradationController(
    ...
    private fun collectDegradationReasons(): DegradationDecision = if (buildModelParameters.isRequiresToolingModels) {
        DegradationDecision(emptyMap(), emptyMap())
    } else {
        DegradationDecision(
    ...
    data class DegradationDecision(
        ...
        fun onDegradedTask(consumer: (Task, List<String>) -> Unit) {
