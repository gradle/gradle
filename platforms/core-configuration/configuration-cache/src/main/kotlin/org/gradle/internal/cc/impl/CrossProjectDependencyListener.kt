...
interface CrossProjectDependencyListener {
    /**
     ...
     */
    fun onProjectCoupling(referrer: ProjectState, target: ProjectState)

    fun onProjectDependency(referrer: ProjectState, target: ProjectState)
}
