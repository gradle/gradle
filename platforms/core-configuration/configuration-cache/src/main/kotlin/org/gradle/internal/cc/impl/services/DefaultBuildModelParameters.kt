...
data class DefaultBuildModelParameters(
    ...
    private val resilientModels: String // Comma separated list of models that should be built resiliently.
    ...
    override fun getResilientModels(): String = resilientModels
}
