...
import org.gradle.integtests.fixtures.configurationcache.ConfigurationCacheExecutionResultProblemsFixture
...
abstract class AbstractConfigurationCacheOptInFeatureIntegrationTest extends AbstractIntegrationSpec {
    ...
    protected ConfigurationCacheExecutionResultProblemsFixture problems
    ...
    def setup() {
        ...
        problems = new ConfigurationCacheExecutionResultProblemsFixture(testDirectory)
    }
