...
public class FetchCustomModelForProjectsByPath implements BuildAction<List<SomeToolingModel>> {
    private final Collection<String> projectPaths;

    public FetchCustomModelForProjectsByPath(Collection<String> projectPaths) {
