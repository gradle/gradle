...
) = InterpretationSequence(listOf(ProjectInterpretationSequenceStep("project", AssignmentGenerationId.PROPERTY_ASSIGNMENT, softwareTypeRegistry) { projectEvaluationSchema(softwareTypeRegistry) }))
