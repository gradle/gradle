...
/**
 * Generates a {@code @BindsProjectFeature}-annotated plugin with a single binding to a definition
 * (or definition build model) and a real (non-{@code BuildModel.None}) build model.
 */
class FeaturePluginBuilder extends AbstractFeaturePluginBuilder {
