...
/**
 * A {@link ProjectFeaturePluginClassBuilder} for creating a plugin class that does not bind a project feature.
 */
class NotAProjectFeaturePluginClassBuilder extends ProjectFeaturePluginClassBuilder {
