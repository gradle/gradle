 ...
 * {@code Source extends Definition<Source.SourceModel>}) contains a definition nested inside
 * each element.  Used to test that features can bind to Definition elements that are deeply
 * nested inside plain (non-Definition) NDOC element types.
 */
class ProjectTypeDefinitionNestedDeeplyWithinNdocClassBuilder extends ProjectTypeDefinitionClassBuilder {
    ...
    String getPublicTypeClassContent() {
        return """
            ...
            public interface ${publicTypeClassName} extends ${Definition.class.simpleName}<${publicTypeClassName}.ModelType> {
                ...
                interface Source extends Named {
                ...
                interface Group extends ${Definition.class.simpleName}<${publicTypeClassName}.Group.Model> {
