 ...
 *  <p>
 *  Serialization of an object that is supported by the configuration cache is performed by an {@link org.gradle.configurationcache.serialization.EncodingProvider}.
 *  Deserialization, on the other hand, is performed by a {@link org.gradle.configurationcache.serialization.DecodingProvider}.
 *  </p>
 *  <p>Both protocols are highly specialized and, as such, they are specified as Single Abstract Method interfaces.</p>
 *
 *  <h3>Codecs</h3>
 *  <p>A {@link org.gradle.configurationcache.serialization.Codec Codec} is an object that is both an <code>EncodingProvider</code> and a <code>DecodingProvider</code>.</p>
 ...
 *  <h3>WriteContext</h3>
 *  <p>
 *      Before serialization starts, a {@link org.gradle.configurationcache.serialization.WriteContext} is created.
 *      The WriteContext keeps track (among other things) of the low level binary stream (actually, gradle.messaging's {@link org.gradle.internal.serialize.Encoder Encoder}) and the codec to be used.
 *  </p>
 *  <p>
 *      Object serialization is a graph-walking process, and as such, it has a recursive nature.
 *  </p>
 *  <p></p>
 *      In order to serialize one object, {@link  org.gradle.configurationcache.serialization.WriteContext#write(java.lang.Object, kotlin.coroutines.Continuation) WriteContext.write(object)} must be invoked.
 *  </p>
 *  <p><code>WriteContext.write(object)</code> then delegates to {@link org.gradle.configurationcache.serialization.Codec#encode(org.gradle.configurationcache.serialization.WriteContext, java.lang.Object, kotlin.coroutines.Continuation) Codec.encode(WriteContext, Object)}.</p>
 ...
 *      <li>encode any related/contained objects by delegating to {@link  org.gradle.configurationcache.serialization.WriteContext#write(java.lang.Object, kotlin.coroutines.Continuation) WriteContext.write(object)} passing the related object.</li>
 *  </ul>
 *  </p>
 */
