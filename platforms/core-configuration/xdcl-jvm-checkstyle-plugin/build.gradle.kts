...
// provider walks its dependency closure (checkstyle lib -> JVM lib -> common lib) and picks up every
// schema-carrying jar transitively.
xdclBuiltinEcosystem {
    pluginId = "checkstyle-ecosystem"
}
