...
public class FileCopier {
    ...
    private DestinationRootCopySpec createCopySpec(Action<? super SyncSpec> action) {
        DefaultCopySpec copySpec = new DefaultCopySpec(
        ...
        DestinationRootCopySpec destinationRootCopySpec = instantiator.newInstance(DestinationRootCopySpec.class, fileResolver, filePropertyFactory, copySpec);
