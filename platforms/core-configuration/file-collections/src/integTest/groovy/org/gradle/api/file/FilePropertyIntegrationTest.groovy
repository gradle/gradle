...
"""
        ...
        then:
        failure.assertHasDescription("Execution failed for task ':useIntTypeDsl' (created in build file 'build.gradle').")
        ...
        then:
        failure.assertHasDescription("Execution failed for task ':useIntTypeApi' (created in build file 'build.gradle').")
        failure.assertHasCause("Cannot set the value of extension 'custom' property 'prop' of type org.gradle.api.file.Directory using an instance of type java.lang.Integer.")
        ...
        then:
        failure.assertHasDescription("Execution failed for task ':useFileTypeDsl' (created in build file 'build.gradle').")
        ...
        then:
        failure.assertHasDescription("Execution failed for task ':useFileProviderDsl' (created in build file 'build.gradle').")
        ...
        then:
        failure.assertHasDescription("Execution failed for task ':useFileProviderApi' (created in build file 'build.gradle').")
        failure.assertHasCause("Cannot set the value of extension 'custom' property 'prop' of type org.gradle.api.file.Directory using a provider of type org.gradle.api.file.RegularFile.")
    }
...
"""
        ...
        then:
        failure.assertHasDescription("Execution failed for task ':useDirTypeDsl' (created in build file 'build.gradle').")
        ...
        then:
        failure.assertHasDescription("Execution failed for task ':useDirProviderDsl' (created in build file 'build.gradle').")
        ...
        then:
        failure.assertHasDescription("Execution failed for task ':useDirProviderApi' (created in build file 'build.gradle').")
        failure.assertHasCause("Cannot set the value of extension 'custom' property 'prop' of type org.gradle.api.file.RegularFile using a provider of type org.gradle.api.file.Directory.")
    }
