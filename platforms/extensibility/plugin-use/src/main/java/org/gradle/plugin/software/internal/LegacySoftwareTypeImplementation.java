 ...
 */
public class LegacySoftwareTypeImplementation<T> implements SoftwareFeatureImplementation<T, T> {
    ...
    public LegacySoftwareTypeImplementation(
    ...
    public boolean equals(Object o) {
        ...
        LegacySoftwareTypeImplementation<?> that = (LegacySoftwareTypeImplementation<?>) o;
