...
public class DefaultProjectFeatureApplicator implements ProjectFeatureApplicator {
    ...
    public DefaultProjectFeatureApplicator(ProjectFeatureRegistry projectFeatureRegistry, ModelDefaultsApplicator modelDefaultsApplicator, InspectionScheme inspectionScheme, ProblemsInternal problems, PluginManagerInternal pluginManager, ClassLoaderScope classLoaderScope, ObjectFactory objectFactory) {
