...
class ValidatePluginsPart2IntegrationTest extends AbstractIntegrationSpec implements ValidationMessageChecker, ValidatePluginsTrait {
    ...
    def "cannot annotate type 'java.net.URL' with @Input"() {
        ...
        verifyAll(receivedProblem(0)) {
            fqid == 'verification:property-verification:unsupported-value-type-for-input'
    ...
    def "detects problems with file inputs"() {
        ...
        and:
        verifyAll(receivedProblem(0)) {
            fqid == 'verification:property-verification:incorrect-use-of-input-annotation'
        ...
        verifyAll(receivedProblem(4)) {
            fqid == 'verification:property-verification:missing-normalization-annotation'
    ...
    def "detects problems on nested collections"() {
        ...
        and:
        verifyAll(receivedProblem(0)) {
            fqid == 'verification:property-verification:missing-annotation'
    ...
    def "nested map with unsupported key type is validated with warning"() {
        ...
        verifyAll(receivedProblem) {
            fqid == 'verification:property-verification:nested-map-unsupported-key-type'
    ...
    def "nested #typeName#parameterType is validated with warning"() {
        ...
        and:
        verifyAll(receivedProblem) {
            fqid == 'verification:property-verification:nested-type-unsupported'
