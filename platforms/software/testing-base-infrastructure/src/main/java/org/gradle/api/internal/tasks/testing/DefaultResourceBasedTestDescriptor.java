...
@NullMarked
public class DefaultResourceBasedTestDescriptor extends DefaultTestSuiteDescriptor {
    private final String classDisplayName;

    public DefaultResourceBasedTestDescriptor(Object id, String className) {
        this(id, className, null);
    }

    @UsedByScanPlugin("test-distribution")
    public DefaultResourceBasedTestDescriptor(Object id, String className, @Nullable String classDisplayName) {
        this(id, className, classDisplayName, new DefaultClassSource(className, null));
    }

    public DefaultResourceBasedTestDescriptor(Object id, String className, @Nullable String classDisplayName, TestSource source) {
