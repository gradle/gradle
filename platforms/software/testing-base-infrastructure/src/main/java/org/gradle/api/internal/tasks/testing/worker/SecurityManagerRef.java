 ...
 */
@NullMarked
public abstract class SecurityManagerRef {
    ...
    private static final class RealSecurityManagerRef extends SecurityManagerRef {
        ...
        @Override
        public void reinstall() throws SecurityException {
     ...
     *
     * @throws SecurityException if thrown when setting the security manager
     */
    public abstract void reinstall() throws SecurityException;
}
