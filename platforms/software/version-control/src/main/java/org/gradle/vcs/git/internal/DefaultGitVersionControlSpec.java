...
public abstract class DefaultGitVersionControlSpec extends AbstractVersionControlSpec implements GitVersionControlSpec {
    ...
    public Property<URI> getUrl() {
        // TODO(lazy-migration): having setUrl(String) overload prevents us from simply declaring this method abstract.
        return url;
    }

    @Override
    public void setUrl(String url) {
        // TODO(lazy-migration): this should be handled as other Property<URI> instances.
