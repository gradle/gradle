...
public abstract class DefaultAntlrSourceDirectorySet extends DefaultSourceDirectorySet
        implements AntlrSourceDirectorySet {

    @Inject
    public DefaultAntlrSourceDirectorySet(
