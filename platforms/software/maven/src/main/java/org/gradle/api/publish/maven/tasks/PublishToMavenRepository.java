...
public abstract class PublishToMavenRepository extends AbstractPublishToMaven {
    ...
    public void configureFromRepository(MavenArtifactRepository repository) {
        ...
        this.getAuthenticationSchemes().set(((DefaultMavenArtifactRepository) repository).getConfiguredAuthenticationProvider());
    }
    ...
    public void publish() {
        ...
        MavenArtifactRepository repository = createRepository();
    ...
    private MavenArtifactRepository createRepository() {
