...
final class GenericPageRenderer extends TabbedPageRenderer<TestTreeModel> {
    ...
    public static String getUrlTo(
        ...
        java.nio.file.Path relativePath = Paths.get("./" + GenericHtmlTestReportGenerator.getFilePath(shrink, originatingPath, isOriginatingPathLeaf)).getParent()
            .relativize(Paths.get("./" + GenericHtmlTestReportGenerator.getFilePath(shrink, targetPath, isTargetPathLeaf)));
