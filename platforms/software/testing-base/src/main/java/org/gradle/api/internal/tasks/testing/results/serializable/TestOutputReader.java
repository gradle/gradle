...
public final class TestOutputReader implements Closeable {
    ...
    public void useTestOutputEvents(
            OutputEntry entry, TestOutputEvent.Destination destination, IoConsumer<TestOutputEvent> eventConsumer)
            throws IOException {
        ...
        useTestOutputEventsWithInfo(
                destination, eventConsumer, entryStart, entry.getOutputRanges().end, fileId -> fileId == entry.getId());
    }

    public void useTestOutputEvents(
            Iterable<OutputEntry> entries,
    ...
    private static CombinedEntryInfo getCombinedEntryInfo(
            Iterable<OutputEntry> entries, TestOutputEvent.Destination destination) {
        ...
        while (true) {
            ...
            try {
                ...
                throw new IllegalStateException(
                        "Should have reached EOF when reading the id, not in the middle of an event", e);
            } catch (Exception e) {
