...
/**
 * Opaque object used to search for test output associated with a specific test result.
 *
 * <p>
 * Internally stores information that allows narrowing the location of output of a specific test result in an
 * output events file.
 * </p>
 */
