...
/**
 * Reads test output from an output events file generated by {@link SerializableTestResultStore}.
 */
public final class OutputReader implements Closeable {
    ...
    OutputReader(Path outputEventsFile) {
