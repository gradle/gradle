        ...
        new Html(builder.getOutput()) {{
            html();
                head();
                    ...
                    script().src(jqueryLink).charset(UTF_8).end();
                    script().src(jtreeLink).charset(UTF_8).end();
                    script().src(namingScheme.transform(project)).charset(UTF_8).end();
                    script().src(scriptLink).charset(UTF_8).end();
