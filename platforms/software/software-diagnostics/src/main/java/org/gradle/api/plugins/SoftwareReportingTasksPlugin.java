...
import org.gradle.api.tasks.diagnostics.DiagnosticsTaskNames;
...
@Incubating
@Nonnull
public abstract class SoftwareReportingTasksPlugin implements Plugin<Project>, DiagnosticsTaskNames {
    @Override
