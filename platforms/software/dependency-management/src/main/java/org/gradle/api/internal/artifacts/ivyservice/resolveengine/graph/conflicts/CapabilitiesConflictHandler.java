...
public interface CapabilitiesConflictHandler extends ConflictHandler<ConflictResolutionResult> {

    List<PotentialConflict> registerNode(NodeState node);

    void unregisterNode(NodeState node);
