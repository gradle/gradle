...
public class IvyDependencyMetadata extends ExternalModuleDependencyMetadata {
    ...
    protected GraphVariantSelectionResult selectLegacyConfigurations(
        ...
        return getDependencyDescriptor().selectLegacyConfigurations(configuration, (IvyComponentGraphResolveState) targetComponentState, variantSelector.getFailureHandler());
    }
