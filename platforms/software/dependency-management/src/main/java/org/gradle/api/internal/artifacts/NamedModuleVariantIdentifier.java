...
/**
 * Identifier for a variant of a module component, identified by its name.
 */
public class NamedModuleVariantIdentifier implements ModuleVariantIdentifier {

    private final ModuleComponentIdentifier componentIdentifier;
    private final String name;
    private final int hashCode;

    public NamedModuleVariantIdentifier(
    ...
    public boolean equals(Object o) {
        ...
        NamedModuleVariantIdentifier that = (NamedModuleVariantIdentifier) o;
