...
public class CapabilitiesRules {
    ...
    public ImmutableCapabilities execute(VariantResolveMetadata variant, MutableCapabilitiesMetadata capabilities) {
        ...
        return ImmutableCapabilities.of(capabilities.asImmutable().getCapabilities());
    }
}
