...
public final class NoCompatibleVariantsFailure extends AbstractVariantSelectionByAttributesFailure {
    ...
    public NoCompatibleVariantsFailure(ComponentGraphResolveState targetComponent, AttributeContainerInternal requestedAttributes, Set<Capability> requestedCapabilities, List<ResolutionCandidateAssessor.AssessedCandidate> candidates) {
