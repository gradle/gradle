...
public abstract class AbstractExternalDependencyFactory implements ExternalModuleDependencyFactory {
    ...
    public static abstract class SubDependencyFactory implements ExternalModuleDependencyFactory {
        ...
        @Override
        public MinimalExternalModuleDependencyProvider create(String alias) {
    ...
    @Override
    public MinimalExternalModuleDependencyProvider create(String alias) {
        return new DefaultMinimalExternalModuleDependencyProvider(alias, createMinimalDependency(config.getDependencyData(alias)));
    }
