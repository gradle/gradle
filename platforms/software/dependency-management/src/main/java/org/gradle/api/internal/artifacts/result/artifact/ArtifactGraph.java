...
public interface ArtifactGraph {
    ...
    /**
     * Get all nodes in the graph. The result produced by this method is calculated
     * lazily. Graph resolution is not triggered until the underlying provider is queried.
     * <p>
     * Nodes are returned in the order as specified by {@link org.gradle.api.artifacts.ResolutionStrategy.SortOrder}.
     */
    Provider<List<ArtifactNode>> getAllNodes();
