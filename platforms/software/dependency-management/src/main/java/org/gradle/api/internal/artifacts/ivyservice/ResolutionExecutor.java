...
public class ResolutionExecutor {
    ...
    public ResolverResults resolveBuildDependencies(
        ...
        ComponentResolvers resolvers = getResolvers(params, Collections.emptyList(), componentSelection, cachePolicy);
        ...
        doResolve(params, resolvers, IS_LOCAL_EDGE, ImmutableList.of(), dependencySubstitutionRule, capabilitiesResolutionRules, visitors);
    ...
    public ResolverResults resolveGraph(
        ...
        ComponentResolvers resolvers = getResolvers(params, repositories, componentSelection, cachePolicy);
        ...
        doResolve(params, resolvers, Specs.satisfyAll(), getAllSyntheticDependencies(params), dependencySubstitutionRule, capabilitiesResolutionRules, graphVisitors.build());
    ...
    private void doResolve(
        ...
        ImmutableActionSet<DependencySubstitutionInternal> dependencySubstitutionRules,
        CapabilitiesResolutionInternal capabilityConflictResolutionRules,
        ...
        dependencyGraphResolver.resolve(
            ...
            dependencySubstitutionRules,
            params.getModuleConflictResolutionStrategy(),
            capabilityConflictResolutionRules,
