...
public class ResolvedArtifactSetResolver {
    ...
    public void visitInUnmanagedWorker(ResolvedArtifactSet artifacts, ArtifactVisitor visitor) {
        ...
        workerLeaseService.runAsUnmanagedWorkerThread(() -> visitArtifacts(artifacts, visitor));
    }

    public void visitArtifacts(ResolvedArtifactSet artifacts, ArtifactVisitor visitor) {
