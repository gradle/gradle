...
/**
 * Default implementation of {@link LocalVariantGraphResolveMetadata} used to represent a single Configuration.
 */
public final class DefaultLocalVariantGraphResolveMetadata implements LocalVariantGraphResolveMetadata, LocalVariantArtifactGraphResolveMetadata {
    ...
    private final CalculatedValue<VariantDependencyState> dependencies;
    ...
    public DefaultLocalVariantGraphResolveMetadata(
        ...
        CalculatedValue<VariantDependencyState> dependencies,
     ...
     */
    public static class VariantDependencyState {
