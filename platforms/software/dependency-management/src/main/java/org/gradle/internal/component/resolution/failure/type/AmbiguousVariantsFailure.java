...
public final class AmbiguousVariantsFailure extends AbstractVariantSelectionByAttributesFailure {
    ...
    public AmbiguousVariantsFailure(ComponentGraphResolveState targetComponent, AttributeContainerInternal requestedAttributes, Set<Capability> requestedCapabilities, List<ResolutionCandidateAssessor.AssessedCandidate> candidates) {
