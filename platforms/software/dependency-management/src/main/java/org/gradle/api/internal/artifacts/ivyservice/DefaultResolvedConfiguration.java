...
public class DefaultResolvedConfiguration implements ResolvedConfiguration {
    ...
    public Set<File> getFiles() throws ResolveException {
        ...
        getArtifactsForThisConfiguration().visitArtifacts(visitor, false);
    ...
    private SelectedArtifactSet getArtifactsForThisConfiguration() {
        if (selectedArtifacts == null) {
            selectedArtifacts = visitedArtifacts.select(configuration.getImplicitSelectionSpec());
        }
