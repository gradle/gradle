...
public class DependencyManagementGradleUserHomeScopeServices implements ServiceRegistrationProvider {
    ...
    ImmutableTransformWorkspaceServices createTransformWorkspaceServices(
        ...
        CrossBuildInMemoryCache<Identity, ExecutionEngine.IdentityCacheResult<TransformExecutionResult.TransformWorkspaceResult>> identityCache = crossBuildInMemoryCacheFactory.newCacheRetainingDataFromPreviousBuild(result -> result.getResult().isSuccessful());
        ...
        return new ImmutableTransformWorkspaceServices() {
            ...
            @Override
            public Cache<Identity, ExecutionEngine.IdentityCacheResult<TransformExecutionResult.TransformWorkspaceResult>> getIdentityCache() {
