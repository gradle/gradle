...
public class DefaultLenientConfiguration implements LenientConfiguration, LenientConfigurationInternal {
    ...
    public SelectedArtifactSet select() {
        ...
        return new DefaultSelectedArtifactSet(artifactSetResolver, graphResults, artifactResults.getArtifacts());
    }
    ...
    public SelectedArtifactSet select(final Spec<? super Dependency> dependencySpec) {
        ...
        return new SelectedArtifactSet() {
            ...
            public void visitArtifacts(ArtifactVisitor visitor, boolean continueOnSelectionFailure) {
                getDelegate().visitArtifacts(visitor, continueOnSelectionFailure);
            }

            private DefaultSelectedArtifactSet getDelegate() {
                ResolvedArtifactSet filteredArtifacts = resolveFilteredArtifacts(dependencySpec, artifactResults);
                return new DefaultSelectedArtifactSet(artifactSetResolver, graphResults, filteredArtifacts);
            }
        };
    }
    ...
    public Set<File> getFiles() {
        ...
        artifactSetResolver.visitArtifacts(getSelectedArtifacts().getArtifacts(), visitor);
    ...
    public Set<File> getFiles(Spec<? super Dependency> dependencySpec) {
        ...
        artifactSetResolver.visitArtifacts(filteredArtifacts, visitor);
        return visitor.files;
    }
