...
class EdgeState implements DependencyGraphEdge {
    ...
    private void calculateTargetConfigurations(ComponentState targetComponent) {
        ...
        try {
            ...
            targetVariants = dependencyMetadata.selectVariants(resolveState.getVariantSelector(), attributes, targetComponentState, resolveState.getConsumerSchema(), dependencyState.getDependency().getSelector().getRequestedCapabilities());
