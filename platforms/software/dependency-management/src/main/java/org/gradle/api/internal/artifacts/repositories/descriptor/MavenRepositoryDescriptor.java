...
public class MavenRepositoryDescriptor extends UrlRepositoryDescriptor {
    ...
    public static class Builder extends UrlRepositoryDescriptor.Builder<Builder> {
        ...
        public MavenRepositoryDescriptor create() {
            ...
            ImmutableList<ResourcePattern> metadataResources =
                    ImmutableList.of(new M2ResourcePattern(url, MavenPattern.M2_PATTERN));
            ImmutableList.Builder<ResourcePattern> artifactResourcesBuilder =
                    ImmutableList.builderWithExpectedSize(1 + artifactUrls.size());
            ...
            String id = calculateId(
                    MavenResolver.class, metadataResources, artifactResources, metadataSources, hasher -> {});
