 ...
 */
public class RedirectingGradleMetadataModuleMetadataSource
    ...
    public RedirectingGradleMetadataModuleMetadataSource(
            MetadataSource<?> delegate,
    ...
    public MutableModuleComponentResolveMetadata create(
        ...
        MutableModuleComponentResolveMetadata metadata = delegate.create(
                repositoryName,
                componentResolvers,
        ...
        if (result.shouldUseGradleMetatada()) {
            MutableModuleComponentResolveMetadata resolveMetadata = gradleModuleMetadataSource.create(
                    repositoryName,
                    componentResolvers,
                    moduleComponentIdentifier,
                    prescribedMetaData,
