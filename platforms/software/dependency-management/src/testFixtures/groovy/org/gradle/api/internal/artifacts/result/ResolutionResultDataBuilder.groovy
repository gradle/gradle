...
class ResolutionResultDataBuilder {
    ...
    static DefaultUnresolvedDependencyResult newUnresolvedDependency(String group='x', String module='x', String version='1', String selectedVersion='1') {
        ...
        new DefaultUnresolvedDependencyResult(requested, newModule(group, module, selectedVersion), false, new ModuleVersionResolveException(newSelector(DefaultModuleIdentifier.newId(group, module), version), broken), ComponentSelectionReasons.requested())
    }
