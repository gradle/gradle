...
"""
   ...
   Dependency path: 'root' (lockedConf) --> 'org:foo:1.+'
   Dependency path: 'root' (lockedConf) --> 'org:foo:{strictly 1.1}'
   Constraint path: 'root' (lockedConf) --> 'org:foo:{strictly 1.0}' because of the following reason: Dependency version enforced by Dependency Locking"""
...
"""
        ...
        failure.assertHasCause """Cannot find a version of 'org:foo' that satisfies the version constraints:
   Dependency path: 'root' (lockedConf) --> 'org:foo:1.+'
   Dependency path: 'root' (lockedConf) --> 'org:foo:1.1'
   Constraint path: 'root' (lockedConf) --> 'org:foo:{strictly 1.0}' because of the following reason: Dependency version enforced by Dependency Locking"""
