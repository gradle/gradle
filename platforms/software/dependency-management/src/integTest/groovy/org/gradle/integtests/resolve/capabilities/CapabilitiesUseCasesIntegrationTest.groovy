...
class CapabilitiesUseCasesIntegrationTest extends AbstractModuleDependencyResolveTest {
   ...
   Cannot select module because of conflict with cglib:cglib:3.2.5 ($variant). Both provide capability 'cglib:cglib:3.2.5'.""")
        }
   ...
   Cannot select module because of conflict with org.apache:groovy-all:1.0 ($variant). Both provide capability 'org.apache:groovy:1.0'.""")
            failure.assertHasCause("""Module 'org.apache:groovy-json' has been rejected:
   Cannot select module because of conflict with org.apache:groovy-all:1.0 ($variant). Both provide capability 'org.apache:groovy-json:1.0'.""")
            failure.assertHasCause("""Module 'org.apache:groovy-all' has been rejected:
   Cannot select module because of conflict with org.apache:groovy-json:1.0 ($variant). Both provide capability 'org.apache:groovy-json:1.0'.""")
        }
   ...
   Cannot select module because of conflict with org:testB:1.0 (runtime). Both provide capability 'org.test:cap:1.0'.""")
            failure.assertHasCause("""Module 'org:testB' has been rejected:
   Cannot select module because of conflict with org:testA:1.0 (runtime). Both provide capability 'org.test:cap:1.0'.""")
        }
