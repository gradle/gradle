...
class ProjectLocalDependencyResolutionConsistencyIntegrationTest extends AbstractModuleDependencyResolveTest {
   ...
   Dependency path: 'root' (conf) --> 'org:foo:1.1'
   Constraint path: 'root' (conf) --> 'org:foo:{strictly 1.0}' because of the following reason: version resolved in configuration ':other' by consistent resolution"""
    }
