...
""")
    ...
    def "reports if we try to get dependencies from a different variant"() {
        ...
        then:
        failure.assertHasCause("Variant 'testFixturesApiElements' doesn't belong to resolved component 'root project 'test''. There's no resolved variant with the same name. Most likely you are using a variant from another component to get the dependencies of this component.")
    }
