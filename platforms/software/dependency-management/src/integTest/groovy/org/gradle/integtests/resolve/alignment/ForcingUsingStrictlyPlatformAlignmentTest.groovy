...
class ForcingUsingStrictlyPlatformAlignmentTest extends AbstractAlignmentSpec {
   ...
   Constraint path ':test:unspecified' --> 'org:core:2.9.4' ($coreVariant) --> 'org:platform:2.9.4' (default) --> 'org:databind:2.9.4' because of the following reason: belongs to platform org:platform:2.9.4"""
    }
