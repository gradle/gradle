...
class ForcingUsingStrictlyPlatformAlignmentTest extends AbstractAlignmentSpec {
    ...
    def "fails if forcing a virtual platform version and forcing a leaf with different version"() {
        ...
        then:
        failure.assertHasCause """Cannot find a version of 'org:databind' that satisfies the version constraints:
   Dependency path: 'root' (conf) --> 'org:databind:{strictly 2.7.9}'
   Constraint path: 'root' (conf) --> 'org:platform:2.9.4' (default) --> 'org:databind:2.9.4' because of the following reason: belongs to platform org:platform:2.9.4"""
    }
...
"""
        ...
        failure.assertHasCause """Cannot find a version of 'org:databind' that satisfies the version constraints:
   Dependency path: 'root' (conf) --> 'org:databind:{strictly 2.7.9}'
   Constraint path: 'root' (conf) --> 'project :other' (conf) --> 'org:core:2.9.4' ($coreVariant) --> 'org:platform:2.9.4' (default) --> 'org:databind:2.9.4' because of the following reason: belongs to platform org:platform:2.9.4"""
    }
