...
class EndorseStrictVersionsIntegrationTest extends AbstractModuleDependencyResolveTest {
   ...
   Dependency path: 'root' (conf) --> 'org:foo'
   Constraint path: 'root' (conf) --> 'org:platform-a:1.0' (runtime) --> 'org:foo:{strictly 1.0}'
   Constraint path: 'root' (conf) --> 'org:platform-b:1.0' (runtime) --> 'org:foo:{strictly 2.0}'"""
    }
