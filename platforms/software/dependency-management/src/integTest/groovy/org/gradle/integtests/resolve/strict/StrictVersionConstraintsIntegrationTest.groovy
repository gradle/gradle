...
class StrictVersionConstraintsIntegrationTest extends AbstractModuleDependencyResolveTest {
   ...
   Dependency path: 'root' (conf) --> 'org:c:2.0'
   Dependency path: 'root' (conf) --> 'org:a:1.0' (runtime) --> 'org:c:{strictly 1.0}'
   Dependency path: 'root' (conf) --> 'org:a:1.0' (runtime) --> 'org:b:1.0' (runtime) --> 'org:c:2.0'"""
    }
   ...
   Dependency path: 'root' (conf) --> 'project :foo'
   Constraint path: 'root' (conf) --> 'org:foo:{strictly 1.0}'""")
    }
    ...
    def "original version constraint is not ignored if there is another parent"() {
        ...
        then:
        failure.assertHasCause """Cannot find a version of 'org:foo' that satisfies the version constraints:
   Dependency path: 'root' (conf) --> 'org:x1:1.0' (runtime) --> 'org:bar:1.0' (runtime) --> 'org:foo:2.0'
   Constraint path: 'root' (conf) --> 'org:x1:1.0' (runtime) --> 'org:foo:{strictly 1.0}'"""
    }
