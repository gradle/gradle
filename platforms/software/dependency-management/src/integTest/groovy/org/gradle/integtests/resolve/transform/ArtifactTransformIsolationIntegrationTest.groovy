...
"""
    ...
    def "cannot register a transform from a custom classloader"() {
        ...
        then:
        failureDescriptionContains(isConfigCache ? "Configuration cache state could not be cached: Gradle runtime: Error while reading work graph" : "Execution failed for task ':consumer:resolve'.")
