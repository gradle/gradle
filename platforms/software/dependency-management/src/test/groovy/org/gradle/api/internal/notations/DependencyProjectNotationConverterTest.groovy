...
class DependencyProjectNotationConverterTest extends Specification {
    ...
    @ExpectDeprecation("Passing a Project object as a dependency notation has been deprecated")
    def "emits deprecation when a Project is passed as dependency notation"() {
        given:
        ...
        then:
        1 * factory.create(projectState) >> projectDependency
