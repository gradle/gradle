...
import org.gradle.buildinit.plugins.internal.DaemonJvmCriteriaGenerator;
...
public class ProjectLayoutSetupRegistryFactory {
    ...
    public ProjectLayoutSetupRegistry createProjectLayoutSetupRegistry() {
        ...
        BuildContentGenerator daemonJvmCriteriaGenerator = new DaemonJvmCriteriaGenerator();
        List<BuildContentGenerator> jvmProjectGenerators = ImmutableList.of(settingsDescriptor, gitIgnoreGenerator, gitAttributesGenerator, gradlePropertiesGenerator, daemonJvmCriteriaGenerator, resourcesGenerator);
        List<BuildContentGenerator> commonGenerators = ImmutableList.of(settingsDescriptor, gitIgnoreGenerator, gitAttributesGenerator, gradlePropertiesGenerator, daemonJvmCriteriaGenerator);
