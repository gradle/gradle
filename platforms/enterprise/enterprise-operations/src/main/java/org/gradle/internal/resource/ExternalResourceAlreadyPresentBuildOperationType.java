...
/**
 * Fired when a requested external resource is already present locally and no download is needed.
 * This operation is a child of {@code DownloadArtifactBuildOperationType}.
 *
 * @since 8.14
 */
public final class ExternalResourceAlreadyPresentBuildOperationType implements BuildOperationType<ExternalResourceAlreadyPresentBuildOperationType.Details, ExternalResourceAlreadyPresentBuildOperationType.Result> {
    ...
    public interface Result {
        ...
        /**
         * The size of the artifact file on disk, in bytes.
         */
        long getFileSize();
