...
<SampleScripts sample_name="example" basename="build" subpath="app" tag="demo" />
...
<SampleScripts sample_name="gradle-managed-types" basename="build" tag="eager-evaluation" />
...
<SampleScripts sample_name="gradle-managed-types" basename="build" tag="lazy-evaluation" />
...
<SampleScripts sample_name="gradle-managed-types" basename="build" tag="eager-task" />

The fix: use a **lazy** `Provider` or a `Property<String>`:

<SampleScripts sample_name="gradle-managed-types" basename="build" tag="lazy-task" />
