...
<SampleScripts sample_name="local-variables" basename="build" />
...
<SampleScripts sample_name="extra-properties" basename="build" tag="extraProperties" />
...
<SampleScripts sample_name="simple" basename="build" subpath="sub-project-a" />
...
<SampleScripts sample_name="simple" basename="build" subpath="sub-project-a" tag="plugins" />
...
<SampleScripts sample_name="simple" basename="build" subpath="sub-project-a" tag="repo" />
...
<SampleScripts sample_name="simple" basename="build" subpath="sub-project-a" tag="dep" />
...
<SampleScripts sample_name="simple" basename="build" subpath="sub-project-a" tag="app" />
...
<SampleScripts sample_name="simple" basename="build" subpath="sub-project-a" tag="task" />
...
<SampleScripts sample_name="simple" basename="build" subpath="sub-project-a" tag="test" />
...
<SampleScripts sample_name="simple" basename="build" subpath="sub-project-a" tag="doc" />
...
<SampleScripts sample_name="project-api" basename="build" tag="project-name" />
