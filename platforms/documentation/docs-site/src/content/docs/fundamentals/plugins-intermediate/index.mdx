...
<SampleScripts sample_name="simple" basename="settings" tag="simple-setting-repositories" />
...
<SampleScripts sample_name="dsl" basename="build" tag="use-plugin" />
...
<SampleScripts sample_name="multiproject" basename="settings" tag="include-subprojects" />
<SampleScripts sample_name="multiproject" basename="build" tag="plugins-on-subprojects" />
<SampleScripts sample_name="multiproject" basename="build" subpath="hello-a" />
<SampleScripts sample_name="multiproject" basename="build" subpath="hello-b" />
<SampleScripts sample_name="multiproject" basename="build" subpath="goodbye-c" />
...
<SampleScripts sample_name="multi-project-build" basename="settings" tag="base" />
<SampleScripts sample_name="multi-project-build" basename="build" tag="root" />
<SampleScripts sample_name="multi-project-build" basename="build" subpath="domain" tag="root" />
<SampleScripts sample_name="multi-project-build" basename="build" subpath="infra" tag="root" />
<SampleScripts sample_name="multi-project-build" basename="build" subpath="http" tag="root" />
...
<SampleScripts sample_name="dsl-with-build-src" basename="build" subpath="buildSrc" tag="main-block" />

The plugin can then be applied by ID:

<SampleScripts sample_name="dsl-with-build-src" basename="build" tag="use-plugin" />
...
<SampleScripts sample_name="buildscript" basename="build" tag="buildscript_block" />
...
<SampleScripts sample_name="buildscript" basename="build" tag="plugin" />
...
<SampleScripts sample_name="plugin-management" basename="settings" />
...
<SampleScripts sample_name="plugin-management" basename="init" />
...
<SampleScripts sample_name="consuming" basename="settings" tag="custom-plugin-repositories" />
...
<SampleScripts sample_name="plugin-versions" basename="settings" tag="configure-plugin-version" />
<SampleScripts sample_name="plugin-versions" basename="build" />
<SampleFile sample_name="plugin-versions" path="common/gradle.properties" />
...
<SampleScripts sample_name="resolution-rules" basename="settings" tag="plugin-resolution-strategy" />
...
<SampleScripts sample_name="publishing" basename="build" tag="complete-plugin-publishing" />
...
<SampleScripts sample_name="multi-project-build" basename="build" tag="use-plugin-legacy" />
...
<SampleScripts sample_name="plugin-intro" basename="build" tag="apply-by-type" />
...
<SampleScripts sample_name="custom-plugin" basename="build" tag="script-plugin" />
...
<SampleScripts sample_name="catalogs-toml-simple" basename="build" tag="plugin" />
