---
title: "How to Use a Local Fork of a Module Dependency with Gradle"
---
...
<SampleScripts sample_name="local-fork" basename="build" subpath="my-app" tag="dependency" />
...
<SampleScripts sample_name="local-fork" basename="settings" />
...
<SampleScripts sample_name="local-fork" basename="settings" subpath="my-fork" />

The build file must have the same GAV coordinates as required by `my-app`:

<SampleScripts sample_name="local-fork" basename="build" subpath="my-fork/okhttp" />
...
<SampleScripts sample_name="local-fork" basename="build" subpath="my-app" tag="dependency-tip" />
...
Gradle <Xref page="composite-builds" section="Composite Builds (Included Builds)">composite builds</Xref> provide a straightforward and efficient method to substitute external module dependencies with local forks.