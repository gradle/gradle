...
<SampleScripts sample_name="feature-variants-intro" basename="build" subpath="library" tag="producer" />

And a consumer can require the feature’s capability:

<SampleScripts sample_name="feature-variants-intro" basename="build" subpath="consumer" tag="consumer" />
...
<SampleScripts sample_name="feature-variants-test-fixtures" basename="build" tag="register_test_fixtures" />
...
<SampleScripts sample_name="producer-separate-sourceset" basename="build" tag="register_variant,register_variant2" />
...
<SampleScripts sample_name="producer-separate-sourceset" basename="build" tag="variant_dependencies" />
...
<SampleScripts sample_name="producer-separate-sourceset" basename="build" tag="plugins,publishing" />
...
<SampleScripts sample_name="producer-separate-sourceset" basename="build" tag="register_variant_extra_jars" />
...
<SampleScripts sample_name="requiring-features" basename="build" subpath="producer" tag="producer" />

A consumer project can explicitly depend on the "MySQL support" feature by requiring its capability:

<SampleScripts sample_name="requiring-features" basename="build" subpath="consumer" tag="consumer" />
...
<SampleScripts sample_name="requiring-features-external" basename="build" subpath="project" tag="consumer" />
...
<SampleScripts sample_name="incompatible-variants" basename="build" subpath="producer" tag="producer" />
...
<SampleScripts sample_name="incompatible-variants" basename="build" subpath="consumer" tag="consumer" />
