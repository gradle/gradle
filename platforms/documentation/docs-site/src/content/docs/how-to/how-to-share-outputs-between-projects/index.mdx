...
<SampleScripts sample_name="share-outputs" basename="build" subpath="producer" tag="java-lib" />
...
<SampleScripts sample_name="share-outputs" basename="build" subpath="producer" tag="instrumentedjar-task" />
...
<SampleScripts sample_name="share-outputs" basename="build" subpath="producer" tag="custom-config" />
...
<SampleScripts sample_name="share-outputs" basename="build" subpath="consumer" tag="custom-config" />
...
<SampleScripts sample_name="share-outputs" basename="build" subpath="consumer" tag="dependency" />
...
<SampleScripts sample_name="share-outputs" basename="build" subpath="consumer" tag="task" />
...
<SampleScripts sample_name="modeling-features-cross-project-publications-advanced" basename="build" subpath="consumer" tag="compatibility-rule" />

Which we declare on the attributes schema:

<SampleScripts sample_name="modeling-features-cross-project-publications-advanced" basename="build" subpath="consumer" tag="compatibility-rule-use" />
