...
<SampleScripts sample_name="basic" basename="build" tag="compile-dependencies" />
...
<SampleScripts sample_name="basic" basename="build" tag="pom-dependencies" />
...
<SampleScripts sample_name="basic" basename="build" tag="repositories" />
...
<SampleScripts sample_name="import-bom" basename="build" tag="bom" />
...
1. Create a settings script that matches the `<modules>` block of the root POM.
   ...
   <SampleScripts sample_name="multi-module" basename="settings" />
   <CalloutList>
...
<SampleScripts sample_name="profiles" basename="build" />
<SampleScripts sample_name="profiles" basename="profile-default" />
<SampleScripts sample_name="profiles" basename="profile-test" />
<SampleScripts sample_name="profiles" basename="profile-prod" />
...
<SampleScripts sample_name="basic" basename="build" tag="process-resources" />
...
<SampleScripts sample_name="basic" basename="build" tag="checkstyle" />
...
<SampleScripts sample_name="basic" basename="build" tag="depends-on" />
...
<SampleScripts sample_name="ant" basename="build" />
