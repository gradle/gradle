...
Documentation on configuring plugin publication can be found both [on the Portal](https://plugins.gradle.org/docs/publish-plugin) and <Xref page="publishing-gradle-plugins" section="Configuring the {publishplugin}">in the user manual</Xref>.
