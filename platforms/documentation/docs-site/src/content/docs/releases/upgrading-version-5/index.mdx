...
- PMD has been updated to [PMD 6.17.0](https://pmd.github.io/latest/pmd_release_notes.html#28-july-2019---6170).
- JaCoCo has been updated to [0.8.5](http://www.jacoco.org/jacoco/trunk/doc/changes.html). Contributed by [Evgeny Mandrikov](https://github.com/Godin)
...
<Xref page="pmd-plugin" section="The PMD Plugin">The PMD plugin</Xref> has been upgraded to use [PMD version 6.15.0](https://pmd.github.io/pmd-6.15.0/pmd_release_notes.html) instead of 6.8.0 by default.
...
A [Build Scan](https://gradle.com/develocity/product/build-scan) shows much deeper insights into your build and you can use [Develocity](https://gradle.com/develocity) to directly compare two build’s build-scans.
...
<Xref page="jacoco-plugin" section="The JaCoCo Plugin">The JaCoCo plugin</Xref> has been upgraded to use [JaCoCo version 0.8.4](http://www.jacoco.org/jacoco/trunk/doc/changes.html) instead of 0.8.3 by default.
