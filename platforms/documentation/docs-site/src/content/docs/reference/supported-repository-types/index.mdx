...
<SampleScripts sample_name="custom-plugin" basename="build" subpath="java-gradle-plugin" tag="local-maven" />
...
<SampleScripts sample_name="supported-repository-types-maven-local-filter" basename="build" tag="maven-local-filter" />
...
<SampleScripts sample_name="define-repository" basename="build" tag="ivy-repo-with-maven-layout" />
...
<SampleScripts sample_name="define-repository" basename="build" tag="ivy-repo-with-pattern-layout" />

For an Ivy repository that fetches Ivy files and artifacts from different locations, define separate patterns:

<SampleScripts sample_name="define-repository" basename="build" tag="ivy-repo-with-custom-pattern" />

Optionally, you can enable Maven-style layout for the 'organisation' part, with forward slashes replacing dots:

<SampleScripts sample_name="define-repository" basename="build" tag="ivy-repo-with-m2compatible-layout" />
...
<SampleScripts sample_name="define-repository" basename="build" tag="flat-dir-multi" />
