...
<SampleScripts sample_name="dependency-caching-changing-deps" basename="build" tag="changing-deps" />
...
<SampleScripts sample_name="troubleshooting-cache-dynamic" basename="build" tag="dynamic-version-cache-control" />

To change how long Gradle will cache the metadata and artifacts for a changing module, use:

<SampleScripts sample_name="troubleshooting-cache-changing" basename="build" tag="changing-module-cache-control" />
