...
<SampleScripts sample_name="customizing-resolution-metadata-rule" basename="build" tag="config-component-metadata-rule" />
...
<SampleScripts sample_name="customizing-resolution-metadata-rule" basename="settings" tag="rule-in-settings" />

By default, project-specific rules take precedence over settings rules.
However, this behavior can be adjusted:

<SampleScripts sample_name="customizing-resolution-metadata-rule" basename="settings" tag="prefer-settings" />
...
<SampleScripts sample_name="customizing-resolution-metadata-rule" basename="settings" tag="enforce-settings" />

The default behavior is equivalent to calling this method:

<SampleScripts sample_name="customizing-resolution-metadata-rule" basename="settings" tag="prefer-projects" />
...
<SampleScripts sample_name="customizing-resolution-metadata-rule" basename="build" tag="jaxen-rule-1" />
...
<SampleScripts sample_name="customizing-resolution-metadata-rule" basename="build" tag="jaxen-rule-2" />
...
<SampleScripts sample_name="customizing-resolution-metadata-rule" basename="build" tag="jaxen-dependencies" />
...
<SampleScripts sample_name="customizing-resolution-metadata-rule" basename="build" tag="quasar-rule" />
...
<SampleScripts sample_name="customizing-resolution-metadata-rule" basename="build" tag="quasar-dependencies" />
...
<SampleScripts sample_name="customizing-resolution-metadata-rule" basename="build" tag="guava-rule" />
...
<SampleScripts sample_name="customizing-resolution-metadata-rule" basename="build" tag="guava-dependencies" />
...
<SampleScripts sample_name="customizing-resolution-metadata-rule" basename="build" tag="lwgj-rule" />
...
<SampleScripts sample_name="customizing-resolution-metadata-rule" basename="build" tag="lwgj-dependencies" />

Gradle fails to select a variant because a machine architecture needs to be chosen:

<SampleFile sample_name="customizing-resolution-metadata-rule" path="tests/failRuntimeClasspathResolve.out" />
...
<SampleScripts sample_name="customizing-resolution-metadata-rule" basename="build" tag="guice-rule" />
...
<SampleScripts sample_name="customizing-resolution-metadata-rule" basename="build" tag="guice-dependencies" />
...
<SampleScripts sample_name="customizing-resolution-metadata-rule" basename="build" tag="ivy-component-metadata-rule" />
...
<SampleScripts sample_name="customizing-resolution-metadata-rule" basename="build" tag="maven-packaging-component-metadata-rule" />
...
<SampleScripts sample_name="customizing-resolution-metadata-rule" basename="build" tag="custom-status-scheme" />
