...
<SampleScripts sample_name="md5-custom-task" basename="build" subpath="buildSrc" />
...
<SampleScripts sample_name="md5-custom-task" basename="build" />
...
<SampleScripts sample_name="md5-classloader-isolation" basename="build" subpath="buildSrc" />
...
<SampleScripts sample_name="md5-classloader-isolation" basename="build" />
...
<SampleScripts sample_name="worker-daemon" basename="build" tag="worker-daemon" />
