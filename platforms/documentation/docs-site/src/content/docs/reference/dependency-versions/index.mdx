...
<SampleScripts sample_name="declaring-dependencies-concrete-version" basename="build" tag="required-version" />
...
<SampleScripts sample_name="declaring-dependencies-concrete-version" basename="build" tag="rich-version-intro" />
...
<SampleScripts sample_name="declaring-dependencies-concrete-version" basename="build" tag="rich-version" />

To enforce [strict versions](#sec:strict-version), you can also use the `!!` notation:

<SampleScripts sample_name="declaring-dependencies-concrete-version" basename="build" tag="strict-shorthand" />
...
<SampleScripts sample_name="managing-transitive-dependencies-force-for-dependency" basename="build" tag="force-using-strictly" />
...
<SampleScripts sample_name="declaring-dependencies-without-version" basename="build" tag="dependencies-without-version" />
...
<SampleScripts sample_name="declaring-dependencies-dynamic-version" basename="build" tag="dependencies" />
...
<SampleScripts sample_name="declaring-dependencies-changing-version" basename="build" tag="dependencies" />
