...
<SampleScripts sample_name="customizing-resolution-consistent-resolution" basename="build" tag="dependencies" />
...
<SampleScripts sample_name="customizing-resolution-consistent-resolution" basename="build" tag="explicit-configuration" />
...
<SampleScripts sample_name="customizing-resolution-consistent-resolution" basename="build" tag="java-convention" />
