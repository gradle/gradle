...
<SampleScripts sample_name="variant-attributes-intro" basename="build" tag="bundling-attribute" />

For example, a build might have `debug` and `release` variants.
This selects the `debug` variant based on the attribute.

<SampleScripts sample_name="variant-attributes-intro" basename="build" tag="target-attribute" />

***Attributes*** help Gradle match the right ***variant*** by comparing the requested attributes with what’s available:

<SampleScripts sample_name="variant-attributes-intro" basename="build" tag="target-attribute-single" />
...
<SampleScripts sample_name="customizing-resolution-attribute-simple" basename="build" subpath="lib" tag="attributes" />

In the consumer project (that uses the library), you can specify the JVM version attribute when declaring dependencies.

<SampleScripts sample_name="customizing-resolution-attribute-simple" basename="build" subpath="consumer" tag="attributes" />
...
<SampleScripts sample_name="customizing-resolution-attribute-simple" basename="build" subpath="lib" tag="custom-attributes" />
...
<SampleScripts sample_name="attribute-matching" basename="build" tag="define_attribute" />
...
<SampleScripts sample_name="attribute-matching" basename="build" tag="register-attributes" />
...
<SampleScripts sample_name="attribute-matching" basename="build" tag="attributes-on-configurations" />

For attributes which type extends `Named`, the value of the attribute ***must*** be created via the _object factory_:

<SampleScripts sample_name="attribute-matching" basename="build" tag="named-attributes" />
...
<SampleScripts sample_name="customizing-resolution-attribute-simple" basename="build" subpath="lib" tag="attribute-compatibility" />
...
<SampleScripts sample_name="customizing-resolution-disambiguation-rule" basename="build" subpath="consumer" tag="disambiguation_rule" />
...
<SampleScripts sample_name="customizing-resolution-ivy-metadata-rule" basename="build" tag="ivy-component-metadata-rule" />
