...
<dt>**<Xref page="java-plugin" section="The Java Plugin">Java Plugin</Xref>**</dt>
<dd>
...
<SampleScripts sample_name="idea" basename="build" tag="use-plugin" />
...
<dt>`cleanIdea` — <GroovyDocLink class="org.gradle.api.tasks.Delete" /></dt>
<dd>
...
<dt>`cleanIdeaProject` — <GroovyDocLink class="org.gradle.api.tasks.Delete" /></dt>
<dd>

Removes the IDEA project file

</dd>
<dt>`cleanIdeaModule` — <GroovyDocLink class="org.gradle.api.tasks.Delete" /></dt>
<dd>

Removes the IDEA module file

</dd>
<dt>`cleanIdeaWorkspace` — <GroovyDocLink class="org.gradle.api.tasks.Delete" /></dt>
<dd>

Removes the IDEA workspace file

</dd>
<dt>`ideaProject` — <GroovyDocLink class="org.gradle.plugins.ide.idea.GenerateIdeaProject" /></dt>
<dd>

Generates the `.ipr` file. This task is only added to the root project.

</dd>
<dt>`ideaModule` — <GroovyDocLink class="org.gradle.plugins.ide.idea.GenerateIdeaModule" /></dt>
<dd>

Generates the `.iml` file

</dd>
<dt>`ideaWorkspace` — <GroovyDocLink class="org.gradle.plugins.ide.idea.GenerateIdeaWorkspace" /></dt>
<dd>
...
<dl>
<dt>`idea` — <GroovyDocLink class="org.gradle.plugins.ide.idea.model.IdeaModel" /></dt>
<dd>

Top level element that enables configuration of the idea plugin in a DSL-friendly fashion

</dd>
<dt>`idea.project` <GroovyDocLink class="org.gradle.plugins.ide.idea.model.IdeaProject" /></dt>
<dd>

Allows configuring project information

</dd>
<dt>`idea.module` <GroovyDocLink class="org.gradle.plugins.ide.idea.model.IdeaModule" /></dt>
<dd>

Allows configuring module information

</dd>
<dt>`idea.workspace` <GroovyDocLink class="org.gradle.plugins.ide.idea.model.IdeaWorkspace" /></dt>
<dd>
...
<dl>
<dt><GroovyDocLink class="org.gradle.plugins.ide.idea.model.IdeaProject" /></dt>
<dd>

- `beforeMerged { <JavaDocLink class="org.gradle.plugins.ide.idea.model.Project" /> arg -> …​ }`
- `whenMerged { <JavaDocLink class="org.gradle.plugins.ide.idea.model.Project" /> arg -> …​ }`
- `withXml { <JavaDocLink class="org.gradle.api.XmlProvider" /> arg -> …​ }`

</dd>
<dt><JavaDocLink class="org.gradle.plugins.ide.idea.model.IdeaModule" /></dt>
<dd>

- `beforeMerged { <JavaDocLink class="org.gradle.plugins.ide.idea.model.Module" /> arg -> …​ }`
- `whenMerged { <JavaDocLink class="org.gradle.plugins.ide.idea.model.Module" /> arg -> …​ }`
- `withXml { <JavaDocLink class="org.gradle.api.XmlProvider" /> arg -> …​ }`

</dd>
<dt><JavaDocLink class="org.gradle.plugins.ide.idea.model.IdeaWorkspace" /></dt>
<dd>

- `beforeMerged { <JavaDocLink class="org.gradle.plugins.ide.idea.model.Workspace" /> arg -> …​ }`
- `whenMerged { <JavaDocLink class="org.gradle.plugins.ide.idea.model.Workspace" /> arg -> …​ }`
- `withXml { <JavaDocLink class="org.gradle.api.XmlProvider" /> arg -> …​ }`
...
<SampleScripts sample_name="idea" basename="build" tag="module-before-merged" />
...
<SampleScripts sample_name="idea" basename="build" tag="project-before-merged" />
...
<SampleScripts sample_name="idea" basename="build" tag="module-when-merged" />
...
<SampleScripts sample_name="idea" basename="build" tag="project-with-xml" />

## Identifying additional test directories

When using this plugin together with the <Xref page="java-plugin" section="The Java Plugin">Java plugin</Xref>, after adding additional source sets you may wish to inform IDEA when they contain test source rather than production source, so that the IDE can treat the directories appropriately.  This can be accomplished by using this plugin’s `Module` block.

<SampleScripts sample_name="idea-additional-test-sources" basename="build" tag="mark-additional-sourcesets-as-test" />

:::note
When working with the <Xref page="jvm-test-suite-plugin" section="The JVM Test Suite Plugin">JVM Test Suite Plugin</Xref>, test sources will automatically identified correctly.
:::
