...
<SampleScripts sample_name="basics" basename="build" tag="basics" />
...
<SampleScripts sample_name="accessors" basename="build" tag="accessors" />
...
<SampleScripts sample_name="basics" basename="build" tag="lazy" />

For all other containers, accessors for elements are of type `NamedDomainObjectProvider<T>`, providing the same behavior:

<SampleScripts sample_name="basics" basename="build" tag="container" />
...
<SampleScripts sample_name="no-accessors" basename="build" tag="no-accessors" />
...
<SampleScripts sample_name="no-accessors" basename="build" tag="dependencies" />
...
<SampleScripts sample_name="no-accessors" basename="build" tag="project-extension" />
...
<SampleScripts sample_name="basics" basename="build" tag="source" />
...
<SampleScripts sample_name="no-accessors" basename="build" tag="project-container-extension" />
...
<SampleScripts sample_name="no-accessors" basename="build" tag="tasks" />
...
<SampleScripts sample_name="containers-api" basename="build" tag="api" />
...
<SampleScripts sample_name="containers-scope" basename="build" tag="scope" />
...
<SampleScripts sample_name="basics" basename="build" tag="extra" />
...
<SampleScripts sample_name="basics" basename="build" subpath="my-sub-project" tag="prop" />
...
<SampleScripts sample_name="basics" basename="build" tag="test-task" />
...
<SampleScripts sample_name="basics" basename="build" subpath="my-sub-project" tag="property" />
...
<SampleScripts sample_name="basics" basename="build" subpath="my-sub-project" tag="provider" />
...
<SampleScripts sample_name="basics" basename="build" subpath="my-sub-project" tag="named" />
...
<SampleScripts sample_name="assignment" basename="build" tag="assignment" />
...
<SampleScripts sample_name="kotlin-dsl-plugin" basename="build" subpath="buildSrc" tag="apply" />
...
<SampleScripts sample_name="interoperability-static-extensions" basename="build" tag="kotlin-from-groovy" />
...
<SampleScripts sample_name="interoperability-static-extensions" basename="build" tag="groovy-from-kotlin" />
...
<SampleScripts sample_name="interoperability-delegate-closure-of" basename="build" tag="delegateClosureOf" />
...
<SampleScripts sample_name="interoperability-kotlin-closure" basename="build" tag="kotlinClosure" />
...
<SampleScripts sample_name="interoperability-groovy-builder" basename="build" tag="withGroovyBuilder" />
