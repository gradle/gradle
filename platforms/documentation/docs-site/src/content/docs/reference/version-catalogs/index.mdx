...
<SampleScripts sample_name="catalogs-settings" basename="build" tag="simple_dependency_use" />
...
<SampleScripts sample_name="catalogs-settings" basename="build" tag="use_catalog" />
...
<SampleFile sample_name="catalogs-settings" path="common/gradle/libs.versions.toml" />
...
<SampleFile sample_name="catalogs-classifiers" path="common/gradle/libs.versions.toml" />
...
<SampleScripts sample_name="catalogs-classifiers" basename="build" tag="use_classifier" />
...
<SampleScripts sample_name="catalogs-classifiers" basename="build" tag="use_artifact_type" />
...
<SampleScripts sample_name="catalogs-java-platform-catalog" basename="settings" subpath="consumer" tag="consume_catalog" />
...
<SampleScripts sample_name="catalogs-toml" basename="settings" subpath="buildSrc" tag="import_main_catalog" />
...
<SampleScripts sample_name="catalogs-multiple-catalogs" basename="settings" tag="multiple-catalogs" />

Each catalog generates its own extension, so you reference them by name in build scripts:

<SampleScripts sample_name="catalogs-multiple-catalogs" basename="build" tag="use-multiple-catalogs" />
...
<SampleFile sample_name="catalogs-toml" path="common/gradle/libs.versions.toml" />
...
<SampleFile sample_name="catalogs-toml" path="common/gradle/test-libs.versions.toml" tag="catalog" />
...
<SampleScripts sample_name="catalogs-settings" basename="build" tag="use_dependency_bundle" />
...
<SampleScripts sample_name="catalogs-settings" basename="build" tag="use_plugin" />
...
<SampleScripts sample_name="catalogs-asprovider" basename="build" tag="use_version_asprovider" />
...
<SampleScripts sample_name="catalogs-settings" basename="settings" tag="catalog_with_versions" />
...
<SampleScripts sample_name="catalogs-publish-toml-file" basename="build" tag="publish_toml_file" />
...
<SampleScripts sample_name="catalogs-version-catalog-plugin" basename="build" tag="catalog_spec" />

In both cases, configure a publication using the `versionCatalog` component:

<SampleScripts sample_name="catalogs-version-catalog-plugin" basename="build" tag="catalog_publish" />
...
<SampleScripts sample_name="catalogs-toml" basename="settings" tag="change_default_extension_name" />

## Overwriting catalog versions

You can overwrite versions when importing a catalog:

<SampleScripts sample_name="catalogs-java-platform-catalog" basename="settings" subpath="consumer" tag="overwrite_version" />
...
<SampleScripts sample_name="catalogs-toml-build-src" basename="settings" subpath="buildSrc" />

Once the version catalog is imported, dependencies can be referenced using a few tricks:

<SampleScripts sample_name="catalogs-toml-build-src" basename="build" subpath="buildSrc" />
...
<SampleScripts sample_name="catalogs-toml-build-src" basename="java-commons-convention" subpath="buildSrc/src/main/{lang}" />
...
<SampleFile sample_name="catalogs-duplicate-and-verify" path="kotlin/gradle/distribution.versions.toml" tag="versions" />

<SampleFile sample_name="catalogs-duplicate-and-verify" path="kotlin/gradle/test.versions.toml" tag="versions" />

Add a small verification task (or a CI script) that parses both files and fails the build if the values diverge:

<SampleScripts sample_name="catalogs-duplicate-and-verify" basename="build" tag="verify_shared_versions" />
...
<SampleFile sample_name="catalogs-external-properties" path="kotlin/gradle/shared-versions.properties" tag="shared_versions" />

<SampleScripts sample_name="catalogs-external-properties" basename="settings" tag="inject_versions" />

The TOML files use `version.ref` to reference these versions as if they were declared locally:

<SampleFile sample_name="catalogs-external-properties" path="kotlin/gradle/distribution.versions.toml" tag="catalog" />
...
<SampleScripts sample_name="catalogs-published-catalog-overrides" basename="build" subpath="catalog" tag="publish_catalog" />

Consuming project (`settings.gradle(.kts)`):

<SampleScripts sample_name="catalogs-published-catalog-overrides" basename="settings" subpath="consumer" tag="consume_with_overrides" />
...
<SampleScripts sample_name="catalogs-combine-from-with-version" basename="settings" tag="combine_from_with_version" />
...
<SampleFile sample_name="catalogs-kotlin-version-sharing" path="common/gradle/catalog.versions.toml" tag="kotlin_catalog" />

<SampleScripts sample_name="catalogs-kotlin-version-sharing" basename="settings" tag="kotlin_version_sharing" />
...
<SampleScripts sample_name="catalogs-gradle-apis" basename="build" tag="use_catalog_entries" />
...
<SampleScripts sample_name="catalogs-gradle-apis" basename="build" tag="use_provider_in_apis" />
