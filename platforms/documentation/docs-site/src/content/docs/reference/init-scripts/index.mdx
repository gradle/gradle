...
<SampleScripts sample_name="configuration-injection" basename="build" />
<SampleScripts sample_name="configuration-injection" basename="init" />
...
<SampleScripts sample_name="external-dependency" basename="init" tag="declare-classpath" />
...
<SampleScripts sample_name="external-dependency" basename="init" tag="all" />
<SampleScripts sample_name="external-dependency" basename="build" />
...
<SampleScripts sample_name="plugins" basename="init" tag="init-script-plugin" />
<SampleScripts sample_name="plugins" basename="build" tag="show-repos-task" />
...
<SampleFile sample_name="init-kotlin" path="kotlin/baseline-init-plugin/src/main/kotlin/com/example/BaselineInitPlugin.kt" />

<SampleFile sample_name="init-groovy" path="groovy/baseline-init-plugin/src/main/groovy/com/example/BaselineInitPlugin.groovy" />
...
<SampleScripts sample_name="init-kotlin" basename="init" />

<SampleScripts sample_name="init-groovy" basename="init" />
