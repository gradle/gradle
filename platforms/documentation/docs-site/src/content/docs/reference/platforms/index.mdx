...
<SampleScripts sample_name="recommender" basename="build" subpath="platform" tag="full-platform" />
...
<SampleScripts sample_name="managing-transitive-dependencies-enforced-constraints-from-b-o-m" basename="build" tag="dependency-on-bom" />
