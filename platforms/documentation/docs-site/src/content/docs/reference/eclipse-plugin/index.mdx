...
<SampleScripts sample_name="eclipse" basename="build" tag="use-eclipse-plugin" />

Using the Eclipse WTP plugin:

<SampleScripts sample_name="eclipse" basename="build" tag="use-eclipse-wtp-plugin" />
...
<SampleScripts sample_name="eclipse" basename="build" tag="module-before-merged" />
...
<SampleScripts sample_name="eclipse" basename="build" tag="project-before-merged" />
...
<SampleScripts sample_name="eclipse" basename="build" tag="module-when-merged" />
...
<SampleScripts sample_name="eclipse" basename="build" tag="wtp-with-xml" />
...
<SampleScripts sample_name="eclipse" basename="build" tag="test-sources" />
...
<SampleScripts sample_name="eclipse" basename="build" tag="test-fixtures" />
