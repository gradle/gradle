...
<SampleScripts sample_name="java-library-quickstart" basename="build" tag="use-plugin" />
...
<SampleScripts sample_name="java-library-quickstart" basename="build" tag="dependencies" />
...
<SampleScripts sample_name="java-library" basename="build" tag="dependencies" />
...
<SampleScripts sample_name="module" basename="build" tag="declareVersion" />
...
<SampleScripts sample_name="module" basename="build" tag="dependencies" />
...
<SampleScripts sample_name="module-disabled" basename="build" tag="disableModulePath" />
...
<SampleScripts sample_name="module" basename="build" tag="automaticModuleName" />
