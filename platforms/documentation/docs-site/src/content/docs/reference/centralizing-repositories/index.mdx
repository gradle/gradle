...
<SampleScripts sample_name="define-repository-in-settings" basename="settings" tag="declare_repositories_settings" />
...
<SampleScripts sample_name="define-repository-in-settings" basename="settings" tag="prefer_projects" />
...
<SampleScripts sample_name="define-repository-in-settings" basename="settings" tag="prefer_settings" />
...
<SampleScripts sample_name="define-repository-in-settings" basename="settings" tag="enforce_settings" />