...
<SampleScripts sample_name="sample-java-project" basename="build" tag="link-task-properties" />
...
<SampleScripts sample_name="lazy-file-variants" basename="build" tag="lazy-javadoc-destination" />
...
<SampleScripts sample_name="sample-java-project" basename="build" tag="inner-link-task-properties" />
...
<SampleScripts sample_name="file" basename="build" tag="simple-params" />
...
<SampleScripts sample_name="misc" basename="build" subpath="project2" tag="using-root-dir-property" />
...
<SampleScripts sample_name="file-collections" basename="build" tag="simple-params" />
...
<SampleScripts sample_name="file-collections" basename="build" tag="closure" />
...
<SampleScripts sample_name="file-collections" basename="build" tag="usage" />
...
<SampleScripts sample_name="file-collections" basename="build" tag="filtering-file-collections" />
...
<SampleScripts sample_name="input-files" basename="build" tag="set-input-files" />
...
<SampleScripts sample_name="input-files" basename="build" tag="add-input-files" />
...
<SampleScripts sample_name="file-trees" basename="build" tag="define" />
...
<SampleScripts sample_name="copy" basename="settings" tag="change-default-exclusions" />
...
<SampleScripts sample_name="file-trees" basename="build" tag="use" />
...
<SampleScripts sample_name="copy" basename="build" tag="standalone-copyspec" />
...
<SampleScripts sample_name="copy" basename="build" tag="shared-copy-patterns" />
...
<SampleScripts sample_name="sample-java-project" basename="build" tag="nested-specs" />
...
<SampleScripts sample_name="sync" basename="build" tag="copy-dependencies" />
...
<SampleScripts sample_name="copy" basename="build" tag="copy-single-file-example" />
...
<SampleScripts sample_name="copy" basename="build" tag="copy-single-file-example-with-task-properties" />
...
<SampleScripts sample_name="copy" basename="build" tag="copy-multiple-files-example" />
...
<SampleScripts sample_name="copy" basename="build" tag="copy-multiple-files-with-flat-filter-example" />
...
<SampleScripts sample_name="copy" basename="build" tag="copy-multiple-files-with-deep-filter-example" />
...
<SampleScripts sample_name="copy" basename="build" tag="copy-directory-example" />
...
<SampleScripts sample_name="copy" basename="build" tag="copy-directory-including-itself-example" />
...
<SampleScripts sample_name="copy" basename="build" tag="copy-task-2" />
...
<SampleScripts sample_name="copy" basename="build" tag="copy-method" />
...
<SampleScripts sample_name="copy" basename="build" tag="copy-method-with-dependency" />
...
<SampleScripts sample_name="copy" basename="build" tag="rename-on-copy-example" />
...
<SampleScripts sample_name="copy" basename="build" tag="truncate-names-example" />
...
<SampleScripts sample_name="copy" basename="build" tag="rename-files" />
...
<SampleScripts sample_name="copy" basename="build" tag="copy-task-with-patterns" />
...
<SampleScripts sample_name="copy" basename="build" tag="filter-files" />
...
<SampleScripts sample_name="copy" basename="build" tag="file-permissions" />
...
<SampleScripts sample_name="copy" basename="build" tag="file-specific-permissions" />
...
<SampleScripts sample_name="working-with-files-file-ops" basename="build" tag="move-rename" />
...
<SampleScripts sample_name="working-with-files-file-ops" basename="build" tag="move-copy" />
...
<SampleScripts sample_name="misc" basename="build" tag="delete-example" />
...
<SampleScripts sample_name="misc" basename="build" tag="delete-with-filter-example" />
...
<SampleScripts sample_name="copy" basename="build" tag="create-archive-example" />
...
<SampleScripts sample_name="archives-with-base-plugin" basename="build" tag="create-archive-with-base-plugin-example" />
...
<SampleScripts sample_name="archive-naming" basename="build" tag="zip-task" />
...
<SampleScripts sample_name="archive-naming" basename="build" tag="zip-task-with-custom-base-name" />
...
<SampleScripts sample_name="archives-changed-base-name" basename="build" />
...
<SampleScripts sample_name="file-trees" basename="build" tag="archive-trees" />
...
<SampleScripts sample_name="archives" basename="build" tag="revert-reproducible" />
...
<SampleScripts sample_name="archives" basename="build" tag="reproducible-timestamp" />
...
<SampleScripts sample_name="archives" basename="build" tag="unpack-archive-example" />
...
<SampleScripts sample_name="archives" basename="build" tag="unpack-archive-subset-example" />
...
<SampleScripts sample_name="misc" basename="build" tag="mkdir-example" />
...
<SampleScripts sample_name="working-with-files-file-ops" basename="build" tag="create-dirs" />
...
<SampleScripts sample_name="install-executable" basename="build" />
...
<SampleScripts sample_name="deploy-war-with-copy" basename="build" />