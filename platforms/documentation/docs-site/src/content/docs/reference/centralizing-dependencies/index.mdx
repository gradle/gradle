...
<SampleScripts sample_name="dep-man" basename="build" subpath="platform" />

Then, you can use that platform in your project:

<SampleScripts sample_name="dep-man" basename="build" subpath="app" />
...
<SampleScripts sample_name="managing-transitive-dependencies-constraints-from-b-o-m" basename="build" tag="dependency-on-bom" />
...
<SampleFile sample_name="catalogs-toml-simple" path="common/gradle/libs.versions.toml" />

Then, you can use the version catalog in you build file:

<SampleScripts sample_name="catalogs-toml-simple" basename="build" />
