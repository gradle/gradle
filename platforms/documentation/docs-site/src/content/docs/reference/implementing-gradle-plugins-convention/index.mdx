...
<SampleScripts sample_name="managing-transitive-dependencies-dependency-alignment-with-platform" basename="myproject.publishing-conventions" subpath="buildSrc/src/main/{lang}" />
...
<SampleScripts sample_name="managing-transitive-dependencies-dependency-alignment-with-platform" basename="build" subpath="platform" tag="convention" />