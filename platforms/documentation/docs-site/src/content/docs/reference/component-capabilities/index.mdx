...
<SampleScripts sample_name="component-capabilities-capability-conflict" basename="build" tag="capability-conflict" />
...
<SampleScripts sample_name="managing-transitive-dependencies-declaring-capabilities" basename="build" tag="fix_asm" />
...
<SampleScripts sample_name="managing-transitive-dependencies-declaring-capabilities" basename="build" tag="dependencies" />
...
<SampleScripts sample_name="managing-transitive-dependencies-declaring-capabilities" basename="build" tag="declare_capability" />

This ensures that Gradle detects the conflict and fails with a clear error message:

<SampleFile sample_name="managing-transitive-dependencies-declaring-capabilities" path="tests/dependencyReport.out" />
...
<SampleScripts sample_name="modeling-features-outgoing-capabilities" basename="build" tag="declare-outgoing-capabilities" />
...
<SampleScripts sample_name="managing-transitive-dependencies-declaring-capabilities" basename="build" tag="use_highest_asm" />
...
<SampleScripts sample_name="managing-transitive-dependencies-declaring-capabilities" basename="build" tag="use_slf4j" />
