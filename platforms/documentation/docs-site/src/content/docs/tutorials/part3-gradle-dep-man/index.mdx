...
<SampleScripts sample_name="dependency-types" basename="build" subpath="app" tag="dep-types" />
...
<SampleScripts sample_name="generated" basename="build" subpath="app" tag="init-declarations" />
