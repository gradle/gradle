...
import { CalloutList, FileTree, GitHubButton, SampleFile, SampleScripts, Xref } from '#/components';
...
<SampleScripts sample_name="use-test-kit-avoid" basename="build" />
...
<GitHubButton sample="use-test-kit-do" action="download" />
...
<SampleFile sample_name="use-test-kit-do" path="common/build-logic/src/main/java/org/example/MyTask.java" />
...
<SampleFile sample_name="use-test-kit-do" path="common/build-logic/src/main/java/org/example/MyPlugin.java" />
...
<SampleScripts sample_name="use-test-kit-do" basename="build" subpath="build-logic" tag="do-this" />
...
<SampleFile sample_name="use-test-kit-do" path="common/build-logic/src/functionalTest/java/org/example/MyPluginFunctionalTest.java" />
