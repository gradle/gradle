...
description: "Gradle's official Docker images for running builds in containers, including available tags and usage."
---
...
Do not copy a host <Xref page="directory-layout" section="1. Gradle User Home directory">`GRADLE_USER_HOME`</Xref> into a container when its paths, operating system, JDK, permissions, or Gradle version are incompatible.
