...
- JaCoCo has been updated to [0.8.6](http://www.jacoco.org/jacoco/trunk/doc/changes.html).
...
This is no longer necessary because Gradle has a separate <Xref page="java-plugin" section="Dependency configurations">annotation processor classpath</Xref>.
