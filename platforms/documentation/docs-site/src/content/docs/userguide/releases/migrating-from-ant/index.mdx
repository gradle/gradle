...
description: "Migrating an Apache Ant build to Gradle, including incremental approaches that reuse existing Ant tasks."
---
...
For example, the <Xref page="java-plugin" section="Dependency management">Java Plugin</Xref> defines configurations like `implementation`, `testImplementation` and `runtimeOnly`.
