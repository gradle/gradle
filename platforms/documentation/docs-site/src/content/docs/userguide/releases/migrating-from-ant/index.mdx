...
<SampleScripts sample_name="import-build" basename="build" tag="apply-plugin" />
...
<SampleScripts sample_name="import-build" basename="build" tag="import-build" />
...
<SampleScripts sample_name="import-build" basename="build" tag="source-sets" />
...
<SampleScripts sample_name="import-build" basename="build" tag="task-dependencies" />
...
<SampleScripts sample_name="file-deps" basename="build" tag="file-deps" />
...
<SampleScripts sample_name="file-deps" basename="build" tag="retrieve-deps" />
...
<SampleScripts sample_name="file-deps" basename="build" tag="properties" />
...
4. Implement inter-project dependencies.
   ...
   <SampleFile sample_name="multi-project" path="groovy/web/build.xml" tag="build-required" />
   <CalloutList>
