...
description: "Migrating a Gradle 4.x build to Gradle 5.0, covering deprecations, removals and behaviour changes."
---
...
- The [PMD Plugin](https://pmd.github.io/) now uses [6.8.0](https://pmd.github.io/2018/09/30/PMD-6.8.0/#30-september-2018---680) instead of 5.6.1 by default.
