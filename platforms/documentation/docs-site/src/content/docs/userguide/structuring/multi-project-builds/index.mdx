...
description: "Multi-project builds: declaring subprojects, wiring dependencies between them, and how Gradle configures them."
---
...
<SampleScripts sample_name="custom-layout" basename="settings" tag="lookup-project" source_dir="snippets/structuring-builds/customLayout" />

Using this descriptor, you can change the name, project directory, and build file of a project:

<SampleScripts sample_name="custom-layout" basename="settings" tag="change-project" source_dir="snippets/structuring-builds/customLayout" />
...
<SampleScripts sample_name="basic-dependencies" basename="settings" source_dir="snippets/structuring-builds/basic-dependencies" />
<SampleScripts sample_name="basic-dependencies" basename="build" subpath="shared" source_dir="snippets/structuring-builds/basic-dependencies" />
<SampleScripts sample_name="basic-dependencies" basename="build" subpath="api" source_dir="snippets/structuring-builds/basic-dependencies" />
<SampleScripts sample_name="basic-dependencies" basename="build" subpath="services/person-service" source_dir="snippets/structuring-builds/basic-dependencies" />
