...
<SampleScripts sample_name="basic-multiproject" basename="settings" />
...
<SampleScripts sample_name="basic-multiproject" basename="build" subpath="app" />
...
<SampleScripts sample_name="standard-layouts" basename="settings" tag="hierarchical-layout" />
...
<SampleScripts sample_name="multiple-subprojects" basename="settings" />
...
<SampleScripts sample_name="customizing-resolution-capability-substitution-rule" basename="settings" tag="inc" />
