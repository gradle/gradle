...
description: "Sharing build logic across subprojects with buildSrc and convention plugins."
---
...
<SampleScripts sample_name="no-build-src" basename="build" subpath="api" tag="common-logic" source_dir="snippets/structuring-builds/no-buildSrc" />
<SampleScripts sample_name="no-build-src" basename="build" subpath="services" tag="common-logic" source_dir="snippets/structuring-builds/no-buildSrc" />
<SampleScripts sample_name="no-build-src" basename="build" subpath="shared" tag="common-logic" source_dir="snippets/structuring-builds/no-buildSrc" />
...
<SampleScripts sample_name="build-src" basename="build" subpath="buildSrc" source_dir="snippets/structuring-builds/buildSrc" />
...
<SampleScripts sample_name="build-src" basename="java-common-conventions" subpath="buildSrc/src/main/{lang}" source_dir="snippets/structuring-builds/buildSrc" />
...
<SampleScripts sample_name="build-src" basename="build" subpath="api" tag="non-common-logic" source_dir="snippets/structuring-builds/buildSrc" />
<SampleScripts sample_name="build-src" basename="build" subpath="services" tag="non-common-logic" source_dir="snippets/structuring-builds/buildSrc" />
<SampleScripts sample_name="build-src" basename="build" subpath="shared" tag="non-common-logic" source_dir="snippets/structuring-builds/buildSrc" />
