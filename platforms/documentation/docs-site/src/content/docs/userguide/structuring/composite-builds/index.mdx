...
description: "Composite builds: including one build in another, and substituting module dependencies with included projects."
---
...
<SampleScripts sample_name="composite-builds-basic" basename="settings" tag="inc" source_dir="snippets/structuring-builds/composite-builds-basic" />
...
<SampleScripts sample_name="composite-builds-basic" basename="settings" source_dir="snippets/structuring-builds/composite-builds-basic" />
...
<SampleScripts sample_name="composite-builds-basic" basename="build" tag="run" source_dir="snippets/structuring-builds/composite-builds-basic" />
...
<SampleScripts sample_name="composite-builds-hierarchical-multirepo" basename="build" source_dir="snippets/structuring-builds/composite-builds-hierarchical-multirepo" />
...
<SampleScripts sample_name="composite-builds-referencing-projects" basename="build" tag="referencing-projects" source_dir="snippets/structuring-builds/composite-builds-referencingProjects" />
...
<SampleScripts sample_name="composite-builds-basic" basename="settings" subpath="my-app" tag="mag" source_dir="snippets/structuring-builds/composite-builds-basic" />

Then the plugin is used as follows:

<SampleScripts sample_name="composite-builds-basic" basename="build" subpath="my-app/app" tag="plugin_dependencies" source_dir="snippets/structuring-builds/composite-builds-basic" />
...
<SampleScripts sample_name="composite-builds-settings-plugin" basename="settings" tag="settings-plugin" source_dir="snippets/structuring-builds/composite-builds-settingsPlugin" />
...
<SampleScripts sample_name="composite-builds-declared-substitution" basename="build" subpath="anonymous-library" source_dir="snippets/structuring-builds/composite-builds-declared-substitution" />
...
<SampleScripts sample_name="composite-builds-declared-substitution" basename="settings" tag="composite_substitution" source_dir="snippets/structuring-builds/composite-builds-declared-substitution" />
...
<SampleScripts sample_name="customizing-resolution-deactivate-global-substitution" basename="build" tag="disableGlobalDependencySubstitutionRules" source_dir="snippets/structuring-builds/customizingResolution-deactivateGlobalSubstitution" />
