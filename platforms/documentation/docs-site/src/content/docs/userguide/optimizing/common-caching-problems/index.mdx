...
description: "Common causes of poor cache performance, such as undeclared inputs, absolute paths and volatile task inputs."
---
...
<SampleScripts sample_name="integration-tests" basename="build" tag="environment" source_dir="snippets/optimizing-builds/build-cache/integration-tests" />
...
<SampleScripts sample_name="conditional-action" basename="build" tag="conditionalAction" source_dir="snippets/optimizing-builds/build-cache/conditional-action" />

You should always add the action unconditionally:

<SampleScripts sample_name="conditional-action" basename="build" tag="unconditionalAction" source_dir="snippets/optimizing-builds/build-cache/conditional-action" />
...
<SampleScripts sample_name="java-version-tracking" basename="build" tag="trackVendor" source_dir="snippets/optimizing-builds/build-cache/java-version-tracking" />
...
<SampleScripts sample_name="custom-action" basename="build" tag="customAction" source_dir="snippets/optimizing-builds/build-cache/custom-action" />

do

<SampleScripts sample_name="configure-task" basename="build" tag="configureTask" source_dir="snippets/optimizing-builds/build-cache/configure-task" />
...
<SampleScripts sample_name="reproducible-archives" basename="build" source_dir="snippets/optimizing-builds/build-cache/reproducible-archives" />
