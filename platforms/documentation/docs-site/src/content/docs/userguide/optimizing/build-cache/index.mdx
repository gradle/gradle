---
title: "Build Cache"
description: "The Gradle build cache: reusing task outputs produced by other builds, and how local and remote caches work together."
---
...
<SampleScripts sample_name="cacheable-bundle-task" basename="build" tag="bundle-task" source_dir="snippets/optimizing-builds/build-cache/cacheable-bundle-task" />
...
<SampleScripts sample_name="cacheable-bundle" basename="build" tag="bundle-task" source_dir="snippets/optimizing-builds/build-cache/cacheable-bundle" />
...
<SampleScripts sample_name="configure-built-in-caches" basename="settings" tag="configure-directory-build-cache" source_dir="snippets/optimizing-builds/build-cache/configure-built-in-caches" />
...
<SampleScripts sample_name="http-build-cache" basename="settings" tag="http-build-cache" source_dir="snippets/optimizing-builds/build-cache/http-build-cache" />
...
<SampleScripts sample_name="configure-built-in-caches" basename="settings" tag="configure-http-build-cache" source_dir="snippets/optimizing-builds/build-cache/configure-built-in-caches" />
...
<SampleScripts sample_name="http-build-cache" basename="settings" tag="allow-untrusted-server" source_dir="snippets/optimizing-builds/build-cache/http-build-cache" />
...
<SampleScripts sample_name="http-build-cache" basename="settings" tag="use-expect-continue" source_dir="snippets/optimizing-builds/build-cache/http-build-cache" />
...
<SampleScripts sample_name="developer-ci-setup" basename="settings" tag="developer-ci-setup" source_dir="snippets/optimizing-builds/build-cache/developer-ci-setup" />
...
<SampleScripts sample_name="configure-by-init-script" basename="init" source_dir="snippets/optimizing-builds/build-cache/configure-by-init-script" />
