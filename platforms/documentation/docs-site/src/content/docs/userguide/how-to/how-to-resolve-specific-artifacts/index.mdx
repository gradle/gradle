...
<SampleScripts sample_name="declaring-dependencies-artifact-only" basename="build" tag="artifact-only-dependency-declaration" />
...
<SampleScripts sample_name="declaring-dependencies-artifact-only-with-classifier" basename="build" tag="artifact-only-dependency-declaration" />
