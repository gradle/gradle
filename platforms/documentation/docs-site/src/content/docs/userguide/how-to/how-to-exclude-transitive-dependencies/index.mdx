...
<SampleScripts sample_name="exclude-transitives" basename="build" tag="dependency-full" />
...
<SampleFile sample_name="exclude-transitives" path="tests/dependencies.out" />
...
<SampleScripts sample_name="exclude-transitives" basename="build" tag="dependency-ex" />
...
<SampleFile sample_name="exclude-transitives" path="tests/dependencies-excluded.out" />
...
<SampleScripts sample_name="exclude-transitives" basename="build" tag="dependency-extra" />

In this case, `commons-collections` is ***still included*** because `opencsv` brings it back.

Running `./gradlew dependencies --configuration runtimeClasspath` showcases the results:

<SampleFile sample_name="exclude-transitives" path="tests/dependencies-extra.out" />
...
<SampleScripts sample_name="exclude-transitives" basename="build" tag="dependency-extra-ex" />
...
<SampleFile sample_name="exclude-transitives" path="tests/dependencies-extra-excluded.out" />
