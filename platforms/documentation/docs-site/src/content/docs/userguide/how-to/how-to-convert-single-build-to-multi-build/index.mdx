...
<SampleScripts sample_name="single-multi-build" basename="settings" />
...
<SampleScripts sample_name="single-multi-build" basename="build" subpath="app" />
...
<SampleScripts sample_name="single-multi-build" basename="build" subpath="library" />
...
<SampleScripts sample_name="single-multi-build" basename="build" />
