---
title: "How to Convert a Single-Project Build into a Multi-Project Build in Gradle"
description: "Splitting a single-project build into subprojects, covering the settings file, shared logic and project dependencies."
---
...
<SampleScripts sample_name="single-multi-build" basename="settings" source_dir="snippets/how-to/structuring-builds/structuring-builds/single-multi-build" />
...
<SampleScripts sample_name="single-multi-build" basename="build" subpath="app" source_dir="snippets/how-to/structuring-builds/structuring-builds/single-multi-build" />
...
<SampleScripts sample_name="single-multi-build" basename="build" subpath="library" source_dir="snippets/how-to/structuring-builds/structuring-builds/single-multi-build" />
...
<SampleScripts sample_name="single-multi-build" basename="build" source_dir="snippets/how-to/structuring-builds/structuring-builds/single-multi-build" />
...
However, ***shared logic should be handled using <Xref page="sharing-build-logic-between-subprojects" section="Sharing Build Logic using `buildSrc`">convention plugins</Xref>*** rather than the root build file.
...
If you wanted one of your libraries to be its own build, you should consider using <Xref page="composite-builds" section="Composite Builds (Included Builds)">Composite Builds</Xref> (i.e., included builds) instead.