...
description: "Replacing a module dependency with a local fork of its sources, using composite builds or substitution rules."
---
...
<SampleScripts sample_name="local-fork" basename="build" subpath="my-app" tag="dependency" source_dir="snippets/how-to/dependency-management/dependency-management/local-fork" />
...
<SampleScripts sample_name="local-fork" basename="settings" source_dir="snippets/how-to/dependency-management/dependency-management/local-fork" />
...
<SampleScripts sample_name="local-fork" basename="settings" subpath="my-fork" source_dir="snippets/how-to/dependency-management/dependency-management/local-fork" />

The build file must have the same GAV coordinates as required by `my-app`:

<SampleScripts sample_name="local-fork" basename="build" subpath="my-fork/okhttp" source_dir="snippets/how-to/dependency-management/dependency-management/local-fork" />
...
<SampleScripts sample_name="local-fork" basename="build" subpath="my-app" tag="dependency-tip" source_dir="snippets/how-to/dependency-management/dependency-management/local-fork" />
