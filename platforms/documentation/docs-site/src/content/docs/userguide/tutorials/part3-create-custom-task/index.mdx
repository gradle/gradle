...
description: "Developing Plugins, part 3: writing a custom task type and contributing it from the plugin."
---
...
<SampleFile sample_name="plugin-tutorial" path="{lang}/plugin/src/main/{lang}/org/example/SlackTask.{srcExt}" source_dir="snippets/tutorials/developing-plugins/plugin-tutorial" />
...
<SampleScripts sample_name="plugin-tutorial" basename="build" subpath="plugin" tag="slack-api" source_dir="snippets/tutorials/developing-plugins/plugin-tutorial" />
...
<SampleFile sample_name="plugin-tutorial" path="{lang}/plugin/src/main/{lang}/org/example/SlackPlugin.{srcExt}" tag="slack-task" source_dir="snippets/tutorials/developing-plugins/plugin-tutorial" />
