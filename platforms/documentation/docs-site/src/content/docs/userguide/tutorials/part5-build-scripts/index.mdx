...
description: "Authoring Builds, part 5: writing a build script and understanding what belongs in one."
---
...
<SampleScripts sample_name="build-scripts-plugin-build" basename="build" tag="plugin-build-script" source_dir="snippets/tutorials/authoring-builds/buildScripts-pluginBuild" />
...
<SampleScripts sample_name="build-scripts-gradle-plugin-config" basename="build" tag="gradle-plugin-config" source_dir="snippets/tutorials/authoring-builds/buildScripts-gradlePluginConfig" />
...
<SampleScripts sample_name="build-scripts-task-definitions" basename="build" tag="task-definitions" source_dir="snippets/tutorials/authoring-builds/buildScripts-taskDefinitions" />
...
<SampleScripts sample_name="build-scripts-plugin-setup" basename="build" tag="update-plugin-config" source_dir="snippets/tutorials/authoring-builds/buildScripts-pluginSetup" />
...
<SampleScripts sample_name="build-scripts-plugin-setup" basename="build" tag="greeting-plugin" source_dir="snippets/tutorials/authoring-builds/buildScripts-pluginSetup" />
