...
<SampleFile sample_name="plugin-tutorial" path="kotlin/plugin/src/functionalTest/kotlin/org/example/SlackPluginFunctionalTest.kt" />

<SampleFile sample_name="plugin-tutorial" path="groovy/plugin/src/functionalTest/groovy/org/example/SlackPluginFunctionalTest.groovy" />
...
<SampleScripts sample_name="plugin-tutorial" basename="build" subpath="plugin" tag="test-config" />
