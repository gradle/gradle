...
description: "Developing Plugins, part 5: using the Dataflow API to hook into the build lifecycle from a plugin."
---
...
<SampleFile sample_name="plugin-tutorial" path="{lang}/plugin/src/main/{lang}/org/example/SlackBuildFlowAction.{srcExt}" source_dir="snippets/tutorials/developing-plugins/plugin-tutorial" />
...
<SampleFile sample_name="plugin-tutorial" path="{lang}/plugin/src/main/{lang}/org/example/SlackPlugin.{srcExt}" tag="final" source_dir="snippets/tutorials/developing-plugins/plugin-tutorial" />
