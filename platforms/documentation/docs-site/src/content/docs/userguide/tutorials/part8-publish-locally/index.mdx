...
description: "Developing Plugins, part 8: publishing the plugin to a local Maven repository and consuming it from another build."
---
...
<SampleScripts sample_name="plugin-tutorial" basename="build" subpath="plugin" tag="publish" source_dir="snippets/tutorials/developing-plugins/plugin-tutorial" />
...
<SampleScripts sample_name="plugin-tutorial" basename="build" subpath="plugin" tag="repo" source_dir="snippets/tutorials/developing-plugins/plugin-tutorial" />
...
<SampleScripts sample_name="plugin-tutorial" basename="settings" subpath="consumer" tag="repo" source_dir="snippets/tutorials/developing-plugins/plugin-tutorial" />

## Step 4: Apply the Plugin in the `consumer` Project

<SampleScripts sample_name="plugin-tutorial" basename="build" subpath="consumer" tag="repo" source_dir="snippets/tutorials/developing-plugins/plugin-tutorial" />
