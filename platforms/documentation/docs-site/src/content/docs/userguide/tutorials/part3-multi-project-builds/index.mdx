...
description: "Authoring Builds, part 3: structuring a build with subprojects and composite builds."
---
...
<SampleScripts sample_name="multi-project-builds-lib-build" basename="build" tag="lib-build" source_dir="snippets/tutorials/authoring-builds/multiProjectBuilds-libBuild" />
...
<SampleScripts sample_name="multi-project-builds-add-subproject" basename="settings" tag="add-subproject" source_dir="snippets/tutorials/authoring-builds/multiProjectBuilds-addSubproject" />
...
```kotlin title="gradle/license-plugin/settings.gradle.kts"
...
```groovy title="gradle/license-plugin/settings.gradle"
rootProject.name = 'license'
include('plugin')
```
...
<SampleScripts sample_name="multi-project-builds-add-build" basename="settings" tag="add-build" source_dir="snippets/tutorials/authoring-builds/multiProjectBuilds-addBuild" />
...
***Next Step:*** <Xref page="part4-settings-file" section="Part 4: Writing the Settings File">Settings File</Xref> \>\>