...
<SampleScripts sample_name="multi-project-builds-lib-build" basename="build" tag="lib-build" />
...
<SampleScripts sample_name="multi-project-builds-add-subproject" basename="settings" tag="add-subproject" />
...
<SampleScripts sample_name="multi-project-builds-add-build" basename="settings" tag="add-build" />
