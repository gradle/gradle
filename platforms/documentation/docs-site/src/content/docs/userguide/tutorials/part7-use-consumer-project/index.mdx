...
<SampleScripts sample_name="plugin-tutorial" basename="settings" />
...
<SampleScripts sample_name="plugin-tutorial" basename="build" subpath="plugin" tag="plugins" />

<SampleScripts sample_name="plugin-tutorial" basename="build" subpath="plugin" tag="dependencies" />
...
<SampleScripts sample_name="plugin-tutorial" basename="settings" subpath="consumer" tag="entire" />
...
<SampleScripts sample_name="plugin-tutorial" basename="build" subpath="consumer" tag="build" />
