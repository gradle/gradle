...
description: "Authoring Builds, part 6: writing a task in a build script and wiring it into the build."
---
...
<SampleScripts sample_name="writing-tasks-register-configure" basename="build" tag="register-configure" source_dir="snippets/tutorials/authoring-builds/writingTasks-registerConfigure" />
...
<SampleScripts sample_name="writing-tasks-license-task" basename="build" tag="license-task" source_dir="snippets/tutorials/authoring-builds/writingTasks-licenseTask" />
