...
description: "Authoring Builds, part 1: generating a Java application with gradle init as the basis for the tutorial."
---

import { Xref } from '#/components';
import { TabItem, Tabs } from '@astrojs/starlight/components';
import { Image } from 'astro:assets';
import buildScan3 from './build-scan-3.png';
...
<Image src={buildScan3} alt="build scan 3" />

***Next Step:*** <Xref page="part2-build-lifecycle" section="Part 2: The Build Lifecycle">The Build Lifecycle</Xref> \>\>