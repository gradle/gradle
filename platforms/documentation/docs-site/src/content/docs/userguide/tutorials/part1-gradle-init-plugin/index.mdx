...
description: "Developing Plugins, part 1: scaffolding a plugin project with gradle init."
---
...
<SampleScripts sample_name="plugin-tutorial" basename="build" subpath="plugin" tag="plugin-init" source_dir="snippets/tutorials/developing-plugins/plugin-tutorial" />
...
<SampleFile sample_name="plugin-tutorial" path="{lang}/plugin/src/main/{lang}/org/example/PluginTutorialPlugin.{srcExt}" source_dir="snippets/tutorials/developing-plugins/plugin-tutorial" />
