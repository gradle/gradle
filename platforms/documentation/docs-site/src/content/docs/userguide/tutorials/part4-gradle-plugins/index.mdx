...
description: "Running Builds, part 4: applying a plugin and using the tasks and conventions it contributes."
---
...
<SampleScripts sample_name="generated" basename="build" subpath="app" tag="init-plugins" source_dir="snippets/tutorials/running-builds/generated" />
...
<SampleScripts sample_name="upgraded" basename="build" subpath="app" tag="init-plugins" source_dir="snippets/tutorials/running-builds/upgraded" />
...
<SampleScripts sample_name="upgraded" basename="build" subpath="app" tag="init-publish" source_dir="snippets/tutorials/running-builds/upgraded" />
