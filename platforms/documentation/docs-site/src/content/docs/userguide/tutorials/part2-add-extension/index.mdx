...
description: "Developing Plugins, part 2: adding an extension so the plugin can be configured from a build script."
---
...
<SampleFile sample_name="plugin-tutorial" path="{lang}/plugin/src/main/{lang}/org/example/SlackPlugin.{srcExt}" tag="slack-plugin" source_dir="snippets/tutorials/developing-plugins/plugin-tutorial" />

You’ll also need to update the `build.gradle(.kts)` file to point to the new plugin class name:

<SampleScripts sample_name="plugin-tutorial" basename="build" subpath="plugin" tag="gradle-plugin" source_dir="snippets/tutorials/developing-plugins/plugin-tutorial" />
...
<SampleFile sample_name="plugin-tutorial" path="{lang}/plugin/src/main/{lang}/org/example/SlackExtension.{srcExt}" source_dir="snippets/tutorials/developing-plugins/plugin-tutorial" />
...
<SampleFile sample_name="plugin-tutorial" path="{lang}/plugin/src/main/{lang}/org/example/SlackPlugin.{srcExt}" tag="slack-extension" source_dir="snippets/tutorials/developing-plugins/plugin-tutorial" />
