...
description: "Developing Plugins, part 4: unit testing plugin classes to check they behave as expected."
---
...
<SampleFile sample_name="plugin-tutorial" path="{lang}/plugin/src/test/{lang}/org/example/SlackPluginTest.{srcExt}" source_dir="snippets/tutorials/developing-plugins/plugin-tutorial" />
