...
<SampleScripts sample_name="generated" basename="build" subpath="app" tag="init-task" />
...
<SampleScripts sample_name="generated" basename="build" subpath="app" tag="init-hello" />
...
<SampleFile sample_name="generated" path="groovy/app/src/main/java/org/example/App.java" />
