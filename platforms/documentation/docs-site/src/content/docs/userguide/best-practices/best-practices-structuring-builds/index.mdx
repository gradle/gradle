...
import { CalloutList, GitHubButton, KotlinDocLink, SampleFile, SampleScripts, Xref } from '#/components';
...
<SampleScripts sample_name="modularize-your-build-avoid" basename="settings" tag="avoid-this" />

<SampleScripts sample_name="modularize-your-build-avoid" basename="build" subpath="app" tag="avoid-this" />
...
<SampleScripts sample_name="modularize-your-build-do" basename="settings" tag="do-this" />

<SampleScripts sample_name="modularize-your-build-do" basename="build" subpath="app" tag="do-this" />

<SampleScripts sample_name="modularize-your-build-do" basename="build" subpath="util-commons" tag="do-this" />

<SampleScripts sample_name="modularize-your-build-do" basename="build" subpath="util-guava" tag="do-this" />
...
<SampleScripts sample_name="no-source-in-root-avoid" basename="build" tag="avoid-this" />
...
<SampleScripts sample_name="no-source-in-root-do" basename="settings" tag="do-this" />

<SampleScripts sample_name="no-source-in-root-do" basename="build" subpath="core" tag="do-this" />
...
<SampleScripts sample_name="favor-composite-builds-avoid" basename="build" subpath="buildSrc" tag="avoid-this" />

**Set up a Plugin Build**: This is the same using either method.

<SampleScripts sample_name="favor-composite-builds-avoid" basename="settings" tag="avoid-this" />

**`buildSrc` products are automatically usable**: There is no additional configuration with this method.

#### Do This Instead

<GitHubButton sample="favor-composite-builds-do" action="download" />
...
<SampleScripts sample_name="favor-composite-builds-do" basename="build" subpath="build-logic/plugin" tag="do-this" />

**Set up a Plugin Build**: This is the same using either method.

<SampleScripts sample_name="favor-composite-builds-do" basename="settings" tag="do-this" />

<SampleScripts sample_name="favor-composite-builds-do" basename="settings" subpath="build-logic" tag="do-this" />
...
<SampleScripts sample_name="avoid-empty-projects-avoid" basename="settings" tag="avoid-this" />
...
<SampleFile sample_name="avoid-empty-projects-avoid" path="tests/avoidEmptyProjects-avoid.out" />
...
<SampleScripts sample_name="avoid-empty-projects-do" basename="settings" tag="do-this" />
...
<SampleFile sample_name="avoid-empty-projects-do" path="tests/avoidEmptyProjects-do.out" />
...
<SampleScripts sample_name="use-convention-plugins-avoid" basename="build" subpath="project-a" tag="avoid-this" />
<SampleScripts sample_name="use-convention-plugins-avoid" basename="build" subpath="project-b" tag="avoid-this" />
...
<SampleScripts sample_name="use-convention-plugins-do" basename="settings" tag="do-this" />
<SampleScripts sample_name="use-convention-plugins-do" basename="build" subpath="build-logic" tag="do-this" />
...
<SampleScripts sample_name="use-convention-plugins-do" basename="my.base-java-library" subpath="build-logic/src/main/{lang}" tag="do-this" />
<SampleScripts sample_name="use-convention-plugins-do" basename="my.java-library" subpath="build-logic/src/main/{lang}" tag="do-this" />
<SampleScripts sample_name="use-convention-plugins-do" basename="my.java-use-junit5" subpath="build-logic/src/main/{lang}" tag="do-this" />
...
<SampleScripts sample_name="use-convention-plugins-do" basename="build" subpath="project-a" tag="do-this" />
<SampleScripts sample_name="use-convention-plugins-do" basename="build" subpath="project-b" tag="do-this" />
