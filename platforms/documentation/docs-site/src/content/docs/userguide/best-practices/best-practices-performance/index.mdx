...
description: "Recommendations for keeping builds fast, covering distribution choice, configuration cache, parallel execution and build caching."
---
...
<SampleFile sample_name="use-build-cache-avoid" path="common/gradle.properties" source_dir="snippets/best-practices/useBuildCache-avoid" />

#### Do This Instead

To enable the Build Cache, add the following to your `gradle.properties` file:

<SampleFile sample_name="use-build-cache-do" path="common/gradle.properties" source_dir="snippets/best-practices/useBuildCache-do" />
...
<SampleFile sample_name="use-configuration-cache-avoid" path="common/gradle.properties" source_dir="snippets/best-practices/useConfigurationCache-avoid" />

#### Do This Instead

To enable the Configuration Cache, add the following to your `gradle.properties` file:

<SampleFile sample_name="use-configuration-cache-do" path="common/gradle.properties" source_dir="snippets/best-practices/useConfigurationCache-do" />
...
<SampleScripts sample_name="avoid-computation-in-configuration-phase-avoid" basename="build" tag="avoid-this" source_dir="snippets/best-practices/avoidComputationInConfigurationPhase-avoid" />
...
<SampleScripts sample_name="avoid-computation-in-configuration-phase-do" basename="build" tag="do-this" source_dir="snippets/best-practices/avoidComputationInConfigurationPhase-do" />
