...
import { CalloutList, GitHubButton, SampleFile, SampleScripts, Xref } from '#/components';
...
<SampleScripts sample_name="use-version-catalogs-avoid" basename="build" tag="avoid-this" />
...
<SampleFile sample_name="use-version-catalogs-do" path="common/gradle/libs.versions.toml" />

<GitHubButton sample="use-version-catalogs-do" action="download" />

<SampleScripts sample_name="use-version-catalogs-do" basename="build" tag="do-this" />
...
<SampleFile sample_name="version-catalog-naming-do" path="common/gradle/libs.versions.toml" />

<GitHubButton sample="version-catalog-naming-do" action="download" />

<SampleScripts sample_name="version-catalog-naming-do" basename="build" tag="do-this" />
...
<SampleScripts sample_name="settings-repositories-avoid" basename="build" tag="avoid-this" />

#### Do This Instead

Instead, you should set them up in `settings.gradle.kts` like this:

<GitHubButton sample="settings-repositories-do" action="download" />

<SampleScripts sample_name="settings-repositories-do" basename="settings" tag="do-this" />
...
<SampleScripts sample_name="kotlin-std-lib-avoid" basename="build" tag="avoid-this" />
...
<GitHubButton sample="kotlin-std-lib-do" action="download" />

<SampleScripts sample_name="kotlin-std-lib-do" basename="build" tag="do-this" />
...
<SampleScripts sample_name="avoid-duplicate-dependencies-avoid" basename="build" />
...
<GitHubButton sample="avoid-duplicate-dependencies-do" action="download" />

<SampleScripts sample_name="avoid-duplicate-dependencies-do" basename="build" />
...
<SampleScripts sample_name="use-gav-string-avoid" basename="build" tag="avoid-this" />
...
<GitHubButton sample="use-gav-string-do" action="download" />

<SampleScripts sample_name="use-gav-string-do" basename="build" tag="do-this" />
...
<SampleScripts sample_name="content-filtering-avoid" basename="settings" tag="content-filtering-avoid" />

#### Do This Instead

Use content filtering to ensure that the proper repositories are searched first for the expected artifacts:

<GitHubButton sample="content-filtering-do" action="download" />

<SampleScripts sample_name="content-filtering-do" basename="settings" tag="content-filtering-do" />
...
<GitHubButton sample="content-filtering-exclusive-do" action="download" />

<SampleScripts sample_name="content-filtering-exclusive-do" basename="settings" tag="content-filtering-do" />
...
<SampleScripts sample_name="apply-exclusions-narrowly-avoid" basename="build" tag="avoid-this" />
...
<GitHubButton sample="apply-exclusions-narrowly-do" action="download" />

<SampleScripts sample_name="apply-exclusions-narrowly-do" basename="build" tag="do-this" />
...
<SampleScripts sample_name="avoid-configurations-without-attributes-avoid" basename="build" subpath="producer" tag="avoid-this" />
...
<SampleScripts sample_name="avoid-configurations-without-attributes-avoid" basename="build" subpath="consumer" tag="avoid-this" />
...
<GitHubButton sample="avoid-configurations-without-attributes-do" action="download" />

In `producer/build.gradle(.kts)`:

<SampleScripts sample_name="avoid-configurations-without-attributes-do" basename="build" subpath="producer" tag="do-this" />
...
<SampleScripts sample_name="avoid-configurations-without-attributes-do" basename="build" subpath="consumer" tag="do-this" />
