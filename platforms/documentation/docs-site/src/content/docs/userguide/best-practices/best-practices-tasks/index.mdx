...
import { CalloutList, GitHubButton, JavaDocLink, SampleScripts, Xref } from '#/components';
...
<SampleScripts sample_name="avoid-depends-on-do" basename="build" tag="depended-upon-task-setup" />
...
<SampleScripts sample_name="avoid-depends-on-avoid" basename="build" tag="avoid-this" />
...
<GitHubButton sample="avoid-depends-on-do" action="download" />

<SampleScripts sample_name="avoid-depends-on-do" basename="build" tag="do-this" />
...
<SampleScripts sample_name="use-cacheability-annotations-avoid" basename="build" tag="avoid-this" />
...
<GitHubButton sample="use-cacheability-annotations-do" action="download" />

<SampleScripts sample_name="use-cacheability-annotations-do" basename="build" tag="do-this" />
...
<SampleScripts sample_name="avoid-provider-get-outside-task-action-avoid" basename="build" tag="provider-get-task-setup" />
...
<SampleScripts sample_name="avoid-provider-get-outside-task-action-avoid" basename="build" tag="avoid-this" />
...
<GitHubButton sample="avoid-provider-get-outside-task-action-do" action="download" />

<SampleScripts sample_name="avoid-provider-get-outside-task-action-do" basename="build" tag="do-this" />
...
<SampleScripts sample_name="group-tasks-avoid" basename="build" subpath="app" tag="avoid-this" />
...
<GitHubButton sample="group-tasks-do" action="download" />

<SampleScripts sample_name="group-tasks-do" basename="build" subpath="app" tag="do-this" />
...
<SampleScripts sample_name="avoid-jdk-collection-api-on-file-collections-avoid" basename="build" subpath="lib" tag="avoid-this" />
...
<GitHubButton sample="avoid-jdk-collection-api-on-file-collections-do" action="download" />

<SampleScripts sample_name="avoid-jdk-collection-api-on-file-collections-do" basename="build" subpath="lib" tag="do-this" />
...
<SampleScripts sample_name="avoid-resolving-configurations-manually-avoid" basename="build" subpath="app" tag="avoid-this" />
...
<GitHubButton sample="avoid-resolving-configurations-manually-do" action="download" />

<SampleScripts sample_name="avoid-resolving-configurations-manually-do" basename="build" subpath="app" tag="do-this" />
...
<SampleScripts sample_name="prefer-path-sensitivity-none-avoid" basename="build" />
...
<GitHubButton sample="prefer-path-sensitivity-none-do" action="download" />

<SampleScripts sample_name="prefer-path-sensitivity-none-do" basename="build" tag="do-this" />
...
<SampleScripts sample_name="unique-outputs-avoid" basename="build" tag="avoid-this" />
...
<SampleScripts sample_name="unique-outputs-simple-do" basename="build" tag="simple-do-this" />
...
<GitHubButton sample="unique-outputs-do" action="download" />

<SampleScripts sample_name="unique-outputs-do" basename="build" tag="do-this" />
...
<SampleScripts sample_name="avoid-hardcoding-task-names-avoid" basename="build" tag="avoid-this" />
...
<GitHubButton sample="avoid-hardcoding-task-names-do" action="download" />
...
<SampleScripts sample_name="avoid-hardcoding-task-names-do" basename="build" tag="ok" />
...
<SampleScripts sample_name="avoid-hardcoding-task-names-do" basename="build" tag="best" />
...
<SampleScripts sample_name="dont-access-project-avoid" basename="build" tag="avoid-this" />
...
<GitHubButton sample="dont-access-project-do" action="download" />
...
<SampleScripts sample_name="dont-access-project-do" basename="build" tag="do-this" />
...
<SampleScripts sample_name="be-careful-with-map-flatmap-avoid" basename="build" tag="config-time-read" />
...
<SampleScripts sample_name="be-careful-with-map-flatmap-do" basename="build" tag="flatmap-provider" />
...
<SampleScripts sample_name="be-careful-with-map-flatmap-ex-avoid" basename="build" tag="naked-provider" />
...
<SampleScripts sample_name="be-careful-with-map-flatmap-avoid" basename="build" tag="derived-property" />
...
<SampleScripts sample_name="be-careful-with-map-flatmap-do" basename="build" tag="derived-property-fix" />
...
<SampleScripts sample_name="be-careful-with-map-flatmap-do" basename="build" tag="direct-annotation" />
...
<SampleScripts sample_name="be-careful-with-map-flatmap-do" basename="build" tag="eager-property" />
