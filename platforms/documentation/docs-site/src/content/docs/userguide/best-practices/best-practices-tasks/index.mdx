...
description: "Recommendations for writing tasks, covering task dependencies, inputs and outputs, and avoiding work at configuration time."
---
...
- **No eager reads are needed:** Appending to a plain `Property` forces you to call `get()` at configuration time to read the current collection before writing a new one back, which violates [Do not call `get()` on a Provider outside a Task action](#avoid_provider_get_outside_task_action).
...
<SampleScripts sample_name="favor-collection-properties-avoid" basename="build" tag="setup" source_dir="snippets/best-practices/favorCollectionProperties-avoid" />
...
<SampleScripts sample_name="favor-collection-properties-avoid" basename="build" tag="avoid-this" source_dir="snippets/best-practices/favorCollectionProperties-avoid" />
...
This resolves the property before the build has finished configuring, in violation of [Do not call `get()` on a Provider outside a Task action](#avoid_provider_get_outside_task_action).
...
<SampleScripts sample_name="favor-collection-properties-do" basename="build" tag="do-this" source_dir="snippets/best-practices/favorCollectionProperties-do" />
...
- <Xref page="lazy-configuration" section="Working with collections">Working with Collections</Xref>
- <Xref page="lazy-configuration" section="Working with maps">Working with Maps</Xref>
- <Xref page="properties-providers" section="Using Gradle Managed Properties">Managed Properties</Xref>

### Tags

`<Xref page="tags-reference" section="`#tasks`">#tasks</Xref>`, `<Xref page="tags-reference" section="`#properties`">#properties</Xref>`, `<Xref page="tags-reference" section="`#inputs-and-outputs`">#inputs-and-outputs</Xref>`