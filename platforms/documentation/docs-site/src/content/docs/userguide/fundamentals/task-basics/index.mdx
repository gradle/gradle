---
title: "Task Basics"
description: "What a task is, how tasks declare work and dependencies, and how Gradle decides which tasks to run."
---

import { Xref } from '#/components';
import { Image } from 'astro:assets';
import gradleBasic5 from './gradle-basic-5.png';
...
<Image src={gradleBasic5} alt="gradle basic 5" />
...
***Next Step:*** <Xref page="gradle-optimizations" section="Incremental Builds and Build Caching Basic">Learn about Incremental Builds and Build Caching</Xref> \>\>