...
description: "Running Gradle from the command line: invoking tasks, common options, and how the CLI relates to the Wrapper."
---
...
:::tip
Use of the <Xref page="gradle-wrapper" section="Gradle Wrapper">Gradle Wrapper</Xref> is highly encouraged. Substitute `./gradlew` (in macOS / Linux) or `gradlew.bat` (in Windows) for `gradle` in the following examples.
:::
...
***Next Step:*** <Xref page="settings-file-basics" section="Settings File Basics">Learn about the Settings file</Xref> \>\>