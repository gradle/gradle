---
title: "Plugin Basics"
description: "Introduction to Gradle's plugin system: what plugins provide, where they come from, and how to apply them."
---

import { JavaDocLink, Xref } from '#/components';
import { Image } from 'astro:assets';
import gradleBasic6 from './gradle-basic-6.png';
...
<Image src={gradleBasic6} alt="gradle basic 6" />
...
Core plugins are unique in that they provide short names, such as `java-library` for the core <JavaDocLink class="org.gradle.api.plugins.JavaLibraryPlugin" />.
...
See the <Xref page="plugin-reference" section="Gradle Plugin Reference">Core Plugin Reference</Xref> for a full list.
...
***Next Step:*** <Xref page="build-scans" section="Build Scan Basics">Learn about Build Scan</Xref> \>\>