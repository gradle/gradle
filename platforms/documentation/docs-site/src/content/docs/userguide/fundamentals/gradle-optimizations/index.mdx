...
description: "How incremental builds and the build cache avoid redundant work, and what makes a task eligible for each."
---

import { Xref } from '#/components';
import { Image } from 'astro:assets';
import gradleBasic8 from './gradle-basic-8.png';

Gradle uses two main features to reduce build time: **incremental builds** and **build caching**.

<Image src={gradleBasic8} alt="gradle basic 8" />
...
***Next Step:*** <Xref page="plugin-basics" section="Plugin Basics">Learn about Plugins</Xref> \>\>