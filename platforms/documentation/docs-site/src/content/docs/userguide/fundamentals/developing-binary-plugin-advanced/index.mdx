...
description: "Developing a binary plugin: defining tasks, exposing configuration through extensions, and structuring plugin code."
---
...
<SampleScripts sample_name="file-size-diff-binary-plugin" basename="build" subpath="plugin" tag="simple" source_dir="snippets/fundamentals/developing-plugins/fileSizeDiffBinaryPlugin" />
...
<SampleScripts sample_name="file-size-diff-binary-plugin" basename="build" source_dir="snippets/fundamentals/developing-plugins/fileSizeDiffBinaryPlugin" />
