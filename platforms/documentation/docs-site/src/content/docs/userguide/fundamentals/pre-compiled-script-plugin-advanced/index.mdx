...
<SampleScripts sample_name="precompiled-script-plugins-in-build-src" basename="java-library-convention" subpath="buildSrc/src/main/{lang}" />

And are applied in other projects like this:

<SampleScripts sample_name="precompiled-script-plugins-in-build-src" basename="build" />
...
<SampleScripts sample_name="test-report" basename="build" subpath="buildSrc" />
...
<SampleScripts sample_name="test-report" basename="myproject.java-conventions" subpath="buildSrc/src/main/{lang}" />
...
<SampleScripts sample_name="test-report" basename="build" subpath="core" />
