...
description: "Introduction to Gradle's dependency management: declaring dependencies, repositories, and how transitive dependencies are resolved."
---

import { CalloutList, SampleFile, SampleScripts, Xref } from '#/components';
import { Image } from 'astro:assets';
import gradleBasic7 from './gradle-basic-7.png';

Gradle has built-in support for **dependency management**.

<Image src={gradleBasic7} alt="gradle basic 7" />
...
<SampleScripts sample_name="introduction-dependencies" basename="build" tag="dependency-intro-dep" source_dir="snippets/fundamentals/running-builds/introductionDependencies" />
...
<SampleFile sample_name="introduction-dependencies" path="common/gradle/libs.versions.toml" source_dir="snippets/fundamentals/running-builds/introductionDependencies" />
...
<SampleScripts sample_name="introduction-dependencies" basename="build" tag="dependency-intro-catalog" source_dir="snippets/fundamentals/running-builds/introductionDependencies" />

***Next Step:*** <Xref page="task-basics" section="Task Basics">Learn about Tasks</Xref> \>\>