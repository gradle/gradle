...
<SampleScripts sample_name="introduction-dependencies" basename="build" tag="dependency-intro-dep" />
...
<SampleFile sample_name="introduction-dependencies" path="common/gradle/libs.versions.toml" />
...
<SampleScripts sample_name="introduction-dependencies" basename="build" tag="dependency-intro-catalog" />
