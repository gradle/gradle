...
description: "Publishing a binary plugin so it can be reused across builds or shared through the Gradle Plugin Portal."
---
...
<SampleScripts sample_name="file-size-diff-binary-plugin" basename="build" subpath="plugin" tag="plugin-id" source_dir="snippets/fundamentals/developing-plugins/fileSizeDiffBinaryPlugin" />
...
<SampleScripts sample_name="publishing-binary-plugin-publishing-block" basename="build" tag="publishing-block" source_dir="snippets/fundamentals/developing-plugins/publishingBinaryPlugin-publishingBlock" />
