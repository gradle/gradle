...
description: "What a Gradle plugin is and what it can contribute to a build: tasks, conventions and configuration."
---
...
<SampleScripts sample_name="dsl" basename="build" tag="use-community-plugin" source_dir="snippets/fundamentals/developing-plugins/dsl" />
...
<SampleScripts sample_name="junitplatform-engine" basename="build" tag="filter-engine" source_dir="snippets/fundamentals/developing-plugins/junitplatform-engine" />

And Java options using the `java {}` block:

<SampleScripts sample_name="fixtures" basename="build" subpath="lib" tag="java-block" source_dir="snippets/fundamentals/developing-plugins/fixtures" />
