...
description: "Testing binary plugins with unit and functional tests, including Gradle TestKit."
---
...
<SampleScripts sample_name="file-size-diff-binary-plugin" basename="build" subpath="plugin" source_dir="snippets/fundamentals/developing-plugins/fileSizeDiffBinaryPlugin" />
...
<SampleScripts sample_name="file-size-diff-binary-plugin" basename="settings" source_dir="snippets/fundamentals/developing-plugins/fileSizeDiffBinaryPlugin" />
