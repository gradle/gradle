...
You can also control the JVM used to run Gradle itself using the [Daemon JVM criteria](gradle_daemon.mdx#sec:daemon_jvm_criteria).
...
:::note
Some IDEs also allow you to configure the [Gradle Daemon](gradle_daemon.mdx#gradle_daemon) JVM in the same settings screen.
...
{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/jvm-multi-project-with-toolchains/kotlin" files="list/build.gradle.kts[tags=customToolchain]" */}

{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/jvm-multi-project-with-toolchains/groovy/" files="list/build.gradle[tags=customToolchain]" */}

In addition, in the `application` subproject, we add another Java execution task to run our application with JDK 17.

{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/jvm-multi-project-with-toolchains/kotlin" files="application/build.gradle.kts[tags=customExec]" */}

{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/jvm-multi-project-with-toolchains/groovy/" files="application/build.gradle[tags=customExec]" */}
...
Toolchains tool providers can be obtained from the [`javaToolchains`]({javadocPath}/org/gradle/jvm/toolchain/JavaToolchainService.html) extension.

Three tools are available:

- A `JavaCompiler` which is the tool used by the [JavaCompile]({groovyDslPath}/org.gradle.api.tasks.compile.JavaCompile.html#org.gradle.api.tasks.compile.JavaCompile:javaCompiler) task
- A `JavaLauncher` which is the tool used by the [JavaExec]({groovyDslPath}/org.gradle.api.tasks.JavaExec.html#org.gradle.api.tasks.JavaExec:javaLauncher) or [Test]({groovyDslPath}/org.gradle.api.tasks.testing.Test.html#org.gradle.api.tasks.testing.Test:javaLauncher) tasks
- A `JavadocTool` which is the tool used by the [Javadoc]({groovyDslPath}/org.gradle.api.tasks.javadoc.Javadoc.html#org.gradle.api.tasks.javadoc.Javadoc:javadocTool) task
...
{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-config-task/kotlin/" files="build.gradle.kts[tags=java-executable]" */}

{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-config-task/groovy/" files="build.gradle[tags=java-executable]" */}

As another example, you can configure the _Java Home_ for a task as follows:

{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-config-task/kotlin/" files="build.gradle.kts[tags=java-home]" */}

{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-config-task/groovy/" files="build.gradle[tags=java-home]" */}

If you require a path to a specific tool such as Java compiler, you can obtain it as follows:

{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-config-task/kotlin/" files="build.gradle.kts[tags=java-compiler]" */}

{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-config-task/groovy/" files="build.gradle[tags=java-compiler]" */}
...
[`JvmVendorSpec`]({javadocPath}/org/gradle/jvm/toolchain/JvmVendorSpec.html) has a list of well-known JVM vendors recognized by Gradle.
...
{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-filters/kotlin/" files="build.gradle.kts[tags=toolchain-known-vendor]" */}

{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-filters/groovy/" files="build.gradle[tags=toolchain-known-vendor]" */}
...
{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-filters/kotlin/" files="build.gradle.kts[tags=toolchain-matching-vendor]" */}

{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-filters/groovy/" files="build.gradle[tags=toolchain-matching-vendor]" */}
...
{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-filters/kotlin/" files="build.gradle.kts[tags=toolchain-native-image]" */}

{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-filters/groovy/" files="build.gradle[tags=toolchain-native-image]" */}
...
{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-filters/kotlin/" files="build.gradle.kts[tags=toolchain-matching-implementation]" */}

{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-filters/groovy/" files="build.gradle[tags=toolchain-matching-implementation]" */}
...
Gradle installs the downloaded JDKs in the [Gradle User Home](directory_layout.mdx#dir:gradle_user_home).
...
Once installed in the [Gradle User Home](directory_layout.mdx#dir:gradle_user_home), a provisioned JDK becomes one of the JDKs visible to [auto-detection](#sec:auto_detection) and can be used by any subsequent builds, just like any other JDK installed on the system.
...
For details on writing such plugins, consult the [Toolchain Resolver Plugins](toolchain_plugins.mdx#toolchain_plugins) page.
...
{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-foojay/kotlin/" files="settings.gradle.kts[tags=plugin-application]" */}

{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-foojay/groovy/" files="settings.gradle[tags=plugin-application]" */}
...
{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-management/kotlin/" files="settings.gradle.kts[tags=toolchain-management]" */}

{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-management/groovy/" files="settings.gradle[tags=toolchain-management]" */}
...
When removing an auto-provisioned toolchain is necessary, remove the relevant toolchain located in the `/jdks` directory within the [Gradle User Home](directory_layout.mdx#dir:gradle_user_home).

:::note
The [Gradle Daemon](gradle_daemon.mdx#gradle_daemon) caches information about your project, including configuration details such as toolchain paths or versions. Changes to a project&#8217;s toolchain configuration might only occur once the Gradle Daemon is restarted. It is recommended to  [stop the Gradle Daemon](gradle_daemon.mdx#sec:stopping_an_existing_daemon) to ensure that Gradle updates the configuration for subsequent builds.
:::
...
{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-task/kotlin/" files="build.gradle.kts[tags=custom-toolchain-task-with-java]" */}

{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-task/groovy/" files="build.gradle[tags=custom-toolchain-task-with-java]" */}

{/* converter-gap: node=colist */}

In a project where the `java` plugin was applied, we can use the task as follows:

{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-task/kotlin/" files="build.gradle.kts[tags=custom-toolchain-task-with-java-usage]" */}

{/* converter-gap: node=sample dir="snippets/reference/platforms/jvm/toolchain-task/groovy/" files="build.gradle[tags=custom-toolchain-task-with-java-usage]" */}
...
You can find more details on defining custom tasks in the [Authoring tasks](more_about_tasks.mdx#more_about_tasks) documentation.
