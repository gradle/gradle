...
A [Build Scan](https://scans.gradle.com/) is a persistent, shareable record of what happened when running a build.
...
:::note
For information on what data is collected and how it&#8217;s handled, see the [Gradle.com Privacy Policy](https://gradle.com/privacy).
:::
...
[Develocity Plugin User Manual](https://docs.gradle.com/develocity/gradle-plugin/current/#getting_set_up) explains how to generate a Build Scan.
...
Use the [Gradle Profiler](https://github.com/gradle/gradle-profiler) to find these kinds of bottlenecks.
...
If you find that something in Gradle itself slows down your build, don&#8217;t hesitate to send a profiler snapshot to [performance@gradle.com](mailto:performance@gradle.com).
...
If you find that Gradle takes a long time to process it, use more traditional profiling methods, like the [Gradle Profiler](https://github.com/gradle/gradle-profiler), to determine the cause.
