...
The Gradle dependency cache consists of two storage types located under `$[GRADLE_USER_HOME](directory_layout.mdx#dir:gradle_user_home)/caches`:
...
You can learn more about cache cleanup in [Gradle-managed Directories](directory_layout.mdx#dir:gradle_user_home:cache_cleanup).
...
You can fine-tune certain aspects of caching programmatically using the [ResolutionStrategy]({javadocPath}/org/gradle/api/artifacts/ResolutionStrategy.html) for a configuration.
...
{/* converter-gap: node=sample dir="snippets/reference/dependency-management/dependency-management/troubleshooting-cache-dynamic/kotlin" files="build.gradle.kts[tags=dynamic-version-cache-control]" */}

{/* converter-gap: node=sample dir="snippets/reference/dependency-management/dependency-management/troubleshooting-cache-dynamic/groovy" files="build.gradle[tags=dynamic-version-cache-control]" */}

To change how long Gradle will cache the metadata and artifacts for a changing module, use:

{/* converter-gap: node=sample dir="snippets/reference/dependency-management/dependency-management/troubleshooting-cache-changing/kotlin" files="build.gradle.kts[tags=changing-module-cache-control]" */}

{/* converter-gap: node=sample dir="snippets/reference/dependency-management/dependency-management/troubleshooting-cache-changing/groovy" files="build.gradle[tags=changing-module-cache-control]" */}
