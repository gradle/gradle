...
{/* converter-gap: node=sample dir="snippets/reference/platforms/native/swift-basic/kotlin" files="build.gradle.kts[tags=apply-swift-plugin]" */}

{/* converter-gap: node=sample dir="snippets/reference/platforms/native/swift-basic/groovy" files="build.gradle[tags=apply-swift-plugin]" */}
...
The Swift plugins also integrates the above tasks into the standard [lifecycle tasks](base_plugin.mdx#sec:base_tasks).
...
Gradle’s Swift support uses a `ConfigurableFileCollection` directly from the [application]({groovyDslPath}/org.gradle.language.swift.SwiftApplication.html) or [library]({groovyDslPath}/org.gradle.language.swift.SwiftLibrary.html) script block to configure the set of sources to compile.
...
{/* converter-gap: node=sample dir="snippets/reference/platforms/native/swift-basic/kotlin" files="build.gradle.kts[tags=swift-dependency-mgmt]" */}

{/* converter-gap: node=sample dir="snippets/reference/platforms/native/swift-basic/groovy" files="build.gradle[tags=swift-dependency-mgmt]" */}
...
Be aware that the [Swift Library Plugin](swift_library_plugin.mdx#swift_library_plugin) creates an additional configuration — `api` — for dependencies that are required for compiling and linking both the module and any modules that depend on it.

We have only scratched the surface here, so we recommend that you read the [dedicated dependency management chapters](getting_started_dep_man.mdx#dependency-management-in-gradle) once you’re comfortable with the basics of building Swift projects with Gradle.

Some common scenarios that require further reading include:

- Defining a custom [Maven-compatible](supported_repository_types.mdx#repository-types) repository
...
:::note
All [SwiftCompile]({groovyDslPath}/org.gradle.language.swift.tasks.SwiftCompile.html) tasks are incremental and cacheable.
:::
...
{/* converter-gap: node=sample dir="snippets/reference/platforms/native/swift-basic/kotlin/common" files="build.gradle.kts[tags=swift-source-set]" */}

{/* converter-gap: node=sample dir="snippets/reference/platforms/native/swift-basic/groovy/common" files="build.gradle[tags=swift-source-set]" */}
...
These tasks are of type [SwiftCompile]({groovyDslPath}/org.gradle.language.swift.tasks.SwiftCompile.html), [LinkSharedLibrary]({groovyDslPath}/org.gradle.nativeplatform.tasks.LinkSharedLibrary.html) and [CreateStaticLibrary]({groovyDslPath}/org.gradle.nativeplatform.tasks.CreateStaticLibrary.html) respectively.
...
{/* converter-gap: node=sample dir="snippets/reference/platforms/native/swift-basic/kotlin" files="build.gradle.kts[tags=swift-compiler-options-all-variants]" */}

{/* converter-gap: node=sample dir="snippets/reference/platforms/native/swift-basic/groovy" files="build.gradle[tags=swift-compiler-options-all-variants]" */}
...
{/* converter-gap: node=sample dir="snippets/reference/platforms/native/swift-basic/kotlin" files="build.gradle.kts[tags=swift-compiler-options-per-variants]" */}

{/* converter-gap: node=sample dir="snippets/reference/platforms/native/swift-basic/groovy" files="build.gradle[tags=swift-compiler-options-per-variants]" */}
...
{/* converter-gap: node=sample dir="snippets/reference/platforms/native/swift-basic/kotlin" files="build.gradle.kts[tags=swift-select-target-machines]" */}

{/* converter-gap: node=sample dir="snippets/reference/platforms/native/swift-basic/groovy" files="build.gradle[tags=swift-select-target-machines]" */}
...
The Swift Application and Library Plugins add a `clean` task to you project by using the [base plugin](base_plugin.mdx#base_plugin).
...
Gradle manages this distinction via the [Swift Library Plugin](swift_library_plugin.mdx#swift_library_plugin), which introduces an _api_ configuration in addition to the _implementation_ once covered in this chapter.
...
If you’re unsure of the difference between an API and implementation dependency, the [Swift Library Plugin](swift_library_plugin.mdx#sec:swift_library_api_vs_implementation) chapter has a detailed explanation.

## Building Swift applications

See the [Swift Application Plugin](swift_application_plugin.mdx#swift_application_plugin) chapter for more details, but here’s a quick summary of what you get:
