...
description: "File operations in build logic: file collections, file trees, copying, archiving and path handling."
---
...
:::note
`skipWhenSourceIsEmpty` is an <Xref page="feature-lifecycle" section="The Feature Lifecycle">incubating</Xref> feature and is subject to change.
:::
