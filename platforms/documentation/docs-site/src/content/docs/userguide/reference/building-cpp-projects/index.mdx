...
description: "Building C++ projects with Gradle: source layout conventions, toolchains, variants and dependencies."
---
...
<SampleScripts sample_name="cpp-basic" basename="build" tag="apply-cpp-plugin" source_dir="snippets/reference/platforms/native/cpp-basic" />
...
The C++ plugins also integrates the above tasks into the standard <Xref page="base-plugin" section="Tasks">lifecycle tasks</Xref>. The task that produces the development binary is attached to `assemble`.  By default, the development binary is the debug variant.
...
<SampleScripts sample_name="cpp-basic" basename="build" tag="cpp-dependency-mgmt" source_dir="snippets/reference/platforms/native/cpp-basic" />
...
<SampleScripts sample_name="cpp-basic" basename="build" tag="cpp-toolchain" source_dir="snippets/reference/platforms/native/cpp-basic" />
...
<SampleScripts sample_name="cpp-basic" basename="build" subpath="common" tag="cpp-source-set" source_dir="snippets/reference/platforms/native/cpp-basic" />
...
<SampleScripts sample_name="cpp-basic" basename="build" tag="cpp-compiler-options-all-variants" source_dir="snippets/reference/platforms/native/cpp-basic" />
...
<SampleScripts sample_name="cpp-basic" basename="build" tag="cpp-compiler-options-per-variants" source_dir="snippets/reference/platforms/native/cpp-basic" />
...
<SampleScripts sample_name="cpp-basic" basename="build" tag="cpp-select-target-machines" source_dir="snippets/reference/platforms/native/cpp-basic" />
