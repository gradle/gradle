---
title: "Capabilities"
description: "Capabilities, which let Gradle detect and resolve conflicts between different implementations of the same API."
---
...
<SampleScripts sample_name="component-capabilities-capability-conflict" basename="build" tag="capability-conflict" source_dir="snippets/reference/dependency-management/controlling-dependency-resolution/componentCapabilities-capabilityConflict" />
...
<SampleScripts sample_name="managing-transitive-dependencies-declaring-capabilities" basename="build" tag="fix_asm" source_dir="snippets/reference/dependency-management/controlling-dependency-resolution/managingTransitiveDependencies-declaringCapabilities" />
...
<SampleScripts sample_name="managing-transitive-dependencies-declaring-capabilities" basename="build" tag="dependencies" source_dir="snippets/reference/dependency-management/controlling-dependency-resolution/managingTransitiveDependencies-declaringCapabilities" />
...
<SampleScripts sample_name="managing-transitive-dependencies-declaring-capabilities" basename="build" tag="declare_capability" source_dir="snippets/reference/dependency-management/controlling-dependency-resolution/managingTransitiveDependencies-declaringCapabilities" />

This ensures that Gradle detects the conflict and fails with a clear error message:

<SampleFile sample_name="managing-transitive-dependencies-declaring-capabilities" path="tests/dependencyReport.out" source_dir="snippets/reference/dependency-management/controlling-dependency-resolution/managingTransitiveDependencies-declaringCapabilities" />
...
<SampleScripts sample_name="modeling-features-outgoing-capabilities" basename="build" tag="declare-outgoing-capabilities" source_dir="snippets/reference/dependency-management/controlling-dependency-resolution/modelingFeatures-outgoingCapabilities" />

Capabilities must be attached to _outgoing configurations_, which are <Xref page="declaring-configurations" section="Declarable, Resolvable, and Consumable configurations">consumable configurations</Xref> of a component.
...
<SampleScripts sample_name="managing-transitive-dependencies-declaring-capabilities" basename="build" tag="use_highest_asm" source_dir="snippets/reference/dependency-management/controlling-dependency-resolution/managingTransitiveDependencies-declaringCapabilities" />
...
<SampleScripts sample_name="managing-transitive-dependencies-declaring-capabilities" basename="build" tag="use_slf4j" source_dir="snippets/reference/dependency-management/controlling-dependency-resolution/managingTransitiveDependencies-declaringCapabilities" />
...
For more information, refer to the <JavaDocLink class="org.gradle.api.artifacts.ResolutionStrategy" method="capabilitiesResolution">capabilities resolution API</JavaDocLink>.