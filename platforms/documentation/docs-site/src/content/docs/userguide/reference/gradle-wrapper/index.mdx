...
description: "The Gradle Wrapper in full: generating it, upgrading it, verifying it, and how it resolves a distribution."
---
...
See [Preserving Existing Wrapper Properties](#sec:preserving_wrapper_properties) for details.
