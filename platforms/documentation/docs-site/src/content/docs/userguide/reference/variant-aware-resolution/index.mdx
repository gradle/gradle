...
<SampleScripts sample_name="customizing-resolution-secondary-variants" basename="build" tag="lib" />
...
<SampleScripts sample_name="customizing-resolution-secondary-variants" basename="build" tag="add" />
...
<SampleScripts sample_name="customizing-resolution-secondary-variants" basename="build" tag="custom" />
