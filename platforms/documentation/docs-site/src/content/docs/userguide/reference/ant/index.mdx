...
<SampleScripts sample_name="use-ant-task" basename="build" />
...
<SampleScripts sample_name="task-with-nested-text" basename="build" />
...
<SampleScripts sample_name="task-with-nested-elements" basename="build" />
...
<SampleScripts sample_name="use-ant-type" basename="build" />
...
<SampleScripts sample_name="use-external-ant-task" basename="build" tag="configure-task" />
...
<SampleScripts sample_name="use-external-ant-task-with-config" basename="build" tag="define-classpath" />

To use the classpath configuration, use the `asPath` property of the custom configuration:

<SampleScripts sample_name="use-external-ant-task-with-config" basename="build" tag="use-classpath" />
...
<SampleFile sample_name="hello" path="common/build.xml" />
...
<SampleScripts sample_name="depends-on-ant-target" basename="build" />
...
<SampleScripts sample_name="add-behaviour-to-ant-target" basename="build" />
...
<SampleScripts sample_name="depends-on-task" basename="build" />

<SampleFile sample_name="depends-on-task" path="common/build.xml" />
...
<SampleScripts sample_name="rename-task" basename="build" />

<SampleFile sample_name="rename-task" path="common/build.xml" />
...
<SampleScripts sample_name="properties" basename="build" tag="set-property" />
...
<SampleFile sample_name="properties" path="common/build.xml" tag="getproperty" />

<SampleScripts sample_name="properties" basename="build" tag="get-property" />

There are several ways to set an Ant reference:

<SampleScripts sample_name="properties" basename="build" tag="set-reference" />

<SampleFile sample_name="properties" path="common/build.xml" tag="setreference" />

There are several ways to get an Ant reference:

<SampleFile sample_name="properties" path="common/build.xml" tag="getreference" />

<SampleScripts sample_name="properties" basename="build" tag="get-reference" />
...
<SampleScripts sample_name="ant-logging" basename="build" />
