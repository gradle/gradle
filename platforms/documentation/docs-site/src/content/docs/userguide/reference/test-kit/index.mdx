...
description: "Gradle TestKit: functionally testing plugins and build logic by running real builds in isolation."
---
...
<SampleScripts sample_name="junit-quickstart" basename="build" tag="declare-gradle-testkit-dependency" source_dir="snippets/reference/plugin-development/junitQuickstart" />
...
<SampleScripts sample_name="junit-quickstart" basename="build" tag="declare-junit-dependency" source_dir="snippets/reference/plugin-development/junitQuickstart" />
...
<SampleScripts sample_name="automatic-classpath-injection-quickstart" basename="build" tag="automatic-classpath" source_dir="snippets/reference/plugin-development/automaticClasspathInjectionQuickstart" />
...
<SampleScripts sample_name="automatic-classpath-injection-custom-test-source-set" basename="build" tag="custom-test-source-set" source_dir="snippets/reference/plugin-development/automaticClasspathInjectionCustomTestSourceSet" />
