...
description: "Testing JVM projects: test tasks, frameworks, filtering, reporting and controlling test execution."
---
...
<SampleScripts sample_name="java-basic" basename="build" tag="java-basic-test-config" source_dir="snippets/reference/core-plugins/java-basic" />
...
<SampleScripts sample_name="filtering" basename="build" tag="test-filtering" source_dir="snippets/reference/platforms/jvm/filtering" />
...
<SampleScripts sample_name="custom-dirs" basename="build" tag="custom-report-dirs" source_dir="snippets/reference/platforms/jvm/customDirs" />
...
<SampleScripts sample_name="test-report" basename="myproject.java-conventions" subpath="buildSrc/src/main/{lang}" tag="test-report" source_dir="snippets/reference/platforms/jvm/testReport" />
<SampleScripts sample_name="test-report" basename="build" tag="test-report" source_dir="snippets/reference/platforms/jvm/testReport" />
...
<SampleScripts sample_name="junit-xml-results" basename="build" tag="configure-location-convention" source_dir="snippets/reference/platforms/jvm/junit-xml-results" />

With the above configuration, the XML files will be written to `layout.buildDirectory.dir("junit-xml/$testTaskName")`.

<SampleScripts sample_name="junit-xml-results" basename="build" tag="configure-location-task" source_dir="snippets/reference/platforms/jvm/junit-xml-results" />
...
<SampleScripts sample_name="junit-xml-results" basename="build" tag="configure-content" source_dir="snippets/reference/platforms/jvm/junit-xml-results" />
...
If you are using [Build Scan](https://scans.gradle.com) or [Develocity](https://develocity.ai/),
...
<SampleScripts sample_name="junit-categories" basename="build" tag="test-categories" source_dir="snippets/reference/platforms/jvm/junit-categories" />
...
<SampleScripts sample_name="junitplatform-tagging" basename="build" tag="test-tags" source_dir="snippets/reference/platforms/jvm/junitplatform-tagging" />
...
<SampleScripts sample_name="testng-groups" basename="build" tag="test-config" source_dir="snippets/reference/platforms/jvm/testng-groups" />
...
<SampleScripts sample_name="junitplatform-jupiter" basename="build" tag="enabling-junit-platform" source_dir="snippets/reference/platforms/jvm/junitplatform-jupiter" />
...
<SampleScripts sample_name="junitplatform-jupiter" basename="build" tag="jupiter-dependencies" source_dir="snippets/reference/platforms/jvm/junitplatform-jupiter" />
...
<SampleScripts sample_name="junitplatform-mix" basename="build" tag="vintage-dependencies" source_dir="snippets/reference/platforms/jvm/junitplatform-mix" />
...
[junit-jupiter-engine](https://docs.junit.org/current/api/org.junit.jupiter.engine/module-summary.html) and [junit-vintage-engine](https://junit.org/junit5/docs/current/api/org.junit.vintage.engine/module-summary.html).
...
<SampleScripts sample_name="junitplatform-engine" basename="build" tag="filter-engine" source_dir="snippets/reference/platforms/jvm/junitplatform-engine" />
...
<SampleScripts sample_name="testng-preserveorder" basename="build" tag="test-config" source_dir="snippets/reference/platforms/jvm/testng-preserveorder" />
...
<SampleScripts sample_name="testng-groupbyinstances" basename="build" tag="test-config" source_dir="snippets/reference/platforms/jvm/testng-groupbyinstances" />
...
<SampleScripts sample_name="java-basic" basename="build" tag="practical-integ-test-source-set" source_dir="snippets/reference/core-plugins/java-basic" />
...
<SampleScripts sample_name="java-basic" basename="build" tag="integ-test-task" source_dir="snippets/reference/core-plugins/java-basic" />
...
<SampleScripts sample_name="patch-module" basename="build" tag="patchArgs" source_dir="snippets/reference/platforms/jvm/patch-module" />
...
<SampleScripts sample_name="java-basic" basename="build" tag="skip-tests-condition" source_dir="snippets/reference/core-plugins/java-basic" />
...
`cleanTest` is based on a task rule provided by the <Xref page="base-plugin" section="Tasks">Base Plugin</Xref>. You can use it for _any_ task.
...
<SampleScripts sample_name="fixtures" basename="build" subpath="lib" tag="use-plugin" source_dir="snippets/reference/platforms/jvm/fixtures" />
...
<SampleScripts sample_name="fixtures" basename="build" subpath="lib" tag="test_fixtures_deps" source_dir="snippets/reference/platforms/jvm/fixtures" />
...
<SampleScripts sample_name="fixtures" basename="build" tag="consumer_dependencies" source_dir="snippets/reference/platforms/jvm/fixtures" />
...
<SampleScripts sample_name="fixtures" basename="build" tag="external-test-fixtures-dependency" source_dir="snippets/reference/platforms/jvm/fixtures" />
...
<SampleScripts sample_name="fixtures" basename="build" subpath="lib" tag="disable-test-fixtures-publishing" source_dir="snippets/reference/platforms/jvm/fixtures" />
...
<SampleScripts sample_name="non-class-based-testing" basename="build" subpath="lib" tag="test-setup" source_dir="snippets/reference/platforms/jvm/non-class-based-testing" />
...
<SampleFile sample_name="non-class-based-testing" path="common/lib/src/test/definitions/ExampleTests.xml" source_dir="snippets/reference/platforms/jvm/non-class-based-testing" />

<SampleFile sample_name="non-class-based-testing" path="common/lib/src/test/definitions/sub/MoreTests.xml" source_dir="snippets/reference/platforms/jvm/non-class-based-testing" />
