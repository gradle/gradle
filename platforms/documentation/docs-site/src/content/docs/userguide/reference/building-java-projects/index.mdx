...
description: "Building JVM projects with Gradle: source sets, compilation, testing, packaging and publishing conventions."
---
...
<SampleScripts sample_name="java-basic" basename="build" tag="apply-java-plugin" source_dir="snippets/reference/core-plugins/java-basic" />
...
The Java Library Plugin also integrates the above tasks into the standard <Xref page="base-plugin" section="Tasks">Base Plugin lifecycle tasks</Xref>:
...
<SampleScripts sample_name="source-sets-bad-conf-names" basename="build" tag="create-configurations" source_dir="snippets/reference/platforms/jvm/sourceSets-badConfNames" />
...
<SampleScripts sample_name="custom-confs-creation" basename="build" tag="create-configurations" source_dir="snippets/reference/platforms/jvm/customConfs-creation" />
...
<SampleScripts sample_name="java-basic" basename="build" tag="java-dependency-mgmt" source_dir="snippets/reference/core-plugins/java-basic" />
...
<SampleScripts sample_name="custom-dirs" basename="build" tag="custom-src-dirs" source_dir="snippets/reference/platforms/jvm/customDirs" />
...
<SampleScripts sample_name="custom-dirs" basename="build" tag="custom-extra-src-dir" source_dir="snippets/reference/platforms/jvm/customDirs" />
...
<SampleScripts sample_name="java-basic" basename="build" tag="java-compiler-options" source_dir="snippets/reference/core-plugins/java-basic" />
...
<SampleScripts sample_name="java-basic" basename="build" tag="java-release-flag" source_dir="snippets/reference/core-plugins/java-basic" />
...
<SampleScripts sample_name="maven-publish" basename="build" tag="defining-sources-jar-task" source_dir="snippets/reference/platforms/jvm/maven-publish" />

If you want to create an 'uber' (AKA 'fat') JAR, then you can use a task definition like this:

<SampleScripts sample_name="archives-with-java-plugin" basename="build" tag="create-uber-jar-example" source_dir="snippets/reference/platforms/jvm/archivesWithJavaPlugin" />
...
<SampleScripts sample_name="manifest" basename="build" tag="add-to-manifest" source_dir="snippets/reference/platforms/jvm/manifest" />
...
<SampleScripts sample_name="manifest" basename="build" tag="provider-manifest" source_dir="snippets/reference/platforms/jvm/manifest" />
...
<SampleScripts sample_name="manifest" basename="build" tag="custom-manifest" source_dir="snippets/reference/platforms/jvm/manifest" />
...
<SampleScripts sample_name="manifest" basename="build" tag="merge" source_dir="snippets/reference/platforms/jvm/manifest" />
...
<SampleScripts sample_name="manifest" basename="build" tag="write" source_dir="snippets/reference/platforms/jvm/manifest" />
...
<SampleScripts sample_name="java-basic" basename="build" tag="using-custom-doclet" source_dir="snippets/reference/core-plugins/java-basic" />
...
<SampleScripts sample_name="java-basic" basename="build" tag="defining-custom-javadoc-task" source_dir="snippets/reference/core-plugins/java-basic" />
...
<SampleScripts sample_name="preview" basename="build" tag="enabling-feature-preview" source_dir="snippets/reference/platforms/jvm/preview" />
...
<SampleScripts sample_name="compile-task-classpath" basename="build" tag="compile-task-classpath" source_dir="snippets/reference/platforms/jvm/compileTaskClasspath" />
