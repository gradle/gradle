...
<SampleScripts sample_name="scala-quickstart" basename="build" tag="use-plugin" />
...
<SampleScripts sample_name="scala-customized-layout" basename="build" tag="custom-source-locations" />
...
<SampleScripts sample_name="scala-quickstart" basename="build" tag="scala-version" />

Configuring Gradle to use Scala 3 is no different from Scala 2.

<SampleScripts sample_name="scala3" basename="build" tag="scala-version" />
...
<SampleScripts sample_name="scala-quickstart" basename="build" subpath="inferred-version" tag="scala-dependency" />

Scala 3 projects need to declare a `scala3-library_3` dependency instead:

<SampleScripts sample_name="scala3" basename="build" subpath="inferred-version" tag="scala-dependency" />

If Scala is only used for test code, the `scala-library` dependency should be added to the `testImplementation` configuration:

<SampleScripts sample_name="scala-dependency" basename="build" tag="scala-test-dependency" />
...
<SampleScripts sample_name="zinc-dependency" basename="build" tag="zinc-dependency" />
...
<SampleScripts sample_name="compiler-plugin" basename="build" tag="compiler-plugin" />
...
<SampleScripts sample_name="zinc" basename="build" tag="adjust-memory" />
...
<SampleScripts sample_name="force" basename="build" tag="force-compilation" />
...
<SampleScripts sample_name="idea-target-version" basename="build" tag="scala-idea-target-version" />