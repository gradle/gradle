...
<SampleScripts sample_name="more-about-tasks-task-grouping" basename="build" subpath="app" tag="task-grouping" />
...
<SampleScripts sample_name="more-about-tasks-register-configure-implement" basename="build" tag="register-configure-implement" />
...
<SampleScripts sample_name="define-using-string-task-names" basename="build" tag="simple_register" />
...
<SampleScripts sample_name="configure-using-block" basename="build" tag="declare-task" />
...
<SampleScripts sample_name="configure-using-var" basename="build" tag="configure" />

#### 2. Using a configuration block:

Use a block to configure the task immediately upon registering it:

<SampleScripts sample_name="define-and-configure" basename="build" tag="no-description" />
