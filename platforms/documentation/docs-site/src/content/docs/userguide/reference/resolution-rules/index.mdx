...
description: "Resolution rules for influencing the resolution engine directly, including substitution, forcing and capability rules."
---
...
<SampleScripts sample_name="managing-transitive-dependencies-force-for-configuration" basename="build" tag="force-per-configuration" source_dir="snippets/reference/dependency-management/dependency-management/managingTransitiveDependencies-forceForConfiguration" />
...
<SampleScripts sample_name="customizing-resolution-replacement-rule" basename="build" tag="module_replacement_declaration" source_dir="snippets/reference/dependency-management/dependency-management/customizingResolution-replacementRule" />
...
<SampleScripts sample_name="customizing-resolution-substitution-rule" basename="build" tag="module_to_project_substitution" source_dir="snippets/reference/dependency-management/dependency-management/customizingResolution-substitutionRule" />
...
<SampleScripts sample_name="customizing-resolution-substitution-rule" basename="build" tag="project_to_module_substitution" source_dir="snippets/reference/dependency-management/dependency-management/customizingResolution-substitutionRule" />
...
<SampleScripts sample_name="customizing-resolution-conditional-substitution-rule" basename="build" subpath="consumer" tag="project_substitution" source_dir="snippets/reference/dependency-management/dependency-management/customizingResolution-conditionalSubstitutionRule" />
...
<SampleScripts sample_name="customizing-resolution-attribute-substitution-rule" basename="build" subpath="lib" tag="dependencies" source_dir="snippets/reference/dependency-management/dependency-management/customizingResolution-attributeSubstitutionRule" />
...
<SampleScripts sample_name="customizing-resolution-attribute-substitution-rule" basename="build" subpath="consumer" tag="substitution_rule" source_dir="snippets/reference/dependency-management/dependency-management/customizingResolution-attributeSubstitutionRule" />
...
<SampleScripts sample_name="customizing-resolution-attribute-substitution-rule" basename="build" subpath="consumer" tag="substitution_rule_alternative" source_dir="snippets/reference/dependency-management/dependency-management/customizingResolution-attributeSubstitutionRule" />
...
<SampleScripts sample_name="customizing-resolution-capability-substitution-rule" basename="build" tag="substitution_rule" source_dir="snippets/reference/dependency-management/dependency-management/customizingResolution-capabilitySubstitutionRule" />
...
<SampleScripts sample_name="customizing-resolution-classifier-substitution-rule" basename="build" subpath="consumer" tag="dependencies" source_dir="snippets/reference/dependency-management/dependency-management/customizingResolution-classifierSubstitutionRule" />
...
<SampleScripts sample_name="customizing-resolution-classifier-substitution-rule" basename="build" subpath="lib" tag="dependencies" source_dir="snippets/reference/dependency-management/dependency-management/customizingResolution-classifierSubstitutionRule" />
...
<SampleScripts sample_name="customizing-resolution-classifier-substitution-rule" basename="build" subpath="consumer" tag="substitution_rule" source_dir="snippets/reference/dependency-management/dependency-management/customizingResolution-classifierSubstitutionRule" />
...
<SampleScripts sample_name="customizing-resolution-selection-rule" basename="build" tag="reject-version-1-1" source_dir="snippets/reference/dependency-management/dependency-management/customizingResolution-selectionRule" />
...
<SampleScripts sample_name="customizing-resolution-selection-rule" basename="build" tag="targeted-component-selection" source_dir="snippets/reference/dependency-management/dependency-management/customizingResolution-selectionRule" />
...
<SampleScripts sample_name="customizing-resolution-selection-rule" basename="build" tag="component-selection-with-metadata" source_dir="snippets/reference/dependency-management/dependency-management/customizingResolution-selectionRule" />
...
<SampleScripts sample_name="customizing-resolution-default-dependency" basename="build" tag="configuration-default-dependencies" source_dir="snippets/reference/dependency-management/dependency-management/customizingResolution-defaultDependency" />
...
<SampleScripts sample_name="managing-transitive-dependencies-exclude-for-configuration" basename="build" tag="exclude-transitive-dependencies" source_dir="snippets/reference/dependency-management/dependency-management/managingTransitiveDependencies-excludeForConfiguration" />
...
<SampleFile sample_name="managing-transitive-dependencies-exclude-for-dependency" path="common/src/main/java/Main.java" source_dir="snippets/reference/dependency-management/dependency-management/managingTransitiveDependencies-excludeForDependency" />
...
<SampleScripts sample_name="managing-transitive-dependencies-exclude-for-dependency" basename="build" tag="exclude-transitive-dependencies-2" source_dir="snippets/reference/dependency-management/dependency-management/managingTransitiveDependencies-excludeForDependency" />

To fully exclude `commons-collections`, you must also exclude it from `opencsv`:

<SampleScripts sample_name="managing-transitive-dependencies-exclude-for-dependency" basename="build" tag="exclude-transitive-dependencies-3" source_dir="snippets/reference/dependency-management/dependency-management/managingTransitiveDependencies-excludeForDependency" />
...
<SampleScripts sample_name="managing-transitive-dependencies-resolution-strategy" basename="build" tag="fail-on-version-conflict" source_dir="snippets/reference/dependency-management/dependency-management/managingTransitiveDependencies-resolutionStrategy" />
...
<SampleScripts sample_name="managing-transitive-dependencies-disable-for-dependency" basename="build" tag="transitive-per-dependency" source_dir="snippets/reference/dependency-management/dependency-management/managingTransitiveDependencies-disableForDependency" />
...
<SampleScripts sample_name="managing-transitive-dependencies-disable-for-configuration" basename="build" tag="transitive-per-configuration" source_dir="snippets/reference/dependency-management/dependency-management/managingTransitiveDependencies-disableForConfiguration" />
...
<SampleScripts sample_name="customizing-resolution-resolution-strategy" basename="build" tag="resolve-rules" source_dir="snippets/reference/dependency-management/dependency-management/customizingResolution-resolutionStrategy" />
...
<SampleScripts sample_name="customizing-resolution-resolution-strategy" basename="build" tag="custom-versioning-scheme" source_dir="snippets/reference/dependency-management/dependency-management/customizingResolution-resolutionStrategy" />
...
<SampleScripts sample_name="customizing-resolution-resolution-strategy" basename="build" tag="denying_version" source_dir="snippets/reference/dependency-management/dependency-management/customizingResolution-resolutionStrategy" />
...
<SampleScripts sample_name="customizing-resolution-lazy-dependencies" basename="build" tag="configuration-lazy-add-dependency" source_dir="snippets/reference/dependency-management/dependency-management/customizingResolution-lazyDependencies" />
...
<SampleScripts sample_name="customizing-resolution-lazy-dependencies" basename="build" tag="preferred-version-constraints" source_dir="snippets/reference/dependency-management/dependency-management/customizingResolution-lazyDependencies" />
