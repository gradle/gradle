...
description: "The PMD plugin: running PMD static analysis over Java sources as part of the build."
---
...
<SampleScripts sample_name="code-quality" basename="build" tag="use-pmd-plugin" source_dir="snippets/reference/core-plugins/codeQuality" />
...
You can also run PMD with a specific JDK using a [Java toolchain](#sec:pmd_configuration_toolchains).
...
<SampleScripts sample_name="code-quality" basename="build" tag="customize-pmd" source_dir="snippets/reference/core-plugins/codeQuality" />
...
<SampleScripts sample_name="code-quality" basename="build" tag="pmd-threads" source_dir="snippets/reference/core-plugins/codeQuality" />
