...
description: "The services Gradle injects into tasks and plugins, covering file operations, process execution and more."
---
...
<SampleScripts sample_name="services" basename="build" tag="clean-temp-inject" source_dir="snippets/reference/gradle-types/services" />

<SampleFile sample_name="services" path="{lang}/buildSrc/src/main/java/org/example/CleanTempTask.java" tag="clean-temp-inject" source_dir="snippets/reference/gradle-types/services" />
...
<SampleScripts sample_name="services" basename="build" tag="object-factory" source_dir="snippets/reference/gradle-types/services" />
...
<SampleScripts sample_name="services" basename="build" tag="object-factory-inject" source_dir="snippets/reference/gradle-types/services" />
...
<SampleScripts sample_name="services" basename="build" tag="project-layout" source_dir="snippets/reference/gradle-types/services" />

Here is an example using `javax.inject.Inject`:

<SampleScripts sample_name="services" basename="build" tag="project-layout-inject" source_dir="snippets/reference/gradle-types/services" />
...
<SampleScripts sample_name="services" basename="settings" tag="build-layout" source_dir="snippets/reference/gradle-types/services" />

Here is an example using `javax.inject.Inject`:

<SampleScripts sample_name="services" basename="settings" tag="build-layout-inject" source_dir="snippets/reference/gradle-types/services" />
...
<SampleScripts sample_name="services" basename="build" tag="provider-factory" source_dir="snippets/reference/gradle-types/services" />

The task named `printMessage` uses the `ProviderFactory` to create a `provider` that supplies the message string.

Here is an example using `javax.inject.Inject`:

<SampleScripts sample_name="services" basename="build" tag="provider-factory-inject" source_dir="snippets/reference/gradle-types/services" />
...
<SampleScripts sample_name="services" basename="build" tag="worker-executor" source_dir="snippets/reference/gradle-types/services" />
...
<SampleScripts sample_name="services" basename="build" tag="file-system-inject" source_dir="snippets/reference/gradle-types/services" />
...
<SampleScripts sample_name="services" basename="build" tag="file-system-adhoc" source_dir="snippets/reference/gradle-types/services" />
...
<SampleScripts sample_name="services" basename="build" tag="archive-op-inject" source_dir="snippets/reference/gradle-types/services" />
...
<SampleScripts sample_name="services" basename="build" tag="archive-op-adhoc" source_dir="snippets/reference/gradle-types/services" />
...
<SampleScripts sample_name="services" basename="build" tag="exec-op-inject" source_dir="snippets/reference/gradle-types/services" />
...
<SampleScripts sample_name="services" basename="build" tag="exec-op-adhoc" source_dir="snippets/reference/gradle-types/services" />
...
<SampleScripts sample_name="services" basename="build" tag="tooling-model" source_dir="snippets/reference/gradle-types/services" />
...
<SampleScripts sample_name="services" basename="build" tag="dependency-constraint-factory-inject" source_dir="snippets/reference/gradle-types/services" />
...
<SampleFile sample_name="reporting-problems" path="{lang}/plugin/src/main/{lang}/org/example/HelloProblemsPlugin.{srcExt}" tag="problems-service" source_dir="snippets/reference/plugin-development/reportingProblems" />
...
<SampleScripts sample_name="services" basename="build" tag="build-invocation-details-inject" source_dir="snippets/reference/gradle-types/services" />
...
<SampleScripts sample_name="services" basename="build" tag="software-component-factory-inject" source_dir="snippets/reference/gradle-types/services" />
