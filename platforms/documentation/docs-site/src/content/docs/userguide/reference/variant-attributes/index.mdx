...
description: "Variants and attributes: how Gradle describes what a component offers and what a consumer needs."
---
...
You can understand more about the use of platform and enforced platforms variants by looking at the <Xref page="platforms" section="Importing a Platform (BOM)">importing BOMs</Xref> section of the manual.
