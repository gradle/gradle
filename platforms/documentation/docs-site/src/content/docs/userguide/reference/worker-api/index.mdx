...
description: "The Worker API for splitting a task's work into units that run in parallel, optionally in an isolated process."
---
...
Managed types are lazy, isolatable, and compatible with the <Xref page="configuration-cache" section="Configuration Cache">configuration cache</Xref>, and they let Gradle fingerprint parameter values for up-to-date checks and the build cache.

| Use | For |
| --- | --- |
| <JavaDocLink class="org.gradle.api.provider.Property">`Property<T>`</JavaDocLink> | A single scalar value |
| <JavaDocLink class="org.gradle.api.file.RegularFileProperty" />, <JavaDocLink class="org.gradle.api.file.DirectoryProperty" /> | A file or directory location |
| <JavaDocLink class="org.gradle.api.file.ConfigurableFileCollection" /> | A collection of files |
| <JavaDocLink class="org.gradle.api.provider.ListProperty">`ListProperty<T>`</JavaDocLink>, <JavaDocLink class="org.gradle.api.provider.SetProperty">`SetProperty<T>`</JavaDocLink>, <JavaDocLink class="org.gradle.api.provider.MapProperty">`MapProperty<K, V>`</JavaDocLink> | A collection of values |
| <JavaDocLink class="org.gradle.api.Named" /> objects, <Xref page="build-services" section="Using Shared Build Services">build services</Xref> | Named or shared state |
...
Gradle model containers such as <JavaDocLink class="org.gradle.api.NamedDomainObjectContainer" /> are not supported as work parameters.
