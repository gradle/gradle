...
<SampleScripts sample_name="implementing-custom-tasks-package-app" basename="build" tag="package-app" />
...
<SampleScripts sample_name="implementing-custom-tasks-package-app" basename="build" tag="wire-lifecycle" />
...
<SampleFile sample_name="implementing-custom-tasks-generate-report" path="kotlin/GenerateReportTask.kt" tag="generate-report-task" />

<SampleFile sample_name="implementing-custom-tasks-generate-report" path="groovy/GenerateReportTask.groovy" tag="generate-report-task" />
...
<SampleScripts sample_name="implementing-custom-tasks-generate-report" basename="build" tag="register-task" />
...
<SampleScripts sample_name="implementing-custom-tasks-convention-plugin" basename="build" tag="convention-plugin" />

We define a task called `printVersion` in the build file of the `app`:

<SampleFile sample_name="implementing-custom-tasks-print-version" path="kotlin/PrintVersion.kt" tag="print-version" />

<SampleFile sample_name="implementing-custom-tasks-print-version" path="groovy/PrintVersion.groovy" tag="print-version" />
...
<SampleScripts sample_name="implementing-custom-tasks-do-first-last" basename="build" tag="do-first-last" />
...
<SampleScripts sample_name="implementing-custom-tasks-dynamic-inputs" basename="build" tag="dynamic-inputs" />
...
<SampleScripts sample_name="implementing-custom-tasks-clear-actions" basename="build" tag="clear-actions" />
...
<SampleScripts sample_name="implementing-custom-tasks-modify-behavior" basename="build" tag="modify-behavior" />
...
<SampleScripts sample_name="implementing-custom-tasks-configurable-task" basename="build" tag="configurable-task" />
...
<SampleScripts sample_name="implementing-custom-tasks-lazy-properties" basename="build" tag="lazy-properties" />
...
<SampleScripts sample_name="implementing-custom-tasks-all-types" basename="build" tag="all-types" />
