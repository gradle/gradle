...
<SampleScripts sample_name="greeting" basename="greetings" subpath="buildSrc/src/main/{lang}" tag="create-extension" />
...
<SampleScripts sample_name="greeting" basename="greetings" subpath="buildSrc/src/main/{lang}" tag="update" />

If you apply the `greetings` plugin, you can set the convention in your build script:

<SampleScripts sample_name="greeting" basename="build" subpath="app" />
...
<SampleScripts sample_name="greeting" basename="greetings" subpath="buildSrc/src/main/{lang}" tag="convention" />
...
<SampleScripts sample_name="greeting" basename="greetings" subpath="buildSrc/src/main/{lang}" tag="task" />
...
<SampleScripts sample_name="precompiled-script-plugins-external-plugins" basename="build" subpath="buildSrc" />

It can then be applied in the precompiled script plugin:

<SampleScripts sample_name="precompiled-script-plugins-external-plugins" basename="my-plugin" subpath="buildSrc/src/main/{lang}" />
...
<SampleScripts sample_name="precompiled-script-plugins-settings" basename="settings" subpath="settings-plugin" />

Set up the build to support precompiled script plugins:

<SampleScripts sample_name="precompiled-script-plugins-settings" basename="build" subpath="settings-plugin" />
...
<SampleScripts sample_name="precompiled-script-plugins-settings" basename="my-plugin.settings" subpath="settings-plugin/src/main/{lang}" />
...
<SampleScripts sample_name="precompiled-script-plugins-settings" basename="settings" tag="main" />
