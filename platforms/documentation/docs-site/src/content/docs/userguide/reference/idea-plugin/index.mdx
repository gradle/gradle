...
description: "The IDEA plugin: generating IntelliJ IDEA project files from a Gradle build."
---

import { GroovyDocLink, JavaDocLink, SampleScripts, Xref } from '#/components';

The IDEA plugin generates files that are used by [IntelliJ IDEA](https://www.jetbrains.com/idea/), thus making it possible to open the project from IDEA (`File` - `Open Project`). Both external dependencies (including associated source and Javadoc files) and project dependencies are considered.
...
<SampleScripts sample_name="idea" basename="build" tag="use-plugin" source_dir="snippets/reference/core-plugins/idea" />
...
<SampleScripts sample_name="idea" basename="build" tag="module-before-merged" source_dir="snippets/reference/core-plugins/idea" />
...
<SampleScripts sample_name="idea" basename="build" tag="project-before-merged" source_dir="snippets/reference/core-plugins/idea" />
...
<SampleScripts sample_name="idea" basename="build" tag="module-when-merged" source_dir="snippets/reference/core-plugins/idea" />
...
<SampleScripts sample_name="idea" basename="build" tag="project-with-xml" source_dir="snippets/reference/core-plugins/idea" />
...
<SampleScripts sample_name="idea-additional-test-sources" basename="build" tag="mark-additional-sourcesets-as-test" source_dir="snippets/reference/core-plugins/ideaAdditionalTestSources" />

:::note
When working with the <Xref page="jvm-test-suite-plugin" section="The JVM Test Suite Plugin">JVM Test Suite Plugin</Xref>, test sources will be automatically identified correctly.
:::
...
:::note
The `idea.pathVariables` property is deprecated and will be removed in Gradle 10, along with the generated-file tasks described above. Modern versions of IntelliJ IDEA import Gradle projects directly and do not rely on these generated files.
:::