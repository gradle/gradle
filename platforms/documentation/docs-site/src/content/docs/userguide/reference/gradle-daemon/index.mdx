---
title: "Gradle Daemon"
description: "The Gradle Daemon: the long-lived process that runs builds, why it exists, and how to configure or disable it."
---
...
<SampleScripts sample_name="customized-task" basename="build" tag="customized-daemon-jvm-task" source_dir="snippets/reference/runtime-configuration/customized-task" />
...
<SampleScripts sample_name="customized-task" basename="build" tag="customized-plat-daemon-jvm-task" source_dir="snippets/reference/runtime-configuration/customized-task" />
...
<SampleScripts sample_name="customized-task" basename="build" tag="customized-uri-daemon-jvm-task" source_dir="snippets/reference/runtime-configuration/customized-task" />
...
<SampleScripts sample_name="customized-task" basename="build" tag="customized-noplat-daemon-jvm-task" source_dir="snippets/reference/runtime-configuration/customized-task" />
