...
description: "Gradle's Property and Provider types, the foundation of lazy configuration in tasks and plugins."
---
...
<SampleScripts sample_name="property" basename="build" tag="introduction" source_dir="snippets/reference/gradle-types/property" />
...
<SampleScripts sample_name="property" basename="build" tag="set-prop" source_dir="snippets/reference/gradle-types/property" />
...
<SampleScripts sample_name="property" basename="build" tag="set-prov" source_dir="snippets/reference/gradle-types/property" />
...
<SampleScripts sample_name="basics" basename="build" subpath="my-sub-project" tag="transform" source_dir="snippets/reference/gradle-types/basics" />

You can see the following example for a detailed breakdown at `Provider` chaining using `map()`:

<SampleScripts sample_name="example" basename="build" subpath="app" tag="type" source_dir="snippets/reference/gradle-types/example" />
...
<SampleScripts sample_name="property" basename="build" tag="prop-managed" source_dir="snippets/reference/gradle-types/property" />

Or _read-only_, meaning that it is of type `Provider`, which only has a `get()` method:

<SampleScripts sample_name="property" basename="build" tag="prov-managed" source_dir="snippets/reference/gradle-types/property" />
...
<SampleScripts sample_name="property" basename="build" tag="named" source_dir="snippets/reference/gradle-types/property" />
