...
description: "Building Swift projects with Gradle: source layout conventions, toolchains, variants and dependencies."
---
...
<SampleScripts sample_name="swift-basic" basename="build" tag="apply-swift-plugin" source_dir="snippets/reference/platforms/native/swift-basic" />
...
The Swift plugins also integrates the above tasks into the standard <Xref page="base-plugin" section="Tasks">lifecycle tasks</Xref>.
...
<SampleScripts sample_name="swift-basic" basename="build" tag="swift-dependency-mgmt" source_dir="snippets/reference/platforms/native/swift-basic" />
...
<SampleScripts sample_name="swift-basic" basename="build" subpath="common" tag="swift-source-set" source_dir="snippets/reference/platforms/native/swift-basic" />
...
<SampleScripts sample_name="swift-basic" basename="build" tag="swift-compiler-options-all-variants" source_dir="snippets/reference/platforms/native/swift-basic" />
...
<SampleScripts sample_name="swift-basic" basename="build" tag="swift-compiler-options-per-variants" source_dir="snippets/reference/platforms/native/swift-basic" />
...
<SampleScripts sample_name="swift-basic" basename="build" tag="swift-select-target-machines" source_dir="snippets/reference/platforms/native/swift-basic" />
