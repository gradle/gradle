...
description: "The native software plugins for building executables and libraries, and the model they use for variants and toolchains."
---
...
| Windows | [GCC](http://gcc.gnu.org/) with [MinGW](http://www.mingw.org/) and [MinGW64](https://mingw-w64.org) | Windows XP and later. |
