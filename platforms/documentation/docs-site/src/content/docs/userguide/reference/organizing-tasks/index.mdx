...
<SampleScripts sample_name="organizing-tasks-app-grouping" basename="build" subpath="app" tag="app-grouping" />
...
<SampleScripts sample_name="organizing-tasks-global-groups" basename="build" tag="global-groups" />
...
<SampleScripts sample_name="organizing-tasks-global-lifecycle" basename="build" tag="global-lifecycle" />
