...
description: "File system watching and the Virtual File System, which let Gradle detect changes without rescanning the project."
---
...
To reduce unnecessary watching and re-execution, consider limiting the inputs of specific tasks using <JavaDocLink class="org.gradle.api.tasks.util.PatternFilterable" method="exclude(java.lang.String&#8230;&#8203;)">`fileTree.exclude()`</JavaDocLink>.
...
<dl>
<dt>Gradle does not detect some changes</dt>
<dd>

_Please [let us know on the Gradle community Slack](https://gradle-community.slack.com)._
...
<dt>VFS state dropped due to lost state</dt>
<dd>
...
File system watching uses [inotify](http://en.wikipedia.org/wiki/Inotify) on Linux.
