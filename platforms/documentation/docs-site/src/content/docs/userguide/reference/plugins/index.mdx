...
description: "How plugins extend Gradle: what they contribute, where they come from, and how they are applied and resolved."
---
...
<SampleScripts sample_name="custom-plugin-script" basename="build" tag="no-script-plugin" source_dir="snippets/reference/plugin-development/customPluginScript" />
...
<SampleScripts sample_name="custom-plugin-script" basename="other" source_dir="snippets/reference/plugin-development/customPluginScript" />

<SampleScripts sample_name="custom-plugin-script" basename="build" tag="script-plugin" source_dir="snippets/reference/plugin-development/customPluginScript" />
...
<SampleScripts sample_name="greeting-plugin" basename="GreetingPlugin" subpath="buildSrc/src/main/{lang}" source_dir="snippets/reference/plugin-development/greetingPlugin" />

The `GreetingPlugin` can now be applied in other subprojects' builds by using its ID:

<SampleScripts sample_name="greeting-plugin" basename="build" subpath="app" tag="use-plugin" source_dir="snippets/reference/plugin-development/greetingPlugin" />
...
<SampleScripts sample_name="plugin-project" basename="build" subpath="database-logic" source_dir="snippets/reference/plugin-development/pluginProject" />
...
<SampleScripts sample_name="plugin-project" basename="my-java-library" subpath="buildSrc/src/main/{lang}" source_dir="snippets/reference/plugin-development/pluginProject" />
...
For more on publishing plugins, see <Xref page="publishing-gradle-plugins" section="Adding the Plugin Publish Plugin">Publishing Plugins</Xref>.
