...
description: "Declaring what a repository may or may not contain, so Gradle avoids pointless lookups and unintended sources."
---
...
<SampleScripts sample_name="declaring-repositories-filtering" basename="build" tag="repository-filter" source_dir="snippets/reference/dependency-management/declaring-repositories/declaringRepositories-filtering" />
...
<SampleScripts sample_name="declaring-repositories-filtering" basename="build" tag="exclusive-repository-filter" source_dir="snippets/reference/dependency-management/declaring-repositories/declaringRepositories-filtering" />
...
<SampleScripts sample_name="declaring-repositories-filtering" basename="build" tag="repository-snapshots" source_dir="snippets/reference/dependency-management/declaring-repositories/declaringRepositories-filtering" />
...
<SampleScripts sample_name="customizing-resolution-ivy-dynamic-mode" basename="build" tag="ivy-repo-dynamic-mode" source_dir="snippets/reference/dependency-management/declaring-repositories/customizingResolution-ivyDynamicMode" />
