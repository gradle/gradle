...
<SampleScripts sample_name="define-repository" basename="build" tag="maven-ivy-repository-no-auth" />

**Declaring an SFTP Protocol for a Repository**

<SampleScripts sample_name="define-repository" basename="build" tag="maven-ivy-repository-auth" />

**Declaring an S3-Backed Maven and Ivy Repository**

<SampleScripts sample_name="define-repository" basename="build" tag="maven-ivy-s3-repository" />

**Declaring an S3-Backed Maven and Ivy Repository Using IAM**

<SampleScripts sample_name="define-repository" basename="build" tag="maven-ivy-s3-repository-with-iam" />

**Declaring a GCS-Backed Maven and Ivy Repository**

<SampleScripts sample_name="define-repository" basename="build" tag="maven-ivy-gcs-repository" />
...
<SampleScripts sample_name="define-repository" basename="build" tag="authenticated-maven-repo" />
...
<SampleScripts sample_name="define-repository" basename="build" tag="digest-authentication" />
...
<SampleScripts sample_name="define-repository" basename="build" tag="preemptive-authentication" />
...
<SampleScripts sample_name="define-repository" basename="build" tag="header-authenticated-maven-repo" />
...
<SampleScripts sample_name="publishing-credentials" basename="build" tag="repositories" />
