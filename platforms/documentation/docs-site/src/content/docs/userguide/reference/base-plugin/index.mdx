...
<SampleScripts sample_name="base-plugin" basename="build" tag="apply-base-plugin" />
...
<SampleScripts sample_name="archives-changed-base-name" basename="build" tag="base-plugin-config" />
