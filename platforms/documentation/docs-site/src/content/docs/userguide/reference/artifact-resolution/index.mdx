...
description: "How Gradle maps a resolved dependency graph to a set of artifact files, and how artifact selection works."
---
...
The <JavaDocLink class="org.gradle.api.artifacts.ArtifactView" /> API operates on top of the resolved graph, defined by a [`ResolutionResult`](/javadoc/org/gradle/api/artifacts/result/ResolutionResult.html).
