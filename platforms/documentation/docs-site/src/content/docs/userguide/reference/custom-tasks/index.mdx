...
description: "Advanced task authoring: up-to-date checks, incremental work, input and output declarations, and worker execution."
---
...
<SampleScripts sample_name="custom-tasks-incremental-task" basename="build" tag="incremental-task" source_dir="snippets/reference/task-development/customTasks-incrementalTask" />
...
<SampleScripts sample_name="incremental-task" basename="build" tag="incremental-task" source_dir="snippets/reference/task-development/incrementalTask" />
...
<SampleScripts sample_name="incremental-task" basename="build" tag="reverse" source_dir="snippets/reference/task-development/incrementalTask" />
...
<SampleScripts sample_name="incremental-task" basename="build" tag="updated-inputs" source_dir="snippets/reference/task-development/incrementalTask" />
...
<SampleScripts sample_name="incremental-task" basename="build" tag="removed-input" source_dir="snippets/reference/task-development/incrementalTask" />
...
<SampleScripts sample_name="incremental-task" basename="build" tag="removed-output" source_dir="snippets/reference/task-development/incrementalTask" />
...
<SampleScripts sample_name="command-line-option-string-option" basename="build" tag="task" source_dir="snippets/reference/task-development/commandLineOption-stringOption" />
...
<SampleScripts sample_name="verification-failure" basename="build" tag="verification-failure" source_dir="snippets/reference/task-development/verificationFailure" />
