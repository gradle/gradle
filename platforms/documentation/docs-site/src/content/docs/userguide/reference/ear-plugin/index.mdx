...
description: "The Ear plugin: assembling Java EE enterprise application EAR archives."
---
...
<SampleScripts sample_name="ear-with-war" basename="build" tag="use-ear-plugin" source_dir="snippets/reference/core-plugins/earWithWar" />
...
<SampleScripts sample_name="ear-customized" basename="build" subpath="ear" source_dir="snippets/reference/core-plugins/earCustomized" />
...
<SampleScripts sample_name="skinny-war" basename="build" subpath="war" source_dir="snippets/ear/skinnyWar" />
...
<SampleScripts sample_name="skinny-war" basename="build" subpath="ear" source_dir="snippets/ear/skinnyWar" />
