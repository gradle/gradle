...
<SampleScripts sample_name="catalogs-settings" basename="build" tag="use_catalog_equiv" />
...
<SampleScripts sample_name="declaring-dependencies-project-dependencies" basename="build" subpath="web-service" tag="project-dependencies" />
...
<SampleScripts sample_name="external-dependencies" basename="build" tag="file-dependencies" />
...
<SampleFile sample_name="declaring-dependencies-basic" path="common/app/src/main/java/org/example/InitializeCollection.java" />
...
<SampleScripts sample_name="managing-transitive-dependencies-disable-for-configuration" basename="build" tag="dependency-config" />
