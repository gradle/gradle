...
<SampleScripts sample_name="external-dependencies" basename="build" tag="module-dependencies" />
...
<SampleScripts sample_name="declaring-dependencies-type-safe-project-dependencies" basename="settings" tag="accessors" />
...
<SampleScripts sample_name="declaring-dependencies-type-safe-project-dependencies" basename="build" subpath="web-service" tag="project-dependencies" />
...
<SampleScripts sample_name="declaring-dependencies-file-dependencies" basename="build" tag="file-dependencies" />
...
<SampleScripts sample_name="generated-file-dependencies" basename="build" tag="generated-file-dependencies" />
...
<SampleScripts sample_name="inspecting-dependencies-dependency-reason" basename="build" tag="dependency-reason" />
