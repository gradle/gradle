...
description: "The Project Report plugin: tasks that report on a project's tasks, dependencies and properties."
---
...
The plugin applies the reporting base plugin, so you can change the base directory for all reports through the <GroovyDocLink class="org.gradle.api.reporting.ReportingExtension">`reporting`</GroovyDocLink> extension:
