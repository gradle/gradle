...
description: "The ArtifactView API for customising artifact resolution, including filtering, lenient resolution and attribute overrides."
---
...
<SampleScripts sample_name="performing-resolution-artifact-resolution" basename="build" tag="variant-reselection" source_dir="snippets/reference/dependency-management/controlling-dependency-resolution/performingResolution-artifactResolution" />
...
<SampleScripts sample_name="performing-resolution-artifact-resolution-lenient" basename="build" tag="lenient-resolution-dependencies" source_dir="snippets/reference/dependency-management/controlling-dependency-resolution/performingResolution-artifactResolution-lenient" />

Lenient resolution is performed by using the `ArtifactView.lenient()` method:

<SampleScripts sample_name="performing-resolution-artifact-resolution-lenient" basename="build" tag="resolve-lenient" source_dir="snippets/reference/dependency-management/controlling-dependency-resolution/performingResolution-artifactResolution-lenient" />
...
<SampleScripts sample_name="performing-resolution-artifact-resolution-component-filter" basename="build" tag="component-filter-dependencies" source_dir="snippets/reference/dependency-management/controlling-dependency-resolution/performingResolution-artifactResolution-componentFilter" />

Using the `componentFilter` method, we can specify filters that select only artifacts of a certain type:

<SampleScripts sample_name="performing-resolution-artifact-resolution-component-filter" basename="build" tag="resolve-component-filter" source_dir="snippets/reference/dependency-management/controlling-dependency-resolution/performingResolution-artifactResolution-componentFilter" />
...
<SampleScripts sample_name="artifact-transforms-unzip" basename="build" tag="resolve-transformed-files" source_dir="snippets/reference/dependency-management/controlling-dependency-resolution/artifactTransforms-unzip" />
