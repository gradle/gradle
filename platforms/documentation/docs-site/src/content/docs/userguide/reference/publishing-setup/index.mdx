...
description: "Setting up publication: what a module is, which plugins to apply, and how components become publications."
---
...
<SampleScripts sample_name="java-library" basename="build" tag="apply-plugins" source_dir="snippets/reference/dependency-management/publishing/javaLibrary" />
...
<SampleScripts sample_name="java-library" basename="build" tag="configure-publishing" source_dir="snippets/reference/dependency-management/publishing/javaLibrary" />
...
<SampleScripts sample_name="java-library" basename="build" tag="disable_validation" source_dir="snippets/reference/dependency-management/publishing/javaLibrary" />