---
title: "Build Scan"
description: "Ways to inspect what a build did, including Build Scans, reports and the command-line options that expose build detail."
---

import { Image } from 'astro:assets';
import buildScanHome from './build-scan-home.png';
import buildScanPerformancePage from './build-scan-performance-page.png';
import buildScanConfigurationBreakdown from './build-scan-configuration-breakdown.png';
import scriptBApplication from './script-b-application.png';
import gradleProfileReport from './gradle-profile-report.png';
...
<Image src={buildScanHome} alt="build scan home" />
...
<Image src={buildScanPerformancePage} alt="build scan performance page" />
...
<Image src={buildScanConfigurationBreakdown} alt="build scan configuration breakdown" />
...
<Image src={scriptBApplication} alt="script b application" />
...
<Image src={gradleProfileReport} alt="Sample Gradle profile report" />
