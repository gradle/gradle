...
<SampleScripts sample_name="test-filtering" basename="build" tag="test-filtering" />
...
<SampleScripts sample_name="test-report" basename="myproject.xctest-conventions" subpath="buildSrc/src/main/{lang}" tag="test-report" />
