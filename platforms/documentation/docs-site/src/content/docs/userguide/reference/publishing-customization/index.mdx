...
description: "Customising a publication: components, adding artifacts, and editing the generated metadata."
---
...
<SampleFile sample_name="modeling-features-cross-project-publications-advanced-published" path="{lang}/buildSrc/src/main/{lang}/com/acme/InstrumentedJarsPlugin.{srcExt}" tag="add_variant_to_existing_component" source_dir="snippets/reference/dependency-management/publishing/modelingFeatures-crossProjectPublications-advanced-published" />
...
<SampleScripts sample_name="java-project" basename="build" tag="publish-modify-component" source_dir="snippets/reference/dependency-management/publishing/javaProject" />
...
<SampleFile sample_name="modeling-features-cross-project-publications-advanced-published" path="{lang}/buildSrc/src/main/{lang}/com/acme/InstrumentedJarsPlugin.{srcExt}" tag="create_adhoc_component" source_dir="snippets/reference/dependency-management/publishing/modelingFeatures-crossProjectPublications-advanced-published" />
...
<SampleScripts sample_name="publish-artifact" basename="build" tag="custom-artifact" source_dir="snippets/reference/dependency-management/publishing/publish-artifact" />
...
<SampleScripts sample_name="publish-artifact" basename="build" tag="custom-artifact-publication" source_dir="snippets/reference/dependency-management/publishing/publish-artifact" />
...
<SampleScripts sample_name="conditional-publishing" basename="build" tag="publishing" source_dir="snippets/reference/dependency-management/publishing/conditional-publishing" />
...
<SampleScripts sample_name="conditional-publishing" basename="build" tag="task-config" source_dir="snippets/reference/dependency-management/publishing/conditional-publishing" />
...
<SampleScripts sample_name="conditional-publishing" basename="build" tag="shorthand-tasks" source_dir="snippets/reference/dependency-management/publishing/conditional-publishing" />
...
<SampleScripts sample_name="java-library" basename="build" tag="configure-generate-task" source_dir="snippets/reference/dependency-management/publishing/javaLibrary" />
