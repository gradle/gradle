...
description: "What counts as public Gradle API, and the guarantees that come with each API's stability level."
---
...
:::note
For more details, see <Xref page="kotlin-dsl" section="Avoid Using Internal Kotlin DSL APIs">Avoid Using Internal Kotlin DSL APIs</Xref>.
:::