...
description: "The Problems API, which lets plugins report structured, actionable problems instead of plain failures."
---
...
<SampleFile sample_name="problem-reporting" path="{lang}/buildSrc/src/main/java/org/myorg/ProblemReportingPlugin.java" tag="snippet" source_dir="snippets/reference/plugin-development/problemReporting" />
...
<SampleFile sample_name="reporting-problems" path="{lang}/plugin/src/main/{lang}/org/example/HelloProblemsPlugin.{srcExt}" source_dir="snippets/reference/plugin-development/reportingProblems" />
...
<SampleFile sample_name="reporting-problems" path="{lang}/plugin/src/main/{lang}/org/example/HelloProblemsPlugin.{srcExt}" tag="problems-id" source_dir="snippets/reference/plugin-development/reportingProblems" />
...
<SampleFile sample_name="reporting-problems" path="{lang}/plugin/src/main/{lang}/org/example/HelloProblemsPlugin.{srcExt}" tag="problems-reporter" source_dir="snippets/reference/plugin-development/reportingProblems" />
...
<SampleFile sample_name="reporting-problems" path="{lang}/plugin/src/main/{lang}/org/example/HelloProblemsPlugin.{srcExt}" tag="problems-report" source_dir="snippets/reference/plugin-development/reportingProblems" />

#### Reporting a fatal problem

Use `problems.getReporter().throwing {}` to fail the build with a structured error:

<SampleFile sample_name="reporting-problems" path="{lang}/plugin/src/main/{lang}/org/example/HelloProblemsPlugin.{srcExt}" tag="problems-throw" source_dir="snippets/reference/plugin-development/reportingProblems" />
...
<SampleFile sample_name="reporting-problems" path="{lang}/plugin/src/main/{lang}/org/example/HelloProblemsPlugin.{srcExt}" tag="problems-spec" source_dir="snippets/reference/plugin-development/reportingProblems" />
...
<SampleFile sample_name="problems-api-usage" path="common/reporters/standard-plugin/src/main/java/reporters/FailingTask.java" tag="problems-api-fail-the-build" source_dir="snippets/reference/plugin-development/problems-api-usage" />
