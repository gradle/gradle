...
<SampleScripts sample_name="java-library-distribution" basename="build" tag="use-plugin" />

To define the name for the distribution you have to set the `baseName` property as shown below:

<SampleScripts sample_name="java-library-distribution" basename="build" tag="name-conf" />
...
<SampleScripts sample_name="java-library-distribution" basename="build" tag="custom-distribution" />