...
<SampleScripts sample_name="plugin-with-variants" basename="build" tag="publish-1" />
...
<SampleScripts sample_name="plugin-with-variants" basename="build" tag="publish-2" />
...
<SampleScripts sample_name="plugin-with-variants" basename="settings" tag="publish-3" />
