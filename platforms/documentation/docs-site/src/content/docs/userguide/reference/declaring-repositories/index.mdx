...
description: "Telling Gradle where to download dependencies from, and the repository types it supports."
---
...
<SampleScripts sample_name="define-repository" basename="build" tag="maven-local" source_dir="snippets/reference/dependency-management/basics/defineRepository" />
