...
<SampleScripts sample_name="catalogs-platforms-platform-example" basename="build" tag="platform-example" />
...
<SampleFile sample_name="catalogs-platforms" path="common/gradle/libs.versions.toml" />

Platform:

<SampleScripts sample_name="catalogs-platforms" basename="build" subpath="platform" />

Consumer:

<SampleScripts sample_name="catalogs-platforms" basename="build" subpath="consumer" tag="usage" />
