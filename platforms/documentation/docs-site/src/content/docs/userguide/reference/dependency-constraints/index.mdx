...
<SampleScripts sample_name="java-platform-quickstart" basename="build" tag="use-plugin,constraints" />
...
<SampleScripts sample_name="managing-transitive-dependencies-versions-with-constraints" basename="build" tag="dependency-strictly" />
