...
description: "The graph resolution phase, in which Gradle builds the resolved dependency graph from declared dependencies."
---
...
<SampleScripts sample_name="performing-resolution-resolution-result" basename="build" tag="graph-traversal-function" source_dir="snippets/reference/dependency-management/advanced/performingResolution-resolutionResult" />
...
<SampleScripts sample_name="performing-resolution-resolution-result" basename="build" tag="define-graph-traversal-task" source_dir="snippets/reference/dependency-management/advanced/performingResolution-resolutionResult" />
...
<SampleScripts sample_name="performing-resolution-resolution-result" basename="build" tag="register-graph-traversal-task" source_dir="snippets/reference/dependency-management/advanced/performingResolution-resolutionResult" />
