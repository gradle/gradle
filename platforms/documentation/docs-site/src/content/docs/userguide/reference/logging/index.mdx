...
description: "Gradle's logging: log levels, controlling output, writing to the log from build logic, and the console modes."
---
...
<SampleScripts sample_name="logging" basename="build" tag="task-log-stdout" source_dir="snippets/reference/runtime-configuration/logging" />
...
<SampleScripts sample_name="logging" basename="build" tag="use-println" source_dir="snippets/reference/runtime-configuration/logging" />
...
<SampleScripts sample_name="logging" basename="build" tag="use-logger" source_dir="snippets/reference/runtime-configuration/logging" />
...
<SampleScripts sample_name="logging" basename="build" tag="use-logger-placeholder" source_dir="snippets/reference/runtime-configuration/logging" />
...
<SampleScripts sample_name="logging" basename="build" tag="use-slf4j" source_dir="snippets/reference/runtime-configuration/logging" />
...
<SampleScripts sample_name="logging" basename="build" tag="capture-stdout" source_dir="snippets/reference/runtime-configuration/logging" />
...
<SampleScripts sample_name="logging" basename="build" tag="task-capture-stdout" source_dir="snippets/reference/runtime-configuration/logging" />
...
<SampleScripts sample_name="custom-logger" basename="customLogger.init" source_dir="snippets/reference/runtime-configuration/customLogger" />
