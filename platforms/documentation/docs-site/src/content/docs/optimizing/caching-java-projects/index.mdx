...
<SampleScripts sample_name="integration-tests" basename="build" tag="integTest" />
...
<SampleScripts sample_name="integration-tests" basename="build" tag="distributionPathInput" />
...
<SampleScripts sample_name="integration-tests" basename="build" tag="distributionDirInput" />
...
<SampleScripts sample_name="integration-tests" basename="build" tag="ignoreSystemProperties" />
