...
<SampleScripts sample_name="isolated-projects-lifecycle-api" basename="settings" tag="lifecycle-before-project" />
...
<SampleScripts sample_name="lifecycle-settings-plugin" basename="settings" tag="settings-file" />
...
<SampleScripts sample_name="lifecycle-apply-false" basename="settings" tag="settings-file" />
