...
<SampleScripts sample_name="incremental-build-custom-task-class" basename="build" tag="ad-hoc-task" />
...
<SampleScripts sample_name="performance-tips" basename="build" tag="expensive-plugin" />

Instead:

<SampleScripts sample_name="performance-tips" basename="build" tag="optimized-plugin" />
...
- If only one subproject requires the script, remove it from the others, reducing the configuration delay by **2 seconds**.
  ...
  <SampleScripts sample_name="performance-tips" basename="build" tag="apply-selectively" />
- If multiple—but not all—subprojects use the script, refactor it into a custom plugin inside <Xref page="sharing-build-logic-between-subprojects" section="About the `buildSrc` directory">`buildSrc`</Xref> and apply it only to the relevant subprojects. This reduces configuration time and avoids code duplication.
  ...
  <SampleScripts sample_name="performance-tips" basename="build" tag="apply-custom-plugin" />
...
<SampleScripts sample_name="performance-tips" basename="build" tag="cache-dynamic-versions" />
...
<SampleScripts sample_name="performance-tips" basename="build" tag="defer-resolution" />
...
<SampleScripts sample_name="resolve-at-configuration-time" basename="build" tag="copy" />
...
<SampleScripts sample_name="resolve-at-build-time" basename="build" tag="copy" />
...
<SampleScripts sample_name="performance-tips" basename="build" tag="custom-resolution-logic" />
...
<SampleScripts sample_name="parallel-test-execution" basename="build" tag="parallel-calculated" />
...
<SampleScripts sample_name="parallel-test-execution" basename="build" tag="fork-every" />
...
<SampleScripts sample_name="parallel-test-execution" basename="build" tag="disable-reports" />
...
<SampleScripts sample_name="performance-conditional-reports" basename="build" tag="conditional-reports" />
...
<SampleScripts sample_name="parallel-test-execution" basename="build" tag="fork-java" />
