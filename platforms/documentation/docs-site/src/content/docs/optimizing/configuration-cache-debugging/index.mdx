...
<SampleScripts sample_name="problems-kotlin" basename="build" />

<SampleScripts sample_name="problems-groovy" basename="build" />
...
<SampleScripts sample_name="problems-fixed" basename="build" tag="fixed" />
...
<SampleScripts sample_name="problems-fixed-reuse" basename="build" tag="fixed-reuse" />
...
<SampleFile sample_name="test-kit" path="kotlin/src/test/kotlin/org/example/BuildLogicFunctionalTest.kt" tag="functional-test-configuration-cache" />

<SampleFile sample_name="test-kit" path="groovy/src/test/groovy/org/example/BuildLogicFunctionalTest.groovy" tag="functional-test-configuration-cache" />
