...
androidHomeWarmup {
    ...
    sdkVersions.set(
        listOf(
            // Used by
            // declaringConfigurations-kmp
            // declaringConfigurations-android
            // android-application sample
            // structuring-software-projects/android-app sample
            // All use AGP 9, build-tools 36 and compileSdk 36
