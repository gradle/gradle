...
You don't have to answer an interactive question about the source package anymore.
Instead, a default value of `org.example` will be used.
Of course, you can override this using an existing option `--package` flag for the `init` task.
