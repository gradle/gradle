...
After the execution of around 15,000 tasks or more, the IDE would experience a delay of several seconds.
...
The root cause was that a lot more information then needed was serialized via the Tooling API.
