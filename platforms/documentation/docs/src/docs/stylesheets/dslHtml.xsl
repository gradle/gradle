...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xsl:template match="book" mode="sidebar">
        <li>
            <a href="../userguide/userguide.html" class="reference-links">User Manual Home</a>
        </li>
        <li>
            <a href="index.html" class="active reference-links">DSL Reference Home</a>
        </li>
        <li>
            <a href="../release-notes.html" class="reference-links">Release Notes</a>
        </li>
        <ul class="sections">
    ...
    <xsl:template match="chapter" mode="sidebar">
        ...
        <li>
            <a href="index.html" class="reference-links">DSL Reference Home</a>
        </li>
        <li>
            <a href="../release-notes.html" class="reference-links">Release Notes</a>
        </li>
    ...
    <xsl:template match="seg" mode="seglist.table">
        ...
        <tr>
            <th><xsl:apply-templates select="$segtitles[$segnum=position()]" mode="segtitle-in-seg"/>:
            </th>
            <td>
                <xsl:apply-templates/>
            </td>
    ...
    <xsl:template match="seg" mode="seglist.list">
        ...
        <xsl:variable name="seglist" select="ancestor::segmentedlist"/>
        <xsl:variable name="segtitles" select="$seglist/segtitle"/>
        <dt><xsl:apply-templates select="$segtitles[$segnum=position()]" mode="segtitle-in-seg"/>:
        </dt>
        <dd>
            <xsl:apply-templates/>
        </dd>
