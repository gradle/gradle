...
----
include::{snippetsPath}/tasks/incrementalBuild-customTaskClass/common/buildSrc/src/main/java/org/example/ProcessTemplates.java[tag=custom-task-class]
----

[source,java]
.buildSrc/src/main/java/org/example/TemplateData.java
----
include::{snippetsPath}/tasks/incrementalBuild-customTaskClass/common/buildSrc/src/main/java/org/example/TemplateData.java[]
----
