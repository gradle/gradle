...
[source,java]
----
include::{snippetsPath}/workerApi/md5CustomTask/common/buildSrc/src/main/java/CreateMD5.java[]
----
...
[source,java]
----
include::{snippetsPath}/workerApi/md5NoIsolation/common/buildSrc/src/main/java/MD5WorkParameters.java[]
----
...
[source,java]
----
include::{snippetsPath}/workerApi/md5NoIsolation/common/buildSrc/src/main/java/GenerateMD5.java[]
----
...
[source,java]
----
include::{snippetsPath}/workerApi/md5NoIsolation/common/buildSrc/src/main/java/CreateMD5.java[]
----
...
[source, groovy]
----
include::{snippetsPath}/workerApi/md5ClassloaderIsolation/common/buildSrc/src/main/java/CreateMD5.java[]
----
...
[source,java]
----
include::{snippetsPath}/workerApi/md5ProcessIsolation/common/buildSrc/src/main/java/CreateMD5.java[]
----
