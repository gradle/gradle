...
For <<supported_repository_types.adoc#sec:maven_repo,Maven repositories>>, it's often the case that a repository would either contain releases or snapshots.
