...
*Artifacts* typically include compiled libraries, JAR files, AAR files, DLLs, or ZIPs.
...
In an ideal case, once a *variant* is selected, the *artifact* should be automatically resolved.
