...
<<component_capabilities.adoc#sub:selecting-between-candidates,Conflicts>> arise in the following scenarios:
...
In the example above, the issue isn't with attribute matching but with <<component_capabilities.adoc#sub:selecting-between-candidates,**capability matching**>>.
