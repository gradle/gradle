...
In Java projects, the `java-platform` plugin combined with <<dependency-constraints.adoc#dependency-constraints,dependency constraints>> can be used to create a platform:
