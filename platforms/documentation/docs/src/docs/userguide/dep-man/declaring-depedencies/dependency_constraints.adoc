...
TIP: It is recommended to use <<dependency_versions.adoc#single-version-declarations,dependency versions>> instead of dependency constraints.

Dependency constrains are best used to create <<platforms.adoc#sec:sharing-dep-versions-between-projects,platforms>>:
