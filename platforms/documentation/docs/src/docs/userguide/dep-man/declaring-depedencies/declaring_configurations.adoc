...
- This separation ensures that your project maintains clean boundaries between its API and internal dependencies.

2. **Resolvable Configuration from Dependency Configuration**: Create a custom resolvable configuration to resolve specific sets of dependencies, like classpaths, at various build stages.
