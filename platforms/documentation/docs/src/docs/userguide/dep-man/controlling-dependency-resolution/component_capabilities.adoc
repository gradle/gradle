...
If `com.other:module` appears elsewhere in the dependency graph, the build will fail, and consumers <<dependency_capability_conflict.adoc#sub:selecting-between-candidates,must choose which module to use>>.
