...
To leverage <<artifact_views.adoc#artifact_views,Artifact Views>> with Artifact Transforms, you can configure a custom `ArtifactView` to access the transformed artifacts.
