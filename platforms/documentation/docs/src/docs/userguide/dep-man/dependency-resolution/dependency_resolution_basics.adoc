...
See <<graph_resolution_resolution.adoc#graph_resolution_resolution,Dependency Graph Resolution>> to learn more.
...
See <<artifact-resolution.adoc#artifact-resolution,Artifact Resolution>> to learn more.
