...
====
include::sample[dir="snippets/dependencyManagement/catalogs-toml/kotlin",files="gradle/libs.versions.toml[]"]
====

Then, you can use the version catalog in you build file:

====
include::sample[dir="snippets/dependencyManagement/catalogs-toml/kotlin",files="build.gradle.kts[]"]
include::sample[dir="snippets/dependencyManagement/catalogs-toml/groovy",files="build.gradle[]"]
====
