...
====
include::sample[dir="snippets/dependencyManagement/declaringDependencies-basic/kotlin",files="build.gradle.kts[tags=dependency-config]"]
include::sample[dir="snippets/dependencyManagement/declaringDependencies-basic/groovy",files="build.gradle[tags=dependency-config]"]
====
