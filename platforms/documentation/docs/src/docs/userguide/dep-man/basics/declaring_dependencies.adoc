...
See <<dependency_configurations.adoc#dependency-configurations, Dependency Configurations>>.
3. You can specify repositories where Gradle should look for dependencies in your build file.
See <<declaring_repositories_adv.adoc#declaring-repositories, Declaring Repositories>>.
...
As for the `runtimeOnly` configuration, the `org.org.apache.commons:commons-lang3:3.14.0`.
