...
While it's generally better to manage module conflicts using <<component_capabilities.adoc#sub:capabilities, capabilities>>, there are scenarios—especially when working with older versions of Gradle-that require a different approach.
