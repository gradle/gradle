...
All variants of a component provide a number of <<component_capabilities.adoc#sub:capabilities, capabilities>>, which are denoted similarly using GAV coordinates.
