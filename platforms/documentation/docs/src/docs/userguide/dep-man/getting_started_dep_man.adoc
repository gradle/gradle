...
In order to influence how Gradle resolves dependencies, it's important to understand <<dependency_resolution_basics.adoc#dependency-resolution-basics,how it works>>.
