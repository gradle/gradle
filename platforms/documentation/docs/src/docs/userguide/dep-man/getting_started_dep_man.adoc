...
- A lockfile is a file that stores the exact versions of dependencies used in a project
- A version catalog is a centralized list of dependency versions that can be referenced in multiple projects.
- A convention plugin defines conventions and configurations that can be applied consistently across projects.
