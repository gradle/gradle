...
//If you want to understand the basics of dependency management with Gradle, start <<declaring_dependencies.adoc#one-declaring-dependencies,here>>.


== 2. Declaring Dependencies
declaring_dependencies_basics.html

You can add external libraries to your Java project, such as Guava.
//These libraries are <<declaring_dependencies.adoc#one-declaring-dependencies,_dependencies_>> of your project.
They are added using the `dependencies{}` block in your build file.

== 3. Declaring Repositories
declaring_repositories_basics.html

//You can <<declaring_repositories.adoc#three-declaring-repositories,declare _repositories_>> to tell Gradle where to fetch external _dependencies_.
...
dependency_resolution_basics.html
