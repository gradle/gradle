...
====
include::sample[dir="snippets/fundamentals/authoring-builds/quickstart/kotlin", files="build.gradle.kts[tags=use-plugin-legacy]"]
include::sample[dir="snippets/fundamentals/authoring-builds/quickstart/groovy", files="build.gradle[tags=use-plugin-legacy]"]
====
