...
Starting with 9.3, the Tooling API exposes a lightweight model that returns the exact command-line text without starting a Gradle daemon:
...
You can fetch it like any other model:
