...
For Android Studio users: Ensure you are using the latest version of the Android Gradle Plugin to avoid compatibility issues and gain access to performance improvements with each new release.
