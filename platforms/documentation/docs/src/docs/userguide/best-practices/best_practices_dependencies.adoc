...
Gradle uses <<variant_aware_resolution.adoc#sec:understanding-variant-selection,variant-aware dependency resolution>> to select the appropriate artifacts.
...
- It was <<upgrading_version_8.adoc#selecting_variant_by_configuration_name,deprecated for Maven repositories>> in Gradle 8.10 and removed in Gradle 9.0.0. It is only recommended for Ivy repositories.
