...
If you use more than one repository, you should use content filtering to make sure you take the right artifacts from the right repository by using a content filter.
