...
They are often a better choice for build logic that does not need to be shared outside of a build, and that is simple enough to not require additional type safeness and testability benefits.
