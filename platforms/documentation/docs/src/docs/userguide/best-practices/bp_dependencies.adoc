...
Use them in combination with <<dependency_locking.adoc#dependency_locking,dependency locking>> and <<resolution_rules.adoc#resolution_rules,version alignment>> to enforce consistency across builds.
