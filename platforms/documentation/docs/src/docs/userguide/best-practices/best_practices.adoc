...
There are many scenarios where how to best use Gradle is unclear, as Gradle provides many ways of accomplishing the same goals.
...
This section outlines best practices for authoring Gradle builds that are maintainable, efficient, and aligned with Gradle's core design philosophy.
...
- Recommendations should be widely applicable to _many_ or _most_ typical builds.
