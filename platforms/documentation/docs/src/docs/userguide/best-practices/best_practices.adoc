...
To view all Gradle Best Practices at a glance, along with the Gradle version they were introduced in, visit the <<best_practices_status.adoc#best_practices_status,Status Page>>.
