...
[[tag:repositories]]
`#repositories` :: Items that explain how to declare and use <<declaring_repositories.adoc#declaring_repositories,dependency repositories>>.

[[tag:settings]]
`#settings` :: Items that explain how to use the <<settings_file.adoc#settings_file,settings file>> to configure multi-project builds, including how to structure projects and include them in the build.
...
`#task-configuration-avoidance` :: Items that are related to Gradle's <<writing_tasks.adoc#sec:task_configuration_avoidance,task configuration avoidance>> APIs and how to use them effectively.
