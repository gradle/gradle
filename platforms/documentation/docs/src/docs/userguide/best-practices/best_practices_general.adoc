...
This allows you to organize large builds containing many projects to improve comprehensibility, versus having all your projects live at the root of the build.
...
However, without further configuration, Gradle will create empty projects for every element of the path.
...
=== References
- <<multi_project_builds.adoc,Multi-Project Builds>>
