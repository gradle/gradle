...
Explicitly setting the root project's name also ensures that it is referred to consistently.
...
If you try running the `projects` report, you will see a name based on the build's current location.
