...
It is a place to configure the build as a whole, such as declaring (but not applying) plugins to ensure the same version is available in every project in a build, and to do other types of configuration that apply to all the build's projects.
