...
[source,text]
----
include::{snippetsPath}/best-practices/avoidAfterEvaluate-avoid/tests-kotlin/avoidAfterEvaluate.bad.kotlin.out[]
----
...
include::{snippetsPath}/best-practices/avoidAfterEvaluate-do/tests-kotlin/avoidAfterEvaluate.good.kotlin.out[]
----
