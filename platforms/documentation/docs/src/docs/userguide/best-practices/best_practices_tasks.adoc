...
Accessing the `Project` instance during task execution is not compatible with the Configuration Cache and should be avoided.
...
- <<configuration_cache.adoc#config_cache:requirements:use_project_during_execution,Configuration Cache Requirements>>
