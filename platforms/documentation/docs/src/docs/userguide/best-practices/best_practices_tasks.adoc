...
In addition, resolving configurations during the configuration phase can slow down the build, even when running unrelated tasks (e.g., `help`) that don't require the resolved dependencies.
...
====
include::sample[dir="snippets/bestPractices/avoidResolvingConfigurationsManually-avoid/kotlin/library",files="build.gradle.kts[tags=bad-classpath-printer]"]
include::sample[dir="snippets/bestPractices/avoidResolvingConfigurationsManually-avoid/groovy/library",files="build.gradle[tags=bad-classpath-printer]"]
====
...
====
include::sample[dir="snippets/bestPractices/avoidResolvingConfigurationsManually-do/kotlin/library",files="build.gradle.kts[tags=good-classpath-printer]"]
include::sample[dir="snippets/bestPractices/avoidResolvingConfigurationsManually-do/groovy/library",files="build.gradle[tags=good-classpath-printer]"]
====
