...
This helps organize your tasks into meaningful categories and makes them easier to find in reports such as `./gradlew tasks`.

Providing this metadata ensures your tasks are discoverable and understandable to other users (and to your future self).

=== Example

==== Don't Do This

Tasks without a group appear under the "other" category in `gradle tasks` output, making them harder to locate:

====
include::sample[dir="snippets/bestPractices/groupTasks/kotlin/avoid-this",files="build.gradle.kts[tags=avoid-this]"]
include::sample[dir="snippets/bestPractices/groupTasks/groovy/avoid-this",files="build.gradle[tags=avoid-this]"]
====

[source,text]
----
$ gradlew tasks
include::{snippetsPath}/bestPractices/groupTasks/tests/groupTasks.bad.out[]
----
...
====
include::sample[dir="snippets/bestPractices/groupTasks/kotlin/do-this",files="build.gradle.kts[tags=do-this]"]
include::sample[dir="snippets/bestPractices/groupTasks/groovy/do-this",files="build.gradle[tags=do-this]"]
====

[source,text]
----
$ gradlew tasks
include::{snippetsPath}/bestPractices/groupTasks/tests/groupTasks.good.out[]
----
