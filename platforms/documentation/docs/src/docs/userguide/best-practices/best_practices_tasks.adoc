...
====
include::sample[dir="snippets/bestPractices/avoidResolvingConfigurationsManually-avoid/kotlin/lib",files="build.gradle.kts[tags=avoid-this]"]
include::sample[dir="snippets/bestPractices/avoidResolvingConfigurationsManually-avoid/groovy/lib",files="build.gradle[tags=avoid-this]"]
====
