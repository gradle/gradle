...
====
include::sample[dir="snippets/bestPractices/useKotlinDSL/groovy/avoid-this",files="build.gradle[tags=avoid-this]"]
====

==== Do This Instead

====
include::sample[dir="snippets/bestPractices/useKotlinDSL/kotlin/do-this",files="build.gradle.kts[tags=do-this]"]
====
