...
You should setup a <<composite_builds.adoc#sec:defining_composite_builds,Composite Build>> (commonly called an "included build") to hold your _build logic_ (such as any plugins - including convention plugins - and other customizations that are specific to your build).
...
=== References
<<part3_multi_project_builds.adoc#sec:step_3_understand_composite_builds,Composite Builds in the Multi-Project Builds Tutorial>>
<<composite_builds.adoc#sec:composite_builds,Composite Builds reference documentation>>
