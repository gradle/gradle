...
Resolving configuration before task execution phase can lead to incorrect results and slows gradle build performance.

Once configuration is resolved it can't be resolved again, and it can lose some information when it is resolved too early.
