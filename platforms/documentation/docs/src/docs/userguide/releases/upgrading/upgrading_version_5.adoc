...
- PMD has been updated to https://pmd.github.io/2019/07/28/PMD-6.17.0/#28-july-2019---6170[PMD 6.17.0].
- JaCoCo has been updated to https://www.jacoco.org/jacoco/trunk/doc/changes.html[0.8.5]. Contributed by link:https://github.com/Godin[Evgeny Mandrikov]
...
<<pmd_plugin#pmd_plugin, The PMD plugin>> has been upgraded to use link:https://pmd.github.io/2019/05/26/PMD-6.15.0/[PMD version 6.15.0] instead of 6.8.0 by default.
...
<<jacoco_plugin#jacoco_plugin, The JaCoCo plugin>> has been upgraded to use link:https://www.jacoco.org/jacoco/trunk/doc/changes.html[JaCoCo version 0.8.4] instead of 0.8.3 by default.
