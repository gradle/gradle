...
= Upgrading your build from Gradle 8.14.3 to 9.0.0

This chapter provides the information you need to migrate your Gradle 8.14.3 builds to the major Gradle 9.0.0.
