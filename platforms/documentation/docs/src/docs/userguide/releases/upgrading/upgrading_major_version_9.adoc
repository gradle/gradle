...
This property is deprecated since Gradle 9.9 and will be removed in Gradle 11, see <<upgrading_version_9.adoc#deprecated_configuration_cache_opt_out_properties, the Gradle 9.x upgrade guide>>.
