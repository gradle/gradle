...
= Upgrading your build from Gradle 8.14.2 to 9.0.0

This chapter provides the information you need to migrate your Gradle 8.14.2 builds to the major Gradle 9.0.0.
...
The following helper methods for launching external processes were <<#deprecated_project_exec,deprecated in Gradle 8.11>> and have now been removed in Gradle 9.0.0:
