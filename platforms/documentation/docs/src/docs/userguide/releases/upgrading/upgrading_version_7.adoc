...
[[v7_warnings_that_are_now_errors]]
=== Warnings that are now errors

[[v7_referencing_tasks_in_included_build]]
...
[[v7_creating_tar_trees_from_resources_without_backing_files]]
...
[[v7_using_invalid_java_toolchain_specifications]]
...
[[v7_using_automatic_toolchain_downloading_without_repository]]
...
[[v7_changing_test_framework_after_setting_options]]
...
[[v7_legacy_artifact_transform_api]]
...
[[v7_legacy_incremental_task_inputs_api]]
...
[[v7_legacy_antlr_source_virtual_directory_api]]
...
[[v7_java_application_api_cleanup]]
...
[[v7_default_domain_object_set_api_cleanup]]
...
[[v7_jacoco_plugin_extension_api_cleanup]]
...
[[v7_dependency_insight_report_task_api_cleanup]]
...
[[v7_report_and_test_report_api_cleanup]]
...
[[v7_abstract_test_task_api_cleanup]]
...
[[v7_source_directory_set_api_cleanup]]
...
[[v7_version_catalog_api_cleanup]]
...
[[v7_worker_executor_api_cleanup]]
...
[[v7_dependency_substitution_api_cleanup]]
...
[[v7_abstract_archive_task_api_cleanup]]
...
[[v7_abstract_compile_api_deprecations]]
...
[[v7_resolved_component_result_api_cleanup]]
...
[[v7_code_quality_plugins_api_cleanup]]
...
[[v7_external_dependency_api_cleanup]]
...
[[v7_build_scan_method_removed_from_kotlin_dsl]]
...
[[v7_configuration_extension_methods_removed_from_kotlin_dsl]]
...
[[v7_potential_breaking_changes_8_0]]
=== Potential breaking changes

[[v7_java_fork_options_return_immutable_lists]]
...
[[v7_nullable_annotations_better_reflect_nullability]]
...
[[v7_plugins_tasks_and_extension_classes_are_abstract]]
...
Gradle uses runtime class decoration to implement abstract methods as long as the object is instantiated via `ObjectFactory` or some other automatic mechanism (like <<properties_providers.adoc#managed_properties,managed properties>>).
Those methods should never be directly implemented.

[[v7_wrapper_task_configuration]]
...
[[v7_changes_in_abstract_code_quality_plugin_class]]
...
[[v7_remove_implicit_add_opens_for_gradle_workers]]
...
[[v7_source_set_classes_dirs_no_longer_depends_on_entire_source_set]]
...
[[v7_minimal_supported_kotlin_gradle_plugin_version_changed]]
...
[[v7_minimal_supported_android_gradle_plugin_version_changed]]
...
[[v7_change_to_ant_builder_parent_class]]
...
[[v7_plugin_declaration_is_not_serializable]]
...
[[v7_gradle_does_not_use_equals_for_serialized_values]]
...
[[v7_task_and_transform_validation_warnings_now_errors]]
...
[[v7_gradle_does_not_ignore_empty_directories_for_file_trees]]
...
[[v7_format_of_java_version_changed_for_java_9_and_10]]
...
[[v7_init_scripts_applied_to_build_src]]
...
[[v7_gradle_no_longer_runs_build_task_for_build_src]]
...
[[v7_build_finished_hook_for_build_src_runs_after_all_tasks]]
...
[[v7_changes_to_paths_of_included_builds]]
...
[[v7_adding_jst_ejb_with_eclipse_wtp_plugin]]
...
[[v7_simplifying_pmd_custom_rules_configuration]]
...
[[v7_report_get_output_location_return_type_changed]]
...
[[v7_removed_external_plugin_validation_plugin]]
...
[[v7_reproducible_archives_can_change]]
...
[[v7_java_base_plugin_sets_jar_war_ear_destination_directory]]
...
[[v7_upload_task_should_not_be_used]]
...
[[v7_configurations_no_longer_allowed_as_dependencies]]
...
[[v7_deprecated_consumption_configurations_now_non_consumable]]
...
[[v7_identical_consumable_configurations_now_error]]
...
The <<variant_aware_resolution.adoc#outgoing_variants_report,`outgoingVariants` report>> will warn about this for impacted configurations.

[[v7_toolchain_based_tasks_for_jvm_projects]]
...
[[v7_plugin_bundle_dropped_in_plugin_publish_plugin]]
...
[[v7_updates_to_attribute_disambiguation_rules_methods]]
...
[[v7_potential_breaking_changes_7_6]]
=== Potential breaking changes
...
[[v7_changes_to_dependency_declarations_in_test_suites]]
...
[[v7_replacement_collections_in_idea_module]]
...
[[v7_replacement_methods_in_test_report]]
...
[[v7_potential_breaking_changes_7_5]]
=== Potential breaking changes

[[v7_version_catalog_only_accepts_single_toml_import]]
...
[[v7_updates_to_default_tool_versions_7_5]]
...
[[v7_classpath_file_generated_by_eclipse_plugin_changed]]
...
[[v7_signing_plugin_defaults_to_gpg]]
...
----
[[v7_must_run_after_constraints_no_longer_violated]]
...
[[v7_missing_files_specified_with_relative_paths_checkstyle]]
...
Gradle 7.5 introduces configuration cache-compatible ways to execute and obtain output of an external process with the link:{groovyDslPath}/org.gradle.api.provider.ProviderFactory.html[provider-based APIs] or a custom implementation of the link:{javadocPath}/org/gradle/api/provider/ValueSource.html[`ValueSource`] interface.
The <<configuration_cache_requirements.adoc#config_cache:requirements:external_processes,configuration cache chapter>> has more details to help with the migration to the new APIs.

[[changes_7.4]]
== Upgrading from 7.3 and earlier

[[v7_potential_breaking_changes_7_4]]
=== Potential breaking changes

[[v7_updates_to_default_tool_versions_7_4]]
==== Updates to default tool integration versions
...
link:{groovyDslPath}/org.gradle.api.provider.ProviderFactory.html#org.gradle.api.provider.ProviderFactory:gradleProperty(java.lang.String)[Gradle properties] and link:{groovyDslPath}/org.gradle.api.provider.ProviderFactory.html#org.gradle.api.provider.ProviderFactory:fileContents(org.gradle.api.file.RegularFile)[file contents] meant to be used at configuration time together with the configuration cache feature.
...
Clients are also free to use standard Java APIs such as `System#getenv` to read environment variables, `System#getProperty` to read system properties as well as Gradle APIs such as link:{groovyDslPath}/org.gradle.api.provider.ProviderFactory.html#org.gradle.api.provider.ProviderFactory:systemProperty(java.lang.String)[`Project#property(String)`] and link:{javadocPath}/org/gradle/api/Project.html#findProperty-java.lang.String-[`Project#findProperty(String)`] to read Gradle properties at configuration time.
...
[[v7_configurable_report_set_destination_deprecated]]
...
See the <<configuration_cache_requirements.adoc#config_cache:requirements:build_listeners,configuration cache chapter>> for details on how to migrate these usages to APIs that are supported by the configuration cache.
...
See the <<configuration_cache_requirements.adoc#config_cache:requirements:use_project_during_execution,configuration cache chapter>> for details on how to migrate these usages to APIs that are supported by the configuration cache.
...
[[v7_potential_breaking_changes_7_3]]
=== Potential breaking changes

[[v7_updates_to_bundled_gradle_dependencies_7_3]]
==== Updates to bundled Gradle dependencies
...
[[v7_application_order_of_plugins_in_plugins_block]]
...
[[v7_effects_of_exclusion_on_substituted_dependencies]]
...
You have to use the <<version_catalogs.adoc#sec:type-unsafe-access-to-catalog,version catalog extension>> instead.

[[v7_toolchain_support_in_scala]]
...
[[v7_potential_breaking_changes_7_2]]
=== Potential breaking changes

[[v7_security_changes_to_start_scripts_and_wrapper]]
...
[[v7_updates_to_bundled_gradle_dependencies_7_2]]
==== Updates to bundled Gradle dependencies
...
[[v7_updates_to_default_tool_versions_7_2]]
==== Updates to default tool integration versions
...
[[v7_potential_breaking_changes_7_1]]
=== Potential breaking changes

[[v7_updates_to_default_tool_versions_7_1]]
==== Updates to default tool integration versions

- JaCoCo has been updated to https://www.jacoco.org/jacoco/trunk/doc/changes.html[0.8.7].

[[v7_org_gradle_util_package_is_now_public_api]]
...
[[v7_classes_now_officially_public_api]]
...
[[v7_classes_deprecated_for_removal_in_gradle_8]]
...
[[v7_classes_moved_to_org_gradle_util_internal]]
...
[[v7_return_type_of_source_set_extensions_changed]]
...
[[v7_start_scripts_require_bash_shell]]
...
<<resolution_rules#sec:dependency-substitution-rules, Dependency substitutions>> using `with` method have been deprecated and are replaced with `using` method that also allows chaining.
...
See the <<artifact_transforms.adoc#sec:abm-artifact-transforms,user manual>> for more information on implementing `TransformAction`.
