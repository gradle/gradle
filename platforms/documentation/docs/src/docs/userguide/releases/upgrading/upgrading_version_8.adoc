...
==== Upgrade to Eclipse JGit 7.3.0

Eclipse JGit has been updated from 5.13.3 to link:https://projects.eclipse.org/projects/technology.jgit/releases/7.3.0[7.3.0].

This update reworks how Gradle configures JGit for SSH operations and introduces support for using the SSH Agent, leveraging the new capabilities available in link:https://github.com/eclipse-jgit/jgit/blob/v7.3.0.202506031305-r/org.eclipse.jgit.ssh.apache.agent/README.md[JGit’s] SSH agent integration.
