...
Starting with Gradle 9.0 the lowest supported Kotlin Gradle Plugin version is 1.9.21.
Previous versions are not supported anymore because they use now removed Gradle APIs.

The lowest supported Kotlin Gradle Plugin version for Gradle 8.x was 1.6.10.

==== Lowest supported Android Gradle Plugin version change

Starting with Gradle 9.0 the lowest supported Android Gradle Plugin version is 7.4.0.
Previous versions are not supported anymore because they use now removed Gradle APIs.

The lowest supported Android Gradle Plugin version for Gradle 8.x was 7.3.0.
