...
The "convention" concept defined by the `org.gradle.api.plugins.Convention` type has been deprecated since Gradle 8.2 and is now removed.

Core Gradle plugins were still registering deprecated conventions that also got removed in Gradle 9.0:
