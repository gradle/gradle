...
See the user guide section on <<dependency_graph_resolution#dependency_resolution_resolution,programmatic dependency resolution>> for more details on this API.
