...
The embedded Kotlin has been updated from 1.9.24 to link:https://github.com/JetBrains/kotlin/releases/tag/v2.0.0[Kotlin 2.0.0].

The default `kotlin-test` version in JVM test suites has been upgraded to 2.0.0 as well.
