...
The feature should not have any visible impact on the usual build output, with JDK8 being an exception: when annotation processors are used in the compiler, the output message might slightly differ from the previous ones (see [#29501](https://github.com/gradle/gradle/issues/29501)).
