...
= Upgrading your build from Gradle 8.x to 8.14.2

This chapter provides the information you need to migrate your Gradle 8.x builds to Gradle 8.14.2.
...
+
. Run `gradle wrapper --gradle-version 8.14` to update the project to 8.14.
