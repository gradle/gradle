...
==== TaskContainer.create/creating methods removed from the Kotlin DSL

Eager task creation methods on link:{javadocPath}/org/gradle/api/tasks/TaskContainer.html[the `TaskContainer` interface] have been removed in Gradle 9.0.
