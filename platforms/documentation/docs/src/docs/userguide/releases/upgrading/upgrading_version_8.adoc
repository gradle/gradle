...
==== Project directories must exist

Gradle will now fail if you include a project that does not correspond to a directory
in the file system, or if the directory exists but is read-only.
...
See more in <<deprecated_missing_project_directory>>.
