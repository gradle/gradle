...
Groovy has been updated from 3.0.24 to https://groovy-lang.org/changelogs/changelog-3.0.25.html[Groovy 3.0.25].

==== Upgrade to ASM 9.8

ASM was upgraded from 9.7.1 to https://asm.ow2.io/versions.html[9.8] to ensure compatibility with Java 25.
