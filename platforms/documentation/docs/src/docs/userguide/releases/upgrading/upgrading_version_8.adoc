...
In future Gradle versions, new subtypes of `ComponentIdentifier` may continue to be added.
Build logic should remain resilient to unknown subtypes of `ComponentIdentifier` being returned by Gradle APIs.
