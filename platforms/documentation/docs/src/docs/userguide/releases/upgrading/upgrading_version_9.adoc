...
==== Upgrade to Kotlin 2.3.21-RC

The embedded Kotlin has been upgraded from 2.3.20 to link:https://github.com/JetBrains/kotlin/releases/tag/v2.3.21-RC[Kotlin 2.3.21-RC].
