...
The link:{javadocPath}/org/gradle/api/reporting/ReportingExtension.html#file(java.lang.String)[`file()` method] on `ReportingExtension` has been deprecated and will be removed in Gradle 10.0.0.
