...
Gradle now embeds Kotlin 2.2.10, upgrading from the previously embedded version 2.2.0.

For full details and potential breaking changes, consult the link:https://github.com/JetBrains/kotlin/releases/tag/v2.2.10[Kotlin release notes].
