...
==== Upgrade to Kotlin 2.3.10-RC

The embedded Kotlin has been upgraded from 2.2.21 to link:https://github.com/JetBrains/kotlin/releases/tag/v2.3.10-RC[Kotlin 2.3.10-RC].
