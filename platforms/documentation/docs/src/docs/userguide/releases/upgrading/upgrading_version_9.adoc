...
[[changes_9.10.0]]
== Upgrading from 9.9.0 and earlier

=== Potential breaking changes

[[kotlin_2_5_0]]
==== Upgrade to Kotlin 2.5.0-Beta1

The embedded Kotlin has been upgraded from 2.4.20 to link:https://github.com/JetBrains/kotlin/releases/tag/v2.5.0-Beta1[Kotlin 2.5.0-Beta1].
