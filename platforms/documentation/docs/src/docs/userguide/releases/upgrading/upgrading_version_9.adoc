...
==== Upgrade to Kotlin 2.3.20-Beta2

The embedded Kotlin has been upgraded from 2.3.0 to link:https://github.com/JetBrains/kotlin/releases/tag/v2.3.20-Beta2[Kotlin 2.3.20-Beta2].
