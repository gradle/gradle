...
==== Upgrade to Kotlin 2.4.0-Beta2

The embedded Kotlin has been upgraded from 2.3.20 to link:https://github.com/JetBrains/kotlin/releases/tag/v2.4.0-Beta2[Kotlin 2.4.0-Beta2].
...
The embedded Kotlin has been upgraded from 2.3.10 to link:https://github.com/JetBrains/kotlin/releases/tag/v2.4.0-Beta2[Kotlin 2.4.0-Beta2].
