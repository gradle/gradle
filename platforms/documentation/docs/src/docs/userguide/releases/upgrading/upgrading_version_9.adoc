...
[[v9_upgrade_to_groovy_4_0_31]]
==== Upgrade to Groovy 4.0.31

Groovy has been updated to link:https://groovy-lang.org/changelogs/changelog-4.0.31.html[4.0.31].
Since the previous version was 4.0.29, the link:https://groovy-lang.org/changelogs/changelog-4.0.30.html[4.0.30] changes are also included.
