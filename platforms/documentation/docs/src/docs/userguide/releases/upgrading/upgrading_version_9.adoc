...
[[kotlin_2_4_10]]
==== Upgrade to Kotlin 2.4.20-RC3

The embedded Kotlin has been upgraded from 2.4.10 to link:https://github.com/JetBrains/kotlin/releases/tag/v2.4.20-RC3[Kotlin 2.4.20-RC3].
