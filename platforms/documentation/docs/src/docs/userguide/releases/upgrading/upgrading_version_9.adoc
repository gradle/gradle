...
----
| Delegate from `project` directly:
[source,kotlin]
----
...
==== Upgrade to Kotlin 2.3.21-RC2

The embedded Kotlin has been upgraded from 2.3.20 to link:https://github.com/JetBrains/kotlin/releases/tag/v2.3.21-RC2[Kotlin 2.3.21-RC2].
