...
Restricting the model to an explicit set of scripts by setting the `org.gradle.tooling.model.kotlin.dsl.scripts` Gradle property
(`KotlinDslScriptsModel.SCRIPTS_GRADLE_PROPERTY_NAME`, also deprecated) is now deprecated and will be removed in Gradle 10.
