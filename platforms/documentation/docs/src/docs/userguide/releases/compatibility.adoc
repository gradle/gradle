...
JVM 6 and 7 can be used for <<building_java_projects.adoc#sec:java_cross_compilation,compilation>> but are deprecated for use with testing.
Testing with JVM 6 and 7 will not be supported in Gradle 9.0.
...
Gradle is tested with Kotlin 1.6.10 through 2.0.20-Beta1.
