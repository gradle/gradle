...
Gradle is tested with Kotlin 1.6.10 through 2.1.20-Beta2.
...
.Supported Platforms
|===
| OS | Architecture | Officially Gradle supported?

| Ubuntu 22 | `amd64` | Yes
| Ubuntu 22 | `aarch64` | No

| Windows 10 | `amd64` | Yes
| Windows 10 | `aarch64` | No

| macOS 12 | `amd64` | Yes
| macOS 12 | `aarch64` | Yes

| Ubuntu 16 | `amd64` | No
| Ubuntu 16 | `aarch64` | No

| Alpine 3.20 | `amd64` | No
| Alpine 3.20 | `aarch64` | No

| CentOS 9 | `amd64` | No
| CentOS 9 | `aarch64` | No

| Amazon Linux | `amd64` | No
| Amazon Linux | `aarch64` | No
