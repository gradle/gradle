...
* The asterisk (*) indicates versions that include partial support or specific caveats. Please refer to detailed notes above for more information.
...
Gradle is tested with Kotlin 2.0.0 through 2.3.0-Beta2.
...
Gradle is tested with Android Gradle Plugin 8.13 through 9.0.0-alpha11.
