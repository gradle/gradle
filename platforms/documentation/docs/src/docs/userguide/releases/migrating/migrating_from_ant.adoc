...
Gradle does use something similar in the form of <<build_environment.adoc#sec:project_specific_properties,project properties>>, which are a reasonable way to parameterize a build.
