...
- **Use lazy wiring** like `providers.environmentVariable` to feed sensitive data to tasks and only obtain the values at execution time, keeping them out of the serialized task graph.
