...
The same applies to a build under test that enables <<isolated_projects.adoc#isolated_projects,Isolated Projects>>, which is built on the Configuration Cache infrastructure.
