...
=== Visualize Parallelism with a Build Scan
...
=== Visualize the Build Cache with a Build Scan
...
==== Find dynamic and changing versions with a Build Scan
...
==== Visualize dependency resolution with a Build Scan
...
Use a *Build Scan* or *profile reports* to ensure custom dependency resolution logic is not causing performance issues.
