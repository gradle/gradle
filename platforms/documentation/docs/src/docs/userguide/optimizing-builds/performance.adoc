...
To identify and remove them, use the https://github.com/nebula-plugins/gradle-lint-plugin[Gradle Lint plugin].
...
Or configure the property in the `gradle.properties` file in the <<directory_layout.adoc#directory_layout,project root or your Gradle home directory>>:
