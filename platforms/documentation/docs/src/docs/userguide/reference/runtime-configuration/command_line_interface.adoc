...
Toggles <<isolated_projects.adoc#isolated_projects,Isolated Projects>>. Projects are configured in parallel and their configuration might be reused from previous builds. _Default is off_.
