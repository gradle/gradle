...
NOTE: Daemon log files in `daemon/<GRADLE_VERSION>/` directories are also cleaned up automatically.
Log files older than 14 days are deleted.
Unlike the categories above, the retention period for daemon logs is fixed and cannot be configured.

The retention period for each of the five cache categories above can be configured independently via an <<init_scripts.adoc#init_scripts,init script>> in the Gradle User Home:

====
include::sample[dir="snippets/initScripts/cacheRetention/kotlin",files="gradleUserHome/init.d/cache-settings.init.gradle.kts"]
include::sample[dir="snippets/initScripts/cacheRetention/groovy",files="gradleUserHome/init.d/cache-settings.init.gradle"]
====
...
====
include::sample[dir="snippets/initScripts/disableCacheCleanup/kotlin",files="gradleUserHome/init.d/cache-settings.init.gradle.kts"]
include::sample[dir="snippets/initScripts/disableCacheCleanup/groovy",files="gradleUserHome/init.d/cache-settings.init.gradle"]
====
...
====
include::sample[dir="snippets/initScripts/multiVersionCacheRetention/kotlin",files="gradleUserHome/init.d/cache-settings.init.gradle.kts"]
include::sample[dir="snippets/initScripts/multiVersionCacheRetention/groovy",files="gradleUserHome/init.d/cache-settings.init.gradle"]
====

Version-compliant cache configuration script:

====
include::sample[dir="snippets/initScripts/multiVersionCacheRetention/kotlin",files="gradleUserHome/init.d/gradle8/cache-settings.init.gradle.kts"]
include::sample[dir="snippets/initScripts/multiVersionCacheRetention/groovy",files="gradleUserHome/init.d/gradle8/cache-settings.init.gradle"]
====
...
====
include::sample[dir="snippets/initScripts/cacheMarking/kotlin",files="gradleUserHome/init.d/cache-settings.init.gradle.kts"]
include::sample[dir="snippets/initScripts/cacheMarking/groovy",files="gradleUserHome/init.d/cache-settings.init.gradle"]
====
