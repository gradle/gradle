...
* A link:{javadocPath}/org/gradle/api/tasks/AbstractCopyTask.html#from(java.lang.Object...)[CopySpec.from(java.lang.Object...)] method to define what to copy
* An link:{javadocPath}/org/gradle/api/tasks/AbstractCopyTask.html#into(java.lang.Object)[CopySpec.into(java.lang.Object)] method to define the destination
...
====
include::sample[dir="snippets/files/archives/kotlin",files="build.gradle.kts[tags=revert-reproducible]"]
include::sample[dir="snippets/files/archives/groovy",files="build.gradle[tags=revert-reproducible]"]
====
