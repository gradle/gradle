...
Then call the method link:{javadocPath}/org/gradle/api/model/ObjectFactory.html#newInstance(java.lang.Class,java.lang.Object...)[`ObjectFactory.newInstance`] to generate an implementation of the interface that holds an injected service.
