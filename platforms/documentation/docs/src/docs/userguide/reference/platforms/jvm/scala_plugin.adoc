...
====
include::sample[dir="snippets/reference/platforms/jvm/quickstart/kotlin",files="build.gradle.kts[tags=scala-version]"]
include::sample[dir="snippets/reference/platforms/jvm/quickstart/groovy",files="build.gradle[tags=scala-version]"]
====
...
====
include::sample[dir="snippets/reference/platforms/jvm/quickstart/kotlin/inferred-version",files="build.gradle.kts[tags=scala-dependency]"]
include::sample[dir="snippets/reference/platforms/jvm/quickstart/groovy/inferred-version",files="build.gradle[tags=scala-dependency]"]
====
