...
====
include::sample[dir="snippets/reference/platforms/jvm/basic/kotlin",files="build.gradle.kts[tags=apply-java-plugin]"]
include::sample[dir="snippets/reference/platforms/jvm/basic/groovy",files="build.gradle[tags=apply-java-plugin]"]
====
...
====
include::sample[dir="snippets/reference/platforms/jvm/basic/kotlin",files="build.gradle.kts[tags=java-dependency-mgmt]"]
include::sample[dir="snippets/reference/platforms/jvm/basic/groovy",files="build.gradle[tags=java-dependency-mgmt]"]
====
...
====
include::sample[dir="snippets/reference/platforms/jvm/basic/kotlin",files="build.gradle.kts[tags=java-compiler-options]"]
include::sample[dir="snippets/reference/platforms/jvm/basic/groovy",files="build.gradle[tags=java-compiler-options]"]
====
...
====
include::sample[dir="snippets/reference/platforms/jvm/basic/kotlin",files="build.gradle.kts[tags=java-release-flag]"]
include::sample[dir="snippets/reference/platforms/jvm/basic/groovy",files="build.gradle[tags=java-release-flag]"]
====
...
====
include::sample[dir="snippets/reference/platforms/jvm/crossCompilation/kotlin",files="build.gradle.kts[tags=java-cross-compilation]"]
include::sample[dir="snippets/reference/platforms/jvm/crossCompilation/groovy",files="build.gradle[tags=java-cross-compilation]"]
====
...
====
include::sample[dir="snippets/reference/platforms/jvm/basic/kotlin",files="build.gradle.kts[tags=using-custom-doclet]"]
include::sample[dir="snippets/reference/platforms/jvm/basic/groovy",files="build.gradle[tags=using-custom-doclet]"]
====
...
====
include::sample[dir="snippets/reference/platforms/jvm/basic/kotlin",files="build.gradle.kts[tags=defining-custom-javadoc-task]"]
include::sample[dir="snippets/reference/platforms/jvm/basic/groovy",files="build.gradle[tags=defining-custom-javadoc-task]"]
====
