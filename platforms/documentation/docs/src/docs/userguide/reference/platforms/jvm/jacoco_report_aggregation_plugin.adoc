...
More information about the variants produced by test execution with JaCoCo are available in the <<jacoco_plugin#sec:outgoing_variants_jacoco,Outgoing Variants>> section of the JaCoCo Plugin documentation.
