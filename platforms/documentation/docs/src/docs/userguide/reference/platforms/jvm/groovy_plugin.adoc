...
====
include::sample[dir="snippets/reference/platforms/jvm/groovyQuickstart/kotlin",files="build.gradle.kts[tags=use-plugin]"]
include::sample[dir="snippets/reference/platforms/jvm/groovyQuickstart/groovy",files="build.gradle[tags=use-plugin]"]
====
