...
====
include::sample[dir="snippets/reference/platforms/jvm/quickstart/kotlin",files="build.gradle.kts[tags=groovy-dependency]"]
include::sample[dir="snippets/reference/platforms/jvm/quickstart/groovy",files="build.gradle[tags=groovy-dependency]"]
====
