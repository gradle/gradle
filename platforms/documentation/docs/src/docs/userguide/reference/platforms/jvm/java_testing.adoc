...
====
include::sample[dir="snippets/reference/platforms/jvm/basic/kotlin",files="build.gradle.kts[tags=java-basic-test-config]"]
include::sample[dir="snippets/reference/platforms/jvm/basic/groovy",files="build.gradle[tags=java-basic-test-config]"]
====
...
====
include::sample[dir="snippets/reference/platforms/jvm/basic/kotlin",files="build.gradle.kts[tags=practical-integ-test-source-set]"]
include::sample[dir="snippets/reference/platforms/jvm/basic/groovy",files="build.gradle[tags=practical-integ-test-source-set]"]
====
...
====
include::sample[dir="snippets/reference/platforms/jvm/basic/kotlin",files="build.gradle.kts[tags=integ-test-task]"]
include::sample[dir="snippets/reference/platforms/jvm/basic/groovy",files="build.gradle[tags=integ-test-task]"]
====
...
====
include::sample[dir="snippets/reference/platforms/jvm/basic/kotlin",files="build.gradle.kts[tags=skip-tests-condition]"]
include::sample[dir="snippets/reference/platforms/jvm/basic/groovy",files="build.gradle[tags=skip-tests-condition]"]
====
