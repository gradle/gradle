...
====
include::sample[dir="snippets/testing/non-class-based-testing/common/lib/src/test/definitions",files="ExampleTests.xml[]"]
====

====
include::sample[dir="snippets/testing/non-class-based-testing/common/lib/src/test/definitions/sub",files="MoreTests.xml[]"]
====
