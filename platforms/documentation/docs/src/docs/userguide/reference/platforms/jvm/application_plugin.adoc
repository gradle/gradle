...
====
include::sample[dir="snippets/reference/platforms/jvm/application/kotlin",files="build.gradle.kts[tags=applicationName-conf]"]
include::sample[dir="snippets/reference/platforms/jvm/application/groovy",files="build.gradle[tags=applicationName-conf]"]
====
