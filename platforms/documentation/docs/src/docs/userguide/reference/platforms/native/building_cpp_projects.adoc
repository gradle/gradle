...
The {cpp} plugins covered in this chapter were https://blog.gradle.org/introducing-the-new-cpp-plugins[introduced in 2018]. They replace the older software model Native plugins, which were removed in Gradle 10.
