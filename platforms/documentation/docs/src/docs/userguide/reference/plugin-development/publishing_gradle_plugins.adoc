...
The {portal} highlights plugins that declare support for opt-in Gradle features with compatibility badges.
...
NOTE: Declaring compatibility with Isolated Projects requires {publishplugin} v2.2.1 or later.
