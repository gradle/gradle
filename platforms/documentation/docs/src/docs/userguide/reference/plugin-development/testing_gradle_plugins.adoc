...
The following is an example of a unit test of the `Greeting` plugin from <<implementing_binary_plugins.adoc#implementing_binary_plugins, Binary Plugins>>:
...
The following is an example of a functional test of the `Greeting` plugin from <<implementing_binary_plugins.adoc#implementing_binary_plugins, Binary Plugins>>:
