...
Subproject (`moduleA`) build file:

====
include::sample[dir="snippets/dependencyManagement/strictlyConstraintPrecedence/kotlin/moduleA",files="build.gradle.kts[tags=strictly-precedence-module]"]
include::sample[dir="snippets/dependencyManagement/strictlyConstraintPrecedence/groovy/moduleA",files="build.gradle[tags=strictly-precedence-module]"]
====
