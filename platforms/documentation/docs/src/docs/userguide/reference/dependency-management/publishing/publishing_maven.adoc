...
====
include::sample[dir="snippets/reference/dependency-management/publishing/quickstart/kotlin",files="build.gradle.kts[tags=use-plugin]"]
include::sample[dir="snippets/reference/dependency-management/publishing/quickstart/groovy",files="build.gradle[tags=use-plugin]"]
====
...
====
include::sample[dir="snippets/reference/dependency-management/publishing/quickstart/kotlin",files="build.gradle.kts[tags=repositories]"]
include::sample[dir="snippets/reference/dependency-management/publishing/quickstart/groovy",files="build.gradle[tags=repositories]"]
====
