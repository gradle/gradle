...
====
include::sample[dir="snippets/dependencyManagement/catalogs-toml/common",files="gradle/libs.versions.toml[]"]
====
...
====
include::sample[dir="snippets/dependencyManagement/catalogs-toml/common",files="gradle/test-libs.versions.toml[]"]
====
