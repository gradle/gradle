...
====
include::sample[dir="snippets/reference/core-plugins/eclipse/kotlin",files="build.gradle.kts[tags=classpath-with-xml]"]
include::sample[dir="snippets/reference/core-plugins/eclipse/groovy",files="build.gradle[tags=classpath-with-xml]"]
====
