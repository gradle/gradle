...
====
include::sample[dir="snippets/reference/core-plugins/distribution/kotlin",files="build.gradle.kts[tags=publishing]"]
include::sample[dir="snippets/reference/core-plugins/distribution/groovy",files="build.gradle[tags=publishing]"]
====
