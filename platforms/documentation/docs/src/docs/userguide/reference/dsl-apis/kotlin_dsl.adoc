...
====
include::sample[dir="snippets/reference/dsl-apis/containers-delegated-properties/kotlin",files="build.gradle.kts[tags=delegated-properties]"]
====
...
Gradle has two main sources of properties defined at runtime: <<build_environment.adoc#sec:project_properties,_project properties_>> and <<writing_build_scripts_intermediate.adoc#sec:extra_properties,_extra properties_>>.
...
====
include::sample[dir="snippets/reference/dsl-apis/basics/kotlin",files="build.gradle.kts[tags=property]"]
====
...
====
include::sample[dir="snippets/reference/dsl-apis/basics/kotlin",files="build.gradle.kts[tags=test-task-eager]"]
====
...
====
include::sample[dir="snippets/reference/dsl-apis/basics/kotlin",files="build.gradle.kts[tags=write]"]
====
...
====
include::sample[dir="snippets/reference/dsl-apis/jvm-multi-project-with-toolchains/kotlin",files="buildSrc/src/main/kotlin/myproject.java-conventions.gradle.kts[tags=toolchain]"]
====
