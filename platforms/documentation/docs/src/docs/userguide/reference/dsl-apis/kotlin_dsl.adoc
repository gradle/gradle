...
* The embedded Kotlin compiler is supported on various platforms and architectures. Refer to the link:https://kotlinlang.org/docs/native-target-support.html[Kotlin/Native target support documentation] for details on currently supported targets.
...
====
include::sample[dir="snippets/java/jvm-multi-project-with-toolchains/kotlin",files="buildSrc/src/main/kotlin/myproject.java-conventions.gradle.kts[tags=toolchain]"]
====
