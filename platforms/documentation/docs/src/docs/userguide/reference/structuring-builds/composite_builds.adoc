...
=== For Plugins Applied in Build Scripts
...
A special case of included builds are builds that define Gradle plugins that need to be applied in the *settings file itself*.
