...
====
include::sample[dir="snippets/reference/task-development/taskConfigurationAvoidance-sideEffects/kotlin",files="build.gradle.kts[tags=side-effects]"]
include::sample[dir="snippets/reference/task-development/taskConfigurationAvoidance-sideEffects/groovy",files="build.gradle[tags=side-effects]"]
====
