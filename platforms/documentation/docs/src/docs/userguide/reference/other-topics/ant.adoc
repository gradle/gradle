...
====
include::sample[dir="snippets/ant/hello/common",files="build.xml"]
====
...
====
include::sample[dir="snippets/ant/dependsOnTask/common",files="build.xml"]
====
...
====
include::sample[dir="snippets/ant/renameTask/common",files="build.xml"]
====
...
====
include::sample[dir="snippets/ant/properties/common",files="build.xml[tags=getproperty]"]
====
...
====
include::sample[dir="snippets/ant/properties/common",files="build.xml[tags=setreference]"]
====

There are several ways to get an Ant reference:

====
include::sample[dir="snippets/ant/properties/common",files="build.xml[tags=getreference]"]
====
