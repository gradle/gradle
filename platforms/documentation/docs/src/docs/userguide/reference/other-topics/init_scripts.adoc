...
====
include::sample[dir="snippets/reference/other-topics/configurationInjection/groovy",files="build.gradle[];init.gradle[]"]
include::sample[dir="snippets/reference/other-topics/configurationInjection/kotlin",files="build.gradle.kts[];init.gradle.kts[]"]
====
...
[source,text]
----
include::{snippetsPath}/reference/other-topics/configurationInjection/tests-common/initScriptConfiguration.out[]
----
=====
...
====
include::sample[dir="snippets/reference/other-topics/externalDependency/kotlin",files="init.gradle.kts[tags=declare-classpath]"]
include::sample[dir="snippets/reference/other-topics/externalDependency/groovy",files="init.gradle[tags=declare-classpath]"]
====
...
====
include::sample[dir="snippets/reference/other-topics/externalDependency/kotlin",files="init.gradle.kts[tags=all];build.gradle.kts[]"]
include::sample[dir="snippets/reference/other-topics/externalDependency/groovy",files="init.gradle[tags=all];build.gradle[]"]
====
...
[source,text]
----
include::{snippetsPath}/reference/other-topics/externalDependency/tests-common/externalInitDependency.out[]
----
=====
[.multi-language-text.lang-groovy]
=====
...
====
include::sample[dir="snippets/reference/other-topics/plugins/kotlin",files="init.gradle.kts[tags=init-script-plugin];build.gradle.kts[tag=show-repos-task]"]
include::sample[dir="snippets/reference/other-topics/plugins/groovy",files="init.gradle[tags=init-script-plugin];build.gradle[tag=show-repos-task]"]
====
...
[source,text]
----
include::{snippetsPath}/reference/other-topics/plugins/tests-common/usePluginsInInitScripts.out[]
----
=====
[.multi-language-text.lang-groovy]
=====
...
====
include::sample[dir="snippets/reference/other-topics/init-kotlin/kotlin",files="baseline-init-plugin/src/main/kotlin/com/example/BaselineInitPlugin.kt[]"]
include::sample[dir="snippets/reference/other-topics/init-groovy/groovy",files="baseline-init-plugin/src/main/groovy/com/example/BaselineInitPlugin.groovy[]"]
====
...
====
include::sample[dir="snippets/reference/other-topics/init-kotlin/kotlin",files="init.gradle.kts[]"]
include::sample[dir="snippets/reference/other-topics/init-groovy/groovy",files="init.gradle[]"]
====
