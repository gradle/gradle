...
Useful `Gradle` callbacks include: `settingsEvaluated {}`, `projectsLoaded {}`, `beforeProject {}`, `afterProject {}`. You can see more in the <<build_lifecycle#lifecycle_api,Gradle LifeCycle API>>.
