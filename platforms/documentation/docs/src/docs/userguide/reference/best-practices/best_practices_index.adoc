...
****
There are currently *<span id="best-practices-count">X</span> Best Practices*.
****
  ...
  function init() {
    ...
    headerCells.forEach((header, index) => {
      ...
      header.addEventListener('click', function() {
        ...
        // Update current indicator - after toggle, if ascending is false, we just sorted ascending
    ...
    function updateCount() {
      ...
      const countElement = document.getElementById('best-practices-count');
      if (countElement) {
