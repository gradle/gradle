...
Ensure that published artifacts are built in a trusted way.

=== Explanation

The published artifacts should be generated from a *complete, fresh build* using an empty machine
...
outputs,temporary files, or cached artifacts.
