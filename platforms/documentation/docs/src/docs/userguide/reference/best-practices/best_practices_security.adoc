...
If you use the link:https://github.com/marketplace/actions/build-with-gradle#the-setup-gradle-action[setup-gradle action] (version v4 or newer) for GitHub Actions, Wrapper validation will be performed automatically.
...
If you cannot use the setup-gradle action, you can alternatively use the dedicated link:https://github.com/marketplace/actions/build-with-gradle#the-wrapper-validation-action[Gradle Wrapper validation action]:
