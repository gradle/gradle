...
If you need to apply properties across *multiple subprojects*, extract the configuration into a <<custom_plugins.adoc#sec:convention_plugins,convention plugin>>.
