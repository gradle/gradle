...
- IDEs and build tools can download sources and documentation directly from repositories or online docs.
...
- It **shortens the feedback loop** when upgrading Gradle or rotating caches.
