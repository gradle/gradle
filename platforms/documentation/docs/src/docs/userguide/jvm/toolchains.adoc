...
After completing the above steps, you can use the `./gradlew build` command to rebuild the project.
Gradle will use the JRE/JDK version specified in the build file for the build process.
====
