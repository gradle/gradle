...
For this purpose, the plugin exposes two <<dependency_configurations.adoc#sec:what-are-dependency-configurations,configurations>> that can be used to declare dependencies: `api` and `runtime`.
