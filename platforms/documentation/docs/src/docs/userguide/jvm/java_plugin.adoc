...
The Java plugin adds a number of <<dependency_configurations.adoc#sec:what-are-dependency-configurations,dependency configurations>> to your project, as shown below.
