...
If your build consumes modules with Ivy metadata, you might be able to activate api and implementation separation as described <<variant_model.adoc#sec:ivy-mapping-to-variants,here>> if all modules follow a certain structure.
