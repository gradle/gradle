...
| `apiElements`
| For compiling against the public API of this library
| yes
| no
...
| `privateApiElements`
| For compiling against the private API of this library
| yes
| no
| This configuration is meant to be used by consumers, to support unit test dependencies during compilation.
