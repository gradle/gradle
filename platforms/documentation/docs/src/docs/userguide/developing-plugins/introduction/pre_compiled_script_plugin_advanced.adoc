...
**Precompiled script plugins** or **convention plugins** will often be found in a <<composite_builds.adoc#efining_composite_builds,Composite Build>> with a name similar to `build-logic`:
