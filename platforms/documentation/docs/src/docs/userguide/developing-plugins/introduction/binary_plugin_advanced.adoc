...
====
include::sample[dir="snippets/plugins/simple/kotlin", files="build.gradle.kts[tags=simple]"]
include::sample[dir="snippets/plugins/simple/groovy", files="build.gradle[tags=simple]"]
====
...
== Updating the Convention Plugin
...
This is a very rudimentary example of a binary plugin.
