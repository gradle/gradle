...
- Understand the "Hello, World" plugin that was automatically created for you.
...
You can specify the language you want.
...
This is what the `gradlePlugin {}` block looks like:
...
* `val greeting by plugins.creating { ... }`: This registers a new plugin definition with the ID `org.example.greeting`.
...
1.  **Get a Slack Account and Workspace**: If you don't have one, create a link:https://slack.com/help/articles/218080037-Getting-started-for-new-Slack-users[Slack Account] and a link:https://slack.com/help/articles/206845317-Create-a-Slack-workspace[Slack Workspace] where you have administrative privileges.
