...
Build projects in parallel. For limitations of this option, see <<performance.adoc#sec:parallel_execution, Parallel Project Execution>>. _Default is off_.
