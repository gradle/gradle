...
You also get a project report within a https://scans.gradle.com/[Build Scan].
...
A https://scans.gradle.com/[Build Scan] gives a full, visual report of what dependencies exist on which configurations, transitive dependencies, and dependency version selection.
