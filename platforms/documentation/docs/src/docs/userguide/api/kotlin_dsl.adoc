...
// 3. all dependencies added to `buildSrc/build.gradle` will be available to all build scripts
...
// .The container scope string invoke extension
// ====
// include::sample[dir="snippets/kotlinDsl/containers-string-invoke/kotlin",files="build.gradle[tags=string-invoke]"]
// ====
