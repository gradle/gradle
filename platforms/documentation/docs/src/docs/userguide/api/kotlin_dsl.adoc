...
That includes <<multi_project_builds.adoc#sec:multiproject_buildsrc,buildSrc projects>>, <<composite_builds#composite_builds,included builds>> and <<custom_plugins#custom_plugins,Gradle plugins>>.
