...
WARNING: While `TaskContainer`, `PluginManager`, and other services provided via `@Provides` are also injectable; you should avoid injecting types not listed above.
