...
=== Using the Settings Directory

Suppose you want to use a path relative to the _settings_ directory.
In that case, you need to use link:{groovyDslPath}/org.gradle.api.Project.html#org.gradle.api.Project:layout[Project.layout],
obtain the link:{groovyDslPath}/org.gradle.api.file.ProjectLayout.html#org.gradle.api.file.ProjectLayout:settingsDirectory[ProjectLayout.settingsDirectory] from it
and construct an absolute path based on that, like so:
