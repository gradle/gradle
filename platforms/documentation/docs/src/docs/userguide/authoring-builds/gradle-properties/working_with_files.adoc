...
To use file system permission unset values of link:{groovyDslPath}/org.gradle.api.tasks.bundling.Zip.html#org.gradle.api.tasks.bundling.Zip:dirPermissions[Zip.getDirPermissions()] and link:{groovyDslPath}/org.gradle.api.tasks.bundling.Zip.html#org.gradle.api.tasks.bundling.Zip:filePermissions[Zip.getFilePermissions()] to `644`.
Alternatively to preserve file system permissions globally for you build you can add `org.gradle.archives.preserve-file-system-permissions=true` to `gradle.properties` file.
