...
----
// Setting a property
val messageProperty: Property<String> = project.objects.property(String::class.java)
messageProperty.set("Hello, World!")
...
----
// Setting a provider
val messageProvider: Provider<String> = project.providers.provider { "Hello, world!" }
...
[cols="1,1"]
|===
|Property Type |Cell in column 2, header row
