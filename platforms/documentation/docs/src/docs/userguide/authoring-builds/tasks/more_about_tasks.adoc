...
Before reading this chapter, it's recommended that you first read the <<gradle_directories_intermediate.adoc#gradle_directories,Learning The Basics>> and complete the <<part1_gradle_init_project.adoc#part1_gradle_init,Tutorial>>.
