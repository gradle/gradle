...
This information can be used by different user interfaces such as Gradle's console output, a Build Scan, or IDEs to communicate problems to the user in the most appropriate way.
