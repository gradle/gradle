...
The link:{userManualPath}/jvm/jvm_test_suite_plugin.html[Test Suite plugin] provides a DSL and API to model multiple groups of automated tests into test suites in JVM-based projects.
