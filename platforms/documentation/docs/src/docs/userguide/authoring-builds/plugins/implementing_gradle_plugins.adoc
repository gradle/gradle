...
* dependencies in the root project of the <<multi_project_builds.adoc#sec:multiproject_buildsrc,build source (`buildSrc`)>> that appear on the compile or runtime classpath;
