...
The following brief example shows an example issue reported from a plugin. For a full example, see our link:../samples/plugins/problem-reporting[ end-to-end sample].
