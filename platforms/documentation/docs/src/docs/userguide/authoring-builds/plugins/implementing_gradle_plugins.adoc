...
The following brief example shows an example issue reported from a plugin. For a full example, see our link:../samples/sample_problems_api_usage.html[end-to-end sample].
