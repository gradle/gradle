...
Gradle's <<variant_aware_resolution.adoc#seven-variant-aware-resolution,dependency management engine>> allows you to share arbitrary artifacts between projects and build them on demand.
