...
====
include::sample[dir="snippets/build-organization/composite-builds/basic/kotlin",files="my-app/app/build.gradle.kts[tags=app_dependencies]"]
include::sample[dir="snippets/build-organization/composite-builds/basic/groovy",files="my-app/app/build.gradle[tags=app_dependencies]"]
====
...
include::{snippetsPath}/build-organization/composite-builds/basic/tests/basicCli.out[]
----
...
====
include::sample[dir="snippets/build-organization/composite-builds/basic/kotlin",files="settings.gradle.kts[]"]
include::sample[dir="snippets/build-organization/composite-builds/basic/groovy",files="settings.gradle[]"]
====
...
====
include::sample[dir="snippets/build-organization/composite-builds/basic/kotlin",files="build.gradle.kts[tags=run]"]
include::sample[dir="snippets/build-organization/composite-builds/basic/groovy",files="build.gradle[tags=run]"]
====
...
====
include::sample[dir="snippets/build-organization/composite-builds/declared-substitution/kotlin/anonymous-library",files="build.gradle.kts[]"]
include::sample[dir="snippets/build-organization/composite-builds/declared-substitution/groovy/anonymous-library",files="build.gradle[]"]
====
...
====
include::sample[dir="snippets/build-organization/composite-builds/declared-substitution/kotlin",files="settings.gradle.kts[tags=composite_substitution]"]
include::sample[dir="snippets/build-organization/composite-builds/declared-substitution/groovy",files="settings.gradle[tags=composite_substitution]"]
====
...
====
include::sample[dir="snippets/build-organization/composite-builds/hierarchical-multirepo/kotlin",files="build.gradle.kts"]
include::sample[dir="snippets/build-organization/composite-builds/hierarchical-multirepo/groovy",files="build.gradle"]
====
