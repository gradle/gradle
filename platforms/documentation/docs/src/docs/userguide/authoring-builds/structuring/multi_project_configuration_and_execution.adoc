...
- Refrain from referencing other subprojects' build scripts and prefer <<glossary.adoc#sub:cross_project_configuration,cross-project configuration>> from the root project.
