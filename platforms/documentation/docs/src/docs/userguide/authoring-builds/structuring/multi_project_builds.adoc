...
A _basic_ multi-project build contains a root project and a single subproject.

This is an example of the structure for a multi-project build that contains a single subproject called `app`:
