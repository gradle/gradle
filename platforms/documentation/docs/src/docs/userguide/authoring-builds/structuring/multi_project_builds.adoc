...
├── build.gradle(.kts)          // Root project build script (optional)
├── app/                        // Subproject
│   ├── build.gradle(.kts)      // Subproject build script
│   └── src/
│       └── main/
├── core/                       // Another subproject
│   ├── build.gradle(.kts)
│   └── src/
└── util/                       // Another subproject
    ├── build.gradle(.kts)
    └── src/
----
...
│   └── build.gradle.kts    // Subproject build file
└── settings.gradle.kts     // Settings file
----
=====
[.multi-language-sample]
...
├── app                     // Subproject
│   ...                     // Source code and other files
│   └── build.gradle        // Subproject build file
...
`buildSrc` is a convention-based embedded build located in the root of your Gradle project.
...
├── build.gradle(.kts)
├── app/
│   ├── build.gradle(.kts)      // Subproject build script, applies `java-library` and testing logic
│   └── src/
├── core/
│   ├── build.gradle(.kts)      // Subproject build script, applies `java-library` and testing logic
│   └── src/
...
├── build.gradle.kts
├── buildSrc/
│   └── java-library-convention.gradle.kts  // Applies `java-library` and testing logic
├── app/
│   ├── build.gradle.kts                    // Subproject build script, applies `java-library-convention`
│   └── src/
├── core/
│   ├── build.gradle.kts                    // Subproject build script, applies `java-library-convention`
│   └── src/
...
[source,text]
----
composite-project/              // Root project directory
├── settings.gradle(.kts)       // Settings file
├── app/                        // Subproject
│   ├── build.gradle(.kts)
│   └── src/
...
│    ├── build.gradle(.kts)
│    └── src/
└── libs/                       // Standalone, reusable library (included build)
    └── lib/
        ├── settings.gradle.kts
        ├── build.gradle.kts
        └── src/
