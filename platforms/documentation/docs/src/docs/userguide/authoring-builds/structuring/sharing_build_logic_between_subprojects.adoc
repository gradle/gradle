...
Instead of repeating the same included dependencies in each subproject build script, Gradle provides a special directory for storing shared build logic and plugins.
