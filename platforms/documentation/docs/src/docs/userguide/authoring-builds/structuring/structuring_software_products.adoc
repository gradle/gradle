...
As software projects grow, it is common to organize large systems into components that are connected.
...
1. It allows you to describe the coarse grained structure and architecture of your software in a model written in Gradle's DSLs.
...
- The _aggregation_ component contains the setup of the delivery pipeline that is required to push the product to production and doing automated end-to-end testing as part of that. +
