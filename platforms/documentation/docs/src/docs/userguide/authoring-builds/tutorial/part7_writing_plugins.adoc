...
If you haven’t read the <<gradle_directories.adoc#gradle_directories,Beyond the Basics>> section yet, we recommend starting there to learn important mid-level topics.
