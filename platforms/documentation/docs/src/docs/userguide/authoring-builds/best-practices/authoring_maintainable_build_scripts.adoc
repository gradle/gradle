...
You can find an example for capturing user input to configure runtime behavior in the <<implementing_gradle_plugins_binary.adoc#sec:plugin_conventions,implementing plugins section>>.
