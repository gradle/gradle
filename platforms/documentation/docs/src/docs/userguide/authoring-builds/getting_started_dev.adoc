...
<<intro_multi_project_builds.adoc#intro_multi_project_builds,Part 2.>> Structuring Multi-Project Builds +
...
<<gradle_managed_types.adoc#,Part 5.>> Gradle Managed Types +
<<dependencies.adoc#,Part 6.>> Declaring and Managing Dependencies +
