...
Enables incubating <<structuring_software_products_details.adoc#sec:configuration_on_demand, configuration on demand>>, where Gradle will attempt to configure only necessary projects.
+
_Default is `false`._
