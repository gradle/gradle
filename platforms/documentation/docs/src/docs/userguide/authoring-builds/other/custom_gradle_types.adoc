...
== Custom plugin provided `dependencies` block
...
.ExamplePlugin.java
----
include::{snippetsPath}/plugins/dependenciesBlock/kotlin/buildSrc/src/main/java/com/example/ExamplePlugin.java[tags=wire-dependencies]
----
====
