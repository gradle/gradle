...
- Types that have custom `dependencies` blocks
...
== Plugin provided `dependencies` block

NOTE: Custom `dependencies` blocks are based on incubating APIs.

A plugin can provide a custom `dependencies` block that allows users to declare dependencies in a type-safe and context-aware way.
...
That new type needs to be accessible from a part of your plugin (a domain object or extension).
...
==== Create an interface that extends `Dependencies`
...
.Create dependencies block type
====
[source.multi-language-sample,java]
.ExampleDependencies.java
----
include::{snippetsPath}/plugins/dependenciesBlock/kotlin/buildSrc/src/main/java/com/example/ExampleDependencies.java[tags=custom-dependencies-type]
----
====

==== Add accessors for dependency scopes
...
.ExampleDependencies.java
----
include::{snippetsPath}/plugins/dependenciesBlock/kotlin/buildSrc/src/main/java/com/example/ExampleDependencies.java[tags=custom-dependencies-scopes]
----
====

==== Add accessors for custom `dependencies` block
...
.Add getter and configurable block methods
====
[source.multi-language-sample,java]
.ExampleExtension.java
----
include::{snippetsPath}/plugins/dependenciesBlock/kotlin/buildSrc/src/main/java/com/example/ExampleExtension.java[tags=dependencies-accessors]
----
====

==== Wire dependency scopes to `Configuration`s
...
====
[source.multi-language-sample,kotlin]
.com.example.custom-dependencies.gradle.kts
----
include::{snippetsPath}/plugins/dependenciesBlock/kotlin/buildSrc/src/main/kotlin/com.example.custom-dependencies.gradle.kts[tags=wire-dependencies]
----
[source.multi-language-sample,groovy]
.com.example.custom-dependencies.gradle
----
include::{snippetsPath}/plugins/dependenciesBlock/groovy/buildSrc/src/main/groovy/com.example.custom-dependencies.gradle[tags=wire-dependencies]
----
====
