 ...
 * Declaring dependencies with <<dependency_versions.adoc#sub:declaring_dependency_with_changing_version,changing>> (e.g. SNAPSHOT) and <<dependency_versions.adoc#sub:declaring_dependency_with_dynamic_version,dynamic>> (range) versions
