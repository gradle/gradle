...
You can then conditionally apply one of those profile scripts based on a <<build_environment.adoc#sec:project_specific_properties,project property>> of your own choice.
