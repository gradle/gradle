...
====
include::sample[dir="snippets/tutorials/running-builds/dependency-types/kotlin",files="app/build.gradle.kts[tags=dep-types]"]
include::sample[dir="snippets/tutorials/running-builds/dependency-types/groovy",files="app/build.gradle[tags=dep-types]"]
====
