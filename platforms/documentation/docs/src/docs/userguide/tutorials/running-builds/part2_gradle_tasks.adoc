...
====
include::sample[dir="snippets/tutorials/running-builds/generated/kotlin",files="app/build.gradle.kts[tags=init-plugins]"]
include::sample[dir="snippets/tutorials/running-builds/generated/groovy",files="app/build.gradle[tags=init-plugins]"]
====
...
====
include::sample[dir="snippets/tutorials/running-builds/generated/kotlin",files="app/build.gradle.kts[tags=init-task]"]
include::sample[dir="snippets/tutorials/running-builds/generated/groovy",files="app/build.gradle[tags=init-task]"]
====
...
====
include::sample[dir="snippets/tutorials/running-builds/generated/kotlin",files="app/build.gradle.kts[tags=init-hello]"]
include::sample[dir="snippets/tutorials/running-builds/generated/groovy",files="app/build.gradle[tags=init-hello]"]
====
...
====
include::sample[dir="snippets/tutorials/running-builds/generated/groovy",files="app/src/main/java/org/example/App.java[]"]
====
