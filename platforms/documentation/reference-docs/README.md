...
Follow the instructions in [notes.md](https://github.com/gradle/gradle/blob/master/platforms/documentation/reference-docs/src/docs/release/notes.md).
...
```bash
./gradlew :reference-docs:releaseNotes
```
...
| User manual only (links may break)     | `./gradlew :reference-docs:userguide`               |
| Multi-page HTML manual only            | `./gradlew :reference-docs:userguideMultiPage`      |
| Single-page HTML manual only           | `./gradlew :reference-docs:userguideSinglePageHtml` |
| Javadoc only                           | `./gradlew :reference-docs:javadocAll`              |
| Run all snippet and sample tests       | `./gradlew :reference-docs:docsTest`                |
...
```bash
./gradlew :reference-docs:checkDeadInternalLinks
```
...
To fully understand how to write and test code snippets in the Gradle documentation, see @platforms/documentation/reference-docs/src/docs/rules/snippets.md

### `org.gradle.samples` plugin

The main build file for documentation, `platforms/documentation/reference-docs/build.gradle.kts`, applies the `org.gradle.samples` plugin.
...
```bash
./gradlew :reference-docs:dslHtml
```
...
```bash
./gradlew :reference-docs:javadocAll
```
