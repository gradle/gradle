...
trait ServiceRegistryFixture {

    String normalizedMessage(Throwable exception) {
        withoutTestClassName(TextUtil.normaliseLineSeparators(exception.message))
    }

    String withoutTestClassName(String s) {
