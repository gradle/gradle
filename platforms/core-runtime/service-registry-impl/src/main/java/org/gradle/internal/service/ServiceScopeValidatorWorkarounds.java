...
class ServiceScopeValidatorWorkarounds {
    ...
    private static final Set<String> SUPPRESSED_VALIDATION_CLASSES = new HashSet<String>(Arrays.asList(
            ...
            // makes CC skip serialization and instead use service look-up which yield a wrong value for this specially
            // setup task
            "org.gradle.api.internal.StartParameterInternal",

            // Configuration Cache service Codec fails to get an instance of this service, due to multiple being
            // available
