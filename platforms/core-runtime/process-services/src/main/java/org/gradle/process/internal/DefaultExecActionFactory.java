...
public class DefaultExecActionFactory implements ExecFactory {
    ...
    public ExecAction newDecoratedExecAction() {
        DefaultExecAction execAction = instantiator.newInstance(DefaultExecAction.class, filePropertyFactory.withResolver(fileResolver), execHandleFactory.newExecHandleBuilder());
    ...
    public ExecAction newExecAction() {
        return new DefaultExecAction(filePropertyFactory.withResolver(fileResolver), execHandleFactory.newExecHandleBuilder());
    }
    ...
    public ExecHandleBuilder newExec() {
        return new DefaultExecHandleBuilder(filePropertyFactory.withResolver(fileResolver), execHandleFactory.newExecHandleBuilder());
    }
