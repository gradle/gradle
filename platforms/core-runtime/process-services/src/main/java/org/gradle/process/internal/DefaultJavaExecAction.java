...
public class DefaultJavaExecAction implements JavaExecAction {
    ...
    public ExecResult execute() {
        ...
        javaExecHandleBuilder.setExtraJvmArgs(javaExecSpec.getExtraJvmArgs());
        ExecHandle execHandle = ExecHandleBuilderConfigurer.configureFrom(javaExecHandleBuilder, javaExecSpec)
            .build();
