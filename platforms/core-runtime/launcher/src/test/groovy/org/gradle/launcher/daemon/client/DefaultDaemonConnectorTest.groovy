...
class DefaultDaemonConnectorTest extends Specification {
    ...
    def startBusyDaemon() {
        ...
        DaemonContext context = new DefaultDaemonContext(daemonNum.toString(), javaHome, JavaLanguageVersion.current(), Jvm.current().vendor, javaHome, daemonNum, 1000, [], false, NativeServicesMode.ENABLED, DaemonParameters.Priority.NORMAL)
