...
class DefaultDaemonConnectorTest extends Specification {
    ...
    def startBusyDaemon() {
        ...
        DaemonContext context = new DefaultDaemonContext(daemonNum.toString(), javaHome, javaHome, daemonNum, 1000, [], false, NativeServicesMode.ENABLED, DaemonParameters.Priority.NORMAL)
