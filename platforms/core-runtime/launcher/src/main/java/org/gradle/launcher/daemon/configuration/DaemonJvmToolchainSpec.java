...
public class DaemonJvmToolchainSpec implements JavaToolchainSpecInternal {
    ...
    public DaemonJvmToolchainSpec(PropertyFactory propertyFactory, DaemonJvmCriteria daemonJvmCriteria) {
        version = propertyFactory.property(JavaLanguageVersion.class).value(JavaLanguageVersion.of(daemonJvmCriteria.getJavaVersion().getMajorVersion()));
