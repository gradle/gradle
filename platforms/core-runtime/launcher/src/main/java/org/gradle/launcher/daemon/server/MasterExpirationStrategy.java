...
public class MasterExpirationStrategy implements DaemonExpirationStrategy {
    ...
    public MasterExpirationStrategy(
            Daemon daemon,
            DaemonServerConfiguration params,
        ...
        strategies.add(new AllDaemonExpirationStrategy(ImmutableList.of(
                ...
                new DaemonIdleTimeoutExpirationStrategy(
                        daemon, DUPLICATE_DAEMON_GRACE_PERIOD_MS, TimeUnit.MILLISECONDS),
    ...
    private void addLowMemoryDaemonExpirationStrategyWhenSupported(
            Daemon daemon,
            ImmutableList.Builder<DaemonExpirationStrategy> strategies,
            ListenerManager listenerManager) {
        final LowMemoryDaemonExpirationStrategy lowMemoryDaemonExpirationStrategy =
                new LowMemoryDaemonExpirationStrategy(0.05);
