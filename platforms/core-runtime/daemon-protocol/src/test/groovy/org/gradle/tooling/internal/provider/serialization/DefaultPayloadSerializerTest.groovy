...
class DefaultPayloadSerializerTest extends AbstractClassGraphSpec {
    final DefaultPayloadSerializer originator = new DefaultPayloadSerializer(new WellKnownClassLoaderRegistry(new DefaultPayloadClassLoaderRegistry(new ClassLoaderCache(), new ModelClassLoaderFactory())))
    final DefaultPayloadSerializer receiver = new DefaultPayloadSerializer(new WellKnownClassLoaderRegistry(new DefaultPayloadClassLoaderRegistry(new ClassLoaderCache(), new ModelClassLoaderFactory())))
