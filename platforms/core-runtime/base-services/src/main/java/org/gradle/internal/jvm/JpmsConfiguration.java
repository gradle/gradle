...
public class JpmsConfiguration {
     ...
     * Exposes the required packages for test workers to work on Java 9+.
     */
    private static final List<String> GRADLE_TEST_WORKERS_JPMS_WITH_TESTKIT_ARGS_9 = ImmutableList.of(
        ADD_OPENS_JAVA_BASE_JAVA_LANG_ALL_UNNAMED,
     ...
     * @return the JVM arguments
     */
    public static List<String> forTestWorkersWithTestKit(int majorVersion) {
        if (majorVersion < 9) {
            return ImmutableList.of();
        }
        return GRADLE_TEST_WORKERS_JPMS_WITH_TESTKIT_ARGS_9;
    }
}
