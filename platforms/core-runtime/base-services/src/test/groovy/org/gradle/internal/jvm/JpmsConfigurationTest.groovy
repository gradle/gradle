...
class JpmsConfigurationTest extends Specification {
    ...
    def "forTestWorkersWithTestKit returns JPMS args for Java 9 and above"() {
        when:
        def result = JpmsConfiguration.forTestWorkersWithTestKit(majorVersion)
    ...
    def "forTestWorkersWithTestKit returns empty list for Java 8 and below"() {
        expect:
        JpmsConfiguration.forTestWorkersWithTestKit(majorVersion) == []
    ...
    def "all methods return immutable lists"() {
        ...
        def testWorkerWithTestKitResult = JpmsConfiguration.forTestWorkersWithTestKit(9)
    ...
    def "forTestWorkersWithTestKit returns consistent results across versions"() {
        expect:
        JpmsConfiguration.forTestWorkersWithTestKit(9) == JpmsConfiguration.forTestWorkersWithTestKit(17)
        JpmsConfiguration.forTestWorkersWithTestKit(17) == JpmsConfiguration.forTestWorkersWithTestKit(24)
    }
    ...
    def "all JPMS args lists are non-null"() {
        ...
        JpmsConfiguration.forTestWorkersWithTestKit(version) != null
    ...
    def "forTestWorkers contains subset of forTestWorkersWithTestKit args"() {
        ...
        def testWorkersWithTestKitArgs = JpmsConfiguration.forTestWorkersWithTestKit(9)
