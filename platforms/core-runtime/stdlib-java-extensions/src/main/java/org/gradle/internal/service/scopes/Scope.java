 ...
 *            Build
 *       ┌──────┴───┬──────────────┐
 *    Settings   Project   ProjectExecution
 * </pre>
 *
...
public interface Scope {
     ...
     * Its services are internal to Gradle: they are not available when configuring the project,
     * and user code cannot inject them.
     * <p>
     * {@link Build} and parent scope services are visible to {@link ProjectExecution} scope services, but not vice versa.
     * {@link Project} scope services are not visible, so the project state that execution needs is registered explicitly.
     */
