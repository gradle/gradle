...
public class DefaultFileMetadata implements FileMetadata {
    ...
    private static final FileMetadata DIR_ACCESSED_VIA_SYMLINK =
            new DefaultFileMetadata(FileType.Directory, 0, 0, AccessType.VIA_SYMLINK);
    private static final FileMetadata MISSING = new DefaultFileMetadata(FileType.Missing, 0, 0, AccessType.DIRECT);
    private static final FileMetadata BROKEN_SYMLINK =
            new DefaultFileMetadata(FileType.Missing, 0, 0, AccessType.VIA_SYMLINK);
