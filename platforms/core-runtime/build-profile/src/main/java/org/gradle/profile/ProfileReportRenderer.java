            ...
            return new ReportRenderer<BuildProfile, SimpleHtmlWriter>() {
                ...
                public void render(BuildProfile model, SimpleHtmlWriter htmlWriter) throws IOException {
                    htmlWriter
                            ...
                            .attribute("id", "header")
                            .startElement("p")
                            .characters(model.getBuildDescription())
                            .endElement()
                            .startElement("p")
                            .characters(model.getBuildStartedDescription())
                            .endElement()
                            .endElement();
                }
            };
            ...
            return new ReportRenderer<BuildProfile, SimpleHtmlWriter>() {
                ...
                public void render(BuildProfile model, SimpleHtmlWriter htmlWriter) throws IOException {
                    ...
                    htmlWriter
                            ...
                            .startElement("a")
                            .attribute("href", "#tab2")
                            .characters("Dependency Resolution")
                            .endElement()
                            .endElement()
                            .startElement("li")
                            .startElement("a")
                            .attribute("href", "#tab3")
                            .characters("Artifact Transforms")
                            .endElement()
                            .endElement()
                            .startElement("li")
                            .startElement("a")
                            .attribute("href", "#tab4")
                            .characters("Task Execution")
                            .endElement()
                            .endElement()
                            .endElement();
                    ...
                    htmlWriter
                            .startElement("td")
                            .attribute("class", "numeric")
                            .characters(TimeFormatting.formatDurationVeryTerse(model.getElapsedTotal()))
                            .endElement();
                    htmlWriter.endElement();
                    htmlWriter.startElement("tr");
                    ...
                    htmlWriter
                            .startElement("td")
                            .attribute("class", "numeric")
                            .characters(TimeFormatting.formatDurationVeryTerse(model.getElapsedStartup()))
                            .endElement();
                    htmlWriter.endElement();
                    htmlWriter.startElement("tr");
                    htmlWriter
                            .startElement("td")
                            .characters("Settings and buildSrc")
                            .endElement();
                    htmlWriter
                            .startElement("td")
                            .attribute("class", "numeric")
                            .characters(TimeFormatting.formatDurationVeryTerse(model.getElapsedSettings()))
                            .endElement();
                    htmlWriter.endElement();
                    htmlWriter.startElement("tr");
                    ...
                    htmlWriter
                            .startElement("td")
                            .attribute("class", "numeric")
                            .characters(TimeFormatting.formatDurationVeryTerse(model.getElapsedProjectsLoading()))
                            .endElement();
                    htmlWriter.endElement();
                    htmlWriter.startElement("tr");
                    htmlWriter
                            .startElement("td")
                            .characters("Configuring Projects")
                            .endElement();
                    htmlWriter
                            .startElement("td")
                            .attribute("class", "numeric")
                            .characters(TimeFormatting.formatDurationVeryTerse(
                                    profiledProjectConfiguration.getElapsedTime()))
                            .endElement();
                    htmlWriter.endElement();
                    htmlWriter.startElement("tr");
                    htmlWriter
                    ...
                    htmlWriter
                            .startElement("td")
                            .attribute("class", "numeric")
                            .characters(TimeFormatting.formatDurationVeryTerse(model.getElapsedArtifactTransformTime()))
                            .endElement();
                    htmlWriter.endElement();
                    htmlWriter.startElement("tr");
                    ...
                    htmlWriter
                            .startElement("td")
                            .attribute("class", "numeric")
                            .characters(TimeFormatting.formatDurationVeryTerse(model.getElapsedTotalExecutionTime()))
                            .endElement();
                    htmlWriter.endElement();
                    htmlWriter.endElement();
                    htmlWriter.endElement();
                    ...
                    for (Operation operation : profiledProjectConfiguration) {
                        ...
                        htmlWriter
                                .startElement("td")
                                .characters(operation.getDescription())
                                .endElement();
                        htmlWriter
                                .startElement("td")
                                .attribute("class", "numeric")
                                .characters(TimeFormatting.formatDurationVeryTerse(operation.getElapsedTime()))
                                .endElement();
                        htmlWriter.endElement();
                    }
                    ...
                    htmlWriter
                            ...
                            .attribute("class", "numeric")
                            .characters(TimeFormatting.formatDurationVeryTerse(
                                    model.getDependencySets().getElapsedTime()))
                            .endElement();
                    htmlWriter.endElement();
                    ...
                    for (ProjectProfile project : model.getProjects()) {
                        htmlWriter
                                .startElement("tr")
                                .startElement("td")
                                .characters(project.getPath())
                                .endElement()
                                .startElement("td")
                                .attribute("class", "numeric")
                                .characters(TimeFormatting.formatDurationVeryTerse(project.getElapsedTime()))
                                .endElement()
                                .startElement("td")
                                .characters("(total)")
                                .endElement()
                        ...
                        for (TaskExecution taskExecution : project.getTasks()) {
                            htmlWriter
                                    .startElement("tr")
                                    .startElement("td")
                                    .attribute("class", "indentPath")
                                    .characters(taskExecution.getPath())
                                    .endElement()
                                    .startElement("td")
                                    .attribute("class", "numeric")
                                    .characters(TimeFormatting.formatDurationVeryTerse(taskExecution.getElapsedTime()))
                                    .endElement()
                                    .startElement("td")
                                    .characters(taskExecution.getStatus())
                                    .endElement()
                                    .endElement();
                        }
                    }
