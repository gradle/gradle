...
public class TestExecutionRequestAction extends SubscribableBuildAction {
    ...
    public static Collection<? extends TaskExecutionRequest> getTaskRequests(List<InternalTaskSpec> taskSpecs, boolean runDefaultTasks) {
        if (!taskSpecs.isEmpty()) {
            ...
            return Collections.singletonList(new DefaultTaskExecutionRequest(taskPaths));
        } else if (runDefaultTasks) {
            return Collections.singletonList(new RunDefaultTasksExecutionRequest());
        } else {
            return Collections.emptyList();
        }
    }

    public static Set<InternalJvmTestRequest> getInternalJvmTestRequests(ProviderInternalTestExecutionRequest testExecutionRequest, Set<String> classNames) {
    ...
    public static InternalDebugOptions getDebugOptions(ProviderInternalTestExecutionRequest testExecutionRequest) {
        return testExecutionRequest.getDebugOptions(new DefaultDebugOptions());
    }

    public static Map<String, List<InternalJvmTestRequest>> getTaskAndTests(ProviderInternalTestExecutionRequest testExecutionRequest) {
