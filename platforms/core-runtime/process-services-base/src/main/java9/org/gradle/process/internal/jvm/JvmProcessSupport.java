...
/**
 * Java 9+ copy of {@link JvmProcessSupport}, using the real {@link Process} APIs directly with
 * no reflection.
 */
@NullMarked
public final class JvmProcessSupport {
    ...
    public static CompletableFuture<Process> onExit(Process process, Executor executor) {
        // Route the handling to the provided executor for consistency with Java 8.
        return process.onExit().thenApplyAsync(p -> p, executor);
    }
