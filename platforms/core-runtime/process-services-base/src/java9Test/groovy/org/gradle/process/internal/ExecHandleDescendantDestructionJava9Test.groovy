...
@UsesNativeServices
@Timeout(60)
class ExecHandleDescendantDestructionJava9Test extends AbstractExecHandleSpec {

    void "abort destroys all child processes"() {
        def execHandle = handle().args(args(DefaultExecHandleSpec.AppWithChildWithGrandChild)).build()
    ...
    private static List<String> childProcessHandles(ExecHandle execHandle) {
