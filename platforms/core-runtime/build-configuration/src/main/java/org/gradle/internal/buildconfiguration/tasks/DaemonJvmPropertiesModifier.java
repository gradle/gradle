...
public class DaemonJvmPropertiesModifier {
    ...
    public void updateJvmCriteria(
        ...
        try {
            PropertiesUtils.store(
                    daemonJvmProperties,
                    propertiesFile,
                    "This file is generated by " + DaemonJvmPropertiesConfigurator.TASK_NAME);
        } catch (IOException e) {
    ...
    private static void validateToolchainVersion(JavaLanguageVersion version) {
        ...
        // TODO: Need to consider how to handle future versions of Java that are not yet known. This currently allows
        // any version of Java above the minimum.
        int minimalSupportedVersion = 8;
        if (!version.canCompileOrRun(minimalSupportedVersion)) {
            String exceptionMessage = String.format(
                    "Unsupported Java version '%s' provided for the 'jvm-version' option. Gradle can only run with Java %d and above.",
