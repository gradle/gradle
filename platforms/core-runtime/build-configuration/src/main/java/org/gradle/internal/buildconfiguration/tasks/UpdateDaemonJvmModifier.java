...
import org.gradle.internal.buildconfiguration.BuildPropertiesConfigurator;
...
public class UpdateDaemonJvmModifier {
    public static void updateJvmCriteria(
        ...
        try {
            PropertiesUtils.store(buildProperties, propertiesFile, "This file is generated by " + BuildPropertiesConfigurator.TASK_NAME);
        } catch (IOException e) {
