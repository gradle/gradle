...
public class UpdateDaemonJvmModifier {
    public static void updateJvmCriteria(
        ...
        Map<String, URI> availableToolchains
    ) {
        ...
        for (Map.Entry<String, URI> entry : availableToolchains.entrySet()) {
            String archOS = entry.getKey();
            URI toolchainUrl = entry.getValue();
            daemonJvmProperties.put(String.format(DaemonJvmPropertiesDefaults.TOOLCHAIN_URL_PROPERTY_FORMAT, archOS), toolchainUrl.toASCIIString());
        }
