...
class UpdateDaemonJvmModifierTest extends Specification {
    ...
    def "writes expected properties into file"() {
        when:
        UpdateDaemonJvmModifier.updateJvmCriteria(daemonJvmPropertiesFile, JavaLanguageVersion.of(11), JvmVendor.fromString("IBM"), JvmImplementation.VENDOR_SPECIFIC)
        then:
