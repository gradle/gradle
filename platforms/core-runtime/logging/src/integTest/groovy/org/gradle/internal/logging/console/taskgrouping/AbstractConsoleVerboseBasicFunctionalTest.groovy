...
import static org.gradle.api.logging.configuration.ConsoleOutput.PlainWithColor
...
abstract class AbstractConsoleVerboseBasicFunctionalTest extends AbstractConsoleGroupedTaskFunctionalTest {
    def "can have verbose task output according to --console"() {
        ...
        def hasSilenceTaskOutput = consoleType in [Verbose, Plain, PlainWithColor] || consoleType == Auto && !consoleAttachment.stdoutAttached
