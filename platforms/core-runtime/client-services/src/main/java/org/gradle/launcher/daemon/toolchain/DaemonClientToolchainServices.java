...
public class DaemonClientToolchainServices implements ServiceRegistrationProvider {
    ...
    protected JavaToolchainQueryService createJavaToolchainQueryService(
        ...
        ExternalResourceFactory externalResourceFactory = new DaemonToolchainExternalResourceFactory(fileSystem, listenerManager, redirectVerifierFactory, httpClientFactory, progressLoggerFactory, clock, operationIdFactory, buildProgressListener);
