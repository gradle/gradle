...
public abstract class DaemonClientServicesSupport implements ServiceRegistrationProvider {
    ...
    @Provides
    JvmMetadataDetector createJvmMetadataDetector(ClientExecHandleFactory execHandleFactory, TemporaryFileProvider temporaryFileProvider, GlobalScopedCacheBuilderFactory globalScopedCacheBuilderFactory) {
