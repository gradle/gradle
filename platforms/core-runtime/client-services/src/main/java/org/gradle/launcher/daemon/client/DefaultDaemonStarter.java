...
public class DefaultDaemonStarter implements DaemonStarter {
    ...
    public DaemonStartupInfo startDaemon(boolean singleUse) {
        ...
        if (criteria instanceof DaemonJvmCriteria.Spec) {
            ...
            resolvedJvm = jvmDetector.getValidJvm(((DaemonJvmCriteria.JavaHome) criteria).getJavaHome());
        ...
        UnsupportedJavaRuntimeException.assertIsSupportedDaemonJvmVersion(resolvedJvm.getJavaVersion());
