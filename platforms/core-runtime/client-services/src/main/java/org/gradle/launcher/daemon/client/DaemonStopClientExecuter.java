...
public class DaemonStopClientExecuter {
    ...
    public DaemonStopClientExecuter(ServiceRegistry loggingServices, DaemonClientFactory daemonClientFactory, DaemonParameters daemonParameters) {
        this.loggingServices = loggingServices;
        this.daemonClientFactory = daemonClientFactory;
        this.daemonParameters = daemonParameters;
    }

    public void execute(Consumer<DaemonStopClient> action) {
        ServiceRegistry clientServices = daemonClientFactory.createMessageDaemonServices(loggingServices, daemonParameters);
        try {
