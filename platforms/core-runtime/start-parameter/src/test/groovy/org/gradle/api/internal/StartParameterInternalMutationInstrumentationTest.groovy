...
class StartParameterInternalMutationInstrumentationTest extends Specification {
    ...
    private static final List<String> NOTIFYING = [
        ...
        "includeBuild(File)",
        "setArtifactTransformsPerScopeVariantCache(boolean)",
        ...
        "setConfigurationCacheIgnoreInputsDuringStore(Value)",
        "setConfigurationCacheIgnoreUnsupportedBuildEventsListeners(Value)",
        ...
        "setConfigurationCacheSkipTaskLoggingListenersSerialization(Value)",
        ...
        "setSharedMavenMirrorSettings(boolean)",
    ...
    private static final List<String> READS = [
        ...
        "getConfigurationCacheIgnoreInputsDuringStore()",
        "getConfigurationCacheIgnoreUnsupportedBuildEventsListeners()",
        "getConfigurationCacheIgnoredFileSystemCheckInputs()",
        "getConfigurationCacheMaxProblems()",
        "getConfigurationCacheProblems()",
        "getConfigurationCacheSkipTaskLoggingListenersSerialization()",
        "getConsoleOutput()",
        ...
        "hashCode()",
        "isArtifactTransformsPerScopeVariantCache()",
