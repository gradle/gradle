...
public enum BytecodeInterceptorFilter {
    ...
    INSTRUMENTATION_AND_BYTECODE_REPORT(
            EnumSet.of(BytecodeInterceptorType.INSTRUMENTATION, BytecodeInterceptorType.BYTECODE_UPGRADE_REPORT)),
    INSTRUMENTATION_AND_BYTECODE_UPGRADE(
            EnumSet.of(BytecodeInterceptorType.INSTRUMENTATION, BytecodeInterceptorType.BYTECODE_UPGRADE)),
    ALL(EnumSet.of(
            BytecodeInterceptorType.INSTRUMENTATION,
