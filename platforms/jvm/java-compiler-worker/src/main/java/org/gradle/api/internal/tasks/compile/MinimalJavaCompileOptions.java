...
public class MinimalJavaCompileOptions implements Serializable {
    ...
    private MinimalCompilerDaemonDebugOptions debugOptions;
    ...
    public void setSourcepath(@Nullable List<File> sourcepath) {
    ...
    public void setDebugOptions(MinimalCompilerDaemonDebugOptions debugOptions) {
