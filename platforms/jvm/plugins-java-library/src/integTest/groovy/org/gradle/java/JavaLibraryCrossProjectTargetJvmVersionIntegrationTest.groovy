...
class JavaLibraryCrossProjectTargetJvmVersionIntegrationTest extends AbstractIntegrationSpec {
  ...
  - Variant 'apiElements' declares the public API view of a library for use during compile-time, packaged as a jar, and its dependencies declared externally:
  ...
  - Variant 'privateApiElements' declares the private API view of a library for use during compile-time, packaged as a jar, and its dependencies declared externally:
      - Incompatible because this component declares a component, compatible with Java 7 and the consumer needed a component, compatible with Java 6
      - Other compatible attribute:
          - Doesn't say anything about its target Java environment (preferred optimized for standard JVMs)
                ...
                configurations {
                    "apiElementsJdk\${v}" {
                        ...
                        attributes {
                            ...
                            attribute(ApiView.VIEW_ATTRIBUTE, objects.named(ApiView, ApiView.PUBLIC))
