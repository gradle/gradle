...
class PmdPluginVersionIntegrationTest extends AbstractPmdPluginVersionIntegrationTest {
    ...
    def "analyze bad code"() {
        ...
        expect:
        fails("check")
        failure.assertHasDescription("Execution failed for task ':pmdTest' (created in build file 'build.gradle').")
...
"""
    ...
    def "use custom rule set files"() {
        ...
        expect:
        fails("pmdMain")
        failure.assertHasDescription("Execution failed for task ':pmdMain' (created in build file 'build.gradle').")
