...
class CodeNarcPluginTest extends AbstractProjectBuilderSpec {
    ...
    def "adds codenarc extension"() {
        ...
        codenarc.reportsDirectory.asFile.get() == project.file("build/reports/codenarc")
    ...
    def "configures any additional codenarc tasks"() {
        ...
        repo.module("org.codenarc", "CodeNarc", CodeNarcPlugin.DEFAULT_CODENARC_VERSION).publish()
