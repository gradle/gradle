...
class ClassSetAnalysisDataSerializerTest extends Specification {
    ...
    def "serializes"() {
        def data = new ClassSetAnalysisData(["A": hash, "B": hash, "C": hash, "D": hash],
            [
                "A": dependentClasses(PersistentSet.of("B", "C"), PersistentSet.of()),
                "B": dependentClasses(PersistentSet.of("C"), PersistentSet.of()),
                "C": dependentClasses(PersistentSet.of(), PersistentSet.of()),
                "D": dependencyToAll("reason"),
            ],
