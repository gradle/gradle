...
public class AntJacocoCheck implements Action<AntBuilderDelegate> {
    ...
    public void execute(AntBuilderDelegate antBuilder) {
        ...
        try {
            antBuilder.invokeMethod("jacocoReport", new Object[] {
                Collections.emptyMap(),
                new Closure<Object>(this, this) {
                    @SuppressWarnings("unused") // Magic Groovy method
                    public Object doCall(Object ignore) {
                        antBuilder.invokeMethod("executiondata", new Object[] {
                            emptyArgs,
                            new Closure<Object>(this, this) {
                                @SuppressWarnings("unused") // Magic Groovy method
                                public Object doCall(Object ignore) {
                                    params.getExecutionData()
                                            .filter(File::exists)
                                            .addToAntBuilder(antBuilder, "resources");
                                    return Void.class;
                                }
                            }
                        });
                        Map<String, Object> structureArgs = ImmutableMap.<String, Object>of(
                                "name", params.getProjectName().get());
                        antBuilder.invokeMethod("structure", new Object[] {
                            structureArgs,
                            new Closure<Object>(this, this) {
                                @SuppressWarnings("unused") // Magic Groovy method
                                public Object doCall(Object ignore) {
                                    antBuilder.invokeMethod("classfiles", new Object[] {
                                        emptyArgs,
                                        new Closure<Object>(this, this) {
                                            @SuppressWarnings("unused") // Magic Groovy method
                                            public Object doCall(Object ignore) {
                                                params.getAllClassesDirs()
                                                        .filter(File::exists)
                                                        .addToAntBuilder(antBuilder, "resources");
                                                return Void.class;
                                            }
                                    ...
                                    antBuilder.invokeMethod("sourcefiles", new Object[] {
                                        sourcefilesArgs,
                                        new Closure<Object>(this, this) {
                                            @SuppressWarnings("unused") // Magic Groovy method
                                            public Object doCall(Object ignore) {
                                                params.getAllSourcesDirs()
                                                        .filter(File::exists)
                                                        .addToAntBuilder(antBuilder, "resources");
                                                return Void.class;
                                            }
                        ...
                        Set<JacocoViolationRule> rules =
                                filter(params.getRules().get(), RULE_ENABLED_PREDICATE);
                        if (!rules.isEmpty()) {
                            Map<String, Object> checkArgs = ImmutableMap.<String, Object>of(
                                    "failonviolation",
                                    params.getFailOnViolation().get(),
                                    "violationsproperty",
                                    VIOLATIONS_ANT_PROPERTY);

                            antBuilder.invokeMethod("check", new Object[] {
                                checkArgs,
                                new Closure<Object>(this, this) {
                                    @SuppressWarnings("unused") // Magic Groovy method
                                    public Object doCall(Object ignore) {
                                        for (final JacocoViolationRule rule : rules) {
                                            Map<String, Object> ruleArgs = ImmutableMap.<String, Object>of(
                                                    ...
                                                    rule.getElement(),
                                                    "includes",
                                                    Joiner.on(':').join(rule.getIncludes()),
                                                    "excludes",
                                                    Joiner.on(':').join(rule.getExcludes()));
                                            antBuilder.invokeMethod("rule", new Object[] {
                                                ruleArgs,
                                                new Closure<Object>(this, this) {
                                                    @SuppressWarnings("unused") // Magic Groovy method
                                                    public Object doCall(Object ignore) {
                                                        for (JacocoLimit limit : rule.getLimits()) {
                                                            Map<String, Object> limitArgs =
                                                            ...
                                                            antBuilder.invokeMethod(
                                                                    "limit",
                                                                    new Object[] {ImmutableMap.copyOf(limitArgs)});
                                                        }
                                                        return Void.class;
                                                    }
                                                }
