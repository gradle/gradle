...
public class ToolchainsJvmServices extends AbstractGradleModuleServices {
    protected static class BuildServices implements ServiceRegistrationProvider {
        ...
        @Provides
        protected JdkCacheDirectory createJdkCacheDirectory(ObjectFactory objectFactory, GradleUserHomeDirProvider homeDirProvider, FileOperations operations, FileLockManager lockManager, ClientExecHandleFactory execHandleFactory, GradleUserHomeTemporaryFileProvider temporaryFileProvider) {
