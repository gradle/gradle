...
import static org.gradle.testing.fixture.JUnitCoverage.getLATEST_JUNIT6_VERSION
import static org.hamcrest.Matchers.equalTo

class JUnit6JupiterParameterizedClassIntegrationTest extends JUnitPlatformIntegrationSpec {
    @Override
    String getJupiterVersion() {
        return LATEST_JUNIT6_VERSION
    }
