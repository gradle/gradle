...
abstract class AbstractJUnitCategoriesOrTagsCoverageIntegrationSpec extends AbstractTestingMultiVersionIntegrationTest {
    ...
    def "can exclude categories or tags only"() {
        ...
        results.testPath('SomeOtherCatTests').onlyRoot()
            ...
            .assertChildrenExecuted(maybeParentheses('someOtherOk1'), maybeParentheses('someOtherOk2'))
        results.testPath("NoCatTests").onlyRoot()
            .assertChildCount(2, 0)
            .assertChildrenExecuted(maybeParentheses('noCatOk1'), maybeParentheses('noCatOk2'))
        results.testPath("SomeTests").onlyRoot()
            .assertChildCount(3, 0)
            .assertChildrenExecuted(maybeParentheses('noCatOk3'), maybeParentheses('noCatOk4'), maybeParentheses('someOtherCatOk2'))
    }
    ...
    def "can include categories or tags only"() {
        ...
        results.testPath('CategoryATests').onlyRoot()
            ...
            .assertChildrenExecuted(maybeParentheses('catAOk1'), maybeParentheses('catAOk2'), maybeParentheses('catAOk3'), maybeParentheses('catAOk4'))
        results.testPath("SomeTests").onlyRoot().assertChildCount(1, 0)
        results.testPath("SomeTests").onlyRoot().assertChildrenExecuted(maybeParentheses('catAOk1'))
    }
