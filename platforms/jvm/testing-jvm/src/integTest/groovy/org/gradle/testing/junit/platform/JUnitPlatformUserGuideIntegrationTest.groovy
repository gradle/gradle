...
'''
        ...
        result.testPath(':org.gradle.TestingAStackDemo:org.gradle.TestingAStackDemo$WhenNew').onlyRoot()
            .assertChildCount(3, 0)
            .assertChildrenExecuted('isEmpty()', 'throwsExceptionWhenPopped()')
        result.testPath(':org.gradle.TestingAStackDemo:org.gradle.TestingAStackDemo$WhenNew:org.gradle.TestingAStackDemo$WhenNew$AfterPushing').onlyRoot()
            .assertChildCount(1, 0)
...
'''
        ...
        results.testPath('org.gradle.Test').onlyRoot()
            .assertChildCount(1, 0)
        results.testPath(':org.gradle.Test:dynamicTestsFromCollection()').onlyRoot()
            .assertChildCount(2, 0)
...
'''
        ...
        results.testPath('org.gradle.Test').onlyRoot()
            .assertChildCount(1, 0)
        results.testPath(':org.gradle.Test:ok(String)').onlyRoot()
            .assertChildCount(3, 0)
...
'''
        ...
        results.testPath('org.gradle.TestTemplateTest').onlyRoot()
            .assertChildCount(1, 0)
        results.testPath(':org.gradle.TestTemplateTest:testTemplate(String)').onlyRoot()
            .assertChildCount(2, 0)
