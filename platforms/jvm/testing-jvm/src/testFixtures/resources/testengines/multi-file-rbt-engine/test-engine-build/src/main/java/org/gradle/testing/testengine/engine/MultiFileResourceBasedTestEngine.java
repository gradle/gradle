...
public class MultiFileResourceBasedTestEngine implements TestEngine {
    public static final Logger LOGGER = LoggerFactory.getLogger(MultiFileResourceBasedTestEngine.class);

    public static final String ENGINE_ID = "multi-file-rbt-engine";
    public static final String ENGINE_NAME = "Multi-File Resource Based Test Engine";
    ...
    public TestDescriptor discover(EngineDiscoveryRequest discoveryRequest, UniqueId uniqueId) {
        ...
        EngineDiscoveryRequestResolver.builder()
            .addSelectorResolver(new MultiFileResourceBasedSelectorResolver())
            .build()
