...
public class MatchesNothingTestEngine implements TestEngine {
    public static final Logger LOGGER = LoggerFactory.getLogger(MatchesNothingTestEngine.class);

    public static final String ENGINE_ID = "matches-nothing-engine";
    public static final String ENGINE_NAME = "Matches Nothing Test Engine";
    ...
    public TestDescriptor discover(EngineDiscoveryRequest discoveryRequest, UniqueId uniqueId) {
        ...
        EngineDiscoveryRequestResolver.builder()
            .addSelectorResolver(new MatchesNothingSelectorResolver())
            .build()
