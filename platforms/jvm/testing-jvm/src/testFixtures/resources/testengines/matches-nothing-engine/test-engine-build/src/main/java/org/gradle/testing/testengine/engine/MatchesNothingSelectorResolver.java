...
public class MatchesNothingSelectorResolver implements SelectorResolver {
    public static final Logger LOGGER = LoggerFactory.getLogger(MatchesNothingSelectorResolver.class);
