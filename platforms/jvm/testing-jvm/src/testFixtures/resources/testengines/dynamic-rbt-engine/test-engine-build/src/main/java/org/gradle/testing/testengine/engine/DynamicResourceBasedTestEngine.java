...
public class DynamicResourceBasedTestEngine implements TestEngine {
    public static final Logger LOGGER = LoggerFactory.getLogger(DynamicResourceBasedTestEngine.class);

    public static final String ENGINE_ID = "dynamic-rbt-engine";
    public static final String ENGINE_NAME = "Resource Based Test Engine (Dynamic)";
    ...
    public TestDescriptor discover(EngineDiscoveryRequest discoveryRequest, UniqueId uniqueId) {
        ...
        EngineDiscoveryRequestResolver.builder()
            .addSelectorResolver(new ResourceBasedSelectorResolver(true))
            .build()
