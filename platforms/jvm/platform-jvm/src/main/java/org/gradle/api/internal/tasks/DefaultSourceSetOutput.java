...
public abstract class DefaultSourceSetOutput extends CompositeFileCollection implements SourceSetOutput {
    ...
    private DirectoryProperty resourcesDirectory;
    ...
    @Inject
    public DefaultSourceSetOutput(String sourceSetDisplayName, TaskDependencyFactory taskDependencyFactory, FileResolver fileResolver, FileCollectionFactory fileCollectionFactory, FileFactory fileFactory, ObjectFactory objectFactory) {
