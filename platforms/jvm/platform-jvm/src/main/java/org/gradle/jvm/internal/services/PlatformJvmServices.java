...
public class PlatformJvmServices extends AbstractGradleModuleServices {
    ...
    public void registerProjectServices(ServiceRegistration registration) {
        registration.addProvider(new ServiceRegistrationProvider() {
            @Provides
            ManifestFactory createManifestFactory(ProviderFactory providerFactory, FileResolver fileResolver) {
                return new DefaultManifestFactory(providerFactory, fileResolver);
            }
        });
    }
}
