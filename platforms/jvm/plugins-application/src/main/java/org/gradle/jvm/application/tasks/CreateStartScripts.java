 ...
 * <li>{@code mainClassName} - The main class name, or usually {@code null} if none. For legacy reasons, this may be set to {@code --module [moduleEntryPoint]} when using a main module.
