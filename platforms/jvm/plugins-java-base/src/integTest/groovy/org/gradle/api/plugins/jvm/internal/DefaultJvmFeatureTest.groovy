...
class DefaultJvmFeatureTest extends AbstractProjectBuilderSpec {
    ...
    def "can create a single main feature with a main source set"() {
        ...
        feature.privateApiElementsConfiguration == project.configurations.getByName(JvmConstants.PRIVATE_API_ELEMENTS_CONFIGURATION_NAME)
    ...
    def "can create a single non-main feature with a non-main source set"() {
        ...
        feature.privateApiElementsConfiguration == project.configurations.getByName('featurePrivateApiElements')
