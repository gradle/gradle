...
public abstract class DefaultJavaPluginConvention extends org.gradle.api.plugins.JavaPluginConvention implements HasPublicType {
    ...
    public TypeOf<?> getPublicType() {
        return typeOf(org.gradle.api.plugins.JavaPluginConvention.class);
    }
