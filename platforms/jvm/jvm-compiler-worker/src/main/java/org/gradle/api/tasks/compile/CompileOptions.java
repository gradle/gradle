...
public abstract class CompileOptions implements Serializable {
    ...
    @Optional
    @Input
    public abstract Property<String> getJavaModuleVersion();
    ...
    @Optional
    @Input
    public abstract Property<String> getJavaModuleMainClass();
    ...
    @Optional
    @OutputDirectory
    public abstract DirectoryProperty getHeaderOutputDirectory();
