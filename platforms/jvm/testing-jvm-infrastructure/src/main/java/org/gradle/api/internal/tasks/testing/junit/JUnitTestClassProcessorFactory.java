 ...
 */
class JUnitTestClassProcessorFactory implements WorkerTestClassProcessorFactory<ClassTestDefinition>, Serializable {
    private final JUnitSpec spec;

    public JUnitTestClassProcessorFactory(JUnitSpec spec) {
        this.spec = spec;
    }
