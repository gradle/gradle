...
public class FileBasedInstallationFactory {
    ...
    public static Set<InstallationLocation> fromDirectory(
            File rootDirectory, String supplierName, BiFunction<File, String, InstallationLocation> locationFactory) {
