...
class IntellijInstallationSupplierTest extends Specification {
    ...
    @Subject
    def supplier = new IntellijInstallationSupplier(toolchainConfiguration)
    ...
    def "supplies single installations for single candidate"() {
        given:
        def expectedLocation = candidates.createDir("11.0.6.hs-adpt")
    ...
    def "supplies multiple installations for multiple paths"() {
        ...
        directories*.source.unique() == ["IntelliJ"]
    }
}
