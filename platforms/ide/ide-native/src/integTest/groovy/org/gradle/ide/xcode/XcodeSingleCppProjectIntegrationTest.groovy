...
class XcodeSingleCppProjectIntegrationTest extends AbstractXcodeIntegrationSpec {
    ...
    def "can build C++ executable from Xcode"() {
        ...
        then:
        resultDebug.assertTasksScheduled(':compileDebugCpp', ':linkDebug', ':installDebug', ':_xcode___App_Debug')
        ...
        then:
        resultRelease.assertTasksScheduled(':compileReleaseCpp', ':linkRelease', ':stripSymbolsRelease', ':installRelease', ':_xcode___App_Release')
    ...
    def "can build C++ executable from Xcode with multiple architecture"() {
        ...
        then:
        resultDebug.assertTasksScheduled(':compileDebugX86-64Cpp', ':linkDebugX86-64', ':installDebugX86-64', ':_xcode___App_DebugX86-64')
        ...
        then:
        resultRelease.assertTasksScheduled(':compileReleaseX86-64Cpp', ':linkReleaseX86-64', ':stripSymbolsReleaseX86-64', ':installReleaseX86-64', ':_xcode___App_ReleaseX86-64')
...
"""
        ...
        then:
        resultDebug.assertTasksScheduled(':compileDebugCpp', ':linkDebug', ':_xcode___App_Debug')
        ...
        then:
        resultRelease.assertTasksScheduled(':compileReleaseCpp', ':linkRelease', ':stripSymbolsRelease', ':_xcode___App_Release')
    ...
    def "can build C++ library from Xcode with multiple architecture"() {
        ...
        then:
        resultDebug.assertTasksScheduled(':compileDebugX86-64Cpp', ':linkDebugX86-64', ':_xcode___App_DebugX86-64')
        ...
        then:
        resultRelease.assertTasksScheduled(':compileReleaseX86-64Cpp', ':linkReleaseX86-64', ':stripSymbolsReleaseX86-64', ':_xcode___App_ReleaseX86-64')
