...
class WeakIdentityHashMapTest extends Specification {
    ...
    def "equals() and hashCode() should be consistent"() {
        ...
        // Verify: When both WeakKeys have null referents, equals() returns true but hashCodes differ
        boolean equals = weakKey1.equals(weakKey2)
        boolean hashCodeEqual = weakKey1.hashCode() == weakKey2.hashCode()
