...
public class DefaultProblemsSummaries implements ProblemsSummaries {
    private final List<ProblemSummary> problemIdSummaries;

    public DefaultProblemsSummaries(List<ProblemSummary> problemIdSummaries) {
