...
public class PingConsumerConnection extends StopWhenIdleConsumerConnection {
    public PingConsumerConnection(
        ConnectionVersion4 delegate,
    ...
    public void ping(ConsumerOperationParameters operationParameters) {
        ((InternalPingConnection) getDelegate()).ping(operationParameters);
    }
}
