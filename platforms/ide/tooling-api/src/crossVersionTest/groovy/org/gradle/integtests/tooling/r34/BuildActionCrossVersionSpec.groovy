...
class BuildActionCrossVersionSpec extends ToolingApiSpecification {
    ...
    def "can load custom action from url containing whitespaces"() {
        ...
        def builder = new GradleBackedArtifactBuilder(new NoDaemonGradleExecuter(targetDist, temporaryFolder).withWarningMode(null), temporaryFolder.testDirectory.file("action"))
