...
/**
 * Verifies JDK compatibility for tooling api when configuring the daemon JVM via toolchains.
 */
class DaemonToolchainsBuildJvmCrossVersionSpec extends ExplicitDaemonJvmCrossVersionSpec {
    ...
    void configureLauncher(ConfigurableLauncher<? extends ConfigurableLauncher> launcher, Jvm jvm) {
        launcher.withArguments("-Porg.gradle.java.installations.paths=" + jvm.javaHome.canonicalPath)
    }
