...
class ToolingApiEclipseModelClasspathContainerCrossVersionSpec extends ToolingApiSpecification {
    ...
    private void maybeExpectJavaRuntimeNameDeprecation() {
        // javaRuntimeName was deprecated in 9.6 and un-deprecated in 9.8
        if (targetVersion.baseVersion >= GradleVersion.version("9.6") && targetVersion.baseVersion < GradleVersion.version("9.8")) {
