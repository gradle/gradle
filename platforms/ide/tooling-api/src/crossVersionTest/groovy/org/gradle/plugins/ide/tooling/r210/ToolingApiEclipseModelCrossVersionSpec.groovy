...
class ToolingApiEclipseModelCrossVersionSpec extends ToolingApiSpecification {
    ...
    @Requires(value = [IntegTestPreconditions.Java8HomeAvailable, IntegTestPreconditions.Java17HomeAvailable])
    def "Java project returns default source compatibility"() {
        ...
        where:
        jvm << [AvailableJavaHomes.jdk8, AvailableJavaHomes.jdk17] // FIXME: theese need to render nicer for TC test comparisons
    }
