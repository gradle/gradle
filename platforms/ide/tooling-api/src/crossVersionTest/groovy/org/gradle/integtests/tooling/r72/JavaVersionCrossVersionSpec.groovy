...
class JavaVersionCrossVersionSpec extends ToolingApiSpecification {
    ...
    @Requires([JdkVersionTestPreconditions.Jdk11OrLater, InstalledJdkTestPreconditions.Java8HomeAvailable])
    ...
    @Requires([JdkVersionTestPreconditions.Jdk8OrEarlier, InstalledJdkTestPreconditions.Java11HomeAvailable])
