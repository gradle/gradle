...
import static org.gradle.integtests.tooling.r89.ProblemProgressEventCrossVersionSpec.failureMessage

@ToolingApiVersion(">=8.12")
@TargetGradleVersion(">=8.12")
class ProblemThresholdCrossVersionSpec extends ToolingApiSpecification {
