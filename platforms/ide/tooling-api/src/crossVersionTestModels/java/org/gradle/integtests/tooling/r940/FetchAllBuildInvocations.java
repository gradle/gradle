 ...
 */
class FetchAllBuildInvocations implements BuildAction<AllBuildInvocationsResult>, Serializable {
    @Override
    public AllBuildInvocationsResult execute(BuildController controller) {
        ...
        List<BuildInvocations> includedInvocations = new ArrayList<>();
