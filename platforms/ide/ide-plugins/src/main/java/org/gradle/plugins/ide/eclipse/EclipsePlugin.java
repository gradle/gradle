...
public abstract class EclipsePlugin extends IdePlugin {
    ...
    protected void onApply(Project project) {
        getLifecycleTask().configure(IdePlugin.withDescription("Generates all Eclipse files."));
        getCleanTask().configure(IdePlugin.withDescription("Cleans all Eclipse files."));
