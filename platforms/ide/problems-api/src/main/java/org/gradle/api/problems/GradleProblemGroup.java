 ...
 * plugins with Gradle.
 * <p>
 * This group is closed: it is not possible to create additional sub-groups below it or below its sub-groups, which are
 * {@link GradleSecondLevelProblemGroup}s. Problems can be reported into any of its sub-groups and into {@link #getUndefined()}.
 * <p>
 * Gradle reports its own deprecations under a {@code Deprecation} sub-group of this group. That sub-group is reserved for
 * Gradle and not available here; consumers identify it, like any group, by its name path.
 * <p>
...
public abstract class GradleProblemGroup extends ProblemGroup {
     ...
     * @since 9.9.0
     */
    public abstract GradleSecondLevelProblemGroup getBuildCache();
     ...
     * @since 9.9.0
     */
    public abstract GradleSecondLevelProblemGroup getBuildDefinition();
     ...
     * @since 9.9.0
     */
    public abstract GradleSecondLevelProblemGroup getBuildLogic();
     ...
     * @since 9.9.0
     */
    public abstract GradleSecondLevelProblemGroup getConfigurationCache();
     ...
     * @since 9.9.0
     */
    public abstract GradleSecondLevelProblemGroup getDslEvaluation();
     ...
     * @since 9.9.0
     */
    public abstract GradleSecondLevelProblemGroup getInvocation();
     ...
     * @since 9.9.0
     */
    public abstract GradleSecondLevelProblemGroup getIsolatedProjects();
     ...
     * @since 9.9.0
     */
    public abstract GradleSecondLevelProblemGroup getPluginValidation();
