...
class DefaultDeprecationBuilder implements DeprecateSpec, DeprecatePluginSpec, DeprecateMethodSpec {
    ...
    @Override
    public DeprecateSpec details(String reason) {
        builder.details(reason);
        return this;
    }

    @Override
    public DeprecateSpec documentedAt(DocLink link) {
        builder.documentedAt(link);
        return this;
    }

    @Override
    public DeprecateSpec documentedAt(String url) {
        builder.documentedAt(url);
        return this;
    }
