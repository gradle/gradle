...
public abstract class PackagingProblemGroup extends RootProblemGroup {
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getDistributions();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getJar();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getNativeLinking();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getSigning();
}
