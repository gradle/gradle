...
public abstract class CompilationProblemGroup extends RootProblemGroup {
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getCpp();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getGroovy();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getJava();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getKotlin();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getScala();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getSwift();
}
