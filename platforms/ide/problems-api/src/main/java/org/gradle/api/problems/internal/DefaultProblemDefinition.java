...
public class DefaultProblemDefinition implements Serializable, ProblemDefinition {
    ...
    public boolean equals(Object o) {
        ...
        return severity == that.severity && equal(id, that.id) && equal(documentationLink, that.documentationLink);
    }
    ...
    public String toString() {
        return "DefaultProblemDefinition{" + "id="
                + id + ", severity="
                + severity + ", documentationLink="
                + documentationLink + '}';
    }
}
