...
public abstract class GradleCoreProblemGroup {
    ...
    private static final ProblemGroup DEPENDENCY_RESOLUTION_PROBLEM_GROUP = ProblemGroup.create("dependency-resolution", "Dependency resolution");
    ...
    public static ProblemGroup dependencyResolution() {
        return DEPENDENCY_RESOLUTION_PROBLEM_GROUP;
    }
