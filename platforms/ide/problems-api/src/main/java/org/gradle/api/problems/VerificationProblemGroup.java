...
public abstract class VerificationProblemGroup extends RootProblemGroup {
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getCodeCoverage();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getCodeQuality();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getSecurity();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getTesting();
}
