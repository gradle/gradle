...
public abstract class TransformationProblemGroup extends RootProblemGroup {
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getBinaryTransformation();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getCodeTransformation();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getResourceTransformation();
}
