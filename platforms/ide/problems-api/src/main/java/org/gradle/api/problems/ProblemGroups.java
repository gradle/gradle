 ...
 *     {@code problems.getGroups().getCompilation().getJava().problemId("Unused import")}.</li>
 *     <li>If no predefined sub-group matches, create one with {@link RootProblemGroup#group(String)}, for example
 *     {@code problems.getGroups().getTransformation().group("KMP").problemId("...")}, or use the {@code Undefined} sub-group.</li>
