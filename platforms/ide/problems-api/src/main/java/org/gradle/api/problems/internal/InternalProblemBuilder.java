...
public interface InternalProblemBuilder extends InternalProblemSpec {
    ...
    /**
     * Creates the new problem. Calling this method won't report the problem via build operations, it can be done separately by calling {@link InternalProblemReporter#report(Problem)}.
     *
