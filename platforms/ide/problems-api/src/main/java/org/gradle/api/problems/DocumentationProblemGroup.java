...
public abstract class DocumentationProblemGroup extends RootProblemGroup {
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getJavadoc();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getGroovydoc();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getScaladoc();
}
