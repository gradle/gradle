...
public interface Problems {
     ...
     * {@code getGroups().getCompilation().getJava().problemId("Unused import")}. The groups and the ids created from them
     * are stable values; create them once and reuse them at every report site.
     *
