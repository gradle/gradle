...
public abstract class DependenciesProblemGroup extends RootProblemGroup {
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getDeclaration();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getLocking();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getGraphResolution();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getArtifactResolution();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getVerification();
}
