...
public abstract class ExternalProcessesProblemGroup extends RootProblemGroup {
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getApplication();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getService();
     ...
     * @since 9.9.0
     */
    public abstract SecondLevelProblemGroup getTool();
}
