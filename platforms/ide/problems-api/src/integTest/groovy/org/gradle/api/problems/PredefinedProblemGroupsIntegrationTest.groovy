...
class PredefinedProblemGroupsIntegrationTest extends AbstractIntegrationSpec {
    ...
    def "can report a problem into a sub-group of the closed Gradle root group"() {
        given:
        withReportProblemTask """
            problems.reporter.report(problems.groups.gradle.buildDefinition.problemId("Deprecated plugin applied")) {}
        """
        ...
        then:
        receivedProblem.definition.id.fqid == "Gradle:Build Definition:Deprecated plugin applied"
    }
