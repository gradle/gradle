...
final class PredefinedDocumentationProblemGroup extends DocumentationProblemGroup implements ResolvableProblemGroup, Serializable {
    ...
    private final DefaultSecondLevelProblemGroup javadoc = new DefaultSecondLevelProblemGroup("Javadoc", PredefinedProblemGroupDescriptions.DOCUMENTATION_JAVADOC, this);
    private final DefaultSecondLevelProblemGroup groovydoc = new DefaultSecondLevelProblemGroup("Groovydoc", PredefinedProblemGroupDescriptions.DOCUMENTATION_GROOVYDOC, this);
    private final DefaultSecondLevelProblemGroup scaladoc = new DefaultSecondLevelProblemGroup("Scaladoc", PredefinedProblemGroupDescriptions.DOCUMENTATION_SCALADOC, this);
    ...
    @Override
    public SecondLevelProblemGroup getJavadoc() {
        return javadoc;
    }

    @Override
    public SecondLevelProblemGroup getGroovydoc() {
        return groovydoc;
    }

    @Override
    public SecondLevelProblemGroup getScaladoc() {
        return scaladoc;
    }
