...
final class PredefinedExternalProcessesProblemGroup extends ExternalProcessesProblemGroup implements ResolvableProblemGroup, Serializable {
    ...
    private final DefaultSecondLevelProblemGroup application = new DefaultSecondLevelProblemGroup("Application", PredefinedProblemGroupDescriptions.EXTERNAL_PROCESSES_APPLICATION, this);
    private final DefaultSecondLevelProblemGroup service = new DefaultSecondLevelProblemGroup("Service", PredefinedProblemGroupDescriptions.EXTERNAL_PROCESSES_SERVICE, this);
    private final DefaultSecondLevelProblemGroup tool = new DefaultSecondLevelProblemGroup("Tool", PredefinedProblemGroupDescriptions.EXTERNAL_PROCESSES_TOOL, this);
    ...
    @Override
    public SecondLevelProblemGroup getApplication() {
        return application;
    }

    @Override
    public SecondLevelProblemGroup getService() {
        return service;
    }

    @Override
    public SecondLevelProblemGroup getTool() {
        return tool;
    }
