...
final class PredefinedVerificationProblemGroup extends VerificationProblemGroup implements ResolvableProblemGroup, Serializable {
    ...
    private final DefaultSubProblemGroup codeCoverage = new DefaultSubProblemGroup("Code Coverage", PredefinedProblemGroupDescriptions.VERIFICATION_CODE_COVERAGE, this);
    private final DefaultSubProblemGroup codeQuality = new DefaultSubProblemGroup("Code Quality", PredefinedProblemGroupDescriptions.VERIFICATION_CODE_QUALITY, this);
    private final DefaultSubProblemGroup security = new DefaultSubProblemGroup("Security", PredefinedProblemGroupDescriptions.VERIFICATION_SECURITY, this);
    private final DefaultSubProblemGroup testing = new DefaultSubProblemGroup("Testing", PredefinedProblemGroupDescriptions.VERIFICATION_TESTING, this);
    ...
    @Override
    public SubProblemGroup getCodeCoverage() {
        return codeCoverage;
    }

    @Override
    public SubProblemGroup getCodeQuality() {
        return codeQuality;
    }

    @Override
    public SubProblemGroup getSecurity() {
        return security;
    }

    @Override
    public SubProblemGroup getTesting() {
        return testing;
    }
