...
/**
 * The predefined {@code Others} root group. Singleton, reachable through {@link DefaultProblemGroups}.
 */
final class PredefinedOthersProblemGroup extends OthersProblemGroup implements ResolvableProblemGroup, Serializable {

    static final String NAME = "Others";

    private final DefaultLeafProblemGroup undefined = DefaultLeafProblemGroup.undefined(this, NAME);
    private final PredefinedChildren children = new PredefinedChildren(undefined);
    ...
    public String getDescription() {
        return PredefinedProblemGroupDescriptions.OTHERS;
    }
