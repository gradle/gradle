...
final class PredefinedDeliveryProblemGroup extends DeliveryProblemGroup implements ResolvableProblemGroup, Serializable {
    ...
    private final DefaultSecondLevelProblemGroup publishing = new DefaultSecondLevelProblemGroup("Publishing", PredefinedProblemGroupDescriptions.DELIVERY_PUBLISHING, this);
    private final DefaultSecondLevelProblemGroup deployment = new DefaultSecondLevelProblemGroup("Deployment", PredefinedProblemGroupDescriptions.DELIVERY_DEPLOYMENT, this);
    ...
    @Override
    public SecondLevelProblemGroup getPublishing() {
        return publishing;
    }

    @Override
    public SecondLevelProblemGroup getDeployment() {
        return deployment;
    }
