...
class ProblemRendererTest extends Specification {
    ...
    private static ProblemGroup getLevel0Group() {
        return IdFactory.instance().createProblemGroup("test-group-0", "Test group level 0", null);
    }

    private static ProblemGroup getLevel1Group() {
        return IdFactory.instance().createProblemGroup("test-group-1", "Test group level 1", getLevel0Group());
    }
}
