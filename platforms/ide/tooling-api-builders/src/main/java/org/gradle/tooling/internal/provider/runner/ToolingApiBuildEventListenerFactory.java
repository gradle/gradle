...
public class ToolingApiBuildEventListenerFactory implements BuildEventListenerFactory {
    ...
    private ClientBuildEventGenerator createClientBuildEventGenerator(
        ...
        ProjectConfigurationTracker projectConfigurationTracker =
                new ProjectConfigurationTracker(ancestryTracker, pluginApplicationTracker);
        ...
        TaskOperationMapper taskOperationMapper =
                new TaskOperationMapper(postProcessors, taskOriginTracker, operationDependenciesResolver);
    ...
    private List<OperationResultPostProcessor> createPostProcessors(
            BuildEventSubscriptions subscriptions, BuildEventConsumer consumer) {
    ...
    private BuildOperationListener createBuildOperationListener(
            BuildEventSubscriptions subscriptions, ProgressEventConsumer progressEventConsumer) {
        // TODO (donat) think of a better name for this class
        return new ClientForwardingBuildOperationListener(
                progressEventConsumer, subscriptions, () -> new OperationIdentifier(idFactory.nextId()));
    }
}
