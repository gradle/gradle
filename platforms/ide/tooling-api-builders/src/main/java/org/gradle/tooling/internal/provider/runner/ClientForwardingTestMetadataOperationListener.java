...
import org.gradle.internal.build.event.types.DefaultReportMetadataEvent;
...
/* package */ class ClientForwardingTestMetadataOperationListener implements BuildOperationListener {
    ...
    public void progress(OperationIdentifier buildOperationId, OperationProgressEvent progressEvent) {
        ...
        if (details instanceof ExecuteTestBuildOperationType.Metadata) {
            ...
            // TODO (donat) we should handle file events here
            DefaultTestMetadataEvent event = new DefaultReportMetadataEvent(progressEvent.getTime(), descriptor, metadataMetadataEvent.getValues(), metadataMetadataEvent.getLogTime());
