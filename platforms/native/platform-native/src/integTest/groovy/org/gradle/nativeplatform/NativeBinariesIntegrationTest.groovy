...
"""
        ...
        then:
        failure.assertHasDescription("Execution failed for task ':linkMainSharedLibrary' (created in build file 'build.gradle').");
        failure.assertHasCause("A build operation failed.")
...
"""
        ...
        then:
        failure.assertHasDescription("Execution failed for task ':createMainStaticLibrary' (created in build file 'build.gradle').");
        failure.assertHasCause("A build operation failed.")
