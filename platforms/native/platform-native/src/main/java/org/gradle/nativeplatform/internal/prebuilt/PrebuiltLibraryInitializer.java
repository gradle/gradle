...
public class PrebuiltLibraryInitializer implements Action<PrebuiltLibrary> {
    ...
    public void createNativeBinaries(
            ...
            FileCollectionFactory fileCollectionFactory) {
        createNativeBinary(
                DefaultPrebuiltSharedLibraryBinary.class,
                "shared",
                library,
                platform,
                buildType,
        ...
        createNativeBinary(
                DefaultPrebuiltStaticLibraryBinary.class,
                "static",
                library,
                platform,
                buildType,
    ...
    public <T extends NativeLibraryBinary> void createNativeBinary(
        ...
        T nativeBinary =
                instantiator.newInstance(type, name, library, buildType, platform, flavor, fileCollectionFactory);
        library.getBinaries().add(nativeBinary);
    }

    private String getName(
            String typeName, PrebuiltLibrary library, NativePlatform platform, BuildType buildType, Flavor flavor) {
