...
class DefaultCppBinaryTest extends Specification {
    ...
    def setup() {
        ...
        binary = TestUtil.objectFactory().newInstance(DefaultCppBinary, Names.of("mainDebug"), project.objects, Stub(Provider), Stub(FileCollection), componentHeaders, configurations, implementation, Stub(CppPlatform), Stub(NativeToolChainInternal), Stub(PlatformToolProvider), Stub(NativeVariantIdentity))
    }
