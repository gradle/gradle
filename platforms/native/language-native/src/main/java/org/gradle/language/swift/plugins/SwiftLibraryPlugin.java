...
public abstract class SwiftLibraryPlugin implements Plugin<Project> {
    ...
    public void apply(final Project project) {
        ...
        final DefaultSwiftLibrary library =
                componentFactory.newInstance(SwiftLibrary.class, DefaultSwiftLibrary.class, "main");
        ...
        project.afterEvaluate(p -> {
            ...
            library.getBinaries().whenElementKnown(SwiftSharedLibrary.class, sharedLibrary -> {
                ...
                configurations.consumable(names.withSuffix("SwiftApiElements"), apiElements -> {
                    ...
                    apiElements
                            .getAttributes()
                            .attribute(Usage.USAGE_ATTRIBUTE, objectFactory.named(Usage.class, Usage.SWIFT_API));
                    ...
                    apiElements
                            ...
                            .attribute(
                                    ...
                                    sharedLibrary.getTargetMachine().getOperatingSystemFamily());
            ...
            library.getBinaries().whenElementKnown(SwiftStaticLibrary.class, staticLibrary -> {
                ...
                configurations.consumable(names.withSuffix("SwiftApiElements"), apiElements -> {
                    ...
                    // use the implementation dependencies here.  See https://bugs.swift.org/browse/SR-1393.
                    apiElements.extendsFrom(
                            ((DefaultSwiftStaticLibrary) staticLibrary).getImplementationDependencies());
                    apiElements
                            .getAttributes()
                            .attribute(Usage.USAGE_ATTRIBUTE, objectFactory.named(Usage.class, Usage.SWIFT_API));
                    ...
                    apiElements
                            ...
                            .attribute(
                                    OperatingSystemFamily.OPERATING_SYSTEM_ATTRIBUTE,
                                    staticLibrary.getTargetMachine().getOperatingSystemFamily());
