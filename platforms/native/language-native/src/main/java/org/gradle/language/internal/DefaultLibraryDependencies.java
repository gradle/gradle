...
public class DefaultLibraryDependencies extends DefaultComponentDependencies implements LibraryDependencies {
    ...
    @Inject
    public DefaultLibraryDependencies(RoleBasedConfigurationContainerInternal configurations, String implementationName, String apiName, DependencyHandler dependencyHandler, DependencyFactory dependencyFactory) {
        super(configurations, implementationName, dependencyHandler, dependencyFactory);
