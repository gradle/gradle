...
abstract class AbstractCppComponentIntegrationTest extends AbstractNativeLanguageComponentIntegrationTest {
    ...
    def "can build for multiple target machines"() {
        ...
        expect:
        succeeds getTaskNameToAssembleDevelopmentBinaryWithArchitecture(MachineArchitecture.X86), getTaskNameToAssembleDevelopmentBinaryWithArchitecture(MachineArchitecture.X86_64), getTaskNameToAssembleDevelopmentBinaryWithArchitecture(MachineArchitecture.AARCH_64)
        result.assertTasksExecutedAndNotSkipped(getTasksToAssembleDevelopmentBinary(MachineArchitecture.X86),
            ...
            getTasksToAssembleDevelopmentBinary(MachineArchitecture.AARCH_64),
                ...
                getTaskNameToAssembleDevelopmentBinaryWithArchitecture(MachineArchitecture.AARCH_64))
    }
