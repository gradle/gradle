    ...
    private static class Accessors {
        ...
        private static boolean getterAnnotatedWithNullable(JavaMethod getter) {
            try {
                ...
                return method.getAnnotation(javax.annotation.Nullable.class) != null || method.getAnnotatedReturnType().getAnnotation(org.jspecify.annotations.Nullable.class) != null;
            } catch (NoClassDefFoundError e) {
                return getter.isAnnotatedWith(javax.annotation.Nullable.class) || getter.isAnnotatedWith(org.jspecify.annotations.Nullable.class);
            }
        }

        private static boolean setterAnnotatedWithNullable(JavaMethod setter) {
            return Arrays.stream(setter.reflect().getParameterAnnotations()[0]).anyMatch(a ->
                a instanceof javax.annotation.Nullable
            ) || Arrays.stream(setter.reflect().getAnnotatedParameterTypes()[0].getAnnotations()).anyMatch(a ->
