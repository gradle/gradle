...
trait HttpServerFixture {
    ...
    private void ensureDispatcher() {
        if (dispatcher == null) {
            ...
            dispatcher = new HttpServerDispatcher(loggingHandler, securityHandlerWrapper, getCustomHandler(), sslPreHandler)
        }
    }
    ...
    void enableSsl(
        ...
        httpsServer.setHttpsConfigurator(new FixtureHttpsConfigurator(sslContext, protocols, needClientAuth))
        httpsServer.setExecutor(getExecutor())
    ...
    static class FixtureHttpsConfigurator extends HttpsConfigurator {
        ...
        FixtureHttpsConfigurator(SSLContext sslContext, String[] protocols, boolean needClientAuth) {
            super(sslContext)
