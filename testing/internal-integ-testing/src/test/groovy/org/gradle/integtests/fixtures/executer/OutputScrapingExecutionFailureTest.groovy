...
* What went wrong:
Execution failed for task ':broken' (created in build file 'build.gradle').
 \u001B[33m> \u001B[39mbroken
...
* Exception is:
org.gradle.api.tasks.TaskExecutionException: Execution failed for task ':broken' (created in build file 'build.gradle').
...
2019-10-03T09:33:09.031+0200 [ERROR] [org.gradle.internal.buildevents.BuildExceptionReporter] Execution failed for task ':broken' (created in build file 'build.gradle').
...
2019-10-03T09:33:09.033+0200 [ERROR] [org.gradle.internal.buildevents.BuildExceptionReporter] org.gradle.api.tasks.TaskExecutionException: Execution failed for task ':broken' (created in build file 'build.gradle').
