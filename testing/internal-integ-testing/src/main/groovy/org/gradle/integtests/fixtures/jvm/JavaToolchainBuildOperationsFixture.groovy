...
trait JavaToolchainBuildOperationsFixture {
    ...
    static Map<String, String> toolchainValuesFromMetadata(JvmInstallationMetadata jdkMetadata) {
        return [
    ...
    static void assertToolchainUsages(List<BuildOperationRecord.Progress> events, JvmInstallationMetadata jdkMetadata, String... tools) {
        assertToolchainUsages(events, toolchainValuesFromMetadata(jdkMetadata), tools)
    }

    static void assertToolchainUsages(List<BuildOperationRecord.Progress> events, Map<String, String> toolchainValues, String... tools) {
        assert events.size() > 0
        ...
        events.each { usageEvent ->
            ...
            assert usedToolchain == toolchainValues
        }
    }
    ...
    static void assertToolchainUsage(String toolName, JvmInstallationMetadata jdkMetadata, BuildOperationRecord.Progress usageEvent) {
        ...
        def usedToolchain = usageEvent.details.toolchain
        assert usedToolchain == toolchainValuesFromMetadata(jdkMetadata)
    }
