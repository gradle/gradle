 ...
 */
final class ConfigurationCacheExecutionResultProblemsFixture extends ConfigurationCacheProblemsFixture {

    ConfigurationCacheExecutionResultProblemsFixture(File rootDir) {
        super(rootDir)
    }
