...
abstract class AbstractConsoleGroupedTaskFunctionalTest extends AbstractIntegrationSpec {
    ...
    boolean shouldCheckDeprecations() {
        ...
        return consoleType == ConsoleOutput.Plain || consoleType == ConsoleOutput.PlainWithColor || (consoleType == ConsoleOutput.Auto && consoleAttachment == ConsoleAttachment.NOT_ATTACHED)
    }
