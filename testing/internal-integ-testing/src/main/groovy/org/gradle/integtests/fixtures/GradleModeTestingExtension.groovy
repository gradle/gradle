 ...
 */
@NullMarked
class GradleModeTestingExtension<A extends Annotation> {

    private final GradleModeTestingPolicy<A> policy
    @Nullable
    private final ToBeFixedSpecInterceptor expectFailureInterceptor

    GradleModeTestingExtension(GradleModeTestingPolicy<A> policy, @Nullable ToBeFixedSpecInterceptor expectFailureInterceptor) {
        this.policy = policy
