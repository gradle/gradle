...
class KnownProblemIds {
    ...
    private static final HashMap<String, List<String>> KNOWN_DEFINITIONS = [
        ...
        'deprecation:accessing-a-method-from-a-parent-project': ['Accessing a method from a parent project has been deprecated.'],
        'deprecation:accessing-a-property-from-a-parent-project': ['Accessing a property from a parent project has been deprecated.'],
