...
class KnownProblemIds {
    ...
    private static final HashMap<String, List<String>> KNOWN_DEFINITIONS = [
        ...
        'deprecation:querying-the-output-of-an-artifact-transform-of-a-project-artifact-from-a-task-action-without-declaring-it-as-a-task-input': ['Querying the output of an artifact transform of a project artifact from a task action without declaring it as a task input has been deprecated.'],
