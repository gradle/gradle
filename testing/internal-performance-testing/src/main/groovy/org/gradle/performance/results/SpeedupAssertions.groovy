...
class SpeedupAssertions {
  ...
  location:  ${location}
  → Either fix the regression in '${current.name}', or — only if the slowdown is intentional and accepted — lower the floor at this location. Do NOT delete the assertion.""" as Object)
        }
    }
