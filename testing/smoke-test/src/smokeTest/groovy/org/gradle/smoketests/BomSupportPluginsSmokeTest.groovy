    ...
    def 'bom support is provided by #bomSupportProvider'() {
        ...
        if (bomSupportProvider == "nebula recommender plugin") {
            runner.expectDeprecationWarning(
                "Declaring an 'is-' property with a Boolean type has been deprecated. Starting with Gradle 9.0, this property will be ignored by Gradle. The combination of method name and return type is not consistent with Java Bean property rules and will become unsupported in future versions of Groovy. Add a method named 'getStrictMode' with the same behavior and mark the old one with @Deprecated and @ReplacedBy, or replace the return type of 'netflix.nebula.dependency.recommender.provider.RecommendationProviderContainer.isStrictMode' with 'boolean'. Consult the upgrading guide for further information: https://docs.gradle.org/${GradleVersion.current().version}/userguide/upgrading_version_8.html#groovy_boolean_properties",
