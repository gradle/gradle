...
class PalantirConsistentVersionsPluginSmokeTest extends AbstractSmokeTest {
    ...
    def 'basic functionality'() {
        ...
        runner('--write-locks')
            ...
            .expectLegacyDeprecationWarning("Mutating the dependencies of configuration ':gcvLocks' after it has been consumed as a variant. This behavior has been deprecated. This will fail with an error in Gradle 9.0. After a Configuration has been resolved, consumed as a variant, or used for generating published metadata, it should not be modified. Consult the upgrading guide for further information: https://docs.gradle.org/${GradleVersion.current().version}/userguide/upgrading_version_8.html#mutate_configuration_after_locking")
            .expectLegacyDeprecationWarning("Mutating the hierarchy of configuration ':apiElements' after it has been consumed as a variant. This behavior has been deprecated. This will fail with an error in Gradle 9.0. After a Configuration has been resolved, consumed as a variant, or used for generating published metadata, it should not be modified. Consult the upgrading guide for further information: https://docs.gradle.org/${GradleVersion.current().version}/userguide/upgrading_version_8.html#mutate_configuration_after_locking")
            .expectLegacyDeprecationWarning("Mutating the hierarchy of configuration ':runtimeElements' after it's child configuration ':default' has been consumed as a variant. This behavior has been deprecated. This will fail with an error in Gradle 9.0. After a Configuration has been resolved, consumed as a variant, or used for generating published metadata, it should not be modified. Consult the upgrading guide for further information: https://docs.gradle.org/${GradleVersion.current().version}/userguide/upgrading_version_8.html#mutate_configuration_after_locking")
            .expectLegacyDeprecationWarning("Mutating the hierarchy of configuration ':other:apiElements' after it has been consumed as a variant. This behavior has been deprecated. This will fail with an error in Gradle 9.0. After a Configuration has been resolved, consumed as a variant, or used for generating published metadata, it should not be modified. Consult the upgrading guide for further information: https://docs.gradle.org/${GradleVersion.current().version}/userguide/upgrading_version_8.html#mutate_configuration_after_locking")
            .expectLegacyDeprecationWarning("Mutating the hierarchy of configuration ':other:runtimeElements' after it's child configuration ':other:default' has been consumed as a variant. This behavior has been deprecated. This will fail with an error in Gradle 9.0. After a Configuration has been resolved, consumed as a variant, or used for generating published metadata, it should not be modified. Consult the upgrading guide for further information: https://docs.gradle.org/${GradleVersion.current().version}/userguide/upgrading_version_8.html#mutate_configuration_after_locking")
