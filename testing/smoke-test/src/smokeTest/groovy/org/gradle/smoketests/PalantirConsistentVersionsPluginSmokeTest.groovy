...
class PalantirConsistentVersionsPluginSmokeTest extends AbstractSmokeTest {
    ...
    def 'basic functionality'() {
        ...
        when:
        def failure = runner('--write-locks')
        ...
        failure.output.contains("Cannot mutate the dependencies of configuration ':gcvLocks' after the configuration was consumed as a variant. After a configuration has been observed, it should not be modified.")
