...
class PalantirConsistentVersionsPluginSmokeTest extends AbstractSmokeTest {
    ...
    def 'basic functionality'() {
        ...
        runner('--write-locks')
            ...
            .expectLegacyDeprecationWarning("Mutating a Configuration after it has been observed. This behavior has been deprecated. This will fail with an error in Gradle 9.0. The dependencies of configuration ':gcvLocks' were mutated after the configuration was consumed as a variant. After a Configuration has been resolved, consumed as a variant, or used for generating published metadata, it should not be modified. Consult the upgrading guide for further information: https://docs.gradle.org/${GradleVersion.current().version}/userguide/upgrading_version_8.html#mutate_configuration_after_locking")
            .expectLegacyDeprecationWarning("Mutating a Configuration after it has been observed. This behavior has been deprecated. This will fail with an error in Gradle 9.0. The hierarchy of configuration ':apiElements' was mutated after the configuration was consumed as a variant. After a Configuration has been resolved, consumed as a variant, or used for generating published metadata, it should not be modified. Consult the upgrading guide for further information: https://docs.gradle.org/${GradleVersion.current().version}/userguide/upgrading_version_8.html#mutate_configuration_after_locking")
            .expectLegacyDeprecationWarning("Mutating a Configuration after it has been observed. This behavior has been deprecated. This will fail with an error in Gradle 9.0. The hierarchy of configuration ':runtimeElements' was mutated after the configuration's child configuration ':default' was consumed as a variant. After a Configuration has been resolved, consumed as a variant, or used for generating published metadata, it should not be modified. Consult the upgrading guide for further information: https://docs.gradle.org/${GradleVersion.current().version}/userguide/upgrading_version_8.html#mutate_configuration_after_locking")
            .expectLegacyDeprecationWarning("Mutating a Configuration after it has been observed. This behavior has been deprecated. This will fail with an error in Gradle 9.0. The hierarchy of configuration ':other:apiElements' was mutated after the configuration was consumed as a variant. After a Configuration has been resolved, consumed as a variant, or used for generating published metadata, it should not be modified. Consult the upgrading guide for further information: https://docs.gradle.org/${GradleVersion.current().version}/userguide/upgrading_version_8.html#mutate_configuration_after_locking")
            .expectLegacyDeprecationWarning("Mutating a Configuration after it has been observed. This behavior has been deprecated. This will fail with an error in Gradle 9.0. The hierarchy of configuration ':other:runtimeElements' was mutated after the configuration's child configuration ':other:default' was consumed as a variant. After a Configuration has been resolved, consumed as a variant, or used for generating published metadata, it should not be modified. Consult the upgrading guide for further information: https://docs.gradle.org/${GradleVersion.current().version}/userguide/upgrading_version_8.html#mutate_configuration_after_locking")
