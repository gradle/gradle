...
tasks.register("patchExternalModules", PatchExternalModules::class.java) {
...
tasks.register("install", Install::class.java) {
...
tasks.register("installAll", Install::class.java) {
