...
@CacheableTask
abstract class NextMajorRemovalReportTask : DefaultTask() {
    ...
    fun analyze() = workerExecutor.processIsolation { classpath.from(additionalClasspath) }.submit(RemovalReportWorkAction::class) {
        ...
        srcDirs.from(this@NextMajorRemovalReportTask.sources)
        htmlReportFile = this@NextMajorRemovalReportTask.htmlReportFile
        textReportFile = this@NextMajorRemovalReportTask.textReportFile
        title = this@NextMajorRemovalReportTask.title
        targetMajorVersion = this@NextMajorRemovalReportTask.targetMajorVersion
    }
}
