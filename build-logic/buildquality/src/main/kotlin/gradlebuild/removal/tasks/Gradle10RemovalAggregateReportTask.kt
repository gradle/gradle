...
@CacheableTask
abstract class Gradle10RemovalAggregateReportTask : DefaultTask() {
    ...
    fun generateReport() = workerExecutor.noIsolation().submit(RemovalReportAggregationWorkAction::class) {
        reports.from(this@Gradle10RemovalAggregateReportTask.reports)
        htmlReportFile = this@Gradle10RemovalAggregateReportTask.htmlReportFile
        csvReportFile = this@Gradle10RemovalAggregateReportTask.csvReportFile
        currentCommit = this@Gradle10RemovalAggregateReportTask.currentCommit
    }
}
