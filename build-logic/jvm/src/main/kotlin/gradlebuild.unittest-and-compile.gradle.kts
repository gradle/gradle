...
// Use the Java 21 compiler, when possible, to perform compilation.
// This does not mean we target Java 21 bytecode. The target bytecode
// is controlled by the `gradlebuildJava.targetVersion` property.
configureDefaultToolchain(21)
