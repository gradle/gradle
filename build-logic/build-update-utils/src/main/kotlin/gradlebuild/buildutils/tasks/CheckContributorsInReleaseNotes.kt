    ...
    fun check() {
        ...
        if (contributorsInPullRequestsButNotInReleaseNotes.isNotEmpty()) {
            error(
                ...
                You can run `GITHUB_TOKEN=<YourGitHubToken> ./gradlew reference-docs:updateContributorsInReleaseNotes --milestone <milestone>` to update the release notes with correct contributors automatically.
                """.trimIndent()
            )
        }
    }
