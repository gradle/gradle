...
abstract class UpdateAgpVersions : DefaultTask() {
    ...
    companion object {
        ...
        fun selectVersionsFrom(minimumSupported: String, allVersions: List<String>): List<String> {
            ...
            val allSelectable = (allMinorLatests + minimumSupportedNumber).sorted()
            val selected = allSelectable.subList(allSelectable.indexOf(minimumSupportedNumber) + 1, allSelectable.size)
