...
class UpdateKotlinVersionsTest extends Specification {
    ...
    def "previous minor keeps its latest stable alongside a newer RC"() {
        ...
        // (e.g. 2.4.0-Beta2), the previous minor's selection switched from the per-patch logic to
        ...
        then:
        selected == ["2.0.0", "2.0.21", "2.1.21", "2.2.21", "2.3.20", "2.3.21-RC", "2.4.0-Beta2"]
    }
    ...
    def "previous minor with no stable patch is dropped"() {
        ...
        then:
        selected == ["2.0.0", "2.0.21", "2.1.21", "2.2.21", "2.4.0-Beta2"]
    }
