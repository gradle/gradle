...
/**
 * Configures the xdcl-ecosystem manifest for a built-in XDCL ecosystem plugin module.
 *
 ...
 * schema discovery is blind to it. The manifest — `META-INF/xdcl-ecosystem/<pluginId>.properties`,
 ...
 */
interface XdclEcosystemExtension {
