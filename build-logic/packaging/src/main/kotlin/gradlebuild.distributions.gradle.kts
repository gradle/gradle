...
val docsPath = docsResolver("docsPath", ":docs-site")
docsPath.description = "Resolves to the complete Gradle documentation site - automatically adds dependency to the :docs-site project"
