...
public class JUnit4Testsuites {

    protected List<JUnit4Testsuite> testsuite;
     ...
     * {@link JUnit4Testsuite }
     *
     *
     */
    public List<JUnit4Testsuite> getTestsuite() {
        if (testsuite == null) {
            testsuite = new ArrayList<JUnit4Testsuite>();
        }
