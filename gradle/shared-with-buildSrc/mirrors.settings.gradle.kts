...
val originalUrls: Map<String, String> = mapOf(
    ...
    "gradle" to "https://repo.gradle.org/artifactory/repo",
    "gradleplugins" to "https://plugins.gradle.org/m2",
    "gradlejavascript" to "https://repo.gradle.org/artifactory/javascript-public",
    "gradle-libs" to "https://repo.gradle.org/artifactory/libs",
    "gradle-releases" to "https://repo.gradle.org/artifactory/libs-releases",
    "gradle-snapshots" to "https://repo.gradle.org/artifactory/libs-snapshots",
    "gradle-enterprise-plugin-rc" to "https://repo.gradle.org/artifactory/enterprise-libs-release-candidates-local",
