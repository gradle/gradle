...
public interface PomFilterContainer {
     ...
     *
     * @see #setFilter(org.gradle.api.dependencies.maven.PublishFilter)
     */
    PublishFilter getFilter();

    /**
     * <p>Sets the default filter to be used. This filter is active if no custom filters have been added (see {@link #addFilter(String, org.gradle.api.dependencies.maven.PublishFilter)}).
     ...
     * to use the (see {@link #addFilter(String, org.gradle.api.dependencies.maven.PublishFilter)} method.</p>
     *
     * @param defaultFilter
     * @see #getFilter()
     */
    ...
    /**
     * <p>Sets the default pom to be used. This pom is active if no custom filters have been added (see {@link #addFilter(String, org.gradle.api.dependencies.maven.PublishFilter)}).
    ...
    /**
     * Returns a filter added with {@link #addFilter(String, org.gradle.api.dependencies.maven.PublishFilter)}
     *
     * @param name The name of the filter
     */
    ...
    /**
     * Returns the pom associated with a filter added with {@link #addFilter(String, org.gradle.api.dependencies.maven.PublishFilter)}.
     *
     * @param name The name of the filter.
     */
