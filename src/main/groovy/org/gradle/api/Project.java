...
public interface Project {
    ...
    /**
     * Returns the default prefix for naming archive tasks created via bundles.
     *
    ...
    /**
     * <p>Set's the default prefix used for naming archive tasks. This is used if you create archive task via bundles.
     * For example <code>libs.jar()</code> creates an archive task with the name of the default prefix plus <code>
     * "_jar"</code>. The default for the default prefix is <i>archive</i>.</p>
     *
     ...
     * via bundles. For example <code>libs.jar()</code> generates an archive with the name of the default prefix plus <code>
     * ".jar"</code>. The default for the default prefix is the name of the project.</p>
     *
    ...
    /**
     * Sets a {@link Convention} object for this project. Usually this is not needed as every project has a default
     * Convention object in use.
     * 
    ...
    /**
     * Returns the nesting level of a project in a multi-project hierarchy. For single project builds this is always 0.
     * In a multi-project hierarchy 0 is returned for the root project.
     */
    int getDepth();
    ...
    /**
     * Informs about whether a certain plugin has been applied against this project. If a plugin has been applied,
     * the class of this plugin is contained in the returned set.
     *
     * @return A set with class objects of plugins applied against this project. Returns an empty set if no plugin has
     * been applied.
     */
    ...
    /**
     * Adds an afterEvaluateListener to this project. Such a listener gets notified when the build script belonging
     * to this project has been executed. A parent project may for example add such a listener to its child project.
     * Such a listener can futher configure those child projects based on the state of the child projects after there
     * build scripts have been run.
     *
    ...
    /**
     * Returns all afterEvaluateListener of this project.
     *
