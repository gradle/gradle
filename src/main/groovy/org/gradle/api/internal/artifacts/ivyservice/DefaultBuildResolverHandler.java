 ...
 * @author Hans Dockter
 */
public class DefaultBuildResolverHandler implements BuildResolverHandler {
    ...
    public DefaultBuildResolverHandler(File buildResolverDir, LocalReposCacheHandler localReposCacheHandler) {
