...
class DefaultDependencyContainer implements DependencyContainer {
    static Logger logger = LoggerFactory.getLogger(DefaultDependencyContainer)
    ...
    DefaultDependencyContainer(DependencyFactory dependencyFactory, List defaultConfs) {
