...
object KotlinScriptDefinitionProvider {
    ...
    val PROJECT_PROTOTYPE = KotlinScriptConfig(
    ...
    fun scriptDefinitionFor(classPath: List<File>, prototype: KotlinScriptConfig = PROJECT_PROTOTYPE): KotlinConfigurableScriptDefinition {
