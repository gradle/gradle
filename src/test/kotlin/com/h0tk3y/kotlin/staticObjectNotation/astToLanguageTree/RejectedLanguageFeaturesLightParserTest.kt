...
class RejectedLanguageFeaturesLightParserTest: AbstractRejectedLanguageFeaturesTest() {
    ...
    fun `rejects star imports`() {
        val code = """
            ...
            """.trimIndent()
        val expected = """
            UnsupportedConstruct(languageFeature = StarImport, potentialElementSource = indexes: 0..14, file: test, erroneousSource = indexes: 13..14, file: test)
            UnsupportedConstruct(languageFeature = StarImport, potentialElementSource = indexes: 15..25, file: test, erroneousSource = indexes: 24..25, file: test)
    ...
    fun `rejects renaming imports`() {
        val code = """
            ...
            """.trimIndent()
        val expected = """
            UnsupportedConstruct(languageFeature = RenamingImport, potentialElementSource = indexes: 0..13, file: test, erroneousSource = indexes: 9..13, file: test)
    ...
    fun `rejects variable type labels`() {
        val code = """
            ...
            """.trimIndent()
        val expected = """
            UnsupportedConstruct(languageFeature = ExplicitVariableType, potentialElementSource = indexes: 0..14, file: test, erroneousSource = indexes: 7..10, file: test)
            """.trimIndent()
        assertResult(expected, code)
    }
    ...
    fun `rejects indexed assignments`() {
        val code = """
            ...
            """.trimIndent()
        val expected = """
            UnsupportedConstruct(languageFeature = Indexing, potentialElementSource = indexes: 0..4, file: test, erroneousSource = indexes: 0..4, file: test)
            UnsupportedConstruct(languageFeature = Indexing, potentialElementSource = indexes: 9..17, file: test, erroneousSource = indexes: 9..17, file: test)
            UnsupportedConstruct(languageFeature = Indexing, potentialElementSource = indexes: 22..26, file: test, erroneousSource = indexes: 22..26, file: test)
            UnsupportedConstruct(languageFeature = Indexing, potentialElementSource = indexes: 33..43, file: test, erroneousSource = indexes: 33..43, file: test)
            UnsupportedConstruct(languageFeature = Indexing, potentialElementSource = indexes: 48..57, file: test, erroneousSource = indexes: 48..57, file: test)
            UnsupportedConstruct(languageFeature = Indexing, potentialElementSource = indexes: 68..72, file: test, erroneousSource = indexes: 68..72, file: test)
            UnsupportedConstruct(languageFeature = Indexing, potentialElementSource = indexes: 77..84, file: test, erroneousSource = indexes: 77..84, file: test)
            UnsupportedConstruct(languageFeature = Indexing, potentialElementSource = indexes: 89..96, file: test, erroneousSource = indexes: 89..96, file: test)
            """.trimIndent()
        assertResult(expected, code)
    }
    ...
    fun `rejects mutable vars`() {
        ...
        val expected = """
            ...
            MultipleFailures(
                ...
                UnsupportedConstruct(languageFeature = ExplicitVariableType, potentialElementSource = indexes: 10..24, file: test, erroneousSource = indexes: 17..20, file: test)
            )
            MultipleFailures(
                ...
                UnsupportedConstruct(languageFeature = ExplicitVariableType, potentialElementSource = indexes: 25..35, file: test, erroneousSource = indexes: 32..35, file: test)
            ...
            MultipleFailures(
                ...
                UnsupportedConstruct(languageFeature = ExplicitVariableType, potentialElementSource = indexes: 36..55, file: test, erroneousSource = indexes: 52..55, file: test)
    ...
    fun `rejects modifiers on vals`() {
        ...
        val expected = """
            MultipleFailures(
                ...
                UnsupportedConstruct(languageFeature = ExplicitVariableType, potentialElementSource = indexes: 0..21, file: test, erroneousSource = indexes: 14..17, file: test)
            )
            MultipleFailures(
                ...
                UnsupportedConstruct(languageFeature = ExplicitVariableType, potentialElementSource = indexes: 22..40, file: test, erroneousSource = indexes: 37..40, file: test)
    ...
    fun `rejects annotation usages`() {
        ...
        var expected = """
            ...
            UnsupportedConstruct(languageFeature = AnnotationUsage, potentialElementSource = indexes: 13..21, file: test, erroneousSource = indexes: 13..21, file: test)
            UnsupportedConstruct(languageFeature = AnnotationUsage, potentialElementSource = indexes: 24..28, file: test, erroneousSource = indexes: 24..28, file: test)
            UnsupportedConstruct(languageFeature = AnnotationUsage, potentialElementSource = indexes: 34..40, file: test, erroneousSource = indexes: 34..40, file: test)
            """.trimIndent()
        assertResult(expected, code)
    }
}