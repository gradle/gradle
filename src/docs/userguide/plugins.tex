...
\outputInputTutorial{../../../build/tutorial-output/pluginIntrofile.out}
...
\outputInputTutorial{../../../build/tutorial-output/pluginConfigfile.out}
...
\outputInputTutorial{../../../build/tutorial-output/pluginConventionfile.out}
