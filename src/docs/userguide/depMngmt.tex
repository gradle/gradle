...
\section{Deploying to Maven Repositories} % (fold)
...
\codeGradleFile[pomGeneration - ]{../../../build/distributions/exploded/samples/pomGeneration/build.gradle}


% section deploying_to_maven_repositories (end)