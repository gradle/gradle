...
Now execute the build script\footnote{Every code sample in this chapter can be found in the \texttt{samples} dir of your Gradle distribution. The output box always denotes the directory name relative to the \texttt{samples} dir.}:
\outputInputTutorial{../../../build/tutorial-output/hellofile.out} 
...
\outputInputTutorial{../../../build/tutorial-output/datefile.out}
or
\codeInput{../../../build/distributions/exploded/samples/tutorial/countfile}
\outputInputTutorial{../../../build/tutorial-output/countfile.out}
...
\outputInputTutorial{../../../build/tutorial-output/introfile.out}
To add a dependency, the corresponding task does not need to exist. 
\codeInput{../../../build/distributions/exploded/samples/tutorial/lazyDependsOnfile}
\outputInputTutorial{../../../build/tutorial-output/lazyDependsOnfile.out}
...
\outputInputTutorial{../../../build/tutorial-output/dynamicfile.out}
...
\outputInputTutorial{../../../build/tutorial-output/dynamicDependsfile.out}
Or you can add behavior to an existing task.
\codeInput{../../../build/distributions/exploded/samples/tutorial/helloEnhancedfile}
\outputInputTutorial{../../../build/tutorial-output/helloEnhancedfile.out}
...
\outputInputTutorial{../../../build/tutorial-output/helloWithShortCutfile.out}
...
\outputInputTutorial{../../../build/tutorial-output/antChecksumfile.out}
...
\outputInputTutorial{../../../build/tutorial-output/antChecksumWithMethodfile.out}
...
\outputInputTutorial{../../../build/tutorial-output/configureByDagfile.out}
