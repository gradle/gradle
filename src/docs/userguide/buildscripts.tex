...
\codeInput{../../samples/userguide/tutorial/hello/build.gradle} 
...
\codeInput{../../samples/userguide/tutorial/upper/build.gradle}
\outputInputTutorial{upper}
or
\codeInput{../../samples/userguide/tutorial/count/build.gradle}
\outputInputTutorial{count}
...
\codeInput{../../samples/userguide/tutorial/intro/build.gradle}
\outputInputTutorial{intro}
To add a dependency, the corresponding task does not need to exist. 
\codeInput{../../samples/userguide/tutorial/lazyDependsOn/build.gradle}
\outputInputTutorial{lazyDependsOn}
...
\codeInput{../../samples/userguide/tutorial/dynamic/build.gradle}
\outputInputTutorial{dynamic}
...
\codeInput{../../samples/userguide/tutorial/dynamicDepends/build.gradle}
\outputInputTutorial{dynamicDepends}
Or you can add behavior to an existing task.
\codeInput{../../samples/userguide/tutorial/helloEnhanced/build.gradle}
\outputInputTutorial{helloEnhanced}
...
\codeInput{../../samples/userguide/tutorial/helloWithShortCut/build.gradle}
\outputInputTutorial{helloWithShortCut}
This enables very readable code. Especially when using the out of the box tasks provided by the plugins (e.g. \texttt{compile}).

\section{Dynamic Task Properties} % (fold)
\label{sec:dynamic_properties}
You can assign arbitrary \emph{new} properties to any task.
\codeInput{../../samples/userguide/tutorial/dynamicProperties/build.gradle}
\outputInputTutorial{dynamicProperties}
% section dynamic_properties (end)
...
\codeInput{../../samples/userguide/tutorial/antChecksum/build.gradle}
\outputInputTutorial{antChecksum}
...
\codeInput{../../samples/userguide/tutorial/antChecksumWithMethod/build.gradle}
\outputInputTutorial{antChecksumWithMethod}
...
\section{Default Tasks} % (fold)
\label{sec:default_tasks}
Gradle allows you to define one ore more default tasks for your build. 
\codeInput{../../samples/userguide/tutorial/defaultTasks/build.gradle}
\outputInputTutorial{defaultTasks}
...
\codeInput{../../samples/userguide/tutorial/configByDag/build.gradle}
\outputInputTutorial{configByDag}
