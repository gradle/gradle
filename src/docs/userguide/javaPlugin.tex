...
\begin{center}
	...
	\end{tabular} 
\end{center}
\caption{Java Convention Object - Javadoc Properties}
\end{table}
% section javadoc (end)
...
\begin{center}
	...
	\end{tabular} 
\end{center}
\caption{Java Convention Object - Resource Properties}
\end{table}
...
\begin{center}
	...
	\end{tabular} 
\end{center}
\caption{Java Convention Object - Compile Properties}
\end{table}
...
\begin{center}
	...
	\end{tabular} 
\end{center}
\caption{Java Convention Object - Test Properties}
\end{table}
...
\begin{center}
	...
	\end{tabular} 
\end{center}
\caption{Java Convention Object - Bundle Properties}
\end{table}
...
\codeInput{../../samples/userguide/tutorial/zip/build.gradle}
\outputInputTutorial{zip}
...
\codeInput{../../samples/userguide/tutorial/zipWithCustomName/build.gradle}
\outputInputTutorial{zipWithCustomName}
You can further customize the names by passing arguments to archive method of the bundle task:
\codeInput{../../samples/userguide/tutorial/zipWithArguments/build.gradle}
\outputInputTutorial{zipWithArguments}
% subsection adding_archives (end)
\subsection{Configuration Action} % (fold)
\label{sub:configuration_action}
t.b.d.
% subsection configuration_action (end)
...
\subsection{Eclipse Classpath} % (fold)
...
\begin{center}
	...
	\end{tabular} 
\end{center}
\caption{Java Convention Object - Eclipse Properties}
\end{table}
% subsection eclipse_classpath (end)
\subsection{Eclipse Project} % (fold)
...
\begin{center}
	...
	\end{tabular} 
\end{center}
\caption{Java Convention Object - Eclipse Project Properties}
\end{table}
% subsection eclipse_project (end)
