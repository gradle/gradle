 ...
 *
 * Equivalent to <code>id("com.gradle.build-scan") version "1.8"`</code>.
 * You can also use e.g. <code>`build-scan` version "1.7.1"</code> if you want to use a different version.
 */
