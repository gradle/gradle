...
data class FlameGraphGeneration(
    ...
    override fun asConfigurationId(model: CIBuildModel) = "${model.projectId}_PerformanceTest$uuid"
    ...
    inner class FlameGraphGenerationBuildSpec(
        ...
        override val type: PerformanceTestType = PerformanceTestType.AD_HOC

        override fun asConfigurationId(
            model: CIBuildModel,
            bucket: String,
        ): String = "${this@FlameGraphGeneration.asConfigurationId(model)}$bucket"

        override fun channel(): String = this@FlameGraphGeneration.channel()
    }
}
