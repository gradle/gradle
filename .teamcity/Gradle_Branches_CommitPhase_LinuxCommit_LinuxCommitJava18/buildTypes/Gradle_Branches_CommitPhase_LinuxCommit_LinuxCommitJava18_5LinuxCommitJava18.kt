...
object Gradle_Branches_CommitPhase_LinuxCommit_LinuxCommitJava18_5LinuxCommitJava18 : BuildType({
    uuid = "d2d0449e-0964-4405-81f0-03a0bbeb6e6b"
    extId = "Gradle_Branches_CommitPhase_LinuxCommit_LinuxCommitJava18_5LinuxCommitJava18"
    name = "(5) Linux commit - Java 1.8"
    description = "Fast verification on Linux through in-process tests [clean quickTest5]"
