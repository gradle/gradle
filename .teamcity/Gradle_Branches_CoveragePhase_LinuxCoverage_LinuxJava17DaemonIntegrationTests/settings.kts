package Gradle_Branches_CoveragePhase_LinuxCoverage_LinuxJava17DaemonIntegrationTests
...
version = "10.0"
project(Gradle_Branches_CoveragePhase_LinuxCoverage_LinuxJava17DaemonIntegrationTests.Project)