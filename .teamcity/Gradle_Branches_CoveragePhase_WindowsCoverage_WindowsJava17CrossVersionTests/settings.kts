package Gradle_Branches_CoveragePhase_WindowsCoverage_WindowsJava17CrossVersionTests
...
version = "10.0"
project(Gradle_Branches_CoveragePhase_WindowsCoverage_WindowsJava17CrossVersionTests.Project)