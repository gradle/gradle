...
object BuildType_Gradle_Branches_CoveragePhase_WindowsCoverage_WindowsJava17DaemonIntegrationTest : BuildType({
    uuid = "a2be8eee-16c7-4945-af24-cd9afb88496f"
    extId = "Gradle_Branches_CoveragePhase_WindowsCoverage_WindowsJava17DaemonIntegrationTest"
    name = "(1) Windows - Java 1.7 - Daemon integration tests"
    description = "Daemon integration tests for Windows [clean daemonTest1]"
