package Gradle_Branches_CoveragePhase_WindowsCoverage_WindowsJava17DaemonIntegrationTest
...
version = "10.0"
project(Gradle_Branches_CoveragePhase_WindowsCoverage_WindowsJava17DaemonIntegrationTest.Project)