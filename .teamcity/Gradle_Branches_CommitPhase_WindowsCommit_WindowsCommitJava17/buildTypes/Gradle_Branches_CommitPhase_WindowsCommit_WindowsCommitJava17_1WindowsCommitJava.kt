...
object Gradle_Branches_CommitPhase_WindowsCommit_WindowsCommitJava17_1WindowsCommitJava : BuildType({
    uuid = "b3de8fb6-d8eb-4b9d-9342-f47513d8e7ce"
    extId = "Gradle_Branches_CommitPhase_WindowsCommit_WindowsCommitJava17_1WindowsCommitJava"
    name = "(1) Windows commit - Java 1.7"
    description = "Fast verification on windows through in-process tests [clean quickTest1]"
