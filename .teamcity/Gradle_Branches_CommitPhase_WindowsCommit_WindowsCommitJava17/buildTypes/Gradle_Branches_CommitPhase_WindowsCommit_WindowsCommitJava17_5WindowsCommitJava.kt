...
object Gradle_Branches_CommitPhase_WindowsCommit_WindowsCommitJava17_5WindowsCommitJava : BuildType({
    uuid = "444fe882-a48b-45b1-8353-ddbda614cf76"
    extId = "Gradle_Branches_CommitPhase_WindowsCommit_WindowsCommitJava17_5WindowsCommitJava"
    name = "(5) Windows commit - Java 1.7"
    description = "Fast verification on windows through in-process tests [clean quickTest5]"
