...
object Gradle_Branches_CommitPhase_WindowsCommit_WindowsCommitJava17_6WindowsCommitJava : BuildType({
    uuid = "6556a0fa-ffec-40fa-8e2c-ae628d9da5cb"
    extId = "Gradle_Branches_CommitPhase_WindowsCommit_WindowsCommitJava17_6WindowsCommitJava"
    name = "(6) Windows commit - Java 1.7"
    description = "Fast verification on windows through in-process tests [clean quickTest6]"
