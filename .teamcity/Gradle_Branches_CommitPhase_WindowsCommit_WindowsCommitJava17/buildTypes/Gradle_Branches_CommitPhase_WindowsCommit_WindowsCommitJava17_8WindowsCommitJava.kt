...
object Gradle_Branches_CommitPhase_WindowsCommit_WindowsCommitJava17_8WindowsCommitJava : BuildType({
    uuid = "f8e90ea1-99f0-49a4-b445-1590ff7082dc"
    extId = "Gradle_Branches_CommitPhase_WindowsCommit_WindowsCommitJava17_8WindowsCommitJava"
    name = "(8) Windows commit - Java 1.7"
    description = "Fast verification on windows through in-process tests [clean quickTest8]"
