...
object Gradle_Branches_CommitPhase_WindowsCommit_WindowsCommitJava17_2WindowsCommitJava : BuildType({
    uuid = "3a5ba123-fd43-45d6-8e23-502ecce4e0a7"
    extId = "Gradle_Branches_CommitPhase_WindowsCommit_WindowsCommitJava17_2WindowsCommitJava"
    name = "(2) Windows commit - Java 1.7"
    description = "Fast verification on windows through in-process tests [clean quickTest2]"
