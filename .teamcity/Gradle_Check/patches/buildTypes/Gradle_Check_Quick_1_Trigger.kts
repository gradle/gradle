...
To apply the patch, change the buildType with uuid = 'Gradle_Check_Quick_1_Trigger' (id = 'Gradle_Check_Quick_1_Trigger')
accordingly, and delete the patch script.
*/
changeBuildType(uuid("Gradle_Check_Quick_1_Trigger")) {
    features {
