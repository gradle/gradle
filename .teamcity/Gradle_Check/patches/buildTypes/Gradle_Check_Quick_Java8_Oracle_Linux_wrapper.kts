...
To apply the patch, change the buildType with uuid = 'Gradle_Check_Quick_Java8_Oracle_Linux_wrapper' (id = 'Gradle_Check_Quick_Java8_Oracle_Linux_wrapper')
accordingly and delete the patch script.
*/
changeBuildType("Gradle_Check_Quick_Java8_Oracle_Linux_wrapper") {
    expectSteps {
        gradle {
