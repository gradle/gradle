...
To apply the patch, change the buildType with uuid = 'Gradle_Check_Quick_Java8_Oracle_Linux_announce' (id = 'Gradle_Check_Quick_Java8_Oracle_Linux_announce')
accordingly and delete the patch script.
*/
changeBuildType("Gradle_Check_Quick_Java8_Oracle_Linux_announce") {
    expectSteps {
        gradle {
        ...
        gradle {
            name = "GRADLE_RUNNER"
            tasks = "clean announce:quickTest"
            buildFile = ""
