...
Gradle exposes an API for providing credentials in link:{javadocPath}/org/gradle/api/provider/ProviderFactory.html#credentials-java.lang.Class-java.lang.String-[ProviderFactory]
