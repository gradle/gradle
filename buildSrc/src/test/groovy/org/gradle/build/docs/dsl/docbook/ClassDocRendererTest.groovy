...
class ClassDocRendererTest extends XmlSpecification {
    ...
    <section>
        ...
        <section id="prop1" role="detail">
            ...
            <caution>
                <para>Note: This property is <link linkend="element-annotations">deprecated</link> and will be removed in the next major version of Gradle.</para>
            </caution>
        ...
        <section id="prop2" role="detail">
            ...
            <caution>
                <para>Note: This property is <link linkend="element-annotations">incubating</link> and may change in a future version of Gradle.</para>
            </caution>
    ...
    <section>
        ...
        <section id="method1Id" role="detail">
            ...
            <caution>
                <para>Note: This method is <link linkend="element-annotations">deprecated</link> and will be removed in the next major version of Gradle.</para>
            </caution>
            <para>method comment</para>
        </section>
        <section id="method2Id" role="detail">
            ...
            <caution>
                <para>Note: This method is <link linkend="element-annotations">incubating</link> and may change in a future version of Gradle.</para>
            </caution>
            <para>overloaded comment</para>
        </section>
    </section>
