...
class ReleasedVersionsFromServicesGradleOrg implements ReleasedVersions {
    private static final Logger LOGGER = Logging.getLogger(ReleasedVersionsFromServicesGradleOrg.class)
