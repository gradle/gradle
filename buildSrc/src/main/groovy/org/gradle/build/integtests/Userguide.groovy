...
//                runMp('partialTasks/water', 'PartialTasksNotQuiet', 'distanceToIceberg', Executer.LIFECYCLE),
                ...
                run('tutorial', 'properties',
                        '-PcommandLineProjectProp=commandLineProjectPropValue -Dorg.gradle.project.systemProjectProp=systemPropertyValue printProps').setEnvs(['ORG_GRADLE_PROJECT_envProjectProp=envPropertyValue']),
