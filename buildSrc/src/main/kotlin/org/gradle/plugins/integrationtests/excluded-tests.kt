...
object ExcludedTests {
    fun excludesForJavaVersion(version: JavaVersion) = excludedTests[version] ?: emptySet()

    private
    val excludedTests = exclude(
    ...
    private
    fun exclude(vararg pairs: Pair<String, List<JavaVersion>>): Map<JavaVersion, Set<String>> {
