...
fun configureTests() {
    ...
    tasks.withType<Test>().configureEach {
        ...
        if (!BuildEnvironment.isIntelliJIDEA) {
            // JUnit 5 Vintage engine can't recognize Spock @SafeUnroll test method correctly
            // So if running an @SafeUnroll method in IDEA with include pattern "SomeClass.methodName"
