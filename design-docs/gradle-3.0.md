...
* Remove `ClientModule` and replace with consumer-side component metadata rules.
* Remove `ExternalModuleDependency.changing`. Use component metadata rules instead.
