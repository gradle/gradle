...
## Story: Deprecate support for Tooling API clients earlier than Gradle 1.2
...
## Story: Deprecate support for Gradle versions earlier than Gradle 1.0-milestone-8
